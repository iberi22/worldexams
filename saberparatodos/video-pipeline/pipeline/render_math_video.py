...
def calculate_timecodes(duration_seconds: int, num_steps: int, intro_seconds: int = 3, outro_seconds: int = 3) -> list[int]:
...
def render_with_remotion(question_id: str, parsed: dict, audio_wav: str, timecodes: list[int], duration_seconds: float) -> str:
    """
    ...
    cmd = [
        ...
        "--output", raw_video,
        "--composition", "VerticalMathTemplate",
        "--remotionDir", str(REMOTION_DIR),
        "--scale", "1",
    ]
