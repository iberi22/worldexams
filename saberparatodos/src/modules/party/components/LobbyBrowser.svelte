<script lang="ts">
  ...
  interface Props {
    onJoin: (partyId: string, partyName: string) => void;
    onClose: () => void;
  }
    ...
    <div class="flex-1 overflow-y-auto p-6 scrollbar-hide">
      ...
      {:else if lobbies.length === 0}
        <div class="text-center py-20">
            ...
            <p class="text-white/30 text-sm max-w-xs mx-auto">Sé el primero en crear un desafío Stop para que otros se unan.</p>
                    ...
                    <div class="flex items-start justify-between relative z-10 w-full">
                        <div class="flex-1">
                            <div class="flex items-center gap-2 mb-2">
                                <span class="px-2 py-0.5 bg-pink-500 text-white text-[10px] font-black rounded uppercase">STOP</span>
                            ...
                            <p class="text-sm text-white/40 mt-1">Host: <span class="text-white/60">{session.host_name}</span></p>
