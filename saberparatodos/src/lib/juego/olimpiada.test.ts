...
describe('olimpiada (F7)', () => {
  ...
  it('bounds cubren el trimestre completo', () => {
  ...
  it('elegibilidad: Oro+ 2 semanas + simulacro válido', () => {
    const ok = esElegible(['Oro', 'Plata', 'Diamante'], [{ questions: 115, accuracy: 0.72 }]);
  ...
  it('set común de 20 con exclusiones', () => {
