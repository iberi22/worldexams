    ...
    <div class="space-y-6 relative z-10">
      ...
      <div class="space-y-3">
        ...
        <div class="grid grid-cols-2 gap-3">
          ...
          <button
            class="py-3 px-4 rounded border transition-all duration-200 flex flex-col items-center gap-2 bg-white/5 border-white/10 text-white/30 cursor-not-allowed relative overflow-hidden"
            disabled
          >
            ...
            <span class="text-xs font-bold uppercase opacity-50">Party Mode</span>
            <div class="absolute inset-0 flex items-center justify-center bg-black/60 font-mono text-[10px] text-[#FCD116] uppercase tracking-widest rotate-12 backdrop-blur-[1px]">
                Coming Soon
            </div>
          </button>
        </div>
