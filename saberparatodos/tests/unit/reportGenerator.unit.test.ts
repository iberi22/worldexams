...
describe('ReportGenerator HTML Generation', () => {
  ...
  beforeEach(() => {
    ...
    sampleResults = {
      ...
      questionStats: [
        { questionId: 'q1', correctCount: 2, incorrectCount: 0, averageTime: 45000, difficultyPerceived: 3 },
        { questionId: 'q2', correctCount: 1, incorrectCount: 1, averageTime: 48000, difficultyPerceived: 4 },
      ],
    };
  });
