...
# Explicación
Colombia tiene tres ramas del poder público: Ejecutiva (Presidente), Legislativa (Congreso) y Judicial (Cortes y Tribunales).
...
|----------|-----|------------|----------|
| 1 | CO-SOC-11-CIU-002-v1 | Medium | ⬜ |
| 2 | CO-SOC-11-CIU-002-v2 | Low | ⬜ |
| 3 | CO-SOC-11-CIU-002-v3 | Low | ⬜ |
| 4 | CO-SOC-11-CIU-002-v4 | Medium | ⬜ |
