...
- [x] C) She does homework and plays with friends
- [ ] D) She has breakfast

### Explicación Pedagógica

**¿Por qué C es correcta?**
El texto indica la secuencia temporal: "**After school**, she goes home, does her homework, and plays soccer...".

**Competencia evaluada:** Lectura Literal - Identificación de Secuencia
...
**¿Por qué C es correcta?**
El texto dice: "then she **walks** to school".
...
**ID:** "CO-ING-11-reading-002-v5"

### Enunciado

Based on the text, why does Maria walk to school?

### Opciones

- [ ] A) Because she likes exercise.
- [ ] B) Because she has no car.
- [x] C) Because the school is near her house.
- [ ] D) Because her friends walk too.

### Explicación Pedagógica

**¿Por qué C es correcta?**
El texto da la razón (causa): "she walks to school **because it is near her house**".

**Competencia evaluada:** Lectura Literal - Causa y Efecto
**Componente:** Reading Comprehension
...
**ID:** "CO-ING-11-reading-002-v7"

### Enunciado

In the sentence "She has a big breakfast with **her** family", the word "**her**" refers to:
...
El pronombre posesivo "her" se refiere al sujeto de la oración y del texto, que es Maria. Significa "la familia de Maria".

**Competencia evaluada:** Referencia Pronominal
**Componente:** Grammar in Context
...
|----------|-----|------------|----------|
| 1 | CO-ING-11-reading-002-v1 | Medium | 1.0 (Auto) |
| 2 | CO-ING-11-reading-002-v2 | Low | 1.0 (Auto) |
| 3 | CO-ING-11-reading-002-v3 | Low | 1.0 (Auto) |
| 4 | CO-ING-11-reading-002-v4 | Medium | 1.0 (Auto) |
| 5 | CO-ING-11-reading-002-v5 | Medium | 1.0 (Auto) |
| 6 | CO-ING-11-reading-002-v6 | High | 1.0 (Auto) |
