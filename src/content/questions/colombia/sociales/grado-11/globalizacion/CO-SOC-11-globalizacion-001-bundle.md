...
> **Fuente:** Estándares Básicos de Competencias en Ciencias Sociales
...
¿Qué proceso se caracteriza por el aumento de la conexión e intercambio entre personas, empresas y gobiernos de todo el mundo?
...
Esta es la definición básica de **Globalización**: un proceso de creciente interconectividad e interdependencia a nivel mundial en ámbitos económicos, culturales y tecnológicos.
...
Algunos críticos de la globalización argumentan que este proceso puede amenazar la **soberanía** de los países. ¿Cuál argumento respalda mejor esta afirmación?

### Opciones

- [ ] A) La globalización obliga a todos los países a tener el mismo presidente.
- [ ] B) Los países ya no pueden tener ejércitos propios.
- [x] C) Las decisiones de organismos internacionales (FMI, OMC) o empresas multinacionales pueden condicionar las políticas internas de un país.
- [ ] D) La globalización elimina las fronteras físicas en los mapas.

### Explicación Pedagógica

La soberanía se ve "limitada" cuando un Estado debe seguir reglas impuestas por entes externos (FMI, Banco Mundial) para recibir préstamos o comerciar, perdiendo autonomía en sus decisiones de política económica interna.
...
Analice la siguiente situación: "Una empresa multinacional cierra su fábrica en un país desarrollado y la traslada a un país en vía de desarrollo donde los salarios son más bajos y las leyes ambientales más laxas." Este fenómeno se conoce como:

### Opciones

- [ ] A) Desarrollo Sostenible
- [x] B) Deslocalización Industrial (Offshoring)
- [ ] C) Nacionalización
- [ ] D) Economía Circular

### Explicación Pedagógica

La **deslocalización** es una estrategia común en la globalización donde las empresas trasladan procesos productivos a lugares con menores costos operativos. Esto genera empleo (a veces precario) en el destino, pero desempleo en el origen, y plantea dilemas éticos y ambientales.
...
|----------|-----|------------|-------------------|------------|----------|
| 1 | v1 | 4 | Pensamiento sistémico | Poder y Economía | ⬜ |
| 2 | v2 | Low | Pensamiento social | Poder y Economía | ⬜ |
| 3 | v3 | Low | Pensamiento social | Poder y Economía | ⬜ |
| 4 | v4 | Medium | Multiperspectivismo | Poder y Economía | ⬜ |
