...
**ID:** `CO-CIE-11-fisica-001-v2`

### Enunciado

Según la Primera Ley de Newton (Inercia), si la fuerza neta que actúa sobre un objeto es cero, el objeto:

### Opciones

- [ ] A) Debe estar en reposo obligatoriamente.
- [ ] B) Debe moverse con velocidad creciente.
- [ ] C) Se moverá en círculos.
- [x] D) Permanecerá en reposo o se moverá con velocidad constante en línea recta.

### Explicación Pedagógica

La **Ley de Inercia** establece que un cuerpo mantiene su estado de movimiento a menos que una fuerza externa actúe sobre él. Si la fuerza neta es cero, la aceleración es cero, lo que significa velocidad constante (que puede ser cero o diferente de cero).
...
**ID:** `CO-CIE-11-fisica-001-v4`

### Enunciado

Dos objetos, uno de plomo (pesado) y otro de madera (ligero), se dejan caer desde la misma altura en una cámara de vacío (sin aire). ¿Cuál llega primero al suelo?

### Opciones

- [ ] A) El objeto de plomo porque es más pesado.
- [ ] B) El objeto de madera porque tiene menos inercia.
- [x] C) Ambos llegan al mismo tiempo.
- [ ] D) Depende de la forma de los objetos.

### Explicación Pedagógica

En ausencia de resistencia del aire, la única fuerza que actúa es la gravedad.
- Fuerza sobre objeto: $F = mg$
- Segunda Ley: $F = ma \implies mg = ma \implies a = g$
- La masa se cancela; **todos los objetos caen con la misma aceleración** ($g$), independientemente de su masa. Por tanto, recorren la misma distancia en el mismo tiempo.
...
**ID:** `CO-CIE-11-fisica-001-v6`

### Enunciado

Una pelota de 0.5 kg se deja caer desde una altura de 20 metros. Despreciando la resistencia del aire y asumiendo $g = 10 \text{ m/s}^2$, ¿cuál es su energía cinética justo antes de tocar el suelo?
...
Utilizamos el principio de **Conservación de la Energía Mecánica**:
- Energía inicial (punto más alto): Solo Potencial ($E_p = mgh$). $v=0 \implies E_c=0$.
- Energía final (suelo): Solo Cinética ($E_c$). $h=0 \implies E_p=0$.
- $E_{inicial} = E_{final} \implies mgh = E_{c\_final}$

Cálculo:
$E_c = (0.5 \text{ kg})(10 \text{ m/s}^2)(20 \text{ m})$
$E_c = 0.5 \times 200 = 100 \text{ Joules}$
...
|----------|-----|------------|-------------------|------------|----------|
| 1 | CO-CIE-11-fisica-001-v1 | Medium | Explicación | Mecánica | ⬜ |
| 2 | CO-CIE-11-fisica-001-v2 | Low | Uso comprensivo | Mecánica | ⬜ |
| 3 | CO-CIE-11-fisica-001-v3 | Low | Explicación | Mecánica | ⬜ |
| 4 | CO-CIE-11-fisica-001-v4 | Medium | Explicación | Mecánica | ⬜ |
