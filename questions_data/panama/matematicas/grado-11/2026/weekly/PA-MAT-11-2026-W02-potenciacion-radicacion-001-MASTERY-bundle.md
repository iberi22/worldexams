---
id: "PA-MAT-11-2026-W02-potenciacion-radicacion-001-MASTERY-bundle"
country: "panama"
grado: 11
...
### Enunciado
¿Cuál es el resultado de simplificar la expresión $x^5 \cdot x^3$?
...
Identificación y aplicación de la ley de producto de potencias con la misma base en el campo de los números reales.
...
### Explicacion Pedagogica
Comprensión de la ley de potencia de una potencia y su aplicación en el cálculo de áreas geométricas.
...
### Enunciado
¿A qué es equivalente la expresión $5^{-2}$?
...
### Enunciado
¿Cuál es la representación en forma de potencia con exponente fraccionario de la raíz quinta de $x^3$?
...
### Enunciado
Si la población inicial es de $3^2$ bacterias, ¿cuántas habrá después de 4 horas? Exprese el resultado como una potencia de 3.
...
### Enunciado
Simplifica la expresión $\frac{(a^2 b^3)^2}{a^3 b^4}$.
...
### Explicacion Pedagogica
Ejecución de operaciones combinadas con potencias, incluyendo potencia de un producto y cociente de potencias.
...
### Enunciado
Simplifica el radical $\sqrt{72}$ a su forma más sencilla $a\sqrt{b}$.
...
### Enunciado
¿Cuál es el valor numérico de la expresión $27^{2/3}$?
...
### Explicacion Pedagogica
Aplicación de la técnica de racionalización de denominadores con raíces cuadradas simples.
...
### Enunciado
Simplifica la expresión: $\sqrt{20} + \sqrt{45}$.

### Opciones
- [ ] A) $\sqrt{65}$ <!-- feedback: Incorrecto. Los radicales no se pueden sumar sumando sus radicandos directamente. -->
- [x] B) $5\sqrt{5}$ <!-- feedback: Correcto. 2*sqrt(5) + 3*sqrt(5) = 5*sqrt(5) tras simplificar cada término individualmente. -->
- [ ] C) 13 <!-- feedback: Incorrecto. Error de cálculo; los radicales simplificados no producen un número entero exacto. -->
- [ ] D) $5\sqrt{10}$ <!-- feedback: Incorrecto. Error al simplificar los términos o al operar con los índices de las raíces. -->

### Explicacion Pedagogica
Adición de radicales semejantes mediante su simplificación previa a una base común.
...
### Enunciado
Simplifica y expresa con exponentes positivos: $\left(\frac{x^2 y^{-3}}{z^{-1}}\right)^{-2}$.
...
### Enunciado
¿Cuál es el factor por el que se debe multiplicar el numerador y denominador para racionalizar $\frac{1}{\sqrt[3]{2}}$?
...
### Explicacion Pedagogica
Comprensión del proceso de racionalización para raíces de índice superior a 2.
...
### Enunciado
Calcula el producto y simplifica: $\sqrt{3x} \cdot \sqrt[3]{3x}$.
...
### Enunciado
Simplifica la expresión $\sqrt[3]{\sqrt{64x^{12}}}$.
...
### Explicacion Pedagogica
Simplificación de radicales anidados (raíz de una raíz) y aplicación de leyes de exponentes sobre variables.
...
### Explicacion Pedagogica
Análisis de las propiedades de los radicales con índices pares e impares y su relación con el valor absoluto.
...
### Enunciado
Si un monto final es $M = C \cdot e^{rt}$, ¿cuál es la expresión correcta para despejar el tiempo $t$?
...
### Explicacion Pedagogica
Evaluación de la capacidad para manipular ecuaciones exponenciales y comprender la naturaleza inversa de sus operaciones.
...
### Explicacion Pedagogica
Simplificación de expresiones con radicales de índice variable n y potencias dependientes de dicho índice.
...
### Enunciado
Resuelve para $x$ la ecuación: $2^{x+2} + 2^x = 20$.
...
### Explicacion Pedagogica
Ejecución de operaciones fraccionarias complejas con radicales, involucrando productos notables y racionalización.
