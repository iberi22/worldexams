---
id: "BO-MAT-11-2026-W08-tema-w08-001-MASTERY-bundle"
country: "bolivia"
grado: 11
...
### Enunciado
¿Cuál es el conjunto solución de la inecuación lineal básica 2x + 6 < 14?

### Opciones
- [x] A) x < 4 <!-- feedback: ¡Correcto! Restando 6 de ambos lados se tiene 2x < 8, y dividiendo por 2 resulta x < 4. -->
- [ ] B) x > 4 <!-- feedback: Incorrecto. No hay coeficientes negativos, por lo que no se debe invertir el signo de desigualdad. -->
- [ ] C) x < 10 <!-- feedback: Incorrecto. Realizaste operaciones aritméticas erróneas con los sumandos. -->
- [ ] D) x <= 4 <!-- feedback: Incorrecto. La desigualdad es estricta (<), por lo que no debe incluir el signo de igualdad. -->
...
### Enunciado
Resuelva la inecuación lineal con coeficientes fraccionarios: -5x + 20 < 5. ¿Cuál es la solución?

### Opciones
- [x] A) x > 3 <!-- feedback: ¡Correcto! Al dividir por el término negativo se invierte el sentido de la desigualdad. -->
- [ ] B) x < 3 <!-- feedback: Incorrecto. Olvidaste invertir la desigualdad al dividir entre el término negativo de la variable. -->
- [ ] C) x > 5 <!-- feedback: Incorrecto. Error al realizar la división aritmética de las constantes. -->
- [ ] D) No tiene solución real <!-- feedback: Incorrecto. Toda inecuación lineal posee solución real en un intervalo. -->
...
### Enunciado
Resuelva la inecuación lineal con coeficientes fraccionarios: -14x + 56 < 14. ¿Cuál es la solución?

### Opciones
- [x] A) x > 3 <!-- feedback: ¡Correcto! Al dividir por el término negativo se invierte el sentido de la desigualdad. -->
- [ ] B) x < 3 <!-- feedback: Incorrecto. Olvidaste invertir la desigualdad al dividir entre el término negativo de la variable. -->
- [ ] C) x > 14 <!-- feedback: Incorrecto. Error al realizar la división aritmética de las constantes. -->
- [ ] D) No tiene solución real <!-- feedback: Incorrecto. Toda inecuación lineal posee solución real en un intervalo. -->
...
### Enunciado
Resuelva la inecuación lineal con coeficientes fraccionarios: -16x + 64 < 16. ¿Cuál es la solución?

### Opciones
- [x] A) x > 3 <!-- feedback: ¡Correcto! Al dividir por el término negativo se invierte el sentido de la desigualdad. -->
- [ ] B) x < 3 <!-- feedback: Incorrecto. Olvidaste invertir la desigualdad al dividir entre el término negativo de la variable. -->
- [ ] C) x > 16 <!-- feedback: Incorrecto. Error al realizar la división aritmética de las constantes. -->
- [ ] D) No tiene solución real <!-- feedback: Incorrecto. Toda inecuación lineal posee solución real en un intervalo. -->
