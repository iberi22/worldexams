---
id: "CL-ING-11-2026-W32-global-trade-001-MASTERY-bundle"
country: "chile"
grado: 11
asignatura: "Ingles"
tema: "global-trade"
...
# MASTERY Bundle - Ingles: Global Trade (W32)
...
### Enunciado
The interruption in the supply chain had caused prices to skyrocket before the government intervened.
...
### Enunciado
Fair trade initiatives aim to ensure that producers in developing countries receive an equitable price for their products.
...
### Enunciado
The author concludes that digital trade is transforming the global economy by reducing the cost of cross-border transactions.
...
### Enunciado
Business leaders wish the trade war would end as soon as possible.

### Opciones
- [ ] A) ends <!-- feedback: Incorrect. 'Wish' for future change needs 'would'. -->
- [x] B) would end <!-- feedback: Correct. 'Wish + would' for a desired change in a situation. -->
- [ ] C) ended <!-- feedback: Incorrect. 'Wish + past' for present state desire. -->
- [ ] D) have ended <!-- feedback: Incorrect. Past regret. -->
...
### Enunciado
The report stated that global trade had grown by 5% in the previous year.
...
### Explicacion Pedagogica
'Equitable' correctly identifies the ethical requirement for a trade system that benefits all participants fairly.
