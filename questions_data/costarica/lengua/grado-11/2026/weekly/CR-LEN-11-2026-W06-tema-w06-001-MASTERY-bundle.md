---
id: "CR-LEN-11-2026-W06-tema-w06-001-MASTERY-bundle"
country: "costarica"
grado: 11
asignatura: "lengua"
tema: "tema-w06"
...
# Bundle MASTERY: Géneros Literarios: Narrativa - Grado 11

Este bundle contiene 20 preguntas sobre **géneros literarios: narrativa** para grado 11,
...
El género narrativo se constituye a partir de la mediación de la voz del narrador, encargada de estructurar el relato del acontecer ficticio.
...
### Enunciado
¿Qué rasgo es característico de la novela costumbrista y realista costarricense de principios del siglo XX?
...
### Explicacion Pedagogica
La narrativa costumbrista de autores de la Generación del Olimpo como García Monge o Magón retrata al campesino costarricense y sus costumbres.
...
### Enunciado
¿Qué función cumple la recreación del habla popular costarricense en los diálogos de los personajes de esta literatura?

### Opciones
- [ ] A) Demostrar que los campesinos no sabían leer ni escribir de forma formal.
  <!-- feedback: Incorrecto. El propósito del autor es de representación artística, no una burla de alfabetización. -->
- [x] B) Aportar realismo, color local y autenticidad sociocultural a la caracterización de los personajes del agro costarricense.
  <!-- feedback: Correcto. Recrear el dialecto popular rústico dota de verosimilitud y arraigo nacional a la ficción literaria. -->
- [ ] C) Corregir los errores ortográficos de la población de la provincia conforme a las directrices del MEP.
  <!-- feedback: Incorrecto. La obra es literaria artística, no un manual pedagógico corrector del Ministerio. -->
- [ ] D) Sustituir el uso de la raya de diálogo (—) por el pronombre de tratamiento 'vos' en las oraciones.
  <!-- feedback: Incorrecto. La raya de diálogo sigue usándose formalmente para estructurar el diálogo escrito independientemente de la variante dialectal. -->

### Explicacion Pedagogica
La incorporación de la variante dialectal campesina o rústica en el costumbrismo consolida la verosimilitud y el valor de la obra.
...
### Enunciado
¿Cuál de las siguientes descripciones representa mejor el estilo de la narrativa realista social?
...
### Explicacion Pedagogica
La narrativa de realismo social se caracteriza por el retrato objetivo y crítico de las condiciones de vida de las clases trabajadoras, denunciando injusticias.
...
### Enunciado
¿Qué elemento define al realismo mágico dentro de la narrativa hispanoamericana del siglo XX?
...
### Explicacion Pedagogica
El realismo mágico difumina las fronteras entre lo real y lo fantástico, asimilando lo extraordinario como un componente natural de la cotidianidad de los personajes.
...
### Enunciado
¿Cuál de las siguientes opciones describe el tema principal y el marco de fondo de esta obra cumbre del realismo social costarricense?
...
### Explicacion Pedagogica
La novela de Carlos Luis Fallas es una denuncia militante del imperialismo económico y la miseria obrera en las plantaciones bananeras de Costa Rica de mediados de siglo.
...
### Enunciado
¿Qué técnica de suspenso es eficaz para mantener el interés del lector joven a lo largo del relato narrativo?
...
### Explicacion Pedagogica
El suspenso en la narrativa de misterio se sustenta en la administración de los datos de la trama, estimulando la conjetura del receptor.
...
### Enunciado
¿Qué personaje del folclore tradicional protagoniza la mayoría de estas divertidas historias populares costarricenses?

### Opciones
- [ ] A) El monstruo de la laguna del Volcán Irazú.
  <!-- feedback: Incorrecto. Es un personaje ajeno a los cuentos de Carmen Lyra. -->
- [x] B) Uvieta o el Tío Conejo, quien burla de forma ingeniosa a personajes de mayor tamaño como Tío Coyote o la misma Muerte.
  <!-- feedback: Correcto. Tío Conejo es el arquetipo de la astucia popular campesina en los cuentos tradicionales de Carmen Lyra. -->
- [ ] C) Un caballero español que recorre las llanuras en busca de castillos.
  <!-- feedback: Incorrecto. Es ajeno al folclore costarricense de la tía Panchita. -->
- [ ] D) Un superhéroe moderno que vuela sobre la provincia de Cartago.
  <!-- feedback: Incorrecto. Los cuentos se nutren del folclore tradicional y personajes de animales. -->

### Explicacion Pedagogica
Los cuentos de Carmen Lyra adaptan el folclore popular costarricense, elevando a personajes como Tío Conejo a símbolos del ingenio de los sectores populares.
...
- [ ] D) La descripción de las especies de peces del Golfo de Nicoya.
  <!-- feedback: Incorrecto. Es una novela con enfoque de realismo social urbano, no un manual de biología marina. -->

### Explicacion Pedagogica
La obra de Fernando Contreras Castro es una de carácter ecológico y social sobre el consumismo, la exclusión y la dignidad humana en los márgenes de la sociedad.
...
### Enunciado
¿Cuál es una diferencia formal que caracteriza al cuento frente al género de la novela?

### Opciones
- [ ] A) El cuento es siempre de autoría anónima, mientras que la novela posee firma de la provincia.
  <!-- feedback: Incorrecto. Ambos géneros tienen autores individuales identificados de forma libre. -->
- [x] B) El cuento posee una extensión breve, se concentra en un único conflicto dramático de intensidad alta y tiene pocos personajes, mientras que la novela despliega tramas complejas.
  <!-- feedback: Correcto. Describe con precisión las propiedades de brevedad del cuento frente a la novela. -->
- [ ] C) El cuento se escribe en versos rimados y la novela en prosa descriptiva.
  <!-- feedback: Incorrecto. Ambos géneros se escriben de forma convencional en prosa descriptiva literaria. -->
- [ ] D) El cuento carece de un desenlace lógico debido a la prisa de la provincia.
  <!-- feedback: Incorrecto. El cuento posee desenlaces de gran impacto estético. -->

### Explicacion Pedagogica
El cuento destaca por la concentración de sus recursos estéticos en un único núcleo de tensión dramática, logrando un efecto de intensidad.
...
### Explicacion Pedagogica
La geografía literaria en la novela social contemporánea de Costa Rica plasma la brecha social, oponiendo el residuo urbano marginal frente al consumo capitalino.
...
### Enunciado
¿Cuál es el propósito del costumbrismo en este pasaje?
...
### Explicacion Pedagogica
El costumbrismo costarricense valida la identidad campesina dándole espacio literario a sus giros lingüísticos, costumbres laborales y paisajes regionales.
...
### Enunciado
¿Qué contradicción de la sociedad agraria costarricense expone el desenlace trágico de esta novela?
...
### Explicacion Pedagogica
El desenlace de 'El Moto' rompe con el idilio costumbrista bucólico y denuncia las estructuras patriarcales de la época.
...
- [ ] D) Exige la creación de nuevas oficinas en la provincia de Puntarenas.
  <!-- feedback: Incorrecto. Es una crítica de comportamiento, ajena a reformas del colegio. -->

### Explicacion Pedagogica
La ironía consiste en dar a entender lo contrario de lo que se dice explícitamente, o en asociar conceptos contradictorios para satirizar de forma lúdica.
...
### Enunciado
¿Qué valor humano, ético e intercultural aporta el análisis de esta temática en las aulas de undécimo año de Costa Rica?
...
### Explicacion Pedagogica
El análisis literario de problemáticas marginales o migratorias humaniza la educación, convirtiendo la lectura en un taller de reflexión ética e intercultural.
...
### Enunciado
Al evaluar la consistencia estética y la coherencia de género de este desenlace, ¿cuál es el dictamen crítico más acertado?

### Opciones
- [ ] A) Es una muestra de que el autor posee un gran manejo de la historia de la provincia.
  <!-- feedback: Incorrecto. Esta resolución destruye la seriedad del realismo social e invalida la denuncia planteada con un recurso de fantasía infantil ajeno. -->
- [x] B) Constituye una ruptura de las convenciones del realismo social, de carácter facilista del tipo 'deus ex machina' que invalida la denuncia de las condiciones de vida del obrero.
  <!-- feedback: Correcto. El realismo social exige resoluciones lógicas de la sociedad, no salvaciones mágicas inverosímiles. -->
- [ ] C) Es una muestra de que el estudiante no estudió las normas del Ministerio.
  <!-- feedback: Incorrecto. Es un fallo de técnica de estructura dramática de género literario, no un error de ortografía elemental. -->
- [ ] D) La resolución es sumamente viable en Costa Rica puesto que los bancos regalan dinero cotidianamente.
  <!-- feedback: Incorrecto. Es una fantasía ajena a la dura realidad laboral y económica de la provincia. -->

### Explicacion Pedagogica
La coherencia de género literario exige respetar el marco de verosimilitud construido. El realismo social pierde su fuerza de denuncia si recurre a resoluciones mágicas.
...
- [ ] D) La redacción del fragmento utilizando rimas de la provincia.
  <!-- feedback: Incorrecto. La prosa especulativa de ciencia ficción no requiere rimar para sostener su coherencia interna. -->

### Explicacion Pedagogica
La verosimilitud de la ciencia ficción especulativa reposa en la coherencia de sus hipótesis tecnológicas desarrolladas de forma lógica sobre un sustrato real.
...
### Enunciado
¿Qué valor aporta el contraste de posturas expresado en el diálogo para el sentido de la obra?
...
### Explicacion Pedagogica
El diálogo condensa las tensiones de clase o regionales de un país, devaluando el suspenso superficial frente al conflicto realista del desamparo ambiental.
...
### Enunciado
¿Cuál fue el aporte literario de esta generación conformada por Carmen Lyra, Carlos Luis Fallas, Fabián Dobles y Joaquín Gutiérrez?

### Opciones
- [ ] A) La traducción del latín clásico de obras teatrales en la provincia.
  <!-- feedback: Incorrecto. Esta generación se abocó a temáticas nacionales realistas, no a traducciones medievales europeas. -->
- [x] B) El desarrollo de una narrativa de fuerte denuncia social, que retrató de forma realista los conflictos agrarios, las plantaciones bananeras del Caribe y la vida de los desposeídos.
  <!-- feedback: Correcto. La Generación de los Cuarenta marcó la cumbre del realismo de denuncia social e identitaria en Costa Rica. -->
- [ ] C) La introducción de temas de fantasía espacial en San José.
  <!-- feedback: Incorrecto. Su narrativa es estrictamente realista de corte humano social, alejada de la fantasía espacial futurista. -->
- [ ] D) La abolición del cuento obligando al uso de la lírica de la provincia.
  <!-- feedback: Incorrecto. Esta generación destacó tanto en la novela como en el cuento de corte realista. -->

### Explicacion Pedagogica
La Generación del Cuarenta dotó a la literatura nacional de un marcado compromiso ético, de denuncia obrera y agraria frente al costumbrismo bucólico e idílico anterior.
...
### Enunciado
¿Cómo se denomina técnicamente a la novela que narra hechos de trascendencia histórica, pero reconstruidos artísticamente a través de la ficción y personajes literarios?

### Opciones
- [ ] A) Novela de ciencia ficción de la provincia.
  <!-- feedback: Incorrecto. La ciencia ficción Recrea hipótesis futuristas de tecnología espacial, no hechos reales del pasado. -->
- [x] B) Novela histórica.
  <!-- feedback: Correcto. El género de la novela histórica funde la documentación real de acontecimientos del pasado nacional o mundial con el tejido ficcional de la creación artística. -->
- [ ] C) Novela policíaca clásica.
  <!-- feedback: Incorrecto. La novela policíaca gira en torno a la resolución lógica de un crimen o delito mediante un detective. -->
- [ ] D) Novela epistolar en verso.
  <!-- feedback: Incorrecto. Se estructura mediante correspondencia epistolar (cartas), no de hechos reales históricos. -->

### Explicacion Pedagogica
La novela histórica es un subgenernero narrativo que utiliza la investigación histórica real de un país como marco y andamiaje para la creación de tramas artísticas ficcionales.
