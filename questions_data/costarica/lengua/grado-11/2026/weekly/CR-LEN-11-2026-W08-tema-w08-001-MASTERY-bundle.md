---
id: "CR-LEN-11-2026-W08-tema-w08-001-MASTERY-bundle"
country: "costarica"
grado: 11
asignatura: "lengua"
tema: "tema-w08"
...
# Bundle MASTERY: Géneros Literarios: Drama - Grado 11

Este bundle contiene 20 preguntas sobre **géneros literarios: drama** para grado 11,
...
### Enunciado
¿Cuál de las siguientes características define formalmente al género dramático frente a los demás géneros literarios?

### Opciones
- [x] A) La ausencia de un narrador como intermediario principal y el desarrollo de la trama mediante los diálogos directos de los personajes, concebidos para la representación escénica.
  <!-- feedback: Correcto. El drama se caracteriza por la acción directa y dialógica de los personajes en escena, sin narrador. -->
- [ ] B) La preeminencia de la voz íntima del yo lírico expresando sentimientos mediante versos rimados.
  <!-- feedback: Incorrecto. Esto caracteriza al género lírico, no al dramático. -->
- [ ] C) La recopilación de datos objetivos explicados en tercera persona gramatical.
  <!-- feedback: Incorrecto. Esto define a los textos expositivos de divulgación técnica o científica. -->
- [ ] D) La redacción de un diario íntimo sobre las cosechas de café en Cartago.
  <!-- feedback: Incorrecto. Esto corresponde al género narrativo o de correspondencia personal. -->

### Explicacion Pedagogica
El género dramático o teatral se caracteriza por la inmediatez de la acción representada por los actores, sirviéndose del diálogo, el lenguaje gestual y las acotaciones.
...
### Explicacion Pedagogica
Las acotaciones constituyen el discurso secundario del texto dramático, proveyendo las directrices del autor sobre la puesta en escena.
...
### Enunciado
¿Cómo se denomina técnicamente a cada una de las divisiones mayores de una obra dramática, marcadas convencionalmente por la caída del telón?
...
### Explicacion Pedagogica
El acto representa las grandes etapas lógicas del conflicto dramático (planteamiento, nudo, desenlace), señalando su transición mediante el telón o el oscurecimiento.
...
### Explicacion Pedagogica
La estructura del libreto dramático asigna las intervenciones antecediendo el parlamento con el nombre del personaje, garantizando la fluidez de lectura del actor.
...
### Enunciado
¿Cuál de las siguientes situaciones representa el uso de un 'aparte' en escena?
...
### Explicacion Pedagogica
El aparte es un recurso dramático dialógico que rompe la ilusión de aislamiento de la escena, estrechando complicidad con el espectador.
...
- [ ] D) Coloquio costumbrista rústico.
  <!-- feedback: Incorrecto. El coloquio es una conversación entre dos o más interlocutores reales del campo costarricense. -->

### Explicacion Pedagogica
El monólogo o soliloquio es la herramienta dramática idónea para la introspección reflexiva, donde la soledad del personaje en escena justifica la verbalización de sus pensamientos.
...
### Enunciado
¿Cuál de las siguientes opciones representa de mejor manera esta acotación técnica dentro del libreto dramático?
...
### Explicacion Pedagogica
Las acotaciones proporcionan pautas operativas precisas para que el actor traduzca corporal, visual y gestualmente las emociones del personaje en el escenario.
...
### Enunciado
¿Cuál es el fin catártico primordial de la tragedia de acuerdo con la teoría clásica dramática?
...
### Explicacion Pedagogica
La catarsis trágica persigue purificar el alma del espectador mediante la confrontación estética del dolor humano, el destino ineludible y el sufrimiento del héroe.
...
### Enunciado
¿Cuál de las siguientes características define al género dramático de la comedia?

### Opciones
- [ ] A) La presencia de héroes de la nobleza costarricense que mueren inevitablemente por el destino.
  <!-- feedback: Incorrecto. Esto caracteriza a la tragedia clásica solemne, no a la comedia. -->
- [x] B) El retrato humorístico de personajes comunes enfrentados a enredos o vicios cotidianos, con un desarrollo ligero y un desenlace feliz o moralizante.
  <!-- feedback: Correcto. La comedia busca divertir mostrando los defectos humanos comunes con un desenlace favorable. -->
- [ ] C) La redacción de extensos párrafos descriptivos topográficos sin diálogos entre actores.
  <!-- feedback: Incorrecto. El teatro requiere diálogos; la comedia prescinde de monótonos párrafos de descripción física espacial. -->
- [ ] D) La ausencia total de actores costarricenses en el escenario del teatro.
  <!-- feedback: Incorrecto. El teatro se materializa mediante la actuación física real de actores en escena. -->

### Explicacion Pedagogica
La comedia es un género teatral que fustiga los vicios y ridiculeces sociales mediante la risa, el enredo y la crítica satírica de personajes comunes de la sociedad.
...
### Enunciado
¿Qué elemento marca convencionalmente la transición de una 'escena' a otra dentro del libreto dramático?
...
### Explicacion Pedagogica
La escena es la subdivisión menor del acto teatral, delimitada por la dinámica interactiva de ingreso o egreso de los actores en el espacio de representación.
...
### Explicacion Pedagogica
La contradicción dramática entre el decir público de autoridad y el sentir íntimo confidencial del aparte enriquece la densidad moral del personaje teatral.
...
- [ ] D) Explicar detalladamente el precio en colones de las carretas de transporte de Cartago.
  <!-- feedback: Incorrecto. El mensajero relata la muerte del héroe y la catástrofe familiar, ajeno a variables mercantiles financieras. -->

### Explicacion Pedagogica
El mensajero en el género dramático es un recurso de mediación narrativa indispensable para introducir acontecimientos violentos o distantes sin romper las limitaciones físicas del escenario.
...
### Enunciado
¿Cómo opera la comicidad física y el contraste social en esta escena teatral?
...
### Explicacion Pedagogica
La comedia se vale de recursos físicos y de contraste social para desacreditar la vanidad de los poderosos, logrando una catarsis colectiva a través de la risa.
...
### Enunciado
¿Cómo contribuyen los elementos escenográficos y acústicos indicados al sentido de la acción dramática?

### Opciones
- [x] A) Configuran una atmósfera de inmensa tensión, peligro y soledad heroica, preparando de forma psicológica al espectador para el momento trascendental del sacrificio del personaje.
  <!-- feedback: Correcto. La iluminación focalizada, la penumbra y los tambores de guerra acentúan el suspenso y la inminencia del hito heroico del tambor de Rivas. -->
- [ ] B) Indican que el Teatro Nacional posee fallas de conexión eléctrica en el sistema de luces del escenario central.
  <!-- feedback: Incorrecto. Son indicaciones artísticas de diseño de luces del libreto, no reportes de fallas técnicas o cortocircuitos reales del teatro. -->
- [ ] C) Anuncian que la antorcha fue fabricada con plástico inflamable de contrabando.
  <!-- feedback: Incorrecto. No hay menciones comerciales o de contrabando; la antorcha es un objeto simbólico e histórico nacional real. -->
- [ ] D) Exigen al MEP que se suspenda de inmediato el acto cívico escolar en Alajuela por exceso de ruido.
  <!-- feedback: Incorrecto. Es una indicación de efectos de sonido del libreto de teatro, no una alerta de contaminación acústica escolar. -->

### Explicacion Pedagogica
Los recursos no verbales de la puesta en escena (iluminación, efectos acústicos, utilería) son signos de gran valor expresivo que multiplican la densidad dramática del texto escrito.
...
### Enunciado
Al valorar el cumplimiento de las propiedades elementales del género dramático y el impacto estético de esta propuesta vanguardista, ¿cuál es el dictamen crítico más acertado?
...
### Explicacion Pedagogica
Aunque la experimentación de vanguardia desafía los límites del arte, privar al teatro de sus componentes elementales de acción, habla y expresión corporal dificulta severamente la transmisión dramática de sentido.
...
### Enunciado
Al evaluar la consistencia retórica del parlamento de Sofía, ¿cuál es la principal flaqueza estilística del texto?

### Opciones
- [ ] A) El uso de la personificación referida a los funcionarios de San José.
  <!-- feedback: Incorrecto. Calificarlos de robots es un tropo de deshumanización legítimo en el drama urbano. -->
- [x] B) La redundancia léxica vacía y repetitiva ('robots de oficina', 'robots de robots de papel') que empobrece la carga lírica y la fuerza dramática del parlamento.
  <!-- feedback: Correcto. La repetición circular de 'robots' e 'oficina' de forma burda resta elegancia literaria a la queja dramática del personaje. -->
- [ ] C) La falta de inclusión del precio exacto en colones del papel de oficina en Costa Rica.
  <!-- feedback: Incorrecto. Los libretos de teatro artístico no requieren detalles contables de insumos de papelería. -->
- [ ] D) Que la escena se sitúa en San José excluyendo a la provincia de Puntarenas.
  <!-- feedback: Incorrecto. El marco geográfico de la obra es decisión libre del autor y no constituye una falla de redacción. -->

### Explicacion Pedagogica
Los parlamentos dramáticos sólidos evitan repeticiones redundantes viciosas de vocablos, prefiriendo la fuerza expresiva, metáforas bien delineadas y variedad léxica.
...
### Enunciado
¿Qué error técnico de coherencia cronológica e histórica demerita gravemente la solidez literaria del fragmento anterior?
...
### Explicacion Pedagogica
La narrativa y el drama de temática histórica exigen un riguroso respeto al contexto científico, técnico y cultural de la época que pretenden recrear de forma fidedigna.
...
### Enunciado
¿Qué valor ético e intercultural promueve el teatro social al escenificar las luchas cotidianas de los peones del agro en las tablas nacionales?
...
### Explicacion Pedagogica
El teatro social contemporáneo cumple una alta función pedagógica de concienciación ética, promoviendo la empatía, los valores democráticos y la justicia social en las aulas costarricenses.
...
### Enunciado
¿A qué se refiere este término en la progresión de la acción teatral?
...
### Explicacion Pedagogica
El clímax es el nudo de tensión límite de la obra de teatro, donde las fuerzas dramáticas del protagonista y del antagonista chocan de forma inevitable y decisiva.
...
### Enunciado
¿Cómo se denomina técnicamente al grupo de actores que interviene de forma colectiva en la tragedia clásica, actuando como la voz de la conciencia social, de los dioses o del pueblo, comentando los sucesos de la trama en el escenario?

### Opciones
- [ ] A) Los antagonistas individuales de la provincia.
  <!-- feedback: Incorrecto. El antagonista individual es un personaje único de oposición dramática directa contra el héroe. -->
- [x] B) El coro.
  <!-- feedback: Correcto. El coro es el personaje colectivo de la tragedia clásica que reflexiona sobre el destino, la moral y aconseja a los protagonistas. -->
- [ ] C) El director técnico del Teatro Nacional de San José.
  <!-- feedback: Incorrecto. El director técnico coordina aspectos escenográficos prácticos detrás del escenario, no actúa. -->
- [ ] D) Los tramoyistas encargados de mover las maderas de adobes.
  <!-- feedback: Incorrecto. Son trabajadores técnicos esenciales del teatro, pero no forman parte del elenco de personajes del libreto. -->

### Explicacion Pedagogica
El coro es el componente lírico y colectivo emblemático del teatro clásico que aporta un contrapeso moral y filosófico a las decisiones trágicas de los protagonistas.
