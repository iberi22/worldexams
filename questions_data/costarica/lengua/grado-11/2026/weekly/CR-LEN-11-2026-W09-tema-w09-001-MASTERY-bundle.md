---
id: "CR-LEN-11-2026-W09-tema-w09-001-MASTERY-bundle"
country: "costarica"
grado: 11
asignatura: "lengua"
tema: "tema-w09"
...
# Bundle MASTERY: Análisis de Textos Literarios - Grado 11

Este bundle contiene 20 preguntas sobre **análisis de textos literarios** para grado 11,
...
- [ ] D) A la traducción del texto literario al dialecto bribri o cabécar de Costa Rica.
  <!-- feedback: Incorrecto. La traducción es un proceso lingüístico posterior, no el contexto de producción. -->

### Explicacion Pedagogica
El análisis sociocultural examina de qué manera el contexto real de una sociedad (como la Costa Rica cafetalera o bananera) influye en las preocupaciones de la obra literaria.
...
### Enunciado
¿De qué manera el contexto de recepción puede diferir del de producción al leer esta obra hoy en San José?
...
### Explicacion Pedagogica
La recepción literaria es un proceso dinámico donde el horizonte de expectativas de la época del lector resignifica los mensajes del pasado.
...
### Enunciado
¿Cómo influyen los acontecimientos políticos del país de los años cuarenta (reformas sociales, auge sindical) en la producción de esta novela?
...
### Explicacion Pedagogica
La narrativa de la Generación del 40 en Costa Rica mantiene una vinculación indisociable con los movimientos obreros y las reformas de la época.
...
### Explicacion Pedagogica
La intertextualidad literaria examina los hilos invisibles de correspondencia temática, mítica o formal que vinculan la obra en estudio con la biblioteca universal.
...
- [ ] D) Un caballero español con armadura que busca bueyes perdidos en Heredia.
  <!-- feedback: Incorrecto. Es una figura de fantasía que no posee vinculación con las leyendas de control de conducta moral campesina tradicionales costarricenses. -->

### Explicacion Pedagogica
Las leyendas tradicionales costarricenses como la Segua cumplían una de control social e infundir pánico sobre las conductas consideradas pecaminosas.
...
### Enunciado
¿Qué valor cívico promueve la exaltación lírica de los símbolos nacionales en la literatura de la posguerra costarricense?
...
### Explicacion Pedagogica
La lírica nacional y de exaltación cívica ha sido históricamente una herramienta indispensable en las escuelas de Costa Rica para modelar la identidad nacional y el respeto institucional.
...
### Enunciado
¿Qué dimensión del análisis textual examina las relaciones de explotación del peón frente al patrono de la finca de Cartago?
...
### Explicacion Pedagogica
La dimensión sociocrítica analiza de qué forma las contradicciones de clase, la explotación y la lucha laboral de un país se proyectan artísticamente en el texto literario.
...
### Enunciado
¿Qué rol asume el espectador actual de secundaria ante una puesta en escena con hondo calado ético-social en San José?
...
### Explicacion Pedagogica
El teatro social costarricense contemporáneo educa moralmente al estudiantado de undécimo año, transformando al espectador pasivo en un agente de cambio cívico contra la violencia.
...
### Enunciado
¿A qué se refiere este término técnico en el análisis literario formal?

### Opciones
- [ ] A) Al precio en colones que se pagó al autor por publicar su manuscrito.
  <!-- feedback: Incorrecto. Es un componente económico mercantil, no un recurso interno formal del texto literario. -->
- [x] B) A un elemento temático constante, idea o situación recurrente que se repite a lo largo de una obra o de la literatura universal (como el viaje del héroe o la muerte).
  <!-- feedback: Correcto. El motivo literario guía la progresión temática del texto y es reconocible formalmente en el análisis. -->
- [ ] C) A la firma de las portadas de los manuales del MEP.
  <!-- feedback: Incorrecto. Es un formalismo administrativo, ajeno a la teoría de análisis literario. -->
- [ ] D) A la biografía del director de teatro de Heredia de la asamblea.
  <!-- feedback: Incorrecto. La biografía es externa a las estructuras dramáticas de la obra. -->

### Explicacion Pedagogica
El motivo literario es una idea o símbolo recurrente de la herencia cultural que dota de andamiaje conceptual y unidad semántica al relato.
...
### Enunciado
¿Cuál fue el rol ideológico primordial de esta generación de escritores que incluyó a Magón y a Aquileo J. Echeverría?

### Opciones
- [ ] A) La importación de novelas de ciencia ficción espacial europea en San José.
  <!-- feedback: Incorrecto. Se enfocaron en el agro costarricense, no en ciencia ficción futurista. -->
- [x] B) Fomentar la construcción de la identidad nacional a través del retrato del campesinado del Valle Central, aunque idealizando la vida del campo frente a las crisis de la modernidad.
  <!-- feedback: Correcto. La Generación del Olimpo cimentó las bases del costumbrismo y la imagen mítica idílica de la Costa Rica pacífica, trabajadora e igualitaria. -->
- [ ] C) La abolición del uso de la lengua española en todos los colegios de Costa Rica.
  <!-- feedback: Incorrecto. Al contrario, registraron y dignificaron la variante de la lengua española rural nacional en la creación escrita. -->
- [ ] D) Exigir que todas las novelas fuesen impresas en papel de adobes de la provincia de Alajuela.
  <!-- feedback: Incorrecto. Es una variable comercial sin valor literario de la generación. -->

### Explicacion Pedagogica
La Generación del Olimpo jugó un papel fundacional en la invención de la identidad de Costa Rica, eligiendo al labriego sencillo como el arquetipo cívico nacional.
...
- [ ] D) Que la literatura de Costa Rica del siglo pasado fue escrita enteramente por autores extranjeros.
  <!-- feedback: Incorrecto. Se exalta la literatura nacional de Magón como muestra genuina de identidad costarricense. -->

### Explicacion Pedagogica
El análisis de los discursos populares en el costumbrismo costarricense trasciende lo folclórico, descubriendo el valor de dignidad campesina.
...
- [ ] D) La biografía detallada de los editores del poemario impreso en Cartago.
  <!-- feedback: Incorrecto. Corresponde a variables externas de la publicación, no a su dimensión interpretativa. -->

### Explicacion Pedagogica
La lírica de Jorge Debravo constituye un hito literario por su alta vocación humana, de denuncia de las desigualdades del agro costarricense.
...
### Enunciado
¿Qué tipo de lectura crítica fundamenta esta interpretación del folclore nacional?
...
### Explicacion Pedagogica
Los cuentos populares recopilados y adaptados por Carmen Lyra encierran alegorías de resistencia popular, valiéndose de la astucia de los pequeños para burlar al poderoso.
...
### Explicacion Pedagogica
La geografía literaria de la novela de Fernando Contreras dota al espacio de un hondo simbolismo, convirtiendo al basurero en un de reflexión sobre la sociedad de consumo.
...
### Enunciado
Al evaluar la consistencia realista de este desenlace en una novela de corte crítico social, ¿cuál es el dictamen más fundado del jurado literario?
...
### Explicacion Pedagogica
Un relato realista sólido debe guardar coherencia con sus premisas. Resolver un drama con un golpe de fortuna de fantasía demerita el rigor crítico de la obra.
...
### Enunciado
¿Qué valor interpretativo aporta esta postura crítica sobre el costumbrismo tradicional del país?

### Opciones
- [ ] A) Promueve el odio contra las tradiciones de la carreta típica de Cartago.
  <!-- feedback: Incorrecto. Cuestiona la idealización literaria folclórica, no busca promover odios contra las tradiciones de carretas. -->
- [x] B) Desmitifica la visión idílica del campo costarricense de la Generación del Olimpo, invitando a una lectura más madura, analítica e histórica sobre la realidad social del país.
  <!-- feedback: Correcto. Invita a analizar las desigualdades y conflictos de clase reales detrás de la aparente paz de las obras costumbristas. -->
- [ ] C) Exige la abolición del uso de adobes en la construcción de viviendas por mandato del MEP.
  <!-- feedback: Incorrecto. No trata sobre de adobes; analiza tópicos de idealización literaria campesina. -->
- [ ] D) Obliga a que todos los poetas escriban sonetos de catorce sílabas para las asambleas.
  <!-- feedback: Incorrecto. Es un análisis literario de narrativa y costumbrismo, libre de imposiciones de métrica poética. -->

### Explicacion Pedagogica
La deconstrucción crítica de los mitos fundacionales del costumbrismo costarricense educa moralmente en el rigor del análisis histórico y social, enseñando a discernir la ideología de los textos.
...
### Enunciado
Al evaluar la consistencia histórica de este análisis del personaje de Cundila en 'El moto', ¿qué criterio respalda su validez académica?
...
### Explicacion Pedagogica
La validez del análisis literario con enfoque de género se consolida cuando se confronta críticamente el diseño del personaje ficticio con las variables de la época estudiada.
...
### Enunciado
¿Cuál es el principal defecto de consistencia sociolingüística que señala con acierto el crítico?
...
### Explicacion Pedagogica
La verosimilitud dialógica en el drama exige guardar armonía entre la caracterización social del personaje y su idiolecto lingüístico en el escenario.
...
### Enunciado
¿A qué se refiere este concepto de la teoría de la recepción literaria en el análisis de textos?
...
### Explicacion Pedagogica
El horizonte de expectativas conceptualiza de qué manera los lectores de una época dada leen, juzgan e interpretan estéticamente la herencia literaria recibida del pasado.
...
### Enunciado
¿Cómo se denomina técnicamente al análisis de textos que se centra en el estudio minucioso de la estructura formal de las oraciones, el orden de las palabras y las funciones sintácticas?
...
### Explicacion Pedagogica
El análisis sintáctico o de estructura morfosintáctica es el nivel de estudio que describe las relaciones de concordancia, el orden de las palabras y la arquitectura oracional de la lengua española.
