---
id: "PE-COM-11-2026-W12-tema-w12-001-MASTERY-bundle"
country: "peru"
grado: 11
...
creador: "Jules-Agent"
---
# MASTERY Bundle - Comunicación: La Oración Compuesta y Sintaxis (W12)
...
### Enunciado
¿Cuál es la característica gramatical indispensable que define a una oración compuesta frente a una oración simple?
...
- [ ] D) Subordinada adjetiva especificativa.
  <!-- feedback: Incorrecto. Las adjetivas modifican a un sustantivo mediante pronombres relativos como "que" o "cual". -->
...
### Enunciado
"Que las aguas del lago Titicaca sufran por la contaminación preocupa de forma urgente a los comunistas locales".
¿Qué función sintáctica desempeña la proposición subordinada subrayada en negrita: **"Que las aguas del lago Titicaca sufran por la contaminación"**?

### Opciones
- [ ] A) Objeto directo de la oración.
...
### Enunciado
¿Qué tipo de proposición subordinada se encuentra presente en la oración citada y a qué sustantivo modifica?
...
### Enunciado
¿Cuál de las siguientes opciones contiene una oración compuesta subordinada adverbial concesiva que exprese una dificultad que no impide el cumplimiento del verbo principal?
...
### Enunciado
¿Cuál de las siguientes opciones contiene una oración compuesta subordinada adverbial condicional que plantee una hipótesis obligatoria para la realización de la acción principal?
...
### Enunciado
"Se debe prohibir el tránsito pesado por el perímetro de Chan Chan de modo que las vibraciones no sigan resquebrajando los muros de adobe".
...
- [ ] D) Tengo la esperanza de que mi hijo logre ingresar este año a la Universidad del Santa.
  <!-- feedback: Incorrecto. El sustantivo "esperanza" exige complemento preposicional con "de" (esperanza de algo); el uso es normativamente adecuado. -->
...
### Enunciado
Señale cuál de las siguientes oraciones presenta una proposición subordinada sustantiva que funciona como **complemento de régimen prepocisional** (el verbo principal exige obligatoriamente una preposición específica).

### Opciones
- [ ] A) La comunidad exige que se limpie el río contaminado por relaves mineros de forma inmediata.
  <!-- feedback: Incorrecto. El verbo "exigir" es transitivo directo (exigir algo); la subordinada funciona como objeto directo. -->
- [ ] B) Es sumamente urgente que reparen el puente colgante dañado por las intensas lluvias andinas.
  <!-- feedback: Incorrecto. La proposición subordinada sustantiva "que reparen..." funciona como el sujeto de la oración copulativa. -->
- [x] C) Toda la comunidad campesina de Huancavelica confía en que las nuevas autoridades agrarias los apoyarán.
  <!-- feedback: ¡Correcto! El verbo "confiar" rige obligatoriamente la preposición "en" (confiar en algo); la proposición sustantiva es el término de dicha preposición, actuando como complemento de régimen. -->
- [ ] D) Quienes alcancen las metas de producción de papa nativa recibirán un incentivo económico del municipio.
  <!-- feedback: Incorrecto. Es una proposición subordinada adjetiva sustantivada que funciona como sujeto de "recibirán". -->
...
### Enunciado
"Cuando los inspectores de la UNI afirmaron que los laboratorios cumplían con los estándares de seguridad que exige la ley, los estudiantes celebraron la noticia".
Determine el número de proposiciones subordinadas presentes en la oración y su clasificación sintáctica respectiva.

### Opciones
- [ ] A) Dos proposiciones: una subordinada sustantiva de objeto directo y una adverbial concesiva.
  <!-- feedback: Incorrecto. Falta cuantificar la proposición temporal inicial y la adjetiva final. -->
- [x] B) Tres proposiciones: una adverbial temporal ("Cuando los inspectores..."), una sustantiva de objeto directo ("que los laboratorios cumplían...") y una adjetiva modificadora ("que exige la ley").
  <!-- feedback: ¡Correcto! La oración tiene tres verbos subordinados ("afirmaron", "cumplían", "exige") englobados en estructuras que denotan tiempo, complemento de afirmación y especificación de seguridad, respectivamente. -->
- [ ] C) Tres proposiciones: dos adjetivas especificativas y una adverbial condicional de hipótesis.
  <!-- feedback: Incorrecto. No hay ninguna condicional (no aparece el nexo "si") y solo una es adjetiva ("que exige la ley"). -->
- [ ] D) Cuatro proposiciones: dos sustantivas de sujeto, una adverbial final y una coordinada disyuntiva.
  <!-- feedback: Incorrecto. No existen proposiciones coordinadas en la estructura analizada ni nexos disyuntivos como "o". -->
...
I. "Los comuneros de Puno que protestaron pacíficamente recibieron el apoyo de las autoridades locales".
II. "Los comuneros de Puno, que protestaron pacíficamente, recibieron el apoyo de las autoridades locales".
¿Cuál es la diferencia semántica real que se deriva del análisis sintáctico de ambas estructuras?

### Opciones
- [ ] A) En la oración I, todos los comuneros recibieron apoyo; en la oración II, solo algunos lo hicieron de manera violenta.
...
### Enunciado
"César Vallejo escribió *Trilce* en París; José María Arguedas, *Los ríos profundos* en el Perú".
¿Qué fenómeno sintáctico ocurre en la segunda proposición coordinada yuxtapuesta y qué elemento ha sido elidido u omitido?

### Opciones
- [ ] A) Elipsis del objeto directo; se ha omitido la mención explícita al poemario *Trilce*.
  <!-- feedback: Incorrecto. El objeto directo en la segunda parte es "*Los ríos profundos*"; no está elidido. -->
- [ ] B) Elipsis del sujeto; se ha omitido el pronombre "él" que se refiere a César Vallejo.
  <!-- feedback: Incorrecto. El sujeto está expreso: "José María Arguedas". -->
- [x] C) Elipsis verbal; se ha omitido el verbo "escribió", el cual se halla representado ortográficamente por la coma elíptica.
  <!-- feedback: ¡Correcto! La coma colocada tras "Arguedas" sustituye y elide al verbo "escribió" para evitar una redundancia innecesaria, manteniendo perfecta claridad sintáctica. -->
- [ ] D) Solecismo sintáctico; la oración es gramaticalmente incorrecta por carecer de un verbo subordinante.
  <!-- feedback: Incorrecto. Es una elipsis verbal perfectamente válida según la Real Academia Española (RAE). -->
...
### Enunciado
"Los biólogos del Parque Nacional del Manu oyeron cantar a las aves exóticas en el amanecer".
¿Cuál es la interpretación estructural correcta de la frase **"cantar a las aves exóticas"** dentro del marco de la oración compuesta subordinada de infinitivo?
...
### Enunciado
"Si los comuneros de Junín hubieran conocido el impacto destructivo de la plaga, habrían tomado precauciones fitosanitarias inmediatas".
...
### Enunciado
"El estudiante que ingresó a medicina a quien todos felicitaban declaró que el examen de biología fue más difícil de lo que él esperaba".
¿Cuál es la evaluación estructural y sintáctica de esta oración respecto a su legibilidad y corrección gramatical?
...
### Enunciado
"Llovió tanto en las cabeceras de cuenca del río Rímac que las defensas ribereñas colapsaron inevitablemente".
Al evaluar de forma crítica la estructura sintáctica de esta oración compuesta, se dictamina que se trata de:

### Opciones
- [ ] A) Una oración subordinada adverbial causal pura porque explica el porqué del colapso de las defensas.
  <!-- feedback: Incorrecto. Aunque encierra una explicación de fondo, la forma sintáctica se introduce por una correlación consecutiva intensiva. -->
- [ ] B) Una oración coordinada consecutiva ilativa simple e independiente que no depende del adverbio "tanto".
  <!-- feedback: Incorrecto. Sí depende críticamente del cuantificador intensivo "tanto" ubicado en la proposición principal. -->
- [x] C) Una oración subordinada adverbial consecutiva de intensidad (consecutiva correlativa), donde la consecuencia lógica se introduce por la conjunción "que" tras el cuantificador "tanto".
  <!-- feedback: ¡Correcto! Las consecutivas correlativas vinculan el grado extremo de una cualidad, cantidad o intensidad ("tanto...", "tal...", "tan...") con su consecuencia directa e ineludible. -->
- [ ] D) Una oración subordinada adjetiva explicativa que califica al sustantivo propio "Rímac".
  <!-- feedback: Incorrecto. La conjunción "que" aquí no funciona como pronombre relativo; no reemplaza a "Rímac", sino que introduce el resultado de la lluvia extrema. -->

### Explicación Pedagógica
Las oraciones compuestas consecutivas correlativas (o de intensidad) presentan una estructura binaria obligatoria constituida por un elemento intensivo en la proposición principal (tanto, tan, tal) y una conjunción subordinante "que" que encabeza la consecuencia en la proposición subordinada.
