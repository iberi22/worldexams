---
id: "PE-COM-11-2026-W05-tema-w05-001-MASTERY-bundle"
country: "peru"
grado: 11
...
### Enunciado
En la lectura crítica de textos discontinuos (como infografías y gráficos de barras), ¿cuál es la función de los elementos iconográficos o ilustraciones?
...
Los textos discontinuos combinan lenguaje verbal y no verbal. Los componentes visuales (gráficos, mapas, iconos) facilitan la decodificación de datos cuantitativos o procesos complejos.
...
### Explicacion Pedagogica
La bajada o copete cumple una función introductoria en los textos mixtos y discontinuos, sirviendo para orientar cognitivamente al lector antes de abordar los datos complejos del cuerpo.
...
### Enunciado
Considere un gráfico circular que muestra la distribución del empleo en el Perú actual:
- Sector Informal: 75%
- Sector Formal: 25%
¿Cuál de las siguientes afirmaciones se deduce de manera inequívoca a partir de la información visual de este gráfico discontinuo?
...
### Explicacion Pedagogica
La comprensión lectora de gráficos exige realizar equivalencias numéricas precisas (como convertir porcentajes a fracciones: $75\% = 3/4$) y ceñirse estrictamente a los límites de la información provista por el recurso visual.
...
### Enunciado
En la infografía, se presenta una tabla comparativa con datos de altitud, temperatura y rendimiento por hectárea. ¿Cuál es el propósito cognitivo de organizar la información en una estructura de doble entrada en lugar de prosa corrida?

### Opciones
- [ ] A) Aumentar artificialmente el número de palabras del texto explicativo
...
### Explicacion Pedagogica
Las tablas comparativas son recursos lógicos excelentes para sintetizar variables correlativas, optimizando la asimilación de contrastes de datos cuantitativos y cualitativos.
...
### Enunciado
En el mapa, los distritos costeros del sur (Ica, Arequipa, Moquegua) están coloreados en rojo intenso, mientras que los de la selva norte (Loreto) aparecen en amarillo claro. ¿Cómo debe interpretar el lector esta codificación cromática en el plano de la lectura crítica?
...
### Explicacion Pedagogica
Los textos discontinuos geográficos (mapas de calor o de riesgo) utilizan convenciones de escala cromática. El lector crítico debe asociar la intensidad del color con la magnitud de la variable representada (gravedad, densidad, temperatura).
...
### Enunciado
La infografía incluye una ilustración de una balanza equilibrada que contiene quinua en un platillo y kiwicha en el otro. ¿Qué idea conceptual busca transmitir de forma no verbal esta imagen específica?

### Opciones
- [ ] A) Que la quinua tiene un costo de mercado más elevado que la kiwicha en el Cusco
  <!-- feedback: Incorrecto. La balanza mide equilibrio y equivalencia, no valores monetarios de venta minorista. -->
- [ ] B) Que ambos granos andinos deben ser consumidos mezclados en la misma proporción física de peso
  <!-- feedback: Incorrecto. No se refiere a una instrucción de receta de cocina, sino a un juicio de valor nutricional. -->
- [x] C) La equivalencia y el alto valor nutricional semejante que poseen ambos alimentos andinos para la dieta humana
  <!-- feedback: Correcto. La balanza equilibrada simboliza de manera metafórica y visual la paridad o equivalencia de valor (en este caso, de bondades nutricionales y saludables) de ambos granos precolombinos. -->
- [ ] D) La inminente escasez de recursos agrarios en el territorio nacional
  <!-- feedback: Incorrecto. La imagen es de abundancia e identidad alimentaria positiva; no connota hambruna o escasez. -->

### Explicacion Pedagogica
El uso de metáforas visuales (la balanza para denotar equilibrio o igualdad, el escudo para denotar protección) es clave en el diseño de infografías para transmitir conceptos abstractos de forma rápida y recordable.
...
### Enunciado
La tabla muestra las exportaciones peruanas de arándanos (en millones de dólares) durante los años 2020-2023:
- Año 2020: $1000M
- Año 2021: $1200M
- Año 2022: $1400M
- Año 2023: $1350M
¿Qué conclusión analítica sobre la tendencia exportadora de este fruto se deduce de la tabla?
...
### Explicacion Pedagogica
La interpretación de tablas históricas exige identificar las inflexiones o quiebres de tendencia en la serie de datos (en este caso, el paso de crecimiento a contracción en el último año).
...
### Enunciado
En el diagrama de flujo, se presenta un rombo con la pregunta '¿Cumple con el requisito de pobreza extrema del SISFOH?'. Del rombo salen dos flechas:
- Flecha SÍ: Continúa a la etapa de examen nacional de becas.
- Flecha NO: Fin del proceso.
...
### Explicacion Pedagogica
Los diagramas de flujo utilizan figuras geométricas convencionales. El rombo representa una decisión lógica condicional de tipo binario (sí/no), la cual determina de manera excluyente el camino del usuario en el proceso.
...
### Enunciado
Lea el eslogan de un afiche de de vacunación contra el dengue:
'¡Que el dengue no entre a tu casa! Voltea las llantas y limpia tus floreros'.
...
- [ ] D) Denuncia la falta de agua potable en los distritos costeros del norte peruano
  <!-- feedback: Incorrecto. Aunque la falta de agua es un problema real, la imagen del afiche muestra bienestar y limpieza, no es una denuncia visual de escasez. -->

### Explicacion Pedagogica
La retórica visual de los afiches busca movilizar conductas asociando instrucciones prácticas con ideales de salud y bienestar del entorno familiar.
...
### Enunciado
En un folleto corporativo, el texto afirma:
'Nuestra empresa ha reducido a niveles mínimos históricos el consumo de agua dulce para las operaciones'.
Sin embargo, el gráfico de barras adjunto muestra el consumo anual de agua dulce (en metros cúbicos) de la siguiente manera:
- 2021: 100K
- 2022: 120K
- 2023: 150K
¿Cuál es la crítica de coherencia que un lector perspicaz debe formular frente a este texto discontinuo?

### Opciones
- [ ] A) El gráfico carece de etiquetas de colores atractivos para diferenciar los años fiscales
  <!-- feedback: Incorrecto. La estética del gráfico no resuelve la inconsistencia fáctica del mensaje. -->
- [ ] B) La empresa debería consumir más agua dulce para acelerar el desarrollo del país
  <!-- feedback: Incorrecto. Esto es una opinión ideológica de desarrollo, no un análisis de coherencia de la información provista. -->
- [x] C) Existe una contradicción directa entre la afirmación textual de reducción de agua y los datos reales del gráfico, los cuales demuestran un aumento constante del consumo
  <!-- feedback: Correcto. El gráfico revela un incremento del consumo año a año ($100K \rightarrow 120K \rightarrow 150K$), desmintiendo de forma flagrante la afirmación verbal de que el consumo se redujo a mínimos históricos. El lector crítico contrasta ambos elementos para detectar incongruencias o falsedades. -->
- [ ] D) El gráfico demuestra que los ingenieros de la mina carecen de capacitación profesional
  <!-- feedback: Incorrecto. El aumento de consumo no prueba impericia de los ingenieros; puede debersae a mayor producción u otros factores, pero sí invalida la veracidad del texto del folleto. -->

### Explicacion Pedagogica
La lectura crítica de textos mixtos exige confrontar la retórica del mensaje verbal con los datos duros expuestos en los gráficos auxiliares, herramienta indispensable para identificar el sesgo corporativo o la publicidad engañosa (greenwashing).
...
### Enunciado
La infografía presenta un velocímetro coloreado en franjas:
- Verde (Excelente): 0-50 ug/m3 de material particulado.
- Amarillo (Moderado): 51-100 ug/m3.
- Rojo (Crítico): 101-150 ug/m3.
- Morado (Peligro extremo): >150 ug/m3.
Si una medición en la avenida Abancay registra un valor de 125 ug/m3, ¿bajo qué categoría de riesgo de salud califica la zona y qué infiere el lector?

### Opciones
- [ ] A) Califica como Moderado; infiere que se puede realizar deporte al aire libre sin restricciones
...
### Explicacion Pedagogica
La lectura de escalas de medición e indicadores ambientales en textos discontinuos requiere ubicar la cifra en el tramo correspondiente y deducir las implicaciones prácticas o advertencias médicas asociadas a dicho nivel de riesgo.
...
### Enunciado
En la infografía, se presenta un mapa interactivo con círculos de diferentes tamaños sobre las regiones amazónicas. Los círculos representan el número de hablantes de lenguas indígenas (a mayor círculo, más hablantes), y los colores representan la vitalidad:
- Verde: Vital
- Naranja: En peligro
- Rojo: En peligro crítico / pocas personas de edad avanzada
...
- [ ] D) El Ministerio ha prohibido la enseñanza de esa lengua en las escuelas locales
  <!-- feedback: Incorrecto. El semáforo de vitalidad es científico-diagnóstico de vulnerabilidad; no representa prohibiciones oficiales del Estado. -->

### Explicacion Pedagogica
La interpretación analítica de mapas lingüísticos discontinuos exige cruzar dos variables simultáneas (tamaño de la figura para volumen de hablantes, y código cromático para vitalidad/riesgo de preservación) para emitir un diagnóstico sociocultural preciso.
...
### Enunciado
Lea el eslogan de un afiche de la ONG Salvemos las Lomas:
'Las Lomas de Villa María no son canteras de cemento ni lotes de vivienda: son el pulmón verde de Lima Sur. ¡Defiéndelas de la especulación!'
...
### Explicacion Pedagogica
El destinatario ideal de un texto persuasivo mixto se infiere analizando las apelaciones del eslogan (las amenazas denunciadas) y la carga simbólica de la iconografía (en este caso, el ecosistema verde de lomas y la flor típica de Lima, símbolos de fragilidad natural frente al asfalto urbano).
...
### Explicacion Pedagogica
Los gráficos de dispersión evalúan la correlación entre dos variables continuas. Identificar la dirección de la nube de puntos permite establecer si existe una relación positiva, negativa o nula, insumo indispensable para el análisis crítico de políticas públicas.
...
### Enunciado
En la infografía, el flujo del cacao se representa mediante una línea de tiempo sinuosa interrumpida por grandes círculos numerados del 1 al 5. Los pasos son:
1. Cosecha selectiva en cooperativa de Piura.
2. Fermentación y secado técnico.
3. Certificación orgánica y embalaje.
4. Embarque en el puerto de Paita.
5. Distribución minorista en chocolaterías de Suiza.
...
### Explicacion Pedagogica
Los procesos logísticos secuenciados en infografías exigen comprender la dirección cronológica obligatoria de los flujos de producción. Cada paso es prerrequisito técnico indispensable para la ejecución del nodo sucesivo.
...
### Explicacion Pedagogica
La adecuación gráfica es un principio clave del meta-análisis de textos discontinuos. Cada tipo de gráfico posee fortalezas lógicas específicas: líneas para series de tiempo, barras para comparaciones categóricas, circulares para partes de un todo.
...
### Enunciado
Un canal de televisión muestra un gráfico de barras sobre el número de robos registrados en un distrito limeño durante dos meses contiguos:
- Enero: 100 robos (la barra mide 2 centímetros de altura)
- Febrero: 110 robos (la barra mide 10 centímetros de altura)
¿Cuál es la evaluación crítica de la veracidad y rigor de esta representación gráfica discontinuo?
...
### Explicacion Pedagogica
La distorsión de escalas en textos discontinuos es una de las falacias visuales más recurrentes en la prensa sensacionalista y discursos políticos (truco de truncar el eje Y o exagerar dimensiones), requiriendo un lector crítico capaz de verificar la relación numérica real frente al impacto visual.
...
### Enunciado
Para complementar un artículo científico sobre el derretimiento acelerado del glaciar Pastoruri, el comité editorial decide insertar una infografía mixta. ¿Cuál de los siguientes contenidos visuales aportaría el mayor valor cognitivo y empírico para respaldar la tesis del retroceso glaciar?

### Opciones
- [ ] A) Una serie de fotografías artísticas de turistas de diversas nacionalidades posando sonrientes junto al nevado en los años 80
  <!-- feedback: Incorrecto. Aunque aporta un registro histórico social, las fotos de turistas no proveen datos científicos o de medición del hielo glaciar de forma rigurosa. -->
- [ ] B) Una lista ilustrada de los hostales y restaurantes que operan en la ciudad de Huaraz
  <!-- feedback: Incorrecto. Esta información es puramente comercial y de servicios turísticos locales; no aporta a la tesis del retroceso del glaciar por calentamiento global. -->
- [x] C) Una secuencia cronológica de mapas satelitales (período 1980-2020) que delimiten con precisión matemática la reducción del área de la masa de hielo expresada en kilómetros cuadrados
  <!-- feedback: Correcto. El uso de mapas satelitales comparativos a escala provee la evidencia empírica directa y visual más contundente sobre la pérdida real de superficie glaciar, integrando espacio, tiempo y medición cuantitativa de forma innegable. -->
- [ ] D) Una ilustración mítica de deidades andinas (Apus) llorando lágrimas de agua dulce debido a la contaminación de las minas
  <!-- feedback: Incorrecto. Esto constituye una representación poética o mitológica hermosa de la cosmovisión, pero carece de rigor y valor empírico científico para un artículo de divulgación de ciencias naturales. -->

### Explicacion Pedagogica
La pertinencia del elemento discontinuo auxiliar se mide por su capacidad de aportar evidencia objetiva, contrastable y de lectura unívoca para el tema defendido en el cuerpo expositivo.
...
### Enunciado
Una infografía gubernamental promueve el consumo de 'papillas enriquecidas con hierro' para combatir la anemia en zonas altoandinas de Huancavelica. El diseño visual muestra a una enfermera entregando la papilla a una madre indígena en un centro de salud moderno. ¿Qué supuesto cultural e institucional no explicitado sostiene el éxito del programa según la representación de este afiche?

### Opciones
- [ ] A) Asume que la anemia infantil es una enfermedad de transmisión hereditaria que no tiene cura biológica
  <!-- feedback: Incorrecto. La anemia es un déficit nutricional curable mediante hierro; el afiche promueve justamente su cura. -->
- [ ] B) Afirma que las madres andinas se niegan a alimentar a sus hijos por razones de creencia de creencia religiosa ancestral
  <!-- feedback: Incorrecto. No hay indicios visuales o textuales que acusen a las madres de negligencia deliberada por motivos de fe. -->
- [x] C) Presupone que el Estado cuenta con la infraestructura física de salud activa y personal médico permanente en la zona, y que la población andina confía plenamente en la medicina alopática occidental
  <!-- feedback: Correcto. El éxito de entregar papillas en un centro de salud moderno asume que tales centros existen en las zonas rurales vulnerables, cuentan con personal y que no hay barreras de desconfianza cultural de la población indígena hacia el personal de salud estatal, supuestos que a menudo chocan contra la realidad fáctica de abandono rural. -->
- [ ] D) Asume que los niños andinos rechazan de forma de forma natural el sabor de los alimentos tradicionales de su región
  <!-- feedback: Incorrecto. El afiche promueve el hierro de la papilla; no postula un rechazo innato de los niños a su propia comida local. -->

### Explicacion Pedagogica
Las representaciones institucionales en textos discontinuos suelen idealizar el funcionamiento del Estado (el hospital moderno, la atención amigable). El meta-análisis crítico exige confrontar estas asunciones con los cuellos de botella materiales y culturales reales de la descentralización del país.
...
### Enunciado
Desde la perspectiva cognitiva de la alfabetización mediática, ¿cuál es el peligro intelectual latente de sustituir de manera masiva la lectura de textos complejos continuos (libros, ensayos) por la lectura exclusiva de textos discontinuos (infografías, resúmenes visuales) en la educación secundaria peruana?

### Opciones
- [ ] A) La desaparición absoluta de los talleres de diseño gráfico por falta de computadoras en provincia
  <!-- feedback: Incorrecto. El diseño gráfico se expande con el predominio visual, no desaparece. -->
- [ ] B) El incremento de la velocidad de lectura comprensiva literal en toda la población escolar
  <!-- feedback: Incorrecto. Leer infografías puede agilizar la decodificación visual, pero esto no equivale a profundizar en comprensión compleja abstracta. -->
- [x] C) La atrofia de la capacidad de seguir razonamientos abstractos de larga ilación, estructurar argumentos complejos y sostener la atención profunda en discursos conceptuales extensos
  <!-- feedback: Correcto. Los textos discontinuos e infografías atomizan la información, presentándola en fragmentos fáciles de digerir. La dependencia exclusiva de este formato priva al cerebro del ejercicio de decodificar estructuras subordinadas complejas, seguir líneas argumentativas extensas (como en los ensayos) y desarrollar el pensamiento abstracto reflexivo no apoyado en imágenes. -->
- [ ] D) La prohibición gubernamental del quechua y otras lenguas orales en la Amazonía
  <!-- feedback: Incorrecto. No hay un nexo de causa y efecto racional entre el formato de lectura (infografía vs libro) y políticas de exterminio lingüístico estatal. -->

### Explicacion Pedagogica
El cerebro lector se modela según el tipo de soporte y texto que consume. Mientras la infografía es excelente para sintetizar datos empíricos inmediatos, solo la lectura de textos continuos complejos promueve la capacidad de abstracción profunda y razonamiento crítico de largo aliento, destrezas indispensables para el desarrollo científico e intelectual autónomo.
