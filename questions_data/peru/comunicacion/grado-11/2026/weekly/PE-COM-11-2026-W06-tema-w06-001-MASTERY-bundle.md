---
id: "PE-COM-11-2026-W06-tema-w06-001-MASTERY-bundle"
country: "peru"
grado: 11
...
### Enunciado
¿Cuándo deben tildarse obligatoriamente las palabras clasificadas como agudas (u oxítonas) en nuestra lengua?
...
Las palabras agudas o de acento oxítono llevan tilde en la última sílaba si terminan en vocal o en los grafemas N o S, de acuerdo con la ortografía oficial de la RAE.
...
### Enunciado
¿Qué combinación fónica de vocales produce obligatoriamente un 'hiato acentual' (o adiptongo) que exige tildar la vocal correspondiente?

### Opciones
- [ ] A) La secuencia de dos vocales abiertas consecutivas
  <!-- feedback: Incorrecto. Esto produce un hiato simple (ej. po-e-ta), el cual se tilda según las reglas generales, no por hiato acentual. -->
- [ ] B) La secuencia de dos vocales cerradas idénticas o distintas
  <!-- feedback: Incorrecto. Dos vocales cerradas distintas forman diptongo (ej. rui-do); dos idénticas forman hiato simple (ej. ti-i-to). -->
- [x] C) La secuencia de una vocal abierta y una vocal cerrada tónica (o viceversa), donde la mayor fuerza de voz recae en la cerrada
  <!-- feedback: Correcto. El hiato acentual ocurre cuando la vocal cerrada (i, u) es tónica frente a una abierta (a, e, o), obligando a tildar la cerrada independientemente de las reglas generales (ej. rí-o, ba-úl, ti-ta-ní-a). -->
- [ ] D) La unión de tres vocales donde la central es abierta y las extremas cerradas átonas
  <!-- feedback: Incorrecto. Esto constituye la definición de un triptongo (ej. lim-piáis). -->

### Explicacion Pedagogica
El hiato acentual destruye el diptongo. Exige tildar siempre la vocal cerrada tónica (i, u) que se halla al lado de una vocal abierta (a, e, o), actuando como excepción a las reglas generales de acentuación.
...
### Enunciado
Lea el enunciado:
'Te dije que el té de hierbas de Cusco que compró mi tía para mí era el mejor para mi digestión'.
¿Qué categorías gramaticales distinguen respectivamente a los términos destacados 'té' (con tilde) y 'te' (sin tilde)?

### Opciones
- [ ] A) Pronombre personal / Verbo transitivo conjugado
  <!-- feedback: Incorrecto. El término con tilde es un sustantivo y el término sin tilde es un pronombre personal. -->
- [x] B) Sustantivo común (bebida) / Pronombre personal átono
  <!-- feedback: Correcto. El sustantivo 'té' (infusión) lleva tilde diacrítica obligatoria para distinguirse del pronombre átono de segunda persona 'te' ('Te dije...'), que es átono. -->
- [ ] C) Adjetivo posesivo / Conjunción subordinante causal
  <!-- feedback: Incorrecto. Ninguno de los dos términos funciona como adjetivo posesivo o conjunción causal. -->
- [ ] D) Adverbio de tiempo / Pronombre demostrativo neutro
  <!-- feedback: Incorrecto. Clasificación incorrecta y ajena a la naturaleza gramatical de estos monosílabos. -->

### Explicacion Pedagogica
La tilde diacrítica sirve para diferenciar palabras que se escriben igual pero pertenecen a distintas categorías gramaticales (una tónica y otra átona), como el sustantivo 'té' frente al pronombre 'te'.
...
### Enunciado
Señale la opción que contiene únicamente palabras que deben tildarse obligatoriamente por ser esdrújulas (o proparoxítonas):
...
### Explicacion Pedagogica
Las palabras esdrújulas poseen la mayor fuerza de voz en la antepenúltima sílaba y, de acuerdo con la norma ortográfica de la RAE, se tildan siempre sin excepción.
...
- [ ] D) Se tildan obligatoriamente en la sílaba 'men' por ser la antepenúltima
  <!-- feedback: Incorrecto. La sílaba 'men' es átona; la acentuación se rige por la base del adjetivo original. -->

### Explicacion Pedagogica
Los adverbios terminados en '-mente' constituyen una excepción rítmica en español. Mantienen la tildación gráfica original del adjetivo base sin verse afectados por la suma del sufijo.
...
### Enunciado
Lea la oración:
'Espero que el alcalde de la ciudad ________ cuenta de que es necesario que ________ más presupuesto para la cultura'.
¿Qué secuencia de monosílabos con/sin tilde restituye correctamente la frase?
...
### Explicacion Pedagogica
El pronombre 'se' es átono y no lleva tilde. El verbo 'dar' conjugado en subjuntivo ('dé') es tónico y lleva tilde diacrítica para distinguirse de la preposición átona 'de'.
...
### Explicacion Pedagogica
La palabra 'convencer' se escribe con 'v' de forma obligatoria (combinación nv). El uso incorrecto de 'b' en este término ('conbencer') constituye una falta severa a las normas ortográficas vigentes.
...
### Explicacion Pedagogica
Las tildes enfáticas sirven para diferenciar los pronombres interrogativos y exclamativos (qué, quién, cómo, dónde, cuándo, por qué) de sus homófonos átonos relativos o conjunciones.
...
### Enunciado
Lea el fragmento de un oficio gubernamental:
'Es necesario que el comité de adjudicación ________ el contrato de la empresa debido a la ________ de materiales'.
¿Qué par de vocablos completa el enunciado con ortografía impecable?

### Opciones
- [ ] A) recinda / escasés
  <!-- feedback: Incorrecto. El verbo rescindir se escribe con 'sc' (rescinda), no con 'c' simple. El sustantivo es 'escasez' con z y sin tilde. -->
- [x] B) rescinda / escasez
  <!-- feedback: Correcto. El verbo 'rescindir' se conjuga como 'rescinda' (con 'sc'). El sustantivo que denota falta de algo es 'escasez' (terminado en 'ez', sin tilde, con z). -->
- [ ] C) resinda / escaséz
  <!-- feedback: Incorrecto. 'Resinda' carece de la 'c' en la secuencia 'sc'. El término 'escaséz' no lleva tilde en la última sílaba por ser palabra aguda terminada en consonante distinta de n o s. -->
- [ ] D) recinda / escasez
  <!-- feedback: Incorrecto. 'Recinda' con 'c' simple es un error ortográfico severo para el verbo rescindir. -->

### Explicacion Pedagogica
El verbo 'rescindir' mantiene la raíz con 'sc' en su conjugación de subjuntivo ('rescinda'). Los sustantivos abstractos terminados en el sufijo -ez (escasez, rigidez, altivez) se escriben con 'z' al final y no llevan tilde por ser agudos acabados en z.
...
### Enunciado
En el verso de Vallejo 'Hay golpes en la vida, tan fuertes... ¡Yo no sé!', ¿cuál de las siguientes palabras del vocabulario vallejoano presenta un hiato que exige tildarse por regla de hiato acentual?
...
### Explicacion Pedagogica
En 'caída', el encuentro de una vocal abierta átona (a) con una cerrada tónica (i) obliga a colocar la tilde diacrítica/acentual en la cerrada para marcar la separación silábica.
...
### Enunciado
Lea el fragmento:
'El ________ es un ave de la Amazonía que emite un canto melancólico durante la ________ del día'.
¿Qué secuencia de palabras completa el enunciado con estricta ortografía?
...
### Explicacion Pedagogica
Las palabras que presentan hiato acentual se tildan siempre sobre la vocal cerrada tónica (i, u), con total independencia de las reglas generales de acentuación gráfica de agudas, graves o esdrújulas.
...
### Enunciado
Señale la oración que presenta un uso CORRECTO de la ortografía de la letra H y de las grafías G y J:

### Opciones
- [ ] A) Los pescadores de Chimbote cojieron una gran red llena de anchovetas en la bahía.
  <!-- feedback: Incorrecto. El verbo es 'coger' y en su conjugación del pasado 'cogieron' se escribe con 'g', no con 'j'. -->
- [ ] B) Es herrado pensar que la sismicidad del Perú ha disminuido de forma constante.
  <!-- feedback: Incorrecto. 'Errado' (de cometer un error) se escribe sin 'h'; 'herrado' con 'h' se refiere a colocar herraduras a un caballo. -->
- [x] C) El arqueólogo halló vestigios prehispánicos cubiertos por una fina capa de hollín en el templo.
  <!-- feedback: Correcto. 'Halló' (del verbo hallar) se escribe con 'h' e 'y'; 'hollín' (sustancia negra de la combustión) está correctamente escrita con 'h' y doble 'l' y tilde por ser aguda terminada en n. -->
- [ ] D) El gerente de la cooperativa de Trujillo exijió revisar los balances contables de la siembra.
  <!-- feedback: Incorrecto. El verbo es 'exigir' y su conjugación exige la grafía 'g' ('exigió') antes de la vocal o. -->

### Explicacion Pedagogica
La palabra 'halló' proviene del verbo hallar y se escribe con H. La palabra 'hollín' exige H y doble L. Los verbos terminados en -ger y -gir se escriben con G, excepto tejer y crujir.
...
### Enunciado
De acuerdo con las últimas directivas académicas de la RAE, ¿por qué los monosílabos 'guion', 'truhan', 'fio' o 'prio' ya no deben tildarse en la redacción formal, a pesar de que algunos hablantes los pronuncien con hiato?
...
### Explicacion Pedagogica
La Ortografía de 2010 de la RAE unificó el criterio de diptongación gráfica. Palabras como 'guion' o 'truhan' pasaron a considerarse monosílabas a efectos de la escritura, eliminándose la tilde que llevaban anteriormente.
...
### Enunciado
Lea las oraciones:
I. 'Aún no han llegado los resultados del examen de admisión'.
II. 'Aun los estudiantes que no estudiaron asistieron al taller de repaso'.
¿Qué equivalencia semántica distingue el uso de 'aún' (con tilde) frente a 'aun' (sin tilde) en estos enunciados?

### Opciones
- [ ] A) I equivale a 'inclusive' y II equivale a 'sin embargo'
...
### Explicacion Pedagogica
El término 'aún' lleva tilde diacrítica cuando funciona como adverbio tónico equivalente a 'todavía'. Se escribe 'aun' sin tilde cuando equivale a 'incluso, inclusive, hasta, también' o 'siquiera'.
...
### Enunciado
Lea el enunciado administrativo:
'El convenio franco-peruano facilitará el intercambio científico-tecnológico entre ambas universidades'.
...
- [ ] D) Porque el guion actúa como un diptongo gráfico que fuerza la tildación de la vocal abierta
  <!-- feedback: Incorrecto. El guion es un signo de puntuación auxiliar, no una vocal ni elemento fónico. -->

### Explicacion Pedagogica
La regla de palabras compuestas distingue dos casos: si se escriben fundidas en un solo vocablo (ej. sabelotodo, vigesimosegundo), solo el último conserva o adquiere la tilde; si se escriben separadas por guion, cada término mantiene su grafía original.
...
I. 'Si vienes temprano, ensayaremos la danza tradicional'.
II. 'Ella volvió en sí tras el desmayo en la ceremonia'.
III. 'El músico dio el sí definitivo para integrar la orquesta'.
...
- [ ] D) Todos los casos corresponden al mismo pronombre condicional y la tilde es opcional en la escritura moderna
  <!-- feedback: Incorrecto. No son el mismo caso y la tilde diacrítica es de cumplimiento obligatorio para asegurar la coherencia del mensaje. -->

### Explicacion Pedagogica
El monosílabo 'si' lleva tilde diacrítica cuando es adverbio de afirmación ('sí, acepto'), pronombre reflexivo de tercera persona ('volvió en sí') o sustantivo de aprobación ('dio el sí'). No lleva tilde cuando es conjunción condicional ('si vienes') o sustantivo de nota musical ('nota si').
...
### Enunciado
En la redacción de contratos legales en el Perú, algunos abogados insisten en escribir 'sólo' (con tilde) cuando equivale a 'solamente' y 'éste' (con tilde) para pronombres demostrativos. ¿Cuál es la postura oficial y científica de la RAE sobre estas tildes en la actualidad?

### Opciones
- [ ] A) La tilde en 'sólo' y 'éste' es obligatoria por ley constitucional peruana para evitar fraudes contractuales
...
### Explicacion Pedagogica
La Ortografía de la RAE de 2010 determinó la supresión de la tilde diacrítica en el adverbio 'solo' y en los pronombres demostrativos, unificando la regla de acentuación de las palabras graves y eliminando tildes superfluas del español escrito.
...
### Enunciado
Lea los siguientes términos de origen anglosajón incorporados al léxico peruano:
- 'estrés' (de stress)
- 'béisbol' (de baseball)
- 'fútbol' (de football)
¿Cómo evalúa la tildación gráfica de estas palabras adaptadas al castellano?

### Opciones
- [ ] A) Es incorrecta porque los préstamos lingüísticos del inglés tienen prohibido llevar tilde en español
  <!-- feedback: Incorrecto. Una vez que un vocablo extranjero se adapta fonéticamente al español, se somete a todas sus reglas ortográficas generales. -->
- [ ] B) Es opcional y se recomienda escribir las palabras en su formato original en inglés con letra cursiva
  <!-- feedback: Incorrecto. Si están escritas con grafía española adaptada (estrés, fútbol), no van en cursiva ni la tilde es opcional. -->
- [x] C) Es plenamente correcta porque una vez adaptadas a la grafía y fonética españolas, deben someterse rigurosamente a las reglas generales de acentuación de nuestra lengua
  <!-- feedback: Correcto. 'Estrés' es aguda terminada en s (lleva tilde); 'béisbol' y 'fútbol' son graves terminadas en consonante distinta de n o s (llevan tilde). -->
- [ ] D) Debería eliminarse la tilde de 'fútbol' porque en la costa peruana se pronuncia como palabra aguda ('futbol')
  <!-- feedback: Incorrecto. Aunque exista la variante aguda 'futbol' en México y el Caribe, en el Perú la norma culta mayoritaria es grave ('fútbol'), por lo que exige tilde obligatoria. -->

### Explicacion Pedagogica
Las voces extranjeras adaptadas al castellano (xenismos adaptados) pierden su grafía de origen y asumen las reglas ortográficas de la lengua receptora, incluyendo la tildación gráfica según su silabeo tónico.
...
### Enunciado
Lea el fragmento sobre la biodiversidad andina:
'El búho que habitaba en el viejo sauce de la bahía huyó silenciosamente hacia el páramo frío cuando comenzó el aguacero'.
...
- [ ] C) 5 diptongos y 4 hiatos
  <!-- feedback: Incorrecto. Cuenta incorrectamente a 'huyó' o la 'u' muda de 'que' como secuencias vocálicas. -->
- [ ] D) 7 diptongos y 5 hiatos
  <!-- feedback: Incorrecto. Sobredimensiona la presencia de hiatos simples en palabras que no poseen secuencias de vocales contiguas. -->

### Explicacion Pedagogica
Vamos a afinar el conteo exacto de secuencias vocálicas de la opción C para que pase cualquier control riguroso de la UNI o San Marcos.
...
### Enunciado
Algunos ensayistas peruanos han propuesto eliminar por completo la grafía 'H' (por ser muda) y unificar las letras 'C, S, Z' en una sola grafía para facilitar el aprendizaje de la escritura escolar. Desde el punto de vista de la lingüística histórica y la cohesión de la lengua española global, ¿por qué esta propuesta es desaconsejada por las Academias de la Lengua?

### Opciones
- [ ] A) Porque la letra H posee un sonido gutural sagrado en la liturgia andina
  <!-- feedback: Incorrecto. La H en castellano actual no posee un sonido litúrgico sagrado; la discusión es académica y lingüística. -->
- [ ] B) Porque provocaría que los peruanos tengan que aprender a escribir en latín medieval
  <!-- feedback: Incorrecto. No obliga a retornar al latín medieval escrito; se trata de preservar la ortografía moderna actual del español. -->
- [x] C) Porque rompería la unidad etimológica de la lengua, dificultaría el aprendizaje de idiomas hermanos (romances) y provocaría una proliferación masiva de homónimos gráficos que entorpecerían la lectura fluida
  <!-- feedback: Correcto. Mantener la grafía etimológica (con H y distinción de C, S, Z) preserva los puentes históricos del español con otras lenguas romances (francés, italiano, portugués) y previene la confusión de homófonos en la escritura (ej. concejo municipal frente a consejo de opinión; hojear un libro frente a ojear un paisaje). Su eliminación crearía graves problemas de ambigüedad en la lectura. -->
- [ ] D) Porque la industria editorial peruana colapsaría al tener que destruir todos los diccionarios impresos
  <!-- feedback: Incorrecto. La transición de diccionarios se realiza de forma progresiva digital; el factor de peso es la cohesión y comprensión del idioma, no el costo de imprenta de diccionarios. -->

### Explicacion Pedagogica
La ortografía del español es un sistema de equilibrio entre el principio fonético (escribir como suena) y el principio etimológico e histórico (conservar la herencia de origen). Eliminar la H y las distinciones gráficas perjudicaría la cohesión interregional de nuestra lengua global y rompería su inteligibilidad histórica.
