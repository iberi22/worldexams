---
id: "BR-POR-11-2026-W04-tema-w04-001-MASTERY-bundle"
country: "brasil"
grado: 11
...
**Contexto:** Um estudante de Porto Alegre estuda as figuras de palavras comuns na literatura de vestibular.

### Enunciado
Como é classificada a figura de linguagem que consiste na substituição de um termo por outro com base em uma relação de contiguidade material ou lógica (como o efeito pela causa, o autor pela obra, o continente pelo conteúdo)?
...
**Contexto:** Um grupo de teatro em Salvador ensaia versos barrocos repletos de contrastes intelectuais.

### Enunciado
Qual figura de linguagem consiste no emprego de palavras ou expressões de sentidos opostos que, embora contrastantes, não se anulam de forma lógica (coexistem na mesma frase)?

### Opciones
- [ ] A) Paradoxo (ou Oxímoro).
  <!-- feedback: Incorreto. O paradoxo traz ideias contraditórias que se anulam ou desafiam a lógica racional de forma absurda (ex: ferida que dói e não se sente). -->
- [x] B) Antítese.
  <!-- feedback: Correto! A antítese é a aproximação de termos contrários de forma clara e lógica, como "luz e treva", "dia e noite", "vida e morte". -->
- [ ] C) Hipérbole.
  <!-- feedback: Incorreto. A hipérbole consiste em um exagero intencional de conceitos para dar ênfase expressiva. -->
- [ ] D) Catacrese.
  <!-- feedback: Incorreto. A catacrese é uma metáfora desgastada pelo uso comum pela falta de termo próprio (ex: dente de alho). -->
...
**Contexto:** Uma crônica em um jornal de Curitiba descreve uma situação cotidiana de trânsito em que o motorista exclama: "Estou esperando essa balsa há mil séculos!".
...
- [ ] D) Sinestesia, mesclando de forma integrada sensações do paladar doce com visões coloridas do rio de passagem.
  <!-- feedback: Incorreto. Não há fusão de canais sensoriais (como audição e tato), apenas expressão de cansaço hiperbólico. -->
...
**Contexto:** Uma campanha publicitária impressa em São Paulo exibe a imagem de folhas de alface frescas com o slogan: "Nossas verduras estão gritando por frescor e saúde!".

### Enunciado
No slogan do cartaz de verduras, a figura de linguagem empregada e seu efeito de sentido são:

### Opciones
- [ ] A) Ironia, buscando ridicularizar a qualidade das hortaliças paulistas vendidas na feira livre de passagem.
  <!-- feedback: Incorreto. O anúncio exalta a alta qualidade das verduras e não busca fazer piada de desprestígio contra os vegetais. -->
- [x] B) Personificação (ou Prosopopeia), ao atribuir a ação humana de "gritar" a seres inanimados (as verduras) para destacar sua vivacidade.
  <!-- feedback: Correto! Atribuir verbos ou sentimentos humanos a vegetais ou objetos caracteriza a prosopopeia. -->
- [ ] C) Onomatopeia, por imitar com precisão fonética o som mecânico de mastigação das folhas verdes rústicas.
  <!-- feedback: Incorreto. O verbo "gritar" não imita sons mecânicos da natureza como onomatopeias de mastigação ("crom-crom"). -->
- [ ] D) Pleonasmo, visto que repete termos redundantes desnecessários da mesma classe gramatical sem fins estilísticos.
  <!-- feedback: Incorreto. "Gritar" verduras não constitui redundância lógica de reforço (como "subir para cima"), mas sim metáfora animada. -->
...
**Contexto:** Leia o famoso poema de Camões que discute as contradições do sentimento amoroso: "Amor é um fogo que arde sem se ver, / é ferida que dói, e não se sente...".

### Enunciado
A definição poética do amor construída por Camões apoia-se estruturalmente na figura de linguagem chamada:
...
**Contexto:** Um anúncio imobiliário em Belo Horizonte promove um luxuoso condomínio fechado com a frase: "Um doce silêncio verde espera por você e sua família para viver bem!".
...
**Contexto:** Em um romance realista de Machado de Assis, o narrador relata o falecimento de uma personagem rica: "Dona Plácida não resistiu à febre e partiu para o repouso eterno".

### Enunciado
Machado de Assis utiliza no trecho acima qual recurso estilístico figurado para suavizar a dor da perda e a feiura da morte?
...
**Contexto:** Um compositor da Bossa Nova no Rio de Janeiro escreve uma letra que repete sistematicamente o início das frases: "Olha que coisa mais linda, / Olha que graça de andar, / Olha o mar que balança...".

### Enunciado
Como é denominada essa figura de sintaxe ou de construção literária baseada na repetição intencional de palavras no começo de versos ou períodos sucessivos?

### Opciones
- [ ] A) Aliteração.
  <!-- feedback: Incorreto. Aliteração é a repetição de sons consonantais semelhantes em sequência, não de palavras inteiras idênticas. -->
- [ ] B) Pleonasmo.
  <!-- feedback: Incorreto. Pleonasmo é a redundância lógica de ideias sem repetição textual de palavras idênticas no início de versos. -->
- [x] C) Anáfora.
  <!-- feedback: Correto! A repetição de "Olha..." no início de cada linha constitui uma anáfora, recurso rítmico clássico na poesia e música. -->
- [ ] D) Polissíndeto.
  <!-- feedback: Incorreto. Polissíndeto é a repetição sistemática de conjunções coordenativas (ex: "e corre, e grita, e chora"). -->
...
**Contexto:** Uma crônica humorística publicada em São Paulo comenta a paciência de um marido esperando a esposa escolher sapatos na loja da capital paulista: "Ele foi apenas um doce anjo de paciência, de pé por seis horas seguidas".

### Enunciado
No trecho da crônica de cliques, as figuras de linguagem que atuam de forma simbiótica e integrada são:

### Opciones
- [ ] A) Sinestesia e Onomatopeia, fundindo sons e imitando ruídos de salto alto no chão da loja paulista.
  <!-- feedback: Incorreto. Não há imitação fonética de ruídos mecânicos nem fusão sensorial física na fala descrita. -->
- [x] B) Metáfora (analogia implícita do marido com um "doce anjo") e Hipérbole (exagero dramático de esperar por "seis horas seguidas").
  <!-- feedback: Correto! O homem é associado diretamente a um anjo de forma subjetiva, e o tempo é amplificado dramaticamente. -->
- [ ] C) Catacrese e Pleonasmo de redundância literária, imitando o falar de camponeses baianos do século dezoito.
  <!-- feedback: Incorreto. Não há arcaísmos de camponeses ou desgastes lexicais prosaicos de peças físicas de madeira na frase. -->
- [ ] D) Elipse e Hipérbato, invertendo de forma rebuscada e incompreensível toda a ordem sintática da oração.
  <!-- feedback: Incorreto. A oração segue ordem direta padrão e compreensível, sem omissões ocultas de verbos nucleares. -->
...
**Contexto:** Um artigo de crítica literária analisa os versos simbolistas de Cruz e Sousa, poeta catarinense célebre por jogos fônicos de grande beleza sonora.
...
**Contexto:** Em um ensaio sobre a escrita jornalística, analisa-se uma crítica de cinema publicada em Curitiba: "O novo blockbuster hollywoodiano é uma verdadeira sinfonia de ruídos caóticos e explosões vazias".

### Enunciado
A qualificação do filme como "sinfonia de ruídos caóticos e explosões vazias" apoia-se estilisticamente em qual figura de pensamento?

### Opciones
- [ ] A) Personificação, atribuindo sentimentos humanos de bondade e altruísmo às explosões de efeitos visuais rústicos.
  <!-- feedback: Incorreto. Não se atribui sentimentos ou condutas de generosidade humana aos efeitos de vídeo do filme. -->
- [x] B) Ironia de base metafórica, ao usar o termo solene "sinfonia" (harmonia musical erudita) para descrever barulhos desorganizados e irritantes de forma sarcástica.
  <!-- feedback: Correto! O crítico joga com o contraste irônico de sentidos para atacar de forma ácida e criativa a qualidade do filme. -->
- [ ] C) Pleonasmo de redundância gramatical do português culto, reforçando ideias idênticas de forma desnecessária sem lirismo.
  <!-- feedback: Incorreto. Não há redundância inútil de termos equivalentes (como "descer para baixo"), mas sim uma oposição de conceitos com ironia. -->
- [ ] D) Catacrese de escassez vocabular, imitando a fala espontânea de camponeses rústicos mineiros do século dezoito.
  <!-- feedback: Incorreto. A frase do crítico é elegante e intelectualizada de jornal de mídias, distanciando-se de dialetos arcaicos de escassez. -->
...
**Contexto:** Um artigo de opinião em Porto Alegre critica de forma veemente os gastos públicos excessivos em obras suntuárias: "Enquanto faltam leitos nos hospitais, os estádios nadam em piscinas douradas de dinheiro público".

### Enunciado
No parágrafo de opinião acima, as figuras de linguagem que se destacam na construção da denúncia social são:
...
**Contexto:** Em um ensaio acadêmico da UFRJ, discute-se o estilo poético de Gregório de Matos, o "Boca do Inferno", célebre satírico do Barroco na Bahia colonial.

### Enunciado
"Anjo Bento, que não bento, senão anjo, / Se és bento, como és anjo a um mesmo tempo?"
Analisando esses provocadores versos barrocos de Gregório de Matos, a figura de linguagem estrutural que rege o debate de ideias religiosas é a:

### Opciones
- [ ] A) Catacrese, decorrente da falta de vocabulário para descrever as imagens religiosas do altar de ouro da igreja baiana.
  <!-- feedback: Incorreto. Gregório é erudito e brinca com o duplo sentido de nomes espirituais, longe de sofrer de pobreza vocabular de catacrese. -->
- [x] B) Antítese com jogo metalinguístico (exploração das palavras "bento" e "anjo" sob forte contraste moral e teológico).
  <!-- feedback: Correto! O poeta questiona com ironia as virtudes espirituais de seu destinatário jogando com antíteses conceituais do Barroco. -->
- [ ] C) Onomatopeia pura de sinos físicos de igrejas de Salvador, imitando o barulho mecânico de metais de campanário em silêncio.
  <!-- feedback: Incorreto. Os versos debatem teologia de forma intelectualizada, sem reproduzir foneticamente "blém-blém" de sinos de bronze. -->
- [ ] D) Eufemismo de polidez cortesã, com o intuito de bajular docemente as autoridades civis do reino de Portugal na colônia.
  <!-- feedback: Incorreto. A intenção de Gregório de Matos é eminentemente satírica e de crítica ácida a desvios de poder, fugindo de eufemismos de bajulação. -->
...
**Contexto:** Leia o fragmento da conhecida música nacional de autoria de Chico Buarque: "De tanto beber a dor, / De tanto comer a dor, / Minha dor acabou virando canção...".

### Enunciado
Sob a análise estética das figuras de pensamento na canção de Chico Buarque, o eu lírico constrói o seu sofrimento por meio de:
...
**Contexto:** Em um ensaio de crítica de artes em Belo Horizonte, avalia-se o poema "Sentimento do Mundo", do mineiro Carlos Drummond de Andrade, onde o poeta escreve: "O poeta declina de toda a glória, / aceita a sua dose de cinza e silêncio".
...
- [ ] D) Elipse violenta de artigos do português clássico de Portugal, forçando o leitor a falar apenas em sussurros no asfalto da cidade.
  <!-- feedback: Incorreto. Os versos possuem fluidez sintática padrão culta e elegância contemporânea de fácil e natural entonação pelo leitor. -->
...
**Contexto:** Um artigo de linguística de Campinas analisa o eslogan publicitário de uma famosa marca paulista de chocolates: "O chocolate que derrete o seu estresse e incendeia o seu sorriso de felicidade!".
...
**Contexto:** Em um ensaio de crítica poética de vestibular publicado em Curitiba, compara-se um poema de tendência parnasiana clássica (rigidez formal, descrição objetiva de objetos de mármore) a um poema simbolista de Cruz e Sousa (misticismo fônico, metáforas espirituais sinestésicas).

### Enunciado
Sob a análise estética do uso das figuras de linguagem nos dois movimentos literários históricos do Brasil, avalie qual postura descritiva científica está correta:
...
**Contexto:** Um artigo jornalístico em São Paulo discute o uso controverso da figura "pleonasmo vicioso" (como "subir para cima", "entrar para dentro") na fala espontânea de pessoas em programas de reality show da televisão brasileira.

### Enunciado
"Muitos telespectadores criticam duramente de forma raivosa os participantes de reality show que dizem 'subir para cima' na TV, rotulando os de burros ou ignorantes linguísticos paulistas."
Sob a análise sociolinguística da adequação e da estilística do português brasileiro, avalie criticamente o fenômeno do pleonasmo de reforço na oralidade coloquial:

### Opciones
- [ ] A) Os telespectadores estão corretos cientificamente, pois o pleonasmo é uma falha biológica do cérebro de pessoas sem acesso à rede de internet de São Paulo.
...
**Contexto:** Em um renomado seminário literário da USP, debate-se como poetas da vertente Concretista de São Paulo nos anos 1950 (como Haroldo de Campos) subvertiam as figuras de sintaxe clássicas criando poemas visuais e espaciais geométricos em páginas brancas em silêncio.

### Enunciado
"Os poetas concretistas eliminavam as conjunções sintáticas de ligação verbal tradicionais (assíndeto radical), transformando a própria distribuição geométrica das letras na página branca em figura poética espacial de alta tensão semântica."
Considerando essa inovação radical das vanguardas paulistas do século XX, avalie o efeito estético-funcional gerado por essa subversão da sintaxe tradicional na leitura de poesia:

### Opciones
- [ ] A) O poema concretista falha por completo porque sem conjunções sintáticas tradicionais do português luso o texto de São Paulo vira apenas um borrão sem nexo.
  <!-- feedback: Incorreto. O concretismo paulista conquistou enorme renome internacional ao criar novos códigos estéticos visuais integrados de alto nível intelectual. -->
- [x] B) A supressão das conjunções tradicionais e a espacialização gráfica das palavras obrigam o leitor receptor a atuar ativamente na construção dos sentidos do texto geométrico.
  <!-- feedback: Correto! A paralisia da sintaxe clássica linear força a mente humana a correlcionar as letras por proximidade visual de tela e analogias espaciais poéticas. -->
- [ ] C) Os concretistas de São Paulo foram proibidos de imprimir livros pelo Ministério da Educação por estarem quebrando leis federais de ortografia de Portugal de 1500.
  <!-- feedback: Incorreto. Vanguardas poéticas de arte moderna paulista gozam de plena liberdade constitucional de experimentação artística e curricular acadêmica no país. -->
- [ ] D) O uso exclusivo de assíndeto geométrico nos poemas paulistas de vanguarda foi inventado por robôs de informática para acelerar a leitura eletrônica de computadores.
  <!-- feedback: Incorreto. Trata-se de um projeto artístico humano autêntico do Modernismo de 1952 para aproximar poesia da arquitetura e das artes visuais industriais brasileiras. -->
...
**Contexto:** Um ensaio crítico de vestibular analisa uma polêmica letra de música de rap nacional de autoria de um compositor da periferia de São Paulo de 2026. A letra repete imagens violentas e sarcásticas usando antíteses contra as desigualdades sociais e o asfalto rico da capital paulista.

### Enunciado
"Os versos dizem: 'O condomínio de luxo é um castelo de gelo que sorri com a fome das criancinhas da favela ao lado'. O rap utiliza de forma integrada:"
...
### Explicacion Pedagogica
O rap de protesto paulistano contemporâneo utiliza figuras de linguagem (metáforas, antíteses, hipérboles e prosopopeias satíricas) com alto poder expressivo cívico. Associar as fortunas de condomínios fechados a "castelos de gelo" de frieza social que "sorriem com a fome" dos bairros pobres e favelas vizinhas cria um violento e inesquecível contraste moral de denúncia cívica. O rap mostra como a estilística da conotação atua de forma engajada na esfera musical urbana brasileira para mobilizar as consciências contra exclusões históricas graves.
