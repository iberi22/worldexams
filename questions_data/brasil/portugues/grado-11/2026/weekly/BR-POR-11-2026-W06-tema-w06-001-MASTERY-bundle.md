---
id: "BR-POR-11-2026-W06-tema-w06-001-MASTERY-bundle"
country: "brasil"
grado: 11
...
**Contexto:** Um estudante de Porto Alegre estuda os mecanismos de coesão referencial para a redação do ENEM.

### Enunciado
Como é classificado o recurso de coesão que consiste na retomada de um termo ou ideia anteriormente expressos no texto, utilizando pronomes ou sinônimos de substituição?
...
**Contexto:** Em um artigo sobre gramática normativa em Salvador, discute-se o papel das conjunções coordenativas e subordinativas.

### Enunciado
As conjunções e locuções conjuntivas (como "portanto", "contudo", "porque") atuam de forma dominante na:

### Opciones
- [ ] A) Coesão lexical por repetição literal de substantivos próprios de forma mecânica em todas as linhas.
  <!-- feedback: Incorreto. A coesão lexical por repetição repete os substantivos inteiros e não usa conjunções de conexão lógica. -->
- [x] B) Coesão interparágrafos ou interoracional, estabelecendo relações lógico-discursivas (causa, oposição, conclusão) entre os enunciados.
  <!-- feedback: Correto! As conjunções são conectivos lógicos indispensáveis para tecer as conexões de sentido na oração. -->
- [ ] C) Coerência de contradições, permitindo que o autor afirme fatos impossíveis e mentirosos em sua redação acadêmica de forma de farsa.
  <!-- feedback: Incorreto. A coerência textual exige exatamente a ausência de contradições lógicas insolúveis no texto. -->
- [ ] D) Variação diatópica de arcaísmos coloniais quinhentistas portugueses, herdados das correspondências de 1549.
  <!-- feedback: Incorreto. Conectivos lógicos são peças vivas e contemporâneas do português padrão escrito moderno para organizar ideias. -->
...
**Contexto:** Uma jovem de Curitiba lê o seguinte trecho em sua redação modelo: "As novas leis de trânsito entraram em vigor ontem. Elas visam reduzir os acidentes nas ruas do Paraná".

### Enunciado
No trecho lido pela jovem curitibana, o pronome pessoal "Elas" atua como elemento de:
...
**Contexto:** Um artigo de opinião em São Paulo discute a poluição dos rios paulistas: "O Tietê e o Pinheiros correm pela capital paulista de forma turva. O primeiro deságua no interior paulista; o segundo corta os bairros ricos em silêncio".

### Enunciado
Identifique o mecanismo de coesão referencial utilizado pelo autor ao empregar os termos "O primeiro" e "o segundo":
...
**Contexto:** Um parágrafo dissertativo-argumentativo modelo de redação paulistano discute a necessidade de preservar as florestas nativas do Brasil.

### Enunciado
"As matas nativas brasileiras protegem a biodiversidade das encostas arenosas. Preservar essa floresta tropical rica evita deslizamentos graves de terra."
A transição entre as duas orações do parágrafo apoia-se no mecanismo de coesão chamado:
...
**Contexto:** Em um romance ambientado em Belo Horizonte, o narrador descreve a pressa de um mineiro correndo para não perder o ônibus na rodoviária local: "O rapaz calçou os sapatos, pegou a mala de couro e correu para a rodoviária. Ao chegar lá, o trem já tinha partido".

### Enunciado
Analisando a coerência interna do trecho do romance mineiro, identifica-se uma contradição de sentido (uma quebra de coerência) decorrente do fato de que:

### Opciones
- [ ] A) O rapaz calçou sapatos de couro paulistas ao invés de usar as famosas botas de montanha rústicas de Minas Gerais.
  <!-- feedback: Incorreto. Sapatos de couro são plenamente válidos e normais, sem afetar de forma alguma a coerência lógica de sentido do texto. -->
- [ ] B) O mineiro viajou de mala de couro na rodoviária de Belo Horizonte ao invés de usar caixas de papelão informais em silêncio.
  <!-- feedback: Incorreto. Carregar malas de couro é ato comum em viagens, livre de incoerências lógicas de passagens de texto. -->
- [x] C) O rapaz correu para pegar um "ônibus na rodoviária", mas o narrador relata em seguida de forma incompatível que o "trem" já tinha partido.
  <!-- feedback: Correto! Há uma quebra de coerência situacional e lógica ao misturar dois meios de transporte incompatíveis com o espaço de partida do rapaz. -->
- [ ] D) Belo Horizonte foi fundada no final do século dezenove e o rapaz correu na velocidade de robôs de informática modernos no asfalto.
  <!-- feedback: Incorreto. Correr rápido é ato comum do cotidiano sob pressões de atraso, longe de demandar robôs eletrônicos de rede. -->
...
**Contexto:** Um redator publicitário em Salvador elabora um anúncio de moda de luxo: "A verdadeira sofisticação é discreta. Ela não berra; sussurra requinte aos seus ouvidos".

### Enunciado
No anúncio de moda soteropolitano, como operam os recursos de coesão gramatical e os conectivos de oposição de ideias?
...
**Contexto:** Em uma redação modelo do ENEM escrita em Porto Alegre, o candidato escreve: "As indústrias modernas descartam efluentes tóxicos sem tratamento nos rios gaúchos. Consequentemente, o futuro ambiental das águas do estado está severamente ameaçado".

### Enunciado
Nesse trecho de redação do ENEM, o conectivo inicial "Consequentemente" estabelece de forma explícita qual relação lógico-discursiva entre os períodos do parágrafo?

### Opciones
- [ ] A) Relação de concessão de ideias, amenizando com doces eufemismos a sujeira dos rios para consolar as prefeituras gaúchas.
...
**Contexto:** Um artigo de divulgação científica escrito em Recife descreve os novos métodos de captação de energia limpa por painéis de grafeno: "O grafeno é um material fantástico de carbono puro. No entanto, o seu alto custo financeiro de produção comercial nas indústrias brasileiras de informática de ponta constitui uma barreira real de mercado hoje".

### Enunciado
No texto científico de Recife, o conectivo adversativo "No entanto" atua para estabelecer uma relação de:

### Opciones
- [ ] A) Adição de argumentos equivalentes do mesmo valor lógico, somando vantagens ambientais do grafeno de forma rápida.
...
**Contexto:** Em um anúncio de contratação de executivos seniores em São Paulo, busca-se um "diretor dinâmico que domine novas linguagens e computação eletrônica. Embora a vaga seja paulistana, as reuniões de trabalho de equipe corporativas serão virtuais nas plataformas de informática".

### Enunciado
O operador de concessão "Embora" introduz qual relação de sentido no anúncio corporativo de contratação paulistano?

### Opciones
- [ ] A) Relação de conclusão matemática de preços de calçados de moda paulista de grife nas vitrines da capital.
  <!-- feedback: Incorreto. Concessão não encerra contas matemáticas comerciais de venda de sapatos de luxo nas lojas de moda. -->
- [x] B) Relação de concessão lógica (obstáculo superado), indicando que o fato da vaga ser sediada fisicamente em São Paulo não impede que as atividades cotidianas ocorram de forma virtual na web.
  <!-- feedback: Correto! A concessão admite um limite inicial espacial mas mantém o sucesso da ação principal do enunciado de reuniões virtuais. -->
- [ ] C) Relação de tempo cronológico exato do relógio de ontem de atraso do metrô paulistano de forma de notícias curtas de trânsito.
  <!-- feedback: Incorreto. O operador de concessão atua no campo lógico-argumentativo e de sentido espacial e corporativo de trabalho, livre de horários de atrasos de metrôs. -->
- [ ] D) Arcaísmo linguístico do português clássico europeu de Portugal de 1500 usado para banir o uso de e-mails em São Paulo.
  <!-- feedback: Incorreto. "Embora" é conectivo subordinativo vivo, natural, moderno e amplamente empregado na escrita de alta qualidade do ENEM e corporações nacionais. -->
...
**Contexto:** Um agrônomo de Manaus publica um relatório ecológico de biodiversidade: "Os peixes ornamentais tropicais alimentam-se de plantas aquáticas nos rios. Preservar as matas ciliares ricas evita que as águas fluviais fiquem turvas".

### Enunciado
No trecho de relatório ecológico de Manaus, o mecanismo de coesão lexical e de sentido estabelece que:

### Opciones
- [ ] A) Ocorre elipse oculta de substantivos de forma que o leitor de Manaus precisa ler em silêncio absoluto no asfalto.
  <!-- feedback: Incorreto. O texto possui fluidez e integridade sintática padrão, sem omissões ocultas caóticas incompreensíveis de termos. -->
- [x] B) Há coesão lexical por associação de campo semântico (ou coesão por associação de ideias: "peixes", "plantas aquáticas", "rios", "matas ciliares", "águas fluviais"), consolidando a temática ecológica de forma natural e sem repetição.
  <!-- feedback: Correto! Pertencer ao mesmo universo científico de florestas de rios da bacia amazônica tece a coesão de vocábulos do relatório de biologia. -->
- [ ] C) Ocorre preconceito linguístico, devido ao uso exclusivo de termos de dialetos indígenas proibidos em cartórios civis estaduais.
  <!-- feedback: Incorreto. A linguagem empregada é científica, neutra e em português denotativo correto, livre de restrições ou discriminações de dialetos. -->
- [ ] D) Uso exclusivo de termos de informática de linguagens de computadores modernos de robôs de fábricas do Paraná de forma rústica.
  <!-- feedback: Incorreto. O relatório lida com biodiversidade agrária e botânica de rios de florestas tropicais de Manaus, longe de engenharia mecânica de robôs. -->
...
**Contexto:** No rádio de um táxi que cruza a Avenida Paulista, o locutor lê um alerta aos motoristas paulistanas: "Evitem o centro paulistano amanhã. Concomitantemente ao feriado civil, ocorrerá uma maratona de pedestres no asfalto paulistano".
...
- [ ] D) Arcaísmo quinhentista colonial brasileiro de 1500 usado para forçar motoristas a doarem dinheiro para as igrejas da capital paulista.
  <!-- feedback: Incorreto. É um termo formal, culto e contemporâneo para indicar tempo simultâneo, comum na escrita de exames e jornais nacionais. -->
...
**Contexto:** Em um ensaio de vestibular na USP, discute-se o uso de "anotações catafóricas antecipatórias" em sermões religiosos barrocos escritos na Bahia colonial do século dezoito de autoria do padre Antônio Vieira.

### Enunciado
"Vieira inicia o seu Sermão aos Peixes com a seguinte frase: 'Isto vos digo, peixes da Bahia colonial: vós tendes grandes virtudes, mas também graves vícios'. O termo 'Isto' antecipa as ideias que serão listadas em seguida."
...
**Contexto:** Leia o fragmento de um artigo crítico publicado em um jornal de Belo Horizonte de 2026 discutindo a falha lógica de coesão de peças publicitárias de calçados de moda de luxo:

### Enunciado
"O anúncio de moda dizia: 'Compre o calçado de luxo mais macio do Brasil, porque as solas de couro rústicas mineiras machucam e esfolam a sua pele de forma dolorosa ao andar'."
Analisando a coerência lógica de sentido e coesão do slogan de calçados acima, conclui-se que o texto comete:

### Opciones
- [ ] A) Uma prova incontestável de que os calçados paulistas são fabricados com titânio aeroespacial de informática de ponta no Paraná.
  <!-- feedback: Incorreto. O anúncio de loja paulistano ou mineiro lida com solas de couro rústicas de sapatos comuns e não com engenharia aeroespacial de titânio. -->
- [ ] B) Um crime civil de trânsito passível de prisão imediata dos designers de publicidade corporativos de mídias de celular.
  <!-- feedback: Incorreto. Erros de redação em slógans geram apenas quebras de vendas ou deboches de internautas, livre de penas criminais de prefeituras. -->
- [x] C) Uma quebra de coerência pragmática e argumentativa, pois o conectivo explicativo "porque" introduz um argumento desastroso que desestimula o comprador ao associar o sapato a dores na pele.
  <!-- feedback: Correto! O conectivo induz um argumento contraprodutivo de marketing que sabota a finalidade conativa publicitária do anúncio comercial de moda de luxo. -->
- [ ] D) Uma violação grave do código civil de proteção às florestas tropicais de Belo Horizonte de forma burocrática estatal em silêncio.
  <!-- feedback: Incorreto. É uma quebra de persuasão e lógica de sentido do anúncio de moda, sem relação com desmatamentos de florestas agrárias ou leis de cartórios. -->
...
**Contexto:** Em um ensaio de crítica de redações acadêmicas publicado em Curitiba, avalia-se a redação de um estudante do Paraná que usou repetitivamente o conectivo "além disso" em todas as frases do parágrafo.

### Enunciado
"O candidato escreveu: 'O governo do estado deve investir em asfalto das estradas. Além disso, as prefeituras do Paraná devem reformar calçadas. Além disso, as indústrias modernas paulistas devem plantar árvores nas lajes em silêncio'."
...
- [ ] D) Uma prova científica inquestionável de que os alunos de Letras de Curitiba não sabem escrever em silêncio absoluto no asfalto.
  <!-- feedback: Incorreto. Os estudantes sabem escrever, demandando apenas orientações pedagógicas tradicionais de variação vocabular e riqueza de repertório de operadores textuais. -->
...
**Contexto:** Um artigo crítico publicado em Campinas analisa as quebras de coerência textual voluntárias empregadas por colunistas humorísticos para zombar das incoerências de discursos de políticos brasileiros nas mídias contemporâneas.

### Enunciado
"O colunista de Campinas ironiza o anúncio oficial paulista de um prefeito: 'O prefeito garantiu que o asfalto das avenidas de São Paulo é indestrutível de verdade. Porém, a primeira chuva de ontem de tarde dissolveu e derreteu toda a avenida como chocolate'."
Na piada do colunista de jornal, o conectivo adversativo "Porém" atua de forma estratégica para:
...
**Contexto:** Em um ensaio de crítica literária de vestibular publicado em Curitiba, compara-se a "coesão descontínua irônica" em romances machadianos (narrador que conversa de forma metalinguística com o leitor rompendo a linha temporal) à linearidade rígida jornalística clássica de notícias.

### Enunciado
Sob a análise descritiva científica das regras de coerência textual de Letras, avalie qual afirmação está correta sobre os limites de quebras e desvios de sentido na literatura nacional do país:

### Opciones
- [ ] A) O romance de Machado de Assis falha em termos de coerência de verdade se o narrador de Letras do Rio de Janeiro zombar do leitor e falar em silêncio de morte.
  <!-- feedback: Incorreto. Machado é mundialmente louvado exatamente por suas inovações metalinguísticas de conversação com o leitor de forma de humor irônico de mídias. -->
- [ ] B) A linearidade rígida é a única cientificamente aceitável e válida de redação no Brasil, e os romances que usem saltos no tempo cronológico de ontem devem ser banidos.
  <!-- feedback: Incorreto. A literatura de ficção possui ampla liberdade de estruturas estilísticas cronológicas (anacronias temporais), imunes a censuras de cartilhas escolares rígidas. -->
- [x] C) A coerência literária de Machado é profunda; o narrador quebra a coesão linear jornalística (digressões, ironias), mas mantém a coerência global temática do retrato do egoísmo humano carioca sob um refinado projeto estético.
  <!-- feedback: Correto! As transgressões estilísticas parciais de superfície servem e enriquecem o projeto macroscópico de crítica moral do livro machadiano de vestibular. -->
- [ ] D) Os saltos de tempo cronológico nos livros machadianos foram inventados por robôs de informática de São Paulo em 2026 para acelerar a leitura eletrônica de computadores.
  <!-- feedback: Incorreto. São criações originais humanas artísticas de alta costura literária machadiana do século dezenove de romances realistas nacionais. -->
...
**Contexto:** Um artigo de opinião em Porto Alegre debate as propostas de multas em editais públicos de vestibular que tentam "reprovar sumariamente candidatos de redação que usem mais de dez conectivos em folhas do ENEM paulistas".

### Enunciado
"Estipular limites quantitativos rígidos ou multas de pontuação de redação baseados em contagem fria de conectivos de coesão sequencial gera grande debate ideológico de Letras."
Sob a perspectiva da sociolinguística e da avaliação de redação do ENEM do vestibular, avalie a pertinência de avaliar a coesão de forma estritamente estatística mecânica:
...
**Contexto:** Em um seminário acadêmico de Letras na USP de São Paulo, debate-se a tese de que "a coerência textual não reside apenas na superfície do papel de redação, mas constitui um evento cognitivo construído de forma integrada na mente do leitor em silêncio absoluto".

### Enunciado
"O leitor reconstrói de forma contínua a coerência temática de um parágrafo conectando as lacunas implícitas do texto de Letras com o seu repertório cultural comum compartilhado nacional (fatos do contexto do país)."
...
- [ ] D) A coesão referencial de pronomes demonstrativos e demonstrativos paulistas foi inventada por robôs de informática de startups em São Paulo para acelerar cliques na internet de rede.
  <!-- feedback: Incorreto. Trata-se de ferramentas biológicas evolutivas humanas milenares da escrita para evitar redundâncias cansativas, longe de robôs industriais mecânicos. -->
...
**Contexto:** Um coletivo de estudantes do Ensino Médio de Brasília organiza uma campanha comunitária em uma favela local e elabora um afiche rápido para o trânsito com a frase: "Trânsito humano seguro: Se beber ao volante no asfalto, a sua família chora lágrimas de sangue em silêncio absoluto. Não corra riscos!".

### Enunciado
Considerando o objetivo social de salvar vidas humanas de acidentes de trânsito e o uso adequado de conectivos lógicos implícitos, avalie o design de sentido do slogan de Brasília e assinale o diagnóstico sociolinguístico e estético correto:

### Opciones
- [ ] A) O anúncio falha em termos de Competência 4 do ENEM porque contém a figura de linguagem pleonasmo "lágrimas de sangue" que de fato polui a favela local de gírias.
...
### Explicacion Pedagogica
Para campanhas rápidas de segurança de trânsito no asfalto das metrópoles brasileiras (como em Brasília), a eficácia comunicativa exige textos de coesão ágil e imediata. Omitir conectivos formais extensos de parágrafos dissertativos ("Consequentemente, em decorrência do consumo de álcool, haverá sofrimento familiar") e substituí-los pela justaposição rápida imediata com forte carga de hipérboles dramáticas ("beber ao volante, família chora lágrimas de sangue") acelera de forma dramática a recepção visual de condutores de veículos e pedestres do asfalto de Brasília. O nexo lógico de causa e efeito é reconstituído de forma instantânea e natural pela mente humana, provando a força da coerência pragmática na conscientização social e prevenção de mortes violentas de tráfego de forma inclusiva, rápida e democrática no país de mídias de rede.
