---
id: "PY-CIE-11-2026-W02-tema-w02-001-MASTERY-bundle"
country: "paraguay"
grado: 11
...
# MASTERY Bundle - Ciencias Naturales: Célula eucariota y procariota (W02)

Este bundle cubre de manera exhaustiva el tema de Célula eucariota y procariota para el Grado 11 (3° Curso de la Educación Media) en Paraguay, alineado con los programas oficiales del MEC Paraguay.
...
**Contexto:** Durante una actividad de laboratorio en el Colegio Nacional Ortiz Guerrero de Villarrica, Gladys y su grupo investigan sobre Célula eucariota y procariota.

### Enunciado
¿Cuál es el postulado de la teoría celular que afirma que todos los seres vivos están constituidos por una o más células?

### Opciones
- [x] A) La célula como unidad estructural <!-- feedback: ¡Correcto! Este postulado indica que la célula es el bloque anatómico y estructural constitutivo de toda materia viva. -->
- [ ] B) La célula como unidad funcional o fisiológica <!-- feedback: Incorrecto. Este postulado se refiere a que todas las funciones vitales ocurren dentro de las células. -->
- [ ] C) La célula como unidad de origen <!-- feedback: Incorrecto. Establece que toda célula proviene de otra célula preexistente. -->
- [ ] D) La célula como unidad genética <!-- feedback: Incorrecto. Indica que las células contienen el material genético que se transmite a las células hijas. -->

### Explicacion Pedagogica
La teoría celular, unificadora de la biología, se consolidó en el siglo XIX gracias a los trabajos de Schleiden, Schwann y Virchow.
...
**Contexto:** Durante una actividad de laboratorio en el Colegio Nacional Encarnación de Encarnación, Mateo y su grupo investigan sobre Célula eucariota y procariota.
...
### Explicacion Pedagogica
Los procariontes carecen de compartimentación nuclear, por lo que el material genético está en contacto directo con el citosol en el nucleoide.
...
**Contexto:** Durante una actividad de laboratorio en el Colegio Nacional Dr. Raúl Peña de Caacupé, Valentina y su grupo investigan sobre Célula eucariota y procariota.
...
### Explicacion Pedagogica
Aunque varían en su tamaño y estructura de subunidades (70S en procariontes y 80S en eucariontes), los ribosomas realizan la traducción del código genético en todos los reinos vivos.
...
**Contexto:** Durante una actividad de laboratorio en el Colegio Nacional Ortiz Guerrero de Villarrica, Jorge y su grupo investigan sobre Célula eucariota y procariota.
...
### Explicacion Pedagogica
La síntesis de peptidoglucano es el blanco de muchos antibióticos comunes (como la penicilina), lo que permite destruir bacterias patógenas sin dañar las células del hospedador.
...
**Contexto:** Durante una actividad de laboratorio en el Colegio Nacional de Luque de Luque, Joaquín y su grupo investigan sobre Célula eucariota y procariota.
...
### Explicacion Pedagogica
La envoltura nuclear eucariota posee poros complejos que controlan el paso selectivo de proteínas y ARN, permitiendo una separación física entre la transcripción y la traducción.
...
**Contexto:** Durante una actividad de laboratorio en el Colegio Nacional San José de Concepción de Concepción, Santiago y su grupo investigan sobre Célula eucariota y procariota.
...
### Explicacion Pedagogica
La relación superficie-volumen limita el tamaño de las células sencillas (procariontes). Al evolucionar organelos membranosos, las células eucariotas superaron esta barrera de difusión pasiva.
...
**Contexto:** Durante una actividad de laboratorio en el Colegio Nacional de Pilar de Pilar, Joaquín y su grupo investigan sobre Célula eucariota y procariota.

### Enunciado
Durante la observación de células fúngicas (de un hongo), se detecta la presencia de una pared celular rígida. ¿Qué carbohidrato estructural la compone, diferenciándola de la pared de las células vegetales?

### Opciones
- [x] A) Quitina <!-- feedback: ¡Correcto! La quitina es un polímero de N-acetilglucosamina que forma la estructura de soporte de las paredes celulares de los hongos. -->
- [ ] B) Almidón <!-- feedback: Incorrecto. El almidón es un polisacárido de reserva energética en plantas, no un componente de soporte de paredes celulares. -->
- [ ] C) Glucógeno <!-- feedback: Incorrecto. El glucógeno es el polisacárido de reserva energética en animales y hongos, acumulado en el citoplasma. -->
- [ ] D) Celulosa <!-- feedback: Incorrecto. La celulosa es propia de las plantas, no de la pared de los hongos verdaderos. -->

### Explicacion Pedagogica
La composición de la pared celular es un criterio taxonómico clave para diferenciar los reinos Fungi (quitina) y Plantae (celulosa).
...
**Contexto:** Durante una actividad de laboratorio en el Colegio Nacional de la Capital de Asunción, Martina y su grupo investigan sobre Célula eucariota y procariota.

### Enunciado
¿Cuál es la función del flagelo en ciertas especies de bacterias y células animales como los espermatozoides?

### Opciones
- [x] A) Proporcionar locomoción y movilidad celular en medios líquidos <!-- feedback: ¡Correcto! Los flagelos son apéndices motores que permiten a la célula desplazarse de forma activa a través de fluidos. -->
- [ ] B) Facilitar la transferencia horizontal de plásmidos de resistencia bacteriana <!-- feedback: Incorrecto. El pili sexual (pili) es la estructura encargada de la conjugación, no el flagelo. -->
- [ ] C) Anclar la célula firmemente a las superficies inertes del sustrato <!-- feedback: Incorrecto. Las fimbrias y cápsulas bacterianas median la adhesión celular al sustrato externo. -->
- [ ] D) Captar luz solar y canalizarla hacia los centros de reacción metabólica <!-- feedback: Incorrecto. La luz es captada por fotorreceptores o pigmentos fotosintéticos en membranas especializadas. -->

### Explicacion Pedagogica
El flagelo bacteriano funciona como un motor rotatorio impulsado por fuerza protón-motriz, mientras que el flagelo eucariota tiene una estructura de microtúbulos (9+2) y se mueve por flexión.
...
**Contexto:** Durante una actividad de laboratorio en el Colegio Nacional Dr. Raúl Peña de Caacupé, Camila y su grupo investigan sobre Célula eucariota y procariota.

### Enunciado
¿Qué componente de la envoltura celular procarionte bacteriana, situado externamente a la pared celular de peptidoglucano, contribuye a evadir la fagocitosis por células inmunitarias y previene la desecación?

### Opciones
- [x] A) La cápsula <!-- feedback: ¡Correcto! La cápsula bacteriana es una capa mucilaginosa de polisacáridos que actúa como factor de virulencia, protegiendo a la bacteria de la fagocitosis. -->
- [ ] B) La membrana externa de lipopolisacáridos <!-- feedback: Incorrecto. La membrana externa es característica de bacterias Gram-negativas, pero la capa antifagocítica más externa es la cápsula. -->
- [ ] C) El glucocálix proteico interno <!-- feedback: Incorrecto. El glucocálix se encuentra en células animales y sirve para adhesión y reconocimiento celular, no como cápsula bacteriana. -->
- [ ] D) Los microfilamentos de queratina externa <!-- feedback: Incorrecto. La queratina es una proteína del citoesqueleto eucariota animal, ausente en bacterias. -->

### Explicacion Pedagogica
La cápsula bacteriana es una estructura facultativa presente en algunas bacterias patógenas, aumentando significativamente su patogenicidad.
...
**Contexto:** Durante una actividad de laboratorio en el Colegio Nacional San José de Concepción de Concepción, Ramón y su grupo investigan sobre Célula eucariota y procariota.
...
**Contexto:** Durante una actividad de laboratorio en el Colegio Nacional Encarnación de Encarnación, Ramón y su grupo investigan sobre Célula eucariota y procariota.
...
**Contexto:** Durante una actividad de laboratorio en el Colegio Nacional de Pilar de Pilar, Jorge y su grupo investigan sobre Célula eucariota y procariota.
...
### Explicacion Pedagogica
La actina es el componente principal de los microfilamentos del citoesqueleto, implicada en funciones de motilidad, adhesión celular y la estrangulación del citoplasma al final de la mitosis.
...
**Contexto:** Durante una actividad de laboratorio en el Colegio Nacional San José de Concepción de Concepción, Martina y su grupo investigan sobre Célula eucariota y procariota.
...
### Explicacion Pedagogica
El nucléolo no está rodeado por membrana plasmática propia; es un condensado de proteínas y ácidos nucleicos que rodea las regiones organizadoras nucleolares (NOR).
...
### Explicacion Pedagogica
El coeficiente de sedimentación (Svedberg, S) mide la velocidad con la que sedimenta una partícula en una ultracentrífuga, dependiendo de su masa y forma geométrica.
...
**Contexto:** Durante una actividad de laboratorio en el Colegio Nacional Ortiz Guerrero de Villarrica, Sofía y su grupo investigan sobre Célula eucariota y procariota.
...
### Explicacion Pedagogica
La membrana del lisosoma posee bombas de protones que bombean activamente iones hidrógeno desde el citosol (pH ~7.2) hacia el interior para mantener el pH ácido.
...
**Contexto:** Durante una actividad de laboratorio en el Colegio Nacional de Pilar de Pilar, Benjamín y su grupo investigan sobre Célula eucariota y procariota.
...
### Explicacion Pedagogica
Los cloroplastos realizan la fotosíntesis convirtiendo energía electromagnética en energía química almacenada en azúcares, donde la clorofila actúa como receptor primario de fotones.
...
**Contexto:** Durante una actividad de laboratorio en el Colegio Nacional Ortiz Guerrero de Villarrica, Joaquín y su grupo investigan sobre Célula eucariota y procariota.
...
### Explicacion Pedagogica
La teoría endosimbiótica se ve reforzada por el hecho de que la composición lipídica de la membrana interna de mitocondrias posee cardiolipina, típico de bacterias.
...
**Contexto:** Durante una actividad de laboratorio en el Colegio Nacional Dr. Pedro P. Peña de Coronel Oviedo, Liz y su grupo investigan sobre Célula eucariota y procariota.
...
### Explicacion Pedagogica
La taxonomía de tres dominios propuesta por Carl Woese clasifica la vida en Bacteria, Archaea y Eukarya basándose en diferencias moleculares.
...
**Contexto:** Durante una actividad de laboratorio en el Colegio Nacional San José de Concepción de Concepción, Jorge y su grupo investigan sobre Célula eucariota y procariota.
...
### Explicacion Pedagogica
El complejo del poro nuclear (NPC) es una de las estructuras proteicas más grandes de la célula, permitiendo la difusión pasiva de metabolitos y controlando de forma activa el paso de macromoléculas.
