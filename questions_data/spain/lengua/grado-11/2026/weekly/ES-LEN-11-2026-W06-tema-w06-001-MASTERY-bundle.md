---
id: "ES-LEN-11-2026-W06-tema-w06-001-MASTERY-bundle"
country: "spain"
grado: 11
asignatura: "lengua"
tema: "tema-w06"
...
# Bundle MASTERY: El texto expositivo - Grado 11

Este bundle contiene 20 preguntas sobre la estructura y características formales de los textos expositivos (divulgativos vs especializados, esquemas de organización deductiva, inductiva, encuadrada y paralela, recursos morfosintácticos como la nominalización y la pasiva refleja, progresión temática y adecuación didáctica) según el currículo LOMLOE en España.

---
## Question 1 [D3-D4]
**ID:** ES-LEN-11-2026-W06-tema-w06-001-MASTERY-bundle-v1
**Bloom:** Remember
**EJE:** Tipología textual
**Expected_Success:** 0.88
**Contexto:** Un profesor de selectividad en un instituto de Madrid analiza cómo clasificar los textos según el público al que van dirigidos.
### Enunciado
...
- [ ] D) Son sinónimos perfectos y la lingüística descriptiva moderna ha unificado ambos tipos de textos.
  <!-- feedback: Incorrecto. Mantener su distinción es clave para evaluar la adecuación lingüística del emisor. -->

### Explicacion Pedagogica
El texto expositivo se divide en divulgativo (público general, fin informativo general, aclaraciones frecuentes) y especializado (público experto, tecnicismos abundantes, léxico riguroso y sintaxis compleja).

---

## Question 2 [D3-D4]
**ID:** ES-LEN-11-2026-W06-tema-w06-001-MASTERY-bundle-v2
**Bloom:** Understand
**EJE:** Tipología textual
**Expected_Success:** 0.85
**Contexto:** Un fragmento científico sobre vacunas en Barcelona comienza declarando la tesis principal: 'La vacunación es el método más eficaz de salud pública'. A continuación, desarrolla las pruebas de laboratorio y estadísticas que la avalan.
### Enunciado
¿Qué tipo de estructura organizativa presenta este texto de acuerdo con la posición de la idea principal?

### Opciones
- [x] A) Analizante o deductiva, puesto que la tesis o idea principal se sitúa al inicio del fragmento y después se desarrollan los casos particulares y argumentos.
  <!-- feedback: Correcto. La estructura analizante o deductiva parte de lo general (la idea principal o tesis al inicio) y desciende a lo particular (detalles o pruebas). -->
- [ ] B) Sintetizante o inductiva, porque la tesis principal se oculta en el último renglón de la página.
  <!-- feedback: Incorrecto. La sintetizante iría de lo particular al inicio para concluir con la idea principal al final del texto. -->
- [ ] C) Estructura paralela, donde todas las frases se repiten al unísono de forma poética.
  <!-- feedback: Incorrecto. La paralela expone ideas de idéntico valor conceptual sin subordinarse a una tesis inicial. -->
- [ ] D) Dequeísmo estructural, por omitir preposiciones en el desarrollo de la idea principal.
  <!-- feedback: Incorrecto. El dequeísmo es un error morfosintáctico de régimen preposicional, no un esquema de organización textual. -->

### Explicacion Pedagogica
La estructura deductiva o analizante coloca la idea directriz o tesis en la introducción, procediendo luego al análisis pormenorizado, la demostración de detalles o la ejemplificación.

---

## Question 3 [D3-D4]
**ID:** ES-LEN-11-2026-W06-tema-w06-001-MASTERY-bundle-v3
**Bloom:** Understand
**EJE:** Tipología textual
**Expected_Success:** 0.83
**Contexto:** Un texto explicativo sobre el cambio climático detalla primero la subida de las emisiones de carbono, el deshielo de los glaciares y el aumento de sequías, para concluir afirmando al final: 'Por todo ello, la emergencia climática global es innegable'.
### Enunciado
...
### Explicacion Pedagogica
La estructura sintetizante o inductiva conduce al receptor a través de una serie de premisas, explicaciones o ejemplos parciales, extrayendo la conclusión o tesis general en la parte de cierre.

---

## Question 4 [D3-D4]
**ID:** ES-LEN-11-2026-W06-tema-w06-001-MASTERY-bundle-v4
**Bloom:** Remember
**EJE:** Sintaxis y morfología
**Expected_Success:** 0.81
**Contexto:** Un corrector de estilo en un manual de geografía de España prefiere sustituir la oración 'El río se desborda con frecuencia' por 'La frecuencia de los desbordamientos fluviales es alta'.
### Enunciado
...
- [ ] D) Dequeísmo nominal que exige la preposición 'de' antes del complemento directo.
  <!-- feedback: Incorrecto. Es un cambio de categoría gramatical lícito y gramatical, libre de dequeísmo. -->

### Explicacion Pedagogica
Las nominalizaciones abundan en el registro expositivo científico. Al sustituir acciones dinámicas (verbos) por conceptos fijos (sustantivos abstractos), se dota al discurso de mayor densidad intelectual y abstracción.

---

## Question 5 [D5-D6]
**ID:** ES-LEN-11-2026-W06-tema-w06-001-MASTERY-bundle-v5
**Bloom:** Understand
**EJE:** Tipología textual
**Expected_Success:** 0.79
**Contexto:** En un fragmento sobre astrofísica de Madrid se lee: 'La energía oscura compone el mayor misterio del universo actual (TESIS)... los astrónomos miden el fondo cósmico... por lo tanto, la naturaleza íntima de la energía oscura sigue oculta para la ciencia peninsular (REFORMULACIÓN)'.
### Enunciado
...
### Explicacion Pedagogica
La estructura encuadrada presenta un carácter circular sumamente didáctico. El emisor expone una idea inicial (deducción), aporta explicaciones detalladas y la reafirma en el cierre (inducción), facilitando la fijación conceptual.

---

## Question 6 [D5-D6]
**ID:** ES-LEN-11-2026-W06-tema-w06-001-MASTERY-bundle-v6
**Bloom:** Apply
**EJE:** Tipología textual
**Expected_Success:** 0.77
**Contexto:** Un estudiante compara dos textos en Valencia. El Texto A es una noticia de prensa titulada 'Nuevas bacterias en los ríos' y el Texto B es una tesis de doctorado titulada 'Aislamiento e identificación taxonómica de cepas bacterianas anaerobias en humedales fluviales'.
### Enunciado
...
- [ ] D) Se diferencian porque el Texto B incurre en dequeísmo de objeto directo de forma obligatoria.
  <!-- feedback: Incorrecto. El Texto B es académicamente modélico y cumple con el régimen preposicional estándar. -->

### Explicacion Pedagogica
La tipología expositiva discrimina entre textos divulgativos (como el periodismo de información o libros de texto escolares) y especializados (como monografías científicas, patentes y tesis doctorales) en función de la competencia exigida al receptor.

---

## Question 7 [D5-D6]
**ID:** ES-LEN-11-2026-W06-tema-w06-001-MASTERY-bundle-v7
**Bloom:** Apply
**EJE:** Sintaxis y morfología
**Expected_Success:** 0.81
**Contexto:** Un texto expositivo de Zaragoza explica un concepto matemático de la siguiente manera: 'Los números primos son aquellos que solo poseen dos divisores, a saber, el uno y ellos mismos'.
### Enunciado
...
### Explicacion Pedagogica
Los conectores explicativos o reformuladores son cruciales en los textos expositivos para garantizar la claridad y la progresión temática, guiando al lector en la correcta interpretación de los tecnicismos o definiciones anteriores.

---

## Question 8 [D5-D6]
**ID:** ES-LEN-11-2026-W06-tema-w06-001-MASTERY-bundle-v8
**Bloom:** Apply
**EJE:** Sintaxis y morfología
**Expected_Success:** 0.74
**Contexto:** En un tratado de física en Sevilla se lee: 'Se han medido las fuerzas nucleares con gran precisión. Para ello, se hicieron rebotar protones en un acelerador'.
### Enunciado
¿Qué recurso sintáctico de objetividad se manifiesta en las estructuras 'Se han medido' y 'se hicieron'?

### Opciones
- [x] A) Pasiva refleja, que oculta el agente de la acción para priorizar el proceso científico de forma impersonal y objetiva.
  <!-- feedback: Correcto. La pasiva refleja ('Se han medido', 'se hicieron rebotar') es un recurso sintáctico de distanciamiento que oculta al emisor y aporta objetividad. -->
- [ ] B) Perífrasis verbal de obligación que exige de forma imperativa estudiar la física del átomo.
  <!-- feedback: Incorrecto. Son formas pasivas reflejas ordinarias de indicativo, desprovistas de valores modales de obligación de perífrasis. -->
- [ ] C) Un leísmo de persona directo madrileño aceptado en Sevilla.
  <!-- feedback: Incorrecto. No hay ninguna confusión pronominal de objeto directo; son morfemas de pasiva refleja. -->
- [ ] D) Estilo directo libre que reproduce los gritos de asombro de los protones.
  <!-- feedback: Incorrecto. Los protones carecen de voz lingüística directa o indirecta. -->

### Explicacion Pedagogica
La objetividad e impersonalidad de la prosa científica y expositiva se apoya en mecanismos sintácticos como la pasiva refleja con 'se' y las oraciones impersonales semánticas, restando protagonismo al sujeto humano agente para resaltar los hechos medibles.

---

## Question 9 [D5-D6]
**ID:** ES-LEN-11-2026-W06-tema-w06-001-MASTERY-bundle-v9
**Bloom:** Apply
**EJE:** Tipología textual
**Expected_Success:** 0.78
**Contexto:** Un geógrafo de Barcelona expone: 'El territorio peninsular español comprende tres grandes zonas climáticas: en primer lugar, el clima oceánico lluvioso del norte; en segundo lugar, el clima mediterráneo cálido en el este e interior; y por último, el clima de montaña en las cordilleras'.
### Enunciado
...
### Explicacion Pedagogica
La estructura paralela (o de clasificación/enumeración) presenta ideas o hechos sucesivos con idéntico valor conceptual y sin jerarquía de subordinación entre sí, facilitando la asimilación ordenada de clasificaciones.

---

## Question 10 [D5-D6]
**ID:** ES-LEN-11-2026-W06-tema-w06-001-MASTERY-bundle-v10
**Bloom:** Understand
**EJE:** Semántica y léxico
**Expected_Success:** 0.80
**Contexto:** En un fragmento de informática sobre inteligencia artificial se emplean términos de reciente cuño como 'algoritmo generativo', 'red neuronal profunda' y 'aprendizaje por refuerzo'.
### Enunciado
...
- [ ] D) Metáforas poéticas románticas que expresan melancolía amorosa por los algoritmos.
  <!-- feedback: Incorrecto. Aunque 'red neuronal' tiene un origen metafórico biológico, en informática funciona como tecnicismo denotativo monosémico preciso. -->

### Explicacion Pedagogica
Los tecnicismos garantizan la monosemia (un solo significado para cada significante) y la univocidad en el discurso expositivo de especialidad, desterrando la ambigüedad y la connotación propias de la lírica.

---

## Question 11 [D7-D8]
**ID:** ES-LEN-11-2026-W06-tema-w06-001-MASTERY-bundle-v11
**Bloom:** Analyze
**EJE:** Sintaxis y morfología
**Expected_Success:** 0.63
**Contexto:** Un fragmento de geología de Barcelona reza: 'Se observaron (1) alteraciones en los estratos arcillosos. Se supone (2) que el agua subterránea causó la erosión'.
### Enunciado
...
- [ ] D) Representan un dequeísmo atroz que anula la concordancia verbal del participio.
  <!-- feedback: Incorrecto. No hay preposición 'de' antes del nexo subordinado, lo que demuestra la total corrección formal de las frases. -->

### Explicacion Pedagogica
La gramática de la RAE distingue entre las pasivas reflejas (que admiten concordancia en plural: 'Se abren las puertas') y las impersonales con 'se' (que carecen de sujeto sintáctico expreso y se conjugan siempre en tercera persona del singular: 'Se vive bien aquí'). Ambas se emplean en la exposición científica para garantizar la impersonalidad.

---

## Question 12 [D7-D8]
**ID:** ES-LEN-11-2026-W06-tema-w06-001-MASTERY-bundle-v12
**Bloom:** Analyze
**EJE:** Tipología textual
**Expected_Success:** 0.65
**Contexto:** En un texto académico de Soria se expone el funcionamiento de la fotosíntesis: 'La fotosíntesis es (1) la conversión de materia inorgánica en orgánica. Por ejemplo, (2) las plantas absorben dióxido de carbono. En resumidas cuentas, (3) transforma la energía de la luz'.
### Enunciado
...
### Explicacion Pedagogica
Para guiar con éxito la progresión temática, el emisor de un texto expositivo combina definiciones (para fijar conceptos), ejemplificaciones (para concretar abstracciones) y reformulaciones (para recapitular ideas clave).

---

## Question 13 [D7-D8]
**ID:** ES-LEN-11-2026-W06-tema-w06-001-MASTERY-bundle-v13
**Bloom:** Analyze
**EJE:** Sintaxis y morfología
**Expected_Success:** 0.62
**Contexto:** Un fragmento de geografía física de Sevilla afirma: 'La atmósfera terrestre retiene (1) el calor del Sol. Los vientos distribuyen (2) esta energía de forma global'.
### Enunciado
...
- [ ] D) Perífrasis modal de conjetura o probabilidad de la RAE.
  <!-- feedback: Incorrecto. Son formas verbales simples de indicativo que expresan certeza fáctica, no conjetura o conjetura de posibilidad. -->

### Explicacion Pedagogica
El presente gnomónico o atemporal es el tiempo verbal por excelencia de la prosa científica y expositiva de leyes. Al despojar al verbo de límites temporales concretos (pasado o futuro), asimila el enunciado a una verdad de validez permanente.

---

## Question 14 [D7-D8]
**ID:** ES-LEN-11-2026-W06-tema-w06-001-MASTERY-bundle-v14
**Bloom:** Analyze
**EJE:** Tipología textual
**Expected_Success:** 0.60
**Contexto:** En una clase de bachillerato en Salamanca, se analiza la progresión de la información de un texto: 'El lince ibérico es un felino amenazado. Este mamífero carnívoro habita en Doñana... Su dieta se basa en conejos...'.
### Enunciado
...
### Explicacion Pedagogica
La cohesión y claridad de un texto expositivo depende de la progresión temática. En la progresión de tema constante, un mismo tema sirve de hilo conductor sintáctico y recibe nuevas informaciones (remas) sucesivamente.

---

## Question 15 [D7-D8]
**ID:** ES-LEN-11-2026-W06-tema-w06-001-MASTERY-bundle-v15
**Bloom:** Analyze
**EJE:** Tipología textual
**Expected_Success:** 0.58
**Contexto:** Un folleto informativo sobre el reciclaje urbano distribuido por el Ayuntamiento de Valencia organiza las instrucciones en párrafos precedidos por: 'En primer lugar...', 'En segundo lugar...', 'Por último...'.
### Enunciado
...
- [ ] D) Adjetivos especificativos antepuestos que expresan la belleza poética del reciclaje.
  <!-- feedback: Incorrecto. No son adjetivos de base atributiva nominal; son locuciones conectoras discursivas fijas. -->

### Explicacion Pedagogica
Los marcadores de ordenación discursiva pertenecen a la cohesión textual. Su presencia es indispensable en la tipología expositiva e instructiva para estructurar las fases del razonamiento o los pasos de un método de manera transparente.

---

## Question 16 [D7-D8]
**ID:** ES-LEN-11-2026-W06-tema-w06-001-MASTERY-bundle-v16
**Bloom:** Analyze
**EJE:** Comunicación
**Expected_Success:** 0.59
**Contexto:** Un artículo de divulgación científica publicado por el CSIC en Madrid expone la estructura interna de la Tierra detallando las propiedades del manto y el núcleo.
### Enunciado
...
### Explicacion Pedagogica
El fin de los textos de base expositiva es la transmisión rigurosa de conocimientos verídicos sobre el entorno. Por consiguiente, la función referencial o representativa organiza de forma prioritaria la morfología, sintaxis y semántica del discurso.

---

## Question 17 [D9-D10]
**ID:** ES-LEN-11-2026-W06-tema-w06-001-MASTERY-bundle-v17
**Bloom:** Evaluate
**EJE:** Tipología textual
**Expected_Success:** 0.54
**Contexto:** Un folleto de divulgación médica para prevenir la diabetes entre escolares de Zaragoza abunda en tecnicismos biológicos complejos y nombres de enzimas microscópicas en latín sin ofrecer aclaraciones ni glosarios prácticos.
### Enunciado
...
### Explicacion Pedagogica
La adecuación es una de las propiedades textuales esenciales. Un texto expositivo de carácter divulgativo dirigido a niños debe adecuar su léxico, sintaxis y recursos aclaratorios (glosarios, ejemplos) para garantizar una decodificación exitosa sin pérdidas de información preventiva.

---

## Question 18 [D9-D10]
**ID:** ES-LEN-11-2026-W06-tema-w06-001-MASTERY-bundle-v18
**Bloom:** Evaluate
**EJE:** Tipología textual
**Expected_Success:** 0.52
**Contexto:** Un artículo que pretende ser una exposición científica sobre energías renovables en Barcelona introduce valoraciones subjetivas constantes del autor como: 'La energía solar es mi preferida porque me recuerda los días de playa, mientras que la eólica me parece fría, gris y espantosa'.
### Enunciado
Evalúa el rigor y la coherencia metodológica de este fragmento como texto de base expositiva.

### Opciones
- [x] A) Carece de rigor y coherencia tipológica, al contaminar la exposición objetiva de datos reales con opiniones personales y adjetivación emotiva connotativa que contradicen el fin denotativo unívoco de las ciencias.
  <!-- feedback: Correcto. El discurso expositivo-científico se desvirtúa si el emisor introduce valoraciones sentimentales íntimas, destruyendo la neutralidad metodológica y la objetividad denotativa exigida. -->
- [ ] B) Es un uso brillante de la estructura encuadrada circular del español de Cataluña.
  <!-- feedback: Incorrecto. Es una burda inadecuación de estilo que desvirtúa la neutralidad de la exposición técnica científica, no un logro estructural literario. -->
- [ ] C) Es correcto ya que el presente atemporal de indicativo exige declarar el amor por la playa.
  <!-- feedback: Incorrecto. El presente atemporal describe leyes naturales estables, sin guardar relación con gustos o añoranzas de las vacaciones personales del orador. -->
- [ ] D) Demuestra que las energías renovables se rigen de forma obligatoria por la función fática del lenguaje.
  <!-- feedback: Incorrecto. Se rigen por la función representativa o referencial; la fática se limita a comprobar el canal físico. -->

### Explicacion Pedagogica
El discurso expositivo de carácter científico o técnico exige la supresión de la subjetividad (función expresiva). Mezclar opiniones líricas o gustos personales con datos físicos destruye la objetividad, univocidad y rigor denotativo indispensables de la tipología.

---

## Question 19 [D9-D10]
**ID:** ES-LEN-11-2026-W06-tema-w06-001-MASTERY-bundle-v19
**Bloom:** Evaluate
**EJE:** Tipología textual
**Expected_Success:** 0.50
**Contexto:** Un redactor de contenidos de una web de naturaleza en Doñana decide presentar una guía sobre el lince ibérico con una estructura analizante (tesis al inicio, seguida de explicaciones pormenorizadas).
### Enunciado
...
- [ ] D) Se invalida la analizante porque los felinos de Doñana exigen de forma obligatoria el uso de oraciones exclamativas líricas en los títulos.
  <!-- feedback: Incorrecto. Los felinos son el referente real, ajenos a imperativos o exigencias retóricas en el título de la página web. -->

### Explicacion Pedagogica
La elección de la macroestructura textual debe adecuarse al medio y fin. Para páginas web de información rápida, la estructura analizante (deductiva) resulta óptima al situar la idea principal (tesis) en la cabecera, favoreciendo la legibilidad inmediata frente a la sintetizante que reserva la conclusión para el final.

---

## Question 20 [D9-D10]
**ID:** ES-LEN-11-2026-W06-tema-w06-001-MASTERY-bundle-v20
**Bloom:** Evaluate
**EJE:** Tipología textual
**Expected_Success:** 0.55
**Contexto:** Un grupo de expertos evalúa un borrador de libro de texto de Biología de 2º de Bachillerato redactado bajo la LOMLOE en Zaragoza. El borrador contiene explicaciones lógicas de la mitosis con abundante apoyo visual de esquemas numerados y un glosario con los tecnicismos más arduos definidos de forma precisa.
### Enunciado
...
### Explicacion Pedagogica
El discurso expositivo de carácter docente (libros de texto de bachillerato de la LOMLOE) debe diseñarse de forma multimodal. La inclusión de glosarios léxicos y diagramas visuales (códigos no verbales de anclaje) es una práctica modélica que dota de andamiaje cognitivo al alumno de bachillerato para asimilar la densidad de los tecnicismos científicos de la mitosis celular.
