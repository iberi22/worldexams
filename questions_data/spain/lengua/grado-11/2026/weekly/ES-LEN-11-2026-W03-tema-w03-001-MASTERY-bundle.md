---
id: "ES-LEN-11-2026-W03-tema-w03-001-MASTERY-bundle"
country: "spain"
grado: 11
asignatura: "lengua"
tema: "tema-w03"
...
# Bundle MASTERY: Variedades lingüísticas de España - Grado 11

Este bundle contiene 20 preguntas sobre las variedades diatópicas, diastráticas, diafásicas y diacrónicas del español, analizando el andaluz, el canario, el español de América, el argot juvenil, el plurilingüismo constitucional y la diglosia en España.

---
## Question 1 [D3-D4]
**ID:** ES-LEN-11-2026-W03-tema-w03-001-MASTERY-bundle-v1
**Bloom:** Remember
**EJE:** Lengua y sociedad
**Expected_Success:** 0.88
**Contexto:** Un conferenciante en Valencia explica la influencia de la geografía, el nivel cultural y la situación concreta en el habla.
### Enunciado
...
- [ ] D) Variedades diacrónicas, que estudian la lengua de forma estática en un año fijo.
  <!-- feedback: Incorrecto. Las diacrónicas se refieren al cambio lingüístico a lo largo del tiempo histórico. -->

### Explicacion Pedagogica
Las variedades diatópicas (del griego 'topos', lugar) corresponden a las variaciones geográficas que presenta una lengua, dando origen a los dialectos, hablas locales y variantes regionales.

---

## Question 2 [D3-D4]
**ID:** ES-LEN-11-2026-W03-tema-w03-001-MASTERY-bundle-v2
**Bloom:** Understand
**EJE:** Lengua y sociedad
**Expected_Success:** 0.84
**Contexto:** Un manual de sociolingüística utilizado en Sevilla analiza cómo las personas de distintos estratos culturales emplean el español.
### Enunciado
¿Qué representa un 'sociolecto' o variedad diastrática de la lengua?

### Opciones
- [x] A) El conjunto de hábitos lingüísticos y léxicos que caracterizan a un grupo social o nivel sociocultural concreto.
  <!-- feedback: Correcto. La variedad diastrática o sociolecto refleja la pertenencia del hablante a un estrato social o nivel de instrucción culural. -->
- [ ] B) El cambio morfológico de las preposiciones cuando viajan en tren de Sevilla a Madrid.
  <!-- feedback: Incorrecto. Es una explicación absurda ajena a la teoría sociolingüística de los niveles de lengua. -->
- [ ] C) El acento geográfico y entonación de los canarios en sus islas.
  <!-- feedback: Incorrecto. El acento de Canarias es una variedad diatópica o geográfica, no diastrática. -->
- [ ] D) El registro formal escrito que los científicos utilizan de forma obligatoria en toda la Unión Europea.
  <!-- feedback: Incorrecto. Los lenguajes específicos profesionales son registros situacionales (diafásicos), no estratos sociales directos. -->

### Explicacion Pedagogica
Las variedades diastráticas o sociolectos representan la variación social de la lengua. Se estructuran en niveles (culto, medio, popular/vulgar) según el grado de instrucción académica del hablante.

---

## Question 3 [D3-D4]
**ID:** ES-LEN-11-2026-W03-tema-w03-001-MASTERY-bundle-v3
**Bloom:** Understand
**EJE:** Lengua y sociedad
**Expected_Success:** 0.82
**Contexto:** En una entrevista de trabajo en Madrid, el candidato modifica su léxico habitual y evita el uso de muletillas o coloquialismos.
### Enunciado
...
- [ ] D) El dialecto septentrional español que exige suprimir los verbos transitivos en Madrid.
  <!-- feedback: Incorrecto. No se suprimen verbos transitivos en Madrid; se modula el léxico y la sintaxis. -->

### Explicacion Pedagogica
Las variedades diafásicas o registros lingüísticos se adecúan al contexto, la relación entre emisor y receptor, el canal (oral o escrito) y el tema tratado, oscilando entre los extremos formal e informal.

---

## Question 4 [D3-D4]
**ID:** ES-LEN-11-2026-W03-tema-w03-001-MASTERY-bundle-v4
**Bloom:** Remember
**EJE:** Lengua y sociedad
**Expected_Success:** 0.81
**Contexto:** Durante una clase sobre historia del español en Barcelona, se analiza el uso de las lenguas maternas en las regiones bilingües.
### Enunciado
...
- [ ] D) El uso obligatorio del latín medieval en el Metro de Madrid por orden de la RAE.
  <!-- feedback: Incorrecto. El latín medieval no es de uso oficial en el metro, la diglosia no se refiere a lenguas muertas arcaicas. -->

### Explicacion Pedagogica
La diglosia es un fenómeno social donde coexisten dos lenguas o variedades en una misma comunidad, pero con una distribución desigual de funciones: una variedad 'alta' (formal, administrativa, literaria) y otra 'baja' (familiar, coloquial).

---

## Question 5 [D5-D6]
**ID:** ES-LEN-11-2026-W03-tema-w03-001-MASTERY-bundle-v5
**Bloom:** Understand
**EJE:** Lengua y sociedad
**Expected_Success:** 0.78
**Contexto:** Un turista madrileño viaja a Cádiz y nota que los lugareños pronuncian de forma idéntica las palabras 'casa' y 'caza', sibilando con la consonante alveolar s.
### Enunciado
¿Qué rasgo fonético dialectal del andaluz occidental se evidencia en este fenómeno?

### Opciones
- [x] A) Seseo, consistente en la igualación de los fonemas /θ/ y /s/ en favor del fonema alveolar /s/.
  <!-- feedback: Correcto. El seseo neutraliza la oposición entre la s de 'casa' y la z de 'caza' pronunciando ambas como s, rasgo típico del andaluz occidental y canario. -->
- [ ] B) Ceceo, que consiste en pronunciar el fonema alveolar /s/ metiendo la lengua como si fuera /θ/ en 'zapatos'.
  <!-- feedback: Incorrecto. El ceceo es el fenómeno inverso: igualar en favor de la z ('caza' para referirse a la 'casa'). -->
- [ ] C) Yeísmo, porque el gaditano confunde la doble ll de 'llave' con la y de 'yema'.
  <!-- feedback: Incorrecto. El yeísmo afecta a las consonantes laterales/palatales y no a las sibilantes de 'casa/caza'. -->
- [ ] D) Rotacismo, ya que sustituye sistemáticamente la letra d por la r en todos los participios.
  <!-- feedback: Incorrecto. El rotacismo es el cambio de consonantes por r, ajeno al seseo de las sibilantes. -->

### Explicacion Pedagogica
El seseo es la neutralización de los fonemas sibilantes predorsal /s/ y dental /θ/ en favor de la /s/. Es un rasgo dialectal plenamente correcto y prestigioso en Andalucía occidental, Canarias y toda Hispanoamérica.

---

## Question 6 [D5-D6]
**ID:** ES-LEN-11-2026-W03-tema-w03-001-MASTERY-bundle-v6
**Bloom:** Apply
**EJE:** Lengua y sociedad
**Expected_Success:** 0.76
**Contexto:** En un instituto de enseñanza secundaria de Toledo, dos adolescentes hablan en el patio usando términos como 'estoy rayado', 'eso mola mazo' y 'es un canteo'.
### Enunciado
...
### Explicacion Pedagogica
El argot juvenil es una variedad de lengua informal y efímera que los jóvenes utilizan para diferenciarse y consolidar su identidad grupal, caracterizado por metáforas, juegos de palabras y constante renovación léxica.

---

## Question 7 [D5-D6]
**ID:** ES-LEN-11-2026-W03-tema-w03-001-MASTERY-bundle-v7
**Bloom:** Apply
**EJE:** Lengua y sociedad
**Expected_Success:** 0.79
**Contexto:** Un locutor de radio de Las Palmas de Gran Canaria da las noticias del mediodía pronunciando 'los niños' como 'loh niño' con una suave aspiración de la consonante s implosiva.
### Enunciado
...
### Explicacion Pedagogica
El español de Canarias comparte rasgos fonéticos con el andaluz y el español de América, destacando el seseo, el yeísmo y la aspiración o elisión de la /s/ implosiva, realizaciones dialectales legítimas y prestigiosas.

---

## Question 8 [D5-D6]
**ID:** ES-LEN-11-2026-W03-tema-w03-001-MASTERY-bundle-v8
**Bloom:** Apply
**EJE:** Semántica y léxico
**Expected_Success:** 0.75
**Contexto:** Un estudiante de intercambio en Madrid nota que mientras él pide un 'celular' y toma el 'camión', sus compañeros españoles piden el 'móvil' y toman el 'autobús'.
### Enunciado
...
### Explicacion Pedagogica
La riqueza del español radica en su variedad diatópica. Diversas regiones del mundo hispanohablante adoptan diferentes vocablos (móvil/celular, coche/carro/auto) para denominar las mismas realidades.

---

## Question 9 [D5-D6]
**ID:** ES-LEN-11-2026-W03-tema-w03-001-MASTERY-bundle-v9
**Bloom:** Understand
**EJE:** Semántica y léxico
**Expected_Success:** 0.74
**Contexto:** En una conversación informal en Zaragoza, una persona mayor utiliza el término 'albericoque' y 'asín', expresiones que sus nietos ya no utilizan.
### Enunciado
...
### Explicacion Pedagogica
La lengua experimenta cambios a lo largo del tiempo (variación diacrónica). Los hablantes de mayor edad suelen mantener formas léxicas o gramaticales tradicionales (arcaísmos o variantes generacionales) que la juventud sustituye.

---

## Question 10 [D5-D6]
**ID:** ES-LEN-11-2026-W03-tema-w03-001-MASTERY-bundle-v10
**Bloom:** Understand
**EJE:** Sintaxis y morfología
**Expected_Success:** 0.73
**Contexto:** Un filólogo español viaja a Buenos Aires (Argentina) y observa que la gente conjuga de manera diferente la segunda persona del singular: 'vos sabés' en lugar de 'tú sabes'.
### Enunciado
...
### Explicacion Pedagogica
El voseo es el uso del pronombre 'vos' como segunda persona del singular, acompañado de conjugaciones verbales propias derivadas de las antiguas formas de segunda persona del plural. Es la norma estándar culta en el Río de la Plata.

---

## Question 11 [D7-D8]
**ID:** ES-LEN-11-2026-W03-tema-w03-001-MASTERY-bundle-v11
**Bloom:** Analyze
**EJE:** Lengua y sociedad
**Expected_Success:** 0.65
**Contexto:** Un alumno lee un fragmento de una obra dramática de Lorca: 'A la caridá del cielo no se le pone límite'. El alumno detecta 'caridá' en lugar de 'caridad'.
### Enunciado
...
### Explicacion Pedagogica
La pérdida de la consonante /d/ final de palabra es una tendencia fonética secular del español peninsular, especialmente acusada en las hablas andaluzas y canarias, empleada con fines estilísticos en la literatura regionalista.

---

## Question 12 [D7-D8]
**ID:** ES-LEN-11-2026-W03-tema-w03-001-MASTERY-bundle-v12
**Bloom:** Analyze
**EJE:** Semántica y léxico
**Expected_Success:** 0.62
**Contexto:** En un estudio lexicográfico en Madrid, se analiza la procedencia de palabras cotidianas en el argot popular como 'parné' (dinero), 'molar' (gustar) y 'currar' (trabajar).
### Enunciado
...
- [ ] D) De una jerga marítima canaria exclusiva de la pesca del atún.
  <!-- feedback: Incorrecto. Provienen del caló y se difundieron por toda la península, especialmente en el habla de Madrid. -->

### Explicacion Pedagogica
El caló es la lengua de la comunidad gitana española. A lo largo de la historia, ha transferido numerosos términos al habla informal de la sociedad mayoritaria, enriqueciendo el registro coloquial y el argot popular.

---

## Question 13 [D7-D8]
**ID:** ES-LEN-11-2026-W03-tema-w03-001-MASTERY-bundle-v13
**Bloom:** Analyze
**EJE:** Sintaxis y morfología
**Expected_Success:** 0.61
**Contexto:** Un profesor de filología en Santander (Cantabria) detecta que algunos alumnos redactan frases condicionales de la siguiente manera: 'Si tendría dinero, compraría el coche'.
### Enunciado
...
### Explicacion Pedagogica
La norma académica estándar prescribe el uso del pretérito imperfecto de subjuntivo en la oración subordinada condicional (prótasis) introducida por 'si' ('Si tuviera tiempo, iría'). El uso del condicional simple en esta posición ('Si tendría tiempo...') es un regionalismo del norte peninsular evitado en la norma escrita culta.

---

## Question 14 [D7-D8]
**ID:** ES-LEN-11-2026-W03-tema-w03-001-MASTERY-bundle-v14
**Bloom:** Analyze
**EJE:** Lengua y sociedad
**Expected_Success:** 0.66
**Contexto:** Un actor ensaya un papel en Madrid y decide pronunciar exactamente igual la palabra 'pollo' y 'poyo', igualando los fonemas correspondientes.
### Enunciado
...
### Explicacion Pedagogica
El yeísmo es la neutralización fonológica de la oposición /ʎ/ (palatal lateral sorda, escrita 'll') y /ʝ/ (palatal fricativa sonora, escrita 'y') a favor de la segunda. En España, es la pronunciación normalizada mayoritaria y prestigiosa.

---

## Question 15 [D7-D8]
**ID:** ES-LEN-11-2026-W03-tema-w03-001-MASTERY-bundle-v15
**Bloom:** Analyze
**EJE:** Lengua y sociedad
**Expected_Success:** 0.63
**Contexto:** Un filólogo estudia un bando municipal escrito en el siglo XVII en una comarca rural de la provincia de Guadalajara. El texto dice: '...asín mesmo, se fizo saber a los vecinos...'.
### Enunciado
...
### Explicacion Pedagogica
El cambio diacrónico transforma la valoración social de los vocablos. Formas normales en la Edad de Oro ('fizo') hoy son arcaísmos, y variantes vulgares ('asín') persisten como vulgarismos fuera de la norma culta.

---

## Question 16 [D7-D8]
**ID:** ES-LEN-11-2026-W03-tema-w03-001-MASTERY-bundle-v16
**Bloom:** Analyze
**EJE:** Lengua y sociedad
**Expected_Success:** 0.60
**Contexto:** Un estudiante de derecho de un instituto de Barcelona lee la Constitución Española de 1978 en relación con los derechos lingüísticos de los ciudadanos.
### Enunciado
Según el artículo 3 de la Constitución, ¿cuál es el estatus legal y lingüístico del castellano y de las demás lenguas de España?

### Opciones
- [x] A) El castellano es la lengua española oficial del Estado que todos los españoles tienen el deber de conocer y el derecho a usar; y las demás lenguas españolas serán también oficiales en sus respectivas Comunidades Autónomas de acuerdo con sus Estatutos.
  <!-- feedback: Correcto. La Constitución Española consagra la cooficialidad lingüística asimétrica: el deber de conocimiento se asocia constitucionalmente al castellano y la cooficialidad de las lenguas autonómicas (catalán, gallego, euskera) se delega a los estatutos regionales. -->
- [ ] B) La Constitución prohíbe de forma terminante hablar castellano en el territorio de Cataluña, Galicia y el País Vasco.
  <!-- feedback: Incorrecto. El castellano es oficial en todo el territorio del Estado español, incluidas las comunidades bilingües. -->
- [ ] C) Se establece que el latín clásico de Julio César es el único idioma oficial admisible en los tribunales de Madrid.
  <!-- feedback: Incorrecto. El latín clásico carece de oficialidad lingüística estatal o autonómica en la España moderna. -->
- [ ] D) El euskera se declara lengua oficial obligatoria de toda la Península Ibérica y del norte de África.
  <!-- feedback: Incorrecto. El euskera es cooficial únicamente en el territorio del País Vasco y zonas de Navarra. -->

### Explicacion Pedagogica
El marco plurilingüe de España está definido en el artículo 3 de la Constitución de 1978, estableciendo la cooficialidad de las lenguas regionales en sus comunidades y la oficialidad estatal del castellano.

---

## Question 17 [D9-D10]
**ID:** ES-LEN-11-2026-W03-tema-w03-001-MASTERY-bundle-v17
**Bloom:** Evaluate
**EJE:** Lengua y sociedad
**Expected_Success:** 0.53
**Contexto:** Un columnista en un diario de Sevilla critica que en ciertos informativos nacionales se exija a los periodistas andaluces disimular o suprimir su acento para parecer 'más profesionales y serios'.
### Enunciado
...
### Explicacion Pedagogica
La lingüística moderna rechaza toda jerarquización de lenguas o dialectos. El andaluz es un dialecto del castellano con una norma culta prestigiosa. Exigir la supresión de acentos en medios nacionales es un prejuicio sociolingüístico sin sustento científico.

---

## Question 18 [D9-D10]
**ID:** ES-LEN-11-2026-W03-tema-w03-001-MASTERY-bundle-v18
**Bloom:** Evaluate
**EJE:** Lengua y sociedad
**Expected_Success:** 0.52
**Contexto:** En una comarca bilingüe de Galicia, un estudio sociolingüístico revela que los jóvenes usan el castellano en sus redes sociales y el gallego exclusivamente para hablar con sus abuelos en el ámbito rural.
### Enunciado
...
### Explicacion Pedagogica
La diglosia se produce cuando la coexistencia de dos lenguas en un territorio no es simétrica, de modo que una de ellas (la variedad alta) desplaza a la otra (variedad baja) de los ámbitos formales, tecnológicos y oficiales.

---

## Question 19 [D9-D10]
**ID:** ES-LEN-11-2026-W03-tema-w03-001-MASTERY-bundle-v19
**Bloom:** Evaluate
**EJE:** Lengua y sociedad
**Expected_Success:** 0.50
**Contexto:** Un ensayista madrileño afirma que 'el español auténtico y puro solo se habla en Castilla' y que 'las aportaciones de América desvirtúan y corrompen el idioma nacional'.
### Enunciado
...
- [ ] D) Es correcta debido a que las palabras americanas provienen en su totalidad del catalán de Barcelona.
  <!-- feedback: Incorrecto. El español de América tiene su base en la evolución del castellano meridional y las lenguas indígenas locales, no en el catalán. -->

### Explicacion Pedagogica
La política lingüística panhispánica de la RAE y la Asociación de Academias de la Lengua Española (ASALE) establece un modelo policéntrico del español, donde la norma lingüística es consensuada por las 23 academias de todo el mundo, superando el viejo centralismo peninsular.

---

## Question 20 [D9-D10]
**ID:** ES-LEN-11-2026-W03-tema-w03-001-MASTERY-bundle-v20
**Bloom:** Evaluate
**EJE:** Sintaxis y morfología
**Expected_Success:** 0.56
**Contexto:** Un profesor de selectividad en Canarias explica a sus alumnos por qué ellos usan la fórmula 'ustedes estudian' en vez del peninsular 'vosotros estudiáis'.
### Enunciado
Evalúa el uso del pronombre 'ustedes' en el español canario según el criterio sintáctico normativo oficial de la RAE.

### Opciones
- [x] A) Es una estructura gramaticalmente impecable, correcta y normativa, que forma parte de la norma culta de Canarias y del sur peninsular.
  <!-- feedback: Correcto. El uso de 'ustedes' para la segunda persona del plural de confianza ('ustedes estudian') es la norma canaria, andaluza occidental e hispanoamericana, plenamente correcta según la RAE. -->
- [ ] B) Es un error sintáctico severo que denota un grave loísmo de persona involuntario.
  <!-- feedback: Incorrecto. No hay confusión de pronombres átonos de objeto (leísmo/loísmo) en el uso de 'ustedes' como sujeto pronominal. -->
- [ ] C) Se trata de un dequeísmo de confianza provocado por omitir el pronombre de cortesía 'vos'.
  <!-- feedback: Incorrecto. El dequeísmo se refiere a la preposición 'de' antes de 'que', fenómeno ajeno a la selección de pronombres personales sujeto de plural. -->
- [ ] D) Es una variante ilegal que la RAE penaliza con la pérdida de puntos en las pruebas de acceso a la universidad.
  <!-- feedback: Incorrecto. Es admitido con absoluta corrección gramatical y valor normativo por la propia RAE en su gramática de referencia panhispánica. -->

### Explicacion Pedagogica
En Canarias, Andalucía occidental e Hispanoamérica, se neutraliza la oposición entre 'vosotros' (confianza) y 'ustedes' (cortesía) a favor de 'ustedes' para la segunda persona del plural, conjugándose con el verbo en tercera persona. Es un uso lingüístico modélico, correcto y prestigioso.
