---
id: "ES-LEN-11-2026-W08-tema-w08-001-MASTERY-bundle"
country: "spain"
grado: 11
asignatura: "lengua"
tema: "tema-w08"
...
# Bundle MASTERY: El texto científico, técnico y humanístico - Grado 11

Este bundle contiene 20 preguntas sobre las características de los textos científico-técnicos (objetividad, universalidad, verificabilidad, precisión), textos humanísticos y ensayísticos (carácter abstracto, especulativo, hibridismo del ensayo literario), terminología científica (monosemia, denotación pura, cultismos clásica, neologismos, anglicismos) y adecuación pragmática e historiográfica bajo la LOMLOE en España.

---
## Question 1 [D3-D4]
**ID:** ES-LEN-11-2026-W08-tema-w08-001-MASTERY-bundle-v1
**Bloom:** Remember
**EJE:** Tipología textual
**Expected_Success:** 0.88
**Contexto:** Un profesor de un instituto de Madrid explica a sus alumnos las características que debe cumplir cualquier publicación en una revista de ciencia internacional.
### Enunciado
...
El discurso científico-técnico responde a las necesidades del método científico experimental, el cual exige objetividad (exclusión de sentimientos), universalidad (comprensión internacional de leyes), verificabilidad (posibilidad de reproducir ensayos) y precisión (univocidad léxica).

---

## Question 2 [D3-D4]
**ID:** ES-LEN-11-2026-W08-tema-w08-001-MASTERY-bundle-v2
**Bloom:** Understand
**EJE:** Tipología textual
**Expected_Success:** 0.85
**Contexto:** Un estudiante de bachillerato en Salamanca analiza un ensayo filosófico de José Ortega y Gasset sobre la rebelión de las masas en la Europa contemporánea.
### Enunciado
¿Qué rasgos diferencian primordialmente al 'texto humanístico' (filosofía, ensayo) del científico-técnico?

### Opciones
- [x] A) El texto humanístico trata sobre el hombre, el pensamiento o la sociedad, posee un carácter más abstracto y especulativo, y con frecuencia asocia el rigor con una manifiesta voluntad de estilo literario.
  <!-- feedback: Correcto. A diferencia del científico (monosémico y neutro), el humanístico admite la especulación abstracta, la argumentación reflexiva y la voluntad de estilo (intención estética literaria) característica del ensayo. -->
- [ ] B) El texto humanístico prohíbe de forma terminante usar sustantivos abstractos o el modo indicativo.
  <!-- feedback: Incorrecto. Al contrario, destaca por una enorme densidad de sustantivos abstractos de carácter especulativo. -->
- [ ] C) Trata exclusivamente de la flora y fauna de las montañas de Soria mediante fórmulas de física cuántica.
  <!-- feedback: Incorrecto. La botánica y la física pertenecen a las disciplinas científicas de la naturaleza y no a las disciplinas humanísticas del pensamiento. -->
- [ ] D) Es idéntico al texto publicitario comercial del Metro de Madrid.
  <!-- feedback: Incorrecto. No busca la venta directa de un producto comercial mediante imperativos; busca la reflexión intelectual profunda sobre la cultura. -->

### Explicacion Pedagogica
Los textos humanísticos pertenecen al ámbito de las ciencias humanas (filosofía, historia, sociología). Comparten con los científicos la seriedad y el rigor, pero se diferencian por el carácter abstracto y especulativo de sus conceptos y, especialmente en el ensayo, por una explícita voluntad de estilo literario.

---

## Question 3 [D3-D4]
**ID:** ES-LEN-11-2026-W08-tema-w08-001-MASTERY-bundle-v3
**Bloom:** Understand
**EJE:** Semántica y léxico
**Expected_Success:** 0.83
**Contexto:** Al redactar una monografía sobre química en Valencia, un investigador selecciona meticulosamente términos que posean un único significado exacto en el diccionario.
### Enunciado
...
- [ ] D) Un cambio de código bilingüe en euskera que suprime las consonantes dentales.
  <!-- feedback: Incorrecto. La monosemia opera dentro de cualquier idioma del mundo sin suprimir fonemas o caracteres geográficos. -->

### Explicacion Pedagogica
Frente al lenguaje literario (que explota la polisemia y los significados connotativos subjetivos), el lenguaje de la ciencia y la técnica exige monosemia y denotación pura para asegurar la univocidad y claridad absoluta del mensaje.

---

## Question 4 [D3-D4]
**ID:** ES-LEN-11-2026-W08-tema-w08-001-MASTERY-bundle-v4
**Bloom:** Remember
**EJE:** Tipología textual
**Expected_Success:** 0.82
**Contexto:** Un profesor de literatura de Barcelona explica las características del género ensayístico basándose en autores clásicos españoles como Miguel de Unamuno o Azorín.
### Enunciado
...
### Explicacion Pedagogica
El ensayo es el género literario-humanístico por excelencia. Su flexibilidad formal permite al pensador plasmar sus reflexiones personales sobre cualquier materia, valiéndose de la retórica y la estética del lenguaje sin la rigidez metodológica del informe científico puro.

---

## Question 5 [D5-D6]
**ID:** ES-LEN-11-2026-W08-tema-w08-001-MASTERY-bundle-v5
**Bloom:** Understand
**EJE:** Semántica y léxico
**Expected_Success:** 0.79
**Contexto:** Un fragmento de un ensayo filosófico de Salamanca reza: 'La modernidad impone una reflexión ética sobre la individualidad, donde la racionalidad de las instituciones debe de dialogar con la subjetividad del ciudadano común...'.
### Enunciado
...
### Explicacion Pedagogica
El texto humanístico (especialmente el filosófico y sociológico) destaca por su densidad conceptual. Se apoya de forma ineludible en el léxico abstracto (sustantivos abstractos con sufijos como '-dad', '-ez', '-ismo'), herramientas mentales para verbalizar teorías y reflexiones.

---

## Question 6 [D5-D6]
**ID:** ES-LEN-11-2026-W08-tema-w08-001-MASTERY-bundle-v6
**Bloom:** Apply
**EJE:** Tipología textual
**Expected_Success:** 0.77
**Contexto:** En un informe técnico del CSIC en Madrid se incluye, junto con el texto explicativo verbal, un mapa topográfico en color, tres diagramas de barras con porcentajes de lluvia y dos fórmulas de física hidráulica.
### Enunciado
...
### Explicacion Pedagogica
La literatura científica y técnica es multimodal. Los códigos no verbales (iconos, mapas, fórmulas matemáticas, gráficos estadísticos) complementan al código lingüístico verbal, garantizando la máxima precisión, concisión y universalidad del mensaje.

---

## Question 7 [D5-D6]
**ID:** ES-LEN-11-2026-W08-tema-w08-001-MASTERY-bundle-v7
**Bloom:** Apply
**EJE:** Lengua y sociedad
**Expected_Success:** 0.81
**Contexto:** En un simposio médico en Zaragoza, un investigador señala que la fórmula química del ácido acetilsalicílico ($C_9H_8O_4$) es idéntica en España, Japón, Rusia o Brasil, y se comprende unánimemente por cualquier científico sin traducción lingüística verbal.
### Enunciado
...
### Explicacion Pedagogica
La universalidad es una de las señas de identidad de las ciencias. El uso de la terminología normalizada de la IUPAC, la nomenclatura binomial en latín de la botánica o la simbología matemática garantiza que el mensaje sea decodificado idénticamente por cualquier experto del mundo.

---

## Question 8 [D5-D6]
**ID:** ES-LEN-11-2026-W08-tema-w08-001-MASTERY-bundle-v8
**Bloom:** Apply
**EJE:** Comunicación
**Expected_Success:** 0.74
**Contexto:** Un artículo de paleontología sobre los descubrimientos de la Sierra de Atapuerca (Burgos) describe de forma minuciosa y rigurosa los cráneos fosilizados hallados en los yacimientos.
### Enunciado
...
### Explicacion Pedagogica
En el discurso científico-técnico (paleontología, geología), la función dominante es la representativa o referencial. Su finalidad es transmitir información real, empírica y contrastable sobre objetos, fósiles o fenómenos de la naturaleza.

---

## Question 9 [D5-D6]
**ID:** ES-LEN-11-2026-W08-tema-w08-001-MASTERY-bundle-v9
**Bloom:** Apply
**EJE:** Tipología textual
**Expected_Success:** 0.78
**Contexto:** Se contrastan dos textos históricos sobre la Guerra de la Independencia de España de 1808: el Texto A es un diario íntimo subjetivo de un oficial francés y el Texto B es un manual de historia de 2º de Bachillerato que detalla con neutralidad y rigor de datos las fases de la guerra.
### Enunciado
...
### Explicacion Pedagogica
El análisis histórico abarca géneros diversos. Mientras que las memorias o diarios son narraciones de base subjetiva (expresivas), la historiografía académica es un discurso de base expositivo-explicativa que prioriza la objetividad de los hechos, las fechas, los datos y el análisis de causas y consecuencias.

---

## Question 10 [D5-D6]
**ID:** ES-LEN-11-2026-W08-tema-w08-001-MASTERY-bundle-v10
**Bloom:** Understand
**EJE:** Semántica y léxico
**Expected_Success:** 0.80
**Contexto:** Un filósofo que imparte clase en Valladolid utiliza términos griegos como 'epistemología' (estudio del conocimiento) y 'antropología' (estudio del hombre) para estructurar sus explicaciones.
### Enunciado
¿Qué nombre reciben estas palabras formadas por raíces griegas clásicas integradas en el castellano culto?

### Opciones
- [x] A) Cultismos y helenismos, vocablos de origen griego o latino incorporados tardíamente a la lengua culta por vía escrita sin experimentar cambios fonéticos vulgares.
  <!-- feedback: Correcto. Palabras de origen clásico formadas por prefijos o sufijos griegos ('episteme' = conocimiento, 'logos' = estudio) son cultismos o helenismos, pilares de los tecnicismos humanísticos y científicos. -->
- [ ] B) Vulgarismos desaconsejados por atentar contra la gramática de la RAE.
  <!-- feedback: Incorrecto. Son términos sumamente cultos, correctos, refinados y normativos de la lengua española. -->
- [ ] C) Arcaísmos medievales de uso exclusivo en la provincia de Toledo.
  <!-- feedback: Incorrecto. Aunque tienen raíces antiguas, son palabras técnicas vivas de plena vigencia científica contemporánea mundial. -->
- [ ] D) Préstamos del inglés de los negocios de Monterrey.
  <!-- feedback: Incorrecto. Su etimología es puramente clásica griega y latina, totalmente ajena al inglés moderno corporativo. -->

### Explicacion Pedagogica
Las lenguas humanas forman sus tecnicismos recurriendo de forma habitual a formantes de origen griego o latino (helenismos y cultismos). Estos formantes clásicos facilitan la monosemia y la universalidad terminológica de las disciplinas académicas.

---

## Question 11 [D7-D8]
**ID:** ES-LEN-11-2026-W08-tema-w08-001-MASTERY-bundle-v11
**Bloom:** Analyze
**EJE:** Sintaxis y morfología
**Expected_Success:** 0.63
**Contexto:** En un ensayo sociológico de Barcelona se lee: 'La rápida implantación de la automatización digital del comercio comporta la paulatina transformación del modelo laboral en la sociedad española'.
### Enunciado
...
### Explicacion Pedagogica
El estilo nominal es una marca morfosintáctica del lenguaje de especialidad. Al priorizar el sustantivo abstracto sobre el verbo dinámico, se asimila el proceso real a una categoría conceptual teórica estática propicia para la argumentación humanística y científica.

---

## Question 12 [D7-D8]
**ID:** ES-LEN-11-2026-W08-tema-w08-001-MASTERY-bundle-v12
**Bloom:** Analyze
**EJE:** Tipología textual
**Expected_Success:** 0.65
**Contexto:** Un crítico en Madrid analiza un ensayo filosófico de Miguel de Unamuno de principios del siglo XX, destacando que el escritor no busca la frialdad aséptica de las matemáticas, sino conmover estéticamente al lector mientras razona sobre la inmortalidad del alma.
### Enunciado
¿Qué propiedad definitoria del ensayo literario se pone de manifiesto en la crítica del ensayista?

### Opciones
- [x] A) Su carácter híbrido como género de frontera, que asocia de manera inseparable el rigor de la argumentación lógica con una explícita y bella voluntad de estilo literario de carácter estético.
  <!-- feedback: Correcto. El ensayo literario es un género híbrido de frontera, que no renuncia a la belleza verbal, la retórica y la subjetividad para conmover estéticamente al lector mientras se razona filosóficamente. -->
- [ ] B) Su estatus de manual de botánica forestal de la LOMLOE para identificar la mitosis de los pinos.
  <!-- feedback: Incorrecto. El ensayo unamuniano trata sobre el alma y la fe existencial, alejado de explicaciones de biología de mitosis forestal. -->
- [ ] C) Su total corrección formal dictada por las leyes del Ministerio de Fomento de España.
  <!-- feedback: Incorrecto. El estilo literario es una opción estética creadora libre del autor y no un mandato administrativo ministerial de fomento. -->
- [ ] D) Se devalúa porque Unamuno cometía de forma voluntaria dequeísmo de objeto indirecto en Soria.
  <!-- feedback: Incorrecto. Unamuno fue un prosista excelso y catedrático de griego, de impecable dominio morfosintáctico de la lengua. -->

### Explicacion Pedagogica
El ensayo literario es un género humanístico singular. A diferencia de la monografía científica aséptica, el ensayo se sitúa en la frontera entre la ciencia y la literatura, permitiendo la confluencia de la racionalidad de las ideas con la belleza poética y la sensibilidad personal del autor.

---

## Question 13 [D7-D8]
**ID:** ES-LEN-11-2026-W08-tema-w08-001-MASTERY-bundle-v13
**Bloom:** Analyze
**EJE:** Sintaxis y morfología
**Expected_Success:** 0.62
**Contexto:** En una publicación científica del CSIC en Sevilla se lee la frase: 'Creemos que las últimas observaciones con el radiotelescopio apoyan nuestra teoría sobre los agujeros negros'.
### Enunciado
...
### Explicacion Pedagogica
El plural de modestia ('planteamos', 'analizamos') es un recurso pragmático tradicional del discurso académico. Permite diluir la responsabilidad del yo individual del investigador en una dimensión colectiva (su equipo de laboratorio) o implicar de forma deíctica de cortesía al propio lector.

---

## Question 14 [D7-D8]
**ID:** ES-LEN-11-2026-W08-tema-w08-001-MASTERY-bundle-v14
**Bloom:** Analyze
**EJE:** Sintaxis y morfología
**Expected_Success:** 0.60
**Contexto:** Un fragmento de geología de Valencia afirma: 'El basalto, que es una roca ígnea de origen volcánico rica en silicato de magnesio, se solidifica de forma lenta bajo la corteza continental'.
### Enunciado
...
### Explicacion Pedagogica
En el discurso científico y técnico, las subordinadas adjetivas explicativas o especificativas de relativo ('que es...', 'cuyo origen...') desempeñan un papel fundamental para delimitar y definir de forma precisa los sustantivos y tecnicismos, evitando imprecisiones interpretativas.

---

## Question 15 [D7-D8]
**ID:** ES-LEN-11-2026-W08-tema-w08-001-MASTERY-bundle-v15
**Bloom:** Analyze
**EJE:** Semántica y léxico
**Expected_Success:** 0.58
**Contexto:** Un ensayo sociológico de Barcelona sobre redes de comunicación actuales emplea abundantes términos extranjeros como 'online', 'influencer' y 'feedback' sin adaptar ortográficamente.
### Enunciado
...
### Explicacion Pedagogica
El contacto de lenguas en un mundo globalizado transfiere términos de especialidad (anglicismos). La Real Academia Española promueve la defensa de la unidad e identidad del idioma sugiriendo adaptaciones ortográficas ('selfi', 'estrés') o el uso de equivalentes tradicionales en castellano.

---

## Question 16 [D7-D8]
**ID:** ES-LEN-11-2026-W08-tema-w08-001-MASTERY-bundle-v16
**Bloom:** Analyze
**EJE:** Tipología textual
**Expected_Success:** 0.59
**Contexto:** En un ensayo filosófico sobre la libertad humana en Zaragoza se lee: 'La libertad es un derecho inalienable; así lo sostiene Immanuel Kant al fundamentar su imperativo categórico moral...'.
### Enunciado
Analiza qué recurso argumentativo se está incorporando al citar el pensamiento de Immanuel Kant en este ensayo humanístico.

### Opciones
- [x] A) Argumento de autoridad, al fundamentar el rigor de la tesis de la libertad en el parecer coincidente de un filósofo clásico consagrado de las ciencias humanas.
  <!-- feedback: Correcto. Citar las teorías de Kant es un clásico argumento de autoridad que asiste y eleva la validez intelectual del ensayo humanístico sobre la libertad moral. -->
- [ ] B) Falacia ad hominem, que descalifica y ofende de forma directa la moralidad de Kant en Zaragoza.
  <!-- feedback: Incorrecto. Se sirve del prestigio intelectual de Kant para apoyar la tesis propia, totalmente opuesto al ataque ofensivo ad hominem. -->
- [ ] C) Argumento por ejemplificación botánica de la LOMLOE para la venta de flores.
  <!-- feedback: Incorrecto. Es un análisis de filosofía moral humana y carece de relación con explicaciones botánicas de mitosis vegetal. -->
- [ ] D) Estilo directo libre que reproduce los llantos íntimos del sujeto elíptico.
  <!-- feedback: Incorrecto. El orador resume de forma explicativa indirecta la teoría del filósofo, libre de estilo directo teatral. -->

### Explicacion Pedagogica
Los textos de carácter humanístico y ensayístico utilizan con gran frecuencia argumentos de autoridad. Citar a grandes pensadores de la cultura occidental (como Kant, Aristóteles o Ortega y Gasset) dota de solidez y solvencia académica al debate de las ideas.

---

## Question 17 [D9-D10]
**ID:** ES-LEN-11-2026-W08-tema-w08-001-MASTERY-bundle-v17
**Bloom:** Evaluate
**EJE:** Tipología textual
**Expected_Success:** 0.54
**Contexto:** Un ensayo filosófico incluido en una prueba de acceso a la universidad (EBAU) en Madrid aborda la alienación en la sociedad contemporánea usando una sintaxis tortuosa con oraciones alemanas de veinte líneas traducidas literalmente, plagadas de términos abstrusos sin glosario aclaratorio.
### Enunciado
...
- [ ] D) Se justifica porque la LOMLOE exige que la filosofía de bachillerato se redacte únicamente en latín medieval forense.
  <!-- feedback: Incorrecto. La LOMLOE promueve la filosofía en castellano claro e inclusivo, fomentando las destrezas de argumentación y debate crítico ciudadano. -->

### Explicacion Pedagogica
La claridad y el respeto al receptor son exigencias transversales de la comunicación formal. Presentar textos con un nivel de complejidad inapropiado o con traducciones defectuosas atenta contra el principio de adecuación pragmática de los exámenes estatales de bachillerato.

---

## Question 18 [D9-D10]
**ID:** ES-LEN-11-2026-W08-tema-w08-001-MASTERY-bundle-v18
**Bloom:** Evaluate
**EJE:** Tipología textual
**Expected_Success:** 0.52
**Contexto:** Un artículo que pretende divulgar ciencia en Barcelona afirma: 'El alineamiento místico de los planetas el próximo martes purifica de forma milagrosa el aura molecular del cerebro y cura la calvicie'. No aporta ensayos clínicos, datos de laboratorio ni mediciones físicas demostrables.
### Enunciado
...
### Explicacion Pedagogica
La ciencia se define por sus exigencias metodológicas. Un enunciado que afirme curaciones milagrosas sin aportar pruebas científicas medibles, repetibles y contrastadas (verificabilidad experimental) se sitúa fuera de la tipología del discurso científico-técnico, catalogándose como fraude o pseudociencia.

---

## Question 19 [D9-D10]
**ID:** ES-LEN-11-2026-W08-tema-w08-001-MASTERY-bundle-v19
**Bloom:** Evaluate
**EJE:** Tipología textual
**Expected_Success:** 0.50
**Contexto:** Un texto historiográfico que aborda la Transición Española de 1975-1978 en Sevilla afirma de forma tajante: 'El proceso democrático triunfó exclusivamente por el heroísmo patriótico de un puñado de valientes nobles que doblegaron la cobardía de las masas analfabetas'.
### Enunciado
...
### Explicacion Pedagogica
El discurso historiográfico exige un análisis multicausal científico y neutral de los sucesos sociales del pasado. Sustituir la exposición de causas, tensiones socioeconómicas y pactos constitucionales por juicios morales polarizados y léxico axiológico ('valientes', 'cobardes') invalida el rigor científico de la explicación histórica.

---

## Question 20 [D9-D10]
**ID:** ES-LEN-11-2026-W08-tema-w08-001-MASTERY-bundle-v20
**Bloom:** Evaluate
**EJE:** Semántica y léxico
**Expected_Success:** 0.55
**Contexto:** En una traducción de un manual médico de la UE en Zaragoza, se halla la frase: 'The patient suffered a severe stroke' traducida literalmente por 'El paciente sufrió un golpe severo'. El corrector de estilo español de Zaragoza afirma que la traducción atenta contra el léxico médico adecuado de España.
### Enunciado
...
### Explicacion Pedagogica
La traducción científico-técnica y médica no admite literalidades ingenuas. Exige el conocimiento exacto de la terminología de especialidad normalizada y consagrada en la lengua de destino (en España, el uso de 'ictus' o 'accidente cerebrovascular' y 'grave' en vez de 'severo'), respetando el principio de precisión léxica y de propiedad semántica de la norma estándar culta.
