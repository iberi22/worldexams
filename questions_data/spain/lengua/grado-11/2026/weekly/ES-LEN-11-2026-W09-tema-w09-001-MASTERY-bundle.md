---
id: "ES-LEN-11-2026-W09-tema-w09-001-MASTERY-bundle"
country: "spain"
grado: 11
asignatura: "lengua"
tema: "tema-w09"
...
# Bundle MASTERY: El texto periodístico - Grado 11

Este bundle contiene 20 preguntas sobre los géneros periodísticos informativos, de opinión e interpretativos (noticia, reportaje, crónica, editorial, columna de opinión, cartas al director), estructura de la pirámide invertida y entradilla de las 6 Ws, recursos sintácticos de la prensa (condicional de rumor, citas directas e indirectas, estilo nominal), figuras retóricas de la opinión (ironía, metáforas valorativas), sensacionalismo (clickbait) y adecuación lingüística del canal periodístico en España según el currículo LOMLOE.

---
## Question 1 [D3-D4]
**ID:** ES-LEN-11-2026-W09-tema-w09-001-MASTERY-bundle-v1
**Bloom:** Remember
**EJE:** Tipología textual
**Expected_Success:** 0.88
**Contexto:** Un profesor de Lengua en un instituto de Madrid analiza cómo clasificar los textos que aparecen diariamente en la prensa escrita de España.
### Enunciado
¿Qué gran división tripartita se utiliza para clasificar los géneros periodísticos según su propósito comunicativo?

### Opciones
- [x] A) Géneros informativos (noticia, reportaje), géneros de opinión (editorial, artículo, columna, cartas al director) y géneros mixtos o de interpretación (crónica, entrevista).
  <!-- feedback: Correcto. El periodismo clasifica sus textos en tres bloques fundamentales: informativos (objetividad pura), de opinión (subjetividad argumentativa) e interpretativos o mixtos (hibridismo de ambos). -->
- [ ] B) Poemas modernistas, novelas policiales medievales en latín clásico y bandos municipales de Toledo.
  <!-- feedback: Incorrecto. Corresponden a los géneros literarios y administrativos, no a la prensa periodística de opinión o información. -->
- [ ] C) El laísmo pronominal, la elipsis temporal canaria de Doñana y la diglosia bilingüe.
  <!-- feedback: Incorrecto. Ninguna de estas categorías lingüísticas o fenómenos sociolingüísticos compone un género de la prensa. -->
- [ ] D) Se limita únicamente a la sección de deportes y a los crucigramas del Metro de Madrid.
  <!-- feedback: Incorrecto. La prensa abarca múltiples secciones con géneros estructurados de forma formal. -->

### Explicacion Pedagogica
La teoría de la comunicación periodística clasifica los géneros según su grado de objetividad u opinión: informativos (noticia, reportaje), opinión (editorial, artículo, columna, cartas al director) e interpretativos o mixtos (crónica, entrevista).

---

## Question 2 [D3-D4]
**ID:** ES-LEN-11-2026-W09-tema-w09-001-MASTERY-bundle-v2
**Bloom:** Understand
**EJE:** Tipología textual
**Expected_Success:** 0.85
**Contexto:** Un redactor jefe de un periódico de Madrid revisa la entradilla o lead de una noticia sobre un suceso ocurrido la pasada noche.
### Enunciado
¿Qué estructura de jerarquización de la información caracteriza a la noticia periodística y qué preguntas (las 6 Ws) debe responder de forma prioritaria en su entradilla?

### Opciones
- [x] A) Estructura de pirámide invertida (de mayor a menor relevancia); y debe responder a: quién, qué, cuándo, dónde, por qué y cómo.
  <!-- feedback: Correcto. La noticia jerarquiza los datos de más a menos importantes (pirámide invertida) y su entradilla o lead debe resumir de entrada el núcleo del hecho respondiendo a las preguntas clásicas del periodismo. -->
- [ ] B) Estructura de rima asonante medieval, respondiendo únicamente a las preguntas de matemáticas de la RAE.
  <!-- feedback: Incorrecto. Es un género racional informativo en prosa y no un poema de rima o prueba de matemáticas académicas. -->
- [ ] C) Estructura de cajas chinas, respondiendo exclusivamente a qué piensan los linces ibéricos de Doñana.
  <!-- feedback: Incorrecto. Es una noticia de prensa de actualidad humana de sucesos y no un cuento de relatos encajados sobre felinos. -->
- [ ] D) Se organiza de lo particular a lo general, ocultando el suceso principal en el último renglón por suspense policial.
  <!-- feedback: Incorrecto. Ocultar la noticia atenta contra la inmediatez informativa periodística exige ir al grano al inicio. -->

### Explicacion Pedagogica
La noticia organiza la información de forma decreciente (pirámide invertida) para facilitar la lectura rápida. El lead o párrafo inicial concentra el núcleo del acontecimiento respondiendo a las preguntas informativas fundamentales (quién, qué, cuándo, dónde, por qué, cómo).

---

## Question 3 [D3-D4]
**ID:** ES-LEN-11-2026-W09-tema-w09-001-MASTERY-bundle-v3
**Bloom:** Understand
**EJE:** Tipología textual
**Expected_Success:** 0.83
**Contexto:** Un lector abre las páginas de opinión de un conocido periódico de Sevilla y lee un artículo que no lleva firma, en el que se expone la postura institucional del medio sobre los presupuestos locales.
### Enunciado
...
### Explicacion Pedagogica
El editorial destaca entre los géneros de opinión por su carácter colectivo y solemne. Al carecer de firma individual, se asume la autoría institucional del periódico, buscando orientar ideológicamente a la opinión pública.

---

## Question 4 [D3-D4]
**ID:** ES-LEN-11-2026-W09-tema-w09-001-MASTERY-bundle-v4
**Bloom:** Remember
**EJE:** Tipología textual
**Expected_Success:** 0.82
**Contexto:** Un corresponsal destacado en el extranjero envía un escrito de tres páginas a su periódico de Barcelona narrando los detalles cronológicos del desastre de una inundación, intercalando valoraciones personales y metáforas poéticas sobre el fango.
### Enunciado
...
- [ ] D) Un bando municipal de Valencia que regula el uso de los barcos de recreo.
  <!-- feedback: Incorrecto. Es un texto de prensa interpretativo internacional y no una norma administrativa de tráfico fluvial valenciana. -->

### Explicacion Pedagogica
La crónica es un género periodístico mixto. Comparte la base informativa de la noticia y el reportaje, pero se enriquece con la interpretación temporal (orden cronológico de vivencia) y el estilo expresivo de un corresponsal.

---

## Question 5 [D5-D6]
**ID:** ES-LEN-11-2026-W09-tema-w09-001-MASTERY-bundle-v5
**Bloom:** Understand
**EJE:** Tipología textual
**Expected_Success:** 0.79
**Contexto:** En la portada de 'El País' se lee: 'Ayer por la tarde, un fuerte temporal de viento derribó (1) tres andamios en el centro de Madrid, hiriendo (2) a dos operarios de construcción. El Ayuntamiento investiga (3) el suceso...'.
### Enunciado
...
- [ ] D) Es un loísmo sintáctico de persona que suprime los verbos copulativos de Zaragoza.
  <!-- feedback: Incorrecto. La redacción es morfosintácticamente impecable acorde al registro periodístico culto. -->

### Explicacion Pedagogica
La entradilla de una noticia (lead) cumple una función informativa nuclear. Su diseño responde de manera condensada y directa a las preguntas básicas de la comunicación informativa (qué, quién, dónde, cuándo).

---

## Question 6 [D5-D6]
**ID:** ES-LEN-11-2026-W09-tema-w09-001-MASTERY-bundle-v6
**Bloom:** Apply
**EJE:** Tipología textual
**Expected_Success:** 0.77
**Contexto:** En un fragmento periodístico firmado en Sevilla se lee: 'Siento dolor ante la pasividad con la que contemplamos la degradación del Guadalquivir; es nuestro deber ético alzar la voz contra las vertidos de las industrias...'.
### Enunciado
...
### Explicacion Pedagogica
La columna o artículo de opinión firmado es el cauce idóneo para la expresión subjetiva en prensa. Destaca por el protagonismo del autor, el uso de la primera persona, la libertad de temas y un estilo literario con fines persuasivos.

---

## Question 7 [D5-D6]
**ID:** ES-LEN-11-2026-W09-tema-w09-001-MASTERY-bundle-v7
**Bloom:** Apply
**EJE:** Tipología textual
**Expected_Success:** 0.81
**Contexto:** Un redactor de prensa de Valencia diseña un reportaje de fondo de diez páginas sobre la exclusión tecnológica de los mayores y opta por colocar un gran título llamativo, un lead resumen destacados y organizar el texto en apartados temáticos independientes.
### Enunciado
...
- [ ] D) Se diseña así para generar ruido de canal físico y distraer a los opositores de Aragón.
  <!-- feedback: Incorrecto. Busca combatir el desorden o la confusión de ideas, facilitando una decodificación nítida. -->

### Explicacion Pedagogica
El diseño de la macroestructura de los grandes géneros de la prensa (reportaje, crónica) se sirve de recursos espaciales (subtítulos, destacados, ladillos) para dosificar la información y ofrecer una progresión temática clara y asimilable.

---

## Question 8 [D5-D6]
**ID:** ES-LEN-11-2026-W09-tema-w09-001-MASTERY-bundle-v8
**Bloom:** Apply
**EJE:** Tipología textual
**Expected_Success:** 0.74
**Contexto:** Un lector de Valencia remite un escrito de 15 líneas a la sección de participación ciudadana de un periódico, quejándose de los ruidos nocturnos de las terrazas de su calle y exigiendo soluciones al Ayuntamiento.
### Enunciado
...
- [ ] D) Una columna de opinión de bajo nivel de éxito de Doñana.
  <!-- feedback: Incorrecto. Es una carta al director con formato breve, desvinculada de columnas de opinión de colaboradores fijos pagados. -->

### Explicacion Pedagogica
Las cartas al director representan el espacio interactivo democrático de la prensa. Tienen un formato breve, exigen firma real e identificación del emisor, y abordan problemas de interés cotidiano o social desde el punto de vista ciudadano.

---

## Question 9 [D5-D6]
**ID:** ES-LEN-11-2026-W09-tema-w09-001-MASTERY-bundle-v9
**Bloom:** Apply
**EJE:** Tipología textual
**Expected_Success:** 0.78
**Contexto:** Se contrastan dos textos en un examen de Soria: el Texto A (un reportaje aséptico de datos sobre el paro juvenil en España) y el Texto B (un artículo firmado de un intelectual que argumenta que el paro juvenil destruye la ilusión moral del país).
### Enunciado
...
### Explicacion Pedagogica
El estilo periodístico oscila entre la asfixia subjetiva de la opinión (marcas de primera persona, adjetivación valorativa, retórica conativa) y el rigor descriptivo objetivo de la información pura (impersonalidad con se, datos contrastables, tercera persona del indicativo).

---

## Question 10 [D5-D6]
**ID:** ES-LEN-11-2026-W09-tema-w09-001-MASTERY-bundle-v10
**Bloom:** Understand
**EJE:** Semántica y léxico
**Expected_Success:** 0.80
**Contexto:** Un artículo de opinión sobre la crisis de la vivienda en Barcelona incluye términos como 'burbuja inmobiliaria', 'gentrificación', 'precio del alquiler' y 'desahucio'.
### Enunciado
...
### Explicacion Pedagogica
Los tecnicismos de carácter sociológico, jurídico y económico abundan en las páginas de opinión y economía de los periódicos. Aportan propiedad semántica y rigor intelectual al debate sobre los problemas complejos de la sociedad contemporánea.

---

## Question 11 [D7-D8]
**ID:** ES-LEN-11-2026-W09-tema-w09-001-MASTERY-bundle-v11
**Bloom:** Analyze
**EJE:** Sintaxis y morfología
**Expected_Success:** 0.63
**Contexto:** Un titular en un periódico digital reza: 'El ministro firmaría (1) las nuevas directrices escolares el próximo lunes'. El corrector de estilo advierte que el verbo destacado (1) se halla en un condicional no justificado.
### Enunciado
...
- [ ] D) Una metáfora poética romántica de la Generación del 27.
  <!-- feedback: Incorrecto. Es una anomalía de estilo periodístico de información y no un recurso lírico estético de un poema vanguardista. -->

### Explicacion Pedagogica
El uso del condicional de rumor o 'condicional de posibilidad periodística' ('El presidente se reuniría hoy con el rey...') es un tic de estilo frecuente para eludir responsabilidades de confirmación. Atenta contra la exigencia de rigor y veracidad fáctica de la prensa informativa.

---

## Question 12 [D7-D8]
**ID:** ES-LEN-11-2026-W09-tema-w09-001-MASTERY-bundle-v12
**Bloom:** Analyze
**EJE:** Tipología textual
**Expected_Success:** 0.65
**Contexto:** En una crónica sobre un suceso en Salamanca se lee: 'El testigo declaró textualmente: 'Oí un grito agudo proveniente de la Puerta del Sol' (1). Más tarde, la policía confirmó que el sospechoso había huido en dirección a la estación (2)'.
### Enunciado
...
### Explicacion Pedagogica
La prensa se nutre de voces de testigos y fuentes. Para garantizar la veracidad, recurre al estilo directo (fidelidad absoluta del testimonio entre comillas) o al estilo indirecto (síntesis explicativa del mensaje supeditado al discurso del reportero).

---

## Question 13 [D7-D8]
**ID:** ES-LEN-11-2026-W09-tema-w09-001-MASTERY-bundle-v13
**Bloom:** Analyze
**EJE:** Sintaxis y morfología
**Expected_Success:** 0.62
**Contexto:** En una columna de opinión de Zaragoza se lee la frase: 'El gobierno debe de intervenir de forma urgente en el mercado eléctrico para frenar la subida de tarifas que ahoga a las familias de Aragón'.
### Enunciado
...
### Explicacion Pedagogica
La norma académica mantiene la distinción entre 'deber + infinitivo' (obligación: 'Debes estudiar') y 'deber de + infinitivo' (conjetura: 'Debe de ser tarde'). El uso de la segunda para formular obligaciones es una inadecuación normativa común en la prensa descuidada de España.

---

## Question 14 [D7-D8]
**ID:** ES-LEN-11-2026-W09-tema-w09-001-MASTERY-bundle-v14
**Bloom:** Analyze
**EJE:** Tipología textual
**Expected_Success:** 0.60
**Contexto:** Un crítico en Zaragoza analiza tres titulares de un diario sobre la victoria de un equipo local: Titular 1 ('El Zaragoza vence 2-1 al Sevilla'), Titular 2 ('¡Hazaña heroica en el descuento!') y Titular 3 ('¿Es el Zaragoza un firme candidato al título?').
### Enunciado
...
### Explicacion Pedagogica
El titular es la puerta de acceso al texto periodístico. Su diseño obedece a intenciones pragmáticas diferenciadas: informar (titulares denotativos descriptivos), valorar (titulares expresivos literarios) o persuadir/atraer (titulares apelativos u orientativos).

---

## Question 15 [D7-D8]
**ID:** ES-LEN-11-2026-W09-tema-w09-001-MASTERY-bundle-v15
**Bloom:** Analyze
**EJE:** Semántica y léxico
**Expected_Success:** 0.58
**Contexto:** En una columna de opinión de Soria sobre el abandono rural se lee: 'La despoblación es una hacha implacable que decapita el alma de nuestros pueblos y los condena al silencio eterno de la piedra'.
### Enunciado
...
### Explicacion Pedagogica
El artículo de opinión firmado comparte recursos con la literatura. El uso de la metáfora desgarradora, la personificación dramática y la adjetivación expresiva busca la conmoción ética y afectiva del lector (pathos argumentativo) para sumar su adhesión moral a la causa.

---

## Question 16 [D7-D8]
**ID:** ES-LEN-11-2026-W09-tema-w09-001-MASTERY-bundle-v16
**Bloom:** Analyze
**EJE:** Comunicación
**Expected_Success:** 0.59
**Contexto:** En una clase de bachillerato en Valencia, se compara una editorial periodística institucional sobre la reforma del puerto con una noticia puramente informativa sobre las toneladas de mercancías movilizadas.
### Enunciado
...
- [ ] D) Se anulan todas las funciones del lenguaje por interferencia del ruido del asfalto.
  <!-- feedback: Incorrecto. La comunicación se desenvuelve de forma exitosa, operando las funciones según el género periodístico analizado. -->

### Explicacion Pedagogica
El periodismo persigue diversos fines según su tipología textual. Los géneros informativos se rigen por la función referencial o representativa (dar datos neutros). Los géneros de opinión incorporan las funciones apelativa (provocar un cambio de pensamiento) y expresiva (mostrar el juicio del diario).

---

## Question 17 [D9-D10]
**ID:** ES-LEN-11-2026-W09-tema-w09-001-MASTERY-bundle-v17
**Bloom:** Evaluate
**EJE:** Tipología textual
**Expected_Success:** 0.54
**Contexto:** Un diario digital en Madrid publica un titular sensacionalista que reza: '¡No te creerás lo que un conocido ministro ha hecho hoy en el Congreso de los Diputados!'. Al clicar en la noticia, el texto se limita a relatar que el ministro tomó un vaso de agua mineral durante su intervención.
### Enunciado
...
### Explicacion Pedagogica
El periodismo serio se debe al principio de veracidad y honestidad informativa. El uso del 'clickbait' en titulares degrada la calidad de la prensa, mercantilizando la curiosidad del receptor mediante promesas de exclusivas dramáticas que luego se revelan insustanciales.

---

## Question 18 [D9-D10]
**ID:** ES-LEN-11-2026-W09-tema-w09-001-MASTERY-bundle-v18
**Bloom:** Evaluate
**EJE:** Tipología textual
**Expected_Success:** 0.52
**Contexto:** Un reportaje que pretende ser objetivo sobre las manifestaciones agrícolas en Sevilla introduce de forma sutil las expresiones: 'un grupo de ruidosos alborotadores' frente a 'los pacíficos conductores de coche'. Omite entrevistar a los agricultores y solo recoge la versión de las empresas de transporte.
### Enunciado
Realiza una evaluación crítica de la objetividad y adecuación deontológica de este reportaje periodístico.

### Opciones
- [x] A) Carece de objetividad y neutralidad real, al introducir un severo sesgo de opinión a través de adjetivación valorativa ('ruidosos alborotadores') y de una selección sectaria de fuentes de información, atentando contra el deber de imparcialidad del género.
  <!-- feedback: Correcto. El reportaje objetivo debe ser neutral y equilibrado, recogiendo la voz de todas las partes en conflicto. Usar adjetivos apreciativos tendenciosos y silenciar fuentes es una inadecuación severa que disfraza opinión sesgada de información aséptica. -->
- [ ] B) Es un ejemplo excelente de reportaje objetivo avalado por la RAE de Doñana.
  <!-- feedback: Incorrecto. Las instituciones académicas y los códigos deontológicos de la prensa rechazan la manipulación de fuentes y el sesgo adjetival encubierto en reportajes informativos. -->
- [ ] C) Es correcto ya que los agricultores de Sevilla exigen de forma obligatoria el uso de oraciones exclamativas en latín clásico.
  <!-- feedback: Incorrecto. Los agricultores exigen ser escuchados con imparcialidad en su propio idioma español de uso estándar, sin requisitos de latín clásico de Toledo. -->
- [ ] D) Se devalúa porque comete un loísmo pronominal de persona de forma obligatoria.
  <!-- feedback: Incorrecto. No hay ninguna anomalía de pronombres átonos de acusativo de persona masculinos en el texto; el fallo radica en la neutralidad ideológica del reporte. -->

### Explicacion Pedagogica
La objetividad en los géneros informativos de la prensa exige honestidad metodológica. Un reportaje que manipule la adjetivación para polarizar a la opinión pública ('buenos' contra 'malos') y censure el testimonio de uno de los bandos en conflicto viola los principios éticos elementales de la profesión periodística.

---

## Question 19 [D9-D10]
**ID:** ES-LEN-11-2026-W09-tema-w09-001-MASTERY-bundle-v19
**Bloom:** Evaluate
**EJE:** Tipología textual
**Expected_Success:** 0.50
**Contexto:** Un columnista en Madrid critica con severa ironía una nueva ley de educación: '¡Qué gran acierto! Quitar horas de matemáticas y lengua para poner horas de colorear mandalas es, sin duda, la genialidad pedagógica del siglo que nos convertirá en líderes mundiales de la ciencia'.
### Enunciado
...
### Explicacion Pedagogica
La ironía y la reducción al absurdo son recursos retóricos de primer orden en el periodismo de opinión firmado (columnas). Permiten refutar la postura del rival ridiculizando de manera inteligente sus tesis sin necesidad de caer en descalificaciones burdas o insultos directos (ad hominem).

---

## Question 20 [D9-D10]
**ID:** ES-LEN-11-2026-W09-tema-w09-001-MASTERY-bundle-v20
**Bloom:** Evaluate
**EJE:** Tipología textual
**Expected_Success:** 0.55
**Contexto:** En la sección de cartas al director de un periódico de Madrid, un ciudadano remite una queja redactada en un registro extremadamente vulgar, plagada de insultos personales, abreviaturas tipo chat de móvil ('xq', 'tb') y faltas ortográficas graves de grafías 'b/v'.
### Enunciado
...
### Explicacion Pedagogica
La adecuación lingüística de las cartas al director es regulada con esmero por los libros de estilo de la prensa. Aunque se respete la libertad y la indignación del lector quejoso, el escrito publicado en papel o digital debe ajustarse a la corrección ortográfica de la RAE, la sintaxis estándar y el respeto mutuo, desterrando abreviaturas telefónicas vulgares o descalificaciones de chat.
