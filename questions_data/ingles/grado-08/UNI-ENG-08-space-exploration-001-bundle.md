...
### Opciones
- [ ] A) Driver
- [x] B) Astronaut / Cosmonaut
- [ ] C) Pilot
- [ ] D) Sailor

### Explicación Pedagógica
**English:** **Astronaut**. Space traveler.
*Español: Astronauta.*
...
### Enunciado
The sun and all the planets that orbit around it form the...
...
### Explicación Pedagógica
**English:** **Solar System**. Our planetary neighborhood.
...
### Enunciado
Humans want to visit this planet next.
...
### Enunciado
The force that pulls objects toward the center of the Earth (so we don't float away).
...
### Explicación Pedagógica
**English:** **Gravity**. Universal force.
*Español: Gravedad.*
...
### Enunciado
The Moon is a natural _______ of Earth.
...
### Explicación Pedagógica
**English:** **Satellite**. Object orbiting a planet.
*Español: Satélite.*
...
### Contexto
**Action:** "The rocket blasts off into the sky."
...
### Explicación Pedagógica
**English:** **Launch**. Rocket start.
*Español: Lanzamiento / Despegue.*
...
### Contexto
**Tool:** Used to see distant stars clearly (e.g., Hubble, James Webb).
...
### Explicación Pedagógica
**English:** **Telescope**. Space observation tool.
*Español: Telescopio.*
...
### Enunciado
To travel around a planet in a curved path is to...
...
### Contexto
**Place:** A large spacecraft where astronauts live and work for months.
...
### Opciones
- [ ] A) Moon Base
- [x] B) International Space Station (ISS)
- [ ] C) Star Wars
- [ ] D) Hotel

### Explicación Pedagógica
**English:** **ISS**. Space laboratoy.
*Español: Estación Espacial Internacional.*
...
### Contexto
**Life:** "Extraterrestrial life forms."
...
### Explicación Pedagógica
**English:** **Aliens**. Extraterrestrial.
*Español: Extraterrestres / Alienígenas.*
