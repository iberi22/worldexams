...
**English:** "Woof" is the sound of a dog.
*Español: "Woof" (guau) es el sonido de un perro.*
...
### Explicación Pedagógica
**English:** "Meow" is the sound of a cat.
*Español: "Meow" (miau) es el sonido de un gato.*
...
### Explicación Pedagógica
**English:** Elephants are very big and have trunks.
*Español: Los elefantes son muy grandes y tienen trompas.*
...
*Español: Los peces nadan en el agua.*
...
*Español: Las jirafas tienen cuellos muy largos.*
...
### Explicación Pedagógica
**English:** Cows say "Moo."
*Español: Las vacas dicen "Moo" (muuu).*
...
### Explicación Pedagógica
**English:** Birds have wings and can fly.
*Español: Los pájaros tienen alas y pueden volar.*
...
### Explicación Pedagógica
**English:** Lions are known as kings of the jungle.
*Español: Los leones son conocidos como los reyes de la selva.*
...
### Explicación Pedagógica
**English:** A mouse is small and likes cheese.
*Español: Un ratón ("mouse") es pequeño y le gusta el queso.*
...
### Explicación Pedagógica
**English:** Parrots (loros) are common in tropical countries and can mimic speech.
*Español: Los loros ("parrots") son comunes en países tropicales y pueden imitar el habla.*
