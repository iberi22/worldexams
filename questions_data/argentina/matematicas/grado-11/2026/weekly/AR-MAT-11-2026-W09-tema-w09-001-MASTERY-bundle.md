---
id: "AR-MAT-11-2026-W09-tema-w09-001-MASTERY-bundle"
country: "argentina"
grado: 11
...
### Enunciado
¿Cuál de las siguientes medidas estadísticas de tendencia central se define exactamente como el valor que se repite con mayor frecuencia dentro de un conjunto de datos?
...
### Enunciado
¿Cómo se define el rango (o recorrido) de una variable estadística a partir de un conjunto ordenado de datos?

### Opciones
- [ ] A) Como la diferencia entre la media y la moda. <!-- feedback: Incorrecto. Esta relación no representa el rango físico de dispersión. -->
- [x] B) Como la diferencia entre el valor máximo y el valor mínimo del conjunto. <!-- feedback: Correcto. El rango mide la dispersión total de la distribución y se calcula restando el valor mínimo al valor máximo ($R = X_{\text{máx}} - X_{\text{mín}}$). -->
- [ ] C) Como la raíz cuadrada de la varianza. <!-- feedback: Incorrecto. Esto corresponde a la definición de la desviación estándar. -->
- [ ] D) Como el cociente entre la desviación estándar y el promedio. <!-- feedback: Incorrecto. Esto define al coeficiente de variación. -->

### Explicacion Pedagogica
El rango es la medida de dispersión más sencilla. Indica la amplitud total de la variable y se calcula como la diferencia absoluta entre el dato mayor y el menor.
...
### Enunciado
En un gráfico de barras que describe la distribución de frecuencias de una variable discreta, ¿qué parámetro se visualiza de forma directa en el eje vertical (ordenadas)?
...
### Enunciado
Si se sabe que un conjunto de datos tiene una desviación estándar igual a cero ($\sigma = 0$), ¿qué conclusión podés deducir de manera absoluta sobre los valores de la muestra?
...
### Enunciado
Para calcular la mediana de un conjunto de datos numéricos con una cantidad par de observaciones, ¿qué procedimiento matemático debés realizar?
...
### Enunciado
Si tu calificación en un examen nacional de física se ubica exactamente en el percentil 85 ($P_{85}$), ¿cómo se interpreta de manera correcta este resultado de rendimiento?

### Opciones
- [ ] A) Que respondiste correctamente el $85\%$ de las preguntas del examen. <!-- feedback: Incorrecto. El percentil es una medida de posición relativa, no describe el puntaje bruto obtenido directamente. -->
- [x] B) Que tu nota es igual o superior al rendimiento obtenido por el $85\%$ de los estudiantes evaluados en el país. <!-- feedback: Correcto. El percentil 85 indica que el $85\%$ de la distribución de las notas de los evaluados se encuentra por debajo o al mismo nivel que tu calificación. -->
- [ ] C) Que solo el $85\%$ de los alumnos aprobó el examen. <!-- feedback: Incorrecto. No indica tasas de aprobación fijas. -->
- [ ] D) Que tu nota está un $15\%$ por debajo del promedio nacional de los alumnos. <!-- feedback: Incorrecto. No representa distancias respecto al promedio. -->

### Explicacion Pedagogica
Las medidas de posición como los percentiles dividen a la muestra en cien partes iguales. Estar en el percentil $k$ significa superar o igualar al $k\%$ de la población analizada.
...
### Enunciado
Los registros de lluvia (en milímetros) de los últimos 5 meses en Tucumán fueron: $40, 50, 60, 40, 110$. Calculá el promedio (media aritmética) y la mediana de estos registros.
...
### Explicacion Pedagogica
La media es la suma de los datos dividido entre el total ($300/5 = 60$). Para hallar la mediana, se ordena el conjunto: $\{40, 40, 50, 60, 110\}$; al ser $N=5$ impar, la mediana es el dato de la tercera posición, es decir, $50$.
...
### Enunciado
Dada la cantidad de goles anotados por un equipo en sus últimos 5 partidos: $1, 2, 3, 4, 5$. Calculá el valor exacto de la varianza poblacional de este conjunto de datos.

### Opciones
- [ ] A) Varianza = $1$ <!-- feedback: Incorrecto. Se calculó de forma errónea la desviación absoluta promedio. -->
- [x] B) Varianza = $2$ <!-- feedback: Correcto. El promedio es $\frac{1+2+3+4+5}{5} = 3$. Las diferencias al cuadrado son: $(1-3)^2 = 4$, $(2-3)^2 = 1$, $(3-3)^2 = 0$, $(4-3)^2 = 1$, $(5-3)^2 = 4$. La suma es $10$. Dividiendo por el total de datos (5): Varianza = $10/5 = 2$. -->
- [ ] C) Varianza = $\sqrt{2}$ <!-- feedback: Incorrecto. Este valor representa la desviación estándar de la muestra. -->
- [ ] D) Varianza = $4$ <!-- feedback: Incorrecto. No divide por el tamaño de la población. -->

### Explicacion Pedagogica
La varianza poblacional $\sigma^2$ es el promedio de los cuadrados de las desviaciones respecto de la media. Para los datos dados, la media es $3$, la suma de desvíos cuadráticos es $10$, y la varianza es $10/5 = 2$.
...
### Explicacion Pedagogica
La marca de clase es el valor representativo de un intervalo en una distribución agrupada. Se calcula determinando el valor promedio aritmético de sus límites inferior y superior.
...
### Enunciado
Dada la lista ordenada de tiempos de espera (en minutos) de 7 clientes: $2, 4, 5, 8, 10, 12, 15$. ¿Cuáles son los valores correspondientes al primer cuartil ($Q_1$) y al tercer cuartil ($Q_3$)?
...
### Explicacion Pedagogica
El rango intercuartílico (IQR) es la diferencia absoluta entre el tercer y primer cuartil ($Q_3 - Q_1$). Describe la dispersión de la mitad central de las observaciones y define la longitud de la caja en el boxplot.
...
### Explicacion Pedagogica
Por propiedades de los estadísticos: la media de una variable trasladada es $\mu_{x+c} = \mu_x + c$, mientras que la varianza es invariante ante traslaciones: $\sigma^2_{x+c} = \sigma^2_x$.
...
### Enunciado
Si todos los valores de una muestra de precios en pesos se multiplican por un factor de conversión de $3$, ¿cómo se modifican la varianza y la desviación estándar de la nueva muestra?

### Opciones
- [ ] A) Ambos parámetros se multiplican por 3. <!-- feedback: Incorrecto. La varianza se modifica según el cuadrado del factor de escala. -->
- [ ] B) La varianza se multiplica por 3, y la desviación estándar por 9. <!-- feedback: Incorrecto. Las proporciones de los factores de escala están invertidas. -->
- [x] C) La varianza se multiplica por 9, y la desviación estándar se multiplica por 3. <!-- feedback: Correcto. Si $Y = c \cdot X$, el desvío estándar se multiplica por el factor de escala: $\sigma_y = |c| \cdot \sigma_x = 3 \cdot \sigma_x$. La varianza se multiplica por el cuadrado del factor: $\sigma^2_y = c^2 \cdot \sigma^2_x = 9 \cdot \sigma^2_x$. -->
- [ ] D) Ninguno de los dos parámetros de dispersión se ve afectado. <!-- feedback: Incorrecto. Los factores de escala multiplican las distancias internas entre datos afectando a la dispersión. -->

### Explicacion Pedagogica
Por las propiedades de cambio de escala de los parámetros de dispersión: la desviación estándar es una medida lineal y se escala según $\sigma_{cx} = |c|\sigma_x$. La varianza, al medirse en unidades cuadráticas, se escala según $\sigma^2_{cx} = c^2\sigma^2_x$.
...
### Enunciado
Dada una distribución estadística de sueldos donde $Q_1 = \$120000$ y $Q_3 = \$200000$. Según el criterio clásico del boxplot para identificar valores atípicos (outliers), ¿a partir de qué monto un sueldo es considerado un valor atípico superior?
...
### Enunciado
En un estudio socioeconómico, se determina que la media de la distribución de ingresos es $\$150000$ y la mediana es $\$110000$. ¿Qué tipo de asimetría presenta la distribución de los sueldos en este estudio?

### Opciones
- [x] A) Presenta una asimetría sesgada a la derecha (asimetría positiva). <!-- feedback: Correcto. Dado que la media es significativamente mayor que la mediana ($\text{media} > \text{mediana}$), la distribución tiene una cola alargada hacia los valores altos por el efecto de unos pocos sueldos extremadamente altos. -->
- [ ] B) Presenta una asimetría sesgada a la izquierda (asimetría negativa). <!-- feedback: Incorrecto. Esto ocurriría si la media fuera inferior a la mediana. -->
- [ ] C) Es una distribución perfectamente simétrica y bimodal. <!-- feedback: Incorrecto. En distribuciones simétricas puras, la media y la mediana coinciden exactamente. -->
- [ ] D) Es una distribución uniforme y constante. <!-- feedback: Incorrecto. Una distribución uniforme no tendría tanta diferencia entre sus parámetros centrales. -->

### Explicacion Pedagogica
La asimetría positiva o sesgo a la derecha ocurre cuando la media es empujada hacia la derecha por valores atípicos elevados, resultando que la media es estrictamente mayor que la mediana y que la moda.
...
### Enunciado
El curso A obtuvo un promedio de nota de $6$ con desviación estándar de $1,2$. El curso B obtuvo un promedio de $8$ con desviación estándar de $1,6$. ¿Cuál de los dos grupos es más homogéneo de forma relativa (menor dispersión relativa)?
...
### Enunciado
En una encuesta sobre satisfacción con el transporte público en una muestra de 100 usuarios, se cruzaron los datos de zona geográfica (CABA o GBA) con el nivel de satisfacción (Satisfecho o Insatisfecho). Se obtuvo la siguiente tabla de frecuencias absolutas conjuntas:
- CABA y Satisfecho: 30 usuarios
- CABA e Insatisfecho: 10 usuarios
- GBA y Satisfecho: 20 usuarios
- GBA e Insatisfecho: 40 usuarios
¿Cuál es la frecuencia condicionada de estar Satisfecho dado que el usuario pertenece al GBA?
...
### Explicacion Pedagogica
La frecuencia condicionada restringe el espacio de análisis a una fila o columna específica. En este caso, de los $60$ usuarios pertenecientes al GBA, la proporción de satisfechos es $\frac{20}{60} \approx 33,3\%$.
...
### Enunciado
Un conjunto de 5 puntuaciones tiene una media de $7$ y una mediana de $8$. Si se sabe que 4 de los valores son: $3, 5, 8, 9$. ¿Cuál es el quinto valor faltante de la muestra?
...
### Explicacion Pedagogica
Dado que el promedio de los $5$ datos es $7$, la suma agregada es $35$. Restando las cuatro observaciones conocidas ($25$), despejamos el valor faltante de $10$. Ordenando la muestra $\{3, 5, 8, 9, 10\}$ se comprueba que el valor central es $8$.
...
### Explicacion Pedagogica
Los gráficos de barras se basan en el principio de proporcionalidad entre la altura geométrica de la barra y la magnitud cuantitativa representada. Desplazar el origen del eje vertical altera drásticamente esta proporcionalidad, constituyendo una distorsión visual deshonesta.
...
### Enunciado
En un debate sobre las condiciones de vida de una población rural con una gran desigualdad de ingresos (donde un pequeño grupo concentra la mayor parte de las tierras y capitales y la gran mayoría percibe ingresos de subsistencia), se proponen dos estadísticos para resumir el ingreso típico familiar. Evaluá cuál de las dos medidas (media aritmética o mediana) es éticamente más descriptiva y representativa de la realidad socioeconómica general de esa población.
