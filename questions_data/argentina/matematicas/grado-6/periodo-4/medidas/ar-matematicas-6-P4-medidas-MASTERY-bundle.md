---
id: "ar-matematicas-6-P4-medidas-MASTERY-bundle"
country: "argentina"
grado: 6
...
generated: "2026-06-09T19:46:36.798131"
license: "FREE"
open_source: false
bundle_type: "weekly"
year: 2026
...
**ID:** `AR-MATEMATICAS-6-P4-medidas-001`
**Bloom:** Remember
...
La respuesta correcta es la opción B. Esta pregunta evalúa la comprensión del tema medidas en el grado 6 durante el periodo 4. Use ejemplos de Argentina
...
**ID:** `AR-MATEMATICAS-6-P4-medidas-002`
**Bloom:** Understand
**ICFES:** [General competency]
...
**ID:** `AR-MATEMATICAS-6-P4-medidas-003`
**Bloom:** Apply
**ICFES:** [General competency]
...
**ID:** `AR-MATEMATICAS-6-P4-medidas-004`
**Bloom:** Analyze
**ICFES:** [General competency]
...
**ID:** `AR-MATEMATICAS-6-P4-medidas-005`
**Bloom:** Evaluate
**ICFES:** [General competency]
**Expected_Success:** 0.65
**Contexto:** Contexto de la pregunta.
...
**ID:** `AR-MATEMATICAS-6-P4-medidas-006`
**Bloom:** [Create]
**ICFES:** [General competency]
**Expected_Success:** 0.70
**Contexto:** Contexto de la pregunta.
...
**ID:** `AR-MATEMATICAS-6-P4-medidas-007`
**Bloom:** Remember
**ICFES:** [General competency]
**Expected_Success:** 0.75
**Contexto:** Contexto de la pregunta.
...
**ID:** `AR-MATEMATICAS-6-P4-medidas-008`
**Bloom:** Understand
**ICFES:** [General competency]
**Expected_Success:** 0.80
**Contexto:** Contexto de la pregunta.
...
**ID:** `AR-MATEMATICAS-6-P4-medidas-009`
**Bloom:** Apply
**ICFES:** [General competency]
**Expected_Success:** 0.65
**Contexto:** Contexto de la pregunta.
...
**ID:** `AR-MATEMATICAS-6-P4-medidas-010`
**Bloom:** Analyze
**ICFES:** [General competency]
**Expected_Success:** 0.70
**Contexto:** Contexto de la pregunta.
...
**ID:** `AR-MATEMATICAS-6-P4-medidas-011`
**Bloom:** Evaluate
**ICFES:** [General competency]
**Expected_Success:** 0.75
**Contexto:** Contexto de la pregunta.
...
**ID:** `AR-MATEMATICAS-6-P4-medidas-012`
**Bloom:** [Create]
**ICFES:** [General competency]
**Expected_Success:** 0.80
**Contexto:** Contexto de la pregunta.
...
**ID:** `AR-MATEMATICAS-6-P4-medidas-013`
**Bloom:** Remember
**ICFES:** [General competency]
**Expected_Success:** 0.65
**Contexto:** Contexto de la pregunta.
...
**ID:** `AR-MATEMATICAS-6-P4-medidas-014`
**Bloom:** Understand
**ICFES:** [General competency]
**Expected_Success:** 0.70
**Contexto:** Contexto de la pregunta.
...
**ID:** `AR-MATEMATICAS-6-P4-medidas-015`
**Bloom:** Apply
**ICFES:** [General competency]
**Expected_Success:** 0.75
**Contexto:** Contexto de la pregunta.
...
**ID:** `AR-MATEMATICAS-6-P4-medidas-016`
**Bloom:** Analyze
**ICFES:** [General competency]
**Expected_Success:** 0.80
**Contexto:** Contexto de la pregunta.
...
**ID:** `AR-MATEMATICAS-6-P4-medidas-017`
**Bloom:** Evaluate
**ICFES:** [General competency]
**Expected_Success:** 0.65
**Contexto:** Contexto de la pregunta.
...
**ID:** `AR-MATEMATICAS-6-P4-medidas-018`
**Bloom:** [Create]
**ICFES:** [General competency]
**Expected_Success:** 0.70
**Contexto:** Contexto de la pregunta.
...
**ID:** `AR-MATEMATICAS-6-P4-medidas-019`
**Bloom:** Remember
**ICFES:** [General competency]
**Expected_Success:** 0.75
**Contexto:** Contexto de la pregunta.
...
**ID:** `AR-MATEMATICAS-6-P4-medidas-020`
**Bloom:** Understand
**ICFES:** [General competency]
**Expected_Success:** 0.80
**Contexto:** Contexto de la pregunta.
