---
id: "ar-matematicas-6-P2-operaciones-basicas-MASTERY-bundle"
country: "argentina"
grado: 6
...
generated: "2026-06-09T19:46:36.793868"
license: "FREE"
open_source: false
bundle_type: "weekly"
year: 2026
...
**ID:** `AR-MATEMATICAS-6-P2-operaciones-basicas-001`
**Bloom:** Remember
...
La respuesta correcta es la opción B. Esta pregunta evalúa la comprensión del tema operaciones basicas en el grado 6 durante el periodo 2. Use ejemplos de Argentina
...
**ID:** `AR-MATEMATICAS-6-P2-operaciones-basicas-002`
**Bloom:** Understand
**ICFES:** [General competency]
...
**ID:** `AR-MATEMATICAS-6-P2-operaciones-basicas-003`
**Bloom:** Apply
**ICFES:** [General competency]
...
**ID:** `AR-MATEMATICAS-6-P2-operaciones-basicas-004`
**Bloom:** Analyze
**ICFES:** [General competency]
...
**ID:** `AR-MATEMATICAS-6-P2-operaciones-basicas-005`
**Bloom:** Evaluate
**ICFES:** [General competency]
**Expected_Success:** 0.65
**Contexto:** Contexto de la pregunta.
...
**ID:** `AR-MATEMATICAS-6-P2-operaciones-basicas-006`
**Bloom:** [Create]
**ICFES:** [General competency]
**Expected_Success:** 0.70
**Contexto:** Contexto de la pregunta.
...
**ID:** `AR-MATEMATICAS-6-P2-operaciones-basicas-007`
**Bloom:** Remember
**ICFES:** [General competency]
**Expected_Success:** 0.75
**Contexto:** Contexto de la pregunta.
...
**ID:** `AR-MATEMATICAS-6-P2-operaciones-basicas-008`
**Bloom:** Understand
**ICFES:** [General competency]
**Expected_Success:** 0.80
**Contexto:** Contexto de la pregunta.
...
**ID:** `AR-MATEMATICAS-6-P2-operaciones-basicas-009`
**Bloom:** Apply
**ICFES:** [General competency]
**Expected_Success:** 0.65
**Contexto:** Contexto de la pregunta.
...
**ID:** `AR-MATEMATICAS-6-P2-operaciones-basicas-010`
**Bloom:** Analyze
**ICFES:** [General competency]
**Expected_Success:** 0.70
**Contexto:** Contexto de la pregunta.
...
**ID:** `AR-MATEMATICAS-6-P2-operaciones-basicas-011`
**Bloom:** Evaluate
**ICFES:** [General competency]
**Expected_Success:** 0.75
**Contexto:** Contexto de la pregunta.
...
**ID:** `AR-MATEMATICAS-6-P2-operaciones-basicas-012`
**Bloom:** [Create]
**ICFES:** [General competency]
**Expected_Success:** 0.80
**Contexto:** Contexto de la pregunta.
...
**ID:** `AR-MATEMATICAS-6-P2-operaciones-basicas-013`
**Bloom:** Remember
**ICFES:** [General competency]
**Expected_Success:** 0.65
**Contexto:** Contexto de la pregunta.
...
**ID:** `AR-MATEMATICAS-6-P2-operaciones-basicas-014`
**Bloom:** Understand
**ICFES:** [General competency]
**Expected_Success:** 0.70
**Contexto:** Contexto de la pregunta.
...
**ID:** `AR-MATEMATICAS-6-P2-operaciones-basicas-015`
**Bloom:** Apply
**ICFES:** [General competency]
**Expected_Success:** 0.75
**Contexto:** Contexto de la pregunta.
...
**ID:** `AR-MATEMATICAS-6-P2-operaciones-basicas-016`
**Bloom:** Analyze
**ICFES:** [General competency]
**Expected_Success:** 0.80
**Contexto:** Contexto de la pregunta.
...
**ID:** `AR-MATEMATICAS-6-P2-operaciones-basicas-017`
**Bloom:** Evaluate
**ICFES:** [General competency]
**Expected_Success:** 0.65
**Contexto:** Contexto de la pregunta.
...
**ID:** `AR-MATEMATICAS-6-P2-operaciones-basicas-018`
**Bloom:** [Create]
**ICFES:** [General competency]
**Expected_Success:** 0.70
**Contexto:** Contexto de la pregunta.
...
**ID:** `AR-MATEMATICAS-6-P2-operaciones-basicas-019`
**Bloom:** Remember
**ICFES:** [General competency]
**Expected_Success:** 0.75
**Contexto:** Contexto de la pregunta.
...
**ID:** `AR-MATEMATICAS-6-P2-operaciones-basicas-020`
**Bloom:** Understand
**ICFES:** [General competency]
**Expected_Success:** 0.80
**Contexto:** Contexto de la pregunta.
