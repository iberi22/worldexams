...
- [ ] D) Sangre <!-- feedback: Incorrect. La sangre transporta los nutrientes ya procesados, pero no participa directamente en la descomposición química inicial de los alimentos en la boca. -->

### Explicación Pedagógica
Se evalúa el conocimiento sobre las etapas iniciales de la digestión. La respuesta correcta identifica la saliva como el agente químico inicial en la boca. Un error común es confundir los diferentes jugos digestivos según el órgano donde se producen.
...
- [ ] D) Páncreas <!-- feedback: Incorrect. El páncreas es una glándula que produce jugos digestivos, pero no es un tubo por donde pase el alimento. -->

### Explicación Pedagógica
Se evalúa la identificación de los órganos del tracto digestivo y su ubicación. La respuesta correcta distingue el esófago como el conector principal. Un error frecuente es confundir el esófago con la tráquea debido a su proximidad física.
...
- [ ] D) Boca <!-- feedback: Incorrect. En la boca solo comienza la digestión; no hay absorción significativa de nutrientes hacia el cuerpo en esta etapa. -->

### Explicación Pedagógica
Se evalúa la función de absorción dentro del proceso digestivo. La respuesta correcta localiza esta función en el intestino delgado. Los estudiantes suelen pensar erróneamente que el estómago es el lugar donde se realiza todo el proceso de nutrición.
...
- [ ] D) Lechuga <!-- feedback: Incorrect. La lechuga aporta vitaminas, minerales y fibra, pero su contenido de proteína es muy bajo. -->

### Explicación Pedagógica
Se evalúa la clasificación de los alimentos según sus nutrientes principales. La respuesta correcta identifica al huevo como fuente proteica. El error común es no distinguir entre carbohidratos (energía) y proteínas (construcción).
...
- [ ] D) Mareo <!-- feedback: Incorrect. Aunque el malestar digestivo puede causar incomodidad, el mareo no es el síntoma principal o directo de la falta de fibra. -->

### Explicación Pedagógica
Se evalúa la relación entre la dieta y el funcionamiento de los órganos digestivos. La respuesta correcta asocia la fibra con la salud del colon. Los estudiantes a veces asocian cualquier malestar con la nutrición sin identificar el síntoma específico.
...
- [ ] D) Ayudan a que el aire llegue más rápido a los pulmones durante la comida. <!-- feedback: Incorrect. Estos órganos no tienen funciones respiratorias; pertenecen exclusivamente al sistema digestivo y metabólico. -->

### Explicación Pedagógica
Se evalúa el papel de las glándulas anexas en la digestión. La respuesta correcta explica su función química. El error común es ignorar la existencia de órganos que participan en la digestión sin estar en contacto directo con el trayecto del bolo alimenticio.
...
- [ ] D) El estómago dejaría de producir ácidos para compensar. <!-- feedback: Incorrect. El estómago no reduce sus ácidos por falta de saliva; de hecho, podría trabajar más para intentar compensar la falta de digestión inicial. -->

### Explicación Pedagógica
Se evalúa la capacidad de predecir consecuencias basadas en el funcionamiento de un componente del sistema. La respuesta correcta integra la función mecánica y química de la saliva. Es una pregunta de nivel analítico que requiere conectar causa y efecto.
...
- [ ] D) Que no aportan absolutamente nada de energía al cuerpo. <!-- feedback: Incorrect. Sí aportan mucha energía, pero el problema es que el exceso se almacena como grasa dañina. -->

### Explicación Pedagógica
Se evalúa la interpretación de modelos gráficos sobre nutrición. La respuesta correcta traduce la forma de la pirámide a una recomendación dietética. Los errores suelen ser por una mala interpretación de la importancia de los alimentos "ricos" en sabor pero pobres en nutrientes.
...
- [ ] D) Porque los dientes molares ayudan a que el estómago trabaje menos. <!-- feedback: Incorrect. Aunque ayudan, la razón principal de la variedad es la adaptación a diferentes alimentos, no simplemente ahorrar trabajo al estómago. -->

### Explicación Pedagógica
Se evalúa la relación entre la anatomía y la función dietética. La respuesta correcta identifica la adaptación a una dieta variada. Los estudiantes a veces olvidan la conexión entre la forma de los órganos y su utilidad práctica.
...
- [ ] D) A que el agua que bebió se convirtió en gas inmediatamente. <!-- feedback: Incorrect. El agua no se convierte en gas por correr; el malestar es por la falta de procesamiento inicial de los sólidos. -->

### Explicación Pedagógica
Se evalúa la comprensión de la digestión mecánica y su importancia. La respuesta correcta conecta la masticación con la eficiencia estomacal. Los errores comunes incluyen explicaciones fantásticas o relacionadas con otros sistemas sin base científica.

### Explicación Pedagógica Final
Este bundle evalúa los conocimientos sobre el sistema digestivo y la nutrición humana para grado cuarto. Los temas incluyen la anatomía del tracto digestivo, la función de los diferentes jugos gástricos, la importancia de la nutrición balanceada y la relación entre los hábitos alimenticios y la salud. Las preguntas buscan que el estudiante no solo memorice nombres de órganos, sino que comprenda la secuencia del proceso digestivo y cómo cada parte contribuye a la obtención de energía y nutrientes. Se enfatiza el uso de contextos cotidianos colombianos para facilitar la relevancia del aprendizaje.
