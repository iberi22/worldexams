...
- [ ] D) Condensación <!-- feedback: Incorrect. La condensación es el paso de gas a líquido, como cuando el vapor se vuelve gotas de agua en una tapa. -->

### Explicación Pedagógica
Se evalúa el conocimiento de los cambios de estado del agua. La respuesta correcta identifica la fusión. Un error común es usar términos cotidianos como "derretirse" sin asociarlos con el término científico técnico, o confundir los nombres de los procesos inversos.
...
- [ ] D) Siempre se puede ver y tocar fácilmente. <!-- feedback: Incorrect. Muchos gases, como el aire, son invisibles a nuestros ojos y difíciles de "tocar" como si fueran objetos sólidos. -->

### Explicación Pedagógica
Se evalúa la comprensión de las propiedades de los estados de la materia. La respuesta correcta describe el comportamiento expansivo de los gases. Los estudiantes a veces confunden las propiedades de los líquidos con las de los gases.
...
- [ ] D) Filtración <!-- feedback: Incorrect. La filtración es un método para separar mezclas, no es un cambio de estado de la materia. -->

### Explicación Pedagógica
Se evalúa la aplicación de los cambios de estado en fenómenos naturales del ciclo del agua. La respuesta correcta identifica la condensación. Un error frecuente es confundir el proceso de formación de vapor con el de formación de gotas.
...
- [ ] D) Mezclar arena con sal en un recipiente. <!-- feedback: Incorrect. La arena y la sal mantienen sus propiedades y se pueden separar. Es un cambio físico (mezcla). -->

### Explicación Pedagógica
Se evalúa la distinción entre cambios físicos y químicos. La respuesta correcta identifica la combustión como transformación química. Los estudiantes suelen pensar que cualquier cambio "grande" o "destructivo" es químico, sin analizar la naturaleza de la sustancia.
...
- [ ] D) Un vaso graduado y medir en mililitros. <!-- feedback: Incorrect. El vaso graduado mide el volumen (el espacio que ocupa), no la masa (cantidad de materia). -->

### Explicación Pedagógica
Se evalúa el conocimiento sobre magnitudes físicas e instrumentos de medida. La respuesta correcta asocia masa con balanza y kilogramos. Un error común es confundir masa con volumen o peso con tamaño.
...
- [ ] D) A que el aceite tiene más vitaminas que el agua. <!-- feedback: Incorrect. Los nutrientes no determinan la posición física de los líquidos en una mezcla. -->

### Explicación Pedagógica
Se evalúa el concepto de densidad. La respuesta correcta identifica la densidad como la causa de la estratificación de los líquidos. Los estudiantes a veces creen que el líquido de "arriba" es el que tiene más fuerza o el que es más "espeso".
...
- [ ] D) Energía magnética <!-- feedback: Incorrect. El fuego no tiene propiedades de imán para atraer metales. -->

### Explicación Pedagógica
Se evalúa el reconocimiento de las formas de energía asociadas a cambios químicos. La respuesta correcta identifica la energía térmica. Un error común es no asociar el calor con un tipo de energía específica llamada térmica.
...
- [ ] D) La electricidad de los rayos durante las tormentas. <!-- feedback: Incorrect. Aunque los rayos tienen mucha energía, el ciclo del agua es un proceso continuo impulsado por el sol, no por eventos aislados como los rayos. -->

### Explicación Pedagógica
Se evalúa la comprensión de los motores energéticos de los procesos físicos terrestres. La respuesta correcta identifica al sol como fuente primaria. Los errores reflejan una falta de conexión entre la energía térmica y los cambios climáticos.
...
- [ ] D) El clavo simplemente se ensució con un poco de tierra. <!-- feedback: Incorrect. El cambio es estructural y químico, no es solo suciedad superficial que se pueda quitar lavando con agua. -->

### Explicación Pedagógica
Se evalúa el reconocimiento del proceso de oxidación como cambio químico. La respuesta correcta explica la formación de óxido. Los estudiantes suelen confundir procesos químicos con simples ensuciamientos o cambios de color superficiales.
...
- [ ] D) Separación de fases <!-- feedback: Incorrect. Esto es lo contrario; ocurre cuando los componentes no se mezclan, como el agua y el aceite. -->

### Explicación Pedagógica
Se evalúa la clasificación de mezclas. La respuesta correcta identifica la mezcla homogénea. Un error frecuente es confundir la mezcla con un cambio químico debido a que "ya no se ve" el chocolate original.

### Explicación Pedagógica Final
Este bundle sobre materia y sus cambios para grado cuarto introduce conceptos de física y química básicas. Los estudiantes exploran los estados de la materia, los cambios físicos (como los cambios de estado del agua) y los cambios químicos (como la combustión y la oxidación). Se enfatiza la diferencia entre propiedades medibles como la masa y propiedades relativas como la densidad. El uso de contextos cotidianos, desde la cocina hasta el clima colombiano, permite que el estudiante observe que la ciencia de la materia está presente en todo su entorno. Las preguntas fomentan la observación científica y el uso de terminología técnica adecuada para describir fenómenos naturales.
