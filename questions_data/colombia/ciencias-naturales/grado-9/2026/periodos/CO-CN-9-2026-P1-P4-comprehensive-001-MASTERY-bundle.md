...
tema: "tabla-periodica, enlaces-quimicos, cinematica-movimiento, reproduccion-biologia, sistemas-cuerpo"
periodo: "P1-P4"
...
rubric_baseline: "Tabla periódica, enlaces químicos, movimiento rectilíneo, reproducción celular y humana, sistemas del cuerpo humano"
coverage:
  - "P1: Química — Tabla periódica, configuración electrónica, enlaces químicos"
...
Este bundle integral cubre los cuatro periodos de grado 9 en ciencias naturales: tabla periódica y enlaces químicos, movimiento y cinemática, reproducción celular (mitosis y meiosis), y reproducción humana con sistemas del cuerpo.
...
- [ ] D) Aluminio (Al) — es un metal del grupo 13 <!-- feedback: Incorrect. El aluminio tiene Z=13 y está en el grupo 13, no grupo 2. -->

### Explicación Pedagógica
El número atómico (Z) define la identidad del elemento. El magnesio (Mg, Z=12) tiene configuración electrónica $1s^2 2s^2 2p^6 3s^2$, con dos electrones de valencia, lo que lo ubica en el grupo 2 (metales alcalinotérreos) y período 3.
...
- [ ] D) Enlace de hidrógeno — atracción entre un hidrógeno y átomos electronegativos <!-- feedback: Incorrect. El puente de hidrógeno es una fuerza intermolecular, no un enlace químico primario. -->

### Explicación Pedagógica
La diferencia de electronegatividad entre metales (baja) y no metales (alta) favorece la transferencia de electrones. Por ejemplo, en el NaCl (sal de mesa), el sodio cede un electrón al cloro, formando Na⁺ y Cl⁻ que se atraen electrostáticamente.
...
- [ ] D) Las moléculas de agua son más grandes y pesadas que las de H₂S. <!-- feedback: Incorrect. El agua (18 g/mol) es más liviana que el H₂S (34 g/mol). -->

### Explicación Pedagógica
El agua presenta puentes de hidrógeno porque el oxígeno, muy electronegativo y con pares de electrones libres, atrae fuertemente al hidrógeno de otra molécula. El azufre, siendo menos electronegativo y más grande, forma puentes de hidrógeno muy débiles. Esto explica el alto punto de ebullición del agua (100°C) frente al H₂S (-60°C).
...
- [ ] D) Movimiento uniformemente acelerado, con velocidad inicial de 0 m/s <!-- feedback: Incorrect. El MRU no tiene aceleración. La posición varía linealmente con el tiempo. -->

### Explicación Pedagógica
En un MRU, la posición cambia en cantidades iguales en intervalos de tiempo iguales. La pendiente de la gráfica $x$ vs $t$ es constante e igual a la velocidad: $v = \frac{\Delta x}{\Delta t} = \frac{20 \text{ m}}{2 \text{ s}} = 10$ m/s.
...
- [ ] D) 40 m <!-- feedback: Incorrect. Se usó $at = 4(5) = 20$ y se multiplicó por 2, sin usar la fórmula correcta. -->

### Explicación Pedagógica
Para MRUV con velocidad inicial cero, la distancia recorrida es $x = \frac{1}{2}at^2$. Sustituyendo: $x = \frac{1}{2}(4 \text{ m/s}^2)(25 \text{ s}^2) = 50$ m. La velocidad final sería $v_f = at = 20$ m/s (72 km/h).
...
- [ ] D) La mitosis produce células haploides y la meiosis produce células diploides. <!-- feedback: Incorrect. Es lo opuesto: mitosis produce células diploides, meiosis produce haploides. -->

### Explicación Pedagógica
La mitosis es para crecimiento y reparación celular (2 células hijas 2n idénticas). La meiosis es para formación de gametos (4 células hijas n genéticamente distintas), con dos divisiones y recombinación genética en la meiosis I.
...
- [ ] D) $a = -20$ m/s² y $d = 40$ m <!-- feedback: Incorrect. La aceleración es $(-20)/4 = -5$, no $-20$. Se usó la velocidad inicial en lugar del cambio de velocidad. -->

### Explicación Pedagógica
La aceleración es el cambio de velocidad por unidad de tiempo: $a = \frac{v_f - v_0}{t} = \frac{0-20}{4} = -5$ m/s². La distancia de frenado se calcula con $d = v_0 t + \frac{1}{2}at^2 = 80 - 40 = 40$ m, o alternativamente $d = \frac{v_f^2 - v_0^2}{2a} = \frac{-400}{-10} = 40$ m.
...
- [ ] D) Las tres conducen porque todas se disuelven en agua. <!-- feedback: Incorrect. Disolverse no es suficiente; la sustancia debe disociarse en iones para conducir. -->

### Explicación Pedagógica
La conductividad eléctrica en solución depende de la presencia de iones libres. Los compuestos iónicos (NaCl) se disocian completamente. Los ácidos fuertes (HCl) se ionizan completamente. Los compuestos covalentes como la glucosa se disuelven pero no se ionizan (no electrolitos).
...
- [ ] D) Telofase — se forman nuevos núcleos y los cromosomas se descondensan <!-- feedback: Incorrect. En telofase ocurre la reconstitución nuclear, no la alineación. -->

### Explicación Pedagógica
La mitosis tiene cuatro fases: profase (condensación), metafase (alineación en el ecuador), anafase (separación de cromátidas), telofase (formación de núcleos). La alineación en el ecuador es característica de la metafase.
...
- [ ] D) Producir hormonas como estrógeno y progesterona <!-- feedback: Incorrect. Las hormonas femeninas son producidas principalmente por los ovarios, no por las trompas. -->

### Explicación Pedagógica
Las trompas de Falopio (u oviductos) tienen dos funciones clave: transporte del óvulo mediante cilios y contracciones, y ser el sitio de fecundación. Si no hay fecundación, el óvulo se desintegra; si hay, el cigoto viaja al útero para implantarse.
...
- [ ] D) La distancia recorrida en el intervalo 2-5 s es menor que en 0-2 s. <!-- feedback: Incorrect. En MRU, la distancia es $v \cdot t$. En 0-2 s: $5 \times 2 = 10$ m; en 2-5 s: $5 \times 3 = 15$ m. El segundo intervalo es mayor. -->

### Explicación Pedagógica
En una gráfica $v$ vs $t$, la pendiente representa la aceleración y el área bajo la curva representa la distancia recorrida. En el intervalo 0-5 s: $a=0$ (MRU), distancia $5 \times 5 = 25$ m. En 5-8 s: $a = 10/3 \approx 3.33$ m/s² (MRUV), distancia $= 5 \times 3 + \frac{1}{2}(3.33)(9) \approx 30$ m.
...
- [ ] D) No, porque la meiosis I y II producen células con el mismo número de cromosomas (n). <!-- feedback: Incorrect. La meiosis I reduce de 2n a n; la meiosis II mantiene n. La afirmación del estudiante es sobre el proceso, no sobre el resultado celular. -->

### Explicación Pedagógica
En la meiosis I se separan los cromosomas homólogos (tétradas), reduciendo el número de cromosomas de diploide (2n) a haploide (n). En la meiosis II se separan las cromátidas hermanas (similar a mitosis), manteniendo el número haploide (n → n). Por eso se dice: meiosis I = reduccional, meiosis II = ecuacional.
...
- [ ] D) Ambos están equivocados porque la ovulación no depende de días fijos sino de la temperatura corporal. <!-- feedback: Incorrect. Aunque la temperatura cambia, la ovulación sí sigue un patrón regular aproximadamente al día 14 de un ciclo de 28 días. -->

### Explicación Pedagógica
El ciclo menstrual promedio de 28 días tiene fases: menstrual (días 1-5), folicular (días 6-13), ovulación (día ~14), lútea (días 15-28). La ovulación es desencadenada por el pico de hormona luteinizante (LH) y libera el óvulo del folículo ovárico.
...
- [ ] D) 104.2 m <!-- feedback: Incorrect. Se duplicó algún valor. La distancia total correcta es aproximadamente 72.1 m. -->

### Explicación Pedagógica
La distancia total de detención es la suma de: (1) distancia de reacción $d_r = v_0 t_r$ (MRU mientras decide frenar), y (2) distancia de frenado $d_f = \frac{v_0^2}{2a}$ (MRUV hasta detenerse). $d_{total} = 25(0.8) + \frac{25^2}{2(6)} = 20 + 52.1 = 72.1$ m.
...
- [ ] D) Enfocarse solo en las consecuencias biológicas del embarazo sin considerar el contexto social. <!-- feedback: Incorrect. Un abordaje integral requiere considerar dimensiones biológicas, psicológicas y sociales. -->
