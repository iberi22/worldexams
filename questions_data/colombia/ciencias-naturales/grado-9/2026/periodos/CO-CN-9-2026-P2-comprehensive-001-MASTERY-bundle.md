...
tema: "ecologia-poblaciones, tabla-periodica-propiedades, leyes-newton-aplicaciones"
periodo: 2
...
Este bundle cubre los contenidos del segundo periodo de ciencias naturales en grado 9: ecologia de poblaciones, propiedades periodicas de los elementos y aplicaciones de las leyes de Newton.
...
- [ ] D) El papel que desempena una especie en el ecosistema. <!-- feedback: Incorrect. Ese es el concepto de nicho ecologico. -->

### Explicacion Pedagogica
En ecologia, los niveles de organizacion son: individuo, poblacion (misma especie), comunidad (distintas especies), ecosistema (seres vivos + ambiente), bioma y biosfera.
...
- [ ] D) Por el numero de neutrones en el nucleo. <!-- feedback: Incorrect. El numero de neutrones puede variar en isotopos del mismo elemento. -->

### Explicacion Pedagogica
La tabla periodica moderna esta organizada por numero atomico (Z) creciente. Los periodos son filas horizontales y los grupos son columnas verticales con elementos de propiedades quimicas similares.
...
- [ ] D) Tercera ley: accion y reaccion. <!-- feedback: Incorrect. La tercera ley explica pares de fuerzas, no la detencion del movimiento. -->

### Explicacion Pedagogica
La primera ley de Newton (ley de inercia) establece que un objeto en movimiento continuara moviendose a velocidad constante a menos que una fuerza externa neta actue sobre el. El rozamiento es la fuerza que detiene al escritorio.
...
- [ ] D) Porque tienen muchos neutrones. <!-- feedback: Incorrect. El numero de neutrones no afecta significativamente la reactividad. -->

### Explicacion Pedagogica
La regla del octeto establece que los atomos tienden a completar 8 electrones en su ultima capa para alcanzar estabilidad. Los gases nobles ya tienen esta configuracion, por lo que no tienden a reaccionar.
...
- [ ] D) 5000 individuos/m2 <!-- feedback: Incorrect. Se multiplicaron los valores. -->

### Explicacion Pedagogica
La densidad de poblacion se calcula como D = N/A, donde N es el numero de individuos y A es el area. Es una medida fundamental en ecologia para comparar poblaciones.
...
- [ ] D) 60 m/s2 <!-- feedback: Incorrect. Se uso la fuerza como aceleracion sin dividir por la masa. -->

### Explicacion Pedagogica
La segunda ley de Newton establece que a = F/m. La aceleracion es directamente proporcional a la fuerza neta aplicada e inversamente proporcional a la masa del objeto.
...
- [ ] D) El sodio esta en un periodo superior. <!-- feedback: Incorrect. Ambos estan en el periodo 3 de la tabla periodica. -->

### Explicacion Pedagogica
La reactividad de los metales aumenta hacia abajo y hacia la izquierda en la tabla periodica. Los metales del grupo 1 (alkalinos) son los mas reactivos porque pierden facilmente su unico electron de valencia.
...
- [ ] D) 10000 N <!-- feedback: Incorrect. Se multiplico 1000*20/2 en lugar de 1000*20/5. -->

### Explicacion Pedagogica
La fuerza de frenado se calcula con F = m*a. Primero se encuentra la aceleracion (a = deltaV/deltaT = -20/5 = -4 m/s2). Luego F = 1000*4 = 4000 N.
...
- [ ] D) Las especies nativas se adaptaran inmediatamente. <!-- feedback: Incorrect. La adaptacion evolutiva toma muchas generaciones. -->

### Explicacion Pedagogica
Las especies exoticas o invasoras son una de las principales causas de perdida de biodiversidad a nivel mundial. Compiten con las especies nativas por recursos y pueden no tener depredadores naturales.
...
- [ ] D) 2.5 m/s2 hacia la derecha <!-- feedback: Incorrect. Se dividio 50/20 en lugar de (80-50)/30. -->

### Explicacion Pedagogica
La fuerza neta es la suma vectorial de todas las fuerzas. Cuando las fuerzas estan en direcciones opuestas, se restan. La aceleracion tiene la direccion de la fuerza neta.
...
- [ ] D) No, porque la fuerza del caballo es mayor que la de la carreta. <!-- feedback: Incorrect. La tercera ley dice que las fuerzas son iguales en magnitud. -->

### Explicacion Pedagogica
La tercera ley de Newton dice que las fuerzas siempre vienen en pares (accion-reaccion) que actuan sobre cuerpos diferentes. Por eso no se cancelan. El caballo avanza porque empuja el suelo hacia atras y el suelo lo empuja hacia adelante.
...
- [ ] D) Porque los electrones de valencia estan en niveles mas altos. <!-- feedback: Incorrect. Dentro del mismo periodo, los electrones de valencia estan en el mismo nivel. -->

### Explicacion Pedagogica
La energia de ionizacion es la energia necesaria para arrancar un electron. Aumenta hacia la derecha en un periodo porque la carga nuclear efectiva aumenta, atrayendo mas los electrones y haciendolos mas dificiles de arrancar.
...
- [ ] D) No, la fuerza necesaria se reduce a la mitad. <!-- feedback: Incorrect. La relacion es directamente proporcional, no inversamente. -->

### Explicacion Pedagogica
La segunda ley de Newton F = m*a muestra una relacion de proporcionalidad directa entre fuerza y masa cuando la aceleracion es constante. Si la masa se duplica, la fuerza necesaria se duplica.
...
- [ ] D) Las ranas desarrollan resistencia inmediata a la epidemia. <!-- feedback: Incorrect. La resistencia no se desarrolla inmediatamente; la evolucion requiere seleccion natural a traves de generaciones. -->

### Explicacion Pedagogica
Un cuello de botella genetico ocurre cuando una poblacion se reduce drasticamente. La diversidad genetica se pierde y la poblacion resultante puede tener una composicion genetica diferente a la original, con menor capacidad de adaptacion.
...
- [ ] D) La muestra de neon tiene menos atomos porque tiene menos electrones. <!-- feedback: Incorrect. El numero de atomos es el mismo para todas (1 mol). -->
