...
tema: "evolucion-seleccion-natural, compuestos-organicos, electricidad-basica"
periodo: 4
...
Este bundle cubre la teoria de la evolucion por seleccion natural, los compuestos organicos esenciales para la vida y los fundamentos de la electricidad.
...
- [ ] D) Alfred Wallace <!-- feedback: Parcialmente correcto. Wallace tambien propuso la seleccion natural, pero Darwin es mas reconocido. -->

### Explicacion Pedagogica
Charles Darwin, basandose en observaciones en las Islas Galapagos y otras regiones, propuso que las especies evolucionan a traves de la seleccion natural: los individuos con caracteristicas ventajosas tienen mayor probabilidad de sobrevivir y reproducirse.
...
- [ ] D) Solo forma enlaces ionicos. <!-- feedback: Incorrect. El carbono forma principalmente enlaces covalentes. -->

### Explicacion Pedagogica
El carbono es unico por su capacidad de formar cuatro enlaces covalentes estables, permitiendo cadenas lineales, ramificadas y ciclicas. Esto es la base de la quimica organica y de la vida.
...
- [ ] D) Todas las lagartijas cambiaron de color simultaneamente. <!-- feedback: Incorrect. La evolucion es gradual y ocurre en poblaciones, no en individuos. -->

### Explicacion Pedagogica
La seleccion natural requiere: 1) variacion en la poblacion, 2) herencia de los rasgos, 3) reproduccion diferencial. Las lagartijas mejor camufladas escapan de depredadores, sobreviven mas y tienen mas crias.
...
- [ ] D) Acelerar reacciones quimicas. <!-- feedback: Incorrect. Esa es la funcion de las enzimas, que son proteinas. -->

### Explicacion Pedagogica
Los carbohidratos incluyen azucares simples (glucosa, fructosa) y complejos (almidon, celulosa). Su funcion principal es energetica, aunque tambien cumplen funciones estructurales (celulosa en plantas).
...
- [ ] D) 0.83 A <!-- feedback: Incorrect. Se dividio la resistencia entre el voltaje (10/12), pero es V/R, no R/V. -->

### Explicacion Pedagogica
La ley de Ohm establece que la corriente es directamente proporcional al voltaje e inversamente proporcional a la resistencia: I = V/R. Las unidades son: I en amperios (A), V en voltios (V), R en ohmios (Ω).
...
- [ ] D) Mutacion dirigida <!-- feedback: Incorrect. Las mutaciones son aleatorias, no dirigidas por el ambiente. -->

### Explicacion Pedagogica
La especiacion alopatrica ocurre cuando una barrera fisica (geografica) separa una poblacion. Con el tiempo, la seleccion natural, la deriva genetica y las mutaciones en cada poblacion pueden llevar a la formacion de nuevas especies.
...
- [ ] D) 3 ohmios <!-- feedback: Incorrect. Ese valor no corresponde a ninguna combinacion serie/paralelo de 6 ohmios. -->

### Explicacion Pedagogica
En circuitos en serie, la resistencia equivalente es la suma de todas las resistencias. La corriente es la misma en todo el circuito, pero el voltaje se divide entre las resistencias.
...
- [ ] D) El cabello se carga positivamente y repele el globo. <!-- feedback: Incorrect. El globo atrae, no repele. -->

### Explicacion Pedagogica
La electricidad estatica se produce por la transferencia de electrones entre materiales al frotarlos. Materiales como el vidrio o el cabello tienden a perder electrones (carga positiva), mientras que plasticos como el globo tienden a ganarlos (carga negativa).
...
- [ ] D) El pino evoluciono especificamente para este ambiente. <!-- feedback: Incorrect. El pino trajo adaptaciones de su ambiente original, no evoluciono para Colombia. -->

### Explicacion Pedagogica
La adaptacion es relativa al ambiente. Una especie exotica puede tener exito en un nuevo ambiente si sus caracteristicas resultan ventajosas alli, aunque no haya evolucionado en ese lugar.
...
- [ ] D) 4.8 ohmios <!-- feedback: Incorrect. Se sumaron las resistencias y se dividio entre 2. -->

### Explicacion Pedagogica
En circuitos en paralelo, la resistencia equivalente se calcula como: 1/Req = 1/R1 + 1/R2 + ... La resistencia equivalente siempre es menor que la resistencia mas pequena del circuito.
...
- [ ] D) Los animales se adaptaron a la altura y sus restos quedaron alli. <!-- feedback: Incorrect. Los animales marinos no pueden sobrevivir en la cima de montanas. -->

### Explicacion Pedagogica
Los fosiles son evidencia de la vida pasada y de los cambios geologicos. Encontrar fosiles marinos en montanas indica que la corteza terrestre se ha elevado, transformando fondos marinos en tierra firme.
...
- [ ] D) 9.3 ohmios <!-- feedback: Incorrect. Se sumaron los valores. -->

### Explicacion Pedagogica
La ley de Ohm permite despejar cualquier variable: V = I*R, I = V/R, R = V/I. Es fundamental recordar que la corriente se mide en amperios.
...
- [ ] D) No, pero solo tiene evidencia fosil. <!-- feedback: Incorrect. La evolucion tiene multiples lineas de evidencia: fosiles, ADN, anatomia comparada, distribucion geografica, observacion directa. -->

### Explicacion Pedagogica
En el metodo cientifico, una "teoria" es una explicacion bien fundamentada que integra multiples evidencias. La evolucion es una teoria cientifica con respaldo de: paleontologia, genetica, biologia molecular, biogeografia y observacion directa.
...
- [ ] D) No se puede determinar sin la corriente. <!-- feedback: Incorrect. La formula P = V^2/R usa solo V y R, ambos conocidos. -->

### Explicacion Pedagogica
La potencia electrica se puede calcular con P = V*I = I^2*R = V^2/R. A menor resistencia, mayor corriente y mayor potencia para el mismo voltaje.
...
- [ ] D) No es seleccion natural, es un cambio aleatorio. <!-- feedback: Incorrect. Si los depredadores evitan las ranas brillantes, hay una presion selectiva clara. -->
