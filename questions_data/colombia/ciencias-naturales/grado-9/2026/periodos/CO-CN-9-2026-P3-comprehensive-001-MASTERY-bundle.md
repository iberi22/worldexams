...
tema: "genetica-mendeliana, enlaces-quimicos, termodinamica-basica"
periodo: 3
...
Este bundle cubre los principios de la herencia genetica mendeliana, los tipos de enlaces quimicos y los conceptos basicos de termodinamica.
...
- [ ] D) La apariencia fisica de un rasgo genetico. <!-- feedback: Incorrect. Ese es el fenotipo, no el alelo. -->

### Explicacion Pedagogica
Los alelos son versiones diferentes de un mismo gen que ocupan la misma posicion (locus) en cromosomas homologos. Mendel estudio alelos para caracteres como forma y color de semillas.
...
- [ ] D) Enlace de hidrogeno <!-- feedback: Incorrect. El enlace de hidrogeno es una interaccion intermolecular, no un enlace quimico primario. -->

### Explicacion Pedagogica
El enlace ionico ocurre entre un metal (que pierde electrones) y un no metal (que gana electrones). Ejemplo: NaCl (cloruro de sodio), donde Na dona un electron a Cl.
...
- [ ] D) Que el alelo amarillo es recesivo. <!-- feedback: Incorrect. Si fuera recesivo, no se expresaria en presencia del verde. -->

### Explicacion Pedagogica
Mendel formulo el principio de dominancia: cuando dos alelos diferentes estan presentes, uno (dominante) se expresa y el otro (recesivo) permanece oculto. En la F1, todos los individuos son heterocigotos (Aa) pero muestran solo el caracter dominante.
...
- [ ] D) Enlace covalente apolar <!-- feedback: Incorrect. El enlace es polar porque el oxigeno es mas electronegativo que el hidrogeno. -->

### Explicacion Pedagogica
El enlace covalente se clasifica en polar (cuando los atomos tienen diferente electronegatividad) y apolar (cuando tienen electronegatividad similar). En el agua, O (3.44) es mas electronegativo que H (2.20), creando polos.
...
- [ ] D) 25% rojas y 75% blancas <!-- feedback: Incorrect. Esto seria si el alelo rojo fuera recesivo. -->

### Explicacion Pedagogica
El cuadro de Punnett para Aa x Aa produce: AA (25%), Aa (50%), aa (25%). Como A es dominante, los genotipos AA y Aa producen flores rojas (75%), mientras que aa produce blancas (25%).
...
- [ ] D) La temperatura del agua aumenta porque recibe calor del termometro. <!-- feedback: Incorrect. Es al reves: el agua pierde calor y el termometro gana calor. -->

### Explicacion Pedagogica
El equilibrio termico es el estado en el que dos cuerpos en contacto alcanzan la misma temperatura. El calor fluye del cuerpo mas caliente al mas frio hasta que se igualan las temperaturas.
...
- [ ] D) Puente de hidrogeno <!-- feedback: Incorrect. Los puentes de hidrogeno son interacciones entre moleculas, no dentro del NaCl. -->

### Explicacion Pedagogica
El NaCl es un compuesto ionico. En estado solido, los iones Na+ y Cl- estan ordenados en una red cristalina. Al disolverse en agua, los iones se separan porque las moleculas de agua (polares) rodean y estabilizan los iones.
...
- [ ] D) Herencia ligada al sexo <!-- feedback: Incorrect. No hay informacion sobre cromosomas sexuales en este ejemplo. -->

### Explicacion Pedagogica
En la dominancia incompleta, ni el alelo dominante ni el recesivo se expresan completamente. El heterocigoto (Rr) muestra un fenotipo intermedio. El cruce Rr x Rr da 25% RR (rojo), 50% Rr (rosa), 25% rr (blanco).
...
- [ ] D) Covalente coordinado <!-- feedback: Incorrect. Este tipo de enlace es un tipo especial de covalente. -->

### Explicacion Pedagogica
El enlace metalico se forma entre atomos de metales, donde los electrones de valencia se deslocalizan formando una nube electronica. Esto explica la conductividad electrica, maleabilidad y brillo de los metales.
...
- [ ] D) 10C <!-- feedback: Incorrect. No hay una fuente de enfriamiento por debajo de la temperatura ambiente. -->

### Explicacion Pedagogica
La ley cero de la termodinamica establece que si dos sistemas estan en equilibrio termico con un tercero, estan en equilibrio termico entre si. El agua se enfriara hasta alcanzar la temperatura de la habitacion.
...
- [ ] D) 8 <!-- feedback: Incorrect. El numero de genotipos para n genes heterocigotos es 3^n. Para n=2, 3^2=9. -->

### Explicacion Pedagogica
Para un cruce dihibrido entre dos heterocigotos (AaBb), la proporcion fenotipica clasica es 9:3:3:1. Hay 9 genotipos diferentes y 4 fenotipos diferentes. Esto ilustra el principio de distribucion independiente de Mendel.
...
- [ ] D) Porque el vapor se condensa inmediatamente. <!-- feedback: Incorrect. La condensacion es un efecto, no la causa. -->

### Explicacion Pedagogica
El punto de ebullicion es la temperatura a la cual la presion de vapor del liquido iguala la presion atmosferica. Al aumentar la presion (olla a presion), se necesita mayor temperatura para que el agua hierva.
...
- [ ] D) El segundo, porque el hielo tiene menos masa que el agua. <!-- feedback: Incorrect. La masa es la misma; lo que cambia es la densidad. -->

### Explicacion Pedagogica
La ley de conservacion de la masa (Lavoisier) establece que la masa no se crea ni se destruye en reacciones quimicas o cambios fisicos. Al derretir hielo, la masa total del sistema permanece constante.
...
- [ ] D) 80C <!-- feedback: Incorrect. La temperatura debe estar mas cerca del punto medio. -->

### Explicacion Pedagogica
Cuando dos masas iguales del mismo liquido se mezclan, la temperatura de equilibrio es el promedio de las temperaturas iniciales. Esto se deduce de la ecuacion Qganado = -Qperdido, es decir, m*c*(Teq-T1) = -m*c*(Teq-T2).
...
- [ ] D) q = 0.8 <!-- feedback: Incorrect. Si q=0.8, q2=0.64, que es demasiado alto para recesivos. -->
