...
tema: "ondas-sonido, genetica-avanzada, nomenclatura-quimica"
periodo: 2
...
- [ ] B) Frecuencia <!-- feedback: Incorrecto. Es una característica fundamental de las ondas. -->
- [ ] C) Amplitud <!-- feedback: Incorrecto. Es una característica fundamental de las ondas. -->
- [x] D) Masa <!-- feedback: Correcto. Las ondas transportan energía sin transporte neto de materia, no tienen masa. -->
...
- [ ] B) Una proteína producida por un gen. <!-- feedback: Incorrecto. Los alelos son variantes de genes, no proteínas. -->
- [x] C) Una variante específica de un gen. <!-- feedback: Correcto. Los alelos son diferentes versiones del mismo gen que ocupan el mismo locus en cromosomas homólogos. -->
- [ ] D) Una célula haploide. <!-- feedback: Incorrecto. Una célula haploide tiene un solo juego de cromosomas. -->
...
- [ ] B) 152,240 m <!-- feedback: Incorrecto. v·f = 346·440 = 152,240, pero la fórmula es v/f. -->
- [ ] C) 440 m <!-- feedback: Incorrecto. 440 es la frecuencia en Hz, no la longitud de onda. -->
- [ ] D) 1.27 m <!-- feedback: Incorrecto. Posible inversión: 440/346 = 1.27. -->
...
- [ ] B) Óxido férrico <!-- feedback: Correcto. Fe tiene valencia 2 (ferroso) y 3 (férrico). Fe₂O₃ tiene Fe³⁺, por tanto óxido férrico. -->
- [x] C) Óxido ferroso <!-- feedback: Incorrecto. FeO es óxido ferroso (Fe²⁺). Fe₂O₃ tiene Fe³⁺, es férrico. -->
- [ ] D) Trióxido de dihierro <!-- feedback: Correcto en nomenclatura sistemática, pero la pregunta dice nomenclatura tradicional. -->
...
- [ ] B) 100% <!-- feedback: Incorrecto. No todos los descendientes serán rugosos. -->
- [x] C) 25% <!-- feedback: Correcto. Cuadro de Punnett: LL(25%), Ll(50%), ll(25%). Semilla rugosa (ll) = 25%. -->
- [ ] D) 50% <!-- feedback: Incorrecto. 50% sería si uno fuera heterocigoto y el otro homocigoto recesivo (Ll × ll). -->
...
- [x] B) 1500 m <!-- feedback: Correcto. d = v·t/2 = 1500·2/2 = 1500 m. -->
- [ ] C) 750 m <!-- feedback: Incorrecto. Dividiste entre 4 en lugar de 2. -->
- [ ] D) 300 m <!-- feedback: Incorrecto. Error en unidades o en la fórmula. -->
...
- [ ] B) Sulfato de hidrógeno <!-- feedback: Incorrecto. El nombre del oxoácido no es con la nomenclatura de sales. -->
- [x] C) Ácido sulfúrico <!-- feedback: Correcto. S con valencia 6 (máxima) da el sufijo -ico. -->
- [ ] D) Ácido hiposulfuroso <!-- feedback: Incorrecto. Este nombre correspondería a H₂SO₂. -->
...
- [ ] B) Menor a 800 Hz <!-- feedback: Incorrecto. La frecuencia es menor cuando la fuente se aleja. -->
- [ ] C) Igual a 800 Hz <!-- feedback: Incorrecto. El efecto Doppler altera la frecuencia percibida si hay movimiento relativo. -->
- [ ] D) 0 Hz <!-- feedback: Incorrecto. El sonido se sigue escuchando. -->
...
- [x] B) 50% <!-- feedback: Correcto. Cruce Mm×mm: 50% Mm (marrones), 50% mm (azules). -->
- [ ] C) 25% <!-- feedback: Incorrecto. 25% sería para cruce de dos heterocigotos (Mm×Mm). -->
- [ ] D) 75% <!-- feedback: Incorrecto. 75% sería la probabilidad de ojos marrones en cruce Mm×Mm. -->
...
- [x] B) Refracción <!-- feedback: Correcto. La onda cambia de medio (aire a agua) y su velocidad y dirección cambian, es refracción. -->
- [ ] C) Difracción <!-- feedback: Incorrecto. La difracción es el rodeo de obstáculos. -->
- [ ] D) Interferencia <!-- feedback: Incorrecto. La interferencia es la superposición de ondas. -->
...
- [ ] B) Óxido de magnesio(II) y cloruro de magnesio(II). <!-- feedback: Incorrecto. ¿Por qué? -->
- [ ] C) Óxido de magnesio(II) y cloruro de magnesio(I). <!-- feedback: Incorrecto. El Mg tiene número de oxidación 2+ en ambos compuestos. -->
- [x] D) Óxido de magnesio y cloruro de magnesio. En notación Stock sería innecesario porque Mg solo tiene una valencia (2+). <!-- feedback: Correcto. Cuando el elemento tiene una sola valencia, se omite el número romano. -->
...
- [ ] B) 0.09 <!-- feedback: Incorrecto. q² = 0.09 corresponde a aa homocigoto recesivo. -->
- [x] C) 0.42 <!-- feedback: Correcto. 2pq = 2(0.7)(0.3) = 0.42. -->
- [ ] D) 0.21 <!-- feedback: Incorrecto. pq = 0.21, pero los heterocigotos son 2pq = 0.42. -->
...
- [ ] B) 60 dB <!-- feedback: Incorrecto. 10⁻⁴/10⁻¹²=10⁸, log=8, 10·8=80 dB. -->
- [x] C) 80 dB <!-- feedback: Correcto. β = 10 log(10⁻⁴/10⁻¹²) = 10 log(10⁸) = 10·8 = 80 dB. -->
- [ ] D) 100 dB <!-- feedback: Incorrecto. Posible error en exponentes. -->
...
Estudiante C: Fe₂Cl₃
Estudiante D: FeCl
**Enunciado:** ¿Quién tiene la fórmula correcta?
**Options:**
- [ ] A) FeCl₂ <!-- feedback: Incorrecto. FeCl₂ es cloruro de hierro(II), tiene Fe²⁺. -->
- [x] B) FeCl₃ <!-- feedback: Correcto. Fe³⁺ necesita 3 Cl⁻ (cada Cl⁻ tiene -1) para neutralizar la carga. -->
- [ ] C) Fe₂Cl₃ <!-- feedback: Incorrecto. 2Fe³⁺=+6, 3Cl⁻=-3, no se neutraliza. -->
- [ ] D) FeCl <!-- feedback: Incorrecto. FeCl no balancea: +3-1=+2. -->
...
- [ ] B) 70% <!-- feedback: Incorrecto. Este sería el porcentaje de G+C. -->
- [x] C) 20% <!-- feedback: Correcto. A=30% → T=30% (regla de Chargaff A=T). Queda 40% para G+C (G=C). Entonces G=20% y C=20%. -->
- [ ] D) No se puede determinar sin más datos. <!-- feedback: Incorrecto. Por las reglas de Chargaff A=T y G=C, sí se puede determinar con el dato de A. -->
...
- [x] B) Se acerca, porque n₂ > n₁. <!-- feedback: Correcto. Al pasar a un medio más denso (mayor n), la velocidad disminuye y el rayo se acerca a la normal. -->
- [ ] C) No cambia de dirección. <!-- feedback: Incorrecto. Sí cambia al cambiar de medio. -->
- [ ] D) Se acerca solo si el ángulo es mayor al crítico. <!-- feedback: Incorrecto. El ángulo crítico aplica para reflexión total interna cuando va de medio denso a menos denso. -->
...
- [ ] B) CaCl₂ se llama dicloruro de calcio en nomenclatura sistemática. <!-- feedback: Correcto, pero no es la única afirmación correcta. -->
- [ ] C) AlCl₃ se llama cloruro de aluminio(III) en nomenclatura Stock. <!-- feedback: Correcto, pero la nomenclatura Stock permitiría también solo "cloruro de aluminio" porque el aluminio tiene una sola valencia. -->
- [x] D) Los tres se pueden nombrar correctamente como: cloruro de sodio, cloruro de calcio y cloruro de aluminio en nomenclatura Stock sin número romano. <!-- feedback: Correcto. Según la IUPAC, cuando un elemento tiene una sola valencia común, se omite el número de oxidación en la nomenclatura Stock. Na(1+), Ca(2+), Al(3+) tienen una sola valencia. -->
...
- [ ] B) Porque las moléculas en el agua están más juntas y transmiten la vibración más rápido. <!-- feedback: Incorrecto. Aunque están más juntas, el factor clave es el módulo de elasticidad. -->
- [x] C) Porque el módulo de compresibilidad del agua es mucho mayor que el del aire, superando el efecto de la mayor densidad. <!-- feedback: Correcto. v = √(B/ρ). El módulo B del agua es ~10⁴ veces mayor que el del aire, mientras que ρ es solo ~800 veces mayor. -->
- [ ] D) Porque el sonido no necesita medio para propagarse en el agua. <!-- feedback: Incorrecto. El sonido siempre necesita un medio material. -->
...
- [ ] B) Golpear un diapasón dentro de una caja sellada. <!-- feedback: Incorrecto. El aire dentro de la caja permite la propagación del sonido. -->
- [ ] C) Medir la velocidad del sonido en diferentes gases. <!-- feedback: Incorrecto. Esto compara medios gaseosos, no demuestra el vacío. -->
- [ ] D) Hacer sonar un silbato bajo el agua. <!-- feedback: Incorrecto. El agua es un medio material que sí transmite sonido. -->
