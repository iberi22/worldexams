...
tema: "fisica-movimiento, quimica-enlaces, biologia-genetica, bioquimica-acidos-bases, ondas-calor-termodinamica"
periodo: "P1-P4"
...
Bundle integral de grado 10 que cubre los cuatro periodos académicos: Física (movimiento rectilíneo, circular, leyes de Newton) (P1), Química (enlaces, ácidos y bases) (P2), Biología (genética mendeliana y molecular) (P3), y Ondas, calor y termodinámica (P4). Alineado con DBA MEN y preparación Pre-Saber 11.
...
- [ ] D) La distancia recorrida <!-- feedback: Incorrecto. La distancia recorrida aumenta con el tiempo. -->

### Explicación Pedagógica
El MRU se caracteriza por velocidad constante (v = constante), lo que implica aceleración cero. La posición varía linealmente con el tiempo: x = x₀ + vt.
...
- [ ] D) Enlace de hidrógeno <!-- feedback: Incorrecto. El enlace de hidrógeno es una interacción intermolecular, no un enlace químico primario. -->

### Explicación Pedagógica
Los enlaces iónicos se forman por transferencia de electrones del metal al no metal, creando iones con cargas opuestas que se atraen electrostáticamente. Ejemplo: Na⁺Cl⁻.
...
- [ ] D) 60 km <!-- feedback: Incorrecto. Esta sería la distancia en 1 hora, no en 15 minutos. -->

### Explicación Pedagógica
En MRU, d = v × t. Es importante que las unidades sean consistentes: si la velocidad está en km/h, el tiempo debe estar en horas. 15 minutos = 15/60 = 0.25 horas.
...
- [ ] D) Enlace covalente apolar <!-- feedback: Incorrecto. El agua tiene polaridad porque el oxígeno es más electronegativo que el hidrógeno. -->

### Explicación Pedagógica
El agua presenta enlaces covalentes polares: el oxígeno (electronegatividad 3.44) atrae más los electrones compartidos que el hidrógeno (2.20), generando una carga parcial negativa en el oxígeno y positiva en los hidrógenos.
...
- [ ] D) 45 m/s <!-- feedback: Incorrecto. 45 m/s es la velocidad promedio o la distancia calculada incorrectamente. -->

### Explicación Pedagógica
En caída libre (MRUV), la velocidad varía linealmente: v = v₀ + gt. Con v₀ = 0: v = 10 × 3 = 30 m/s. La aceleración de la gravedad es constante (g ≈ 9.8 m/s²).
...
- [ ] D) 75% <!-- feedback: Incorrecto. 75% sería la proporción en F2 (Aa × Aa), no en F1. -->

### Explicación Pedagógica
Primera ley de Mendel (ley de la uniformidad): al cruzar dos líneas puras (homocigotas) que difieren en un carácter, toda la descendencia F1 es heterocigota y expresa el fenotipo dominante.
...
- [ ] D) 10.2 m/s <!-- feedback: Incorrecto. Sumaste en lugar de multiplicar. v = λ·f, no λ + f. -->

### Explicación Pedagógica
La velocidad de una onda se calcula como v = λ·f, donde λ es la longitud de onda (m) y f es la frecuencia (Hz). La velocidad depende del medio de propagación.
...
- [ ] D) 1 enlace triple y 1 simple <!-- feedback: Incorrecto. Esta estructura no es estable para el CO₂. -->

### Explicación Pedagógica
El CO₂ tiene estructura lineal O=C=O con dos enlaces dobles. Cada oxígeno comparte 2 electrones con el carbono, que a su vez comparte 4 (2 por cada O), completando el octeto de todos los átomos.
...
- [ ] D) 180 Hz <!-- feedback: Incorrecto. Dividiste entre 30 en lugar de 60. -->

### Explicación Pedagógica
La frecuencia en Hz se obtiene dividiendo las RPM entre 60: f = RPM/60. La velocidad angular es ω = 2πf = 2π·RPM/60.
...
- [ ] D) Se repite una secuencia de bases varias veces. <!-- feedback: Incorrecto. La repetición es un tipo diferente de mutación, no una sustitución. -->

### Explicación Pedagógica
Las mutaciones puntuales incluyen sustituciones (cambio de una base por otra), deleciones (pérdida de una base) e inserciones (adición de una base). Las sustituciones pueden ser silenciosas, de sentido erróneo o sin sentido.
...
- [ ] D) 1,400 J <!-- feedback: Incorrecto. Multiplicaste 70×20 en lugar de 70×10×200. -->

### Explicación Pedagógica
El trabajo contra la gravedad depende solo del peso (mg) y la altura (h), no del tiempo empleado: W = mgh. La potencia sí depende del tiempo: P = W/t.
...
- [ ] D) Son alcalinas porque el agua de lluvia siempre es alcalina. <!-- feedback: Incorrecto. El agua de lluvia limpia tiene pH ~5.6 (ligeramente ácido por CO₂), no es alcalina. -->

### Explicación Pedagógica
La lluvia normal tiene pH ≈ 5.6 por el CO₂ disuelto (H₂CO₃). La lluvia ácida tiene pH < 5.6 debido a óxidos de azufre y nitrógeno (SOx, NOx) de la contaminación.
...
- [ ] D) 200 m/s² <!-- feedback: Incorrecto. Multiplicaste v²·r: 100×20 = 2000. -->

### Explicación Pedagógica
La aceleración centrípeta en el movimiento circular uniforme es ac = v²/r, dirigida hacia el centro de la trayectoria. Depende del cuadrado de la velocidad lineal y del radio.
...
- [ ] D) 10,450 J <!-- feedback: Incorrecto. Posible error: 200×4.18×12.5 = 10,450. Usaste ΔT = 50/4 = 12.5. -->

### Explicación Pedagógica
La energía térmica necesaria para calentar una sustancia es Q = m·c·ΔT, donde m es la masa (g), c es el calor específico (J/g°C) y ΔT es el cambio de temperatura. ΔT = 75°C - 25°C = 50°C.
...
- [ ] D) 75% <!-- feedback: Incorrecto. 75% es la probabilidad de obtener fenotipo dominante (AA + Aa). -->

### Explicación Pedagógica
Segunda ley de Mendel: al cruzar dos heterocigotos, la descendencia tiene proporción genotípica 1:2:1 (AA:Aa:aa) y fenotípica 3:1 (dominante:recesivo). La probabilidad del fenotipo recesivo es 1/4 = 25%.
...
- [ ] D) 850 m <!-- feedback: Incorrecto. Dividiste 340/0.4 = 850, confundiendo la relación tiempo-distancia. -->

### Explicación Pedagógica
El eco requiere que el sonido viaje hasta el obstáculo y regrese. Por tanto, la distancia al obstáculo es la mitad de la distancia total recorrida: d = v·t/2.
...
Estudiante C: "Solo hay energía cinética."
Estudiante D: "La energía térmica no tiene relación con el péndulo."
...
- [ ] D) Estudiante D <!-- feedback: Incorrecto. En un péndulo real, la fricción convierte energía mecánica en térmica, aunque el estudiante B describe el caso ideal. -->

### Explicación Pedagógica
En un péndulo ideal (sin fricción), la energía mecánica total (E = Ec + Ep) se conserva, transformándose alternativamente entre cinética y potencial gravitatoria durante la oscilación.
...
- [ ] D) No hay problemas porque todos los valores están en rango normal. <!-- feedback: Incorrecto. El pH 4.2 está muy por fuera del rango normal para agua dulce. -->

### Explicación Pedagógica
El agua dulce natural debe tener pH entre 6.5 y 8.5. Un pH de 4.2 indica contaminación ácida severa, posiblemente por vertimientos industriales o minería. El oxígeno disuelto bajo (< 5 mg/L) también es preocupante.
...
- [ ] D) Agregar fenolftaleína y agitar. <!-- feedback: Incorrecto. La fenolftaleína es incolora en medio ácido y rosa en básico, por lo que si es ácida, no se detectaría cambio visible. -->

### Explicación Pedagógica
El método más confiable para determinar pH es la medición potenciométrica con pH-metro calibrado. Los indicadores como fenolftaleína o tornasol son cualitativos y tienen limitaciones de rango.
...
Estudiante 3: "La ley de inercia solo aplica si no hay fuerzas externas."
Estudiante 4: "Los pasajeros salen hacia atrás."
...
- [ ] D) Estudiante 4: los pasajeros salen hacia atrás. <!-- feedback: Incorrecto. Al frenar, los pasajeros se van hacia adelante (continúan el movimiento), no hacia atrás. -->
