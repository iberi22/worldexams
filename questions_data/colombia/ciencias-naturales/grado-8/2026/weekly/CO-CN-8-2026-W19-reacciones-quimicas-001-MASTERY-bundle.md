---
id: "CO-CN-8-2026-W19-reacciones-quimicas-001-MASTERY-bundle"
country: "colombia"
grado: 8
...
# Bundle MASTERY: Reacciones químicas: evidencias, tipos y balanceo - Grado 8

Esta semana identificamos cuándo ocurre un cambio químico, diferenciamos los tipos básicos de reacciones (síntesis, descomposición y sustitución) y aplicamos la Ley de Conservación de la Masa para balancear ecuaciones en contextos cotidianos del trapiche panelero santandereano, la cocina caleña y el laboratorio escolar pereirano.

## Question 1 [D3-D4]
**ID:** CO-CN-8-2026-W19-reacciones-quimicas-001-MASTERY-bundle-v1
**Bloom:** Remember
**ICFES:** Uso comprensivo del conocimiento científico
**Expected_Success:** 0.85
**Contexto:** En un trapiche panelero de Santander, los trabajadores observan que al hervir el guarapo en la paila, este cambia de color verde claro a un tono oscuro caramelo y libera un aroma intenso a panela.
...
Las reacciones químicas se caracterizan por la formación de sustancias nuevas con propiedades diferentes a las originales. En la elaboración de panela, las evidencias de cambio químico incluyen el cambio de color (de verde claro a caramelo oscuro), la liberación de un aroma intenso, la formación persistente de espuma y el aumento de calor. Estas observaciones indican que las moléculas de sacarosa del jugo de caña se transforman en compuestos nuevos como la caramelina, responsables del color y aroma característicos de la panela.

## Question 2 [D3-D4]
**ID:** CO-CN-8-2026-W19-reacciones-quimicas-001-MASTERY-bundle-v2
**Bloom:** Understand
**ICFES:** Explicación de fenómenos
**Expected_Success:** 0.85
**Contexto:** En una cocina tradicional de Cali, una cocinera mezcla bicarbonato de sodio con vinagre para limpiar una superficie grasosa. La mezcla burbujea vigorosamente y observa que la masa total antes y después de la reacción, medida con una balanza, es exactamente la misma.
...
### Explicacion Pedagogica
La Ley de Conservación de la Masa, formulada por Antoine Lavoisier en 1789, establece que en toda reacción química la masa total de los reactantes es igual a la masa total de los productos. Esto se debe a que los átomos no se crean ni se destruyen durante la reacción, sino que se reorganizan formando nuevas sustancias. En un sistema cerrado, aunque se libere dióxido de carbono (gas), la masa total se conserva exactamente.

## Question 3 [D3-D4]
**ID:** CO-CN-8-2026-W19-reacciones-quimicas-001-MASTERY-bundle-v3
**Bloom:** Remember
**ICFES:** Uso comprensivo del conocimiento científico
**Expected_Success:** 0.85
**Contexto:** En el laboratorio del colegio La Julia en Pereira, los docentes explican a los estudiantes los tres tipos básicos de reacciones químicas que deben reconocer durante este periodo académico.
...
### Explicacion Pedagogica
Las reacciones químicas se clasifican según cómo se transforman las sustancias. En la reacción de descomposición (A), un solo reactante se descompone en dos o más productos, generalmente por acción de calor o electricidad. En la síntesis (B), dos o más reactantes se combinan para formar un único producto. En la sustitución simple (C), un elemento libre reemplaza a otro dentro de un compuesto. En la doble sustitución (D), ocurre un intercambio de iones entre dos compuestos iónicos.

## Question 4 [D5-D6]
**ID:** CO-CN-8-2026-W19-reacciones-quimicas-001-MASTERY-bundle-v4
**Bloom:** Apply
**ICFES:** Indagación
**Expected_Success:** 0.75
**Contexto:** En el laboratorio escolar de Pereira, una estudiante combina doce gramos de carbono con treinta y dos gramos de oxígeno y los hace reaccionar completamente para formar dióxido de carbono.
...
### Explicacion Pedagogica
Según la Ley de Conservación de la Masa (Lavoisier), en cualquier reacción química la masa total de los reactantes es igual a la masa total de los productos. Por lo tanto, masa de CO₂ = masa de C + masa de O₂ = 12 g + 32 g = 44 g. Esta ley es fundamental para el balanceo de ecuaciones químicas y se cumple tanto en reacciones exotérmicas como endotérmicas en sistemas cerrados.

## Question 5 [D5-D6]
**ID:** CO-CN-8-2026-W19-reacciones-quimicas-001-MASTERY-bundle-v5
**Bloom:** Apply
**ICFES:** Uso comprensivo del conocimiento científico
**Expected_Success:** 0.75
**Contexto:** En un trapiche panelero de Santander, el proceso de clarificación del guarapo consiste en adicionar cal (óxido de calcio, CaO) al jugo de caña para eliminar impurezas. Durante el proceso, el CaO reacciona con el agua formando Ca(OH)₂.
...
- [ ] D) Una reacción de neutralización, porque el CaO neutraliza las impurezas ácidas del guarapo.
  <!-- feedback: Incorrecto. Aunque en la práctica la cal tiene un efecto sobre las impurezas, la neutralización ocurre entre un ácido y una base produciendo sal y agua. -->

### Explicacion Pedagogica
En el proceso CaO + H₂O → Ca(OH)₂, dos reactantes (CaO y H₂O) se combinan para formar un único producto (Ca(OH)₂). Esto es característico de una reacción de síntesis o combinación. En el trapiche panelero, esta reacción es esencial para la clarificación, porque el hidróxido de calcio formado ayuda a precipitar las impurezas del guarapo y a regular el pH durante la cocción.

## Question 6 [D5-D6]
**ID:** CO-CN-8-2026-W19-reacciones-quimicas-001-MASTERY-bundle-v6
**Bloom:** Apply
**ICFES:** Indagación
**Expected_Success:** 0.75
**Contexto:** En una cocina de Cali, una cocinera observa que el aceite vegetal reacciona con el oxígeno del aire al calentarse y forma nuevos compuestos que generan el olor característico de la fritura.
...
### Explicacion Pedagogica
Para balancear una ecuación química se ajustan los coeficientes estequiométricos (números delante de las fórmulas) hasta que el número de átomos de cada elemento sea igual en ambos lados. Para CH₄ + O₂ → CO₂ + H₂O: el carbono ya está balanceado; para ajustar el hidrógeno (cuatro a la izquierda, dos a la derecha) se multiplica el H₂O por dos; finalmente se ajustan los oxígenos (cuatro a la derecha) y se multiplica el O₂ por dos. La ecuación balanceada es CH₄ + 2O₂ → CO₂ + 2H₂O.

## Question 7 [D5-D6]
**ID:** CO-CN-8-2026-W19-reacciones-quimicas-001-MASTERY-bundle-v7
**Bloom:** Apply
**ICFES:** Explicación de fenómenos
**Expected_Success:** 0.75
**Contexto:** En el laboratorio del colegio en Pereira, un estudiante añade una pastilla efervescente (que contiene bicarbonato de sodio, NaHCO₃) a un vaso con vinagre (ácido acético, CH₃COOH). Observa efervescencia vigorosa y formación de burbujas que suben a la superficie.
...
- [ ] D) Vapor de agua (H₂O en estado gaseoso), que se escapa del vaso por el calor generado.
  <!-- feedback: Incorrecto. El agua es un producto líquido a temperatura ambiente; las burbujas visibles son CO₂, no vapor de agua. -->

### Explicacion Pedagogica
En la reacción entre el bicarbonato de sodio (NaHCO₃) y el ácido acético del vinagre (CH₃COOH) se producen acetato de sodio (CH₃COONa), agua (H₂O) y dióxido de carbono (CO₂). Las burbujas características de las pastillas efervescentes son burbujas de CO₂ que ascienden a través del líquido. Esta es una reacción ácido-base que produce una sal, agua y un gas, y es la base química del funcionamiento de muchos antiácidos comerciales.

## Question 8 [D7-D8]
**ID:** CO-CN-8-2026-W19-reacciones-quimicas-001-MASTERY-bundle-v8
**Bloom:** Analyze
**ICFES:** Indagación
**Expected_Success:** 0.65
**Contexto:** En el laboratorio escolar de Pereira, el profesor presenta cuatro ecuaciones químicas a sus estudiantes y les pide identificar cuál cumple correctamente con la Ley de Conservación de la Masa.
...
- [ ] D) Fe + O₂ → Fe₂O₃
  <!-- feedback: Incorrecto. Hay un hierro en reactantes contra dos hierros en productos, y dos oxígenos en reactantes contra tres oxígenos en productos, por lo tanto no está balanceada. -->

### Explicacion Pedagogica
Una ecuación química balanceada debe tener el mismo número de átomos de cada elemento en ambos lados. Para 2Mg + O₂ → 2MgO hay dos átomos de Mg y dos de O a cada lado. Las otras opciones presentan desequilibrios atómicos que violan la Ley de Conservación de la Masa, lo que indica que los coeficientes estequiométricos deben ajustarse hasta igualar el número de átomos de cada elemento en reactantes y productos.

## Question 9 [D7-D8]
**ID:** CO-CN-8-2026-W19-reacciones-quimicas-001-MASTERY-bundle-v9
**Bloom:** Analyze
**ICFES:** Explicación de fenómenos
**Expected_Success:** 0.65
**Contexto:** En un trapiche panelero de Santander, los trabajadores observan tres procesos durante la molienda y cocción de la caña: (1) la caña se tritura y se extrae el guarapo, (2) el guarapo hierve y forma espuma que se retira con el remo, (3) el bagazo sobrante se apila y se deja secar al sol.
...
### Explicacion Pedagogica
Para distinguir entre un cambio físico y un cambio químico se debe observar si hay formación de sustancias nuevas con propiedades diferentes. Proceso 1 (trituración): cambio físico, solo se separa el jugo del bagazo. Proceso 2 (cocción): cambio químico, se producen reacciones de caramelización y de pardeamiento no enzimático que generan compuestos nuevos responsables del color y aroma de la panela. Proceso 3 (secado): cambio físico por evaporación del agua sin alteración química.

## Question 10 [D7-D8]
**ID:** CO-CN-8-2026-W19-reacciones-quimicas-001-MASTERY-bundle-v10
**Bloom:** Analyze
**ICFES:** Uso comprensivo del conocimiento científico
**Expected_Success:** 0.65
**Contexto:** En una cocina tradicional de Cali, una cocinera observa que el hierro de una sartén vieja se ha oxidado y formado una capa rojiza. Sabe que el hierro metálico (Fe) reacciona con el oxígeno del aire (O₂) en presencia de humedad.
...
- [ ] D) Es una reacción de doble sustitución entre el hierro y el agua presente en el ambiente.
  <!-- feedback: Incorrecto. La doble sustitución implica intercambio de iones entre dos compuestos; aquí hay reacción con un elemento metálico libre. -->

### Explicacion Pedagogica
La oxidación del hierro en presencia de agua y oxígeno es una reacción de síntesis porque varios reactantes (Fe, O₂ y H₂O) se combinan para formar un único producto, el hidróxido de hierro (Fe(OH)₃). Las evidencias químicas son: cambio de color (de gris metálico a rojizo), formación de una sustancia nueva (el óxido), aumento de volumen (la capa de óxido ocupa más espacio que el hierro original) y pérdida de las propiedades metálicas como la resistencia mecánica y la conductividad.

## Question 11 [D9-D10]
**ID:** CO-CN-8-2026-W19-reacciones-quimicas-001-MASTERY-bundle-v11
**Bloom:** Evaluate
**ICFES:** Indagación
**Expected_Success:** 0.55
**Contexto:** En el laboratorio del colegio en Pereira, dos grupos de estudiantes realizan el siguiente experimento: cada grupo quema completamente cinco gramos de magnesio (Mg) en presencia de oxígeno y mide la masa final del producto (MgO) formado.
...
### Explicacion Pedagogica
En este experimento el sistema está abierto, por lo que el oxígeno del aire se incorpora al producto. La masa de MgO (8,33 g) es mayor que la masa de Mg (5 g) porque se agregó la masa del oxígeno que reaccionó (3,33 g). Si el sistema estuviera cerrado, la masa total antes y después sería exactamente la misma. La Ley de Conservación de la Masa se cumple siempre; lo que varía es la composición del sistema abierto. La concordancia entre los dos grupos valida la precisión del experimento.

## Question 12 [D9-D10]
**ID:** CO-CN-8-2026-W19-reacciones-quimicas-001-MASTERY-bundle-v12
**Bloom:** Evaluate
**ICFES:** Explicación de fenómenos
**Expected_Success:** 0.55
**Contexto:** El director de un trapiche panelero en Santander quiere optimizar el proceso de producción y le pide a su asesor científico que le explique por qué el rendimiento de la producción de panela a partir del guarapo no es del cien por ciento, a pesar de aplicar las reacciones químicas correctas.
...
- [ ] D) El rendimiento no se puede analizar con la Ley de Conservación porque la panela no es un compuesto químico puro.
  <!-- feedback: Incorrecto. La Ley de Conservación aplica a cualquier reacción química, sea el producto puro o una mezcla; lo que cambia es el rendimiento industrial, no la conservación. -->

### Explicacion Pedagogica
El rendimiento industrial de un proceso químico nunca es del cien por ciento en la práctica, aunque las ecuaciones químicas sí lo sean en teoría para el reactante que se transforma. En el trapiche panelero, las pérdidas se deben a extracción incompleta del guarapo del bagazo, evaporación durante la cocción, formación de subproductos no deseados y reacciones incompletas. La Ley de Conservación de la Masa se aplica a la química del proceso, pero la eficiencia industrial depende además de variables físicas, económicas y tecnológicas.