...
Este bundle evalúa el concepto de materia, la distinción entre propiedades generales y específicas, y los cambios de estado de agregación por efecto de la temperatura.

---

## Question 1 (Difficulty D1)

**ID:** `CO-CNA-6-P3-materia-001-MASTERY-v1`
**Bloom:** Remember
...
- [ ] D) La energía que sale del sol. <!-- feedback: Incorrecto. La luz es energía, pero no tiene masa como la materia. -->

### Explicación Pedagógica
La materia constituye todo el universo físico y se caracteriza por tener inercia (masa) y extensión (volumen).

---

## Question 2 (Difficulty D1)

**ID:** `CO-CNA-6-P3-materia-001-MASTERY-v2`
**Bloom:** Remember
**ICFES:** Uso comprensivo del conocimiento científico
...
- [ ] D) Beberse el agua. <!-- feedback: Incorrecto. Esto es un proceso biológico. -->

### Explicación Pedagógica
Los cambios de estado ocurren cuando la materia gana o pierde energía térmica, alterando la cercanía entre sus moléculas.

---

## Question 3 (Difficulty D2)

**ID:** `CO-CNA-6-P3-materia-001-MASTERY-v3`
**Bloom:** Understand
**ICFES:** Uso comprensivo del conocimiento científico
...
- [ ] D) Peso. <!-- feedback: Incorrecto. El peso es la fuerza de atracción de la gravedad sobre la masa. -->

### Explicación Pedagógica
Es importante no confundir masa (cantidad de materia) con peso (fuerza de gravedad), aunque en la vida diaria se usen como sinónimos.

---

## Question 4 (Difficulty D2)

**ID:** `CO-CNA-6-P3-materia-001-MASTERY-v4`
**Bloom:** Understand
...
- [ ] D) Plasma. <!-- feedback: Incorrecto. Aunque similar al gas, el plasma tiene partículas cargadas eléctricamente. -->

### Explicación Pedagógica
La teoría cinético-molecular explica el comportamiento de los estados de la materia según el movimiento y atracción de sus partículas.

---

## Question 5 (Difficulty D3)

**ID:** `CO-CNA-6-P3-materia-001-MASTERY-v5`
**Bloom:** Apply
**ICFES:** Uso comprensivo del conocimiento científico

### Contexto
Un objeto tiene una masa de 200 gramos y un volumen de 100 centímetros cúbicos ($cm^3$).
...
- [ ] D) $20,000 g/cm^3$ <!-- feedback: Incorrecto. Multiplicaste la masa por el volumen. -->

### Explicación Pedagógica
La densidad es una propiedad específica que nos permite identificar sustancias, ya que indica cuánta masa hay en un volumen determinado.

---

## Question 6 (Difficulty D3)

**ID:** `CO-CNA-6-P3-materia-001-MASTERY-v6`
**Bloom:** Understand
**ICFES:** Explicación de fenómenos

### Contexto
Pones a calentar agua en una olla y, después de un tiempo, ves que sale vapor.
...
- [ ] D) Solidificación. <!-- feedback: Incorrecto. Esto es de líquido a sólido. -->

### Explicación Pedagógica
El aumento de temperatura incrementa la energía cinética de las moléculas hasta que vencen sus fuerzas de atracción.

---

## Question 7 (Difficulty D4)

**ID:** `CO-CNA-6-P3-materia-001-MASTERY-v7`
**Bloom:** Analyze
**ICFES:** Uso comprensivo del conocimiento científico
...
- [ ] D) La longitud. <!-- feedback: Incorrecto. Es una propiedad general de los cuerpos. -->

### Explicación Pedagógica
Las propiedades generales (masa, volumen, peso) no sirven para identificar la naturaleza de la materia, a diferencia de las específicas.

---

## Question 8 (Difficulty D4)

**ID:** `CO-CNA-6-P3-materia-001-MASTERY-v8`
**Bloom:** Analyze
**ICFES:** Explicación de fenómenos
...
- [ ] D) La masa aumenta. <!-- feedback: Incorrecto. La masa se conserva, solo cambia el espacio ocupado. -->

### Explicación Pedagógica
La dilatación térmica es el fenómeno por el cual los cuerpos aumentan su tamaño al absorber calor.

---

## Question 9 (Difficulty D5)

**ID:** `CO-CNA-6-P3-materia-001-MASTERY-v9`
**Bloom:** Evaluate
**ICFES:** Indagación

### Contexto
Tienes una mezcla de agua y arena fina en un vaso.
...
- [ ] D) Destilación. <!-- feedback: Incorrecto. Es un método muy complejo y costoso para algo que se resuelve con un filtro. -->

### Explicación Pedagógica
La elección del método de separación depende de las propiedades físicas de los componentes (tamaño de partícula en este caso).

---

## Question 10 (Difficulty D5)

**ID:** `CO-CNA-6-P3-materia-001-MASTERY-v10`
**Bloom:** Analyze
**ICFES:** Explicación de fenómenos
...
- [ ] D) Porque el agua empuja el hielo hacia arriba con sus manos. <!-- feedback: Incorrecto. Es una explicación no científica. -->

### Explicación Pedagógica
La densidad es lo que determina si un objeto flota o se hunde en un fluido. El agua es una de las pocas sustancias que es menos densa en estado sólido.
