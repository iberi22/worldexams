...
Este bundle evalúa el concepto de energía, las diferentes formas en que se manifiesta (cinética, potencial, térmica, etc.) y la ley de conservación de la energía.

---

## Question 1 (Difficulty D1)

**ID:** `CO-CNA-6-P4-energia-001-MASTERY-v1`
**Bloom:** Remember
...
- [ ] D) La velocidad a la que corre un atleta. <!-- feedback: Incorrecto. La velocidad es parte de la energía cinética, pero no es la definición completa. -->

### Explicación Pedagógica
La energía no se puede ver directamente, solo se perciben sus efectos cuando se transforma o se transfiere de un cuerpo a otro.

---

## Question 2 (Difficulty D1)

**ID:** `CO-CNA-6-P4-energia-001-MASTERY-v2`
**Bloom:** Remember
**ICFES:** Uso comprensivo del conocimiento científico
...
- [ ] D) La electricidad. <!-- feedback: Incorrecto. La electricidad es una forma de energía que debemos producir. -->

### Explicación Pedagógica
Casi todas las formas de energía que conocemos provienen directa o indirectamente de la radiación solar.

---

## Question 3 (Difficulty D2)

**ID:** `CO-CNA-6-P4-energia-001-MASTERY-v3`
**Bloom:** Understand
**ICFES:** Uso comprensivo del conocimiento científico
...
- [ ] D) Energía sonora. <!-- feedback: Incorrecto. Es la que transportan las ondas del sonido. -->

### Explicación Pedagógica
Cualquier objeto que se esté desplazando (un carro, una pelota, el viento) posee energía cinética.

---

## Question 4 (Difficulty D2)

**ID:** `CO-CNA-6-P4-energia-001-MASTERY-v4`
**Bloom:** Understand
...
- [ ] D) No tiene energía. <!-- feedback: Incorrecto. La posición elevada le otorga capacidad de realizar trabajo si cayera. -->

### Explicación Pedagógica
La energía potencial se llama así porque tiene el "potencial" de convertirse en movimiento (cinética) si el objeto cae.

---

## Question 5 (Difficulty D3)

**ID:** `CO-CNA-6-P4-energia-001-MASTERY-v5`
**Bloom:** Apply
**ICFES:** Uso comprensivo del conocimiento científico

### Contexto
Enchufas una bombilla y esta se enciende, dando luz y calentándose un poco.
...
- [ ] D) De energía química a sonora. <!-- feedback: Incorrecto. La bombilla no funciona por reacciones químicas ni su fin es sonar. -->

### Explicación Pedagógica
Los artefactos humanos son máquinas diseñadas para transformar una forma de energía en otra más útil para nosotros.

---

## Question 6 (Difficulty D3)

**ID:** `CO-CNA-6-P4-energia-001-MASTERY-v6`
**Bloom:** Understand
**ICFES:** Explicación de fenómenos
...
- [ ] D) Que la energía solo viene del sol y termina en la tierra. <!-- feedback: Incorrecto. La energía fluye y cambia constantemente. -->

### Explicación Pedagógica
Esta ley fundamental de la física implica que el "gasto" de energía es en realidad una conversión a formas menos útiles (como calor disperso).

---

## Question 7 (Difficulty D4)

**ID:** `CO-CNA-6-P4-energia-001-MASTERY-v7`
**Bloom:** Analyze
**ICFES:** Explicación de fenómenos

### Contexto
Un ventilador está funcionando en una habitación.
...
- [ ] D) Térmica -> Eléctrica -> Potencial. <!-- feedback: Incorrecto. El ventilador no funciona con calor ni eleva objetos. -->

### Explicación Pedagógica
Rastrear las transformaciones de energía permite comprender cómo funcionan los sistemas tecnológicos y naturales.

---

## Question 8 (Difficulty D4)

**ID:** `CO-CNA-6-P4-energia-001-MASTERY-v8`
**Bloom:** Analyze
**ICFES:** Uso comprensivo del conocimiento científico

### Contexto
Se frota una mano contra la otra rápidamente.
...
- [ ] D) Energía potencial gravitatoria. <!-- feedback: Incorrecto. No hay cambios de altura significativos. -->

### Explicación Pedagógica
La fricción es una de las causas principales de pérdida de energía útil, transformándola en calor que se disipa al ambiente.

---

## Question 9 (Difficulty D5)

**ID:** `CO-CNA-6-P4-energia-001-MASTERY-v9`
**Bloom:** Evaluate
**ICFES:** Indagación

### Contexto
Se compara una bombilla antigua (incandescente) con una moderna (LED). Ambas dan la misma cantidad de luz, pero la antigua se calienta muchísimo más.
...
- [ ] D) La antigua, porque es más barata de comprar. <!-- feedback: Incorrecto. El precio no define la eficiencia energética física. -->

### Explicación Pedagógica
La eficiencia energética es clave para el desarrollo sostenible, buscando obtener el mismo beneficio con menor gasto de recursos.

---

## Question 10 (Difficulty D5)

**ID:** `CO-CNA-6-P4-energia-001-MASTERY-v10`
**Bloom:** Evaluate
**ICFES:** Explicación de fenómenos
...
- [ ] D) El petróleo. <!-- feedback: Incorrecto. Es la principal fuente no renovable que causa contaminación. -->

### Explicación Pedagógica
Las energías renovables provienen de fuentes naturales inagotables o que se regeneran a una tasa mayor que su consumo.
