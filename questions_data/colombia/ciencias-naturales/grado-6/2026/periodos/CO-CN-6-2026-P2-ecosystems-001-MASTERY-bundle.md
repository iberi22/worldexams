...
This bundle covers ecosystems: biomes, food webs, trophic levels, energy flow and introduction to nutrient cycles.
...
- [ ] D) Rocks <!-- feedback: Abiotic. -->

### Explicación Pedagógica
Biotic = living (plants, animals, bacteria). Abiotic = non-living (water, sun, soil).
...
- [ ] D) They filter salt <!-- feedback: No. -->

### Explicación Pedagógica
Mangrove roots trap sediment and reduce coastal erosion from waves.
...
- [ ] D) Parasitism <!-- feedback: Harm but not kill. -->
...
- [ ] D) Make food <!-- feedback: No. -->

### Explicación Pedagógica
Decomposers (bacteria/fungi) recycle nutrients by breaking down dead matter.
...
- [ ] D) Having no effect <!-- feedback: No. -->

### Explicación Pedagógica
Trees absorb CO2. Deforestation releases stored carbon and reduces CO2 absorption.
...
- [ ] D) Prey becomes predator <!-- feedback: No. -->

### Explicación Pedagógica
More prey available = more food for predators, so predator population may grow.
...
- [ ] D) Farmland <!-- feedback: No. -->

### Explicación Pedagógica
Primary succession starts on surfaces with no soil (bare rock, lava).
...
- [ ] D) Tropical rainforest <!-- feedback: No. -->
