...
This bundle covers matter: states of matter, physical and chemical properties, mixtures, solutions and changes in matter.
...
- [ ] D) Hard, soft, wet <!-- feedback: No. -->

### Explicación Pedagógica
Matter exists as solid (fixed shape), liquid (flows), and gas (expands).
...
- [ ] D) Solid to gas <!-- feedback: Sublimation. -->

### Explicación Pedagógica
Melting: solid absorbs heat and changes to liquid (ice → water).
...
- [ ] D) Colder <!-- feedback: No. -->

### Explicación Pedagógica
Density = mass/volume. Oil is less dense than water, so it floats.
...
- [ ] D) Temporary <!-- feedback: No. -->

### Explicación Pedagógica
Chemical change produces new substances (ash, smoke), not easily reversible.
...
- [ ] D) Solids, liquids, gases <!-- feedback: States. -->

### Explicación Pedagógica
Atoms have: protons (+) and neutrons in nucleus; electrons (-) orbiting.
...
- [ ] D) Solution <!-- feedback: Homogeneous. -->

### Explicación Pedagógica
Heterogeneous: components are visible and can be separated.
...
### Explicación Pedagógica
Solubility: ability to dissolve. Sugar is soluble in water; oil is not.
...
- [ ] D) Oxygen and carbon <!-- feedback: No. -->
