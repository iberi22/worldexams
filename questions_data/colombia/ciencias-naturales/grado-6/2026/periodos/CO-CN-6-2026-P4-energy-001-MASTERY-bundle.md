...
This bundle covers energy: forms of energy, renewable and non-renewable sources, energy transformation and conservation.
...
- [ ] D) Chemical <!-- feedback: No. -->

### Explicación Pedagógica
Kinetic energy = energy of motion. Potential = stored energy.
...
- [ ] C) Sound <!-- feedback: No. -->
- [ ] D) Nuclear <!-- feedback: No. -->

### Explicación Pedagógica
Light bulbs produce light and heat from electrical energy.
...
- [ ] D) Natural gas <!-- feedback: Non-renewable. -->

### Explicación Pedagógica
Solar energy is renewable (infinite). Coal and oil are non-renewable (finite).
...
### Explicación Pedagógica
Law of Conservation: energy is neither created nor destroyed, only transformed.
...
- [ ] D) Insulation <!-- feedback: No. -->

### Explicación Pedagógica
Conduction: heat transfer through direct contact (e.g., pan on stove).
...
### Explicación Pedagógica
Hydroelectric: falling water turns turbines, converting kinetic to electrical energy.
...
- [ ] C) Nuclear <!-- feedback: No. -->
- [ ] D) Solar <!-- feedback: Growing but not majority. -->

### Explicación Pedagógica
Colombia generates ~70% of electricity from hydroelectric plants.
...
### Explicación Pedagógica
Gravitational potential energy = mass x gravity x height (mgh).
...
- [ ] D) Stopping energy use <!-- feedback: No. -->
