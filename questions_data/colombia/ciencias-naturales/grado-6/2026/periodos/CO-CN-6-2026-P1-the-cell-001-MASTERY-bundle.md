...
This bundle covers the cell: cell theory, types of cells (plant/animal), basic organelles and levels of organization.
...
- [ ] D) Cell membrane <!-- feedback: Protection. -->
...
- [ ] D) Plant cells have no nucleus <!-- feedback: No. -->

### Explicación Pedagógica
Plant cells have chloroplasts for photosynthesis and a cell wall.
...
- [ ] D) Make proteins <!-- feedback: Ribosome. -->

### Explicación Pedagógica
Cell membrane is selectively permeable, controlling passage of substances.
...
- [ ] D) Protein synthesis <!-- feedback: No. -->
...
- [ ] D) System, organ, tissue, cell <!-- feedback: No. -->
