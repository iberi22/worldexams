...
Este bundle evalúa el reconocimiento de la célula como unidad básica de los seres vivos, la distinción entre células procariotas y eucariotas, y la función de los organelos celulares.

---

## Question 1 (Difficulty D1)

**ID:** `CO-CNA-6-P1-celula-001-MASTERY-v1`
**Bloom:** Remember
...
- [ ] D) Mitocondria <!-- feedback: Incorrecto. La mitocondria se encarga de la producción de energía. -->

### Explicación Pedagógica
El núcleo es el organelo más prominente en las células animales y vegetales, actuando como el "cerebro" celular.

---

## Question 2 (Difficulty D1)

**ID:** `CO-CNA-6-P1-celula-001-MASTERY-v2`
**Bloom:** Remember
**ICFES:** Uso comprensivo del conocimiento científico
...
- [ ] D) Acuáticos <!-- feedback: Incorrecto. Esto se refiere a su hábitat, no a su estructura. -->

### Explicación Pedagógica
La clasificación según el número de células divide a los seres vivos en unicelulares (una célula) y pluricelulares (muchas células).

---

## Question 3 (Difficulty D2)

**ID:** `CO-CNA-6-P1-celula-001-MASTERY-v3`
**Bloom:** Understand
...
- [ ] D) Las procariotas son células vegetales. <!-- feedback: Incorrecto. Las células vegetales son eucariotas. -->

### Explicación Pedagógica
La presencia o ausencia de un núcleo organizado es el criterio evolutivo que separa a estos dos grandes grupos de células.

---

## Question 4 (Difficulty D2)

**ID:** `CO-CNA-6-P1-celula-001-MASTERY-v4`
**Bloom:** Apply
**ICFES:** Uso comprensivo del conocimiento científico

### Contexto
Un estudiante observa por el microscopio una célula que tiene una **pared celular** rígida y **cloroplastos** verdes.
...
- [ ] D) Un virus. <!-- feedback: Incorrecto. Los virus no son células. -->

### Explicación Pedagógica
Las células vegetales se distinguen de las animales por estructuras que les permiten sostenerse (pared) y producir su propio alimento (cloroplastos).

---

## Question 5 (Difficulty D3)

**ID:** `CO-CNA-6-P1-celula-001-MASTERY-v5`
**Bloom:** Understand
**ICFES:** Uso comprensivo del conocimiento científico
...
- [ ] D) Eliminar los desechos. <!-- feedback: Incorrecto. Esta es función de los lisosomas. -->

### Explicación Pedagógica
La respiración celular ocurre en las mitocondrias, donde se transforma la glucosa en energía aprovechable (ATP).

---

## Question 6 (Difficulty D3)

**ID:** `CO-CNA-6-P1-celula-001-MASTERY-v6`
**Bloom:** Analyze
**ICFES:** Explicación de fenómenos

### Contexto
La membrana celular es descrita como "semipermeable".
...
- [ ] D) Que es totalmente sólida como una piedra. <!-- feedback: Incorrecto. Es flexible y dinámica. -->

### Explicación Pedagógica
La permeabilidad selectiva de la membrana garantiza la homeostasis o equilibrio interno de la célula frente al ambiente externo.

---

## Question 7 (Difficulty D4)

**ID:** `CO-CNA-6-P1-celula-001-MASTERY-v7`
**Bloom:** Analyze
**ICFES:** Explicación de fenómenos
...
- [ ] D) En las vacuolas. <!-- feedback: Incorrecto. Las vacuolas almacenan sustancias, principalmente agua. -->

### Explicación Pedagógica
Los cloroplastos contienen pigmentos fotosintéticos capaces de transformar la energía lumínica en energía química (alimento).

---

## Question 8 (Difficulty D4)

**ID:** `CO-CNA-6-P1-celula-001-MASTERY-v8`
**Bloom:** Analyze
**ICFES:** Indagación

### Contexto
Un grupo de científicos descubre una sustancia que impide que los **ribosomas** funcionen.
...
- [ ] D) El almacenamiento de agua. <!-- feedback: Incorrecto. Las vacuolas se encargan de eso. -->

### Explicación Pedagógica
Sin ribosomas, la célula no puede producir enzimas, transportadores ni estructuras básicas hechas de proteínas.

---

## Question 9 (Difficulty D5)

**ID:** `CO-CNA-6-P1-celula-001-MASTERY-v9`
**Bloom:** Analyze
**ICFES:** Explicación de fenómenos
...
- [ ] D) Célula -> Órgano -> Tejido -> Sistema. <!-- feedback: Incorrecto. Los órganos están formados por tejidos, no al revés. -->

### Explicación Pedagógica
La especialización celular permite que las células se agrupen para realizar funciones complejas en niveles superiores de organización.

---

## Question 10 (Difficulty D5)

**ID:** `CO-CNA-6-P1-celula-001-MASTERY-v10`
**Bloom:** Evaluate
**ICFES:** Indagación

### Contexto
Se sabe que las células de los músculos necesitan mucha energía para que podamos movernos.
...
- [ ] D) Pared celular. <!-- feedback: Incorrecto. Las células humanas no tienen pared celular. -->

### Explicación Pedagógica
La estructura y composición de una célula (cantidad de organelos) se adapta a la función específica que cumple en el organismo.
