...
Este bundle practica la identificación de palabras graves (o llanas) y la aplicación de las reglas para el uso de la tilde (acento ortográfico).
...
**Contexto:** Un niño identifica el acento en palabras comunes en Bogotá.
...
**Contexto:** La regla de la tilde para palabras graves en un colegio de Medellín.
...
**Contexto:** Identificando una palabra grave en una lista de objetos del salón.
...
**Contexto:** Marcando tildes en palabras con terminaciones específicas en Cali.
...
**Contexto:** Clasificando palabras graves sin tilde en Tunja.
...
**Contexto:** El uso de la tilde en nombres propios graves en un colegio de Pasto.
...
**Contexto:** Completando un texto sobre útiles escolares en Barranquilla.
...
**Contexto:** Diferenciando graves de agudas en una lista de animales.
...
**Contexto:** Corrigiendo un párrafo sobre la comida en Cartagena.
...
**Contexto:** Quieres ponerle un nombre a tu mascota que sea una palabra grave con tilde.
