...
**Explicación:** Los halógenos son los elementos del grupo 17 (VII A): flúor, cloro, bromo, yodo y astato. El cloro (Cl, Z=17) es un halógeno. El sodio es un metal alcalino (grupo 1), el oxígeno y el nitrógeno son calcógenos y nitrogenoides respectivamente.
...
**Explicación:** La ley de conservación de la masa, formulada por Antoine Lavoisier, establece que en una reacción química la materia no se crea ni se destruye, solo se transforma. Por lo tanto, la masa total de los reactivos es igual a la masa total de los productos.
...
```
Cadena 1: A - T - G - C - T - A
Cadena 2: T - A - C - G - A - T
```
...
**Explicación:** Las bases nitrogenadas se emparejan de forma específica y complementaria: Adenina (A) con Timina (T), y Guanina (G) con Citosina (C). Este principio de complementariedad es fundamental en la replicación del ADN y fue descrito por Chargaff.
...
**Explicación:** En genética, el alelo dominante se expresa completamente en el fenotipo cuando está presente en heterozigosis (Vv). El alelo recesivo (v) solo se manifiesta cuando el individuo es homozigoto recesivo (vv). Por lo tanto, Vv presentará el fenotipo verde.
...
**Explicación:** El sodio (Na) pierde su electrón de valencia (3s¹) y forma Na⁺ con configuración 2, 8 (isoelectrónica con Neón). El cloro gana un electrón y forma Cl⁻ con configuración 2, 8, 8 (isoelectrónica con Argón). Ambos iones alcanzan estabilidad de octeto.
...
Un cultivo de palma de aceite en la región del Magdalena Medio colombiano necesita producir 180 g de glucosa (C₆H₁₂O₆). ¿Cuántos litros de CO₂ a condiciones normales (P=1 atm, T=273 K) se requieren si el rendimiento es del 100%?
...
**Explicación:** Según la segunda ley de la termodinámica, en cada transferencia de energía en la cadena trófica se pierde energía en forma de calor debido a los procesos metabólicos (respiración celular). Por esto, la energía disponible disminuye aproximadamente en un 90% en cada nivel trófico (regla del 10%).
...
**Explicación:** La Ley de Segregación (I) establece que los alelos de un gen se separan durante la meiosis. La Ley de Distribución Independiente (II) indica que genes de diferentes caracteres se segregan independientemente. La Ley de Dominancia (III) es un concepto previo a Mendel que describe la relación alélica, pero no es una de sus leyes formales.
...
**Explicación:** El Ca(OH)₂ es una base que neutraliza los iones H⁺ del suelo mediante la reacción ácidobase: H⁺ + OH⁻ → H₂O. Al consumir H⁺, la concentración de [H⁺] disminuye y el pH aumenta (escala logarítmica: pH = -log[H⁺]). Un pH de 5,2 subirá hacia valores más cercanos a 7.
...
```
Generación I:    [♀ afectada] —— [♂ no afectado]
Generación II:   [♀ portadora]    [♂ afectado]
                  ↘                ↙
Generación III: [♀ afectada] [♀ portadora] [♂ no afectado]
```
...
**Explicación:** La enfermedad afecta principalmente a varones (generaciones II y III) y es transmitida por mujeres portadoras fenotípicamente normales. Esto es característico de la herencia ligada al cromosoma X recesiva: los hombres (XY) con el alelo afectado se expresan, mientras que las mujeres portadoras (XX) son fenotípicamente normales.
...
**Explicación:** Según la teoría de colisiones, al aumentar la temperatura, las moléculas ganan energía cinética y se mueven más rápido, lo que aumenta tanto el número de colisiones como la fracción de colisiones que superan la energía de activación (Eₐ). Esto acelera la reacción.
...
**Explicación:** Las diferencias fundamentales entre ADN y ARN son: (1) el azúcar del ARN es ribosa y la del ADN es desoxirribosa, (2) el ARN tiene base nitrogenada uracilo (U) mientras que el ADN tiene timina (T), y (3) el ARN es generalmente monocatenario mientras que el ADN es bicatenario.
...
**Explicación:** La proporción 9:3:3:1 es la proporción mendeliana esperada para un cruce dihíbrido con dos genes que segregan independientemente (no ligado). Cada par de alelos muestra dominancia completa. La ley de distribución independiente de Mendel predice esta segregación cuando los genes están en diferentes cromosomas.
...
| Nivel trófico | Organismo | [Mercurio] mg/kg |
|---|---|---|
| Productor | Algas | 0,02 |
| Consumidor 1 | Caracol | 0,2 |
| Consumidor 2 | Pez | 2,0 |
| Consumidor 3 | Garza | 20,0 |
...
**Explicación:** El mercurio es un ejemplo clásico de bioacumulación y biomagnificación. Se acumula en los tejidos y se magnifica (aumenta) en cada nivel trófico porque los depredadores consumen muchas presas, cada una con su carga de mercurio, sin poder eliminarlo eficientemente. La concentración aumenta ~10 veces por nivel (efecto de biomagnificación), pasando de 0,02 mg/kg en productores a 20,0 mg/kg en depredadores apex.
