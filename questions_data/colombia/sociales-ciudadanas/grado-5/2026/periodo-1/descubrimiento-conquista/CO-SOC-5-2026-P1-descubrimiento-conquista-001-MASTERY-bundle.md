...
Este bundle cubre el período del descubrimiento y la conquista del territorio colombiano por parte de los españoles. Explora la llegada de los primeros exploradores, las expediciones de Gonzalo Jiménez de Quesada, Sebastián de Belalcázar y otros conquistadores, la fundación de ciudades, el encuentro entre culturas y la resistencia indígena. Contenido del primer periodo según DBA MEN para grado 5.
...
- [ ] D) 1538, cuando se fundó Bogotá. <!-- feedback: Incorrecto. Para esa fecha los españoles ya estaban en territorio colombiano desde hacía décadas. -->

### Explicación Pedagógica
Se evalúa el conocimiento de la cronología del descubrimiento. La respuesta correcta identifica a Bastidas en 1500. El error común es confundir la llegada de Colón a América con la llegada a Colombia.
...
- [ ] D) Alonso de Ojeda. <!-- feedback: Incorrecto. Alonso de Ojeda exploró la costa caribe pero no fundó Bogotá. -->

### Explicación Pedagógica
Se evalúa el conocimiento del fundador de la capital colombiana. La respuesta correcta es Gonzalo Jiménez de Quesada. El error común es confundir a los conquistadores con las ciudades que fundaron.
...
- [ ] D) Rodrigo de Bastidas. <!-- feedback: Incorrecto. Bastidas exploró la costa caribe pero no fundó Cali. -->

### Explicación Pedagógica
Se evalúa la comprensión de quién fundó las principales ciudades colombianas. La respuesta correcta atribuye Cali a Belalcázar. El error común es confundir los conquistadores y sus ciudades fundadas.
...
- [ ] D) Rodrigo de Bastidas. <!-- feedback: Incorrecto. Bastidas exploró la costa pero no fundó Cartagena. -->

### Explicación Pedagógica
Se evalúa la comprensión de la fundación de Cartagena. La respuesta correcta la atribuye a Pedro de Heredia. El error común es no asociar correctamente a los conquistadores con las ciudades.
...
- [ ] D) Cali (1536). <!-- feedback: Incorrecto. Cali se fundó después de Santa Marta y Cartagena. -->

### Explicación Pedagógica
Se evalúa la capacidad de ordenar cronológicamente la fundación de ciudades. La respuesta correcta identifica a Santa Marta como la primera. El error común es pensar que Bogotá o Cartagena son más antiguas.
...
- [ ] D) Los indígenas se convirtieron todos al islam. <!-- feedback: Incorrecto. No hay registro de conversión al islam. -->

### Explicación Pedagógica
Se evalúa la comprensión de las variadas reacciones indígenas. La respuesta correcta describe la diversidad de respuestas. El error común es simplificar el encuentro como pacífico o exclusivamente violento.
...
- [ ] D) La mita urbana. <!-- feedback: Incorrecto. La mita era un sistema de trabajo obligatorio, más común en el virreinato peruano. -->

### Explicación Pedagógica
Se evalúa la comprensión del sistema de encomiendas. La respuesta correcta lo describe como asignación de indígenas a españoles. El error común es confundir los sistemas de explotación colonial.
...
- [ ] D) Todos los indígenas estuvieron de acuerdo con la conquista. <!-- feedback: Incorrecto. Hubo resistencia generalizada. -->

### Explicación Pedagógica
Se evalúa la capacidad de analizar críticamente el término "descubrimiento". La respuesta correcta cuestiona la perspectiva eurocéntrica. El error común es no problematizar el lenguaje histórico.
...
- [ ] D) Que todos recibieron educación universitaria. <!-- feedback: Incorrecto. La educación no estuvo al alcance de la mayoría indígena. -->

### Explicación Pedagógica
Se evalúa la capacidad de analizar las consecuencias demográficas de la conquista. La respuesta correcta identifica la catástrofe demográfica. El error común es minimizar el impacto de la conquista en la población indígena.
...
- [ ] D) La colonización pura sin mezcla. <!-- feedback: Incorrecto. Hubo amplio mestizaje en Colombia. -->

### Explicación Pedagógica
Se evalúa la capacidad de reflexionar sobre el mestizaje como herencia de la conquista. La respuesta correcta lo describe como origen de la población actual. El error común es no reconocer la mezcla cultural como característica fundacional de Colombia.

### Explicación Pedagógica Final
Este bundle de Ciencias Sociales para grado quinto cubre el Descubrimiento y la Conquista de Colombia. Evalúa el conocimiento de la llegada de Rodrigo de Bastidas (1500), la fundación de Santa Marta (1525, primera ciudad), la fundación de Cartagena por Pedro de Heredia (1533), la fundación de Bogotá por Gonzalo Jiménez de Quesada (1538), la fundación de Cali por Sebastián de Belalcázar (1536), las diversas reacciones indígenas (resistencia, alianzas, enfermedades), el sistema de encomiendas, la crítica al término "descubrimiento", la catástrofe demográfica indígena y el mestizaje como resultado del encuentro de culturas. El objetivo es que los estudiantes comprendan la complejidad del proceso de conquista y sus consecuencias.
