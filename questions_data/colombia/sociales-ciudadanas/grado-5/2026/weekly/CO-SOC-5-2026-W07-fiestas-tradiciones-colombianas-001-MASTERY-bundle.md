---
id: "CO-SOC-5-2026-W07-fiestas-tradiciones-colombianas-001-MASTERY-bundle"
country: "colombia"
grado: 5
asignatura: "sociales-ciudadanas"
tema: "fiestas-tradiciones-colombianas"
periodo: "weekly"
week: "W07"
year: 2026
bundle_type: "weekly"
...
# Bundle MASTERY: Fiestas y Tradiciones Colombianas - Grado 5 (W07)

Fiestas y tradiciones representativas de las regiones colombianas, su origen, elementos culturales y significado para la identidad nacional.
...
Reconocer las principales fiestas tradicionales colombianas según su región.
...
- [ ] D) Que las fiestas son iguales en todas las ciudades del mundo.
  <!-- feedback: Cada fiesta tiene rasgos únicos de su cultura local. -->

### Explicacion Pedagogica
Comprender la diversidad cultural reflejada en las fiestas tradicionales colombianas.
...
### Enunciado
¿Cuál de los siguientes elementos es típico de la Fiesta de las Flores?

### Opciones
- [x] A) Los silleteros, los arreglos florales y los desfiles por las calles de Medellín.
  <!-- feedback: La Fiesta de las Flores se caracteriza por los silleteros y desfiles con flores. -->
- [ ] B) Las procesiones en el río Magdalena.
  <!-- feedback: Las procesiones en el río son típicas de otras fiestas, no de la Fiesta de las Flores. -->
- [ ] C) Las competencias de nieve en alta montaña.
  <!-- feedback: La Fiesta de las Flores se realiza en Medellín y no incluye competencias de nieve. -->
- [ ] D) Las carrozas acuáticas en el mar Caribe.
  <!-- feedback: Las carrozas acuáticas no son típicas de la Fiesta de las Flores. -->

### Explicacion Pedagogica
Identificar los elementos culturales que caracterizan una fiesta tradicional colombiana.
...
### Explicacion Pedagogica
Aplicar el concepto de identidad cultural a partir de los elementos de las fiestas tradicionales.
...
### Explicacion Pedagogica
Reconocer el aporte social y cultural de las fiestas tradicionales para una comunidad.
...
### Explicacion Pedagogica
Comparar el carácter y los elementos de distintas fiestas tradicionales colombianas.
...
- [ ] D) Las fiestas siempre reemplazan las actividades escolares.
  <!-- feedback: Las fiestas se suman a la vida escolar, no la sustituyen. -->

### Explicacion Pedagogica
Analizar el origen histórico, religioso o agrícola de las fiestas tradicionales colombianas.
...
### Explicacion Pedagogica
Evaluar la importancia de respetar y difundir las fiestas tradicionales colombianas para la convivencia.