---
id: "CO-SOC-5-2026-W04-culturas-precolombinas-001-MASTERY-bundle"
country: "colombia"
grado: 5
...
# Bundle MASTERY: Culturas Precolombinas - Grado 5 (W04)

Características de las principales culturas precolombinas del territorio colombiano: Muisca, Tairona, Zenú y Calima, y sus aportes culturales.
...
Reconocer culturas precolombinas que existieron en el actual territorio colombiano antes de la conquista española.
...
- [ ] D) Porque los españoles los habían llevado hasta allí.
  <!-- feedback: Los Muisca estaban allí antes de la llegada de los españoles. -->

### Explicacion Pedagogica
Comprender la relación entre las condiciones geográficas y el asentamiento de las culturas precolombinas.
...
### Explicacion Pedagogica
Identificar los principales aportes culturales, tecnológicos y agrícolas de las culturas precolombinas.
...
### Enunciado
¿Qué tipo de organización tenían los Tairona según el texto?

### Opciones
- [x] A) Una organización social compleja, con ciudades construidas en terrazas e infraestructura hidráulica.
  <!-- feedback: Los Taironas edificaron ciudades con caminos y acueductos, lo que refleja una sociedad organizada. -->
- [ ] B) Una organización nómada sin construcciones fijas.
  <!-- feedback: Los Tairona no eran nómadas; construyeron ciudades permanentes. -->
- [ ] C) Una cultura exclusivamente dedicada a la caza sin agricultura.
  <!-- feedback: Aunque cazaban, también practicaban la agricultura en terrazas. -->
- [ ] D) Una sociedad sin ningún tipo de autoridad ni jefes.
  <!-- feedback: La construcción de ciudades complejas implica formas de organización y autoridad. -->

### Explicacion Pedagogica
Aplicar el concepto de organización social compleja a partir de ejemplos arquitectónicos Taironas.
...
- [ ] D) El tipo de escritura digital que manejaron.
  <!-- feedback: No existía la escritura digital en tiempos precolombinos. -->

### Explicacion Pedagogica
Seleccionar criterios históricos válidos para comparar culturas precolombinas colombianas.
...
- [ ] D) Los Quimbaya despreciaban el oro y solo usaban barro.
  <!-- feedback: Los Quimbaya son famosos precisamente por sus figuras de oro. -->

### Explicacion Pedagogica
Analizar el significado cultural del oro en distintas civilizaciones precolombinas colombianas.
...
- [ ] D) Que las palabras indígenas fueron prohibidas en Colombia.
  <!-- feedback: No fueron prohibidas; de hecho, muchas se incorporaron al uso cotidiano. -->

### Explicacion Pedagogica
Reconocer el legado lingüístico de las culturas precolombinas en el español actual de Colombia.
...
- [ ] D) Porque solo los arqueólogos deberían interesarse por esas culturas.
  <!-- feedback: El legado precolombino es patrimonio de toda la sociedad colombiana. -->

### Explicacion Pedagogica
Evaluar la importancia de conocer y respetar el legado de las culturas precolombinas en Colombia.