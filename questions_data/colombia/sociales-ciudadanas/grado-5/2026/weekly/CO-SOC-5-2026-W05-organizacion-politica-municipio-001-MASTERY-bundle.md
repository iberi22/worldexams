---
id: "CO-SOC-5-2026-W05-organizacion-politica-municipio-001-MASTERY-bundle"
country: "colombia"
grado: 5
asignatura: "sociales-ciudadanas"
tema: "organizacion-politica-municipio"
periodo: "weekly"
week: "W05"
year: 2026
bundle_type: "weekly"
...
# Bundle MASTERY: Organización Política del Municipio - Grado 5 (W05)

Estructura político-administrativa del municipio colombiano: alcalde, Concejo municipal, funciones básicas y participación ciudadana.
...
- [ ] D) El director de la escuela.
  <!-- feedback: El director de la escuela dirige una institución educativa, no el municipio. -->

### Explicacion Pedagogica
Identificar al alcalde como la primera autoridad del gobierno municipal en Colombia.
...
### Enunciado
¿Por qué el Concejo Municipal es importante para el funcionamiento del municipio?

### Opciones
- [x] A) Porque representa a los ciudadanos, aprueba normas locales y vigila al alcalde.
  <!-- feedback: El Concejo Municipal cumple funciones normativas, de control y representación ciudadana. -->
- [ ] B) Porque se encarga únicamente de cobrar impuestos nacionales.
  <!-- feedback: Los impuestos nacionales los administra la nación, no el Concejo Municipal. -->
- [ ] C) Porque dirige las clases en las escuelas del municipio.
  <!-- feedback: La educación es dirigida por la Secretaría de Educación, no por el Concejo. -->
- [ ] D) Porque nombra al presidente de la República.
  <!-- feedback: El Concejo Municipal no tiene injerencia en la elección presidencial. -->

### Explicacion Pedagogica
Comprender el papel del Concejo Municipal en la democracia local colombiana.
...
### Explicacion Pedagogica
Reconocer las funciones ejecutivas del alcalde en el gobierno municipal.
...
### Explicacion Pedagogica
Identificar el municipio como la entidad territorial más cercana a los ciudadanos en Colombia.
...
### Enunciado
¿Qué mecanismo de participación ciudadana pueden usar los vecinos para exigir soluciones al alcalde?

### Opciones
- [x] A) Una solicitud formal a la Alcaldía, audiencias públicas o derechos de petición.
  <!-- feedback: Existen canales formales como derechos de petición y audiencias para que la comunidad se exprese. -->
- [ ] B) Cambiar la Constitución Nacional por su cuenta.
  <!-- feedback: La Constitución solo se reforma por procedimientos especiales del Congreso. -->
- [ ] C) Organizar una pelea en la vía pública.
  <!-- feedback: Las acciones violentas no son canales válidos de participación. -->
- [ ] D) Cambiar al presidente de la República.
  <!-- feedback: Cambiar al presidente requiere elecciones nacionales, no presión vecinal. -->

### Explicacion Pedagogica
Aplicar mecanismos democráticos de participación para que los ciudadanos se relacionen con la Alcaldía.
...
- [ ] D) La rendición de cuentas no tiene relación con el gobierno municipal.
  <!-- feedback: La rendición de cuentas es una obligación clave de los mandatarios locales. -->

### Explicacion Pedagogica
Comparar estilos de gobierno municipal para distinguir prácticas democráticas y cerradas.
...
### Enunciado
¿Qué relación hay entre los impuestos municipales y los servicios que reciben los ciudadanos?

### Opciones
- [x] A) Los impuestos locales financian los servicios públicos que el municipio presta a la comunidad.
  <!-- feedback: Los tributos municipales permiten pagar el alumbrado, el aseo y el arreglo de vías. -->
- [ ] B) Los impuestos municipales se envían al extranjero y no benefician a nadie.
  <!-- feedback: Los impuestos locales se quedan en el municipio para financiar sus servicios. -->
- [ ] C) Los impuestos solo pagan los sueldos del alcalde.
  <!-- feedback: Los impuestos financian toda la administración y los servicios, no solo el sueldo del alcalde. -->
- [ ] D) Los servicios públicos son gratis y no tienen relación con los impuestos.
  <!-- feedback: Los servicios públicos requieren recursos que provienen, en gran parte, de los impuestos. -->

### Explicacion Pedagogica
Analizar la relación entre tributación local y prestación de servicios públicos en el municipio.
...
### Explicacion Pedagogica
Evaluar el papel de la participación ciudadana en la calidad de la democracia municipal.