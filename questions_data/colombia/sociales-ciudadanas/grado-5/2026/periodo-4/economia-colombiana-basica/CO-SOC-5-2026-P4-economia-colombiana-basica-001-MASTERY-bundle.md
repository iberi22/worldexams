...
tema: "economia-colombiana-basica"
periodo: 4
...
Este bundle cubre los conceptos fundamentales de la economía colombiana: los sectores económicos (primario, secundario, terciario), los principales productos de Colombia, el comercio, la moneda, los recursos naturales, la economía familiar y la importancia del trabajo. Contenido del cuarto periodo según DBA MEN para grado 5.
...
- [ ] D) El bolívar. <!-- feedback: Incorrecto. El bolívar es la moneda de Venezuela. -->

### Explicación Pedagógica
Se evalúa el conocimiento básico de la moneda nacional. La respuesta correcta identifica el peso colombiano. El error común es confundir la moneda local con monedas extranjeras.
...
- [ ] D) Infantil, juvenil y adulto. <!-- feedback: Incorrecto. Esos son rangos de edad, no sectores económicos. -->

### Explicación Pedagógica
Se evalúa el conocimiento de la clasificación sectorial de la economía. La respuesta correcta enumera los tres sectores. El error común es confundir sectores económicos con otros tipos de clasificación.
...
- [ ] D) Cuaternario, porque usa tecnología avanzada. <!-- feedback: Incorrecto. El sector cuaternario se refiere a tecnología de información. -->

### Explicación Pedagógica
Se evalúa la comprensión de cómo clasificar las actividades económicas. La respuesta correcta ubica el cultivo en el sector primario. El error común es no distinguir entre la producción primaria y su procesamiento secundario.
...
- [ ] D) Donación. <!-- feedback: Incorrecto. Exportar no es regalar, es vender. -->

### Explicación Pedagógica
Se evalúa la comprensión del concepto de exportación. La respuesta correcta lo define como venta al exterior. El error común es confundir exportación con importación.
...
- [ ] D) Recolección. <!-- feedback: Incorrecto. Recolectar no es el término económico correcto. -->

### Explicación Pedagógica
Se evalúa la capacidad de aplicar el concepto de importación. La respuesta correcta lo define como compra al exterior. El error común es confundir importación con exportación.
...
- [ ] D) Los libros de texto y los uniformes escolares. <!-- feedback: Incorrecto. Esos son productos fabricados. -->

### Explicación Pedagógica
Se evalúa la comprensión de qué son los recursos naturales. La respuesta correcta los distingue de los productos manufacturados. El error común es no saber diferenciar entre recursos naturales y productos elaborados.
...
- [ ] D) Las decisiones económicas que toma solo el gobierno nacional. <!-- feedback: Incorrecto. Eso es macroeconomía, no economía familiar. -->

### Explicación Pedagógica
Se evalúa la comprensión de la economía familiar. La respuesta correcta describe la administración de ingresos y gastos del hogar. El error común es confundir la economía familiar con la nacional.
...
- [ ] D) Ahorrar no sirve para nada. <!-- feedback: Incorrecto. Ahorrar tiene múltiples beneficios. -->

### Explicación Pedagógica
Se evalúa la capacidad de analizar la importancia del ahorro. La respuesta correcta destaca la seguridad y las metas futuras. El error común es pensar que ahorrar es innecesario o solo para ricos.
...
- [ ] D) La economía funciona sola sin necesidad del trabajo humano. <!-- feedback: Incorrecto. Sin trabajo no hay producción de bienes ni servicios. -->

### Explicación Pedagógica
Se evalúa la capacidad de analizar el papel del trabajo en la economía. La respuesta correcta describe el ciclo económico generado por el trabajo. El error común es pensar que la economía es independiente del trabajo de las personas.
...
- [ ] D) Para que otras naciones se beneficien de nuestros productos sin que nosotros ganemos nada. <!-- feedback: Incorrecto. El comercio beneficia a ambas partes. -->

### Explicación Pedagógica
Se evalúa la capacidad de reflexionar sobre la importancia del comercio internacional. La respuesta correcta explica la especialización y el intercambio. El error común es pensar que un país puede ser autosuficiente.

### Explicación Pedagógica Final
Este bundle de Ciencias Sociales para grado quinto cubre la Economía Colombiana Básica. Evalúa el conocimiento de la moneda nacional (peso colombiano), los tres sectores económicos (primario, secundario, terciario), el café como producto del sector primario, los conceptos de exportación e importación, los recursos naturales de Colombia (petróleo, carbón, oro), la economía familiar (ingresos y gastos), la importancia del ahorro, el papel del trabajo en la economía y la necesidad del comercio internacional. El objetivo es que los estudiantes comprendan los conceptos económicos básicos y su aplicación en la vida cotidiana y nacional.
