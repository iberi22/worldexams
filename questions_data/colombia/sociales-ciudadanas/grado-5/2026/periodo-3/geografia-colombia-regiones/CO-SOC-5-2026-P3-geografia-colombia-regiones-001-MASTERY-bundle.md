...
tema: "geografia-colombia-regiones"
periodo: 3
...
Este bundle cubre la geografía de Colombia: su localización en el mundo, límites y fronteras, la división en regiones naturales (Andina, Caribe, Pacífica, Orinoquía, Amazonía, Insular), el relieve, el clima, la hidrografía y la biodiversidad de cada región. Contenido del tercer periodo según DBA MEN para grado 5.
...
- [ ] D) La península ibérica, en Europa. <!-- feedback: Incorrecto. Colombia está en América del Sur, no en Europa. -->

### Explicación Pedagógica
Se evalúa el conocimiento de la localización de Colombia. La respuesta correcta describe su ubicación precisa. El error común es confundir continentes o hemisferios.
...
- [ ] D) 7 países: todos los de Sudamérica. <!-- feedback: Incorrecto. Colombia no limita con todos los países sudamericanos. -->

### Explicación Pedagógica
Se evalúa el conocimiento de los países fronterizos de Colombia. La respuesta correcta enumera los cinco países vecinos. El error común es agregar o quitar países de la lista.
...
- [ ] D) Cundinamarca, Antioquia, Valle, Atlántico, Santander y Nariño. <!-- feedback: Incorrecto. Esos son departamentos, no regiones naturales. -->

### Explicación Pedagógica
Se evalúa la comprensión de las regiones naturales de Colombia. La respuesta correcta enumera las seis regiones. El error común es confundir regiones naturales con divisiones políticas o departamentos.
...
- [ ] D) Tener selva tropical densa con altas temperaturas todo el año. <!-- feedback: Incorrecto. Eso describe más a la Amazonía o al Pacífico. -->

### Explicación Pedagógica
Se evalúa la comprensión de las características de la región Andina. La respuesta correcta describe su relieve montañoso y diversidad climática. El error común es confundir las características de las regiones.
...
- [ ] D) La Caribe está al sur y la Pacífica al norte. <!-- feedback: Incorrecto. Al revés: Caribe al norte, Pacífica al occidente. -->

### Explicación Pedagógica
Se evalúa la capacidad de comparar regiones. La respuesta correcta contrasta los climas de ambas regiones. El error común es no conocer las características distintivas de cada región.
...
- [ ] D) Selva tropical impenetrable durante todo el año. <!-- feedback: Incorrecto. La selva densa es más característica de la Amazonía. -->

### Explicación Pedagógica
Se evalúa la comprensión de las características de la Orinoquía. La respuesta correcta describe sus sabanas y ganadería. El error común es confundirla con la Amazonía.
...
- [ ] D) Ser una llanura desértica con poca vegetación. <!-- feedback: Incorrecto. Eso describe a La Guajira, no a la Amazonía. -->

### Explicación Pedagógica
Se evalúa la capacidad de describir la Amazonía colombiana. La respuesta correcta describe su selva y biodiversidad. El error común es confundir la Amazonía con otras regiones.
...
- [ ] D) Tiene el clima más frío de toda América. <!-- feedback: Incorrecto. La biodiversidad se debe a la variedad de climas y ecosistemas, no al frío. -->

### Explicación Pedagógica
Se evalúa la capacidad de analizar la megadiversidad colombiana. La respuesta correcta explica sus causas y datos. El error común es atribuir la biodiversidad al tamaño del país.
...
- [ ] D) Es la región más extensa del país. <!-- feedback: Incorrecto. La Amazonía es la región más extensa. -->

### Explicación Pedagógica
Se evalúa la capacidad de analizar por qué la región Andina concentra la población. La respuesta correcta combina factores geográficos, económicos y de infraestructura. El error común es no considerar los factores que atraen población a una región.
...
- [ ] D) En la Amazonía se usa ropa de lana por el frío extremo. <!-- feedback: Incorrecto. En la Amazonía hace calor y se usa ropa ligera. -->

### Explicación Pedagógica
Se evalúa la capacidad de reflexionar sobre la relación entre geografía y cultura. La respuesta correcta establece la conexión entre región y costumbres. El error común es pensar que la cultura es independiente del entorno geográfico.

### Explicación Pedagógica Final
Este bundle de Ciencias Sociales para grado quinto cubre la Geografía de Colombia y sus Regiones. Evalúa el conocimiento de la ubicación de Colombia (noroccidente de Sudamérica, zona tropical), sus cinco fronteras terrestres (Venezuela, Brasil, Perú, Ecuador, Panamá), las seis regiones naturales (Andina, Caribe, Pacífica, Orinoquía, Amazonía, Insular), las características de la región Andina (tres cordilleras, pisos térmicos), las diferencias entre Caribe (seca, desértica) y Pacífica (lluviosa, selvática), la Orinoquía (sabanas, ganadería), la Amazonía (selva, biodiversidad), la condición de Colombia como país megadiverso, la concentración poblacional en la región Andina y la influencia de la geografía en la cultura. El objetivo es que los estudiantes comprendan la diversidad geográfica colombiana y cómo esta determina la vida de sus habitantes.
