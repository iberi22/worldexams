...
tema: "geopolitica-mundial, globalizacion, conflicto-paz"
periodo: 3
...
Cubre geopolítica mundial, globalización, conflicto y paz.
...
- [ ] D) Las lenguas y culturas de diferentes países. <!-- feedback: Incorrecto. Eso es antropología cultural o ling\u00fcística. -->

### Explicación Pedagógica
La geopolítica es una disciplina que combina geografía y política para entender cómo los Estados compiten, cooperan y ejercen poder en el escenario internacional. Factores como recursos naturales, posición estratégica, demografía y economía influyen en las decisiones de los países.
...
- [ ] D) Organizar los Juegos Olímpicos. <!-- feedback: Incorrecto. Eso es función del Comité Olímpico Internacional. -->

### Explicación Pedagógica
La ONU (1945) es la organización internacional más importante, con 193 miembros. Sus pilares: paz y seguridad (Consejo de Seguridad), desarrollo (PNUD, UNICEF, UNESCO) y derechos humanos (Consejo de Derechos Humanos). Colombia es miembro fundador.
...
- [ ] D) El comercio internacional ha desaparecido. <!-- feedback: Incorrecto. El comercio global ha aumentado con la globalización. -->

### Explicación Pedagógica
La globalización económica se caracteriza por la deslocalización productiva: las empresas ubican cada etapa de producción donde sea más rentable. Esto genera interdependencia económica, pero también desigualdad entre países y al interior de ellos.
...
- [ ] D) Solo participan guerrillas y Estado. <!-- feedback: Incorrecto. El texto menciona también paramilitares y narcotráfico. -->

### Explicación Pedagógica
El conflicto colombiano es particular por su duración (más de 60 años), multiplicidad de actores y la compleja combinación de causas: desigualdad agraria, exclusión política, narcotráfico y disputas territoriales. No es un conflicto ideológico simple, sino un entramado de violencias superpuestas.
...
- [ ] D) La autarquía, porque Colombia es autosuficiente. <!-- feedback: Incorrecto. Si Colombia importa, no es autosuficiente. -->

### Explicación Pedagógica
La teoría de la ventaja comparativa (David Ricardo) explica que los países se especializan en producir bienes donde tienen menor costo de oportunidad. Colombia tiene ventajas en agricultura (café, flores) y minería (petróleo, carbón), pero no en manufactura tecnológica, por eso las importa.
...
- [ ] D) Rusia debe retirarse del Consejo de Seguridad. <!-- feedback: Incorrecto. El veto es un derecho establecido en la Carta de la ONU. -->

### Explicación Pedagógica
El poder de veto de los 5 miembros permanentes del Consejo de Seguridad es una herencia de la Segunda Guerra Mundial. Es criticado por antidemocrático, pero reformarlo requiere una enmienda a la Carta de la ONU que cualquiera de los 5 puede vetar. Esto limita la capacidad de la ONU para resolver conflictos.
...
- [ ] D) Ambas posturas dicen lo mismo. <!-- feedback: Incorrecto. Son enfoques opuestos sobre el mismo fenómeno. -->

### Explicación Pedagógica
El debate sobre globalización cultural enfrenta dos posturas: quienes ven una homogeneización impulsada por Estados Unidos (imperialismo cultural de la Escuela de Frankfurt) y quienes ven procesos creativos de mezcla (hibridación de Néstor García Canclini). La realidad colombiana muestra ambos fenómenos: consumo de Netflix pero también producción local de contenido.
...
- [ ] D) El acuerdo no incluyó reforma rural. <!-- feedback: Incorrecto. El acuerdo sí incluyó compromisos de reforma rural. -->

### Explicación Pedagógica
Los acuerdos de paz no terminan con la firma: la implementación es una fase larga y compleja. En Colombia, los desafíos incluyen: seguridad de excombatientes, implementación de reforma rural (punto 1), y surgimiento de disidencias que no aceptaron el acuerdo. Aun así, la reducción de homicidios y la desmovilización de más de 13,000 combatientes son logros significativos.
...
- [ ] D) Ambos son países desarrollados. <!-- feedback: Incorrecto. Singapur es desarrollado, Colombia es un país de ingreso medio. -->

### Explicación Pedagógica
La ubicación geográfica es un activo geopolítico. Colombia tiene la ventaja de ser la única puerta de Sudamérica al Pacífico hacia Asia, además del Atlántico hacia Europa. Singapur aprovechó su posición para convertirse en un centro logístico global. Colombia tiene un potencial similar que no ha explotado completamente.
...
- [ ] D) Colombia quiere que la CPI juzgue todos los crímenes. <!-- feedback: Incorrecto. La moratoria busca lo contrario: retrasar la intervención de la CPI. -->

### Explicación Pedagógica
La CPI opera por el principio de complementariedad: solo interviene si los Estados no pueden o no quieren juzgar. La solicitud de moratoria colombiana refleja la tensión entre la soberanía nacional (juzgar nuestros crímenes) y la necesidad de justicia internacional cuando los sistemas internos fallan.
...
- [ ] D) Solo los países ricos participan en la globalización. <!-- feedback: Incorrecto. Todos participan, pero en condiciones desiguales. -->

### Explicación Pedagógica
La globalización selectiva es una crítica a la asimetría del sistema global: se promueve la libre circulación de capitales y mercancías (beneficiando a las corporaciones) pero se restringe la migración humana (afectando a trabajadores del Sur Global). Esto revela que la globalización no es neutral ni universal.
...
- [ ] D) Porque el desplazamiento siempre termina el conflicto. <!-- feedback: Incorrecto. El desplazamiento perpetúa el conflicto. -->

### Explicación Pedagógica
El desplazamiento forzado en Colombia no es una consecuencia incidental del conflicto, sino un mecanismo central de despojo. Grupos armados desplazan poblaciones para apropiarse de tierras, lo que genera nuevos conflictos por la restitución. Entender esta circularidad es clave para analizar el conflicto colombiano.
...
- [ ] D) Porque el gobierno colombiano no colaboró con EE.UU. <!-- feedback: Incorrecto. Colombia ha colaborado extensamente en la guerra contra las drogas. -->

### Explicación Pedagógica
La guerra contra las drogas ha sido criticada por académicos y organismos internacionales por: (1) priorizar la persecución penal sobre la salud pública, (2) generar violencia al encarecer el negocio ilegal, (3) criminalizar a campesinos cultivadores sin afectar las estructuras financieras del narcotráfico. Colombia ha sido el principal laboratorio de esta política.
...
- [ ] D) La brecha digital se cerrará sola con el tiempo. <!-- feedback: Incorrecto. Sin políticas públicas, la brecha tiende a ampliarse. -->

### Explicación Pedagógica
La brecha digital es una dimensión más de la desigualdad. No se trata solo de tener o no internet, sino de las oportunidades que el acceso digital habilita: educación, empleo, servicios de salud, participación ciudadana. La globalización digital excluye a quienes no tienen conectividad, profundizando las brechas preexistentes.
...
- [ ] C) Si la paz es posible o no en Colombia. <!-- feedback: Incorrecto. Hay consenso en que la paz es posible; el debate es sobre el método. -->
- [ ] D) Si el gobierno debe usar solo la fuerza militar. <!-- feedback: Incorrecto. La Paz Total es precisamente una apuesta por la negociación. -->

### Explicación Pedagógica
La Paz Total plantea un dilema ético y estratégico: excluir a algunos grupos perpetúa la violencia, pero negociar con grupos criminales puede ser visto como concesión a la criminalidad.
...
- [ ] D) Los campesinos deben ser encarcelados.

### Explicación Pedagógica
Evaluar éticamente la política antinarcóticos implica considerar quién paga los costos. La erradicación forzada afecta desproporcionadamente a campesinos sin tierra, mientras los líderes de los carteles rara vez son capturados.
...
- [ ] D) Pedir al gobierno que compre todo lo que produzcan.

### Explicación Pedagógica
Diseñar alternativas a economías ilegales requiere pensamiento sistémico: hay que crear condiciones para que otras actividades sean viables. Los proyectos exitosos combinan análisis de mercado, diversificación productiva, organización comunitaria y acompañamiento técnico.
...
- [ ] D) Esperar a que el mercado corrija las desigualdades.

### Explicación Pedagógica
Crear políticas públicas requiere pensamiento multidimensional: (1) invertir en capacidades, (2) diversificar la economía, (3) proteger a los afectados mediante redistribución.
...
- [ ] D) Colombia no debe preocuparse por el cambio climático.

### Explicación Pedagógica
La justicia climática vincula cambio climático con desigualdad global. Países como Colombia sufren impactos severos sin tener la responsabilidad histórica ni los recursos para adaptarse.
