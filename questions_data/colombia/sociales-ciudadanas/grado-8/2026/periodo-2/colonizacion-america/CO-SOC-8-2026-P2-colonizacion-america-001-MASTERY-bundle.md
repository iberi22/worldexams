...
Este bundle cubre la colonización europea de América: la conquista, la organización de los virreinatos, los sistemas de explotación, el mestizaje, el impacto en las poblaciones indígenas y africanas, y las diferencias entre las colonizaciones española, portuguesa e inglesa. Alineado con los DBA de Ciencias Sociales para grado 8.
...
- [ ] D) Holanda <!-- feedback: Incorrecto. Holanda llegó más tarde. -->

### Explicación Pedagógica
El Tratado de Tordesillas (1494) dividió el mundo entre España y Portugal. España obtuvo la mayor parte de América, mientras Portugal recibió Brasil. Este acuerdo, supervisado por el Papa, definió la colonización de América durante el primer siglo.
...
- [ ] D) Un impuesto que los indígenas debían pagar al rey de España <!-- feedback: Incorrecto. Era un sistema de trabajo, no un impuesto. -->

### Explicación Pedagógica
La encomienda fue una institución clave de la colonización española. En teoría, el encomendero debía proteger y evangelizar a los indígenas a cambio de su trabajo. En la práctica, fue una forma de explotación laboral. La Corona intentó regularla con las Leyes Nuevas (1542), pero su aplicación fue limitada.
...
- [ ] D) Todos los indígenas murieron y no quedó ninguno <!-- feedback: Incorrecto. Millones sobrevivieron, aunque diezmados. -->

### Explicación Pedagógica
Los indígenas americanos no tenían defensas inmunológicas contra las enfermedades euroasiáticas (viruela, sarampión, gripe). Se estima que la población americana se redujo de unos 60 millones a menos de 10 millones en el primer siglo de contacto. En Colombia, epidemias diezmaron poblaciones enteras de los muiscas y taironas.
...
- [ ] D) Los territorios eran colonias independientes sin relación con España <!-- feedback: Incorrecto. Eran colonias dependientes de la Corona. -->

### Explicación Pedagógica
El territorio de la actual Colombia pertenecía al Virreinato de la Nueva Granada (creado en 1717), con capital en Santafé de Bogotá. Antes de eso, dependió del Virreinato del Perú. Las autoridades locales incluían gobernadores, corregidores y cabildos municipales. La Casa de Contratación (Sevilla) controlaba el comercio colonial.
...
- [ ] D) El intercambio de regalos entre reyes europeos <!-- feedback: Incorrecto. No era intercambio de regalos. -->

### Explicación Pedagógica
El comercio triangular conectaba tres continentes en un circuito de explotación. Barcos europeos llevaban armas y telas a África, donde intercambiaban por esclavizados. Estos eran transportados en condiciones inhumanas a América (el "pasaje medio") para trabajar en minas y plantaciones. Las materias primas (azúcar, oro, algodón) viajaban a Europa.
...
- [ ] D) La inglesa colonizó primero que la española <!-- feedback: Incorrecto. España colonizó un siglo antes. -->

### Explicación Pedagógica
España colonizó áreas densamente pobladas (México, Perú), creando una sociedad jerarquizada pero con mestizaje, y usando el trabajo indígena forzado. Inglaterra colonizó Norteamérica, donde la población indígena era más dispersa, estableciendo colonias de población blanca que desplazaban a los indígenas de sus tierras (frontera agrícola). Este modelo creó sociedades más segregadas.
...
- [ ] D) Una compañía naviera para transportar productos entre España y América <!-- feedback: Incorrecto. Era una expedición de conquista. -->

### Explicación Pedagógica
La conquista de Colombia fue realizada por varias expediciones: Gonzalo Jiménez de Quesada conquistó el territorio muisca (fundó Santafé de Bogotá), Sebastián de Belalcázar conquistó el suroccidente (Cali, Popayán) y Pedro de Heredia fundó Cartagena. Estas expediciones eran empresas privadas autorizadas por la Corona mediante "capitulaciones".
...
- [ ] D) Eran los dueños de las plantaciones y las minas <!-- feedback: Incorrecto. Los dueños eran españoles y criollos. -->

### Explicación Pedagógica
La esclavitud africana fue masiva en Colombia, especialmente en la minería del Chocó y Antioquia, y en la costa Pacífica. Cartagena fue el principal puerto de entrada de esclavizados. Los africanos trajeron conocimientos (minería, agricultura), música y tradiciones que hoy son parte fundamental de la cultura colombiana.
...
- [ ] D) Un tipo de agricultura sostenible practicada por los indígenas <!-- feedback: Incorrecto. No era sostenible ni indígena. -->

### Explicación Pedagógica
España extrajo inmensas riquezas de América: se estima que entre 1500 y 1800 llegaron a España 170 toneladas de oro y 86.000 de plata. Pero esta riqueza no se reinvirtió en las colonias para desarrollar industrias locales. Al contrario, las colonias tenían prohibido producir bienes manufacturados. Este modelo generó una dependencia económica que duraría siglos.
...
- [ ] D) Un fenómeno exclusivo de las colonias inglesas <!-- feedback: Incorrecto. Fue particularmente intenso en la América española. -->

### Explicación Pedagógica
El mestizaje en la América española fue mucho más intenso que en las colonias inglesas. El sistema de castas clasificaba a la población según su mezcla racial: mestizo (español+indígena), mulato (español+africano), zambo (indígena+africano), etc. Aunque había discriminación, el mestizaje creó sociedades sincréticas en lo cultural, religioso y lingüístico.
...
- [ ] D) Un tipo de embarcación utilizada para transportar esclavos <!-- feedback: Incorrecto. Es lo opuesto: era un espacio de libertad. -->

### Explicación Pedagógica
San Basilio de Palenque, fundado por Benkos Biohó hacia 1600, fue el primer pueblo libre de América. Los cimarrones escapaban de Cartagena y fundaban palenques en las zonas selváticas. La UNESCO declaró a San Basilio de Palenque Obra Maestra del Patrimonio Oral e Inmaterial de la Humanidad. El palenquero es la única lengua criolla de base española que sobrevive en América.
...
- [ ] D) Solo introdujeron algunas plantas ornamentales sin consecuencias <!-- feedback: Incorrecto. Los cambios fueron masivos y profundos. -->

### Explicación Pedagógica
El "Intercambio Colombino" (término acuñado por Alfred Crosby) transformó radicalmente los ecosistemas americanos. Animales como el caballo y la vaca cambiaron los paisajes. Plantas como la caña de azúcar y el trigo se expandieron. La minería con mercurio contaminó ríos y suelos. En Colombia, las especies introducidas desplazaron a muchas especies nativas.
...
- [ ] D) Un sistema de becas para que los indígenas estudiaran en universidades coloniales <!-- feedback: Incorrecto. No era educativo. -->

### Explicación Pedagógica
El tributo indígena era la principal forma de integración de los indígenas al sistema colonial. A cambio del tributo, la Corona otorgaba a los indígenas "protección" y la propiedad comunal de sus tierras (resguardos). Los resguardos sobreviven hoy como territorios colectivos de comunidades indígenas, una institución colonial que se mantiene en la Colombia actual.
...
- [ ] D) La colonización debe juzgarse con los valores de hoy y condenarse sin matices <!-- feedback: Incorrecto. El análisis histórico requiere contextualización. -->

### Explicación Pedagógica
Evaluar la colonización es un ejercicio histórico complejo. Por un lado, fue un proceso brutal que causó un daño inmenso. Por otro, de ese encuentro forzado surgieron nuevas realidades: el español latinoamericano, la gastronomía mestiza (arepa, sancocho, bandeja paisa), la música (cumbia, vallenato), las religiones sincréticas, y nuevas identidades. La clave está en entender el proceso sin caer en apologías ni condenas simplistas.

---

## Question 15 (Mastery - Difficulty D9)

**ID:** `CO-SOC-8-2026-P2-colonizacion-america-001-MASTERY-v15`
**Bloom:** Evaluate
**ICFES:** Pensamiento reflexivo y sistémico
...
- [ ] D) Que el debate sobre los derechos indígenas resolvió todos los problemas de la colonización <!-- feedback: Incorrecto. El debate no impidió los abusos. -->

### Explicación Pedagógica
La "Junta de Valladolid" (1550-1551) enfrentó a Bartolomé de las Casas (defensor de los indígenas) y Juan Ginés de Sepúlveda (quien justificaba la conquista). Este debate, aunque no detuvo los abusos, reconoció a los indígenas como seres humanos con derechos, algo único en la historia de la colonización europea. La Corona española promulgó las Leyes Nuevas (1542) para proteger a los indígenas, aunque su aplicación fue limitada. Esta tensión entre valores e intereses sigue siendo relevante hoy.
