...
tema: "organizacion-colonial-social"
periodo: 2
...
Este bundle cubre la organización social durante la Colonia en Colombia: las castas, el sistema de encomiendas, la esclavitud africana, la vida cotidiana de los diferentes grupos sociales y las instituciones coloniales. Contenido del segundo periodo para grado 4.
...
- [ ] D) Zambos. <!-- feedback: Incorrecto. Los zambos eran hijos de indígena y africano. -->

### Explicación Pedagógica
Se evalúa el conocimiento de la clasificación de castas en la Colonia. La respuesta correcta identifica al mestizo. Los errores comunes surgen de confundir las diferentes categorías del sistema de castas.
...
- [ ] D) El capitalismo. <!-- feedback: Incorrecto. El capitalismo es un sistema económico moderno, no existía en la Colonia. -->

### Explicación Pedagógica
Se evalúa el conocimiento del sistema de trabajo colonial. La respuesta correcta identifica la encomienda. El error común es confundir la encomienda (con indígenas) con la esclavitud (con africanos).
...
- [ ] D) Tumaco. <!-- feedback: Incorrecto. Tumaco es un puerto del Pacífico y no tuvo el volumen de comercio esclavista de Cartagena. -->

### Explicación Pedagógica
Se evalúa el conocimiento sobre la trata de esclavos en Colombia. La respuesta correcta identifica a Cartagena como puerto de entrada. El error común es no asociar la esclavitud con el Caribe colombiano.
...
- [ ] D) Los indígenas no querían independizarse. <!-- feedback: Incorrecto. Hubo muchas rebeliones indígenas durante la Colonia, como la de los Comuneros. -->

### Explicación Pedagógica
Se evalúa la comprensión de las razones de la permanencia del dominio colonial. La respuesta correcta destaca el control español. El error común es minimizar la capacidad de control del imperio español.
...
- [ ] D) Un banco y una biblioteca pública. <!-- feedback: Incorrecto. Aunque podía haber bibliotecas en conventos, no formaban parte del diseño obligatorio de la plaza. -->

### Explicación Pedagógica
Se evalúa la capacidad de reconstruir el paisaje urbano colonial. La respuesta correcta describe los edificios institucionales de la plaza. Los errores comunes son proyectar elementos urbanos modernos al pasado.
...
- [ ] D) Contents porque no querían gobernar. <!-- feedback: Incorrecto. Muchos criollos sí querían gobernar y lideraron los movimientos de independencia. -->

### Explicación Pedagógica
Se evalúa la comprensión de las tensiones sociales que llevaron a la independencia. La respuesta correcta identifica el descontento criollo. El error común es no entender que los criollos estaban en una posición contradictoria.
...
- [ ] D) Peninsular. <!-- feedback: Incorrecto. Peninsular era quien había nacido en España, no en América. -->

### Explicación Pedagógica
Se evalúa la capacidad de aplicar la clasificación social colonial. La respuesta correcta identifica al criollo. El error común es confundir el lugar de nacimiento de los padres con el lugar de nacimiento propio.
...
- [ ] D) El uso del tinto o café en las mañanas. <!-- feedback: Incorrecto. El café llegó a Colombia después de la Colonia y no es de origen africano. -->

### Explicación Pedagógica
Se evalúa la capacidad de identificar el legado cultural africano en Colombia. La respuesta correcta reconoce las expresiones musicales y culinarias de origen africano. El error común es no reconocer la influencia africana en la cultura colombiana.
...
- [ ] D) En esas regiones no llovía, lo que facilitaba la extracción. <!-- feedback: Incorrecto. En el Chocó llueve mucho; la minería se hacía en ríos y lavaderos. -->

### Explicación Pedagógica
Se evalúa la capacidad de relacionar la geografía con la economía colonial. La respuesta correcta asocia la minería con la disponibilidad de oro y mano de obra esclava. El error común es ignorar el papel del trabajo esclavo en las minas.
...
- [ ] D) Es correcta porque no existían los celulares que causan peleas. <!-- feedback: Incorrecto. La violencia y la explotación existían mucho antes de la tecnología moderna. -->

### Explicación Pedagógica
Se evalúa la capacidad de analizar críticamente el período colonial. La respuesta correcta reconoce que la Colonia fue un período de profundas injusticias. El error común es idealizar el pasado colonial o minimizar la violencia estructural de la época.

### Explicación Pedagógica Final
Este bundle de Ciencias Sociales y Ciudadanas para grado cuarto cubre la organización social de la Colonia en Colombia. Evalúa el conocimiento del sistema de castas (peninsulares, criollos, mestizos, mulatos, zambos), la institución de la encomienda, la esclavitud africana en Cartagena, el descontento criollo, el legado cultural africano, la minería como actividad económica y el análisis crítico de la convivencia colonial. El objetivo es que los estudiantes comprendan la estructura social desigual de la Colonia y cómo sus efectos aún se sienten en la sociedad colombiana actual.
