...
Este bundle cubre los símbolos patrios de Colombia: la bandera, el escudo y el himno nacional, su historia, significado y el respeto que merecen. Contenido del tercer periodo según DBA MEN para grado 4.
...
- [ ] D) Verde, blanco y rojo. <!-- feedback: Incorrecto. Esos son los colores de la bandera de México, no de Colombia. -->

### Explicación Pedagógica
Se evalúa el conocimiento básico de los colores de la bandera colombiana. La respuesta correcta describe la disposición correcta. Los errores comunes confunden la bandera de Colombia con la de otros países.
...
- [ ] D) Colombia Tierra Querida. <!-- feedback: Incorrecto. Ese es el título de un pasillo instrumental de Lucho Bermúdez, no el himno nacional. -->

### Explicación Pedagógica
Se evalúa el conocimiento del nombre oficial del himno nacional. La respuesta correcta identifica su denominación oficial. El error común es confundir el himno con otras canciones patrióticas.
...
- [ ] D) Una naranja. <!-- feedback: Incorrecto. La naranja no es el fruto que aparece en el escudo. -->

### Explicación Pedagógica
Se evalúa el conocimiento de los elementos del escudo nacional. La respuesta correcta identifica la granada. El error común es no conocer los elementos específicos del escudo.
...
- [ ] D) La paz de la nación. <!-- feedback: Incorrecto. El color amarillo no representa la paz en el simbolismo de la bandera. -->

### Explicación Pedagógica
Se evalúa la comprensión del simbolismo de los colores patrios. La respuesta correcta asocia el amarillo con la riqueza. Los errores comunes confunden el significado de los diferentes colores.
...
- [ ] D) Salir corriendo al descanso. <!-- feedback: Incorrecto. Salir durante la interpretación del himno es una falta de respeto. -->

### Explicación Pedagógica
Se evalúa la aplicación de las normas de protocolo con los símbolos patrios. La respuesta correcta describe el comportamiento adecuado. El error común es no saber cómo comportarse en los actos cívicos.
...
- [ ] D) José Asunción Silva. <!-- feedback: Incorrecto. Silva fue un poeta colombiano, pero no el autor de la letra del himno nacional. -->

### Explicación Pedagógica
Se evalúa el conocimiento de los autores del himno nacional. La respuesta correcta identifica a Rafael Núñez. El error común es atribuir la autoría a personajes históricos famosos pero equivocados.
...
- [ ] D) Un loro — simboliza la alegría del pueblo colombiano. <!-- feedback: Incorrecto. El loro no aparece en el escudo nacional. -->

### Explicación Pedagógica
Se evalúa el conocimiento del escudo nacional. La respuesta correcta identifica el cóndor y su simbolismo. El error común es no conocer los elementos del escudo o su significado.
...
- [ ] D) Porque el presidente así lo ordenó. <!-- feedback: Incorrecto. El respeto a los símbolos no se basa en órdenes presidenciales sino en lo que representan. -->

### Explicación Pedagógica
Se evalúa la comprensión del significado de los símbolos patrios. La respuesta correcta destaca su valor histórico y de identidad nacional. El error común es pensar que el respeto se basa en razones superficiales o autoritarias.
...
- [ ] D) 1900, a principios del siglo XX. <!-- feedback: Incorrecto. Para 1900 la bandera ya existía desde hacía casi un siglo. -->

### Explicación Pedagógica
Se evalúa el conocimiento del origen histórico de la bandera. La respuesta correcta la sitúa en el contexto de la Gran Colombia. El error común es no ubicar temporalmente el origen de los símbolos patrios.
...
- [ ] D) El sombrero vueltiao. <!-- feedback: Incorrecto. El sombrero vueltiao es un símbolo cultural de la región Caribe, pero no es un símbolo patrio oficial de Colombia. -->

### Explicación Pedagógica
Se evalúa el conocimiento de los símbolos patrios adicionales. La respuesta correcta identifica el árbol nacional. Los errores comunes confunden símbolos culturales o populares con símbolos patrios oficiales.

### Explicación Pedagógica Final
Este bundle de Ciencias Sociales y Ciudadanas para grado cuarto cubre los Símbolos Patrios de Colombia. Evalúa el conocimiento sobre la bandera (colores, orden, significado), el escudo (cóndor, granada, elementos), el himno nacional (autores, protocolo), el origen histórico de los símbolos en la Gran Colombia, y otros símbolos como la palma de cera. El objetivo es que los estudiantes conozcan, respeten y valoren los símbolos que representan la identidad nacional colombiana.
