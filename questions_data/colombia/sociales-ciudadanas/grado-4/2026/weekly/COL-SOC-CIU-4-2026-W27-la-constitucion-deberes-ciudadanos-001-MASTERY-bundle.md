...
tema: "la-constitucion-deberes-ciudadanos"
periodo: "W27"
...
Este bundle explica los deberes de los ciudadanos colombianos según la Constitución Política de 1991.
...
- [ ] D) Juegos que debemos practicar. <!-- feedback: Incorrecto. No son actividades recreativas. -->

### Explicación Pedagógica
[Remember] Recordar qué son los deberes ciudadanos.
...
- [ ] D) Prestar servicio militar. <!-- feedback: Es un deber, pero no el primero. -->

### Explicación Pedagógica
[Remember] Recordar el deber principal de los colombianos.
...
- [ ] D) Solo los deberes importan. <!-- feedback: Incorrecto. Ambos son fundamentales. -->

### Explicación Pedagógica
[Understand] Comprender la relación entre derechos y deberes.
...
- [ ] D) Que no hay límites para nuestros derechos. <!-- feedback: Incorrecto. Sí hay límites. -->

### Explicación Pedagógica
[Understand] Comprender el deber de respetar los derechos ajenos.
...
- [ ] D) Cuidar solamente las mascotas. <!-- feedback: Incorrecto. El deber principal es educativo. -->

### Explicación Pedagógica
[Apply] Aplicar conocimiento sobre el deber de estudiar.
...
- [ ] D) Pagar impuestos es opcional. <!-- feedback: Incorrecto. Es un deber constitucional. -->

### Explicación Pedagógica
[Apply] Aplicar conocimiento sobre el deber de contribuir con los impuestos.
...
- [ ] D) Pierde la nacionalidad. <!-- feedback: Incorrecto. La nacionalidad no se pierde por incumplir deberes. -->

### Explicación Pedagógica
[Analyze] Analizar las consecuencias de incumplir los deberes.
...
- [ ] D) Que podemos destruir lo público porque no es nuestro. <!-- feedback: Incorrecto. Lo público es de todos. -->

### Explicación Pedagógica
[Analyze] Analizar el deber de proteger el patrimonio cultural y natural.
...
- [ ] D) No hay deberes que cumplir. <!-- feedback: Incorrecto. La Constitución establece varios deberes. -->

### Explicación Pedagógica
[Evaluate] Evaluar el cumplimiento de deberes ciudadanos en Colombia.
...
- [ ] D) Una cartelera que diga "No hay deberes". <!-- feedback: Incorrecto. Todos tenemos deberes. -->

### Explicación Pedagógica
[Create] Crear una cartelera escolar sobre deberes ciudadanos.
