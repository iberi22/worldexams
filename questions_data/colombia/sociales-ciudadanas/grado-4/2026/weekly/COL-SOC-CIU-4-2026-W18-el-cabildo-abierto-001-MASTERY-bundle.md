...
Este bundle explica qué es el cabildo abierto, cómo funciona y por qué es importante para la participación ciudadana.
...
- [ ] D) Un programa de televisión. <!-- feedback: Incorrecto. No es un programa. -->

### Explicación Pedagógica
[Remember] Recordar qué es un cabildo abierto.
...
- [ ] D) Solo los periodistas. <!-- feedback: Incorrecto. Pueden asistir pero no exclusivamente. -->

### Explicación Pedagógica
[Remember] Recordar quiénes pueden participar en un cabildo abierto.
...
- [ ] D) El cabildo abierto se hace en otro municipio. <!-- feedback: Incorrecto. Se hace en el mismo municipio. -->

### Explicación Pedagógica
[Understand] Comprender la diferencia entre cabildo abierto y sesión ordinaria.
...
- [ ] D) Problemas de otros países. <!-- feedback: Incorrecto. Son temas locales. -->

### Explicación Pedagógica
[Understand] Comprender qué temas se tratan en los cabildos abiertos.
...
- [ ] D) Solo los candidatos políticos. <!-- feedback: Incorrecto. Cualquier ciudadano puede hacerlo. -->

### Explicación Pedagógica
[Apply] Aplicar conocimiento sobre cómo solicitar un cabildo abierto.
...
- [ ] D) Eligiendo un dictador. <!-- feedback: Incorrecto. Es un mecanismo democrático. -->

### Explicación Pedagógica
[Apply] Aplicar el concepto de cabildo abierto en el ámbito escolar.
...
- [ ] D) No es importante. <!-- feedback: Incorrecto. Es un mecanismo fundamental de participación. -->

### Explicación Pedagógica
[Analyze] Analizar la importancia del cabildo abierto en la democracia local.
...
- [ ] D) Que solo hablen los políticos. <!-- feedback: Incorrecto. En el cabildo abierto los ciudadanos tienen la palabra. -->

### Explicación Pedagógica
[Analyze] Analizar las condiciones para un cabildo abierto efectivo.
...
- [ ] D) No deberían participar porque los concejales ya saben qué hacer. <!-- feedback: Incorrecto. La participación ciudadana enriquece las decisiones. -->

### Explicación Pedagógica
[Evaluate] Evaluar la participación ciudadana en los cabildos abiertos.
...
- [ ] D) Un dibujo sin texto. <!-- feedback: Incorrecto. Debe tener información clara. -->

### Explicación Pedagógica
[Create] Crear un material de difusión para un cabildo abierto.
