...
rubric_baseline: "Repaso P6: Constitución y ramas del poder público"
license: "FREE"
tier: "legacy"
...
Repaso de la Constitución Política, derechos, deberes y las tres ramas del poder público.
...
- [ ] D) Una sola: el presidente. <!-- feedback: Incorrecto. El poder está dividido. -->

### Explicación Pedagógica
[Remember] Recordar las tres ramas del poder público.
...
- [ ] D) Derechos que se pueden comprar. <!-- feedback: Incorrecto. No se compran. -->

### Explicación Pedagógica
[Understand] Comprender qué son los derechos fundamentales.
...
- [ ] D) Comprar en el comercio local. <!-- feedback: Incorrecto. No es un deber constitucional. -->

### Explicación Pedagógica
[Understand] Comprender un ejemplo de deber ciudadano.
...
- [ ] D) Derecho a la propiedad. <!-- feedback: Incorrecto. No es un tema de propiedad. -->

### Explicación Pedagógica
[Apply] Aplicar el conocimiento de los derechos a una situación concreta.
...
- [ ] D) Rama Electoral. <!-- feedback: Incorrecto. La Electoral organiza elecciones. -->

### Explicación Pedagógica
[Apply] Aplicar el conocimiento de las ramas a una situación real.
...
- [ ] D) Porque los derechos se pueden cambiar cada año. <!-- feedback: Incorrecto. Los derechos son estables. -->

### Explicación Pedagógica
[Analyze] Analizar por qué la Constitución de 1991 es una Constitución de derechos.
...
- [ ] D) Nadie puede hacer nada. <!-- feedback: Incorrecto. Hay mecanismos de control. -->

### Explicación Pedagógica
[Analyze] Analizar el control constitucional sobre los actos del Ejecutivo.
...
- [ ] D) Es importante solo para los presidentes. <!-- feedback: Incorrecto. Es importante para todos. -->

### Explicación Pedagógica
[Evaluate] Evaluar la importancia de la Constitución en la vida cotidiana.
...
- [ ] D) Las canciones favoritas del salón. <!-- feedback: Incorrecto. No es parte de una constitución. -->

### Explicación Pedagógica
[Create] Crear una mini constitución para el salón de clases.

---

### Explicación Pedagógica Final
Este bundle de Ciencias Sociales y Ciudadanas para grado cuarto, W30, repasa la Constitución y las ramas del poder público.
