...
tema: "relieve-colombiano-montanas-llanuras-costas"
periodo: "W35"
...
Este bundle explica las principales formas del relieve colombiano: las tres cordilleras, las llanuras, los valles y las costas.
...
- [ ] D) Cuatro cordilleras. <!-- feedback: Incorrecto. Son tres. -->

### Explicación Pedagógica
[Remember] Recordar las tres cordilleras de Colombia.
...
- [ ] D) En la Sierra Nevada de Santa Marta. <!-- feedback: Incorrecto. Esa es una montaña, no una llanura. -->

### Explicación Pedagógica
[Remember] Recordar dónde están las llanuras más extensas.
...
- [ ] D) Es una llanura extensa. <!-- feedback: Incorrecto. Es una montaña. -->

### Explicación Pedagógica
[Understand] Comprender la singularidad geográfica de la Sierra Nevada.
...
- [ ] D) Valle de la Muerte y Valle de los Reyes. <!-- feedback: Incorrecto. No están en Colombia. -->

### Explicación Pedagógica
[Understand] Comprender la formación de los valles interandinos.
...
- [ ] D) El Volcán Galeras. <!-- feedback: Incorrecto. El Galeras está en Nariño pero no es el más alto. -->

### Explicación Pedagógica
[Apply] Aplicar conocimiento sobre los picos más altos de Colombia.
...
- [ ] D) Glaciares y nieves perpetuas. <!-- feedback: Incorrecto. Eso es en alta montaña. -->

### Explicación Pedagógica
[Apply] Aplicar conocimiento sobre el relieve costero colombiano.
...
- [ ] D) Solo afecta los deportes de montaña. <!-- feedback: Incorrecto. Los efectos son mucho más amplios. -->

### Explicación Pedagógica
[Analyze] Analizar la influencia del relieve en la vida de los colombianos.
...
- [ ] D) En la isla de San Andrés. <!-- feedback: Incorrecto. No hay volcanes en San Andrés. -->

### Explicación Pedagógica
[Analyze] Analizar la ubicación de los volcanes colombianos.
...
- [ ] D) Ninguno es bueno para vivir. <!-- feedback: Incorrecto. Colombia es habitable en todas sus regiones. -->

### Explicación Pedagógica
[Evaluate] Evaluar las ventajas y desventajas de vivir en diferentes relieves.
...
- [ ] D) Las capitales de los departamentos. <!-- feedback: Incorrecto. Eso sería un mapa político. -->

### Explicación Pedagógica
[Create] Crear un mapa didáctico del relieve colombiano.
