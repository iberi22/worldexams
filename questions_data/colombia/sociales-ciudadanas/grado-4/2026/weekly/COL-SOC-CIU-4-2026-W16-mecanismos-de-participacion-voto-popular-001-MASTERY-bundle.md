...
tema: "mecanismos-de-participacion-voto-popular"
periodo: "W16"
...
Este bundle explica el voto popular como mecanismo de participación ciudadana en Colombia.
...
- [ ] D) Una multa por no cumplir las normas. <!-- feedback: Incorrecto. No es una sanción. -->

### Explicación Pedagógica
[Remember] Recordar qué es el voto popular.
...
- [ ] D) Los niños de 10 años. <!-- feedback: Incorrecto. Los niños no pueden votar. -->

### Explicación Pedagógica
[Remember] Recordar quiénes tienen derecho al voto.
...
- [ ] D) No es importante. <!-- feedback: Incorrecto. Es fundamental para la democracia. -->

### Explicación Pedagógica
[Understand] Comprender la importancia del voto en la democracia.
...
- [ ] D) Que el presidente sabe por quién votaste. <!-- feedback: Incorrecto. El voto es secreto precisamente para evitar presiones. -->

### Explicación Pedagógica
[Understand] Comprender el principio del voto secreto.
...
- [ ] D) Cada 6 años. <!-- feedback: Incorrecto. Anteriormente era cada 6 años, ahora son 4. -->

### Explicación Pedagógica
[Apply] Aplicar conocimiento sobre la periodicidad de las elecciones.
...
- [ ] D) Un formulario de impuestos. <!-- feedback: Incorrecto. No tiene que ver con impuestos. -->

### Explicación Pedagógica
[Apply] Aplicar conocimiento sobre el tarjetón electoral.
...
- [ ] D) Que se votó por todos los candidatos. <!-- feedback: Incorrecto. No se puede votar por todos. -->

### Explicación Pedagógica
[Analyze] Analizar el significado del voto en blanco.
...
- [ ] D) Pagando por votos. <!-- feedback: Incorrecto. Eso es ilegal. -->

### Explicación Pedagógica
[Analyze] Analizar formas de participación juvenil en los procesos electorales.
...
- [ ] D) No es ni derecho ni deber. <!-- feedback: Incorrecto. La Constitución lo define claramente. -->

### Explicación Pedagógica
[Evaluate] Evaluar el voto como derecho y deber ciudadano.
...
- [ ] D) Ofrecer dinero por votar. <!-- feedback: Incorrecto. Comprar votos es un delito electoral. -->

### Explicación Pedagógica
[Create] Crear una campaña de motivación al voto.
