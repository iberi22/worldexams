...
rubric_baseline: "Repaso P4: mecanismos de participación ciudadana"
---

# Bundle Mastery: Repaso P4 — Mecanismos de participación ciudadana

Repaso de los mecanismos de participación: voto, plebiscito, referendo, consulta popular, cabildo abierto e iniciativa legislativa.
...
- [ ] D) Comprar en el mercado. <!-- feedback: Incorrecto. Comprar es un acto comercial. -->

### Explicación Pedagógica
[Remember] Recordar los mecanismos de participación ciudadana.
...
- [x] D) La televisión. <!-- feedback: Correcto. Ver televisión no es un mecanismo de participación ciudadana. -->

### Explicación Pedagógica
[Remember] Recordar los mecanismos vs. actividades cotidianas.
...
- [ ] D) El plebiscito elige personas y el voto consulta. <!-- feedback: Incorrecto. Es al revés. -->

### Explicación Pedagógica
[Understand] Comprender la diferencia entre voto y plebiscito.
...
- [ ] D) Para cobrar impuestos. <!-- feedback: Incorrecto. No es una instancia tributaria. -->

### Explicación Pedagógica
[Understand] Comprender la función del cabildo abierto.
...
- [ ] D) Plebiscito. <!-- feedback: Incorrecto. El plebiscito es para consultar decisiones del gobierno. -->

### Explicación Pedagógica
[Apply] Aplicar el mecanismo adecuado según la necesidad.
...
- [ ] D) Referendo. <!-- feedback: Incorrecto. El referendo es para leyes o reformas. -->

### Explicación Pedagógica
[Apply] Aplicar la consulta popular en un tema local.
...
- [ ] D) Porque solo los políticos pueden usarlos. <!-- feedback: Incorrecto. Son derechos de todos los ciudadanos. -->

### Explicación Pedagógica
[Analyze] Analizar las causas de la baja participación ciudadana.
...
- [ ] D) Iniciativa legislativa. <!-- feedback: Incorrecto. La iniciativa es para proponer leyes, no para aprobar reformas constitucionales. -->

### Explicación Pedagógica
[Analyze] Analizar qué mecanismo corresponde a una reforma constitucional.
...
- [ ] D) La participación solo es importante cada 4 años. <!-- feedback: Incorrecto. La participación debe ser constante. -->

### Explicación Pedagógica
[Evaluate] Evaluar el impacto de la participación ciudadana en la democracia.
...
- [ ] D) Un examen escrito sobre democracia. <!-- feedback: Incorrecto. Una actividad práctica es más efectiva que un examen. -->

### Explicación Pedagógica
[Create] Crear una actividad lúdica para promover la participación democrática.

---

### Explicación Pedagógica Final
Este bundle de Ciencias Sociales y Ciudadanas para grado cuarto, W20, repasa los mecanismos de participación ciudadana.
