...
tema: "ramas-del-poder-publico-ejecutiva"
periodo: "W28"
...
Este bundle explica la Rama Ejecutiva del poder público en Colombia.
...
- [ ] D) El alcalde de Bogotá. <!-- feedback: Incorrecto. Es una autoridad local. -->

### Explicación Pedagógica
[Remember] Recordar quién encabeza la Rama Ejecutiva.
...
- [ ] D) Elegir a los senadores. <!-- feedback: Incorrecto. Los senadores son elegidos por voto popular. -->

### Explicación Pedagógica
[Remember] Recordar la función principal del presidente.
...
- [ ] D) Tribunales de justicia. <!-- feedback: Incorrecto. No son órganos judiciales. -->

### Explicación Pedagógica
[Understand] Comprender las funciones de los ministerios.
...
- [ ] D) El presidente. <!-- feedback: Incorrecto. El presidente es nacional. -->

### Explicación Pedagógica
[Understand] Comprender la autoridad ejecutiva departamental.
...
- [ ] D) El personero. <!-- feedback: Incorrecto. El personero vigila la gestión pública. -->

### Explicación Pedagógica
[Apply] Aplicar conocimiento sobre la autoridad municipal.
...
- [ ] D) Juzgar delitos. <!-- feedback: Incorrecto. Es función de los jueces. -->

### Explicación Pedagógica
[Apply] Aplicar conocimiento sobre las funciones del alcalde.
...
- [ ] D) Porque las leyes se hacen solas. <!-- feedback: Incorrecto. Las leyes requieren un proceso legislativo. -->

### Explicación Pedagógica
[Analyze] Analizar la separación de poderes entre el Ejecutivo y el Legislativo.
...
- [ ] D) Solo el nivel nacional debería existir. <!-- feedback: Incorrecto. Los niveles locales son importantes. -->

### Explicación Pedagógica
[Analyze] Analizar la organización territorial de la Rama Ejecutiva.
...
- [ ] D) La rendición de cuentas es opcional. <!-- feedback: Incorrecto. Es una obligación legal. -->

### Explicación Pedagógica
[Evaluate] Evaluar la importancia de la rendición de cuentas.
...
- [ ] D) Prometer dinero a los estudiantes. <!-- feedback: Incorrecto. No se puede prometer dinero. -->

### Explicación Pedagógica
[Create] Crear propuestas de liderazgo estudiantil.
