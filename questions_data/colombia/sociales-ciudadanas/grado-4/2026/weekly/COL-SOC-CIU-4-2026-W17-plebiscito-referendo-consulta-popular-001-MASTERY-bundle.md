...
tema: "plebiscito-referendo-consulta-popular"
periodo: "W17"
...
Este bundle explica tres mecanismos de participación: plebiscito, referendo y consulta popular.
...
- [ ] D) Un tipo de impuesto. <!-- feedback: Incorrecto. No es un impuesto. -->

### Explicación Pedagógica
[Remember] Recordar qué es un plebiscito.
...
- [ ] D) Un tipo de moneda. <!-- feedback: Incorrecto. No es una moneda. -->

### Explicación Pedagógica
[Remember] Recordar qué es un referendo.
...
- [ ] D) El plebiscito es solo para niños. <!-- feedback: Incorrecto. Todos los ciudadanos participan. -->

### Explicación Pedagógica
[Understand] Comprender la diferencia entre plebiscito y referendo.
...
- [ ] D) Un examen en las escuelas. <!-- feedback: Incorrecto. No es académico. -->

### Explicación Pedagógica
[Understand] Comprender qué es la consulta popular.
...
- [ ] D) El gerente de un banco. <!-- feedback: Incorrecto. No tiene esa facultad. -->

### Explicación Pedagógica
[Apply] Aplicar conocimiento sobre quién puede convocar consultas populares locales.
...
- [ ] D) La construcción de una carretera. <!-- feedback: Incorrecto. Fue una decisión política importante. -->

### Explicación Pedagógica
[Apply] Aplicar conocimiento histórico sobre el plebiscito de 1957.
...
- [ ] D) Que solo aplica en algunas regiones. <!-- feedback: Incorrecto. Aplica donde se realizó. -->

### Explicación Pedagógica
[Analyze] Analizar el significado de un resultado vinculante.
...
- [ ] D) No son importantes. <!-- feedback: Incorrecto. Son fundamentales. -->

### Explicación Pedagógica
[Analyze] Analizar la importancia de los mecanismos de participación directa.
...
- [ ] D) Solo si pagan. <!-- feedback: Incorrecto. La participación es un derecho, no un servicio pago. -->

### Explicación Pedagógica
[Evaluate] Evaluar el equilibrio entre democracia directa y representativa.
...
- [ ] D) ¿Deberíamos cambiar el nombre del colegio? <!-- feedback: Incorrecto. Aunque es local, debe ser un tema de interés general. -->

### Explicación Pedagógica
[Create] Crear una propuesta de consulta popular municipal.
