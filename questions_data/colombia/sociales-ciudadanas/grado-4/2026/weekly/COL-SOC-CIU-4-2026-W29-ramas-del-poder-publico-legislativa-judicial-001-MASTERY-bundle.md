...
tema: "ramas-del-poder-publico-legislativa-judicial"
periodo: "W29"
...
Este bundle explica la Rama Legislativa (Congreso) y la Rama Judicial (jueces y cortes) en Colombia.
...
- [ ] D) Administrar los municipios. <!-- feedback: Incorrecto. Es función del Ejecutivo local. -->

### Explicación Pedagógica
[Remember] Recordar la función de la Rama Legislativa.
...
- [ ] D) Recolectar impuestos. <!-- feedback: Incorrecto. Es función del Ejecutivo. -->

### Explicación Pedagógica
[Remember] Recordar la función de la Rama Judicial.
...
- [ ] D) La Corte Suprema. <!-- feedback: Incorrecto. Esa es judicial. -->

### Explicación Pedagógica
[Understand] Comprender que el Congreso ejerce la Rama Legislativa.
...
- [ ] D) Alcaldía y Gobernación. <!-- feedback: Incorrecto. Esas son del Ejecutivo local. -->

### Explicación Pedagógica
[Understand] Comprender la estructura bicameral del Congreso.
...
- [ ] D) La Inspección de Policía. <!-- feedback: Incorrecto. Es una autoridad de control. -->

### Explicación Pedagógica
[Apply] Aplicar el concepto de Legislativo a nivel local.
...
- [ ] D) Alcaldías y Gobernaciones. <!-- feedback: Incorrecto. Son del Ejecutivo local. -->

### Explicación Pedagógica
[Apply] Aplicar conocimiento sobre las altas cortes colombianas.
...
- [ ] D) Porque los jueces son más sabios. <!-- feedback: Incorrecto. Es un mecanismo de control constitucional. -->

### Explicación Pedagógica
[Analyze] Analizar el control constitucional de las leyes.
...
- [ ] D) Porque el presidente puede ordenar sentencias. <!-- feedback: Incorrecto. Eso sería inconstitucional. -->

### Explicación Pedagógica
[Analyze] Analizar la importancia de la independencia judicial.
...
- [ ] D) No existen las tres ramas. <!-- feedback: Incorrecto. La Constitución las establece. -->

### Explicación Pedagógica
[Evaluate] Evaluar el funcionamiento del equilibrio de poderes.
...
- [ ] D) Los profesores hacen todo. <!-- feedback: Incorrecto. No es equilibrado. -->

### Explicación Pedagógica
[Create] Crear una distribución de poderes para el colegio.
