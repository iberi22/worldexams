...
tema: "organizacion-territorial-veredas-corregimientos-municipios"
periodo: "W08"
...
- [ ] D) Un departamento rural. <!-- feedback: El departamento contiene municipios. -->

### Explicación Pedagógica
Se evalúa [Remember] con el tema de la pregunta.
...
- [ ] D) Es la capital del departamento. <!-- feedback: Las capitales son ciudades. -->
...
- [ ] D) Corregimiento, vereda, municipio. <!-- feedback: La vereda es menor que el corregimiento. -->

### Explicación Pedagógica
Se evalúa [Understand] con el tema de la pregunta.
...
- [x] D) Para administrar mejor cada zona según sus características. <!-- feedback: La división facilita la administración. -->
...
- [ ] D) Al departamento directamente. <!-- feedback: El departamento no administra veredas directamente. -->

### Explicación Pedagógica
Se evalúa [Apply] con el tema de la pregunta.
...
- [ ] D) 100 veredas exactamente. <!-- feedback: No hay un número exacto. -->
...
- [ ] D) Todas son capitales de municipio. <!-- feedback: Las veredas no son capitales. -->

### Explicación Pedagógica
Se evalúa [Analyze] con el tema de la pregunta.
...
- [x] D) El tamaño de su población rural concentrada y la necesidad de servicios. <!-- feedback: Los corregimientos surgen donde hay población concentrada. -->
...
- [ ] D) Para que los gobernadores tengan trabajo. <!-- feedback: Los gobernadores son departamentales. -->

### Explicación Pedagógica
Se evalúa [Evaluate] con el tema de la pregunta.
...
- [ ] D) Pedírselo al gobernador de otro departamento. <!-- feedback: Deben acudir a su propio municipio. -->

### Explicación Pedagógica
Se evalúa [Create] con el tema de la pregunta.
