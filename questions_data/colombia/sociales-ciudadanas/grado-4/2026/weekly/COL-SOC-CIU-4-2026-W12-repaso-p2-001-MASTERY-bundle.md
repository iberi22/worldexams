...
rubric_baseline: "Repaso del segundo período: organización territorial, departamentos y capitales"
license: "FREE"
tier: "legacy"
...
- [ ] D) El corregimiento. <!-- feedback: Tiene centro poblado. -->
...
- [ ] D) Corregimiento solo en costa. <!-- feedback: En todo el país. -->

### Explicación Pedagógica
Se evalúa [Understand].
...
- [x] D) Para descentralizar la administración y atender mejor las regiones. <!-- feedback: Mejor administración regional. -->
...
- [ ] D) Al congresista. <!-- feedback: Hacen leyes. -->
...
- [ ] D) Para crear empleos públicos. <!-- feedback: No es el propósito. -->
...
- [x] D) Un alcalde y un concejo municipal. <!-- feedback: Estructura básica municipal. -->
...
- [ ] D) El gobernador decide solo. <!-- feedback: Debe consultar a la comunidad. -->
...
- [ ] D) Esperar que el gobierno resuelva solo. <!-- feedback: Se necesita participación. -->
...
Este bundle de Ciencias Sociales y Ciudadanas para grado cuarto, W12, aborda el tema de Repaso P2 desde una perspectiva colombiana.
