...
rubric_baseline: "Los departamentos colombianos, su concepto y cuántos son"
license: "FREE"
tier: "legacy"
...
- [ ] D) 28 departamentos. <!-- feedback: Son 32. -->
...
- [ ] D) Un barrio grande. <!-- feedback: El barrio es parte de un municipio. -->
...
- [ ] D) Para organizar fiestas regionales. <!-- feedback: Su función es administrativa. -->
...
- [x] D) Municipios. <!-- feedback: El departamento agrupa municipios. -->
...
- [ ] D) Santander. <!-- feedback: No es el más extenso. -->
...
- [ ] D) Vaupés. <!-- feedback: Mitú es capital del Vaupés. -->
...
- [ ] D) No se diferencian en nada. <!-- feedback: Sí se diferencian. -->
...
- [x] D) La región Andina. <!-- feedback: La región Andina tiene la mayoría de los departamentos de Colombia. -->
...
- [ ] D) Para competir entre ellos. <!-- feedback: Deben colaborar, no competir. -->
...
- [ ] D) Cambiaría el nombre de todos los departamentos. <!-- feedback: No es necesario. -->
