...
Repaso de diversidad cultural, fechas cívicas y geografía de Colombia.
...
- [ ] D) 8 regiones. <!-- feedback: Incorrecto. Son 6. -->
...
- [ ] D) La cantidad de árboles. <!-- feedback: Incorrecto. La vegetación es consecuencia, no causa. -->

### Explicación Pedagógica
[Remember] Recordar el factor que determina los pisos térmicos.
...
- [ ] D) Los muebles de las casas antiguas. <!-- feedback: Incorrecto. Eso es material. -->

### Explicación Pedagógica
[Understand] Comprender qué es el patrimonio cultural inmaterial.
...
- [ ] D) Los océanos. <!-- feedback: Incorrecto. Los océanos se representan con agua en el escudo. -->

### Explicación Pedagógica
[Understand] Comprender el simbolismo del cóndor en el escudo.
...
- [ ] D) 6 de diciembre. <!-- feedback: Incorrecto. No es una fecha patria principal. -->

### Explicación Pedagógica
[Apply] Aplicar conocimiento sobre la fecha de la Batalla de Boyacá.
...
- [ ] D) Océano Índico y Atlántico. <!-- feedback: Incorrecto. Colombia no tiene costas en el Índico. -->

### Explicación Pedagógica
[Apply] Aplicar conocimiento sobre los océanos de Colombia.
...
- [ ] D) Porque cada persona habla un idioma diferente. <!-- feedback: Incorrecto. Son lenguas de comunidades específicas. -->

### Explicación Pedagógica
[Analyze] Analizar el origen de la diversidad lingüística colombiana.
...
- [ ] D) Todos los colombianos tienen la misma cultura. <!-- feedback: Incorrecto. Colombia es muy diversa. -->

### Explicación Pedagógica
[Analyze] Analizar la influencia de la geografía en la diversidad cultural.
...
- [ ] D) El patrimonio no necesita cuidado. <!-- feedback: Incorrecto. El patrimonio debe protegerse. -->

### Explicación Pedagógica
[Evaluate] Evaluar el cuidado del patrimonio cultural en Colombia.
...
- [ ] D) Hacer una fiesta. <!-- feedback: Incorrecto. No es un proyecto educativo. -->

### Explicación Pedagógica
[Create] Crear un proyecto integrador de geografía, cultura y civismo.
