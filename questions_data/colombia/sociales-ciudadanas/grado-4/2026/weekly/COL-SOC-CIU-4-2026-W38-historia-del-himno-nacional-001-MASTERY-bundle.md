...
Este bundle explica la historia del himno nacional de Colombia, sus autores, su letra y su significado.
...
- [ ] D) Gabriel García Márquez. <!-- feedback: Incorrecto. García Márquez fue escritor pero no del himno. -->

### Explicación Pedagógica
[Remember] Recordar el autor de la letra del himno nacional.
...
- [ ] D) Carlos Vives. <!-- feedback: Incorrecto. Vives es cantante moderno. -->

### Explicación Pedagógica
[Remember] Recordar el compositor de la música del himno.
...
- [ ] D) 1900. <!-- feedback: Incorrecto. Ya existía antes. -->

### Explicación Pedagógica
[Understand] Comprender la fecha de creación del himno nacional.
...
- [ ] D) Se refiere a los símbolos patrios. <!-- feedback: Parcialmente, pero es principalmente sobre la independencia. -->

### Explicación Pedagógica
[Understand] Comprender el significado de la primera estrofa del himno.
...
- [ ] D) Solo escucharlo sin cantar. <!-- feedback: Parcialmente, pero también se debe cantar si se conoce la letra. -->

### Explicación Pedagógica
[Apply] Aplicar el protocolo correcto para entonar el himno.
...
- [ ] D) "Patria, te amo". <!-- feedback: Incorrecto. No es el himno nacional. -->

### Explicación Pedagógica
[Apply] Aplicar conocimiento sobre la letra del coro del himno.
...
- [ ] D) Porque es la canción más antigua de Colombia. <!-- feedback: Incorrecto. No es la más antigua. -->

### Explicación Pedagógica
[Analyze] Analizar la importancia del himno como símbolo patrio.
...
- [ ] D) Que sembrar es doloroso. <!-- feedback: Incorrecto. Se refiere a la independencia, no a la agricultura. -->

### Explicación Pedagógica
[Analyze] Analizar el significado de una de las estrofas del himno.
...
- [ ] D) Nadie siente nada al cantarlo. <!-- feedback: Incorrecto. Es una canción que despierta emociones. -->

### Explicación Pedagógica
[Evaluate] Evaluar el sentimiento que despierta el himno nacional.
...
- [ ] D) No cantar el himno, solo hablar de política. <!-- feedback: Incorrecto. No es un acto que honre al himno. -->

### Explicación Pedagógica
[Create] Crear un acto cívico que honre el himno nacional.
