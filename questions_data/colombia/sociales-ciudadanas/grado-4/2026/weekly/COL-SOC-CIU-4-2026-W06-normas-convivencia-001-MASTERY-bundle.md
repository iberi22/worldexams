...
Este bundle cubre las normas de convivencia en la familia, la escuela y la comunidad colombiana. Se abordan conceptos como el respeto, la tolerancia, la resolución pacífica de conflictos, el manual de convivencia escolar y la importancia de las reglas para la vida en sociedad. Corresponde a la semana 6 del plan de estudios de grado 4 de Sociales y Ciudadanas.
...
- [ ] D) Instrucciones para jugar un deporte. <!-- feedback: Incorrecto. Las reglas de un deporte son un tipo específico de norma, pero no son lo mismo que las normas de convivencia social. -->

### Explicación Pedagógica
Se evalúa el conocimiento básico del concepto de normas de convivencia. La respuesta correcta las define como reglas para la relación armónica. El error común es asociarlas solo con castigos o con contextos muy específicos.
...
- [ ] D) Reglamento de Fútbol. <!-- feedback: Incorrecto. El reglamento de fútbol aplica a ese deporte, no a la convivencia escolar. -->

### Explicación Pedagógica
Se evalúa el conocimiento del Manual de Convivencia como el documento rector de la convivencia escolar. La respuesta correcta lo identifica por su nombre. El error común es confundirlo con otros documentos legales o normativos.
...
- [ ] D) Para que el gobierno pueda controlar a los ciudadanos. <!-- feedback: Incorrecto. Aunque el gobierno establece leyes, las normas de convivencia surgen de la necesidad de organizar la vida colectiva. -->

### Explicación Pedagógica
Se evalúa la comprensión de la función social de las normas. La respuesta correcta destaca la protección del orden, el respeto y la seguridad. El error común es ver las normas como herramientas de control o limitación.
...
- [ ] D) Que uno de los dos ceda siempre para no pelear. <!-- feedback: Incorrecto. Ceder siempre no es justo ni saludable; lo mejor es buscar soluciones donde ambas partes estén de acuerdo. -->

### Explicación Pedagógica
Se evalúa la comprensión de la resolución pacífica de conflictos. La respuesta correcta promueve el diálogo y la mediación. El error común es pensar que la imposición o la violencia son formas válidas de resolver diferencias.
...
- [ ] D) Cerrar la cancha para que nadie la use y evitar problemas. <!-- feedback: Incorrecto. Cerrar un espacio comunitario evita conflictos pero también priva a la comunidad de un lugar de encuentro y recreación. -->

### Explicación Pedagógica
Se evalúa la aplicación de normas de convivencia en un contexto comunitario. La respuesta correcta propone el acuerdo colectivo como método. El error común es recurrir a la exclusión o a la ausencia total de reglas.
...
- [ ] D) Reportarlo con el coordinador cada vez que cometa un error. <!-- feedback: Incorrecto. Reportarlo sin haberle explicado las normas primero es injusto. -->

### Explicación Pedagógica
Se evalúa la aplicación de la empatía y la solidaridad en la enseñanza de normas. La respuesta correcta combina explicación, ejemplo y acompañamiento. El error común es pensar que las normas se aprenden solo a través de la sanción.
...
- [ ] D) Luis debería llevar la misma comida que los demás para evitar burlas. <!-- feedback: Incorrecto. Nadie debe cambiar sus costumbres para evitar ser víctima de burlas; el que debe cambiar su actitud es Carlos. -->

### Explicación Pedagógica
Se evalúa la capacidad de analizar una situación de discriminación a la luz de las normas de convivencia. La respuesta correcta identifica la burla como falta de respeto a la diversidad. El error común es justificar la burla o culpar a la víctima.
...
- [ ] D) La norma no es importante porque es en la casa, no en el colegio. <!-- feedback: Incorrecto. Las normas de convivencia aplican en todos los espacios, incluido el hogar. -->

### Explicación Pedagógica
Se evalúa la capacidad de analizar el incumplimiento de normas en el ámbito familiar. La respuesta correcta reconoce la importancia de cumplir las normas y propone el diálogo como vía de ajuste. El error común es pensar que las normas familiares son menos importantes que las escolares.
...
- [ ] D) Pedir a los padres que se quejen en la Secretaría de Educación. <!-- feedback: Incorrecto. Si bien los padres pueden apoyar, lo primero es agotar las instancias internas del colegio. -->

### Explicación Pedagógica
Se evalúa la capacidad de evaluar mecanismos democráticos para modificar normas. La respuesta correcta promueve el conducto regular y el diálogo institucional. El error común es recurrir a la desobediencia o a la protesta sin argumentos.
...
- [ ] D) 1) Solo los niños pueden hablar. 2) Las niñas deben estar calladas. 3) Los niños deciden todo. <!-- feedback: Incorrecto. Estas normas son discriminatorias y violan derechos fundamentales de igualdad. -->

### Explicación Pedagógica
Se evalúa la capacidad creativa para proponer normas de convivencia equilibradas. La respuesta correcta establece normas que promueven el respeto, la participación y la paz. El error común es proponer normas autoritarias, discriminatorias o la ausencia total de reglas.
