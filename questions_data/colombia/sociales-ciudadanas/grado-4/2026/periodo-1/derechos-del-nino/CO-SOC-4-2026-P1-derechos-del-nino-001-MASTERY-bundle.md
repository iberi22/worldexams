...
Este bundle cubre los derechos fundamentales de los niños y niñas en Colombia, basados en la Constitución y la Convención Internacional de los Derechos del Niño. Contenido del primer periodo según DBA MEN para grado 4 de Sociales y Ciudadanas.
...
- [ ] D) Viajar solos al extranjero cuando quieran. <!-- feedback: Incorrecto. Los niños necesitan la autorización y el acompañamiento de sus padres para viajar. -->

### Explicación Pedagógica
Se evalúa el conocimiento básico de los derechos fundamentales de la infancia. La respuesta correcta identifica los derechos esenciales: familia, educación, salud y protección. Los errores comunes surgen de malinterpretar los derechos como libertades absolutas sin supervisión adulta.
...
- [ ] D) Exigir que le compren todo lo que pide. <!-- feedback: Incorrecto. Exigir no es un deber, y los niños deben aprender a valorar lo que tienen. -->

### Explicación Pedagógica
Se evalúa el equilibrio entre derechos y deberes. La respuesta correcta identifica las responsabilidades básicas de un estudiante. El error típico es pensar que solo se tienen derechos y no obligaciones.
...
- [ ] D) El Ministerio de Deporte. <!-- feedback: Incorrecto. El Ministerio del Deporte promueve la actividad física y el deporte, no atiende casos de maltrato infantil. -->

### Explicación Pedagógica
Se evalúa el conocimiento sobre las instituciones de protección infantil en Colombia. La respuesta correcta identifica al ICBF. Los errores comunes confunden las funciones de diferentes entidades gubernamentales.
...
- [ ] D) Porque los niños pueden trabajar mejor que los adultos. <!-- feedback: Incorrecto. Los niños no deben trabajar; deben estudiar, jugar y desarrollarse sanamente. -->

### Explicación Pedagógica
Se evalúa la comprensión del principio de protección especial a la infancia. La respuesta correcta destaca la vulnerabilidad infantil. El error común es no entender por qué los derechos de los niños son diferentes a los de los adultos.
...
- [ ] D) Debe pedir permiso al alcalde para votar. <!-- feedback: Incorrecto. Las elecciones escolares son internas del colegio y no requieren permiso del alcalde. -->

### Explicación Pedagógica
Se evalúa la aplicación del derecho a la participación y libre expresión de los niños. La respuesta correcta afirma el derecho de María a opinar. El error común es creer que los niños no tienen derecho a participar en decisiones.
...
- [ ] D) Derecho a la propiedad. <!-- feedback: Incorrecto. Aunque pueden heredar, la propiedad no es el derecho que protege su nombre y filiación. -->

### Explicación Pedagógica
Se evalúa la comprensión del derecho a la identidad. La respuesta correcta asocia el nombre y la nacionalidad con este derecho. Los errores surgen de confundir derechos específicos de la infancia.
...
- [ ] D) Porque las empresas no quieren contratar niños. <!-- feedback: Incorrecto. La prohibición es para proteger a los niños, no porque las empresas no quieran contratarlos. -->

### Explicación Pedagógica
Se evalúa la comprensión de la prohibición del trabajo infantil. La respuesta correcta destaca la protección del derecho a la educación y la salud. El error común es justificar el trabajo infantil por necesidad económica sin considerar los derechos del niño.
...
- [ ] D) Pedro está equivocado, los niños solo tienen deberes. <!-- feedback: Incorrecto. Los niños tienen tanto derechos como deberes, no solo una de las dos cosas. -->

### Explicación Pedagógica
Se evalúa la capacidad de analizar la relación entre derechos y deberes. La respuesta correcta reconoce el equilibrio necesario. El error común es pensar que los derechos son absolutos y no implican responsabilidades.
...
- [ ] D) Derecho a la propiedad privada. <!-- feedback: Incorrecto. La comida es una necesidad básica, no un asunto de propiedad. -->

### Explicación Pedagógica
Se evalúa la capacidad de identificar la violación de derechos en situaciones concretas. La respuesta correcta identifica el derecho a la alimentación. El error común es confundir derechos importantes pero no esenciales con derechos básicos de supervivencia.
...
- [ ] D) Son derechos solo si los padres lo permiten. <!-- feedback: Incorrecto. Los derechos de los niños no dependen del permiso de los padres; son inherentes a su condición de niños. -->

### Explicación Pedagógica
Se evalúa la comprensión del derecho al juego como un derecho fundamental. La respuesta correcta reconoce su importancia para el desarrollo integral. El error común es considerar el juego como algo no esencial o como un privilegio.

### Explicación Pedagógica Final
Este bundle de Ciencias Sociales y Ciudadanas para grado cuarto aborda los Derechos del Niño desde una perspectiva colombiana. Evalúa el conocimiento de la Convención Internacional de los Derechos del Niño, las instituciones de protección como el ICBF, el equilibrio entre derechos y deberes, el derecho a la identidad, la prohibición del trabajo infantil, el derecho a la participación, a la alimentación y al juego. El objetivo es que los estudiantes reconozcan sus derechos, sepan a quién acudir si son vulnerados y comprendan que sus derechos vienen acompañados de responsabilidades.
