...
tema: "grupos-indigenas-colombia"
periodo: 1
...
Este bundle cubre los principales grupos indígenas que habitaron y habitan Colombia: su ubicación geográfica, organización social, costumbres y legado cultural. Contenido del primer periodo según DBA MEN para grado 4.
...
- [ ] D) Nasa <!-- feedback: Incorrecto. El pueblo Nasa está ubicado principalmente en el departamento del Cauca, en la región andina. -->

### Explicación Pedagógica
Se evalúa la capacidad de localizar geográficamente los principales grupos indígenas colombianos. La respuesta correcta asocia el departamento de La Guajira con el pueblo Wayúu. Los errores comunes surgen de conocer solo los grupos indígenas más mencionados en los medios.
...
- [ ] D) Exactamente 102 grupos indígenas censados. <!-- feedback: Incorrecto, aunque hay muchas comunidades, no se ha fijado una cifra exacta de 102; la cifra supera los 80. -->

### Explicación Pedagógica
Se evalúa el conocimiento sobre la diversidad cultural colombiana. La respuesta correcta reconoce la gran cantidad de pueblos indígenas que coexisten en el país. El error común es subestimar la diversidad indígena de Colombia.
...
- [ ] D) Tupi-guaraní y quechua. <!-- feedback: Incorrecto. Aunque son familias americanas importantes, estas lenguas son más comunes en Brasil y la región andina sur, no principalmente en Colombia. -->

### Explicación Pedagógica
Se evalúa la comprensión de la clasificación lingüística de los pueblos indígenas colombianos. La respuesta correcta identifica las tres grandes familias. El error común es confundir familias lingüísticas americanas entre sí.
...
- [ ] D) Comandante de policía. <!-- feedback: Incorrecto. La policía es una institución estatal, no una autoridad tradicional indígena. -->

### Explicación Pedagógica
Se evalúa el conocimiento sobre la organización política de los pueblos indígenas actuales. La respuesta correcta identifica al cabildo indígena como figura de autogobierno. Los errores surgen de confundir autoridades estatales con autoridades tradicionales.
...
- [ ] D) Camisa blanca y pantalón de dril. <!-- feedback: Incorrecto. Aunque algunos lo usan hoy por influencia externa, no es su vestimenta tradicional distintiva. -->

### Explicación Pedagógica
Se evalúa el conocimiento sobre las costumbres y la identidad visual de los pueblos indígenas. La respuesta correcta reconoce la indumentaria característica de un grupo específico. El error común es generalizar elementos de culturas indígenas distintas.
...
- [ ] D) Porque el gobierno obliga a hablarlas. <!-- feedback: Incorrecto. El gobierno protege las lenguas pero no obliga a hablarlas; su preservación es voluntaria y cultural. -->

### Explicación Pedagógica
Se evalúa la comprensión del valor del patrimonio lingüístico y cultural. La respuesta correcta destaca el valor cognitivo y cultural de las lenguas indígenas. Los errores suelen minimizar la importancia de la diversidad lingüística.
...
- [ ] D) Uitoto. <!-- feedback: Incorrecto. Los Uitoto son un grupo de la Amazonía colombiana, no de la costa Pacífica. -->

### Explicación Pedagógica
Se evalúa la capacidad de localizar y reconocer las características de los grupos indígenas según su región. La respuesta correcta identifica al pueblo Emberá y su región. Los errores comunes mezclan grupos de diferentes regiones del país.
...
- [ ] D) Tutela. <!-- feedback: Incorrecto. La tutela protege derechos fundamentales vulnerados, pero no es el mecanismo de consulta previa. -->

### Explicación Pedagógica
Se evalúa la comprensión de los derechos constitucionales de los pueblos indígenas. La respuesta correcta identifica la consulta previa. El error común es confundirla con otros mecanismos de participación ciudadana.
...
- [ ] D) Wayúu. <!-- feedback: Incorrecto. Los Wayúu viven en La Guajira, en la península, no en la Sierra Nevada. -->

### Explicación Pedagógica
Se evalúa el conocimiento detallado sobre la ubicación de grupos indígenas específicos. La respuesta correcta identifica a los Arhuacos como habitantes de la Sierra Nevada. Los errores surgen de confundir la ubicación de los diferentes pueblos indígenas.
...
- [ ] D) Zonas francas. <!-- feedback: Incorrecto. Las zonas francas son áreas de comercio especial, no tienen relación con la propiedad indígena. -->

### Explicación Pedagógica
Se evalúa el conocimiento sobre la tenencia de la tierra de los pueblos indígenas en Colombia. La respuesta correcta identifica el concepto de resguardo. El error común es confundir los tipos de propiedad territorial que existen en el país.

### Explicación Pedagógica Final
Este bundle de Ciencias Sociales y Ciudadanas para grado cuarto se enfoca en la riqueza de los grupos indígenas de Colombia. Evalúa el conocimiento sobre su ubicación geográfica (Wayúu en La Guajira, Emberá en el Pacífico, Arhuacos en la Sierra Nevada), su diversidad lingüística (familias Chibcha, Caribe, Arawak), su organización política (cabildos, consulta previa), sus costumbres (vestimenta Guambiana) y su derecho territorial (resguardos). El objetivo es que el estudiante reconozca y valore la multiculturalidad del país y los derechos de los pueblos originarios.
