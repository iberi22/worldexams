...
Este bundle cubre los principales grupos indígenas actuales de Colombia: su ubicación, lenguas, costumbres, cosmovisión y derechos constitucionales. Contenido del primer periodo según DBA MEN para grado 4.
...
- [ ] D) Solo en la isla de San Andrés. <!-- feedback: Incorrecto. San Andrés tiene población raizal, no es la principal zona indígena. -->

### Explicación Pedagógica
Se evalúa la ubicación geográfica de la población indígena actual. La respuesta correcta identifica las regiones con mayor concentración. El error común es creer que los indígenas viven principalmente en grandes ciudades.
...
- [ ] D) El guaraní. <!-- feedback: Incorrecto. El guaraní es una lengua indígena de Paraguay y regiones vecinas. -->

### Explicación Pedagógica
Se evalúa el conocimiento de las lenguas indígenas colombianas. La respuesta correcta identifica el wayuunaiki. El error común es confundir las lenguas indígenas de diferentes países.
...
- [ ] D) La puesta del sol en la cordillera. <!-- feedback: Incorrecto. Aunque el sol es importante, no es el significado principal del rojo en su simbología. -->

### Explicación Pedagógica
Se evalúa la comprensión de la simbología del pueblo Nasa. La respuesta correcta asocia el rojo con la lucha territorial. El error común es dar interpretaciones literales o superficiales.
...
- [ ] D) Un lugar donde solo se puede ir de paseo en vacaciones. <!-- feedback: Incorrecto. Su relación con la Sierra Nevada es espiritual y de cuidado, no turística. -->

### Explicación Pedagógica
Se evalúa la comprensión de la cosmovisión de los pueblos indígenas de la Sierra Nevada. La respuesta correcta describe su visión espiritual del territorio. El error común es reducir la relación de los indígenas con su territorio a lo turístico o económico.
...
- [ ] D) El deber de adoptar el sistema de gobierno de los municipios vecinos. <!-- feedback: Incorrecto. Los territorios indígenas tienen su propio sistema de gobierno. -->

### Explicación Pedagógica
Se evalúa la aplicación del conocimiento constitucional sobre derechos indígenas. La respuesta correcta describe la autonomía reconocida por la Constitución de 1991. El error común es pensar que los territorios indígenas no tienen derechos especiales.
...
- [ ] D) Pintar sus cuerpos para ceremonias. <!-- feedback: Incorrecto. Aunque algunas plantas se usan para pintura corporal, la quina no es la principal. -->

### Explicación Pedagógica
Se evalúa la comprensión de los conocimientos medicinales indígenas. La respuesta correcta identifica el uso de la quina. El error común es desconocer la contribución de los pueblos indígenas a la medicina mundial.
...
- [ ] D) Convertirse todos al español y abandonar sus creencias. <!-- feedback: Incorrecto. Muchos pueblos mantienen sus lenguas y creencias ancestrales. -->

### Explicación Pedagógica
Se evalúa la capacidad de reconocer la resiliencia de los pueblos indígenas. La respuesta correcta destaca la continuidad cultural con adaptación. El error común es pensar que los indígenas desaparecieron o que no cambiaron nada.
...
- [ ] D) Son lenguas muy difíciles de aprender. <!-- feedback: Incorrecto. La dificultad no es la causa de su pérdida; los niños las aprenden naturalmente cuando se hablan en casa. -->

### Explicación Pedagógica
Se evalúa la capacidad de analizar las causas de la pérdida de lenguas indígenas. La respuesta correcta identifica factores sociales y educativos. El error común es buscar explicaciones simplistas o incorrectas.
...
- [ ] D) Uniformes obligatorios que todos los indígenas deben usar. <!-- feedback: Incorrecto. La vestimenta tradicional es voluntaria y cultural, no obligatoria por ley. -->

### Explicación Pedagógica
Se evalúa la capacidad de analizar el significado cultural de las artesanías indígenas. La respuesta correcta valora su importancia cultural y económica. El error común es minimizar el valor cultural de las artesanías.
...
- [ ] D) Que no tienen acceso a teléfonos celulares modernos. <!-- feedback: Incorrecto. El acceso a tecnología no es el principal problema que enfrentan. -->

### Explicación Pedagógica
Se evalúa la capacidad de reflexionar sobre la situación actual de los pueblos indígenas. La respuesta correcta identifica problemas estructurales reales. El error común es minimizar los problemas o tener visiones estereotipadas.

### Explicación Pedagógica Final
Este bundle refuerza el conocimiento sobre los grupos indígenas actuales de Colombia. Evalúa su ubicación (Wayúu en La Guajira, Nasa en el Cauca, Arhuacos en la Sierra Nevada), lenguas (wayuunaiki), cosmovisión (Sierra Nevada como corazón del mundo), derechos constitucionales (autonomía, jurisdicción especial), medicina tradicional (quina), artesanías (mochilas wayúu y arhuacas), y problemáticas actuales (desplazamiento, pérdida de lenguas). El objetivo es que el estudiante reconozca a los pueblos indígenas como comunidades vivas con derechos, cultura propia y desafíos contemporáneos.
