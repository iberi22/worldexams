...
tema: "funciones-trigonometricas, vectores-2d, limite-intuitivo"
periodo: 1
...
Bundle de periodo 1 para grado 10, alineado con DBA MEN y preparación Pre-Saber 11. Cubre funciones trigonométricas en el círculo unitario, operaciones con vectores en el plano y el concepto intuitivo de límite.

---

## Question 1 (Difficulty D3)

**ID:** `CO-MAT-10-2026-P1-comprehensive-001-MASTERY-v1`
**Bloom:** Remember
...
- [ ] D) 1.25 <!-- feedback: Incorrecto. Este resultado sería 5/4, que no corresponde a ninguna razón trigonométrica básica del triángulo. -->

### Explicación Pedagógica
La tangente de un ángulo en un triángulo rectángulo es la razón entre el cateto opuesto y el cateto adyacente al ángulo. Es una de las tres razones trigonométricas fundamentales junto con seno y coseno.

---

## Question 2 (Difficulty D3)

**ID:** `CO-MAT-10-2026-P1-comprehensive-001-MASTERY-v2`
**Bloom:** Understand
**ICFES:** Comunicación y Representación
...
- [ ] D) (0, -1) <!-- feedback: Incorrecto. (0, -1) corresponde al ángulo de 270° (3π/2 radianes). -->

### Explicación Pedagógica
En el círculo unitario, las coordenadas de cualquier punto son (cos θ, sen θ). Memorizar los puntos cardinales del círculo unitario ayuda a graficar funciones trigonométricas.

---

## Question 3 (Difficulty D4)

**ID:** `CO-MAT-10-2026-P1-comprehensive-001-MASTERY-v3`
**Bloom:** Apply
...
- [ ] D) 30 m <!-- feedback: Incorrecto. 30 es el desplazamiento vertical, no el máximo. -->

### Explicación Pedagógica
En una función senoidal de la forma h(t) = A sen(Bt) + D, la amplitud es A y el desplazamiento vertical es D. El valor máximo es A + D y el mínimo es -A + D.

---

## Question 4 (Difficulty D4)

**ID:** `CO-MAT-10-2026-P1-comprehensive-001-MASTERY-v4`
**Bloom:** Understand
**ICFES:** Comunicación y Representación
...
- [ ] D) (6, 4) N <!-- feedback: Incorrecto. Sumaste 3+2 y luego 4+(-1) de forma incorrecta. -->

### Explicación Pedagógica
La suma de vectores se realiza sumando componente a componente: (x₁+x₂, y₁+y₂). Este es el principio fundamental de la composición de fuerzas en física.

---

## Question 5 (Difficulty D5)

**ID:** `CO-MAT-10-2026-P1-comprehensive-001-MASTERY-v5`
**Bloom:** Apply
**ICFES:** Formulación y Ejecución
...
- [ ] D) 200 km/h <!-- feedback: Incorrecto. El viento afecta la trayectoria, por lo que la magnitud resultante no puede ser igual a la del avión sola. -->

### Explicación Pedagógica
La velocidad resultante se obtiene sumando vectorialmente ambas velocidades. La magnitud del vector suma es √(x² + y²), no la suma aritmética de las magnitudes.

---

## Question 6 (Difficulty D5)

**ID:** `CO-MAT-10-2026-P1-comprehensive-001-MASTERY-v6`
**Bloom:** Analyze
...
- [ ] D) 9 <!-- feedback: Incorrecto. Para x muy cercano a 3, el numerador tiende a 0, pero el límite no es 9. -->

### Explicación Pedagógica
El límite de una función describe el valor al que se acerca la función cuando la variable independiente se aproxima a un punto. Al factorizar y simplificar, encontramos que la función es equivalente a x+3 excepto en x=3.

---

## Question 7 (Difficulty D5)

**ID:** `CO-MAT-10-2026-P1-comprehensive-001-MASTERY-v7`
**Bloom:** Apply
**ICFES:** Formulación y Ejecución
...
- [ ] D) 0 m <!-- feedback: Incorrecto. La canastilla nunca toca el suelo porque el centro está a 18 m y el radio es 15 m. -->

### Explicación Pedagógica
El movimiento circular produce una altura senoidal. La altura mínima es D - A = 18 - 15 = 3 m, lo que corresponde a la canastilla en su punto más bajo.

---

## Question 8 (Difficulty D6)

**ID:** `CO-MAT-10-2026-P1-comprehensive-001-MASTERY-v8`
**Bloom:** Analyze
**ICFES:** Razonamiento y Argumentación
...
- [ ] D) u y v tienen la misma magnitud. <!-- feedback: Incorrecto. |u| = 5 y |v| = √5, son diferentes. -->

### Explicación Pedagógica
El producto punto permite determinar la relación angular entre vectores: positivo = ángulo agudo, cero = ortogonal, negativo = ángulo obtuso.

---

## Question 9 (Difficulty D6)

**ID:** `CO-MAT-10-2026-P1-comprehensive-001-MASTERY-v9`
**Bloom:** Apply
**ICFES:** Formulación y Ejecución
...
- [ ] D) No existe <!-- feedback: Incorrecto. La función tiene una discontinuidad removible y el límite sí existe. -->

### Explicación Pedagógica
El límite existe aunque la función no esté definida en x = 2. Al factorizar, eliminamos la indeterminación y evaluamos la expresión simplificada.

---

## Question 10 (Difficulty D6)

**ID:** `CO-MAT-10-2026-P1-comprehensive-001-MASTERY-v10`
**Bloom:** Understand
**ICFES:** Comunicación y Representación
...
- [ ] D) 180° (π rad) <!-- feedback: Incorrecto. Un desfase de 180° produce sen(θ + π) = -sen(θ), no la función coseno. -->

### Explicación Pedagógica
La función coseno es la función seno desplazada 90° hacia la izquierda. En términos de fase, cos(θ) = sen(θ + π/2), lo que significa que el coseno está π/2 radianes adelantado.

---

## Question 11 (Difficulty D7)

**ID:** `CO-MAT-10-2026-P1-comprehensive-001-MASTERY-v11`
**Bloom:** Apply
**ICFES:** Formulación y Ejecución
...
- [ ] D) 6:00 de la tarde <!-- feedback: Incorrecto. A las 18 horas, t=18, T=12 sen(π·12/12)+18 = 12 sen(π)+18 = 18°C, que es el punto medio, no el máximo. -->

### Explicación Pedagógica
Para funciones senoidales, el máximo ocurre cuando el argumento de la función seno es π/2. Despejamos (π/12)(t-6) = π/2 para encontrar el tiempo.

---

## Question 12 (Difficulty D7)

**ID:** `CO-MAT-10-2026-P1-comprehensive-001-MASTERY-v12`
**Bloom:** Analyze
**ICFES:** Razonamiento y Argumentación
...
- [ ] D) (4/√25, 3/√25) <!-- feedback: Incorrecto. Usaste las componentes de F₁ en lugar de la resultante. -->

### Explicación Pedagógica
El vector unitario se obtiene dividiendo cada componente del vector entre su magnitud. Es un vector de longitud 1 que conserva la dirección original.

---

## Question 13 (Difficulty D7)

**ID:** `CO-MAT-10-2026-P1-comprehensive-001-MASTERY-v13`
**Bloom:** Apply
**ICFES:** Formulación y Ejecución
...
- [ ] D) h(t) = 5 sen(π/24 (t - 2)) + 12 <!-- feedback: Incorrecto. ω=π/24 daría un período de 48 horas, no 24. -->

### Explicación Pedagógica
Modelar fenómenos periódicos con funciones senoidales requiere identificar amplitud, período (ω = 2π/T), desplazamiento vertical y desfase según el punto máximo.

---

## Question 14 (Difficulty D8)

**ID:** `CO-MAT-10-2026-P1-comprehensive-001-MASTERY-v14`
**Bloom:** Evaluate
**ICFES:** Razonamiento y Argumentación
...
Estudiante C: "El límite no existe porque hay división entre 0"
...
- [ ] D) Estudiante D <!-- feedback: Incorrecto. Al tender tanto numerador como denominador a 0, se produce una indeterminación, no necesariamente infinito. -->

### Explicación Pedagógica
La factorización de diferencia de cubos permite eliminar la indeterminación: a³ - b³ = (a-b)(a² + ab + b²). Luego se simplifica y se evalúa.

---

## Question 15 (Difficulty D8)

**ID:** `CO-MAT-10-2026-P1-comprehensive-001-MASTERY-v15`
**Bloom:** Analyze
**ICFES:** Razonamiento y Argumentación
...
- [x] D) No es un triángulo rectángulo. <!-- feedback: Correcto. AB=(3,4), BC=(3,-4), AC=(6,0). |AB|²=25, |BC|²=25, |AC|²=36. No se cumple Pitágoras: 25+25=50 ≠ 36. Ningún producto punto da cero. -->

### Explicación Pedagógica
Para verificar si un triángulo es rectángulo se puede usar el teorema de Pitágoras (a²+b²=c²) o el producto punto de los vectores que forman cada vértice (cero = ángulo recto).

---

## Question 16 (Difficulty D8)

**ID:** `CO-MAT-10-2026-P1-comprehensive-001-MASTERY-v16`
**Bloom:** Evaluate
**ICFES:** Razonamiento y Argumentación
...
- [ ] D) La gráfica de g(x) es la gráfica de f(x) desplazada verticalmente 1 unidad. <!-- feedback: Incorrecto. g(x) no es f(x) + 1, sino f(x + π/2). -->

### Explicación Pedagógica
Las funciones seno y coseno tienen la misma forma y la misma frecuencia; la única diferencia es que el coseno está adelantado π/2 radianes respecto al seno: cos(x) = sen(x + π/2).

---

## Question 17 (Difficulty D9)

**ID:** `CO-MAT-10-2026-P1-comprehensive-001-MASTERY-v17`
**Bloom:** Evaluate
**ICFES:** Razonamiento y Argumentación
...
- [ ] D) No, porque PQ y PR tienen la misma dirección. <!-- feedback: Incorrecto. Si tuvieran la misma dirección, serían paralelos, y P, Q, R serían colineales, lo que no ocurre. -->

### Explicación Pedagógica
La perpendicularidad entre vectores se verifica con el producto punto igual a cero. No es suficiente con observar visualmente; se requiere el cálculo algebraico.

---

## Question 18 (Difficulty D9)

**ID:** `CO-MAT-10-2026-P1-comprehensive-001-MASTERY-v18`
**Bloom:** Evaluate
**ICFES:** Razonamiento y Argumentación
...
- [ ] D) Es falsa porque el límite de la suma siempre es indeterminado. <!-- feedback: Incorrecto. Muchas sumas de límites tienen valores determinados. -->

### Explicación Pedagógica
Las propiedades algebraicas de los límites tienen condiciones de aplicabilidad. El límite de una suma es la suma de los límites solo si los límites individuales existen en ℝ.

---

## Question 19 (Difficulty D9)

**ID:** `CO-MAT-10-2026-P1-comprehensive-001-MASTERY-v19`
**Bloom:** Create
**ICFES:** Formulación y Ejecución
...
- [ ] D) D(t) = 40 sen(π/24 (t - 13)) + 110 <!-- feedback: Incorrecto. ω = π/24 da un período de 48 horas, no 24. -->

### Explicación Pedagógica
Para construir un modelo senoidal: amplitud = (máx-mín)/2, valor medio = (máx+mín)/2, ω = 2π/período. El desfase se determina igualando el argumento a π/2 en el punto máximo.

---

## Question 20 (Difficulty D10)

**ID:** `CO-MAT-10-2026-P1-comprehensive-001-MASTERY-v20`
**Bloom:** Evaluate
**ICFES:** Razonamiento y Argumentación
...
- [ ] D) lim_{x→0} f(x) = -1 <!-- feedback: Incorrecto. Esto es cierto solo para el límite por la izquierda (x→0-), no es el límite bilateral. -->
