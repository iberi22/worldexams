...
- [ ] D) 5/8 <!-- feedback: Incorrect. Esta es la fracción de pizza que SOBRÓ (8-3=5), no la que se comió Carlos. Refleja una lectura incompleta de la pregunta. -->

### Explicación Pedagógica
Se evalúa la representación de fracciones como parte-todo. La respuesta correcta identifica correctamente el numerador y el denominador a partir de una situación gráfica o descriptiva. Un error típico es dar la fracción restante en lugar de la solicitada.
...
- [ ] D) 0,300 <!-- feedback: Incorrect. Aunque numéricamente es equivalente a 0,3, el uso de tres decimales sugiere milésimos, lo que puede confundir la interpretación de la precisión de la medida original. -->

### Explicación Pedagógica
El concepto evaluado es la conversión de fracciones decimales a números decimales. La respuesta correcta ubica el dígito en la posición de los décimos. Los errores comunes surgen de confundir décimos con centésimos o con unidades enteras.
...
- [ ] D) 2/4 = 1/3 <!-- feedback: Incorrect. Aunque 2/4 es equivalente a 1/2, no es igual a 1/3. El estudiante confunde conceptos de equivalencia con fracciones unitarias diferentes. -->

### Explicación Pedagógica
Se evalúa la comparación de fracciones con igual numerador o igual denominador. La respuesta correcta demuestra la comprensión de que a mayor denominador, menor es el tamaño de la parte (si el numerador es constante). El error principal es tratar los denominadores como números naturales en lugar de divisores de la unidad.
...
- [ ] D) 3/4 <!-- feedback: Incorrect. El estudiante sobreestima la cantidad gastada; 3/4 de 500 serían 375 pesos. -->

### Explicación Pedagógica
Se evalúa la identificación de fracciones equivalentes en contextos de magnitudes (dinero). La respuesta correcta requiere reconocer la relación de "mitad" entre dos cantidades y expresarla como fracción. Los distractores representan errores en la percepción de las proporciones.
...
- [ ] D) Cincuenta milésimos <!-- feedback: Incorrect. Los milésimos ocuparían tres posiciones decimales. Es un error de escala en el sistema decimal. -->

### Explicación Pedagógica
Se evalúa la lectura de números decimales hasta los centésimos. La respuesta correcta identifica la posición de las cifras decimales. Un error común es confundir los nombres de las posiciones decimales (décimos, centésimos, milésimos).
...
- [ ] D) 2/3 litro <!-- feedback: Incorrect. 2/3 es aproximadamente 0,66. El estudiante confunde fracciones comunes de uso frecuente pero con valores decimales distintos. -->

### Explicación Pedagógica
Se evalúa la equivalencia entre números decimales y fracciones comunes. La respuesta correcta requiere conocer o calcular la relación entre centésimos y cuartos. Los errores suelen ser por confusión entre las equivalencias de 0,25, 0,50 y 0,75.
...
- [ ] D) Ana, porque 4 es mayor que 0,35. <!-- feedback: Incorrect. Aunque la conclusión es correcta, el razonamiento de comparar un entero (4) con un decimal (0,35) es erróneo, ya que el 4 representa una fracción de la pista. -->

### Explicación Pedagógica
Se evalúa la comparación entre fracciones decimales y números decimales. La respuesta correcta requiere convertir ambas cantidades a una misma representación (decimal o fraccionaria con igual denominador). El error más común es comparar los dígitos sin tener en cuenta su valor posicional.
...
- [ ] D) 15,0 <!-- feedback: Incorrect. El estudiante toma el número de partes como un número entero, ignorando que es una fracción del total de 100. -->

### Explicación Pedagógica
Se evalúa la representación de centésimos a partir de un modelo de área (cuadrícula 10x10). La respuesta correcta asocia la cantidad de partes tomadas con las dos posiciones decimales. Los errores suelen ser de desplazamiento de la coma decimal.
...
- [ ] D) 0,525 metros <!-- feedback: Incorrect. El estudiante simplemente coloca los números uno al lado del otro sin realizar la suma aritmética real. Refleja falta de comprensión del algoritmo de suma decimal. -->

### Explicación Pedagógica
Se evalúa la suma de números decimales hasta los centésimos. La respuesta correcta requiere la alineación correcta de los valores posicionales. Un error frecuente es no completar con ceros las posiciones faltantes (pensar que 0,5 + 0,25 es 0,27 o 0,7).
...
- [ ] D) 3/4 <!-- feedback: Incorrect. Esta es la suma de lo que se llevaron los dos primeros amigos, no lo que le corresponde al tercero. Error de interpretación de la pregunta. -->

### Explicación Pedagógica
Se evalúa la suma de fracciones heterogéneas sencillas y el concepto de complemento a la unidad. La respuesta correcta requiere convertir 1/2 a 2/4 para poder operar. Los errores comunes son no usar fracciones equivalentes o confundir la suma parcial con el resultado final.

### Explicación Pedagógica Final
Este bundle aborda los conceptos de fracciones y decimales correspondientes al segundo periodo de cuarto grado. Se enfatiza la relación entre ambos sistemas (fracciones decimales y notación decimal), la representación parte-todo, y las operaciones y comparaciones básicas. Los resultados muestran que los estudiantes suelen tener dificultades con el valor posicional de los decimales (décimos vs centésimos) y con la comparación de fracciones cuando los denominadores son diferentes. El uso de contextos como el dinero y las mediciones ayuda a dar sentido a estos conceptos matemáticos abstractos.
