---
id: "CO-MAT-6-2026-W25-probabilidad-conceptos-001-MASTERY-bundle"
country: "colombia"
grado: 6
...
**Grado:** 6 | **Periodo:** 3 | **Semana:** 25 | **Anio:** 2026
...
- [ ] D) La estadistica de eventos <!-- feedback: Incorrecto. -->

### Explicacion Pedagogica
Probabilidad mide que tan posible es que ocurra un evento.
...
- [ ] D) 1 y 10 <!-- feedback: Incorrecto. -->

### Explicacion Pedagogica
Probabilidad siempre entre 0 (imposible) y 1 (seguro).
...
- [ ] D) 1/12 <!-- feedback: Incorrecto. -->

### Explicacion Pedagogica
P(3)=1/6. Un dado tiene 6 caras.
...
- [ ] D) 1/6 <!-- feedback: Incorrecto. -->

### Explicacion Pedagogica
Pares: 2,4,6. P=3/6=1/2.
...
- [ ] B) 1/2 <!-- feedback: Incorrecto. -->
- [ ] C) 1/3 <!-- feedback: Incorrecto. -->
- [ ] D) 1/4 <!-- feedback: Incorrecto. -->

### Explicacion Pedagogica
8 resultados posibles. Solo 1 es CCC: P=1/8.
...
- [ ] D) 2/8 = 1/4 <!-- feedback: Incorrecto. -->

### Explicacion Pedagogica
Total=10, azules=2. P=2/10=1/5.
...
- [ ] D) No se sabe <!-- feedback: Incorrecto. -->

### Explicacion Pedagogica
Todas son rojas: P=1, evento seguro.
...
### Explicacion Pedagogica
P_A=4/10=0.4. P_B=5/10=0.5. B tiene mayor probabilidad.
...
- [ ] D) No hay relacion <!-- feedback: Incorrecto. -->
