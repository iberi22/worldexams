...
- [ ] D) $1.200 <!-- feedback: Incorrect. Eso es lo que cuesta la empanada, no las vueltas. Las vueltas son 5.000-(2.500+1.200)=1.300. -->

### Explicacion Pedagogica
Primero sumamos lo que cuesta todo: $2.500 + $1.200 = $3.700.
Luego restamos del billete con que paga: $5.000 - $3.700 = $1.300.
Valentina recibe $1.300 de vueltas.
...
- [ ] D) $18.502 <!-- feedback: Incorrect. Sumar 2 unidades a 18.500: 18.500+2=18.502. Esto seria sumar 2 pesos, no multiplicar por 2 kilos. -->

### Explicacion Pedagogica
Multiplicar un numero decimal por un entero se hace igual que con numeros naturales. $18.500 × 2 = $37.000. Santiago debe pagar $37.000 por los 2 kilos de carne.
...
- [ ] D) 1,35 m <!-- feedback: Incorrect. Las unidades son km, no m. 1,35 km = 1.350 m. La respuesta numerica esta bien pero la unidad esta mal. -->

### Explicacion Pedagogica
Para restar numeros decimales, alineamos las comas decimales y restamos como si fueran enteros, manteniendo la coma en el resultado:
2,75 - 1,40 = 1,35 km. A Mateo le faltan 1,35 km para llegar al colegio.
...
- [ ] D) 32,3 litros <!-- feedback: Incorrect. Error: 45,5-13,0=32,5. Si se resta 12,3 en vez de 12,8, da 32,3. La cantidad es 12,8, no 12,3. -->

### Explicacion Pedagogica
Restamos la cantidad actual de la capacidad total: 45,5 - 12,8 = 32,7 litros. Don Carlos necesita 32,7 litros para llenar el tanque.
...
- [ ] D) $1.400 <!-- feedback: Incorrect. Calcular solo 0,5 × 2.800 = 1.400. Falta el costo de los 3 kilos completos. -->

### Explicacion Pedagogica
Multiplicamos el precio por kilo por la cantidad: 2.800 × 3,5 = 2.800 × (3 + 0,5) = 2.800 × 3 + 2.800 × 0,5 = 8.400 + 1.400 = 9.800. Maria Jose debe pagar $9.800.
...
- [ ] D) 4 tarros <!-- feedback: Incorrect. 3 tarros cubren 37,5 m² que ya es suficiente para 28 m². 4 tarros seria excesivo. -->

### Explicacion Pedagogica
1. Calculamos el area de la pared: 8,75 × 3,2 = 28 m².
2. Dividimos el area total entre la cobertura por tarro: 28 ÷ 12,5 = 2,24.
3. Como no se puede comprar 0,24 de un tarro, necesitamos 3 tarros enteros.
Camilo necesita comprar 3 tarros de pintura (2 no alcanzan pero 3 si).
...
- [ ] D) $10.350 <!-- feedback: Incorrect. Error: 4.500×2,3=10.350. Se usa 2,3 en vez de 2,35. Faltan los 0,05 kg. -->

### Explicacion Pedagogica
Multiplicamos: 4.500 × 2,35.
Descomponemos: 2,35 = 2 + 0,3 + 0,05.
4.500 × 2 = 9.000
4.500 × 0,3 = 1.350
4.500 × 0,05 = 225
Total: 9.000 + 1.350 + 225 = 10.575.
Lucia debe pagar $10.575 por las manzanas.
...
- [ ] D) 3,5 <!-- feedback: Incorrect. 3,5 es la nota mas baja, no el promedio. El promedio se calcula sumando todas y dividiendo entre 5. -->

### Explicacion Pedagogica
Para calcular el promedio:
1. Sumamos todas las notas: 4,5 + 3,8 = 8,3; 8,3 + 4,2 = 12,5; 12,5 + 5,0 = 17,5; 17,5 + 3,5 = 21,0.
2. Dividimos entre el numero de notas: 21,0 ÷ 5 = 4,2.
El promedio de Santiago en matematicas es 4,2.
...
- [ ] D) $200 <!-- feedback: Incorrect. Error: 78.500-78.300=200. La cuenta es 78.350, no 78.300. La diferencia es 150. -->

### Explicacion Pedagogica
Restamos el valor real del valor que dice el mesero:
78.500 - 78.350 = 150.
El mesero esta cobrando $150 de mas. La familia debe pagar $78.350, no $78.500.
Siempre es importante verificar las cuentas, especialmente con numeros decimales.
...
- [ ] D) Si, porque 4.250+2.800=7.050 y 7.050+6.500=14.550 <!-- feedback: Incorrect. 7.050+6.500=13.550, no 14.550. Este es un error comun al sumar centenas: 50+500=550, no 1.550. -->

### Explicacion Pedagogica
Verifiquemos la suma paso a paso:
4.250 + 2.800 = 7.050
7.050 + 6.500 = 13.550
