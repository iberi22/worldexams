...
tema: "enteros-operaciones-combinadas"
periodo: 1
week: 3
year: 2026
bundle_type: "weekly"
...
**Grado:** 6Â° | **Periodo:** 1 | **Semana:** 3 | **AÃ±o:** 2026
...
- [ ] D) De derecha a izquierda, sin importar las operaciones <!-- feedback: Incorrect. Las operaciones se resuelven de izquierda a derecha (cuando tienen igual prioridad), no de derecha a izquierda. -->

### Explicacion Pedagogica
La jerarquia de operaciones (tambien conocida como PEMDAS en ingles o PAPOMUDAS en espaÃ±ol) establece:
1. **Parentesis** y corchetes (lo que este dentro se resuelve primero)
2. **Potenciacion** (cuando aplique)
3. **Multiplicacion y Division** (de izquierda a derecha, tienen igual prioridad)
4. **Adicion y Sustraccion** (de izquierda a derecha, tienen igual prioridad)
...
- [ ] D) 12 <!-- feedback: Incorrect. Error: 8 + 6 = 14, 14 - 10 = 4. O pensar que (6 - 10) = 4 en vez de -4, y luego 8 + 4 = 12. -->

### Explicacion Pedagogica
Siempre resolvemos primero lo que esta dentro del parentesis:
- Dentro del parentesis: 6 - 10 = -4
- Fuera del parentesis: 8 + (-4)
- Recordar que sumar un numero negativo equivale a restar: 8 + (-4) = 8 - 4 = 4.
...
- [ ] D) 7 <!-- feedback: Incorrect. Error comun: 12 Ã· (-3) = -4, pero luego hacer -4 - 5 = -9, y -9 + 2 = -7 (confundir multiplicacion con suma). -->

### Explicacion Pedagogica
Aplicamos la jerarquia paso a paso:
1. No hay parentesis, pasamos al siguiente nivel.
2. Division y multiplicacion tienen igual prioridad, se resuelven de izquierda a derecha:
   - Primero: 12 Ã· (-3) = -4 (signos diferentes â†’ negativo)
   - Luego: -4 Ã— 2 = -8 (signos diferentes â†’ negativo)
3. Finalmente: -8 - 5 = -13 (suma de dos numeros negativos)
...
- [ ] D) -24 <!-- feedback: Incorrect. Error comun: resolver (-4) Ã— 7 = -28, luego 8 Ã— (-9) = -72, y sumar: -28 + (-72) = -100, o pensar que 4 Ã— (-2) = -8, pero multiplicar por algo mas. -->

### Explicacion Pedagogica
Siempre se resuelven PRIMERO los parentesis:
- Parentesis 1: (-4 + 8) = 4
- Parentesis 2: (7 - 9) = -2
- Luego se multiplican los resultados: 4 Ã— (-2) = -8
Regla clave: los parentesis agrupan operaciones que deben resolverse antes de cualquier otra cosa.
...
- Lunes: gasta $8,000 en el almuerzo
- Martes: recibe $5,000 de su abuela
- Miercoles: gasta $12,000 en un cuaderno
- Jueves: gasta $3,000 en onces
...
- [ ] D) 25,000 - 8,000 + 5,000 - 12,000 + 3,000 = 13,000 <!-- feedback: Incorrect. Sumar los $3,000 de las onces como si fuera ingreso en vez de gasto. Las onces son un gasto, deben restarse. -->

### Explicacion Pedagogica
Identificamos cada cantidad como ingreso (+) o gasto (-):
- Mesada: +$25,000 (ingreso)
- Almuerzo: -$8,000 (gasto)
- Regalo abuela: +$5,000 (ingreso)
- Cuaderno: -$12,000 (gasto)
- Onces: -$3,000 (gasto)

Expresion completa: 25,000 - 8,000 + 5,000 - 12,000 - 3,000
...
- [ ] D) Faltan $65,000 <!-- feedback: Incorrect. Interpretar que los $200,000 no alcanzan cuando en realidad sobran. Sumar los gastos correctamente pero invertir la conclusion (falta cuando sobra). -->

### Explicacion Pedagogica
Primero calculamos el gasto total:
$45,000 + $38,000 + $52,000 = $135,000

Luego calculamos la diferencia con el dinero disponible:
$200,000 - $135,000 = $65,000

Como el resultado es positivo, significa que SOBRA dinero. Si el resultado hubiera sido negativo, significaria que FALTA.
...
- Sube 400 metros hasta la primera parada
- Sube 800 metros mas hasta la cima
- Baja 500 metros hasta un mirador
- Baja 700 metros hasta la base
...
- [ ] D) 400 - 800 + 500 - 700 = -600 m <!-- feedback: Incorrect. Confundir los signos de las etapas. La segunda etapa es subir (+800), no bajar (-800). La tercera es bajar (-500), no subir (+500). -->

### Explicacion Pedagogica
Representamos cada etapa con su signo:
- Sube 400 m: +400
- Sube 800 m: +800
- Baja 500 m: -500 (o +(-500))
- Baja 700 m: -700 (o +(-700))

Expresion completa: 400 + 800 + (-500) + (-700)
Resolviendo paso a paso:
400 + 800 = 1,200
1,200 + (-500) = 700
700 + (-700) = 0

El teleferico regresa exactamente a la base (0 metros).
...
- Las cartas rojas suman puntos
- Las cartas negras restan puntos
...
- [ ] D) -27 puntos <!-- feedback: Incorrect. Invertir todos los signos: tratar rojas como negativas y negras como positivas: (-6) + 9 + 4 + (-3) + 5 = 9. O sumar todo negativo: -27. Error de lectura de reglas. -->
...
- [ ] D) 22 <!-- feedback: Incorrect. Resolver hasta 20 - (-2) = 22, pero olvidar restar el 3 final. La expresion completa tiene "- 3" al final que debe incluirse. -->

### Explicacion Pedagogica
Resolvemos de adentro hacia afuera:
1. Parentesis interno: (8 - 15) = -7
2. La expresion queda: 20 - [12 + (-7) Ã— 2] - 3
3. Multiplicacion dentro del corchete: (-7) Ã— 2 = -14
4. Suma dentro del corchete: 12 + (-14) = -2
5. La expresion queda: 20 - (-2) - 3
6. 20 - (-2) = 20 + 2 = 22
7. 22 - 3 = 19

El resultado final es 19.
...
- [ ] D) No, el resultado correcto es -11 <!-- feedback: Incorrect. Error comun: (-3)Ã—4 = -12; 12Ã·(-3) = -4; -12 + (-4) = -16; y luego sumar el 5 en vez de restarlo: -16 + 5 = -11, pero la operacion es -5, no +5. -->

### Explicacion Pedagogica
Resolvemos paso a paso respetando la jerarquia de operaciones:

1. No hay parentesis, pasamos a multiplicacion y division (izquierda a derecha):
   - (-3) Ã— 4 = -12 (signos diferentes â†’ negativo)
   - 12 Ã· (-3) = -4 (signos diferentes â†’ negativo)

2. La expresion queda: -12 + (-4) - 5

3. Sumamos de izquierda a derecha:
   - -12 + (-4) = -16
   - -16 - 5 = -21

El error de Carlos pudo ser:
- Pensar que 12 Ã· (-3) = 4 (ignorar el signo negativo del divisor)
- O resolver (-3)Ã—4 = 12 (ignorar el signo negativo del -3)
- O hacer 4 + 12 = 16 y luego operar incorrectamente
El resultado correcto es -21.
