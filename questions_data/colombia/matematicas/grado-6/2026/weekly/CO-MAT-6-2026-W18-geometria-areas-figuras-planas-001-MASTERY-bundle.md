...
tema: "geometria-areas-figuras-planas"
periodo: 2
week: 18
year: 2026
bundle_type: "weekly"
...
- [ ] D) El gramo (g) <!-- feedback: Incorrecto. El gramo mide masa, no área. -->
...
- [ ] D) Área = base ÷ altura <!-- feedback: Incorrecto. El área se multiplica: base × altura, no se divide. -->
...
- [ ] D) 12 m² <!-- feedback: Incorrecto. 4×3=12. Error: usar 3 m en vez de 3,5 m. -->
...
- [ ] D) 36 m² <!-- feedback: Incorrecto. 6²=36. Error: confundir 12² con 6², o 12÷2=6. 12²=12×12=144. -->
...
- [ ] D) 1,5 tarros <!-- feedback: Incorrecto matemáticamente es correcto (15÷10=1,5), pero no se puede comprar medio tarro de pintura. -->
...
- [ ] D) 12 m² <!-- feedback: Incorrecto. (8×6)/4=12. Error: dividir entre 4 en vez de entre 2. -->
...
- [ ] D) No se puede comparar <!-- feedback: Incorrecto. Sí se puede: ambos tienen área de 49 m². -->
...
- [ ] D) 50 m² <!-- feedback: Incorrecto. 60-10=50. Error: estimar el área de la fuente como 10 en vez de 12,56. -->
...
- [ ] D) 3 veces <!-- feedback: Incorrecto. Solo considerar la altura triplicada, olvidando la base duplicada. -->
...
- [ ] D) No se puede saber porque tienen el mismo perímetro <!-- feedback: Incorrecto. Sí se puede calcular. Con el mismo perímetro, la forma más cuadrada da mayor área. -->
