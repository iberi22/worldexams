---
id: "CO-MAT-6-2026-W28-divisibilidad-criterios-mcm-mcd-001-MASTERY-bundle"
country: "colombia"
grado: 6
asignatura: "matematicas"
tema: "divisibilidad-criterios-mcm-mcd"
periodo: 4
week: 28
year: 2026
bundle_type: "weekly"
...
**Grado:** 6 | **Periodo:** 4 | **Semana:** 28 | **Anio:** 2026
...
- [ ] D) Cuando termina en 0 <!-- feedback: Incorrecto. -->

### Explicacion Pedagogica
Un numero es divisible entre 2 si es par (termina en cifra par).
...
- [ ] D) Cuando es impar <!-- feedback: Incorrecto. -->

### Explicacion Pedagogica
Ejemplo: 123 -> 1+2+3=6, 6 es multiplo de 3.
...
- [ ] D) No, porque 845/5=169 no es entero <!-- feedback: Incorrecto. -->

### Explicacion Pedagogica
Divisible entre 5 si termina en 0 o 5. 845 termina en 5, si es divisible.
...
- [ ] D) 20 <!-- feedback: 2+0=2 no es multiplo de 3. -->

### Explicacion Pedagogica
24: par (divisible entre 2). 2+4=6 (divisible entre 3).
...
- [ ] D) Es multiplo de 3 <!-- feedback: Incorrecto. -->

### Explicacion Pedagogica
Divisible entre 6 = divisible entre 2 y 3. Ej: 24, 36, 42.
...
### Explicacion Pedagogica
24=2^3x3, 36=2^2x3^2. mcd=2^2x3=12.
...
- [ ] D) Cada 25s <!-- feedback: Incorrecto. -->

### Explicacion Pedagogica
mcm(10,15): 10=2x5, 15=3x5. mcm=2x3x5=30s.
...
- [ ] D) 420 cm <!-- feedback: Incorrecto. -->

### Explicacion Pedagogica
60=2^2x3x5, 84=2^2x3x7. mcd=2^2x3=12 cm cada pedazo.
...
- [ ] D) Son iguales <!-- feedback: Incorrecto. -->
