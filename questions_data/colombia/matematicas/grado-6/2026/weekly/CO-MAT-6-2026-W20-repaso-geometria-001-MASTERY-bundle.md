...
- [ ] D) El producto de base por altura <!-- feedback: Incorrecto. Esa es la fórmula del área de un rectángulo. -->
...
- [ ] D) lado × 3 <!-- feedback: Incorrecto. Eso es el perímetro de un triángulo equilátero. -->
...
- [ ] D) 61 m <!-- feedback: Incorrecto. 18+25+18=61. Falta un lado de 25 m: 18+25+18+25=86. -->
...
- [ ] D) 300 m² <!-- feedback: Incorrecto. 30×10=300. Error: multiplicar por 10 en vez de por 30. -->
...
- [ ] D) 27 m² <!-- feedback: Incorrecto. (12×9)/4=27. Error: dividir entre 4 en vez de entre 2. -->
...
- [ ] D) 360 m <!-- feedback: Incorrecto. 24×15=360. Error: calcular área y no perímetro. -->
...
- [ ] D) 30 cm² <!-- feedback: Incorrecto. 18+12=30. Error: sumar base y altura. -->
...
- [ ] D) No se puede saber <!-- feedback: Incorrecto. Sí se puede: cuadrado A=100. Rectángulo con L=12, A=8: A=96<100. -->
...
- [ ] D) 1.436 m² <!-- feedback: Incorrecto. 1.500-64=1.436. Error: 64 sería para 4 jardineras, pero son solo 2. -->
...
- [ ] D) 750 cm³ <!-- feedback: Incorrecto. (30-5)×(20-5)=25×15=375. 375×5=1.875. Error: restar 5 en vez de 10. -->
