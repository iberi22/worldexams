...
- [ ] D) 2¹ <!-- feedback: Incorrect. Restar exponentes: 3-2=1. En producto de potencias de igual base, los exponentes se SUMAN, no se restan. -->

### Explicacion Pedagogica
Propiedad: Producto de potencias de igual base.
a^m × a^n = a^(m+n)
2³ × 2² = 2^(3+2) = 2⁵ = 32.
Verificacion: 2³=8, 2²=4, 8×4=32=2⁵. ✓
...
- [ ] D) 1³ <!-- feedback: Incorrect. Dividir las bases: 3÷3=1 y restar exponentes: 5-2=3 → 1³=1. La base se conserva, no se divide. -->

### Explicacion Pedagogica
Propiedad: Cociente de potencias de igual base.
a^m ÷ a^n = a^(m-n), con a ≠ 0.
3⁵ ÷ 3² = 3^(5-2) = 3³ = 27.
Verificacion: 3⁵=243, 3²=9, 243÷9=27=3³. ✓
...
- [ ] D) 4³ <!-- feedback: Incorrect. Multiplicar bases: 2×2=4, conservar exponente 3. (2³)² = 2⁶. 4³ = 64, que es el mismo resultado, pero la expresion correcta es 2⁶. -->

### Explicacion Pedagogica
Propiedad: Potencia de una potencia.
(a^m)^n = a^(m×n)
(2³)² = 2^(3×2) = 2⁶ = 64.
Verificacion: 2³=8, 8²=64=2⁶. ✓
...
- [ ] D) 6² <!-- feedback: Es correcto numericamente (2×3=6, 6²=36), pero la forma DESARROLLADA usando la propiedad es 2²×3². -->

### Explicacion Pedagogica
Propiedad: Potencia de un producto.
(a×b)^n = a^n × b^n
(2×3)² = 2² × 3² = 4 × 9 = 36.
Verificacion directa: (2×3)² = 6² = 36. ✓
...
- [ ] D) 50 <!-- feedback: Incorrect. Confundir 5⁰ con 50. 5⁰ = 1, no 50. -->

### Explicacion Pedagogica
Propiedad: Exponente cero.
Cualquier numero diferente de cero elevado a la 0 es igual a 1.
a⁰ = 1, con a ≠ 0.
Explicacion: 5³÷5³ = 5^(3-3) = 5⁰, pero tambien 125÷125=1. Por lo tanto 5⁰ = 1.
...
- [ ] D) $64.000 <!-- feedback: Incorrect. 2.000×2⁵=64.000. Eso seria despues de 5 años, no 4. El exponente debe ser 4 (años). -->

### Explicacion Pedagogica
Como el dinero se multiplica por 2 cada año, usamos potencias de base 2:
Año 0: $2.000 = 2.000 × 2⁰ = 2.000 × 1 = 2.000
Año 1: 2.000 × 2¹ = 4.000
Año 2: 2.000 × 2² = 8.000
Año 3: 2.000 × 2³ = 16.000
Año 4: 2.000 × 2⁴ = 2.000 × 16 = 32.000
Despues de 4 años hay $32.000.
...
- [ ] D) 2⁴ <!-- feedback: Incorrect. 4+3-2=5, no 4. Error: 2⁴×2³=2⁷ (4+3=7); 2⁷÷2²=2⁵ (7-2=5). -->

### Explicacion Pedagogica
Aplicamos las propiedades paso a paso:
Paso 1: Producto: 2⁴ × 2³ = 2^(4+3) = 2⁷.
Paso 2: Division: 2⁷ ÷ 2² = 2^(7-2) = 2⁵.
Resultado simplificado: 2⁵ = 32.
Orden de las propiedades: primero multiplicacion (suma exponentes), luego division (resta exponentes).
...
- [ ] D) 16 veces mas grande <!-- feedback: Incorrect. 2⁴=16. El exponente del factor es 2 (cuadrado), no 4. (2L)²=4L², por lo tanto 4 veces. -->

### Explicacion Pedagogica
Area original: A₁ = 5² = 25 m².
Nuevo lado: 2×5 = 10 m.
Nueva area: A₂ = (2×5)² = 2²×5² = 4×25 = 100 m² (usando la propiedad potencia de un producto).
Razon: A₂ ÷ A₁ = 100 ÷ 25 = 4.
El area se hace 4 veces mas grande. Esto es porque el area depende del cuadrado del lado.
...
- [ ] D) 6⁴ ÷ 6² = 6⁸ <!-- feedback: Incorrect. 6⁴÷6² = 6⁴⁻²=6². 6²=36. Error: sumar en vez de restar: 4+2=8. -->

### Explicacion Pedagogica
Analicemos cada igualdad:
A) 2⁴×2³ = 2⁷, no 4⁷. 4⁷ = (2²)⁷ = 2¹⁴. ✗
B) (3²)³ = 3⁶, no 3⁵. 3⁶ = 729, 3⁵ = 243. ✗
C) 5⁰×5³ = 1×125 = 125 = 5³. ✓ Cierta.
D) 6⁴÷6² = 6², no 6⁸. ✗
La unica igualdad verdadera es C.
...
- [ ] D) Juan: 2⁶ <!-- feedback: Incorrect. Error: 4+2=6 y olvidar la division entre 2³ por completo. O hacer 4×2=8 y 8-2=6. El resultado correcto es 2³. -->

### Explicacion Pedagogica
Resolvamos paso a paso:
Paso 1: Producto en el numerador: 2⁴ × 2² = 2^(4+2) = 2⁶.
