...
- [ ] D) Una figura abierta con lados rectos <!-- feedback: Incorrecto. Un polígono debe ser una figura CERRADA. -->
...
- [ ] D) 24 m <!-- feedback: Incorrecto. Solo contar dos lados: 12+12=24. Faltan los dos lados de 8 m. -->
...
- [ ] D) 45 cm <!-- feedback: Incorrecto. 45 cm es la medida de un solo lado. El perímetro suma los 3. -->
...
- [ ] D) 45 m <!-- feedback: Incorrecto. 3×15=45. Error: multiplicar vueltas por un lado en vez del perímetro. -->
...
- [ ] D) 80 cm <!-- feedback: Incorrecto. 5×8×2=80. Error: solo 2 pentágonos en vez de 6. -->
...
- [ ] D) 21 postes <!-- feedback: Incorrecto. 86÷4=21,5≈21. La división correcta es 86÷2=43. -->
...
- [ ] D) No se puede determinar sin más datos <!-- feedback: Incorrecto. Sí se puede. Ambos miden 36 m. -->
...
- [ ] D) 500 m <!-- feedback: Incorrecto. 100×5=500. Error: solo multiplicar el largo por las vueltas. -->
...
- [ ] D) $180.000 <!-- feedback: Incorrecto. 15×12.000=180.000. Error: solo contar un lado. -->
...
- [ ] D) Ancho=20 m, Largo=40 m <!-- feedback: Incorrecto. 2×(20+40)=120 m. Excede los 60 m. -->
