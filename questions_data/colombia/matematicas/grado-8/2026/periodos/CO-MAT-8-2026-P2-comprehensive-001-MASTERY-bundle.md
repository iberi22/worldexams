...
tema: "productos-notables, ecuaciones-lineales-2var, datos-bivariados"
periodo: 2
...
Este bundle cubre productos notables básicos, ecuaciones lineales con dos variables y análisis de datos bivariados en contextos colombianos.
...
- [ ] D) $x^2 + 9$ <!-- feedback: Incorrect. $(x+3)(x-3) = x^2 - 9$, no $x^2 + 9$. -->

### Explicación Pedagógica
La diferencia de cuadrados es un producto notable: $(a+b)(a-b) = a^2 - b^2$. Los términos lineales se cancelan porque son opuestos.
...
- [ ] D) $2x^2 + 2x + 1$ <!-- feedback: Incorrect. $(2x)^2 = 4x^2$ y $2(2x)(1) = 4x$. -->

### Explicación Pedagógica
El cuadrado de un binomio $(a+b)^2 = a^2 + 2ab + b^2$. Es importante elevar cada término al cuadrado y no olvidar el doble producto.
...
- [ ] D) No, porque $(x+5)^2 = x^2 - 10x + 25$. <!-- feedback: Incorrect. El signo del doble producto debe ser positivo: $2(x)(5) = 10x$. -->

### Explicación Pedagógica
El error de olvidar el término $2ab$ al desarrollar $(a+b)^2$ es muy común. Siempre debe incluirse el doble del producto de los términos.
...
- [ ] D) $3a^2 - 2b^2$ <!-- feedback: Incorrect. Los coeficientes también deben elevarse al cuadrado. -->

### Explicación Pedagógica
La suma por la diferencia de dos términos da como resultado la diferencia de sus cuadrados: $(a+b)(a-b) = a^2 - b^2$.
...
- [ ] D) $\begin{cases} x + y = 22 \\ 1500x + 2500y = 45000 \end{cases}$ <!-- feedback: Incorrect. Los precios están intercambiados entre las frutas. -->

### Explicación Pedagógica
Un sistema de ecuaciones lineales con dos variables modela situaciones con dos condiciones simultáneas. La primera ecuación suele representar cantidades y la segunda los valores totales.
...
- [ ] D) $x = 8$, $y = 2$ <!-- feedback: Incorrect. $8 + 2 = 10$, pero $8 - 2 = 6$, no 4. -->

### Explicación Pedagógica
Por el método de reducción (suma), se suman las dos ecuaciones para eliminar $y$. Luego se despeja $x$ y se sustituye para encontrar $y$.
...
- [ ] D) $(2, 0)$ <!-- feedback: Incorrect. $2(2) - 3 = 1 \neq 0$. -->

### Explicación Pedagógica
Un punto pertenece a una recta si al sustituir sus coordenadas en la ecuación se cumple la igualdad. El intercepto con el eje $y$ ocurre cuando $x = 0$.
...
- [ ] D) Relación cuadrática. <!-- feedback: Incorrect. Los puntos siguen una línea recta, no una parábola. -->

### Explicación Pedagógica
En datos bivariados, cuando una variable aumenta y la otra también lo hace de manera constante, se dice que existe una correlación lineal positiva.
...
- [ ] D) $y = x + 2$ <!-- feedback: Incorrect. Para $x=3$, $y=5$, pero el punto es $(3,6)$. -->

### Explicación Pedagógica
La recta de mejor ajuste describe la tendencia de los datos bivariados. Se verifica que los puntos estén cerca de la recta propuesta.
...
- [ ] D) $x = 6$ <!-- feedback: Incorrect. $2(6) + y = 12 \to y = 0$, pero $6 - 0 \neq 3$. -->

### Explicación Pedagógica
Por el método de reducción, se suman ambas ecuaciones: $(2x+y)+(x-y) = 3x = 15$, por lo tanto $x = 5$. Luego se sustituye para hallar $y$.
...
- [ ] D) No se puede determinar. <!-- feedback: Incorrect. Sí se puede determinar: pendientes iguales implican rectas paralelas. -->

### Explicación Pedagógica
Dos rectas son paralelas si tienen la misma pendiente ($m_1 = m_2$). El intercepto solo indica si son la misma recta (mismo $b$) o paralelas distintas ($b$ diferente).
...
- [ ] D) No existe correlación entre las variables. <!-- feedback: Incorrect. $|r| = 0.85$ indica una correlación significativa. -->

### Explicación Pedagógica
El coeficiente de correlación $r$ varía entre $-1$ y $1$. Valores cercanos a $\pm 1$ indican correlación fuerte. El signo indica la dirección: positivo (directa) o negativo (inversa).
...
- [ ] D) No, porque la pendiente es 3 y el punto no está en esa pendiente. <!-- feedback: Incorrect. El punto sí satisface la ecuación. -->

### Explicación Pedagógica
Para verificar si un punto pertenece a una recta, se sustituyen sus coordenadas en la ecuación. Si se cumple la igualdad, el punto pertenece a la recta.
...
- [ ] D) Sí, pero solo si $x$ e $y$ son enteros. <!-- feedback: Incorrect. La solución es correcta independientemente del tipo de número. -->

### Explicación Pedagógica
Para verificar la solución de un sistema, se sustituyen los valores en ambas ecuaciones. Si ambas igualdades se cumplen, la solución es correcta.
...
- [ ] D) 22 millones; no es confiable porque se necesitan más datos. <!-- feedback: Incorrect. $1.5(20) + 10 = 40$, no 22. -->
