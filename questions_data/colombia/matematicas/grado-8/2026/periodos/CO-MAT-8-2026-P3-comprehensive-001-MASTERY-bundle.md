...
tema: "factorizacion, funcion-afin-lineal, probabilidad-compuesta"
periodo: 3
...
Este bundle cubre factorización de polinomios, funciones afines y lineales, y probabilidad compuesta aplicadas a contextos colombianos.
...
- [ ] D) $6x$ <!-- feedback: Incorrect. $6x$ no divide a $3x$. -->

### Explicación Pedagógica
La factorización por factor común consiste en extraer el máximo común divisor (MCD) de todos los términos de la expresión. Se aplica la propiedad distributiva inversa.
...
- [ ] D) $(x - 2)(x - 3)$ <!-- feedback: Incorrect. $(x-2)(x-3) = x^2 - 5x + 6$, el signo del término lineal es negativo. -->

### Explicación Pedagógica
Para factorizar $x^2 + bx + c$, se buscan dos números $p$ y $q$ tales que $p + q = b$ y $p \cdot q = c$. La factorización es $(x + p)(x + q)$.
...
- [ ] D) No, porque $x^2 - 9$ no se puede factorizar. <!-- feedback: Incorrect. La diferencia de cuadrados siempre es factorizable. -->

### Explicación Pedagógica
No confundir diferencia de cuadrados ($a^2 - b^2$) con el cuadrado de un binomio ($a \pm b)^2$. La diferencia de cuadrados se factoriza como $(a+b)(a-b)$.
...
- [ ] D) $f(x) = \frac{1}{2}x - 1$ <!-- feedback: Incorrect. Es una función afín porque $b \neq 0$. -->

### Explicación Pedagógica
Una función lineal (proporcionalidad directa) tiene la forma $f(x) = mx$ con $b=0$. Una función afín tiene la forma $f(x) = mx + b$ con $b \neq 0$.
...
- [ ] D) $4(x^2 - 9y^2)$ <!-- feedback: Incorrect. Aunque es un factor común, no es la factorización completa. -->

### Explicación Pedagógica
La diferencia de cuadrados $a^2 - b^2$ se factoriza como $(a+b)(a-b)$. Es importante identificar correctamente $a$ y $b$: en $4x^2$, $a = 2x$; en $9y^2$, $b = 3y$.
...
- [ ] D) $C(x) = 5.2x$ <!-- feedback: Incorrect. Los costos fijos no dependen de $x$. -->

### Explicación Pedagógica
La función afín $f(x) = mx + b$ modela costos totales donde $m$ es el costo variable por unidad y $b$ es el costo fijo. Es importante mantener unidades consistentes.
...
- [ ] D) 10 <!-- feedback: Incorrect. 6 + 2 = 8, no 10. -->

### Explicación Pedagógica
El principio fundamental de conteo establece que si un evento A tiene $m$ formas de ocurrir y un evento B tiene $n$ formas, ambos juntos tienen $m \times n$ formas de ocurrir.
...
- [ ] D) $\frac{5}{10}$ <!-- feedback: Incorrect. $\frac{3}{10} + \frac{2}{10} = \frac{5}{10}$, pero no se suman probabilidades en eventos compuestos. -->

### Explicación Pedagógica
Para eventos independientes (con reemplazo), la probabilidad de que ambos ocurran es el producto de sus probabilidades individuales: $P(A \cap B) = P(A) \times P(B)$.
...
- [ ] D) No se puede determinar. <!-- feedback: Incorrect. Sí se puede: son exactamente la misma función. -->

### Explicación Pedagógica
Dos funciones afines $f(x) = m_1x + b_1$ y $g(x) = m_2x + b_2$ son idénticas si $m_1 = m_2$ y $b_1 = b_2$.
...
- [ ] D) $\frac{7}{36}$ <!-- feedback: Incorrect. 7/36 no corresponde a las combinaciones que suman 7. -->

### Explicación Pedagógica
La probabilidad de un evento es el cociente entre casos favorables y casos posibles. Al lanzar dos dados hay 36 resultados igualmente probables.
...
- [ ] D) Ninguno, porque la expresión no se factoriza. <!-- feedback: Incorrect. Sí es factorizable. -->

### Explicación Pedagógica
Para verificar una factorización, se multiplican los factores. Si el resultado es la expresión original, la factorización es correcta.
...
- [ ] D) 0.85 <!-- feedback: Incorrect. 0.3 + 0.4 + 0.15 = 0.85, pero la intersección se resta, no se suma. -->

### Explicación Pedagógica
La probabilidad de la unión de dos eventos se calcula con $P(A \cup B) = P(A) + P(B) - P(A \cap B)$. Se resta la intersección para no contar dos veces los elementos comunes.
...
- [ ] D) No, porque $-2$ es la tasa de cambio, pero la función es constante. <!-- feedback: Incorrect. $m=-2$ indica que la función sí cambia, y es decreciente. -->

### Explicación Pedagógica
La pendiente $m$ determina la monotonía de una función afín: $m > 0$ es creciente, $m < 0$ es decreciente, $m = 0$ es constante.
...
- [x] D) $\frac{2}{15}$ <!-- feedback: Correct. $\frac{4}{10} \times \frac{3}{9} = \frac{12}{90} = \frac{2}{15}$. -->

### Explicación Pedagógica
En eventos dependientes (sin reemplazo), la probabilidad de que ambos ocurran es $P(A \cap B) = P(A) \times P(B|A)$, donde $P(B|A)$ es la probabilidad de B dado que A ya ocurrió.
...
- [ ] D) 0.5% <!-- feedback: Incorrect. No corresponde a ningún cálculo correcto. -->
