---
id: "CO-MAT-11-2026-W35-inferencia-estadistica-001-MASTERY-bundle"
country: "colombia"
grado: 11
...
# Bundle MASTERY: Inferencia Estadística - Grado 11

Este bundle contiene 20 preguntas sobre **inferencia estadística, estimación de parámetros, intervalos de confianza y margen de error** para Grado 11, alineadas con los DBA y marcos conceptuales del ICFES Saber 11.

## Question 1 [D3-D4]
**ID:** CO-MAT-11-2026-W35-inferencia-estadistica-001-MASTERY-bundle-v1
**Bloom:** Remember
**ICFES:** Aleatorio
**Expected_Success:** 0.85
**Contexto:** En un estudio de mercado realizado en Bogotá sobre una muestra representativa de 400 personas, se estimó la media de ingresos mensuales.
...
Los parámetros resumen características de la población completa (desconocidos en general), mientras que los estadísticos (o estimadores) se calculan a partir de la muestra para aproximar dichos parámetros.

## Question 2 [D3-D4]
**ID:** CO-MAT-11-2026-W35-inferencia-estadistica-001-MASTERY-bundle-v2
**Bloom:** Remember
**ICFES:** Aleatorio
**Expected_Success:** 0.85
**Contexto:** Un analista político calcula un intervalo de confianza del 95% para la proporción de votantes a favor de un candidato en Medellín.

### Enunciado
¿Qué significa que el intervalo de confianza sea del 95%?

### Opciones
- [x] A) Que si se repitiera el muestreo muchas veces, aproximadamente el 95% de los intervalos construidos contendrían el parámetro real.
  <!-- feedback: El nivel de confianza expresa la frecuencia a largo plazo con que el procedimiento de estimación captura el parámetro poblacional verdadero. -->
- [ ] B) Que existe un 95% de probabilidad de que el candidato gane la elección.
  <!-- feedback: El nivel de confianza describe el método de estimación, no el resultado electoral. -->
- [ ] C) Que el 95% de la población votará exactamente por ese candidato.
  <!-- feedback: Confunde la proporción estimada de votos con el nivel de confianza del intervalo. -->
- [ ] D) Que la muestra contiene al 95% de los votantes de la ciudad.
  <!-- feedback: Confunde el tamaño muestral con el nivel de confianza. -->

### Explicacion Pedagogica
Un intervalo de confianza al $95%$ garantiza que el método utilizado genera intervalos que contienen el verdadero parámetro poblacional en el $95%$ de las muestras posibles.

## Question 3 [D3-D4]
**ID:** CO-MAT-11-2026-W35-inferencia-estadistica-001-MASTERY-bundle-v3
**Bloom:** Understand
**ICFES:** Aleatorio
...
**ICFES:** Aleatorio
**Expected_Success:** 0.80
**Contexto:** Un investigador aumenta el tamaño de la muestra de 100 a 400 personas en una encuesta aplicada en Barranquilla.

### Enunciado
¿Qué efecto produce este aumento del tamaño de la muestra sobre el margen de error del intervalo de confianza?

### Opciones
- [x] A) El margen de error se reduce a la mitad.
  <!-- feedback: Como el error estándar depende de 1/sqrt(n), al cuadruplicar n (de 100 a 400), sqrt(400)=20 frente a sqrt(100)=10, se reduce a la mitad. -->
- [ ] B) El margen de error se reduce a la cuarta parte.
  <!-- feedback: Olvida que la relación con n es a través de la raíz cuadrada y no lineal. -->
- [ ] C) El margen de error se duplica.
  <!-- feedback: Confunde la relación; a mayor muestra, menor es el margen de error. -->
- [ ] D) El margen de error permanece exactamente igual.
...
### Opciones
- [x] A) 1.96 kg
  <!-- feedback: E = Z * (sigma / sqrt(n)) = 1.96 * (10 / sqrt(100)) = 1.96 * (10 / 10) = 1.96 kg. -->
- [ ] B) 19.6 kg
  <!-- feedback: Se olvidó dividir entre sqrt(n) o se multiplicó por 10 directamente. -->
- [ ] C) 0.196 kg
  <!-- feedback: Se dividió dos veces por 10 por error. -->
- [ ] D) 3.92 kg
...
**ICFES:** Aleatorio
**Expected_Success:** 0.75
**Contexto:** Un intervalo de confianza del 90% para el gasto promedio diario en transporte en Bucaramanga resultó ser $[12,000; 16,000]$ COP.
...
- [ ] D) Media $\bar{x} = 16,000$ COP y Margen de error $E = 4,000$ COP
  <!-- feedback: Tomó el límite superior como el centro del intervalo. -->

### Explicacion Pedagogica
El centro del intervalo equidistante es la media muestral $\bar{x} = \frac{L_{inf} + L_{sup}}{2} = 14,000$ COP, y la semidistancia al límite es el margen de error $E = \frac{16,000 - 12,000}{2} = 2,000$ COP.

## Question 7 [D5-D6]
**ID:** CO-MAT-11-2026-W35-inferencia-estadistica-001-MASTERY-bundle-v7
**Bloom:** Apply
**ICFES:** Aleatorio
**Expected_Success:** 0.75
...
**Contexto:** Se quiere realizar una prueba de hipótesis para verificar si la altura promedio de las plantas en un cultivo en Cundinamarca supera los 50 cm.
...
### Explicacion Pedagogica
La hipótesis alternativa $H_a$ expresa la condición que el investigador desea probar (en este caso, que la media $mu$ es mayor a 50 cm). $H_0$ incluye el signo de igualdad ($le 50$).

## Question 9 [D5-D6]
**ID:** CO-MAT-11-2026-W35-inferencia-estadistica-001-MASTERY-bundle-v9
**Bloom:** Apply
**ICFES:** Aleatorio
**Expected_Success:** 0.70
...
- [ ] D) La prueba no es válida y debe repetirse.
...
## Question 12 [D7-D8]
**ID:** CO-MAT-11-2026-W35-inferencia-estadistica-001-MASTERY-bundle-v12
**Bloom:** Analyze
**ICFES:** Aleatorio
**Expected_Success:** 0.65
...
- [ ] C) Disminuye la probabilidad del Error Tipo II y aumenta el Error Tipo I.
  <!-- feedback: Invierte el efecto de reducir alpha. -->
- [ ] D) Ambas probabilidades disminuyen sin cambiar el tamaño muestral.
...
**Contexto:** Un informe estadístico presenta dos intervalos de confianza construidos sobre los mismos datos muestrales de salarios en Neiva:
Intervalo A: $[1,200,000; 1,800,000]$ COP
Intervalo B: $[1,300,000; 1,700,000]$ COP
...
### Explicacion Pedagogica
Para la misma muestra, a mayor amplitud del intervalo de confianza corresponde un valor crítico $Z$ más alto, y por consiguiente un mayor nivel de confianza. El Intervalo A es más amplio (ancho 600,000 vs 400,000), por lo que posee mayor confianza.

## Question 14 [D7-D8]
**ID:** CO-MAT-11-2026-W35-inferencia-estadistica-001-MASTERY-bundle-v14
**Bloom:** Analyze
**ICFES:** Aleatorio
**Expected_Success:** 0.60
...
- [x] A) Rechazar $H_0$, ya que el estadístico cae exactamente sobre el límite de la región de rechazo.
  <!-- feedback: Al alcanzar o superar el valor crítico (Z_calc >= Z_crit), la evidencia se encuentra en la región de rechazo. -->
- [ ] B) No rechazar $H_0$, porque se requiere estrictamente que sea mayor a 3.0.
  <!-- feedback: La regla de rechazo utiliza el valor crítico Z_crit correspondiente al nivel alpha. -->
- [ ] C) Aceptar $H_0$ concluyendo que el método empeora el desempeño.
  <!-- feedback: El valor positivo indica una mejora muestral en la dirección de la hipótesis alternativa. -->
- [ ] D) Modificar el nivel de significancia a 5% para poder decidir.
...
### Opciones
- [x] A) 2.0
  <!-- feedback: p_hat = 60/100 = 0.6. Z = (0.6 - 0.5) / sqrt((0.5*0.5)/100) = 0.1 / sqrt(0.0025) = 0.1 / 0.05 = 2.0. -->
- [ ] B) 1.0
  <!-- feedback: Se dividió 0.1 entre 0.1 por error. -->
- [ ] C) 4.0
  <!-- feedback: Olvidó extraer la raíz cuadrada del denominador. -->
- [ ] D) 0.2
...
## Question 17 [D9-D10]
**ID:** CO-MAT-11-2026-W35-inferencia-estadistica-001-MASTERY-bundle-v17
**Bloom:** Evaluate
**ICFES:** Aleatorio
...
## Question 18 [D9-D10]
**ID:** CO-MAT-11-2026-W35-inferencia-estadistica-001-MASTERY-bundle-v18
**Bloom:** Evaluate
**ICFES:** Aleatorio
**Expected_Success:** 0.50
**Contexto:** Un politólogo en Medellín desea estimar una proporción con un margen de error máximo de $3%$ ($E = 0.03$) y $95%$ de confianza ($Z = 1.96$). No dispone de estudios previos sobre el valor de $p$.
...
## Question 19 [D9-D10]
**ID:** CO-MAT-11-2026-W35-inferencia-estadistica-001-MASTERY-bundle-v19
**Bloom:** Evaluate
**ICFES:** Aleatorio
...
- [ ] D) La prueba no es concluyente sin calcular directamente el $p$-valor.
