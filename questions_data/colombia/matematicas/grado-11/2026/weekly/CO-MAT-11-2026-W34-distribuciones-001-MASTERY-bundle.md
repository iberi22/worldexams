...
### Opciones
- [x] A) 1
  <!-- feedback: Por axiómatica de la probabilidad, la suma de las probabilidades sobre todo el espacio muestral es siempre igual a 1. -->
- [ ] B) 100
  <!-- feedback: Se confundió el valor 1 de la probabilidad teórica con el porcentaje del 100%. -->
- [ ] C) 0
  <!-- feedback: La suma no puede ser 0 ya que indicaría un evento imposible en todo el espacio muestral. -->
...
**ICFES:** Aleatorio
**Expected_Success:** 0.85
**Contexto:** Se presenta una tabla de distribución de probabilidad para la cantidad de carros vendidos en un día en un concesionario de Bogotá:
$X = 0 Rightarrow P = 0.5$, $X = 1 Rightarrow P = 0.3$, $X = 2 Rightarrow P = 0.2$.

### Enunciado
¿Cuál es la probabilidad de vender al menos 1 carro en un día determinado?

### Opciones
- [x] A) 0.5
  <!-- feedback: P(X >= 1) = P(X=1) + P(X=2) = 0.3 + 0.2 = 0.5. O también 1 - P(X=0) = 1 - 0.5 = 0.5. -->
- [ ] B) 0.3
...
**ICFES:** Aleatorio
**Expected_Success:** 0.80
**Contexto:** En un experimento binomial de 10 ensayos independientes con probabilidad de éxito $p = 0.4$ en cada ensayo.
...
**Contexto:** En un juego de lotería en Cali, un billete cuesta 5,000 COP. La probabilidad de ganar un premio de 100,000 COP es 0.02, y la probabilidad de no ganar nada es 0.98.
...
- [ ] D) 0 COP
  <!-- feedback: Se asumió incorrectamente que el juego es totalmente justo. -->
...
- [ ] D) $\frac{1}{5}$
  <!-- feedback: Se dividió 1 entre el número total de preguntas. -->
...
### Explicacion Pedagogica
El intervalo $[300 - 2(40), 300 + 2(40)] = [220, 380]$ representa 2 desviaciones estándar a cada lado de la media. Por regla empírica, abarca el $95%$ de los datos.
...
**ICFES:** Aleatorio
**Expected_Success:** 0.70
**Contexto:** Una variable aleatoria discreta $X$ representa el número de fallas en un equipo en Bucaramanga y tiene la siguiente tabla:
...
- [ ] B) 1.0
  <!-- feedback: Se calculó (185 - 170) / 15. -->
- [ ] C) 15.0
  <!-- feedback: Se restó 185 - 170 pero se olvidó dividir entre la desviación estándar sigma. -->
- [ ] D) -1.5
  <!-- feedback: Se restó en orden inverso (170 - 185) obteniendo un signo negativo erróneo. -->

### Explicacion Pedagogica
El puntaje estandarizado $Z$ mide cuántas desviaciones estándar está un dato por encima o por debajo de la media: $Z = \frac{X - mu}{sigma} = \frac{185 - 170}{10} = 1.5$.
...
- [ ] D) 0.9544
  <!-- feedback: Corresponde al área dentro de 2 desviaciones estándar en lugar de 1. -->

### Explicacion Pedagogica
Por simetría, $P(Z < -1) = 1 - P(Z < 1) = 1 - 0.8413 = 0.1587$. Por lo tanto, $P(-1 < Z < 1) = 0.8413 - 0.1587 = 0.6826$.
...
**ICFES:** Aleatorio
**Expected_Success:** 0.60
**Contexto:** Una prueba de 4 preguntas de opción múltiple tiene 4 opciones por pregunta ($p = 0.25$).
...
**Contexto:** Un inversionista en Bogotá analiza un proyecto. Si la economía crece, ganará 50 millones COP con probabilidad 0.4. Si permanece estable, ganará 10 millones con probabilidad 0.4. Si entra en recesión, perderá 30 millones con probabilidad 0.2.
...
### Explicacion Pedagogica
$E[X] = 50(0.4) + 10(0.4) + (-30)(0.2) = 20 + 4 - 6 = 18$ millones COP. Como el ingreso esperado de 18 millones es menor que el costo de inversión de 20 millones, el rendimiento neto esperado es negativo ($-2$ millones).
...
### Explicacion Pedagogica
Estandarizando la variable: $Z_1 = \frac{4.5 - 6}{1.5} = -1.0$ y $Z_2 = \frac{7.5 - 6}{1.5} = 1.0$. Por la regla empírica de la normal, el área comprendida entre $Z = -1$ y $Z = 1$ es aproximadamente $0.683$ (68%).
