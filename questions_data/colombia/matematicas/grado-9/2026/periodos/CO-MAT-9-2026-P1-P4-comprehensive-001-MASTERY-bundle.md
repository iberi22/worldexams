...
tema: "productos-notables, factorizacion, funcion-cuadratica, pitagoras, estadistica-descriptiva, probabilidad, funciones-lineales"
periodo: "P1-P4"
...
rubric_baseline: "Productos notables, factorización, función cuadrática, teorema de Pitágoras, estadística descriptiva, probabilidad, funciones lineales, geometría analítica"
coverage:
  - "P1: Productos notables y factorización"
...
Este bundle integral cubre los cuatro periodos de grado 9 en matemáticas: productos notables, factorización, función cuadrática, teorema de Pitágoras, estadística descriptiva, probabilidad y funciones lineales, con contextos colombianos contemporáneos.
...
- [ ] D) $4x^2 + 6x + 9$ <!-- feedback: Incorrect. El término $2ab$ da $2(2x)(3) = 12x$, no $6x$. -->

### Explicación Pedagógica
El cuadrado de un binomio $(a+b)^2$ se desarrolla como $a^2 + 2ab + b^2$. Es fundamental recordar que el término medio es el **doble del producto** de ambos términos, no simplemente el producto.
...
- [ ] D) $(x-4)(x-9)$ <!-- feedback: Incorrect. $(x-4)(x-9) = x^2 - 13x + 36$, el coeficiente lineal es -13, no -12. -->

### Explicación Pedagógica
Para identificar un trinomio cuadrado perfecto (TCP), se verifica que el término independiente sea un cuadrado perfecto y que el coeficiente lineal sea el doble de la raíz cuadrada de dicho término: $(-6)^2 = 36$ y $2(1)(-6) = -12$.
...
- [ ] D) $x^2 + 4x + 96 = 0$ <!-- feedback: Incorrect. El término independiente debe ser $-96$, no $+96$, al igualar a cero. -->

### Explicación Pedagógica
Los problemas de áreas se modelan mediante ecuaciones cuadráticas. Al expandir $x(x+4) = 96$ obtenemos $x^2 + 4x - 96 = 0$, que se resuelve factorizando: $(x+12)(x-8) = 0$, dando $x=8$ m (ancho) y $x+4=12$ m (largo).
...
- [ ] D) 2 horas <!-- feedback: Incorrect. $h(2) = -16 + 48 + 100 = 132$ m, pero la altura máxima es mayor. El vértice está en $t=3$. -->

### Explicación Pedagógica
Para una función cuadrática $f(x) = ax^2 + bx + c$, el vértice se encuentra en $x_v = -\frac{b}{2a}$. Como $a < 0$, la parábola abre hacia abajo y el vértice representa el valor máximo.
...
- [ ] D) 30 m <!-- feedback: Incorrect. 30 es el término independiente $f(0)$, no la coordenada del vértice. -->

### Explicación Pedagógica
En funciones cuadráticas de la forma $f(x) = ax^2 + bx + c$ con $a > 0$, el vértice es el punto mínimo. Se calcula con $x_v = -\frac{b}{2a}$ y $y_v = f(x_v)$. Luego se evalúa $f(12) = \frac{1}{8}(144) - 36 + 30 = 18 - 36 + 30 = 12$ m de altura mínima.
...
- [ ] D) 7 m <!-- feedback: Incorrect. La altura no puede ser igual a la longitud de la escalera a menos que la base esté en $(0,0)$. -->

### Explicación Pedagógica
En un triángulo rectángulo, $c^2 = a^2 + b^2$, donde $c$ es la hipotenusa. Si la hipotenusa es 7 m y un cateto es 2 m, el otro cateto es $h = \sqrt{7^2 - 2^2} = \sqrt{49 - 4} = \sqrt{45} \approx 6.71$ m.
...
- [ ] D) No, porque $3x - 2$ y $3x + 4$ se intersectan en un punto. <!-- feedback: Incorrect. Dos rectas con igual pendiente nunca se intersectan (a menos que sean la misma recta). -->

### Explicación Pedagógica
Dos rectas con ecuaciones de la forma $y = mx + b$ son paralelas si $m_1 = m_2$, sin importar el valor de $b$. Sus pendientes iguales (3) garantizan que nunca se cruzarán.
...
- [ ] D) $x = -1$ y $x = -3$ <!-- feedback: Incorrect. Verificando $x=-1$: $-2(1) + 8(-1) - 6 = -2 - 8 - 6 = -16 \ne 0$. -->

### Explicación Pedagógica
Las raíces de una función cuadrática se encuentran factorizando o usando la fórmula cuadrática. Aquí se factoriza factor común $-2$: $f(x) = -2(x^2 - 4x + 3) = -2(x-1)(x-3)$, dando las raíces $x=1$ y $x=3$.
...
- [ ] D) 3.5 <!-- feedback: Incorrect. 3.5 sería el promedio de las posiciones 9 y 10 $(4+3)/2$, pero la mediana usa las posiciones 10 y 11. -->

### Explicación Pedagógica
Para un conjunto con número par de datos, la mediana es el promedio de los dos valores centrales. Ordenando los 20 datos: posiciones 10° y 11° son 4 y 5 respectivamente, dando mediana = $(4+5)/2 = 4.5$ horas.
...
- [ ] D) 80% <!-- feedback: Incorrect. 80% sería $P(\text{no compra}|\text{mujer})$, no la probabilidad conjunta. -->

### Explicación Pedagógica
La probabilidad de la intersección de dos eventos se calcula multiplicando la probabilidad del evento condicionante por la probabilidad condicional: $P(A \cap B) = P(A) \cdot P(B|A)$.
...
- [ ] D) No, porque primero debe usar la fórmula cuadrática. <!-- feedback: Incorrect. La fórmula cuadrática encuentra raíces, pero la factorización por agrupación es un método válido y a menudo más directo. -->

### Explicación Pedagógica
El método de factorización por agrupación (también llamado "método del AC") es válido para trinomios de la forma $ax^2 + bx + c$. Se buscan $p$ y $q$ tales que $p \cdot q = a \cdot c$ y $p + q = b$, luego se reescribe y factoriza por grupos: $6x^2 + 15x - 4x - 10 = 3x(2x+5) - 2(2x+5) = (2x+5)(3x-2)$.
...
- [ ] D) 7°C a los 6 minutos <!-- feedback: Incorrect. La temperatura mínima de 7°C es correcta, pero ocurre a los 3 minutos, no a los 6. -->

### Explicación Pedagógica
Para encontrar el valor mínimo de una función cuadrática con $a > 0$, se calcula el vértice. $t_v = -\frac{b}{2a} = -\frac{-12}{2(2)} = 3$ minutos, y $T(3) = 2(9) - 12(3) + 25 = 7°C$.
...
- [ ] D) No, porque $3x^2 - 2x + 5$ sí tiene raíces reales. <!-- feedback: Incorrect. $\Delta = -56 < 0$ indica que NO hay raíces reales, solo complejas. -->

### Explicación Pedagógica
El discriminante $\Delta = b^2 - 4ac$ determina la naturaleza de las soluciones: $\Delta > 0$ (dos raíces reales distintas), $\Delta = 0$ (una raíz real doble), $\Delta < 0$ (dos raíces complejas, ningún corte con el eje $x$).
...
- [ ] D) 158.4 km <!-- feedback: Incorrect. 158.4 es la varianza $s^2$, no la desviación estándar. Falta sacar la raíz cuadrada. -->

### Explicación Pedagógica
La desviación estándar mide la dispersión de los datos respecto a la media. Se calcula como la raíz cuadrada de la varianza: $s = \sqrt{\frac{\sum (x_i - \bar{x})^2}{n}}$.
...
- [ ] D) $x + y = 10$, $x + 3y = 22$ <!-- feedback: Incorrect. La ecuación de puntos está invertida: los partidos ganados dan 3 puntos, los empatados 1. -->
