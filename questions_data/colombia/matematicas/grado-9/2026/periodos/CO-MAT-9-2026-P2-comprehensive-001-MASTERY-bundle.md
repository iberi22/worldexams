...
tema: "ecuacion-cuadratica, trigonometria-ratios, probabilidad-simple"
periodo: 2
...
Este bundle cubre la resolución de ecuaciones cuadráticas por fórmula general, las razones trigonométricas en triángulos rectángulos y los fundamentos de probabilidad simple, aplicados a contextos colombianos.
...
La fórmula general $x = \frac{-b \pm \sqrt{b^2 - 4ac}}{2a}$ se obtiene completando cuadrados en la forma general $ax^2 + bx + c = 0$.
...
- [ ] D) $\frac{\text{hipotenusa}}{\text{cateto opuesto}}$ <!-- feedback: Incorrect. Esa es la definición de cosecante, no de tangente. -->

### Explicación Pedagógica
Las razones trigonométricas básicas son: $\sin(\theta) = \frac{\text{CO}}{\text{H}}$, $\cos(\theta) = \frac{\text{CA}}{\text{H}}$, $\tan(\theta) = \frac{\text{CO}}{\text{CA}}$.
...
- [ ] D) $\frac{3}{4}$ <!-- feedback: Incorrect. Esto sería si hubiera 90 eléctricos, pero hay 30 de 120. -->

### Explicación Pedagógica
La probabilidad clásica de un evento es $P(E) = \frac{\text{número de casos favorables}}{\text{número de casos totales}}$. Siempre debe simplificarse la fracción.
...
- [ ] D) $4/3$ <!-- feedback: Incorrect. $4/3$ sería $\cot(\theta)$, no $\sin(\theta)$. -->

### Explicación Pedagógica
Para calcular razones trigonométricas, primero se deben identificar todos los lados del triángulo. Usamos Pitágoras para hallar el lado faltante, luego aplicamos la definición de la razón solicitada.
...
- [ ] D) $x = 7$ y $x = 3$ <!-- feedback: Incorrect. 7 es el coeficiente $b$ con signo cambiado, no una solución. -->

### Explicación Pedagógica
La fórmula general requiere identificar $a$, $b$ y $c$: $a=2$, $b=-7$, $c=3$. Sustituir en la fórmula y simplificar paso a paso.
...
- [ ] D) 0.5 <!-- feedback: Incorrect. 0.5 sería 100/200. Ningún deporte individual alcanza esa cantidad. -->

### Explicación Pedagógica
La probabilidad como frecuencia relativa se calcula dividiendo la frecuencia del evento entre el total de observaciones. $P = \frac{50}{200} = \frac{1}{4} = 0.25$.
...
- [ ] D) 0.02 <!-- feedback: Incorrect. $\frac{2}{10} = 0.2$, no 0.02. Error al dividir. -->

### Explicación Pedagógica
La rampa forma un triángulo rectángulo donde la longitud de la rampa es la hipotenusa y la altura es el cateto opuesto al ángulo de inclinación. $\sin(\theta) = \frac{2}{10} = 0.2$.
...
- [ ] D) No, porque la probabilidad de lluvia siempre debe ser menor a 0.5. <!-- feedback: Incorrect. La probabilidad de lluvia puede ser cualquier valor entre 0 y 1, no hay restricción de 0.5. -->

### Explicación Pedagógica
La probabilidad axiomáticamente satisface $0 \leq P(E) \leq 1$ para cualquier evento $E$. Un valor de 1.5 viola este axioma fundamental.
...
- [ ] D) $\Delta = 49$, dos soluciones reales <!-- feedback: Incorrect. Se calculó mal: $(-5)^2 = 25$, $4(1)(6) = 24$, $25-24=1$. -->

### Explicación Pedagógica
El discriminante $\Delta = b^2 - 4ac$ clasifica las soluciones. Para $x^2 - 5x + 6$, $\Delta = 1 > 0$ indica dos raíces reales diferentes.
...
- [ ] D) $20/80 = 0.25$ <!-- feedback: Incorrect. Solo considera la intersección (los que cultivan ambos). -->

### Explicación Pedagógica
Para eventos que no son mutuamente excluyentes, se aplica el principio de inclusión-exclusión: $P(A \cup B) = P(A) + P(B) - P(A \cap B)$.
...
- [ ] D) Son incorrectas porque el producto debe ser $-2$. <!-- feedback: Incorrect. El producto de raíces es $c/a = -2/3$, que es exactamente $(1/3)(-2) = -2/3$. -->

### Explicación Pedagógica
Las relaciones entre coeficientes y raíces permiten verificar soluciones sin sustituir: suma $= -b/a$ y producto $= c/a$. Para esta ecuación, suma $= -5/3$ y producto $= -2/3$.
...
- [ ] D) 34.64 m <!-- feedback: Incorrect. Se multiplicó por $\sin(60^\circ) \approx 0.866$ en lugar de $\tan(60^\circ)$. -->

### Explicación Pedagógica
En problemas de ángulo de elevación, $\tan(\theta) = \frac{\text{altura}}{\text{distancia horizontal}}$. Despejando: altura $= \text{distancia} \times \tan(\theta)$.
...
- [ ] D) No, porque $\sin(30^\circ) = \sqrt{3}/2$. <!-- feedback: Incorrect. $\sin(30^\circ) = 1/2$, $\cos(30^\circ) = \sqrt{3}/2$. Se confundió seno con coseno. -->

### Explicación Pedagógica
Las razones trigonométricas dependen exclusivamente del ángulo, no del tamaño del triángulo. Todos los triángulos rectángulos con un ángulo de 30° son semejantes entre sí.
...
- [ ] D) No, deberían ser 5 formas porque solo puede elegir 2 de 5. <!-- feedback: Incorrect. $\binom{5}{2} = 10$, no 5. -->

### Explicación Pedagógica
Cuando el orden no importa, se usan combinaciones: $\binom{n}{k} = \frac{n!}{k!(n-k)!}$. Cuando el orden importa, se usan permutaciones: $P(n,k) = \frac{n!}{(n-k)!}$.
...
- [ ] D) 12 s <!-- feedback: Incorrect. Se duplicó la solución correcta. -->
