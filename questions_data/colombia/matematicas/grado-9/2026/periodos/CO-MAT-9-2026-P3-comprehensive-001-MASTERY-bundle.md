---
id: "CO-MAT-9-2026-P3-comprehensive-001-MASTERY-bundle"
country: "colombia"
grado: 9
...
**Contexto:** Un estudiante en Bogotá estudia la función exponencial $f(x) = 2^x$.
...
**Expected_Success:** 0.75
**ICFES:** Comunicación y Representación
**Contexto:** En una clase de estadística en Cali, el profesor explica qué es la correlación entre dos variables.
...
**Expected_Success:** 0.75
**ICFES:** Comunicación y Representación
**Contexto:** Un estudiante en Medellín ve la gráfica de $f(x) = 3^x$ y nota que pasa por el punto $(0, 1)$.
...
**Contexto:** En un triángulo, se conocen dos lados $a = 8$ cm y $b = 12$ cm, y el ángulo entre ellos $C = 60^\circ$.
...
**Expected_Success:** 0.75
**ICFES:** Formulación y Ejecución
**Contexto:** Un biólogo en el Amazonas modela el crecimiento de una población de aves con $P(t) = 100 \cdot (1.05)^t$, donde $t$ son años.
...
**Contexto:** Un estudiante en Barranquilla afirma que la función $f(x) = \log_2(x)$ es la inversa de $g(x) = 2^x$.
...
**Expected_Success:** 0.75
**ICFES:** Formulación y Ejecución
**Contexto:** Un topógrafo en el Cauca necesita medir la distancia entre dos puntos $A$ y $B$ separados por una quebrada. Coloca un punto $C$ a 50 m de $A$, y mide el ángulo $A = 40^\circ$ y el ángulo $C = 70^\circ$.
...
**Expected_Success:** 0.75
**ICFES:** Formulación y Ejecución
**Contexto:** Una inversión de 2 millones de pesos en un CDT en un banco colombiano crece según $A = 2.000.000(1.08)^t$, donde $t$ son años.
...
**Expected_Success:** 0.75
**ICFES:** Razonamiento y Argumentación
**Contexto:** Un estudio en 10 colegios de Bogotá muestra que a mayor cantidad de horas de estudio semanal, mayor es el puntaje en las pruebas Saber.
...
**Expected_Success:** 0.75
**ICFES:** Formulación y Ejecución
**Contexto:** Resuelve $\log_3(2x - 1) = 2$.
...
**Expected_Success:** 0.75
**ICFES:** Razonamiento y Argumentación
**Contexto:** Un estudiante afirma que la función $f(x) = 2^x$ crece más rápido que $g(x) = x^2$ para valores grandes de $x$.
...
**Expected_Success:** 0.75
**ICFES:** Formulación y Ejecución
**Contexto:** En un triángulo, los lados miden $a = 7$ cm, $b = 9$ cm y $c = 12$ cm.
...
**Expected_Success:** 0.75
**ICFES:** Razonamiento y Argumentación
**Contexto:** Un investigador en Colombia analiza la relación entre la altitud y la temperatura en 15 ciudades colombianas. Obtiene un coeficiente de correlación $r = -0.92$.
...
**Contexto:** Un modelo predice que el número de usuarios de internet en Colombia sigue $U(t) = 30 \cdot (1.12)^t$ millones, donde $t$ son años desde 2020.
...
**Expected_Success:** 0.75
**ICFES:** Pensamiento Reflexivo y Sistémico
**Contexto:** Un ingeniero civil en Bogotá debe calcular la distancia entre dos puntos $A$ y $B$ separados por una construcción. Mide $AC = 40$ m, $BC = 35$ m, y el ángulo $C$ (entre $AC$ y $BC$) es de $75^\circ$.
