...
tema: "textos-argumentativos-basicos"
periodo: 2
...
*En el salón de quinto grado de la I.E. José María Obando, en Popayán, la profesora Lucía organizó un debate. El tema era: "¿Deben los niños de primaria tener celular?". Dos grupos prepararon sus argumentos y esto fue lo que dijeron:*

---

**Grupo A — A FAVOR (argumentan que SÍ deben tener celular):**

*"Nosotros creemos que los niños de primaria SÍ deben tener celular, pero con reglas claras. Primero, el celular sirve para comunicarse con los papás en caso de emergencia. Si un niño se queda tarde en el colegio o necesita que lo recojan, puede llamar rápido. Segundo, muchos niños usan el celular para hacer tareas: buscar información, grabar videos educativos o usar aplicaciones de matemáticas. Tercero, aprender a usar la tecnología desde pequeños es importante porque el mundo de hoy funciona con dispositivos digitales. Pero claro, debe haber límites de tiempo y los papás deben supervisar lo que los niños ven en internet."*

---

**Grupo B — EN CONTRA (argumentan que NO deben tener celular):**

*"Nosotros pensamos que los niños de primaria NO deben tener celular. En primer lugar, el celular distrae mucho en clase. Varios estudios muestran que los niños que llevan celular al colegio se concentran menos y rinden peor en los exámenes. En segundo lugar, pasar mucho tiempo en el celular quita tiempo para jugar al aire libre, leer cuentos o compartir con la familia. En tercer lugar, el internet puede ser peligroso si los niños no saben usarlo bien: hay personas desconocidas que pueden engañarlos. Por eso creemos que es mejor esperar hasta secundaria para tener celular."*
...
- [ ] D) Si el celular es útil para las emergencias. <!-- feedback: Incorrecto. Eso es un argumento dentro del debate, no el tema completo. -->

### Explicación Pedagógica
Se evalúa la identificación del tema central del texto argumentativo. El tema es la pregunta que da origen a los argumentos a favor y en contra.
...
- [ ] D) Que los niños deben esperar hasta secundaria. <!-- feedback: Incorrecto. Esa es una conclusión del Grupo B. -->

### Explicación Pedagógica
Se evalúa la capacidad de distinguir entre argumentos a favor y argumentos en contra dentro de un texto argumentativo.
...
- [ ] D) Que los niños con celular aprenden más rápido. <!-- feedback: Incorrecto. Eso sería un argumento a favor, no en contra. -->

### Explicación Pedagógica
Se evalúa la identificación de un argumento específico respaldado por "estudios", mostrando cómo los textos argumentativos usan evidencia.
...
- [ ] D) Que solo los niños que saquen buenas notas pueden tener celular. <!-- feedback: Incorrecto. No se menciona esa condición. -->

### Explicación Pedagógica
Se evalúa la comprensión de una posición matizada (no es un "sí" absoluto, sino condicionado). La respuesta correcta identifica las condiciones planteadas.
...
- [ ] D) En que el Grupo B no sabe usar la tecnología. <!-- feedback: Incorrecto. No se cuestiona la capacidad técnica de ningún grupo. -->

### Explicación Pedagógica
Se evalúa la capacidad de contrastar dos posturas argumentativas identificando el punto central de desacuerdo.
...
- [ ] D) Que los niños se vuelven perezosos. <!-- feedback: Incorrecto. No mencionan pereza como argumento. -->

### Explicación Pedagógica
Se evalúa la capacidad de identificar qué argumentos están respaldados por alguna forma de evidencia, una habilidad clave de la lectura crítica.
...
- [ ] D) Convencer al lector de que los celulares son malos. <!-- feedback: Incorrecto. El texto presenta ambos lados, no solo uno. -->

### Explicación Pedagógica
Se evalúa la identificación del propósito de un texto argumentativo equilibrado que presenta múltiples perspectivas.
...
- [ ] D) Que los virus dañan el celular. <!-- feedback: Incorrecto. El peligro mencionado es para los niños, no para el dispositivo. -->

### Explicación Pedagógica
Se evalúa la identificación de un argumento específico relacionado con la seguridad infantil en internet.
...
- [ ] D) Que los padres deben comprar celulares a sus hijos. <!-- feedback: Incorrecto. No se habla de obligación de compra. -->

### Explicación Pedagógica
Se evalúa la identificación de la tesis en un texto argumentativo, distinguiéndola de los argumentos que la apoyan.
...
- [ ] D) Que le pida a la profesora que decida por ellos. <!-- feedback: Incorrecto. El texto promueve la autonomía de pensamiento. -->

### Explicación Pedagógica
Se evalúa la comprensión del propósito de un debate o texto argumentativo equilibrado: desarrollar el pensamiento crítico y la capacidad de tomar decisiones informadas.

### Explicación Pedagógica Final
Este bundle introduce a los estudiantes de quinto grado en el género argumentativo a través de un debate escolar sobre un tema relevante para su edad: el uso del celular. El texto presenta dos posturas claramente diferenciadas con sus respectivos argumentos, permitiendo a los estudiantes identificar la tesis, distinguir entre argumentos a favor y en contra, reconocer el uso de evidencia y comprender el propósito persuasivo de estos textos. La habilidad argumentativa es fundamental para la formación ciudadana y el pensamiento crítico.
