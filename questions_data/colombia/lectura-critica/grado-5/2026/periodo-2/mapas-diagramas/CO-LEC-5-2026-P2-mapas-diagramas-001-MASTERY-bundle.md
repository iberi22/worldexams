...
*La profesora Inés pidió a sus estudiantes de quinto grado de la I.E. San Rafael, en Pereira, que hicieran un mapa conceptual sobre "Los Ecosistemas de Colombia". Cada grupo eligió un ecosistema diferente. El grupo de Camilo, Daniela y Marian hizo un mapa sobre la selva amazónica. Así quedó su mapa conceptual:*
...
```
        ...
        |               |               |
    SELVA           PÁRAMO          OCÉANO
    AMAZÓNICA       ANDINO          CARIBE
        |               |               |
    ┌───┼───┐       ┌───┼───┐       ┌───┼───┐
    |   |   |       |   |   |       |   |   |
 CLIMA  FAUNA  FLORA   CLIMA  FAUNA FLORA  CLIMA FAUNA FLORA
cálido  jaguares  orquídeas  frío   cóndor  frailejón  cálido  tortugas  manglares
húmedo  delfines  ceibas    seco   venado  pajonal    salado  corales  algas
lluvioso  guacamayas  lianas  neblina  oso     musgo    cristalino  peces  pastos
                            andino  líquenes                marinos
```

*Después de hacer el mapa, la profesora pidió que cada grupo escribiera un resumen explicando lo que habían aprendido. Esto escribió el grupo de Camilo:*

*"Colombia tiene muchos ecosistemas diferentes. Nosotros estudiamos la selva amazónica, que tiene clima cálido, húmedo y lluvioso. Allí viven jaguares, delfines rosados y guacamayas. Las plantas más importantes son las orquídeas, las ceibas y las lianas. Aprendimos que la selva amazónica colombiana está en el sur del país, en departamentos como Amazonas, Caquetá y Putumayo. Es el pulmón del mundo porque produce mucho oxígeno."*
...
- [ ] D) Amazonas, Bogotá y Cartagena. <!-- feedback: Incorrecto. Esos son lugares geográficos, no ecosistemas. -->

### Explicación Pedagógica
Se evalúa la capacidad de leer un mapa conceptual identificando la información principal en el nivel superior del diagrama.
...
- [ ] D) Altura, temperatura y humedad. <!-- feedback: Incorrecto. Esos serían aspectos del clima, no subcategorías generales. -->

### Explicación Pedagógica
Se evalúa la identificación de los niveles jerárquicos en un mapa conceptual. Los estudiantes deben reconocer la estructura de organización de la información.
...
- [ ] D) En la cordillera de los Andes. <!-- feedback: Incorrecto. Los Andes están en el centro-occidente, la Amazonía está al sur-oriente. -->

### Explicación Pedagógica
Se evalúa la capacidad de extraer información geográfica del texto de acompañamiento. El resumen complementa la información del mapa.
...
- [ ] D) Delfines rosados. <!-- feedback: Incorrecto. Los delfines rosados son de la selva amazónica. -->

### Explicación Pedagógica
Se evalúa la capacidad de localizar información específica en diferentes ramas de un mapa conceptual, distinguiendo entre ecosistemas.
...
- [ ] D) El clima y los animales no están conectados en el mapa. <!-- feedback: Incorrecto. En el mapa, clima y fauna son subcategorías del mismo nivel bajo cada ecosistema. -->

### Explicación Pedagógica
Se evalúa la capacidad de inferir relaciones entre categorías dentro del mapa conceptual. Aunque el mapa no explicita la relación, la organización sugiere dependencia.
...
- [ ] D) Porque a la profesora le gusta más dibujar que leer. <!-- feedback: Incorrecto. No es una razón profesional válida. -->

### Explicación Pedagógica
Se evalúa la comprensión de la función pedagógica de los mapas conceptuales como herramientas de organización del conocimiento.
...
- [ ] D) Manglares. <!-- feedback: Incorrecto. Los manglares son del Océano Caribe. -->

### Explicación Pedagógica
Se evalúa la identificación de información específica dentro de una rama del mapa conceptual.
...
- [ ] D) Templado, ventoso y nublado. <!-- feedback: Incorrecto. Esos no aparecen en el mapa para la selva. -->

### Explicación Pedagógica
Se evalúa la capacidad de leer atributos específicos dentro de una categoría del mapa conceptual.
...
- [ ] D) Es la conclusión del trabajo de otro grupo. <!-- feedback: Incorrecto. Es parte del trabajo del mismo grupo. -->

### Explicación Pedagógica
Se evalúa la comprensión de que el mapa conceptual y el resumen cumplen funciones complementarias: uno organiza, otro explica e interpreta.
...
- [ ] D) Porque ocupa menos espacio que un libro. <!-- feedback: Incorrecto. Esa no es la razón pedagógica principal. -->

### Explicación Pedagógica
Se evalúa la reflexión sobre la utilidad de los organizadores gráficos como herramientas de aprendizaje y estudio.

### Explicación Pedagógica Final
Este bundle trabaja la comprensión e interpretación de mapas conceptuales y diagramas como herramientas para organizar información. El mapa conceptual sobre los ecosistemas de Colombia permite a los estudiantes practicar la lectura de información visual jerarquizada, identificar relaciones entre conceptos y complementar la información del mapa con textos explicativos. La habilidad de interpretar organizadores gráficos es fundamental para el estudio de todas las áreas del conocimiento y para la comprensión de textos académicos.
