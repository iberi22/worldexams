...
tema: "personajes-caracteristicas"
periodo: 3
...
*En el municipio de Nuquí, en la costa pacífica del Chocó, vivían tres hermanos muy diferentes entre sí: Yadira, de 11 años, Jhon, de 10, y la pequeña Emérita, de 8. Cada uno tenía una forma distinta de ver el mundo.*

*Yadira era la mayor. Tenía el pelo largo y rizado como las olas del mar que veía desde su ventana. Era tranquila y observadora. Pasaba horas sentada en la playa, mirando cómo las lanchas de los pescadores iban y venían. A veces, dibujaba en la arena con un palo: peces, aves, barcos. No hablaba mucho, pero cuando lo hacía, todos la escuchaban porque siempre decía cosas interesantes. Su mamá decía: "Yadira tiene ojos que ven lo que otros no ven".*

*Jhon era todo lo contrario. No podía quedarse quieto ni un minuto. Saltaba, corría, trepaba árboles de coco y nadaba en el río. Tenía la piel brillante por el sol y el cabello siempre revuelto. Era audaz: una vez agarró un cangrejo con la mano desnuda y todos quedaron asombrados. Pero a veces se metía en problemas por no pensar antes de actuar. Su papá le decía: "Jhon, la valentía sin cuidado es peligrosa".*

*Emérita, la menor, era dulce y cariñosa. Tenía una sonrisa que iluminaba la casa. Le encantaba cocinar con su abuela y aprender las recetas tradicionales del Pacífico: tapao de pescado, arroz con coco y jugo de borojó. Era muy generosa: siempre compartía su comida con los perros de la calle. Pero también era un poco miedosa. Le tenía miedo a los cangrejos que Jhon agarraba y a las olas grandes del mar.*

*Un día, mientras los tres hermanos jugaban en la playa, encontraron una botella de vidrio enterrada en la arena. Dentro había un mensaje. Empezaba así: "Si estás leyendo esto, ayuda a la tortuga Caná..."*
...
- [ ] D) Caná, Tapao y Borojó. <!-- feedback: Incorrecto. Caná es la tortuga, Tapao es una comida y Borojó una fruta. -->

### Explicación Pedagógica
Se evalúa la identificación de los personajes principales presentados explícitamente al inicio del texto.
...
- [ ] D) Usa gafas para leer. <!-- feedback: Incorrecto. No se mencionan gafas. -->

### Explicación Pedagógica
Se evalúa la identificación de un detalle descriptivo sobre la apariencia física de un personaje.
...
- [ ] D) Enojada y solitaria. <!-- feedback: Incorrecto. No hay indicios de enojo o soledad. -->

### Explicación Pedagógica
Se evalúa la capacidad de inferir la personalidad de un personaje a partir de sus acciones y las descripciones del narrador.
...
- [ ] D) Tímido y miedoso. <!-- feedback: Incorrecto. Jhon es audaz y valiente, no tímido. -->

### Explicación Pedagógica
Se evalúa la síntesis de las características de un personaje a partir de acciones y citas de otros personajes.
...
- [ ] D) En que a Yadira le gusta el mar y a Jhon el río. <!-- feedback: Incorrecto. Ambos juegan tanto en la playa como en el río. -->

### Explicación Pedagógica
Se evalúa la capacidad de contrastar las personalidades de dos personajes, identificando la oposición fundamental entre ellos.
...
- [ ] D) Porque Jhon la asusta con los cangrejos. <!-- feedback: Posible, pero el texto no dice que Jhon la asuste intencionalmente. -->

### Explicación Pedagógica
Se evalúa la inferencia sobre las motivaciones de un personaje a partir de su personalidad descrita en el texto.
...
- [ ] D) Leer mensajes en botellas. <!-- feedback: Incorrecto. Eso ocurre al final y es una actividad de los tres. -->

### Explicación Pedagógica
Se evalúa la identificación de las actividades y gustos específicos de un personaje.
...
- [ ] D) Los tres dibujan en la arena. <!-- feedback: Incorrecto. Solo Yadira dibuja. -->

### Explicación Pedagógica
Se evalúa la capacidad de identificar los elementos comunes entre personajes diferentes, reconociendo su contexto compartido.
...
- [ ] D) Anuncian lo que va a pasar después. <!-- feedback: Incorrecto. No son anuncios de eventos futuros, sino descripciones del presente. -->

### Explicación Pedagógica
Se evalúa la comprensión de la función de las citas de otros personajes como recurso para caracterizar indirectamente a los protagonistas.
...
- [ ] D) Cualquiera de los tres porque son iguales. <!-- feedback: Incorrecto. Los tres son muy diferentes y cada uno aportaría algo distinto. -->

### Explicación Pedagógica
Se evalúa la capacidad de proyectar el comportamiento futuro de un personaje basándose en sus características ya establecidas. Esta habilidad conecta la caracterización con la predicción narrativa.

### Explicación Pedagógica Final
Este bundle trabaja la caracterización de personajes a través de un cuento sobre tres hermanos del Chocó colombiano. El texto presenta personajes con personalidades claramente diferenciadas mediante descripciones físicas, acciones, diálogos y las opiniones de otros personajes sobre ellos. Las preguntas guían al estudiante desde la identificación de características explícitas hasta la inferencia de motivaciones, la comparación entre personajes y la proyección de comportamientos futuros. La comprensión de los personajes es fundamental para la apreciación de la narrativa y el desarrollo de la empatía lectora.
