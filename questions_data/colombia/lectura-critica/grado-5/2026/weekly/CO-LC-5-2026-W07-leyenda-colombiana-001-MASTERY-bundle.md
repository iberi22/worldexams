---
id: "CO-LC-5-2026-W07-leyenda-colombiana-001-MASTERY-bundle"
country: "colombia"
grado: 5
asignatura: "lectura-critica"
tema: "leyenda-colombiana"
periodo: "weekly"
week: "W07"
year: 2026
bundle_type: "weekly"
...
# Bundle MASTERY: Leyenda Colombiana - Grado 5 (W07)

Características de la leyenda como texto narrativo tradicional, su estructura, personajes y propósito cultural en Colombia.
...
Reconocer las características principales de la leyenda como género narrativo tradicional.
...
### Enunciado
¿Qué mezcla de elementos aparece en esta leyenda?

### Opciones
- [x] A) Hechos reales (ríos, pérdida de hijos) con elementos fantásticos (espíritu que aparece y llora).
  <!-- feedback: La leyenda une la realidad con lo sobrenatural para crear el relato. -->
- [ ] B) Solo datos científicos verificados en laboratorio.
  <!-- feedback: La leyenda no se basa en datos científicos. -->
- [ ] C) Únicamente instrucciones para cruzar un río.
  <!-- feedback: La leyenda no es un manual de supervivencia. -->
- [ ] D) Solo recetas de cocina tradicional.
  <!-- feedback: La leyenda no contiene recetas de cocina. -->

### Explicacion Pedagogica
Comprender la combinación de elementos reales y fantásticos típica de las leyendas.
...
- [ ] D) Una receta de cocina con ingredientes y pasos.
  <!-- feedback: La leyenda no es una receta de cocina. -->

### Explicacion Pedagogica
Aplicar el conocimiento sobre la estructura narrativa básica de una leyenda.
...
### Explicacion Pedagogica
Reconocer la intención cultural y simbólica de una leyenda que explica un fenómeno natural.
...
### Explicacion Pedagogica
Aplicar los elementos iniciales necesarios para escribir una leyenda colombiana.
...
### Explicacion Pedagogica
Comparar leyendas colombianas para identificar sus elementos comunes.
...
- [ ] D) Cumplen el papel de explicar matemáticas avanzadas.
  <!-- feedback: Su papel es narrativo y simbólico, no matemático. -->

### Explicacion Pedagogica
Analizar el papel narrativo de los personajes sobrenaturales en las leyendas colombianas.
...
### Explicacion Pedagogica
Evaluar la importancia cultural y educativa de las leyendas colombianas en la formación lectora.