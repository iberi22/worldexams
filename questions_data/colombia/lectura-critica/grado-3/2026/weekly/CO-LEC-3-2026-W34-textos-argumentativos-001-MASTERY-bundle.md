...
Este bundle evalúa la capacidad de identificar la opinión principal de un autor (tesis) y las razones (argumentos) que usa para convencer al lector sobre un tema determinado.

---

## Question 1 [D1-D2]
**ID:** `CO-LEC-3-2026-W34-textos-argumentativos-001-MASTERY-v1`
**Bloom:** Remember
**ICFES:** Semántico
...
- [ ] D) Que el trabajo en equipo es aburrido. <!-- feedback: Incorrecto. El texto dice que el deporte enseña a trabajar en equipo como algo bueno. -->

### Explicación Pedagógica
Identificar la tesis u opinión central es el primer paso para comprender un texto argumentativo. El estudiante debe localizar la afirmación que el autor quiere que aceptemos como verdadera.

---

## Question 2 [D1-D2]
**ID:** `CO-LEC-3-2026-W34-textos-argumentativos-001-MASTERY-v2`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) Porque tirar basura es divertido. <!-- feedback: Incorrecto. El autor está en contra de tirar basura. -->

### Explicación Pedagógica
Reconocer los argumentos permite entender cómo el autor apoya su opinión. El estudiante debe identificar cuáles son las justificaciones explícitas dadas en la lectura.

---

## Question 3 [D2-D3]
**ID:** `CO-LEC-3-2026-W34-textos-argumentativos-001-MASTERY-v3`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) Científico (da datos exactos del ojo humano). <!-- feedback: Incorrecto. Usa razones personales y de gusto, no estudios médicos. -->

### Explicación Pedagógica
Identificar la intención persuasiva ayuda a los estudiantes a reconocer cuándo alguien está intentando influir en sus gustos o comportamientos.

---

## Question 4 [D2-D3]
**ID:** `CO-LEC-3-2026-W34-textos-argumentativos-001-MASTERY-v4`
**Bloom:** Apply
**ICFES:** Semántico
...
- [ ] D) Porque el patio es de color gris. <!-- feedback: Incorrecto. El color del patio no tiene relación con la duración del tiempo libre. -->

### Explicación Pedagógica
Relacionar una opinión con un argumento sólido desarrolla el pensamiento lógico. El estudiante debe elegir la razón que tenga más sentido y utilidad para defender la tesis.

---

## Question 5 [D3-D4]
**ID:** `CO-LEC-3-2026-W34-textos-argumentativos-001-MASTERY-v5`
**Bloom:** Apply
**ICFES:** Semántico
...
Te dan mucha fuerza, te hacen brillar.
Si sano quieres crecer,
vegetales debes comer".
...
- [ ] D) Criticar a los niños que no les gustan las frutas. <!-- feedback: Incorrecto. El tono es positivo e invitador, no de crítica. -->

### Explicación Pedagógica
A veces la argumentación usa formas literarias (como la rima) para ser más efectiva. Identificar el propósito de "convencer" debajo de la forma es una habilidad de lectura crítica.

---

## Question 6 [D3-D4]
**ID:** `CO-LEC-3-2026-W34-textos-argumentativos-001-MASTERY-v6`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) Avisar que el texto se va a terminar pronto. <!-- feedback: Incorrecto. Es un conector lógico de contraste. -->

### Explicación Pedagógica
El uso de conectores de contraste (sin embargo, pero, por el contrario) es vital en la argumentación. Ayuda a entender cómo el autor refuta una idea para proponer la suya.

---

## Question 7 [D4-D5]
**ID:** `CO-LEC-3-2026-W34-textos-argumentativos-001-MASTERY-v7`
**Bloom:** Analyze
**ICFES:** Semántico
...
- [ ] D) Quejarse de que su perro come mucho. <!-- feedback: Incorrecto. El texto es un consejo general, no una queja personal. -->

### Explicación Pedagógica
Analizar cómo se usan los hechos (gastos, tiempo) como argumentos para sostener una opinión permite al estudiante comprender la estructura lógica de los textos de opinión.

---

## Question 8 [D4-D5]
**ID:** `CO-LEC-3-2026-W34-textos-argumentativos-001-MASTERY-v8`
**Bloom:** Evaluate
**ICFES:** Crítico
...
- [ ] D) Porque a todo el mundo le gusta el chocolate. <!-- feedback: Incorrecto. Los gustos de los demás no definen si la frase está bien argumentada o no. -->
