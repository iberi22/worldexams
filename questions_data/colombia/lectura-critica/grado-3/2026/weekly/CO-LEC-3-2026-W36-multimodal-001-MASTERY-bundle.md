...
Este bundle evalúa la capacidad de integrar información proveniente de diferentes lenguajes (palabras, imágenes, gráficos, iconos) que aparecen juntos en un mismo texto para construir un significado completo.

---

## Question 1 [D1-D2]
**ID:** `CO-LEC-3-2026-W36-multimodal-001-MASTERY-v1`
**Bloom:** Remember
**ICFES:** Semántico
...
- [ ] D) Que el mapa es un libro de cuentos sobre micos. <!-- feedback: Incorrecto. Un mapa es un texto multimodal informativo sobre geografía. -->

### Explicación Pedagógica
Identificar el significado de iconos y símbolos en un contexto gráfico (mapa) es una habilidad básica de lectura multimodal. El estudiante debe relacionar el signo visual con la información geográfica.

---

## Question 2 [D1-D2]
**ID:** `CO-LEC-3-2026-W36-multimodal-001-MASTERY-v2`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) Es un dibujo decorativo que no tiene nada que ver con el tema. <!-- feedback: Incorrecto. En un texto multimodal, todos los elementos aportan significado. -->

### Explicación Pedagógica
Comprender la complementariedad entre imagen y texto ayuda al estudiante a integrar mensajes complejos. La imagen del ciclo es una metáfora visual de la palabra "reutilizar".

---

## Question 3 [D2-D3]
**ID:** `CO-LEC-3-2026-W36-multimodal-001-MASTERY-v3`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) Que las galletas son muy viejas. <!-- feedback: Incorrecto. Al contrario, resalta la ventaja de que están listas ya. -->

### Explicación Pedagógica
Interpretar símbolos de prohibición o negación (como la X roja) combinados con datos numéricos permite al estudiante leer etiquetas y empaques de forma autónoma.

---

## Question 4 [D2-D3]
**ID:** `CO-LEC-3-2026-W36-multimodal-001-MASTERY-v4`
**Bloom:** Apply
**ICFES:** Semántico
...
1. Un dibujo de manos bajo el grifo.
2. Un dibujo de manos con espuma.
3. Un dibujo de manos secándose con una toalla.
Los dibujos están unidos por flechas que van del 1 al 2 y del 2 al 3.
...
- [ ] D) Solo hay que mirar los dibujos y no importa el orden. <!-- feedback: Incorrecto. El orden es fundamental para que el lavado sea efectivo. -->

### Explicación Pedagógica
Reconocer las guías de lectura (flechas, números) en textos multimodales de proceso ayuda a los estudiantes a seguir instrucciones gráficas complejas.

---

## Question 5 [D3-D4]
**ID:** `CO-LEC-3-2026-W36-multimodal-001-MASTERY-v5`
**Bloom:** Apply
**ICFES:** Semántico
...
- [ ] D) Enseñar a los niños a saltar sobre los libros. <!-- feedback: Incorrecto. Los libros deben cuidarse, la imagen es simbólica. -->

### Explicación Pedagógica
Analizar metáforas visuales en carteles permite al estudiante comprender mensajes publicitarios o sociales que no son literales. El vuelo representa la imaginación.

---

## Question 6 [D3-D4]
**ID:** `CO-LEC-3-2026-W36-multimodal-001-MASTERY-v6`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) No pasará nada, los dibujos son solo para que el manual sea bonito. <!-- feedback: Incorrecto. Los dibujos técnicos tienen una función informativa vital. -->

### Explicación Pedagógica
Evaluar la importancia de la información técnica visual desarrolla habilidades para la vida cotidiana y el uso de tecnología sencilla.

---

## Question 7 [D4-D5]
**ID:** `CO-LEC-3-2026-W36-multimodal-001-MASTERY-v7`
**Bloom:** Analyze
**ICFES:** Semántico
...
- Dibujo de un Sol: 30°C (Lunes)
- Dibujo de una Nube con lluvia: 18°C (Martes)
- Dibujo de una Nube con Sol: 24°C (Miércoles)
...
- [ ] D) No hay ninguna relación, los números son inventados. <!-- feedback: Incorrecto. Los datos de la infografía muestran una correlación lógica real. -->

### Explicación Pedagógica
Integrar datos cualitativos (dibujos) con cuantitativos (números) es un ejercicio avanzado de lectura multimodal que prepara al estudiante para la interpretación de gráficos científicos y sociales.

---

## Question 8 [D4-D5]
**ID:** `CO-LEC-3-2026-W36-multimodal-001-MASTERY-v8`
**Bloom:** Evaluate
**ICFES:** Crítico
...
- [ ] D) Porque a los ciervos les gusta correr por la carretera. <!-- feedback: Incorrecto. La confusión está en el diseño del mensaje para los humanos. -->
