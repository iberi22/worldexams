...
Este bundle evalúa el reconocimiento de las vocales y el orden del abecedario en español, fundamentado en los Estándares Básicos de Competencias y los DBA de Grado 3.

---

## Question 1 [D1-D2]
**ID:** `CO-LEC-3-2026-W01-vocales-abecedario-001-MASTERY-v1`
**Bloom:** Remember
**ICFES:** Semántico
...
- [ ] D) u, o, i, e, x <!-- feedback: Incorrecto. Las primeras cuatro son vocales, pero la 'x' es una consonante. Las vocales son únicamente cinco: a, e, i, o, u. -->

### Explicación Pedagógica
Las vocales (a, e, i, o, u) son los sonidos fundamentales del español que se producen sin obstrucción del aire en la boca. Identificarlas correctamente es el primer paso para la decodificación de textos y la construcción de la conciencia fonológica en los primeros grados de primaria.

---

## Question 2 [D1-D2]
**ID:** `CO-LEC-3-2026-W01-vocales-abecedario-001-MASTERY-v2`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) 5 vocales <!-- feedback: Incorrecto. La palabra tiene 8 letras en total, de las cuales 5 son consonantes y solo 3 son vocales. -->

### Explicación Pedagógica
Identificar vocales dentro de palabras cotidianas ayuda a los niños a comprender la estructura silábica. En "cholados", las vocales permiten la articulación de las tres sílabas: cho-la-dos, demostrando que cada sílaba requiere al menos una vocal.

---

## Question 3 [D2-D3]
**ID:** `CO-LEC-3-2026-W01-vocales-abecedario-001-MASTERY-v3`
**Bloom:** Remember
**ICFES:** Semántico
...
- [ ] D) D - C - B - A <!-- feedback: Incorrecto. Este es el orden inverso (hacia atrás). El orden alfabético estándar es ascendente, empezando por la A. -->

### Explicación Pedagógica
El orden alfabético es una convención que permite organizar y localizar información de manera eficiente. Dominar la secuencia A-B-C-D es fundamental para el uso posterior de diccionarios, enciclopedias y archivos físicos o digitales.

---

## Question 4 [D2-D3]
**ID:** `CO-LEC-3-2026-W01-vocales-abecedario-001-MASTERY-v4`
**Bloom:** Apply
**ICFES:** Semántico
...
- [ ] D) Danta <!-- feedback: Incorrecto. La 'D' ocupa el cuarto lugar en el abecedario, por lo que aparecerá después de Aracataca, Ballena y Cóndor. -->

### Explicación Pedagógica
La organización de palabras por su letra inicial es una aplicación práctica del abecedario. En este caso, reconocer que 'A' es la primera letra permite determinar que "Aracataca" encabeza la lista, una habilidad esencial para la búsqueda autónoma de información.

---

## Question 5 [D3-D4]
**ID:** `CO-LEC-3-2026-W01-vocales-abecedario-001-MASTERY-v5`
**Bloom:** Apply
**ICFES:** Semántico
...
- [ ] D) Ocoró <!-- feedback: Incorrecto. Ocoró empieza con 'O', que es la cuarta vocal. La última es la 'U'. -->

### Explicación Pedagógica
El orden tradicional de las vocales (A, E, I, O, U) es una secuencia que los estudiantes deben automatizar. Relacionar la posición de la vocal ("última") con una palabra específica ("Uva") refuerza la memoria de trabajo y la categorización lingüística.

---

## Question 6 [D3-D4]
**ID:** `CO-LEC-3-2026-W01-vocales-abecedario-001-MASTERY-v6`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) Tiene 4 vocales: e, a, o, u <!-- feedback: Incorrecto. La palabra no contiene la vocal 'u'. Contiene i, e, a, o. -->

### Explicación Pedagógica
El análisis detallado de las letras de una palabra permite distinguir entre fonemas vocálicos y consonánticos. En "Libertador", identificar las cuatro vocales diferentes ayuda a reconocer la estructura de las cuatro sílabas que componen la palabra.

---

## Question 7 [D4-D5]
**ID:** `CO-LEC-3-2026-W01-vocales-abecedario-001-MASTERY-v7`
**Bloom:** Apply
**ICFES:** Semántico
...
- [ ] D) Caballero - Egan - Rodríguez - Pajón <!-- feedback: Incorrecto. Has fallado en las últimas dos: la 'P' de Pajón va antes que la 'R' de Rodríguez. -->

### Explicación Pedagógica
Ordenar apellidos requiere comparar la primera letra de cada palabra y recordar su posición relativa en el abecedario. Esta actividad desarrolla habilidades de organización de datos y pensamiento lógico-secuencial.

---

## Question 8 [D4-D5]
**ID:** `CO-LEC-3-2026-W01-vocales-abecedario-001-MASTERY-v8`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) Que todas sus vocales tienen tilde. <!-- feedback: Incorrecto. Solo la 'Í' tiene tilde; las demás (o, u, e, a) no la llevan en esta palabra. -->
