...
Este bundle evalúa la capacidad de interpretar señales de tránsito, iconos de advertencia y comunicación no verbal en diferentes contextos sociales y de seguridad.

---

## Question 1 [D1-D2]
**ID:** `CO-LEC-3-2026-W39-mensajes-visuales-001-MASTERY-v1`
**Bloom:** Remember
**ICFES:** Semántico
...
- [ ] D) Tocar la bocina (pito) con fuerza. <!-- feedback: Incorrecto. La señal no se refiere al sonido, sino al movimiento. -->

### Explicación Pedagógica
Identificar señales de tránsito reglamentarias es una habilidad de alfabetización vial básica. Reconocer la forma y el color asociados al comando "detenerse" permite la seguridad en el espacio público.

---

## Question 2 [D1-D2]
**ID:** `CO-LEC-3-2026-W39-mensajes-visuales-001-MASTERY-v2`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) Que todas las personas que entren deben usar falda. <!-- feedback: Incorrecto. Es una identificación de género, no una norma de vestimenta obligatoria. -->

### Explicación Pedagógica
Comprender el lenguaje de los pictogramas permite al estudiante orientarse en edificios y espacios públicos. La asociación de rasgos físicos con categorías sociales es parte del aprendizaje simbólico.

---

## Question 3 [D2-D3]
**ID:** `CO-LEC-3-2026-W39-mensajes-visuales-001-MASTERY-v3`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) Que hay que llenar la caja con agua. <!-- feedback: Incorrecto. No tiene relación con el símbolo de fragilidad. -->

### Explicación Pedagógica
Identificar iconos de advertencia en empaques y productos ayuda a los estudiantes a manejar objetos con el cuidado adecuado.

---

## Question 4 [D2-D3]
**ID:** `CO-LEC-3-2026-W39-mensajes-visuales-001-MASTERY-v4`
**Bloom:** Apply
**ICFES:** Semántico
...
- [ ] D) Que puede bailar mientras cruza la calle. <!-- feedback: Incorrecto. El mensaje es sobre la seguridad y el tiempo de cruce. -->

### Explicación Pedagógica
Analizar el movimiento y el cambio en los mensajes visuales (luz fija vs. luz intermitente) permite comprender gradaciones de urgencia en la comunicación vial.

---

## Question 5 [D3-D4]
**ID:** `CO-LEC-3-2026-W39-mensajes-visuales-001-MASTERY-v5`
**Bloom:** Apply
**ICFES:** Semántico
...
- [ ] D) Que la enfermera es muda y no puede hablar. <!-- feedback: Incorrecto. La imagen comunica una norma para el visitante, no una característica de la enfermera. -->

### Explicación Pedagógica
La interpretación de la comunicación no verbal (gestos) en mensajes públicos es una competencia social importante. El estudiante debe "leer" la postura y el gesto como un comando normativo.

---

## Question 6 [D3-D4]
**ID:** `CO-LEC-3-2026-W39-mensajes-visuales-001-MASTERY-v6`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) Significa que el producto sirve para limpiar esqueletos. <!-- feedback: Incorrecto. No es una indicación de uso, sino una advertencia de seguridad. -->

### Explicación Pedagógica
Reconocer símbolos de peligro químico y toxicidad es vital para la prevención de accidentes en el hogar. El estudiante asocia la imagen de la calavera con la prohibición de contacto o consumo.

---

## Question 7 [D4-D5]
**ID:** `CO-LEC-3-2026-W39-mensajes-visuales-001-MASTERY-v7`
**Bloom:** Analyze
**ICFES:** Semántico
...
1. Un dibujo de un celular dentro de un círculo rojo con una raya diagonal encima.
2. Un dibujo de un celular dentro de un cuadrado azul con una letra "i" blanca al lado.
...
- [ ] D) La señal 2 indica que el celular se puede mojar. <!-- feedback: Incorrecto. La letra "i" representa "información". -->

### Explicación Pedagógica
Analizar el código de colores de las señales (rojo = prohibición, azul = información/servicio) desarrolla una lectura técnica del entorno. El estudiante debe distinguir la función de la señal por su marco gráfico.

---

## Question 8 [D4-D5]
**ID:** `CO-LEC-3-2026-W39-mensajes-visuales-001-MASTERY-v8`
**Bloom:** Evaluate
**ICFES:** Crítico
...
- [ ] D) Porque a la gente no le gustan las puertas negras. <!-- feedback: Incorrecto. El problema es la visibilidad y el mensaje de "cerrado" en una "salida". -->
