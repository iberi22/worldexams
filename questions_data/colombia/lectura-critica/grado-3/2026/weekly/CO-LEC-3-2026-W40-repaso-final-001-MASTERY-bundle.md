...
Este bundle integra los conocimientos más importantes del año: tipos de textos (narrativos, informativos, opinión), elementos literarios y comprensión multimodal.

---

## Question 1 [D1-D2]
**ID:** `CO-LEC-3-2026-W40-repaso-final-001-MASTERY-v1`
**Bloom:** Remember
**ICFES:** Semántico
...
- [ ] D) Teatral, con diálogos y acotaciones. <!-- feedback: Incorrecto. No hay nombres de personajes antes de los textos ni instrucciones entre paréntesis. -->

### Explicación Pedagógica
Repaso de géneros narrativos (Semana 6). Identificar la estructura de cuento permite organizar mentalmente la historia y reconocer la intención del autor (entretener).

---

## Question 2 [D1-D2]
**ID:** `CO-LEC-3-2026-W40-repaso-final-001-MASTERY-v2`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) Que no tenga ninguna tarea pendiente. <!-- feedback: Incorrecto. No se menciona el rendimiento académico como condición en el aviso. -->

### Explicación Pedagógica
Repaso de comprensión literal y condiciones (Semana 17). Localizar los requisitos en un aviso escolar es una habilidad de lectura funcional necesaria para la vida escolar.

---

## Question 3 [D2-D3]
**ID:** `CO-LEC-3-2026-W40-repaso-final-001-MASTERY-v3`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) Que en el Amazonas vive mucha gente que fuma. <!-- feedback: Incorrecto. No tiene relación con el sentido ecológico del texto. -->

### Explicación Pedagógica
Repaso de lenguaje figurado (Semana 30). Comprender metáforas ambientales comunes ayuda a los estudiantes a entender el discurso sobre la conservación de la naturaleza.

---

## Question 4 [D2-D3]
**ID:** `CO-LEC-3-2026-W40-repaso-final-001-MASTERY-v4`
**Bloom:** Apply
**ICFES:** Semántico
...
**RECETA DE BATIDO:**
1. Lavar las fresas.
2. Poner las fresas y la leche en la licuadora.
3. Licuar por un minuto.
4. Servir en un vaso grande.
...
- [ ] D) No pasó nada, el orden de los pasos no importa en la cocina. <!-- feedback: Incorrecto. En la mayoría de las recetas, el orden decide el resultado. -->

### Explicación Pedagógica
Repaso de instrucciones y secuencias (Semana 13). Evaluar el impacto de alterar una secuencia lógica refuerza la disciplina en el seguimiento de procesos técnicos o culinarios.

---

## Question 5 [D3-D4]
**ID:** `CO-LEC-3-2026-W40-repaso-final-001-MASTERY-v5`
**Bloom:** Apply
**ICFES:** Semántico
...
**IMAGEN:** Un niño triste sentado solo en una banca.
**TEXTO:** "¡Di NO al acoso escolar! Todos somos amigos en este colegio".
...
- [ ] D) Decorando el periódico para que no tenga tanto espacio blanco. <!-- feedback: Incorrecto. La imagen tiene una función comunicativa específica unida al texto. -->

### Explicación Pedagógica
Repaso de textos multimodales (Semana 36). Analizar la carga emocional de las imágenes en la publicidad social ayuda a comprender la intención persuasiva de los mensajes de convivencia.

---

## Question 6 [D3-D4]
**ID:** `CO-LEC-3-2026-W40-repaso-final-001-MASTERY-v6`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) Que los seres humanos somos los únicos mamíferos inteligentes. <!-- feedback: Incorrecto. El texto no habla de inteligencia. -->

### Explicación Pedagógica
Repaso de idea principal y textos expositivos (Semanas 18 y 33). El estudiante debe sintetizar la información de clasificación biológica en una sola afirmación general.

---

## Question 7 [D4-D5]
**ID:** `CO-LEC-3-2026-W40-repaso-final-001-MASTERY-v7`
**Bloom:** Analyze
**ICFES:** Semántico
...
- Texto 1 (Noticia): "Ayer se realizó la jornada de vacunación de mascotas en el parque. Se vacunaron 100 perros y 50 gatos".
- Texto 2 (Editorial): "Fue una lástima que muchos dueños no trajeran a sus mascotas a vacunar. La salud de los animales es responsabilidad de todos y no debemos ser descuidados".
...
- [ ] D) No hay diferencia, los dos dicen que las vacunas son gratis. <!-- feedback: Incorrecto. Ninguno menciona el precio, y sus enfoques son muy distintos. -->

### Explicación Pedagógica
Repaso de géneros periodísticos (Semanas 23 y 35). Contrastar la objetividad de la noticia con la subjetividad del editorial es una meta fundamental de la lectura crítica en primaria.

---

## Question 8 [D4-D5]
**ID:** `CO-LEC-3-2026-W40-repaso-final-001-MASTERY-v8`
**Bloom:** Evaluate
**ICFES:** Crítico
...
- [ ] D) A mí me gustan los dos por igual. <!-- feedback: Incorrecto. Es una posición neutral que no argumenta a favor de los libros de ciencias. -->
