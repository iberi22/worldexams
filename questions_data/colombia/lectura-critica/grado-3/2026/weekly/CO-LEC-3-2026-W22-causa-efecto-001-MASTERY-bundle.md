...
Este bundle evalúa la capacidad de identificar por qué ocurren los hechos (causa) y cuáles son las consecuencias de las acciones o eventos (efecto) en un texto.

---

## Question 1 [D1-D2]
**ID:** `CO-LEC-3-2026-W22-causa-efecto-001-MASTERY-v1`
**Bloom:** Remember
**ICFES:** Semántico
...
- [ ] D) Que la ciudad es muy grande. <!-- feedback: Incorrecto. El tamaño de la ciudad no influye en la formación de charcos por lluvia. -->

### Explicación Pedagógica
Identificar la causa directa de un fenómeno meteorológico simple ayuda a establecer conexiones lógicas básicas. La palabra "Como..." al principio del texto suele introducir la causa.

---

## Question 2 [D1-D2]
**ID:** `CO-LEC-3-2026-W22-causa-efecto-001-MASTERY-v2`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) Que la profesora se puso feliz. <!-- feedback: Incorrecto. Los profesores no suelen alegrarse por las malas notas de sus estudiantes. -->

### Explicación Pedagógica
Diferenciar entre la acción realizada y la consecuencia final es clave. El "efecto" es el resultado que surge después de una decisión o evento inicial.

---

## Question 3 [D2-D3]
**ID:** `CO-LEC-3-2026-W22-causa-efecto-001-MASTERY-v3`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) Porque hay más personas viviendo en la casa. <!-- feedback: Incorrecto. No es una causa mencionada en este párrafo. -->

### Explicación Pedagógica
Identificar causas en textos informativos o de consejos ayuda a los estudiantes a comprender la responsabilidad de sus acciones cotidianas y el impacto económico de sus hábitos.

---

## Question 4 [D2-D3]
**ID:** `CO-LEC-3-2026-W22-causa-efecto-001-MASTERY-v4`
**Bloom:** Apply
**ICFES:** Semántico
...
- [ ] D) Que la harina se acabó rápido. <!-- feedback: Incorrecto. No tiene relación con el olvido del tiempo de horneado. -->

### Explicación Pedagógica
A menudo un hecho (causa) puede tener varios efectos simultáneos (pan quemado y humo). Reconocer cualquiera de ellos como consecuencia válida demuestra comprensión de la situación narrada.

---

## Question 5 [D3-D4]
**ID:** `CO-LEC-3-2026-W22-causa-efecto-001-MASTERY-v5`
**Bloom:** Apply
**ICFES:** Semántico
...
- [ ] D) Que los insectos se comieron las hojas. <!-- feedback: Incorrecto. No se menciona la presencia de insectos. -->

### Explicación Pedagógica
Identificar causas negativas (la falta de algo necesario) es un nivel más profundo de comprensión. El estudiante debe entender que la ausencia de un elemento vital (luz) provoca un efecto dañino.

---

## Question 6 [D3-D4]
**ID:** `CO-LEC-3-2026-W22-causa-efecto-001-MASTERY-v6`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) No hay ninguna relación, los carros siempre van lento. <!-- feedback: Incorrecto. El texto dice claramente que es "A causa de la construcción". -->

### Explicación Pedagógica
Identificar la dirección de la relación causa-efecto es vital. No siempre el primer hecho mencionado es la causa; hay que analizar el sentido de las palabras conectoras (como "A causa de...").

---

## Question 7 [D4-D5]
**ID:** `CO-LEC-3-2026-W22-causa-efecto-001-MASTERY-v7`
**Bloom:** Analyze
**ICFES:** Semántico
...
- [ ] D) Los peces atacan a los corales -> El agua cambia de color. <!-- feedback: Incorrecto. No tiene base en la información del texto. -->

### Explicación Pedagógica
Las cadenas de causa y efecto muestran cómo un solo evento puede desencadenar una serie de consecuencias. Analizar procesos ecológicos ayuda a los estudiantes a comprender la interconexión de la naturaleza.

---

## Question 8 [D4-D5]
**ID:** `CO-LEC-3-2026-W22-causa-efecto-001-MASTERY-v8`
**Bloom:** Evaluate
**ICFES:** Crítico
...
- [ ] D) Que la anciana era una ladrona de semillas. <!-- feedback: Incorrecto. El texto dice que ella las regala en agradecimiento. -->
