...
Este bundle evalúa la capacidad de comprender comparaciones, metáforas y expresiones cotidianas donde el significado no es literal, sino que depende del contexto y la imaginación.

---

## Question 1 [D1-D2]
**ID:** `CO-LEC-3-2026-W30-lenguaje-figurado-001-MASTERY-v1`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) Que tiene un secreto guardado en el codo. <!-- feedback: Incorrecto. Los secretos no se guardan en las articulaciones. -->

### Explicación Pedagógica
Las expresiones idiomáticas o modismos son parte del lenguaje figurado cotidiano. Comprender que el significado total es diferente al de las palabras por separado es un paso clave en la competencia comunicativa.

---

## Question 2 [D1-D2]
**ID:** `CO-LEC-3-2026-W30-lenguaje-figurado-001-MASTERY-v2`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) Con dos caminos de tierra. <!-- feedback: Incorrecto. El camino es lo que los ojos iluminan, no con lo que se comparan. -->

### Explicación Pedagógica
La metáfora identifica dos términos que tienen alguna semejanza. Reconocer el término real (ojos) y el término imaginario (luceros) ayuda a visualizar la intención del autor.

---

## Question 3 [D2-D3]
**ID:** `CO-LEC-3-2026-W30-lenguaje-figurado-001-MASTERY-v3`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) Que el examen era una hoja de pan. <!-- feedback: Incorrecto. Los exámenes son de papel, es un uso figurado. -->

### Explicación Pedagógica
Identificar el sentido de las expresiones populares ayuda a la fluidez en la comprensión de textos narrativos y conversaciones reales.

---

## Question 4 [D2-D3]
**ID:** `CO-LEC-3-2026-W30-lenguaje-figurado-001-MASTERY-v4`
**Bloom:** Apply
**ICFES:** Semántico
...
- [ ] D) Porque los árboles estaban muy cansados. <!-- feedback: Incorrecto. El susurro no indica cansancio en esta descripción. -->

### Explicación Pedagógica
La personificación es un tipo de lenguaje figurado donde se atribuyen rasgos humanos a objetos o elementos naturales. Comprender esta comparación implícita enriquece la lectura literaria.

---

## Question 5 [D3-D4]
**ID:** `CO-LEC-3-2026-W30-lenguaje-figurado-001-MASTERY-v5`
**Bloom:** Apply
**ICFES:** Semántico
...
- [ ] D) Pedir que le compren una mascota. <!-- feedback: Incorrecto. No hay ninguna petición de compra en la frase. -->

### Explicación Pedagógica
La hipérbole es una exageración intencionada para dar fuerza a una idea. Identificar esta intención permite al estudiante comprender el tono (muchas veces humorístico o crítico) del hablante.

---

## Question 6 [D3-D4]
**ID:** `CO-LEC-3-2026-W30-lenguaje-figurado-001-MASTERY-v6`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) Se le olvidó dónde estaba su casa. <!-- feedback: Incorrecto. Eso sería "perder el camino" o "perder la memoria". -->

### Explicación Pedagógica
Muchas expresiones del lenguaje figurado usan partes del cuerpo para representar emociones o estados mentales. El estudiante debe traducir el sentido literal al sentido figurado correcto.

---

## Question 7 [D4-D5]
**ID:** `CO-LEC-3-2026-W30-lenguaje-figurado-001-MASTERY-v7`
**Bloom:** Analyze
**ICFES:** Semántico
...
- Literal: "Esa habitación está muy desordenada".
- Figurado: "Esa habitación es un campo de batalla".
...
- [ ] D) Porque el cuarto es muy pequeño y oscuro. <!-- feedback: Incorrecto. Un campo de batalla suele ser grande y abierto; la comparación es por el desorden. -->

### Explicación Pedagógica
Analizar el punto de semejanza en una metáfora ("caos") ayuda al estudiante a comprender cómo se construyen las imágenes literarias a partir de experiencias compartidas.

---

## Question 8 [D4-D5]
**ID:** `CO-LEC-3-2026-W30-lenguaje-figurado-001-MASTERY-v8`
**Bloom:** Evaluate
**ICFES:** Crítico
...
- [ ] D) Sí, porque así la noticia parece un cuento de hadas. <!-- feedback: Incorrecto. Las noticias no deben parecer cuentos de hadas. -->
