...
Este bundle evalúa la capacidad de comprender el sentido completo de oraciones cortas, identificar sus partes (quién hace qué) y entender la intención comunicativa en contextos cercanos al estudiante colombiano.

---

## Question 1 [D1-D2]
**ID:** `CO-LEC-3-2026-W04-comprension-oraciones-001-MASTERY-v1`
**Bloom:** Remember
**ICFES:** Semántico
...
- [ ] D) Amarillo <!-- feedback: Incorrecto. No se menciona ese color en la oración. -->

### Explicación Pedagógica
La comprensión literal de una oración implica identificar los adjetivos que califican al sustantivo. En este caso, reconocer que "negro" es la característica del "gato" es un ejercicio básico de atención y decodificación.

---

## Question 2 [D1-D2]
**ID:** `CO-LEC-3-2026-W04-comprension-oraciones-001-MASTERY-v2`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) El vendedor de la plaza <!-- feedback: Incorrecto. Aunque puede haber un vendedor, la oración no lo menciona como el que realiza la acción principal. -->

### Explicación Pedagógica
Identificar el sujeto (quién realiza la acción) es fundamental para comprender la estructura de la oración. Reconocer sujetos compuestos une la lectura con la gramática básica de grado tercero.

---

## Question 3 [D2-D3]
**ID:** `CO-LEC-3-2026-W04-comprension-oraciones-001-MASTERY-v3`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) Que no hay ningún perro en la casa. <!-- feedback: Incorrecto. El aviso confirma que sí hay un perro. -->

### Explicación Pedagógica
Comprender la intención comunicativa de un mensaje requiere ir más allá de las palabras sueltas. El estudiante debe entender que el mensaje busca prevenir un susto, no necesariamente un ataque, basándose en la descripción del carácter del animal.

---

## Question 4 [D2-D3]
**ID:** `CO-LEC-3-2026-W04-comprension-oraciones-001-MASTERY-v4`
**Bloom:** Apply
**ICFES:** Semántico
...
- [ ] D) Café delicioso es el colombiano. <!-- feedback: Incorrecto. Es menos común y suena un poco extraño para una oración simple. -->

### Explicación Pedagógica
La sintaxis es el orden lógico de las palabras. Al organizar la oración, el estudiante demuestra que comprende cómo se construyen las ideas en su lengua materna para que sean claras y coherentes.

---

## Question 5 [D3-D4]
**ID:** `CO-LEC-3-2026-W04-comprension-oraciones-001-MASTERY-v5`
**Bloom:** Apply
**ICFES:** Semántico
...
- [ ] D) duermen <!-- feedback: Incorrecto. La acción de dormir no tiene relación con preparar una presentación para una fiesta. -->

### Explicación Pedagógica
El uso de verbos adecuados al contexto es esencial para la coherencia. El estudiante debe seleccionar la acción que lógicamente se realiza con un "baile típico", demostrando comprensión de las actividades escolares y culturales.

---

## Question 6 [D3-D4]
**ID:** `CO-LEC-3-2026-W04-comprension-oraciones-001-MASTERY-v6`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) Que dejó de llover antes de que salieran. <!-- feedback: Incorrecto. La expresión sugiere que todavía llovía o que el clima era malo. -->

### Explicación Pedagógica
Comprender conectores adversativos y concesivos básicos (como "a pesar de") permite al estudiante entender relaciones complejas entre ideas dentro de una misma oración, algo vital para la lectura crítica.

---

## Question 7 [D4-D5]
**ID:** `CO-LEC-3-2026-W04-comprension-oraciones-001-MASTERY-v7`
**Bloom:** Analyze
**ICFES:** Sintáctico
...
1. Juan llamó a su hermana.
2. Su hermana fue llamada por Juan.
...
- [ ] D) La primera oración está mal escrita. <!-- feedback: Incorrecto. Ambas oraciones son gramaticalmente correctas en español. -->

### Explicación Pedagógica
Reconocer la equivalencia semántica entre diferentes estructuras sintácticas (activa vs. pasiva) ayuda al estudiante a no dejarse confundir por la forma y centrarse en el contenido del mensaje.

---

## Question 8 [D4-D5]
**ID:** `CO-LEC-3-2026-W04-comprension-oraciones-001-MASTERY-v8`
**Bloom:** Evaluate
**ICFES:** Pragmático
...
- [ ] D) Que el cine esté abierto mañana. <!-- feedback: Incorrecto. Esa es una condición lógica, pero no es la que el papá expresó en su oración. -->
