...
Este bundle evalúa la capacidad de deducir información no explícita en el texto a partir de pistas (leer entre líneas), integrando el conocimiento previo con lo leído.

---

## Question 1 [D1-D2]
**ID:** `CO-LEC-3-2026-W21-inferencias-001-MASTERY-v1`
**Bloom:** Understand
**ICFES:** Inferencial
...
### Contexto
**La mochila de Sara**
"Sara siempre lleva su mochila verde al colegio. Adentro tiene cuadernos, lápices, colores y una lonchera con su almuerzo. Hoy Sara llegó al salón y abrió su mochila para sacar su cuaderno de matemáticas".
...
- [ ] D) Irse para su casa. <!-- feedback: Incorrecto. Acaba de llegar al salón y está preparando sus materiales. -->

### Explicación Pedagógica
La inferencia se basa en conectar pistas del texto con acciones lógicas. Sacar un cuaderno específico (matemáticas) en un salón de clases es una señal clara de que se va a estudiar esa materia, aunque el texto no lo diga explícitamente.

---

## Question 2 [D1-D2]
**ID:** `CO-LEC-3-2026-W21-inferencias-001-MASTERY-v2`
**Bloom:** Understand
**ICFES:** Inferencial
...
- [ ] D) Con mucha nieve. <!-- feedback: Incorrecto. En Colombia no es común que nieve por el cielo gris, pero sí que llueva. -->

### Explicación Pedagógica
Inferir el estado del tiempo a partir de las acciones del personaje (buscar paraguas y chaqueta) demuestra que el estudiante comprende la relación entre el entorno y las necesidades humanas.

---

## Question 3 [D2-D3]
**ID:** `CO-LEC-3-2026-W21-inferencias-001-MASTERY-v3`
**Bloom:** Understand
**ICFES:** Inferencial
...
- [ ] D) Quiere salir a la calle. <!-- feedback: Incorrecto. El texto resalta el plato vacío como la pista principal de su necesidad. -->

### Explicación Pedagógica
Interpretar el comportamiento animal descrito en el texto es una forma de inferencia cotidiana. El estudiante debe asociar la falta de comida/bebida con el comportamiento del gato.

---

## Question 4 [D2-D3]
**ID:** `CO-LEC-3-2026-W21-inferencias-001-MASTERY-v4`
**Bloom:** Apply
**ICFES:** Inferencial
...
- [ ] D) No pasaría nada, en la biblioteca se puede gritar. <!-- feedback: Incorrecto. El letrero prohíbe explícitamente el ruido. -->

### Explicación Pedagógica
Predecir consecuencias a partir de normas y situaciones descritas es un nivel de inferencia aplicado. El estudiante debe entender el conflicto que genera romper una regla de convivencia.

---

## Question 5 [D3-D4]
**ID:** `CO-LEC-3-2026-W21-inferencias-001-MASTERY-v5`
**Bloom:** Apply
**ICFES:** Inferencial
...
- [ ] D) Estaba jugando a las escondidas. <!-- feedback: Incorrecto. Los animales no juegan de esa forma en situaciones de peligro o desprotección. -->

### Explicación Pedagógica
Reconstruir un evento pasado a partir de la situación presente (ave en el suelo + nido en el árbol) es una inferencia de causalidad. El estudiante deduce el origen del problema.

---

## Question 6 [D3-D4]
**ID:** `CO-LEC-3-2026-W21-inferencias-001-MASTERY-v6`
**Bloom:** Understand
**ICFES:** Inferencial
...
- [ ] D) Los dos equipos se odiaban profundamente. <!-- feedback: Incorrecto. El odio no lleva a compartir una pizza al final. -->

### Explicación Pedagógica
Inferir el tono de una relación personal a partir de acciones sociales (darse la mano, compartir comida) permite comprender la pragmática de la comunicación y los valores sociales.

---

## Question 7 [D4-D5]
**ID:** `CO-LEC-3-2026-W21-inferencias-001-MASTERY-v7`
**Bloom:** Analyze
**ICFES:** Inferencial
...
- [ ] D) Es hora de ir a dormir. <!-- feedback: Incorrecto. Las campanas anuncian un festejo, no el descanso. -->

### Explicación Pedagógica
Esta es una inferencia lógica de tipo deductivo. Si A implica B, y escuchamos B, podemos inferir que ocurrió A. El estudiante aplica una regla social establecida en el texto.

---

## Question 8 [D4-D5]
**ID:** `CO-LEC-3-2026-W21-inferencias-001-MASTERY-v8`
**Bloom:** Evaluate
**ICFES:** Crítico
...
- [ ] D) Limpiar la chimenea para ayudar a los cerditos. <!-- feedback: Incorrecto. No es una acción propia de un lobo antagonista. -->
