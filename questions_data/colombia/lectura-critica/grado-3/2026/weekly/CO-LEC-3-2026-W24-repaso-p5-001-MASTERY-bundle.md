...
Este bundle integra los conocimientos de las semanas 21 a 23: inferencias, causa-efecto y textos periodísticos. Se enfoca en la capacidad analítica y crítica del estudiante.

---

## Question 1 [D1-D2]
**ID:** `CO-LEC-3-2026-W24-repaso-p5-001-MASTERY-v1`
**Bloom:** Remember
**ICFES:** Semántico
...
- [ ] D) El alcalde de la ciudad. <!-- feedback: Incorrecto. No se menciona la presencia de autoridades en este párrafo. -->

### Explicación Pedagógica
Repaso de comprensión literal en textos periodísticos (Semana 23). Identificar los actores de un evento es la base para entender cualquier noticia o reporte.

---

## Question 2 [D1-D2]
**ID:** `CO-LEC-3-2026-W24-repaso-p5-001-MASTERY-v2`
**Bloom:** Understand
**ICFES:** Inferencial
...
- [ ] D) Estaba durmiendo en su habitación. <!-- feedback: Incorrecto. Al entrar, apenas llega de la calle. -->

### Explicación Pedagógica
Repaso de inferencias (Semana 21). El estudiante debe conectar los objetos descritos (paraguas, botas con barro) con la situación climática no mencionada explícitamente.

---

## Question 3 [D2-D3]
**ID:** `CO-LEC-3-2026-W24-repaso-p5-001-MASTERY-v3`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) Que tenía un examen muy difícil. <!-- feedback: Incorrecto. El malestar es físico por falta de comida, no por nervios de examen. -->

### Explicación Pedagógica
Repaso de causa-efecto (Semana 22). Identificar la raíz de un problema cotidiano ayuda a los estudiantes a comprender la importancia de los hábitos saludables.

---

## Question 4 [D2-D3]
**ID:** `CO-LEC-3-2026-W24-repaso-p5-001-MASTERY-v4`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) El evento se realizó este año. <!-- feedback: Incorrecto. Es un dato temporal real. -->

### Explicación Pedagógica
Repaso de textos periodísticos (Semana 23). Distinguir entre el relato de hechos (llegar tarde) y los juicios de valor (ser un desastre) es clave para la lectura crítica.

---

## Question 5 [D3-D4]
**ID:** `CO-LEC-3-2026-W24-repaso-p5-001-MASTERY-v5`
**Bloom:** Apply
**ICFES:** Inferencial
...
- [ ] D) Porque la campana del recreo acababa de sonar. <!-- feedback: Incorrecto. Están en el salón con la profesora, no saliendo al recreo. -->

### Explicación Pedagógica
Las inferencias sobre las motivaciones de los personajes ayudan a comprender la dinámica social en los textos narrativos. El estudiante asocia el premio (helado) con el cambio de conducta.

---

## Question 6 [D3-D4]
**ID:** `CO-LEC-3-2026-W24-repaso-p5-001-MASTERY-v6`
**Bloom:** Apply
**ICFES:** Semántico
...
- [ ] D) Jabón en las manos -> Contaminación del agua. <!-- feedback: Incorrecto. El texto se enfoca en la cantidad de agua, no en la contaminación por jabón. -->

### Explicación Pedagógica
Repaso de causa-efecto (Semana 22). Identificar la cadena lógica en textos de concientización ambiental permite al estudiante entender su papel en la protección de los recursos naturales.

---

## Question 7 [D4-D5]
**ID:** `CO-LEC-3-2026-W24-repaso-p5-001-MASTERY-v7`
**Bloom:** Analyze
**ICFES:** Semántico
...
- Titular A: "Cerraron la calle por reparaciones en la tubería de agua".
- Titular B: "¡Caos total! Vecinos enfurecidos por calle cerrada sin previo aviso".
...
- [ ] D) El costo de las reparaciones de la tubería. <!-- feedback: Incorrecto. Ninguno menciona dinero. -->

### Explicación Pedagógica
Repaso de textos periodísticos (Semana 23). Comparar fuentes permite notar cómo se añaden o quitan detalles según el enfoque del periodista (objetivo vs. emocional).

---

## Question 8 [D4-D5]
**ID:** `CO-LEC-3-2026-W24-repaso-p5-001-MASTERY-v8`
**Bloom:** Analyze
**ICFES:** Crítico
...
- [ ] D) En que el científico es su papá. <!-- feedback: Incorrecto. No hay información que indique una relación familiar. -->
