...
Este bundle evalúa la comprensión de textos de divulgación científica para niños, identificando el lenguaje técnico básico, el uso de datos y la explicación de fenómenos naturales.

---

## Question 1 [D1-D2]
**ID:** `CO-LEC-3-2026-W38-textos-cientificos-001-MASTERY-v1`
**Bloom:** Remember
**ICFES:** Semántico
...
### Contexto
**El Planeta Tierra**
"La Tierra es el tercer planeta del sistema solar. Tiene una capa de gases que la rodea llamada **atmósfera**, la cual contiene el oxígeno que respiramos y nos protege de los rayos dañinos del sol".
...
- [ ] D) Sistema solar. <!-- feedback: Incorrecto. El sistema solar es el conjunto de planetas, no la capa de gases de la Tierra. -->

### Explicación Pedagógica
Identificar terminología científica básica permite al estudiante construir un vocabulario académico. Localizar el término "atmósfera" es el primer paso para comprender la geociencia básica.

---

## Question 2 [D1-D2]
**ID:** `CO-LEC-3-2026-W38-textos-cientificos-001-MASTERY-v2`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) Escuchar los latidos del corazón. <!-- feedback: Incorrecto. Eso lo hace un estetoscopio. -->

### Explicación Pedagógica
Comprender la función de los instrumentos científicos ayuda a los estudiantes a entender cómo se produce el conocimiento. Relacionar la herramienta (microscopio) con su uso (ver lo pequeño) es una habilidad de comprensión funcional.

---

## Question 3 [D2-D3]
**ID:** `CO-LEC-3-2026-W38-textos-cientificos-001-MASTERY-v3`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) Materia oscura. <!-- feedback: Incorrecto. El texto no menciona este concepto complejo. -->

### Explicación Pedagógica
Clasificar elementos de la vida cotidiana según categorías científicas (estados de la materia) demuestra que el estudiante puede aplicar el conocimiento teórico a la realidad.

---

## Question 4 [D2-D3]
**ID:** `CO-LEC-3-2026-W38-textos-cientificos-001-MASTERY-v4`
**Bloom:** Apply
**ICFES:** Semántico
...
- [ ] D) No pasaría nada, ella tiene sus propias lámparas. <!-- feedback: Incorrecto. El texto dice claramente que "no tiene luz propia". -->

### Explicación Pedagógica
Predecir consecuencias basadas en una ley o explicación científica (la Luna refleja la luz) desarrolla el razonamiento lógico-deductivo.

---

## Question 5 [D3-D4]
**ID:** `CO-LEC-3-2026-W38-textos-cientificos-001-MASTERY-v5`
**Bloom:** Apply
**ICFES:** Semántico
...
- [ ] D) Que los perros no necesitan sol para nada. <!-- feedback: Incorrecto. El sol es bueno para todos, pero el perro no depende de él para calentar su sangre. -->

### Explicación Pedagógica
Analizar contrastes biológicos permite al estudiante identificar variables científicas. El método de regulación térmica es la variable analizada en este párrafo.

---

## Question 6 [D3-D4]
**ID:** `CO-LEC-3-2026-W38-textos-cientificos-001-MASTERY-v6`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) Porque los experimentos son muy cortos. <!-- feedback: Incorrecto. Pueden ser largos o cortos, la razón es la seguridad de la información. -->

### Explicación Pedagógica
Comprender la base del método científico (experimentación y comprobación) ayuda a valorar el rigor de la ciencia frente a las opiniones o mitos.

---

## Question 7 [D4-D5]
**ID:** `CO-LEC-3-2026-W38-textos-cientificos-001-MASTERY-v7`
**Bloom:** Analyze
**ICFES:** Semántico
...
- [ ] D) Tu voz sonaría como la de un robot. <!-- feedback: Incorrecto. Simplemente no habría sonido según la ley física explicada. -->

### Explicación Pedagógica
Este ejercicio de análisis requiere aplicar una ley física explicada (necesidad de aire para el sonido) a un escenario específico. Desarrolla la transferencia de conocimiento científico.

---

## Question 8 [D4-D5]
**ID:** `CO-LEC-3-2026-W38-textos-cientificos-001-MASTERY-v8`
**Bloom:** Evaluate
**ICFES:** Crítico
...
- [ ] D) Porque el texto es muy corto para ser verdad. <!-- feedback: Incorrecto. Un descubrimiento real puede anunciarse de forma breve al principio. -->
