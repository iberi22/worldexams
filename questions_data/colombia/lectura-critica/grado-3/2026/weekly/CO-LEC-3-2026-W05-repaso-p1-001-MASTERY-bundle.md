...
Este bundle integra los conocimientos de las primeras cuatro semanas: reconocimiento de letras (abecedario/vocales), división silábica, lectura de palabras y comprensión de oraciones.

---

## Question 1 [D1-D2]
**ID:** `CO-LEC-3-2026-W05-repaso-p1-001-MASTERY-v1`
**Bloom:** Remember
**ICFES:** Semántico
...
- [ ] D) Todas son letras repetidas. <!-- feedback: Incorrecto. Cada palabra empieza con una letra diferente. -->

### Explicación Pedagógica
Identificar patrones comunes en grupos de palabras refuerza la categorización lingüística. En este caso, reconocer las cinco vocales como iniciadoras de palabras es un ejercicio de repaso fundamental de la semana 1.

---

## Question 2 [D1-D2]
**ID:** `CO-LEC-3-2026-W05-repaso-p1-001-MASTERY-v2`
**Bloom:** Remember
**ICFES:** Fonético
...
- [ ] D) COL - OM - BIA <!-- feedback: Incorrecto. La 'L' suele iniciar la segunda sílaba (CO-LOM) en lugar de cerrar la primera si la vocal siguiente lo permite. -->

### Explicación Pedagógica
Este ejercicio repasa la división silábica y el concepto de diptongo (vocal cerrada + vocal abierta) que se vio en la semana 2. "Colombia" es una palabra trisílaba.

---

## Question 3 [D2-D3]
**ID:** `CO-LEC-3-2026-W05-repaso-p1-001-MASTERY-v3`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) Parque <!-- feedback: Incorrecto. El parque es el lugar donde está el suelo, no su opuesto. -->

### Explicación Pedagógica
Reconocer relaciones de oposición (antónimos) amplía el vocabulario y la capacidad de análisis semántico, integrando lo aprendido en la semana 3 sobre el significado de las palabras.

---

## Question 4 [D2-D3]
**ID:** `CO-LEC-3-2026-W05-repaso-p1-001-MASTERY-v4`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) El bosque <!-- feedback: Incorrecto. No se menciona el bosque en la oración. -->

### Explicación Pedagógica
Identificar el sujeto y su acción en una oración narrativa simple es una habilidad clave de la semana 4. El estudiante debe distinguir entre el protagonista de la acción y los objetos involucrados.

---

## Question 5 [D3-D4]
**ID:** `CO-LEC-3-2026-W05-repaso-p1-001-MASTERY-v5`
**Bloom:** Apply
**ICFES:** Semántico
...
- [ ] D) Barranquilla - Bucaramanga - Bogotá <!-- feedback: Incorrecto. La 'o' de Bogotá está antes que la 'u' de Bucaramanga. -->

### Explicación Pedagógica
Este ejercicio de la semana 1 sube de nivel al exigir que el estudiante compare no solo la primera letra, sino las siguientes para lograr un ordenamiento alfabético preciso.

---

## Question 6 [D3-D4]
**ID:** `CO-LEC-3-2026-W05-repaso-p1-001-MASTERY-v6`
**Bloom:** Apply
**ICFES:** Fonético
...
- [ ] D) No tiene sílaba tónica <!-- feedback: Incorrecto. Todas las palabras de más de una sílaba la tienen. -->

### Explicación Pedagógica
Identificar el acento prosódico en palabras agudas sin tilde (como tamal) es un desafío importante de la semana 2. Ayuda a mejorar la pronunciación y la futura ortografía acentual.

---

## Question 7 [D4-D5]
**ID:** `CO-LEC-3-2026-W05-repaso-p1-001-MASTERY-v7`
**Bloom:** Analyze
**ICFES:** Semántico
...
1. El sol calienta la mañana.
2. La mañana es calentada por el sol.
...
- [ ] D) Las dos oraciones hablan de cosas diferentes. <!-- feedback: Incorrecto. Ambas hablan de la relación entre el sol y la mañana. -->

### Explicación Pedagógica
Este es un repaso de la semana 4 (comprensión de oraciones) donde se evalúa la capacidad de identificar la sinonimia sintáctica: dos formas diferentes de expresar el mismo contenido.

---

## Question 8 [D4-D5]
**ID:** `CO-LEC-3-2026-W05-repaso-p1-001-MASTERY-v8`
**Bloom:** Evaluate
**ICFES:** Pragmático
...
- [ ] D) Decirte que ya dejó de llover. <!-- feedback: Incorrecto. Si te vas a mojar, es porque probablemente está lloviendo o va a llover. -->
