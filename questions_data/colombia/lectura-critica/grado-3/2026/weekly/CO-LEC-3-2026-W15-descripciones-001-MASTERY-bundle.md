...
Este bundle evalúa la capacidad de identificar detalles en descripciones de personas, animales, objetos y lugares, reconociendo el uso de adjetivos y la creación de imágenes mentales a través de las palabras.

---

## Question 1 [D1-D2]
**ID:** `CO-LEC-3-2026-W15-descripciones-001-MASTERY-v1`
**Bloom:** Remember
**ICFES:** Semántico
...
- [ ] D) A los lentes redondos. <!-- feedback: Incorrecto. Los lentes son un objeto que ella usa. -->

### Explicación Pedagógica
La identificación de comparaciones literales ayuda a precisar las características de una descripción. Reconocer el referente "nieve" como símbolo de blancura es un ejercicio básico de comprensión de adjetivos.

---

## Question 2 [D1-D2]
**ID:** `CO-LEC-3-2026-W15-descripciones-001-MASTERY-v2`
**Bloom:** Understand
**ICFES:** Semántico
...
"Es un edificio de color rojo vibrante, con cuatro grandes cajas que parecen flotar. Por dentro, tiene luces de muchos colores y peceras gigantes donde nadan peces de todos los tamaños".
...
- [ ] D) Tiene muchos árboles adentro. <!-- feedback: Incorrecto. El texto menciona peceras, no árboles internos. -->

### Explicación Pedagógica
Localizar rasgos físicos en la descripción de un lugar permite al estudiante construir una imagen mental del escenario. Los adjetivos de color y forma son los pilares de este tipo de textos.

---

## Question 3 [D2-D3]
**ID:** `CO-LEC-3-2026-W15-descripciones-001-MASTERY-v3`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) Para contar una historia sobre un cohete. <!-- feedback: Incorrecto. El cohete es solo un detalle del dibujo, no el tema de las palabras. -->

### Explicación Pedagógica
Reconocer la función de los adjetivos calificativos es esencial para entender el género descriptivo. El estudiante debe comprender que estas palabras añaden información específica sobre el sustantivo.

---

## Question 4 [D2-D3]
**ID:** `CO-LEC-3-2026-W15-descripciones-001-MASTERY-v4`
**Bloom:** Apply
**ICFES:** Semántico
...
- [ ] D) Colores variados (para el pico). <!-- feedback: Incorrecto. El pico es "colorido", por lo que sí requiere varios colores. -->

### Explicación Pedagógica
La transferencia de información del texto a una imagen mental (o un posible dibujo) es una prueba de comprensión efectiva. El estudiante debe identificar qué información está ausente en la descripción dada.

---

## Question 5 [D3-D4]
**ID:** `CO-LEC-3-2026-W15-descripciones-001-MASTERY-v5`
**Bloom:** Apply
**ICFES:** Semántico
...
- [ ] D) Al león. <!-- feedback: Incorrecto. El león es un animal salvaje y no es "doméstico". -->

### Explicación Pedagógica
Las adivinanzas descriptivas requieren que el estudiante integre varias pistas para llegar a un concepto único. Identificar el referente a partir de sus acciones y rasgos es una habilidad de síntesis.

---

## Question 6 [D3-D4]
**ID:** `CO-LEC-3-2026-W15-descripciones-001-MASTERY-v6`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) Que la ciudad se vea gris y aburrida. <!-- feedback: Incorrecto. El texto resalta el color verde intenso, no el gris. -->

### Explicación Pedagógica
Comprender la relación entre las características ambientales (lluvia) y sus efectos visuales (color de la selva) ayuda a interpretar descripciones geográficas y naturales con mayor profundidad.

---

## Question 7 [D4-D5]
**ID:** `CO-LEC-3-2026-W15-descripciones-001-MASTERY-v7`
**Bloom:** Analyze
**ICFES:** Semántico
...
1. "Es una fruta de forma redondeada, con cáscara roja y semillas pequeñas en su interior".
2. "Es una fruta dulce y crujiente, que al morderla refresca la boca y nos llena de energía".
...
- [ ] D) No se diferencian en nada, dicen exactamente lo mismo. <!-- feedback: Incorrecto. Usan palabras y enfoques sensoriales muy distintos. -->

### Explicación Pedagógica
Analizar los enfoques sensoriales de una descripción permite al estudiante entender que un mismo objeto puede ser descrito desde lo visual, lo gustativo, lo auditivo, etc.

---

## Question 8 [D4-D5]
**ID:** `CO-LEC-3-2026-W15-descripciones-001-MASTERY-v8`
**Bloom:** Evaluate
**ICFES:** Crítico
...
- [ ] D) Mucha prisa y desorden. <!-- feedback: Incorrecto. Es todo lo contrario a una situación de prisa. -->
