...
Este bundle evalúa la comprensión de textos cuyo objetivo es explicar un tema de forma clara y objetiva, identificando definiciones, características y ejemplos.

---

## Question 1 [D1-D2]
**ID:** `CO-LEC-3-2026-W33-textos-expositivos-001-MASTERY-v1`
**Bloom:** Remember
**ICFES:** Semántico
...
"El ciclo del agua es el proceso continuo por el cual el agua se mueve en la Tierra. Este ciclo incluye la evaporación (el agua sube a las nubes), la condensación (se forman gotas) y la precipitación (lluvia)".
...
- [ ] D) La formación de las nubes grises. <!-- feedback: Incorrecto. Eso corresponde a la condensación. -->

### Explicación Pedagógica
Identificar definiciones explícitas dentro de un texto expositivo es una habilidad básica. El estudiante debe localizar el término y su explicación correspondiente que el autor proporciona de forma directa.

---

## Question 2 [D1-D2]
**ID:** `CO-LEC-3-2026-W33-textos-expositivos-001-MASTERY-v2`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) Que viven en grupos familiares. <!-- feedback: Incorrecto. El texto no menciona su forma de vida social, solo su aspecto físico. -->

### Explicación Pedagógica
Extraer características de una categoría (los insectos) permite al estudiante comprender cómo se organiza la información científica en los textos expositivos.

---

## Question 3 [D2-D3]
**ID:** `CO-LEC-3-2026-W33-textos-expositivos-001-MASTERY-v3`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) Expresar sentimientos de alegría por el sol. <!-- feedback: Incorrecto. El tono es neutral e informativo, no poético. -->

### Explicación Pedagógica
Identificar la intención comunicativa de los textos expositivos ayuda a los estudiantes a reconocer cuándo están ante una fuente de conocimiento científico o técnico.

---

## Question 4 [D2-D3]
**ID:** `CO-LEC-3-2026-W33-textos-expositivos-001-MASTERY-v4`
**Bloom:** Apply
**ICFES:** Semántico
...
- [ ] D) Las plantas nos dan agua fresca. <!-- feedback: Incorrecto. Las plantas necesitan agua, pero el texto no dice que nos la den. -->

### Explicación Pedagógica
Identificar relaciones de utilidad o beneficio en textos de ciencias naturales refuerza la comprensión de la interdependencia entre los seres vivos.

---

## Question 5 [D3-D4]
**ID:** `CO-LEC-3-2026-W33-textos-expositivos-001-MASTERY-v5`
**Bloom:** Apply
**ICFES:** Semántico
...
- [ ] D) En cualquier página, el orden no importa. <!-- feedback: Incorrecto. El texto dice que están en orden alfabético para facilitar la búsqueda. -->

### Explicación Pedagógica
Aplicar una regla de organización descrita en el texto (orden alfabético) a una situación práctica demuestra que el estudiante ha comprendido el concepto expuesto.

---

## Question 6 [D3-D4]
**ID:** `CO-LEC-3-2026-W33-textos-expositivos-001-MASTERY-v6`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) Poemas para mi mamá en su día. <!-- feedback: Incorrecto. La poesía busca expresar sentimientos, no exponer hechos científicos. -->

### Explicación Pedagógica
Diferenciar títulos por género textual permite al estudiante predecir el contenido y el tipo de lenguaje que encontrará en la lectura.

---

## Question 7 [D4-D5]
**ID:** `CO-LEC-3-2026-W33-textos-expositivos-001-MASTERY-v7`
**Bloom:** Analyze
**ICFES:** Semántico
...
- [ ] D) Una historia sobre quién inventó el computador. <!-- feedback: Incorrecto. El texto no es histórico, es descriptivo y comparativo. -->

### Explicación Pedagógica
Analizar las estrategias explicativas (como la comparación o la enumeración de ventajas) ayuda a los estudiantes a comprender cómo se construye el conocimiento en los textos de estudio.

---

## Question 8 [D4-D5]
**ID:** `CO-LEC-3-2026-W33-textos-expositivos-001-MASTERY-v8`
**Bloom:** Evaluate
**ICFES:** Crítico
...
- [ ] D) Ninguno, los perros no se deben estudiar en libros. <!-- feedback: Incorrecto. Todos los seres vivos son objeto de estudio científico. -->
