...
Este bundle evalúa la capacidad de comprender avisos publicitarios, identificar el producto o servicio que ofrecen, reconocer el eslogan y entender la intención persuasiva de los anuncios.

---

## Question 1 [D1-D2]
**ID:** `CO-LEC-3-2026-W25-textos-publicitarios-001-MASTERY-v1`
**Bloom:** Remember
**ICFES:** Semántico
...
- [ ] D) Un curso de cocina para hacer dulces. <!-- feedback: Incorrecto. Invita a comprar un producto ya hecho, no a aprender a hacerlo. -->

### Explicación Pedagógica
Identificar el objeto anunciado es la base de la lectura de publicidad. El estudiante debe distinguir entre el lugar donde está el anuncio y el contenido del mensaje publicitario.

---

## Question 2 [D1-D2]
**ID:** `CO-LEC-3-2026-W25-textos-publicitarios-001-MASTERY-v2`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) Que los zapatos están hechos de nubes de verdad. <!-- feedback: Incorrecto. Las nubes son agua y aire, no se puede fabricar calzado con ellas. -->

### Explicación Pedagógica
Comprender el lenguaje figurado en la publicidad es fundamental. El estudiante debe interpretar la metáfora del eslogan como una cualidad del producto (comodidad).

---

## Question 3 [D2-D3]
**ID:** `CO-LEC-3-2026-W25-textos-publicitarios-001-MASTERY-v3`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) Que el zoológico estará abierto solo los domingos. <!-- feedback: Incorrecto. El texto dice que está abierto "todos los días". -->

### Explicación Pedagógica
Identificar ofertas o promociones específicas en la publicidad ayuda al estudiante a extraer información útil para la toma de decisiones cotidianas.

---

## Question 4 [D2-D3]
**ID:** `CO-LEC-3-2026-W25-textos-publicitarios-001-MASTERY-v4`
**Bloom:** Apply
**ICFES:** Semántico
...
- [ ] D) Porque el deportista es el dueño de la fábrica de bebidas. <!-- feedback: Incorrecto. Generalmente son solo la imagen publicitaria, no los dueños. -->

### Explicación Pedagógica
Entender el uso de figuras de autoridad o fama en la publicidad desarrolla el pensamiento crítico frente a los modelos de comportamiento que proponen los medios.

---

## Question 5 [D3-D4]
**ID:** `CO-LEC-3-2026-W25-textos-publicitarios-001-MASTERY-v5`
**Bloom:** Apply
**ICFES:** Semántico
...
- [ ] D) Ocupar espacio porque el texto es muy corto. <!-- feedback: Incorrecto. La imagen es la parte más importante de muchos anuncios. -->

### Explicación Pedagógica
Analizar la función de la imagen en la publicidad (función apelativa) permite al estudiante comprender cómo se intenta influir en sus deseos y necesidades.

---

## Question 6 [D3-D4]
**ID:** `CO-LEC-3-2026-W25-textos-publicitarios-001-MASTERY-v6`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) Explicar que la crema dental es difícil de encontrar. <!-- feedback: Incorrecto. Si la recomiendan muchos, es porque quieren que se use y se compre fácilmente. -->

### Explicación Pedagógica
Identificar argumentos de autoridad (expertos) en la publicidad ayuda a los estudiantes a evaluar la validez de las promesas de los anuncios.

---

## Question 7 [D4-D5]
**ID:** `CO-LEC-3-2026-W25-textos-publicitarios-001-MASTERY-v7`
**Bloom:** Analyze
**ICFES:** Semántico
...
Anuncio A: "Ahorra agua. Es un recurso limitado".
Anuncio B: "¡No dejes que el mundo se seque! Cada gota que ahorras es vida para el futuro. ¡Cierra el grifo ya!"
...
- [ ] D) No hay diferencia, los dos dicen que el agua se acabó. <!-- feedback: Incorrecto. El tono y la fuerza del mensaje son muy diferentes. -->

### Explicación Pedagógica
Diferenciar entre publicidad informativa y publicidad emocional (o propaganda) es una habilidad de análisis crítico. El estudiante debe notar cómo las palabras y los signos de puntuación cambian la fuerza del mensaje.

---

## Question 8 [D4-D5]
**ID:** `CO-LEC-3-2026-W25-textos-publicitarios-001-MASTERY-v8`
**Bloom:** Evaluate
**ICFES:** Crítico
...
- [ ] D) Decir que el juguete es bueno para aprender matemáticas. <!-- feedback: Incorrecto. No menciona beneficios educativos. -->
