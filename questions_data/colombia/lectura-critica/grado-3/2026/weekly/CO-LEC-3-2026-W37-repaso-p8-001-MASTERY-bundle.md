...
Este bundle integra los conocimientos de las semanas 33 a 36: textos expositivos, argumentativos, editorial y textos multimodales. Se enfoca en la comprensión de textos no literarios y complejos.

---

## Question 1 [D1-D2]
**ID:** `CO-LEC-3-2026-W37-repaso-p8-001-MASTERY-v1`
**Bloom:** Remember
**ICFES:** Semántico
...
- [ ] D) Magma de superficie. <!-- feedback: Incorrecto. El término técnico que menciona el texto es lava. -->

### Explicación Pedagógica
Repaso de textos expositivos (Semana 33). Localizar definiciones y términos técnicos dentro de una explicación científica es una habilidad de recuperación de información.

---

## Question 2 [D1-D2]
**ID:** `CO-LEC-3-2026-W37-repaso-p8-001-MASTERY-v2`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) Que los niños traigan sus propios balones de la casa. <!-- feedback: Incorrecto. El texto habla de los balones que ya tiene el colegio. -->

### Explicación Pedagógica
Repaso de editorial (Semana 35). Identificar la solución planteada a un problema comunitario es la clave para comprender la intención constructiva del editorial.

---

## Question 3 [D2-D3]
**ID:** `CO-LEC-3-2026-W37-repaso-p8-001-MASTERY-v3`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) Que las pesas del gimnasio están hechas de fruta. <!-- feedback: Incorrecto. No tiene sentido lógico. -->

### Explicación Pedagógica
Repaso de textos multimodales (Semana 36). El estudiante integra el elemento visual (manzana + fuerza) con el mensaje escrito para deducir el consejo de salud.

---

## Question 4 [D2-D3]
**ID:** `CO-LEC-3-2026-W37-repaso-p8-001-MASTERY-v4`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) Que es mejor salir a jugar al parque que ver tele. <!-- feedback: Incorrecto. El autor compara la televisión con la lectura, no con el juego fuera. -->

### Explicación Pedagógica
Repaso de textos argumentativos (Semana 34). Identificar la razón o justificación que sostiene una opinión permite comprender la lógica del autor.

---

## Question 5 [D3-D4]
**ID:** `CO-LEC-3-2026-W37-repaso-p8-001-MASTERY-v5`
**Bloom:** Apply
**ICFES:** Semántico
...
- [ ] D) Las tres ciudades tienen el mismo clima. <!-- feedback: Incorrecto. El gráfico muestra diferencias claras en la cantidad de lluvia. -->

### Explicación Pedagógica
Repaso de multimodalidad y textos expositivos (Semanas 33 y 36). El estudiante debe traducir la información visual del gráfico a una conclusión escrita válida.

---

## Question 6 [D3-D4]
**ID:** `CO-LEC-3-2026-W37-repaso-p8-001-MASTERY-v6`
**Bloom:** Understand
**ICFES:** Semántico
...
- [ ] D) Que tenga muchos dibujos de monstruos gigantes. <!-- feedback: Incorrecto. Un texto expositivo usa ilustraciones científicas, no de "monstruos". -->

### Explicación Pedagógica
Diferenciar géneros por su base de realidad (fantasía vs. hechos comprobables) es fundamental para la alfabetización académica en primaria.

---

## Question 7 [D4-D5]
**ID:** `CO-LEC-3-2026-W37-repaso-p8-001-MASTERY-v7`
**Bloom:** Analyze
**ICFES:** Semántico
...
"Es urgente que el colegio arregle los bebederos de agua. Aunque nos piden ahorrar agua, los bebederos actuales gotean todo el día y se desperdician cientos de litros".
...
- [ ] D) Que no hay bebederos en el patio. <!-- feedback: Incorrecto. El texto dice que sí hay, pero que están dañados. -->

### Explicación Pedagógica
Analizar contradicciones lógicas en un texto argumentativo permite al estudiante comprender cómo se construye una crítica sólida basada en la observación de la realidad.

---

## Question 8 [D4-D5]
**ID:** `CO-LEC-3-2026-W37-repaso-p8-001-MASTERY-v8`
**Bloom:** Evaluate
**ICFES:** Crítico
...
- [ ] D) Las tablets son muy caras y se pueden romper fácil. <!-- feedback: Incorrecto. Criticar el otro objeto no defiende al libro de ser "aburrido". -->
