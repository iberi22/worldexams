...
## El Misterio de las Luciérnagas del Quindío

*En una reserva natural del departamento del Quindío, los biólogos notaron algo extraño. Durante años, las noches de julio se iluminaban con miles de luciérnagas. Pero este año, solo se veían algunas. Doña Matilde, que lleva 40 años viviendo allí, comentó: "Antes el campo brillaba como si tuviera estrellas en el suelo. Ahora casi no se ven". Los biólogos revisaron sus registros: el uso de pesticidas en los cultivos de café cercanos había aumentado un 300% en los últimos dos años. También descubrieron que la construcción de nuevas viviendas había reducido el bosque nativo. Las luciérnagas necesitan humedad y oscuridad para reproducirse. Las nuevas luces de las casas y la sequía del último verano complicaron aún más su situación.*
...
- [ ] D) En el Amazonas. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Identificación del lugar donde ocurren los hechos.
...
- [ ] D) 50 años. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Identificación de un dato numérico explícito.
...
- [ ] D) Que las luciérnagas habían migrado. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Comprensión del cambio descrito en el texto.
...
- [ ] D) Porque las luciérnagas se parecían a las estrellas de mar. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Inferencia del significado de una comparación poética en un contexto real.
...
- [ ] D) Los pesticidas son alimento para las luciérnagas. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Inferencia de una relación de causa-efecto no dicha explícitamente.
...
- [ ] D) Porque las luces calientan el ambiente. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Inferencia a partir de información implícita sobre los requisitos de hábitat.
...
- [ ] D) No le importa el cambio. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Inferencia del estado emocional a partir del lenguaje utilizado.
...
- [ ] D) Fue declarado reserva. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Identificación de un cambio explícito en el entorno.
...
- [ ] D) Mejora la agricultura. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Inferencia de las consecuencias ecológicas de la disminución de una especie.
...
- [ ] D) Que los pesticidas son buenos para el café. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Reflexión sobre la responsabilidad humana en la conservación de la biodiversidad.

### Explicación Pedagógica Final
Bundle de inferencia básica para grado 6. A partir de una situación real en el Quindío, los estudiantes practican la extracción de conclusiones, la identificación de relaciones causa-efecto implícitas y la interpretación de emociones y consecuencias no dichas explícitamente en el texto.
