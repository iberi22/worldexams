...
*La poesía es una forma especial de escribir. No solo importa lo que se dice, sino cómo suena. Los poetas organizan las palabras en versos y estrofas, y usan la rima para darles musicalidad. En Colombia tenemos una gran tradición poética: desde el poeta premio Nobel Gabriel García Márquez (que también escribió poesía) hasta juglares del vallenato y poetas populares. A continuación, exploramos poemas y canciones de nuestra tierra.*

**POEMA 1 — "Río de mi infancia" (inspirado en el río Magdalena)**

> Río de mi infancia, (a)
> espejo del cielo, (b)
> en tus aguas danza (a)
> todo mi consuelo. (b)
>
> Te llevo en la mente (c)
> aunque estés tan lejos, (d)
> como un sol ardiente (c)
> tras los viejos tejos. (d)

**POEMA 2 — "Coplas del llano" (inspirado en la poesía llanera)**

> Yo soy del llano adentro, (a)
> donde el horizonte es ancho. (b)
> Cabalgo con el viento (a)
> y me duermo con el chanco. (b)
>
> Cuando canta el arrendajo, (c)
> sé que el día va a empezar. (d)
> El llano es mi trabajo, (c)
> mi casa y mi hogar. (d)

**POEMA 3 — "Canción de cuna del Pacífico"**

> Duérmete mi niño, duérmete mi sol,
> que la luna viene a hacerte un colibrí.
> Duérmete mi niño, duérmete mi amor,
> que en el mar de noche brilla el pescaíto aquí.
...
- [ ] D) La última palabra de cada línea. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
La estrofa es la unidad estructural de un poema: un conjunto de versos que forman un bloque. Se separan visualmente con un espacio. Así como un texto en prosa se divide en párrafos, un poema se divide en estrofas.
...
- [ ] D) Cuatro estrofas de dos versos cada una. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Identificación de estrofas: se cuentan los bloques visuales separados por espacios. El Poema 1 tiene dos grupos de cuatro versos (estrofas de 4 versos = cuartetos).
...
- [ ] D) Que ambos versos tienen la misma longitud. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
La rima es la coincidencia de sonidos entre dos o más versos a partir de la última vocal acentuada. Los versos que riman no necesitan tener el mismo tema ni la misma extensión, solo compartir sonidos finales.
...
- [ ] D) Rima cruzada: que alterna. <!-- feedback: Incorrecto. "Rima cruzada" describe el patrón ABAB, no el tipo de sonido. La pregunta es sobre el TIPO de rima (consonante o asonante), no sobre el patrón. -->

### Explicación Pedagógica
Dos tipos de rima: (1) CONSONANTE: coinciden vocales Y consonantes (cielo-consuelo). (2) ASONANTE: coinciden solo las vocales (cielo-fuego, porque la "l" y "g" no coinciden, pero sí la "e" y "o").
...
- [ ] D) No tiene patrón de rima. <!-- feedback: Incorrecto. Sí tiene un patrón claro. -->

### Explicación Pedagógica
Los patrones de rima se nombran con letras: ABAB (cruzada o alterna), AABB (gemela o pareada), ABBA (abrazada). Identificar el patrón ayuda a entender la estructura musical del poema.
...
- [ ] D) Que la rima cambia a consonante. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
La rima asonante es común en poesía popular y canciones (como el vallenato y los llaneros). Es más flexible porque solo requiere que coincidan las vocales, permitiendo más opciones de palabras.
...
- [ ] D) Metáfora. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
La anáfora (repetición) es un recurso poético que refuerza el ritmo y la musicalidad. En canciones de cuna, la repetición crea un efecto calmante y envolvente, como un arrullo.
...
- [ ] D) Porque el Poema 3 es más moderno. <!-- feedback: Incorrecto. La fecha no determina la estructura poética. -->

### Explicación Pedagógica
La forma y el fondo están conectados: la estructura de un poema (versos, rimas, ritmo) se elige según el efecto deseado. Las canciones de cuna usan ritmos suaves y repetitivos; las coplas llaneras usan ritmos vivos y marcados.
...
- [ ] D) Los tres tienen exactamente el mismo número de versos. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
La poesía colombiana de raíz popular expresa un fuerte sentido de pertenencia regional. El paisaje no es solo un escenario: es parte de la identidad del poeta.
...
- [ ] D) "La poesía no tiene ritmo ni musicalidad." <!-- feedback: Incorrecto. El ritmo y la musicalidad son la esencia de la poesía. -->

### Explicación Pedagógica
Reflexión sobre la poesía en la vida cotidiana: la poesía no está solo en los libros de texto. Está en los versos de las canciones que escuchamos (vallenato, rap, pop, reguetón), en los arrullos que nos cantaban de niños, en las coplas populares. Todos somos capaces de apreciar y crear poesía.
