...
### Poema: "Voces del Campo"

*1. El río ríe entre las piedras,*
*2. su risa de agua cristalina.*
*3. Los árboles, como soldados,*
*4. vigilan la colina.*

*5. El sol tiene un millón de rayos*
*6. que abrazan la mañana.*
*7. Las nubes son algodones*
*8. en una cama de lona.*

*9. La lluvia tamborilea*
*10. con sus dedos en el techo.*
*11. El viento silba y silba*
*12. canciones sin derecho.*

*13. En la noche, las estrellas*
*14. son ojos que parpadean.*
*15. La luna es una moneda*
*16. que en el cielo centellea.*
...
- [ ] D) Aliteración. <!-- feedback: Incorrecto. La aliteración es la repetición de sonidos. "Río ríe" tiene cierta repetición de la R, pero la figura principal es la personificación. -->

### Explicación Pedagógica
La personificación es una figura literaria que atribuye cualidades o acciones humanas a objetos, animales o elementos de la naturaleza. En este caso, el río "ríe" —una acción humana— para transmitir la idea de que el agua fluye alegremente.
...
- [ ] D) Hipérbole. <!-- feedback: Incorrecto. No hay exageración. Los árboles pueden ser altos y firmes como soldados sin exagerar. -->

### Explicación Pedagógica
El símil (o comparación) usa palabras como "como", "cual", "parece" para establecer una relación de semejanza entre dos elementos. Aquí los árboles se parecen a soldados porque ambos están erguidos, firmes y alineados.
...
- [ ] D) Que el sol tiene exactamente un millón de rayos. <!-- feedback: Incorrecto. Es una exageración poética, no una afirmación científica. -->

### Explicación Pedagógica
La hipérbole exagera una característica para darle énfasis. "Un millón de rayos" no es un dato literal; es una forma de decir que hay muchísima luz. Identificar cuándo el poeta exagera intencionalmente es clave para comprender la poesía.
...
- [ ] D) Aliteración. <!-- feedback: Incorrecto. No hay repetición intencional de sonidos consonánticos. -->

### Explicación Pedagógica
La metáfora es una identificación directa entre dos elementos: "esto es aquello". A diferencia del símil, la metáfora no usa conectores de comparación. Dice "las nubes SON algodones", no "las nubes son COMO algodones". Esto hace que la imagen sea más potente.
...
- [ ] D) Aliteración, para repetir la letra T. <!-- feedback: Incorrecto. Aunque "tamborilea" tiene T, no es una repetición intencional a lo largo del verso. -->

### Explicación Pedagógica
La onomatopeya no solo imita sonidos de animales o cosas (tic-tac, miau), sino que también puede crear palabras que evocan un sonido específico. "Tamborilea" no es una palabra común; el poeta la inventa para que suene como la lluvia golpeando el techo.
...
- [ ] D) Hipérbole. <!-- feedback: Incorrecto. No exagera; solo repite para crear un efecto sonoro. -->

### Explicación Pedagógica
A veces, en un mismo verso se combinan varias figuras literarias. "El viento silba y silba" combina personificación (el viento hace algo humano) con aliteración (la repetición del sonido S recuerda al silbido del viento).
...
- [ ] D) La primera es una hipérbole y la segunda una metáfora. <!-- feedback: Incorrecto. Ambas son metáforas. "Ojos que parpadean" no exagera; identifica. -->

### Explicación Pedagógica
Reconocer que un mismo poeta puede usar la misma figura literaria (la metáfora) para describir diferentes elementos creando un efecto unitario. Las estrellas y la luna, descritas con metáforas distintas, contribuyen a la misma imagen del cielo nocturno.
...
- [ ] D) El verso 3 usa personificación y el 7 usa hipérbole. <!-- feedback: Incorrecto. Ninguno de los dos es personificación ni hipérbole. -->

### Explicación Pedagógica
Diferenciar entre símil y metáfora es una habilidad fundamental. La clave está en el conector: "como" indica símil; "es/son" indica metáfora. Ambos recursos embellecen el lenguaje, pero funcionan de manera diferente.
...
- [ ] D) Convierte el poema en una noticia. <!-- feedback: Incorrecto. Las figuras literarias hacen lo opuesto: alejan el texto del lenguaje literal y objetivo de una noticia. -->

### Explicación Pedagógica
Evaluar el efecto del lenguaje figurado es una habilidad crítica. Las figuras literarias no son adornos innecesarios: transforman la percepción del lector, conectando lo natural con lo humano y haciendo que el texto cobre vida.
...
- [ ] D) "El mar es una inmensidad de agua." <!-- feedback: Incorrecto. Es una definición literal. Aunque poética, no hay personificación. -->

### Explicación Pedagógica
La personificación requiere atribuir una acción o cualidad humana a algo que no es humano. "Susurrar secretos" le da al mar la capacidad de comunicarse como una persona, creando una imagen misteriosa y bella.

### Explicación Pedagógica Final
Bundle enfocado en figuras literarias: símil, metáfora, personificación, hipérbole, onomatopeya y aliteración. A través de un poema sobre la naturaleza colombiana, los estudiantes practican la identificación de cada figura, comprenden su efecto en el significado del texto, analizan las diferencias entre figuras similares (símil vs. metáfora), y evalúan el valor del lenguaje figurado en la creación de imágenes poéticas.
