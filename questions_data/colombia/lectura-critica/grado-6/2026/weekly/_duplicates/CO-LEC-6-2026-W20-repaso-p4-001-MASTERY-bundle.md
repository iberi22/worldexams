...
## Texto 1: Narrativo — La Caja de los Recuerdos

*Cada vez que llegaba diciembre, la abuela Elena subía al altillo de su casa en Villa de Leyva y bajaba una caja de madera cubierta de polvo. Sus nietos —Sara, de 11 años, y Tomás, de 8— se sentaban en la sala, emocionados, esperando a que la abuela abriera la caja.*

*—Esta carta —dijo la abuela, sacando un sobre amarillento— la escribió tu bisabuelo desde la selva del Chocó, cuando trabajaba como maestro en una escuela rural. Miren la letra, qué cuidada. En esa época no había celulares ni internet.*

*—Abuela, ¿por qué guardas estas cosas si ya no se usan? —preguntó Tomás.*

*La abuela Elena sonrió y guardó silencio un momento.*

*—Porque cuando alguien se va —dijo al fin—, lo único que queda son las historias que otros recuerdan. Esta caja no guarda objetos viejos. Guarda a las personas que ya no están.*

*Sara pasó la mano sobre la tapa de madera. En silencio, entendió que la caja no era solo una caja.*

---

## Texto 2: Informativo — ¿Por qué recordamos?

*La memoria es una función del cerebro que nos permite almacenar, retener y recuperar información. Pero la memoria no funciona como una grabadora: no guardamos todo exactamente como ocurrió. En lugar de eso, el cerebro selecciona, organiza y a veces transforma los recuerdos.*

*¿Por qué recordamos algunas cosas y olvidamos otras? Los científicos han identificado varios factores: la emoción (recordamos mejor lo que nos hace sentir algo), la repetición (lo que repasamos se fija más) y la relevancia (recordamos lo que es importante para nuestra supervivencia o bienestar).*

*Además, los recuerdos se consolidan mientras dormimos. Por eso es tan importante descansar bien después de estudiar: el cerebro necesita tiempo para organizar la información nueva.*

*Fuente: Adaptado de "El cerebro que aprende", Universidad Nacional de Colombia, 2025.*
...
- [ ] D) En Medellín. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Identificación de información explícita en un texto narrativo: el lugar donde ocurre la historia.
...
- [ ] D) Cuando leemos. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Identificación de información explícita en un texto informativo: un dato científico específico.
...
- [ ] D) Que Sara quería la caja para ella sola. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Interpretación de una frase con significado implícito: captar el sentido figurado de una expresión.
...
- [ ] D) Porque los recuerdos siempre son exactos. <!-- feedback: Incorrecto. El texto dice que pueden transformarse. -->

### Explicación Pedagógica
Interpretación de una analogía: entender por qué el autor compara la memoria con una grabadora para explicar un concepto.
...
- [ ] D) La escritura de cartas. <!-- feedback: Incorrecto. Solo el Texto 1. -->

### Explicación Pedagógica
Identificación del tema común entre dos textos de géneros diferentes. Esta habilidad es fundamental para la lectura comparada.
...
- [ ] D) Porque perdió la llave de la caja. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Identificación de la causa de una acción: ¿por qué un personaje actúa de determinada manera?
...
- [ ] D) Recordaría más porque su cerebro estaría más activo. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Inferencia de consecuencias basada en información del texto: aplicar el principio de consolidación de la memoria al caso del estudio nocturno.
...
- [ ] D) Que Villa de Leyva es un buen lugar para vivir. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Predicción basada en el desarrollo de los personajes: anticipar la comprensión futura de un personaje a partir de la experiencia actual narrada.
...
- [ ] D) No hay relación entre los dos textos. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Integración de dos textos: usar la información científica del Texto 2 para explicar un fenómeno narrativo del Texto 1.
...
- [ ] D) Un audífono para escuchar música mientras se ven las fotos. <!-- feedback: Incorrecto. No se relaciona con el tema. -->

### Explicación Pedagógica
Evaluación creativa y síntesis: proponer un elemento que combine la tradición familiar (Texto 1) con la comprensión científica de la memoria (Texto 2).

### Explicación Pedagógica Final
Bundle de repaso del Periodo 4 que integra comprensión inferencial (lectura entre líneas en el texto narrativo), predicciones (qué entenderá Tomás en el futuro), causas y consecuencias (por qué la abuela guarda objetos, por qué dormir ayuda a aprender) y relaciones entre textos (la explicación científica del Texto 2 ilumina la experiencia emocional del Texto 1). Contexto colombiano con Villa de Leyva y un texto adaptado de la Universidad Nacional.
