...
## El lenguaje que transforma la realidad

*Tres figuras literarias nos acompañan cada día sin que siempre las notemos: la metáfora, el símil y la personificación. Aparecen en poemas, en canciones de nuestros artistas colombianos, en cuentos, en la publicidad y hasta en la forma en que hablamos. A continuación, exploramos estas figuras a través de textos inspirados en la riqueza cultural y natural de Colombia.*

**TEXTO A — Carta a la abuela (fragmento)**

> Abuela, tus manos son dos nidos cálidos donde mis miedos se duermen. Tus arrugas son mapas de todos los caminos que has recorrido. Cuando te ríes, las flores del jardín se despiertan para escucharte. Tu voz es como un arrullo de paloma que me envuelve cuando todo está oscuro.

**TEXTO B — El café y sus secretos (descripción de un niño de Circasia, Quindío)**

> Las matas de café en la finca de mi abuelo son como soldados verdes formados en filas. Cuando sopla el viento, los cafetos susurran secretos entre ellos. Los granos maduros son rubíes escondidos entre las hojas. El sol, curioso, se asoma entre las ramas para ver cómo crecen. La cosecha es un tesoro que recogemos con cuidado.

**TEXTO C — Anuncio de una marca colombiana de mochilas Wayúu**

> Imagen: Una mochila Wayúu colorida sobre la arena del desierto de La Guajira.
> Texto: "Lleva contigo la historia de un pueblo. Cada mochila es un tejido de sueños ancestrales. Los hilos son caminos que unen generaciones. La mochila no es un accesorio: es un abrazo de la cultura Wayúu que te acompaña a donde vayas."
...
- [ ] D) A flores del jardín. <!-- feedback: Incorrecto. Las flores se despiertan cuando la abuela ríe, pero no se comparan con su voz. -->

### Explicación Pedagógica
Identificación de una comparación explícita: la voz de la abuela se compara con el arrullo (canto suave) de una paloma, sugiriendo que es una voz calmada, amorosa y reconfortante.
...
- [ ] D) Descripción literal: las arrugas son efectivamente mapas. <!-- feedback: Incorrecto. Las arrugas no son literalmente mapas. Es una imagen poética. -->

### Explicación Pedagógica
Distinción clave: la metáfora establece una identificación directa entre dos cosas usando el verbo "ser". "Tus arrugas SON mapas" implica que las arrugas CUENTAN una historia (como un mapa cuenta caminos), sin necesidad de decir "como".
...
- [ ] D) "las flores del jardín se despiertan" <!-- feedback: Incorrecto. Es una personificación, no un símil. -->

### Explicación Pedagógica
El símil se reconoce por palabras comparativas: "como", "tal cual", "parece", "así como", "más que". La presencia de "como" es la pista más clara.
...
- [ ] D) Exagera el tamaño de las flores. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
La personificación da vida y cualidades humanas a objetos inanimados, animales o elementos de la naturaleza. "Despertarse" y "escuchar" son acciones exclusivamente humanas (o de seres con sistema nervioso) que aquí se atribuyen a las flores.
...
- [ ] D) El símil es una figura más importante que la metáfora. <!-- feedback: Incorrecto. Ambas son igualmente importantes, solo que funcionan de manera distinta. -->

### Explicación Pedagógica
Diferencia de efecto: el símil es más suave y sugerente ("se parecen a"); la metáfora es más directa y poderosa ("son"). Imagina decir "tus ojos son como estrellas" (símil) vs. "tus ojos son estrellas" (metáfora). La segunda suena más poética y absoluta.
...
- [ ] D) "La cosecha es un tesoro que recogemos con cuidado" <!-- feedback: Incorrecto. Es una metáfora (la cosecha es un tesoro). -->

### Explicación Pedagógica
Las personificaciones dan vida a lo inanimado. En la literatura colombiana sobre el café, es común personificar los cafetos y el paisaje porque la naturaleza se siente viva y cercana en las fincas cafeteras.
...
- [ ] D) Que las mochilas solo sirven para guardar cosas. <!-- feedback: Incorrecto. El texto dice explícitamente que "no es un accesorio". -->

### Explicación Pedagógica
Las metáforas en publicidad no solo embellecen el mensaje: crean significado y valor simbólico. Transforman un producto (una mochila) en un vehículo de identidad cultural, apelando al deseo del consumidor de conectarse con tradiciones auténticas.
...
- [ ] D) Ambos textos son difíciles de entender. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
La función transformadora del lenguaje figurado: tanto una abuela como una mata de café son cosas "normales" en la vida colombiana. Las figuras literarias nos invitan a mirarlas con otros ojos, a descubrir su belleza y su valor profundo.
...
### Explicación Pedagógica
Las figuras literarias no son solo para poemas. Hablamos en metáforas todo el tiempo sin darnos cuenta: "perdí el hilo" (metáfora), "estoy quemado" (metáfora), "el tiempo vuela" (personificación). Reconocerlas nos hace más conscientes de cómo usamos el lenguaje.
...
- [ ] D) "La lluvia caía fuerte ese día." (agrega información temporal) <!-- feedback: Incorrecto. Agregar "ese día" no es una figura literaria. -->

### Explicación Pedagógica
Aplicación práctica: transformar lenguaje literal en lenguaje figurado. La clave es preguntarse: ¿cómo puedo decir esto de una manera que haga sentir al lector? Las figuras literarias nos dan herramientas para crear imágenes vívidas y emociones.
