...
## ¿El servicio militar obligatorio debe eliminarse en Colombia?

*En Colombia, el servicio militar obligatorio ha sido tema de debate por décadas. Mientras algunos defienden que es necesario para la defensa nacional y la formación de los jóvenes, otros consideran que es una violación a la libertad individual. A continuación presentamos dos posturas.*

**POSTURA 1: "El servicio militar forma ciudadanos" — Coronel (r) Andrés Ramírez**

El servicio militar obligatorio debe mantenerse. Colombia es un país que ha enfrentado conflictos armados durante décadas y necesita ciudadanos preparados para defender la soberanía. Además, el servicio militar forma el carácter: los jóvenes aprenden disciplina, responsabilidad y trabajo en equipo. Muchos jóvenes de zonas rurales encuentran en el servicio una oportunidad de estudio y trabajo que de otra forma no tendrían. Datos del Ejército Nacional muestran que más del 60% de los soldados que prestan servicio provienen de municipios con pocas oportunidades laborales. Para ellos, el servicio militar no es una obligación, es una oportunidad.

**POSTURA 2: "Obligar a servir no es libertad" — Laura Velásquez, abogada de derechos humanos**

El servicio militar obligatorio debe eliminarse. En un Estado democrático, nadie debería ser obligado a prestar un servicio en contra de su voluntad. Existen alternativas como el servicio social, que permiten aportar al país sin portar armas. Además, el servicio militar sigue siendo discriminatorio: afecta principalmente a jóvenes de bajos recursos que no pueden pagar la exención. Según la Defensoría del Pueblo, cada año se presentan más de 500 quejas por maltrato y violaciones a derechos fundamentales durante la prestación del servicio. Un país en paz no debería basar su defensa en jóvenes obligados.
...
- [ ] D) Los soldados de zonas rurales. <!-- feedback: Incorrecto. Los soldados son mencionados como beneficiarios, no como defensores de una postura. -->

### Explicación Pedagógica
Identificación de información explícita: quién defiende cada postura en un texto argumentativo con posiciones enfrentadas.
...
- [ ] D) La Universidad Nacional. <!-- feedback: Incorrecto. No se menciona a la Universidad Nacional. -->

### Explicación Pedagógica
Identificación de la fuente que respalda un argumento: el uso de datos de una institución oficial fortalece la credibilidad de la postura.
...
- [ ] D) Que las Fuerzas Militares necesitan más presupuesto. <!-- feedback: Incorrecto. No se menciona el presupuesto militar. -->

### Explicación Pedagógica
Identificación de la tesis en un texto argumentativo: la opinión principal que el autor defiende y busca sostener con argumentos.
...
- [ ] D) Colombia necesita ciudadanos preparados para defender la soberanía nacional. <!-- feedback: Incorrecto. Ese es un argumento central del coronel. -->

### Explicación Pedagógica
Diferenciar entre argumentos de una postura y de la otra: reconocer a qué lado pertenece cada argumento en un debate con posturas enfrentadas.
...
- [ ] D) Un argumento de experiencia personal (cuenta algo que le pasó). <!-- feedback: Incorrecto. No cuenta una experiencia personal. -->

### Explicación Pedagógica
Identificación del tipo de argumento: los argumentos basados en principios éticos apelan a valores compartidos (libertad, justicia, derechos humanos) para sostener una postura.
...
- [ ] D) Que Colombia tenga conflictos armados. <!-- feedback: Incorrecto. No cuestiona la existencia de conflictos. -->

### Explicación Pedagógica
Comprensión del contraargumento: identificar cómo una postura cuestiona los fundamentos de la postura opuesta, mostrando una perspectiva diferente sobre los mismos hechos.
...
- [ ] D) Que son familias con tradición militar. <!-- feedback: Incorrecto. El texto no menciona tradición familiar. -->

### Explicación Pedagógica
Inferencia sobre las condiciones socioeconómicas a partir de información presentada: conectar datos demográficos con las realidades de las personas afectadas.
...
- [ ] D) Que el servicio militar es necesario para defender la soberanía. <!-- feedback: Incorrecto. Es una opinión estratégica, no un hecho comprobable. -->

### Explicación Pedagógica
Evaluación de la solidez de los argumentos: los argumentos basados en datos cuantitativos verificables son más sólidos que las afirmaciones subjetivas o de opinión.
...
- [ ] D) Mantener el servicio obligatorio solo para jóvenes de zonas rurales. <!-- feedback: Incorrecto. Sería discriminatorio al imponer la obligación solo a un grupo poblacional. -->

### Explicación Pedagógica
Evaluación y síntesis: proponer una solución que integre argumentos de ambas posturas, demostrando comprensión del debate y capacidad de encontrar puntos de equilibrio.
...
- [ ] D) Las opiniones siempre incluyen números y los hechos no. <!-- feedback: Incorrecto. Los números pueden aparecer tanto en hechos como en opiniones. -->

### Explicación Pedagógica
Reflexión metacognitiva sobre la diferencia entre hechos y opiniones en textos argumentativos: habilidad fundamental para el pensamiento crítico y la lectura analítica.
