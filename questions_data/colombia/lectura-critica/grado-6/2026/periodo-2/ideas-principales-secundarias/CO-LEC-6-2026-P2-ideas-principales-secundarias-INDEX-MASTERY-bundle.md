...
tema: "ideas-principales-secundarias"
periodo: 2
...
## La Chiva: El Bus que es Fiesta

*La chiva es un tipo de bus tradicional de Colombia. Originalmente era el único transporte que conectaba los pueblos de las montañas con las ciudades. Su nombre viene del parecido entre el sonido de su motor y el ruido de una cabra. Las chivas son famosas por su colorido: cada una está pintada a mano con colores brillantes y dibujos de flores, paisajes y animales. En su interior, tienen bancas de madera y un techo alto para que los pasajeros quepan con sus mercancías. Con el tiempo, las chivas dejaron de ser solo transporte. En muchas regiones, se convirtieron en chivas rumberas: buses adaptados para fiestas, con música, luces y espacio para bailar. Hoy en día, la chiva es un símbolo cultural de Colombia. Representa la alegría, el ingenio y la tradición de nuestros pueblos. En 2023, el Ministerio de Cultura declaró a la chiva como Bien de Interés Cultural de la Nación.*
...
- [ ] D) Vender comida ambulante. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Identificación de la función original descrita en el texto.
...
- [ ] D) Porque solo viajan chivas en ella. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Identificación del origen del nombre.
...
- [ ] D) Las chivas están desapareciendo. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Identificación de la idea central que engloba todo el texto.
...
- [ ] D) El texto explica la evolución de la chiva. <!-- feedback: Incorrecto (esto describe el texto mismo). -->

### Explicación Pedagógica
Diferenciación entre detalle descriptivo (secundario) y tema central (principal).
...
- [ ] D) Tienen televisores. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Identificación de un detalle descriptivo.
...
- [ ] D) Que tiene ruedas grandes. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Identificación de un detalle que respalda la idea principal.
...
- [ ] D) Es el tema central del texto. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Comprensión de cómo los párrafos apoyan la idea central.
...
- [ ] D) Se exportó a otros países. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Identificación de un hecho relevante.
...
- [ ] D) Para hacer el texto más largo. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Reflexión metacognitiva sobre la importancia de la jerarquización textual.
...
- [ ] D) Las chivas son famosas. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Evaluación de la capacidad de síntesis identificando lo esencial.

### Explicación Pedagógica Final
Bundle enfocado en la jerarquización de información: diferenciar ideas principales de secundarias en un texto expositivo sobre la chiva colombiana. Desarrolla habilidades de síntesis, identificación del tema central y reconocimiento de detalles de apoyo.
