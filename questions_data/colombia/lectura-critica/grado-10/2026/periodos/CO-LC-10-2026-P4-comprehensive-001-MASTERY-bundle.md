---
id: "CO-LC-10-2026-P4-comprehensive-001-MASTERY-bundle"
country: "colombia"
grado: 10
...
**Contexto:** En clase de filosofia en el colegio San Jose de la Salle en Medellin.
...
**Bloom:** Remember | **ICFES:** Identificar y entender contenidos locales
**Contexto:** En argumentacion filosofica, se estudia el silogismo.
...
**Contexto:** Texto academico: "El presente estudio analiza el impacto de las TIC en el rendimiento academico de estudiantes de grado 10 en Bogota. La hipotesis sostiene que el uso guiado de herramientas digitales mejora los resultados en matematicas. Se aplico una metodologia mixta con 200 estudiantes."
...
**Contexto:** Texto: "Descartes argumenta: 1. Puedo dudar de todo. 2. Pero no puedo dudar de que estoy dudando. 3. Luego, si dudo, existo. Concluye: 'Pienso, luego existo'."
...
**Contexto:** Texto: "Segun el DANE 2023, la tasa de desempleo juvenil en Colombia es del 18.5%, contrastando con la tasa general del 9.2%. La brecha evidencia problemas estructurales."
...
**Contexto:** Silogismo: "Todos los colombianos son latinoamericanos. Maria es colombiana. Luego, Maria es latinoamericana."
...
**Contexto:** Texto: "El abstract de un articulo cientifico debe incluir objetivo, metodologia, resultados y conclusiones."
...
**Bloom:** Analyze | **ICFES:** Reflexionar sobre el contenido
**Contexto:** Platon: mundo sensible = copia imperfecta del mundo de las Ideas. Aristoteles: las esencias estan en las cosas mismas.
...
**Contexto:** Tesis: "Este trabajo busca llenar un vacio en la literatura sobre el conflicto armado colombiano al incorporar la perspectiva de genero, ausente en estudios previos."
...
**Bloom:** Understand | **ICFES:** Identificar y entender contenidos locales
**Contexto:** "No podemos permitir las drogas porque son malas."
...
**Bloom:** Analyze | **ICFES:** Reflexionar sobre el contenido
**Contexto:** Texto: "Nietzsche critica la moral occidental por ser una moral de esclavos que valora la debilidad. Propone la voluntad de poder como fuerza creadora que trasciende el bien y el mal."
...
**Contexto:** Texto academico: "Los resultados muestran una correlacion de 0.85 entre horas de estudio y puntaje ICFES. Sin embargo, correlacion no implica causalidad."
...
**Bloom:** Evaluate | **ICFES:** Reflexionar sobre el contenido
**Contexto:** "Kant afirma que debemos actuar de tal modo que la maxima de nuestra accion pueda convertirse en ley universal (imperativo categorico)."
...
**Bloom:** Evaluate | **ICFES:** Reflexionar sobre el contenido
**Contexto:** Un estudiante argumenta: "Si todos los estudiantes copiaran, el sistema educativo colapsaria. Por tanto, copiar esta mal."
...
**Bloom:** Evaluate | **ICFES:** Reflexionar sobre el contenido
**Contexto:** Texto: "El articulo de revision bibliografica concluye que la mayoria de estudios sobre desercion escolar en Colombia se han focalizado en zonas urbanas, dejando un vacio en el conocimiento sobre las rurales."
...
**Contexto:** Texto: "John Rawls propone el 'velo de ignorancia': para disenar una sociedad justa, debemos ignorar nuestra posicion social, talentos y genero. Solo asi lograremos principios imparciales."
...
**Contexto:** Un estudiante debe escribir un ensayo filosofico sobre la justicia.
...
**Bloom:** Evaluate | **ICFES:** Reflexionar sobre el contenido
**Contexto:** Texto: "La falacia ad hominem ocurre cuando se ataca a la persona que argumenta en lugar de refutar su argumento. Ejemplo: 'Usted no puede hablar de pobreza porque es rico'."
...
**Bloom:** Create | **ICFES:** Reflexionar sobre el contenido
**Contexto:** Se debe disenar la introduccion de un articulo academico sobre movilidad social en Colombia.
...
**Bloom:** Evaluate | **ICFES:** Reflexionar sobre el contenido
**Contexto:** Texto: "Sartre afirma que 'el hombre esta condenado a ser libre'. Esto significa que no hay esencia predeterminada: existimos primero y luego nos definimos mediante nuestras elecciones. La angustia surge de la responsabilidad total."
