...
tema: "textos-continuos-discontinuos"
periodo: 3
...
## El Consumo de Agua en Colombia: Un Análisis Multimodal

**Texto Continuo: ¿Cómo Usamos el Agua los Colombianos?**

*Colombia es uno de los países con mayor disponibilidad de agua dulce en el mundo. Sin embargo, el acceso no es equitativo. Mientras en Bogotá una persona consume en promedio 120 litros de agua al día, en La Guajira el consumo es de apenas 20 litros por persona. La mayor parte del agua en Colombia se usa para agricultura (54%), seguida del uso doméstico (28%), industrial (12%) y otros usos (6%). El cambio climático está afectando la disponibilidad: en los últimos 10 años, el 40% de los municipios colombianos ha experimentado algún tipo de racionamiento de agua. El IDEAM advierte que para 2030, el 70% de la población podría enfrentar estrés hídrico en alguna época del año si no cambiamos nuestros hábitos de consumo.*

**Texto Discontinuo: Gráfica de Consumo de Agua por Sector en Colombia**

```
CONSUMO DE AGUA POR SECTOR (Colombia, 2025)
┌──────────────────────────────────────────────────────────┐
│  Agricultura        ████████████████████████████  54%    │
│  Doméstico          ██████████████                 28%    │
│  Industrial         ██████                         12%    │
│  Otros              ███                             6%    │
├──────────────────────────────────────────────────────────┤
│  Racionamiento en municipios (últimos 10 años):   40%    │
└──────────────────────────────────────────────────────────┘
```

**Tabla: Consumo Diario por Ciudad (Litros por Persona)**

| Ciudad | Consumo diario (L/persona) | Población (millones) |
|--------|---------------------------|---------------------|
| Bogotá | 120 | 8,0 |
| Medellín | 115 | 2,6 |
| Cali | 108 | 2,3 |
...
- [ ] D) Otros. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Identificación de un dato en texto continuo.
...
### Explicación Pedagógica
Identificación de un dato en texto discontinuo (gráfica).
...
- [ ] D) 115 litros. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Identificación de dato en tabla.
...
- [ ] D) La tabla es más importante que la gráfica. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Comprensión de cómo dos formatos distintos ofrecen información complementaria.
...
- [ ] D) Tienen el mismo consumo. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Comparación de datos entre filas de una tabla.
...
- [ ] D) Que el agua es más barata en Bogotá. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Inferencia de implicaciones sociales a partir de datos numéricos.
...
- [ ] D) La tabla de ciudades. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Integración de información textual y visual para confirmar hallazgos.
...
- [ ] D) 120 millones de litros. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Cálculo e inferencia a partir de dos columnas de la tabla.
...
- [ ] D) El consumo aumentará. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Identificación de una proyección en el texto continuo.
...
- [ ] D) Es más divertida. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Comparación de las ventajas de cada formato textual.
...
### Explicación Pedagógica
Identificación de las fortalezas de cada formato.
...
- [ ] D) Porque son más baratos de producir. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Reflexión sobre la complementariedad de formatos en la comunicación multimodal.
...
- [ ] D) La advertencia del IDEAM. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Clasificación correcta entre texto continuo y discontinuo.
...
- [ ] D) El problema del agua solo afecta a Bogotá. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Síntesis de información multimodal para llegar a una conclusión integrada.

### Explicación Pedagógica Final
Bundle sobre textos continuos y discontinuos para grado 8, con información sobre el consumo de agua en Colombia presentada en tres formatos: texto expositivo, gráfica de barras y tabla. Desarrolla habilidades de extracción de datos de múltiples formatos, integración de información textual y visual, comparación de fortalezas comunicativas de cada formato, y síntesis de conclusiones a partir de datos multimodales.
