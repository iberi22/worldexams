...
## ¿Es Verdad lo que Dicen sobre la Jornada Laboral?

*En redes sociales circula información contradictoria sobre un proyecto de reforma laboral en Colombia. Analicemos cuatro publicaciones:*

**Publicación 1: Tuit de Usuario @NoticiasYA (1000 seguidores, sin verificar)**
*"URGENTE: El gobierno va a eliminar el descanso de media hora para el almuerzo. Desde julio, todos los colombianos trabajarán 10 horas seguidas. ¡Comparte para que la gente se entere! #ReformaLaboral"*

**Publicación 2: Publicación de Facebook — "Colombia Informa" (página con 50.000 seguidores)**
*"Los senadores aprobaron un proyecto que reduce de 48 a 42 horas semanales la jornada laboral sin disminuir el salario. La ley beneficiará a 4 millones de trabajadores. Fuente: Ministerio del Trabajo, comunicado oficial del 15 de marzo."*

**Publicación 3: Video de TikTok (@DatosColombia)**
*"Según el DANE, el 63% de los colombianos que trabajan en la informalidad no tienen acceso a prestaciones sociales. Con la nueva reforma, se espera que 1,5 millones de trabajadores informales puedan formalizarse. #DatosReales #Colombia"*

**Publicación 4: Cadena de WhatsApp**
*"⚠️ Esto es muy grave ⚠️ Pase la voz: van a quitar las primas y las cesantías. A mi cuñado que trabaja en una empresa grande le dijeron que desde junio se acaban. ¡COMPARTE A TODOS TUS CONTACTOS!"*
...
- [ ] D) 40 horas. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Identificación de un dato específico.
...
- [ ] D) Publicación 4: porque es WhatsApp. <!-- feedback: Incorrecto (aunque WhatsApp es menos confiable, la 1 es peor). -->

### Explicación Pedagógica
Evaluación inicial de confiabilidad basada en formato y estilo.
...
- [ ] D) Que es larga. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Identificación de señales de alerta típicas de cadenas de desinformación.
...
- [ ] D) Que tiene 1000 seguidores. <!-- feedback: Parcial, pero no es determinante. -->

### Explicación Pedagógica
Aplicación de criterios de fact-checking básico.
...
- [ ] D) Que apoya la reforma. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Identificación de características que aumentan la confiabilidad: fuente verificable y datos específicos.
...
- [ ] D) Un rumor. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Identificación del tipo de evidencia y su peso en la veracidad.
...
- [ ] D) Ignorarla. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Comprensión del proceso de verificación de fuentes.
...
- [ ] D) Ambas dan datos exactos. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Identificación de patrones comunes en la desinformación.
...
- [ ] D) Depende del tema. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Diferenciación entre popularidad y credibilidad.
...
- [ ] D) Promover el debate respetuoso. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Inferencia de la intención detrás de la desinformación.
...
- [ ] D) Ignorarla completamente sin hacer nada. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Aplicación de comportamiento responsable ante información no verificada.
...
- [ ] D) Solo Publicación 3 (TikTok). <!-- feedback: Parcial. -->

### Explicación Pedagógica
Evaluación y selección de fuentes confiables.
...
- [ ] D) Es una red social. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Identificación del valor de las instituciones oficiales como fuentes confiables.
...
- [ ] D) Una es de derecha y otra de izquierda. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Análisis comparativo de la calidad informativa de distintas publicaciones.

### Explicación Pedagógica Final
Bundle sobre veracidad de fuentes y detección de desinformación para grado 8. A través de cuatro publicaciones simuladas sobre la reforma laboral colombiana, los estudiantes desarrollan habilidades de fact-checking, identificación de señales de desinformación, evaluación de confiabilidad según fuentes citadas, y comprensión de la importancia de verificar antes de compartir información.
