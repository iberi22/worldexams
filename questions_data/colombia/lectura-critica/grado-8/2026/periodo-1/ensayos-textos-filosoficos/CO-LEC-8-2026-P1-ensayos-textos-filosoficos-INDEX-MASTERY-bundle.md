...
tema: "ensayos-textos-filosoficos"
periodo: 1
...
## Fragmento: ¿Qué es el Progreso? por M. Rivera

*"Vivimos en una época que celebra el progreso. Cada año sale un teléfono más rápido, una inteligencia artificial más lista, un avión que nos lleva más lejos. Pero, ¿hemos avanzado realmente como sociedad? El progreso tecnológico no siempre significa progreso humano. Podemos comunicarnos al instante con alguien al otro lado del mundo, pero a veces no conocemos al vecino de al lado. Tenemos acceso a más información que nunca, pero nos cuesta más trabajo distinguir la verdad de la mentira. El filósofo colombiano Estanislao Zuleta decía que el verdadero progreso no está en tener más cosas, sino en tener mejores relaciones humanas y una capacidad más profunda de pensar por nosotros mismos. Quizás el progreso no es un destino al que llegamos, sino una pregunta que nos acompañará siempre. ¿Somos realmente mejores que nuestros abuelos? ¿O solo tenemos juguetes más caros?"*
...
- [ ] D) Jorge Isaacs. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Identificación de una referencia explícita.
...
- [ ] D) El progreso educativo. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Comprensión del objeto de la crítica.
...
- [ ] D) Los abuelos eran mejores que nosotros. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Identificación de la tesis central del ensayo filosófico.
...
- [ ] D) Vender productos tecnológicos. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Identificación del propósito reflexivo del ensayo filosófico.
...
- [ ] D) Que no hay comunicación. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Identificación de una paradoja o contradicción planteada por el autor.
...
- [ ] D) Que la información es cara. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Comprensión de la ironía como recurso argumentativo.
...
- [ ] D) Para contradecir su propia tesis. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Análisis de la función de una cita de autoridad en un ensayo.
...
- [ ] D) Son dudas del autor. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Análisis del uso de preguntas retóricas en textos filosóficos.
...
- [ ] D) Algo imposible. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Interpretación de la postura filosófica del autor.
...
### Explicación Pedagógica
Identificación de la oposición conceptual central.
...
- [ ] D) Que no deberían hacer teléfonos nuevos. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Interpretación de la crítica implícita al consumismo tecnológico.
...
- [ ] D) Pregunta, respuesta, conclusión cerrada. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Reconocimiento de la estructura del ensayo filosófico.
...
- [ ] D) Ignora la tecnología. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Evaluación de la solidez argumentativa del ensayo.
...
- [ ] D) Porque habla de tecnología. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Diferenciación entre ensayo filosófico y otros géneros textuales.
...
- [ ] D) ¿Dónde queda la tienda? <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Generación de preguntas filosóficas a partir de la lectura.

### Explicación Pedagógica Final
Bundle sobre ensayos y textos filosóficos para grado 8. El texto invita a reflexionar críticamente sobre el concepto de progreso en la sociedad contemporánea. Desarrolla habilidades de identificación de tesis filosófica, análisis de paradojas e ironías, reconocimiento de estructura ensayística y evaluación de argumentos reflexivos. Incluye referencia al pensador colombiano Estanislao Zuleta.
