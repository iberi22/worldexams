...
*El Cóndor Andino es una de las aves más grandes del mundo que puede volar. Vive en las altas montañas de la Cordillera de los Andes, desde Venezuela hasta Chile. Sus alas extendidas pueden medir hasta 3 metros de largo. Es un ave carroñera, lo que significa que se alimenta de animales muertos, ayudando a limpiar el ecosistema. En Colombia, el Cóndor es un símbolo patrio y aparece en la parte superior de nuestro Escudo Nacional, representando la libertad y la grandeza de nuestra nación. Lamentablemente, se encuentra en peligro de extinción debido a la caza y la pérdida de su hábitat.*
...
- [ ] D) Menos de medio metro. <!-- feedback: Incorrect. Esta medida sería de un ave pequeña, no del ave voladora más grande del mundo como describe el texto. -->

### Explicación Pedagógica
Se evalúa la recuperación de información puntual en un texto informativo. La respuesta correcta se encuentra de forma literal. Los errores comunes surgen de no localizar el dato numérico exacto en la lectura.
...
- [ ] D) Solo en los zoológicos de Colombia. <!-- feedback: Incorrect. El texto describe su vida en estado salvaje a lo largo de toda una cordillera continental. -->

### Explicación Pedagógica
Se evalúa la comprensión del espacio geográfico mencionado en un texto expositivo. La respuesta correcta identifica el nombre propio de la región. El error típico es confundir diferentes regiones naturales de Colombia.
...
- [ ] D) Que cultiva sus propios alimentos en las rocas. <!-- feedback: Incorrect. Los animales no cultivan alimentos; es una idea ajena a la biología descrita en el texto. -->

### Explicación Pedagógica
Se evalúa la capacidad de definir términos técnicos a partir del contexto del texto. La respuesta correcta asocia "carroñera" con la función de limpieza biológica. Un error frecuente es confundir carnívoros cazadores con carroñeros.
...
- [ ] D) El color amarillo de nuestra bandera. <!-- feedback: Incorrect. Los colores tienen sus propios significados; el cóndor como figura representa ideales políticos y sociales. -->

### Explicación Pedagógica
Se evalúa la interpretación del simbolismo nacional presentado en el texto. La respuesta correcta vincula el animal con los valores patrios. Los errores suelen ser por confusión entre los diferentes símbolos que aparecen en el escudo.
...
- [ ] D) Porque ya no quiere volar por el ruido de los aviones. <!-- feedback: Incorrect. Es una explicación imaginaria que no aparece en el texto informativo proporcionado. -->

### Explicación Pedagógica
Se evalúa la identificación de causas y consecuencias en un problema ambiental descrito. La respuesta correcta extrae los factores directos mencionados. Los estudiantes a veces asumen causas generales que no están en el texto.
...
- [ ] D) Porque el cóndor vive dentro de un escudo de madera. <!-- feedback: Incorrect. Es una interpretación literal y errónea del uso simbólico del animal en el escudo nacional. -->

### Explicación Pedagógica
Se evalúa la comprensión de la relación entre el título y el contenido del texto. La respuesta correcta sintetiza los ejes temáticos. El error común es no entender el uso de metáforas o adjetivos en los títulos.
...
- [ ] D) Es una noticia sobre un cóndor que se escapó de un parque. <!-- feedback: Incorrect. No narra un hecho reciente o particular, sino características generales de la especie. -->

### Explicación Pedagógica
Se evalúa el reconocimiento de la tipología textual. La respuesta correcta identifica el formato informativo/expositivo. Los errores reflejan una falta de distinción entre textos literarios y no literarios.
...
- [ ] D) Ya no habría más viento en las cordilleras. <!-- feedback: Incorrect. El viento es un fenómeno meteorológico independiente de la presencia de las aves. -->

### Explicación Pedagógica
Se evalúa la capacidad de proyectar consecuencias lógicas a partir de la información funcional de un texto. La respuesta correcta deduce el impacto de perder un "limpiador" natural. Los errores suelen ser por falta de razonamiento ecológico básico.
...
- [ ] D) El nombre científico que le dan los doctores. <!-- feedback: Incorrect. Los nombres científicos son etiquetas de clasificación, no el lugar donde viven las especies. -->

### Explicación Pedagógica
Se evalúa el dominio del vocabulario técnico ambiental. La respuesta correcta define "hábitat" con precisión. Los estudiantes a menudo confunden hábitat con otros términos biológicos como dieta o rasgos físicos.
...
- [ ] D) Chile es el único país donde el cóndor vive feliz. <!-- feedback: Incorrect. El texto dice que vive desde Venezuela hasta Chile, por lo que no es exclusivo de un solo país. -->

### Explicación Pedagógica
Se evalúa la capacidad de síntesis del mensaje central. La respuesta correcta integra los datos descriptivos con el llamado a la acción. Los errores comunes provienen de interpretaciones parciales o sesgadas de la información.

### Explicación Pedagógica Final
Este bundle de Lectura Crítica para segundo periodo de cuarto grado se enfoca en el texto informativo. A través del estudio del Cóndor de los Andes, se evalúan habilidades como la extracción de datos literales, la definición de términos por contexto (carroñero, hábitat), la interpretación de simbolismos culturales y la comprensión de relaciones causa-efecto en temas ambientales. El objetivo es que el estudiante aprenda a leer para informarse y sea capaz de organizar las ideas principales de un texto expositivo, reconociendo su estructura y propósito comunicativo.
