...
## Poema: Receta para Volar — Por Valentina, 9 años (I.E. La Candelaria, Medellín)

*Para volar necesitas:*
*un papel de colores,*
*un pedazo de cielo,*
*dos alas de ilusión*
*y mucha imaginación.*

*Toma el viento de la tarde,*
*envuélvelo en un suspiro,*
*átalo con un cordón*
*de sueños bien dormidos.*

*Corre por el patio grande,*
*levanta los brazos al sol,*
*si sientes que el pecho late,*
*ya empezó la elevación.*

*No preguntes a los adultos*
*si volar es de verdad,*
*porque ellos ya no recuerdan*
*lo que es la gravedad.*

---

## Instructivo: Cómo hacer un cometa

*Materiales: 1 hoja de papel bond, 2 palitos de balso de 40 cm, pegante, hilo cáñamo (3 metros), tijeras, cinta de colores para la cola.*

*Instrucciones:*
1. *Forma una cruz con los dos palitos de balso y amárralos en el centro con hilo.*
2. *Pega la hoja de papel sobre la estructura de la cruz, dejando 2 cm de borde.*
3. *Recorta el papel sobrante en forma de rombo.*
4. *Ata un extremo del hilo cáñamo al centro de la cruz. Ese será el hilo de vuelo.*
5. *Pega las tiras de colores en la parte de abajo del cometa (la cola).*
6. *Sal al aire libre (parque o cancha) y corre contra el viento para elevarlo.*
...
- [ ] D) Seis. <!-- feedback: Incorrecto. Son exactamente cuatro los ingredientes mencionados en la primera estrofa. -->

### Explicación Pedagógica
Se evalúa la capacidad de contar elementos enumerados en un texto poético. Los estudiantes deben identificar los "ingredientes" que lista el poema al inicio.
...
- [ ] D) Atarlo con un cordón. <!-- feedback: Incorrecto. Lo que se ata con un cordón son los sueños, no el viento. -->

### Explicación Pedagógica
Se evalúa la comprensión literal de una instrucción poética. Aunque el lenguaje es figurado, la acción descrita es clara: tomar y envolver.
...
- [ ] D) Que los sueños se deben atar con un cordón para que no se escapen. <!-- feedback: Incorrecto. Interpreta la metáfora de forma demasiado literal. -->

### Explicación Pedagógica
Se evalúa la interpretación del lenguaje figurado en la poesía. Los estudiantes deben entender que "sueños bien dormidos" es una metáfora de las ilusiones guardadas en el corazón.
...
- [ ] D) Porque los adultos siempre tienen la razón. <!-- feedback: Incorrecto. El poema no sugiere que los adultos tengan la razón; al contrario. -->

### Explicación Pedagógica
Se evalúa la inferencia del mensaje detrás de las palabras poéticas. La respuesta capta la crítica a la pérdida de la imaginación en la adultez.
...
- [ ] D) El instructivo tiene dibujos y el poema no. <!-- feedback: Incorrecto. Ninguno de los textos presentados tiene dibujos. -->

### Explicación Pedagógica
Se evalúa la capacidad de contrastar dos tipos de texto (poema vs. instructivo) a partir de sus características: lenguaje figurado vs. lenguaje claro y secuencial.
...
- [ ] D) Enseñar a volar como un pájaro. <!-- feedback: Incorrecto. El instructivo enseña a hacer un cometa, no a volar una persona. -->

### Explicación Pedagógica
Se evalúa la identificación del propósito de un texto instructivo. La respuesta correcta reconoce la función práctica y secuencial de este tipo de texto.
...
- [ ] D) Salir al aire libre. <!-- feedback: Incorrecto. Eso es el último paso, una vez el cometa está listo. -->

### Explicación Pedagógica
Se evalúa la comprensión de la secuencia en un texto instructivo. Los estudiantes deben reconocer que los pasos tienen un orden establecido y que el primer paso es la base de todo.
...
- [ ] D) Que son palabras en inglés. <!-- feedback: Incorrecto. Todas son palabras en español. -->

### Explicación Pedagógica
Se evalúa el reconocimiento de la rima como característica de los textos poéticos. Los estudiantes deben identificar que las terminaciones similares crean el efecto rítmico del poema.
...
- [ ] D) Ambos están escritos por niños de colegios colombianos. <!-- feedback: Incorrecto. Solo el poema tiene autora (Valentina); el instructivo no tiene autor. -->

### Explicación Pedagógica
Se evalúa la capacidad de encontrar el tema común entre dos textos de géneros diferentes. A pesar de sus diferencias estructurales, ambos textos giran en torno a la idea de volar.
...
- [ ] D) Una moraleja al final. <!-- feedback: Incorrecto. La moraleja es propia de las fábulas, no de los instructivos. -->

### Explicación Pedagógica
Se evalúa el conocimiento de la estructura de los textos instructivos. La respuesta correcta identifica los dos componentes esenciales: materiales y procedimiento.

### Explicación Pedagógica Final
Este bundle combina dos géneros textuales diferentes —poesía y texto instructivo— para que los estudiantes de cuarto grado exploren sus características distintivas y encuentren puntos en común. La poesía "Receta para Volar" usa el lenguaje figurado para hablar de la imaginación, mientras que "Cómo hacer un cometa" presenta pasos concretos para una actividad práctica. Las preguntas guían a los estudiantes desde la comprensión literal hasta la reflexión sobre la intención del autor. El contexto colombiano de la autora (Medellín) y la actividad tradicional de hacer cometas conecta con las experiencias de los niños colombianos.
