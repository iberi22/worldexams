...
*Lee el siguiente texto sobre el proyecto de los estudiantes de cuarto grado de la I.E. La Floresta en Cali:*

*[Párrafo 1] En el patio del colegio La Floresta hay un árbol de mango muy grande que da sombra a todo el descanso. Los niños de cuarto grado se sientan debajo de él para comer sus onces y conversar. Pero este año, la profesora Diana tuvo una idea: en lugar de solo sentarse bajo el árbol, los estudiantes iban a aprender a sembrar nuevas plantas y a cuidar el jardín del colegio. Así nació el proyecto "Semillas del Patio".*

*[Párrafo 2] Cada niño eligió una semilla diferente para sembrar. Camila escogió semillas de tomate, Andrés sembró zanahorias y Valentina prefirió las aromáticas como hierbabuena y albahaca. La profesora les enseñó a preparar la tierra con abono orgánico hecho de cáscaras de fruta y restos de comida. Los niños aprendieron que las plantas necesitan tres cosas para crecer: agua, luz del sol y tierra nutritiva.*

*[Párrafo 3] Después de dos meses, el jardín del colegio estaba lleno de vida. Los tomates de Camila ya tenían frutos pequeños y verdes. Las zanahorias de Andrés asomaban sus hojas por encima de la tierra. Y las aromáticas de Valentina olían tan rico que los niños de otros salones venían a olerlas. El proyecto no solo enseñó a sembrar, sino también a tener paciencia y a trabajar en equipo.*
...
- [ ] D) Que los niños conversan durante el descanso. <!-- feedback: Incorrecto. Es una actividad cotidiana, no la idea principal del párrafo. -->

### Explicación Pedagógica
Se evalúa la capacidad de identificar la idea más importante de un párrafo. La respuesta correcta captura el cambio que introduce la profesora: pasar de solo usar el árbol a aprender a sembrar.
...
- [ ] D) De los juegos en el patio del colegio. <!-- feedback: Incorrecto. El párrafo 2 no menciona juegos, sino actividades de siembra. -->

### Explicación Pedagógica
Se evalúa la identificación del tema del segundo párrafo. La respuesta correcta resume el proceso de siembra y aprendizaje que los niños realizaron.
...
- [ ] D) Los niños se aburrieron del proyecto. <!-- feedback: Incorrecto. El texto dice que otros niños venían a oler las plantas, mostrando interés. -->

### Explicación Pedagógica
Se evalúa la identificación de los resultados descritos en el párrafo final. La respuesta correcta requiere reunir los diferentes indicadores de éxito del proyecto.
...
- [ ] D) Aire, música y agua. <!-- feedback: Incorrecto. La música no se menciona como requisito. -->

### Explicación Pedagógica
Se evalúa la identificación de un detalle secundario que apoya la idea principal. Los tres requisitos son información explícita en el párrafo.
...
- [ ] D) El árbol de mango da sombra durante el descanso. <!-- feedback: Incorrecto. Es un detalle contextual, no la idea principal. -->

### Explicación Pedagógica
Se evalúa la capacidad de sintetizar la idea principal de un texto de múltiples párrafos. La respuesta correcta debe abarcar el propósito del proyecto y su resultado más importante.
...
- [ ] D) Dar instrucciones para sembrar zanahorias. <!-- feedback: Incorrecto. No hay instrucciones de siembra en el Párrafo 1. -->

### Explicación Pedagógica
Se evalúa la comprensión de la función de un párrafo dentro de la estructura general del texto. El primer párrafo sirve como introducción que establece el contexto.
...
- [ ] D) Tierra negra traída del río. <!-- feedback: Incorrecto. No se menciona tierra traída del río. -->

### Explicación Pedagógica
Se evalúa la localización de un detalle específico. La información sobre el abono es un dato secundario que apoya la idea principal del párrafo.
...
- [ ] D) A vender las verduras del jardín. <!-- feedback: Incorrecto. No hay mención de venta de productos. -->

### Explicación Pedagógica
Se evalúa la identificación de la conclusión del texto. La respuesta correcta captura las habilidades sociales y emocionales que los niños desarrollaron.
...
- [ ] D) Instrucciones para hacer un volcán de papel. <!-- feedback: Incorrecto. Eso cambiaría completamente el tema del texto. -->

### Explicación Pedagógica
Se evalúa la capacidad de predecir información coherente con la estructura y tema del texto. La opción más lógica es continuar con las consecuencias del proyecto en el ámbito familiar.
...
- [ ] D) Los párrafos presentan diferentes opiniones sobre un tema. <!-- feedback: Incorrecto. No hay opiniones contrapuestas en el texto. -->

### Explicación Pedagógica
Se evalúa la identificación de la estructura organizativa del texto (orden cronológico). Los estudiantes deben reconocer que los párrafos siguen una secuencia temporal lógica.

### Explicación Pedagógica Final
Este bundle está diseñado para que los estudiantes de cuarto grado desarrollen la habilidad de identificar la idea principal de un párrafo y de un texto completo. El tema del proyecto escolar de siembra en Cali conecta con la experiencia cotidiana de los niños colombianos. Las preguntas trabajan desde la identificación de la idea principal de cada párrafo hasta la síntesis global y la comprensión de la estructura organizativa del texto. Esta habilidad es fundamental para la comprensión lectora en todas las áreas del conocimiento.
