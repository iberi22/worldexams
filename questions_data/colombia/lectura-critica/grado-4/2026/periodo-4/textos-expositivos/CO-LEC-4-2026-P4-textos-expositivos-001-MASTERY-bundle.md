...
*Los arrecifes de coral son uno de los ecosistemas más importantes del mundo. En Colombia, tenemos arrecifes maravillosos en el mar Caribe, especialmente en San Andrés, Providencia, Santa Catalina, el Parque Nacional Natural Tayrona y los archipiélagos de Nuestra Señora del Rosario y San Bernardo, cerca de Cartagena.*

*¿Qué son los corales? Los corales no son plantas ni piedras. Son animales muy pequeños llamados pólipos, que viven en colonias de miles y miles. Cada pólipo es como un saco diminuto con tentáculos alrededor de la boca. Los pólipos construyen un esqueleto duro de carbonato de calcio, que es el mismo material de la tiza. Cuando los pólipos mueren, sus esqueletos quedan y nuevos pólipos construyen encima. Así, poquito a poco, durante cientos de años, se forman los arrecifes.*

*¿Por qué son importantes? Los arrecifes de coral son como las ciudades del mar. En ellos viven muchísimas especies de peces, langostas, cangrejos, estrellas de mar y tortugas. Además, protegen las costas de las olas grandes y los huracanes. También son muy importantes para el turismo: miles de personas visitan San Andrés cada año para bucear y ver los corales.*

*¿Cómo podemos cuidarlos? Lamentablemente, los arrecifes están en peligro. La contaminación del agua, el calentamiento global y el uso de bloqueadores solares cuando buceamos dañan los corales. Los científicos colombianos trabajan en viveros de coral donde cultivan fragmentos para restaurar los arrecifes dañados. Los turistas también pueden ayudar usando bloqueadores ecológicos y no tocando los corales al bucear.*
...
- [ ] D) Algas que flotan en el agua. <!-- feedback: Incorrecto. Los corales no son algas. -->

### Explicación Pedagógica
Se evalúa la comprensión de la definición de un concepto científico presentado en el texto expositivo. La respuesta correcta requiere corregir una idea errónea común.
...
- [ ] D) En la laguna de La Cocha. <!-- feedback: Incorrecto. La laguna de La Cocha es de agua dulce y está en Nariño, no tiene corales. -->

### Explicación Pedagógica
Se evalúa la localización de un dato geográfico explícito. El estudiante debe identificar el mar Caribe como el ecosistema donde están los corales.
...
- [ ] D) Los peces construyen sus nidos en el fondo marino. <!-- feedback: Incorrecto. Los peces no construyen arrecifes de coral. -->

### Explicación Pedagógica
Se evalúa la comprensión de un proceso explicado en el texto. La respuesta correcta sigue la secuencia: esqueleto → muerte → nuevo esqueleto encima → acumulación.
...
- [ ] D) De vidrio. <!-- feedback: Incorrecto. Los esqueletos no son de vidrio. -->

### Explicación Pedagógica
Se evalúa la identificación de un dato científico específico. La comparación con la tiza ayuda a los estudiantes a comprender el material.
...
- [ ] D) Que los corales tienen semáforos y edificios. <!-- feedback: Incorrecto. Es una interpretación demasiado literal de la metáfora. -->

### Explicación Pedagógica
Se evalúa la comprensión de una metáfora explicativa en un texto expositivo. El autor usa una imagen familiar (la ciudad) para explicar la función ecológica de los arrecifes.
...
- [ ] D) Porque hacen que el agua se ponga turbia. <!-- feedback: Incorrecto. Los bloqueadores no enturbian el agua visiblemente. -->

### Explicación Pedagógica
Se evalúa la capacidad de inferir una relación de causa y efecto a partir de la información del texto. La contaminación del agua (incluyendo químicos de bloqueadores) daña los corales.
...
- [ ] D) Están construyendo arrecifes artificiales de cemento. <!-- feedback: Incorrecto. No se mencionan arrecifes artificiales de cemento. -->

### Explicación Pedagógica
Se evalúa la identificación de una solución presentada en el texto. La respuesta correcta describe el método de restauración activa que usan los científicos.
...
- [ ] D) Anunciar un viaje escolar a San Andrés. <!-- feedback: Incorrecto. No hay ningún anuncio de viaje. -->

### Explicación Pedagógica
Se evalúa la identificación del propósito de un texto expositivo. A diferencia de la narración o la instrucción, el texto expositivo busca informar y explicar.
...
- [ ] D) Orden alfabético. <!-- feedback: Incorrecto. Los temas no están en orden alfabético. -->

### Explicación Pedagógica
Se evalúa el reconocimiento de la estructura organizativa de un texto expositivo. La estrategia de preguntas como subtítulos facilita la comprensión y la localización de información.
...
- [ ] D) Recoger conchas marinas en la playa. <!-- feedback: Incorrecto. Recoger conchas no está relacionado con la protección de corales según el texto. -->

### Explicación Pedagógica
Se evalúa la capacidad de transferir la información del texto a una situación práctica. Los estudiantes deben identificar las acciones específicas recomendadas por los científicos.

### Explicación Pedagógica Final
Este bundle utiliza un texto expositivo sobre los arrecifes de coral colombianos para desarrollar la comprensión lectora de textos informativos y científicos. El texto está organizado en secciones temáticas que responden preguntas clave, facilitando la localización de información. Las preguntas evalúan desde la identificación de datos explícitos hasta la inferencia de relaciones causa-efecto y la aplicación práctica del conocimiento. El tema conecta con la riqueza natural de Colombia y promueve la conciencia ecológica.
