...
*Lee con atención el siguiente texto sobre los frailejones:*

*Los frailejones son plantas muy especiales que solo crecen en los páramos de Colombia, Ecuador y Venezuela. Estas plantas parecen árboles pequeños con hojas peludas y una corona de hojas amarillas o plateadas en la parte de arriba. Los frailejones son como esponjas gigantes: atrapan la niebla y el rocío con sus hojas peludas y poco a poco van soltando el agua hacia el suelo. Así, los frailejones ayudan a formar los ríos y quebradas que llevan agua a las ciudades. Por eso son tan importantes.*

*Además, los frailejones crecen muy despacio, apenas un centímetro por año. Un frailejón de un metro de altura puede tener cien años de edad. Lamentablemente, muchas personas queman los páramos para sembrar papas o criar ganado, y eso destruye a los frailejones. Por eso, los niños y las niñas de las escuelas cercanas a los páramos se han convertido en "guardianes del páramo": cuidan las plantas, recogen semillas y enseñan a sus familias a no quemar la vegetación. En el colegio de la vereda El Bosque, en Boyacá, los estudiantes de cuarto grado tienen un vivero de frailejones donde cultivan plantas bebés para después sembrarlas en el páramo.*

*Gracias a estos guardianes, cada año hay más frailejones nuevos en las montañas. La naturaleza y los niños trabajan juntos para proteger el agua de Colombia.*
...
- [ ] D) De los animales que viven en el páramo. <!-- feedback: Incorrecto. El texto no habla de animales, solo de plantas. -->

### Explicación Pedagógica
Se evalúa la identificación del tema general del texto. La respuesta correcta reconoce que los frailejones y su relación con el agua son el eje central de la lectura.
...
- [ ] D) Que los frailejones parecen árboles pequeños. <!-- feedback: Incorrecto. Esa es una descripción visual, no la idea principal del párrafo. -->

### Explicación Pedagógica
Se evalúa la capacidad de distinguir la idea principal de los detalles secundarios en un párrafo. La función esencial de los frailejones (atrapar agua) es más importante que su apariencia o ubicación.
...
- [ ] D) Que no les gusta el frío del páramo. <!-- feedback: Incorrecto. Los frailejones están adaptados al frío del páramo, ese no es un problema. -->

### Explicación Pedagógica
Se evalúa la identificación del conflicto o problema principal presentado en el texto. La respuesta correcta señala la acción humana como la amenaza para estas plantas.
...
- [ ] D) Trasladar los frailejones a la ciudad. <!-- feedback: Incorrecto. Los frailejones solo crecen en los páramos, no en la ciudad. -->

### Explicación Pedagógica
Se evalúa la identificación de la solución propuesta en el texto. Los estudiantes deben conectar el problema (quemas) con la respuesta de la comunidad (guardianes).
...
- [ ] D) Cinco centímetros. <!-- feedback: Incorrecto. Aunque es un número pequeño, el texto dice específicamente un centímetro. -->

### Explicación Pedagógica
Se evalúa la localización de un dato numérico explícito. La respuesta requiere encontrar la cifra exacta mencionada en el texto.
...
- [ ] D) Porque los frailejones cambian de color como las esponjas. <!-- feedback: Incorrecto. No hay información sobre cambio de color. -->

### Explicación Pedagógica
Se evalúa la comprensión de una comparación (símil) usada para explicar una función. El autor usa la imagen de la esponja para que los niños entiendan cómo los frailejones captan y liberan agua.
...
- [ ] D) Un frailejón de cien años mide un metro. <!-- feedback: Incorrecto. Es un dato curioso, pero no la idea más importante del texto. -->

### Explicación Pedagógica
Se evalúa la jerarquización de la información, distinguiendo entre la idea central y los detalles de apoyo. Los estudiantes deben identificar qué afirmación resume mejor el propósito del autor.
...
- [ ] D) Construyen casas para los animales. <!-- feedback: Incorrecto. No se menciona construcción de casas para animales. -->

### Explicación Pedagógica
Se evalúa la identificación de una idea secundaria que apoya la idea principal. El vivero es un ejemplo concreto de cómo los niños protegen los frailejones.
...
- [ ] D) Para explicar cómo se queman los páramos. <!-- feedback: Incorrecto. Menciona las quemas como un problema, no como el propósito del texto. -->

### Explicación Pedagógica
Se evalúa la identificación del propósito comunicativo del texto. La combinación de datos informativos con un llamado a la acción revela una intención educativa y de sensibilización.
...
- [ ] D) Los científicos que estudian los páramos. <!-- feedback: Incorrecto. No se mencionan científicos en el texto. -->

### Explicación Pedagógica
Se evalúa la relación entre el título y el contenido del texto. El título es una metáfora que se explica en el desarrollo: los niños son los guardianes de los frailejones y del agua.

### Explicación Pedagógica Final
Este bundle se centra en la identificación de la idea principal y las ideas secundarias en textos informativos. El tema de los frailejones y los páramos colombianos permite conectar la lectura con la realidad ambiental del país. Las preguntas guían al estudiante desde la identificación del tema general hasta la jerarquización de información y el reconocimiento del propósito del autor. La habilidad de distinguir entre ideas principales y secundarias es fundamental para la comprensión lectora en todos los niveles educativos.
