...
*Viene bajando la sierra,*
*caminito de cristal,*
*besando toda la tierra*
*con su canto de coral.*

*Lleva barcos de esperanza,*
*peces de plata y de sol,*
*en su cauce hay una danza*
...
- [ ] D) Con un espejo roto. <!-- feedback: Incorrect. El cristal sugiere transparencia y fluidez, no una ruptura como el espejo roto. -->

### Explicación Pedagógica
Se evalúa la identificación de figuras literarias sencillas (metáfora/símil) en un texto lírico. La respuesta correcta localiza la comparación exacta. Los errores comunes provienen de usar clichés poéticos que no están en el texto leído.
...
- [ ] D) A que los peces solo salen cuando hay eclipses de sol. <!-- feedback: Incorrect. No hay ninguna referencia a eclipses; es una descripción de la apariencia normal y brillante de la fauna. -->

### Explicación Pedagógica
Se evalúa la capacidad de interpretar el lenguaje figurado y los adjetivos poéticos. La respuesta correcta asocia los colores con efectos visuales de la luz. Un error frecuente es tomar las metáforas de forma literal.

---

# Parte 2: Texto Instructivo - Cómo sembrar un árbol

*1. Elige un lugar con buena luz y espacio.*
*2. Abre un hueco que sea el doble de ancho que la raíz.*
*3. Coloca el árbol derecho en el centro del hueco.*
*4. Cubre con tierra y presiona suavemente con los pies.*
*5. Riega con suficiente agua inmediatamente después.*
...
- [ ] D) Comprar un árbol que sea muy alto. <!-- feedback: Incorrect. El instructivo no menciona la altura del árbol, sino el proceso de siembra. -->

### Explicación Pedagógica
Se evalúa la capacidad de seguir una secuencia de pasos en un texto instructivo. La respuesta correcta identifica el paso inicial. Los errores suelen ser por no respetar el orden cronológico de las acciones.
...
- [ ] D) Tan grande como el salón de clase. <!-- feedback: Incorrect. Es una exageración que no tiene sentido para sembrar un solo árbol. -->

### Explicación Pedagógica
Se evalúa la precisión en la lectura de datos técnicos dentro de una instrucción. La respuesta correcta recupera la proporción mencionada en el texto. El error típico es dar respuestas basadas en la imaginación y no en el texto.
...
- [ ] D) Para limpiar la suela de los zapatos. <!-- feedback: Incorrect. Es una interpretación graciosa pero totalmente alejada del propósito técnico del instructivo de siembra. -->

### Explicación Pedagógica
Se evalúa la inferencia sobre el propósito de una instrucción específica. La respuesta correcta deduce la función de estabilidad. Los estudiantes a veces no entienden el "por qué" de los pasos técnicos.
...
- [ ] D) El poema es verdadero y el instructivo es una mentira. <!-- feedback: Incorrect. Ambos textos se basan en realidades (el río existe y los árboles se siembran así). -->

### Explicación Pedagógica
Se evalúa la capacidad de distinguir entre diferentes funciones del lenguaje y tipologías textuales. La respuesta correcta identifica el contraste entre función poética y función apelativa. Los errores reflejan confusión sobre los géneros literarios.
...
- [ ] D) La desembocadura del río en el mar. <!-- feedback: Incorrect. La desembocadura es solo el final; el cauce es todo el recorrido. -->

### Explicación Pedagógica
Se evalúa el conocimiento de vocabulario específico relacionado con la geografía en un contexto literario. La respuesta correcta define técnicamente "cauce". Un error común es asociar la palabra con el sonido del agua por similitud fonética (cauce/canto).
...
- [ ] D) Todas las palabras del poema riman entre sí. <!-- feedback: Incorrect. La rima es una estructura específica que ocurre solo entre ciertos versos, no en todas las palabras. -->

### Explicación Pedagógica
Se evalúa el reconocimiento de la rima como elemento constitutivo del verso. La respuesta correcta identifica los pares de palabras con sonoridad similar al final. Los estudiantes suelen confundir rima con el simple hecho de que las palabras suenen "bonito".
...
- [ ] D) Que aprenda a buscar agua en las nubes por sí solo. <!-- feedback: Incorrect. Es una idea fantástica sin base biológica; las plantas recién sembradas dependen del cuidado humano inicial. -->

### Explicación Pedagógica
Se evalúa la capacidad de predecir consecuencias por la omisión de pasos en un proceso instructivo. La respuesta correcta identifica la función vital del agua. Los errores reflejan falta de razonamiento lógico aplicado a la realidad física.
...
- [ ] D) Ninguno de los dos, ambos son textos de fantasía. <!-- feedback: Incorrect. Son textos basados en la realidad, pero presentados con estilos diferentes. -->

### Explicación Pedagógica
Se evalúa la capacidad de distinguir entre el lenguaje literario (subjetivo) y el lenguaje instructivo (objetivo). La respuesta correcta identifica la claridad y precisión del instructivo. Un error común es no reconocer que el estilo de escritura depende del propósito del texto.

### Explicación Pedagógica Final
Este bundle de Lectura Crítica para el cuarto periodo de cuarto grado introduce al estudiante en la diversidad de géneros textuales: la lírica (poesía) y los textos funcionales (instructivos). Se evalúan competencias como la interpretación de metáforas, la identificación de rimas, el seguimiento de secuencias lógicas y la distinción entre lenguajes subjetivos y objetivos. El uso de temas ambientales (el Río Magdalena y la siembra de árboles) permite conectar la habilidad lectora con valores ciudadanos y ecológicos. El objetivo final es que el estudiante reconozca que leemos de formas distintas según el tipo de texto y la información que buscamos obtener.
