...
## Poemas de la Tierra Colombiana

*Lea los siguientes fragmentos poéticos y responda las preguntas.*

**Fragmento 1: "Canto a la Tierra"**
*La tierra susurra secretos al viento,*
*el río abraza la montaña con paciencia,*
*y el sol, como un pintor dorado,*
*colorea los cultivos de los campesinos.*

**Fragmento 2: "Ritmo en la Selva"**
*¡Toc toc toc! La lluvia tamborilea en las hojas.*
*El tucán ríe desde su rama: ¡tuc-tuc-tuc!*
*Las lianas, serpientes verdes y dormidas,*
*cuelgan del techo del mundo.*

**Fragmento 3: "El Café"**
*Rojo como la sangre de la montaña,*
*el grano maduro se deja caer en la mano callosa.*
*Sudor de generaciones endulza la taza,*
*y en cada sorbo, el país entero cabe.*

**Fragmento 4: "Lamento del Río"**
*Antes corría libre, cantando entre las piedras.*
*Ahora arrastro lágrimas de plástico y veneno.*
*Los peces huyeron, las garzas se fueron.*
*Soy un río herido que envejece en silencio.*
...
- [ ] D) El sonido de un río. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Identificación del elemento descriptivo en un símil.
...
- [ ] D) Su color. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Comprensión literal del contenido del poema.
...
- [ ] D) Ironía. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Identificación de la personificación.
...
### Explicación Pedagógica
Identificación del símil como comparación explícita.
...
- [ ] D) Antítesis. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Identificación de la onomatopeya.
...
- [ ] D) Describe el color del agua. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Análisis del efecto de la personificación en el lector.
...
- [ ] D) Que la taza transpira. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Interpretación de una metáfora compleja.
...
### Explicación Pedagógica
Identificación de la hipérbole como exageración expresiva.
...
- [ ] D) Que el país no es importante. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Interpretación del significado simbólico de una expresión figurada.
...
- [ ] D) Selva vs. ciudad. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Análisis del contraste temporal como recurso literario.
...
- [ ] D) Hablar de la lluvia. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Inferencia de la intención comunicativa del autor.
...
### Explicación Pedagógica
Identificación del símil en una comparación poética.
...
- [ ] D) Todos están escritos en prosa. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Identificación del tema común y propósito estilístico.
...
- [ ] D) Para ahorrar palabras. <!-- feedback: Incorrecto. -->

### Explicación Pedagógica
Reflexión sobre la función del lenguaje figurado en la literatura.

### Explicación Pedagógica Final
Bundle de figuras literarias para grado 7, con fragmentos poéticos originales inspirados en la naturaleza colombiana. Desarrolla habilidades de identificación de personificación, símil, metáfora, onomatopeya, hipérbole, y análisis del efecto de estos recursos en el significado y la emoción del texto.
