...
grado: 9
asignatura: "ingles"
tema: "reading-comprehension, grammar-B1, vocabulary-B1, listening-skills, writing-B1"
periodo: "P1-P4"
protocol_version: "5.2"
bundle_index: 1
bundle_size: 15
alignment: "DBA MEN + Estándares Básicos Ciclo 3, CEFR B1"
modern_context: true
...
rubric_baseline: "Reading comprehension B1, grammar (present perfect, conditionals, passive voice, relative clauses), vocabulary (environment, technology, daily life), writing strategies"
coverage:
  - "P1: Reading comprehension — narrative and descriptive texts at B1"
...
This comprehensive bundle covers all four periods of 9th grade English: reading comprehension, grammar (present perfect, conditionals, passive voice), vocabulary, and writing skills, all at CEFR B1 level with Colombian contexts.
...
- [ ] D) is studying <!-- feedback: Incorrect. "Is studying" is present continuous, which describes an action in progress now, not an action that started in the past and continues. -->

### Explicación Pedagógica
The present perfect tense connects past actions to the present. It is formed with *have/has* + past participle. Use *has* for third person singular (he, she, it). The phrase "for three years" indicates an action that started in the past and continues to the present.
...
- [ ] D) bring <!-- feedback: Incorrect. The main clause in a first conditional needs "will + infinitive" to express a future result. -->

### Explicación Pedagógica
The first conditional is used for real or likely future situations. Structure: *If + present simple, will + infinitive*. Example: "If it rains tomorrow, I will bring an umbrella." This is different from the second conditional (unreal situations), which uses *would + infinitive*.
...
- [ ] D) visited <!-- feedback: Incorrect. Past simple would be used for completed actions in the past, not for general yearly habits. -->

### Explicación Pedagógica
The present simple is used for habits, routines, and general facts. Signal words like "every year," "always," "usually" indicate present simple. "Tourists visit Cali every year" describes a recurring fact.
...
- [ ] D) have cut <!-- feedback: Incorrect. "Have cut" is present perfect active. The sentence needs passive voice (the trees don't cut themselves). -->

### Explicación Pedagógica
The passive voice shifts focus from who performs the action to who receives it. Present simple passive: *subject + am/is/are + past participle*. Here, the trees don't cut themselves; they are cut by someone. Passive is common in academic and environmental texts.
...
- [ ] D) produced <!-- feedback: Incorrect. Without auxiliary verb "is", this is incomplete for passive voice. -->

### Explicación Pedagógica
The passive voice is especially useful in informational texts about products and processes. "Coffee is produced in the Coffee Region" emphasizes the product (coffee) and location rather than the people who produce it. This is typical of descriptive and expository writing.
...
- [ ] D) had gotten <!-- feedback: Incorrect. "Had gotten" is past perfect, used in third conditional (unreal past situations). Here the situation is unreal present/future. -->

### Explicación Pedagógica
The second conditional describes unreal or imaginary situations in the present or future. Structure: *If + past simple, would + infinitive*. It is used for dreams, wishes, and hypothetical situations. Example: "If I had more money, I would travel around Colombia."
...
- [ ] D) She is currently in Colombia. <!-- feedback: Incorrect. She writes from the UK and has never been to Colombia. -->

### Explicación Pedagógica
Reading comprehension at B1 level requires making simple inferences from the text. The present perfect "have never been" and "have already visited" together indicate that the friend has travel experience in Latin America but not yet in Colombia. The friend also shows interest in visiting.
...
- [ ] D) The author is unsure about the effects of social media. <!-- feedback: Incorrect. The author states a clear opinion using "I believe." -->

### Explicación Pedagógica
Identifying an author's argument requires distinguishing between what others say and what the author says. Signal words like "however," "on the other hand," "I believe" indicate the author's own position. This skill is crucial for critical reading.
...
- [ ] D) Educational apps are not effective for learning. <!-- feedback: Incorrect. The text presents technology positively, not as ineffective. -->

### Explicación Pedagógica
Reading comprehension at B1-B2 level requires identifying not just explicit information but also implicit problems and issues. The text presents technology as beneficial but identifies the digital divide as a key problem. This connects to real issues in Colombia.
...
- [x] D) Additionally <!-- feedback: Correct. "Additionally" (or "also" / "furthermore") adds similar information to support the main idea. -->

### Explicación Pedagógica
Coherence and cohesion in writing depend on using appropriate connectors. *Additionally* / *furthermore* / *also* add information. *However* shows contrast. *Therefore* shows result. *For example* introduces examples. Choosing the right connector makes writing clearer and more organized.
...
- [ ] D) The Magdalena River is too polluted to be cleaned. <!-- feedback: Incorrect. The text shows successful clean-up (500 kg of waste collected). -->

### Explicación Pedagógica
Identifying the main message requires understanding the purpose and tone of the text. The direct quote from the student reveals the central idea: citizen initiative, not government dependence. This is a common theme in environmental and civic texts.
...
- [ ] D) He gone to the supermarket already. <!-- feedback: Incorrect. The auxiliary verb "has" is missing. Present perfect needs have/has + past participle. -->

### Explicación Pedagógica
A common B1-level error is confusing simple past (*went*) with past participle (*gone*). The present perfect always uses the past participle form. Irregular verbs must be memorized: go → went → gone. Other common pairs: see-saw-seen, eat-ate-eaten, write-wrote-written.
...
**Text B:** "While English is useful, we should not forget that our own languages and cultures are valuable. Many Colombian students do not need English for their daily lives. The focus should be on improving Spanish literacy first."
...
- [ ] D) Text A thinks English is useless; Text B thinks it is essential. <!-- feedback: Incorrect. These are the opposite of what the texts say. -->

### Explicación Pedagógica
Comparing arguments requires identifying each text's core values and priorities. Text A prioritizes global opportunities (utilitarian view); Text B prioritizes cultural identity and local needs (preservationist view). Recognizing the underlying values helps in evaluating arguments.
...
2. Describe what she did last weekend
3. Make plans for when the friend visits Colombia
4. End the email
...
- [ ] D) 2, 1, 3, 4 <!-- feedback: Incorrect. Asking about the friend (1) should come before describing her own activities (2). -->

### Explicación Pedagógica
Text organization is key for coherence in writing. A standard informal email follows this structure: opening greeting → inquire about recipient → share personal news → future plans → closing. Teaching text organization at B1 level helps students write more effectively.
...
**Against bilingual education:** "Students learn better in their native language. If we teach subjects like social studies and science in English, many students will fall behind because they don't understand the language well enough. This could increase school dropout rates."
...
- [ ] D) The decision should be left to each school without any government guidelines. <!-- feedback: Incorrect. This avoids addressing the educational quality concerns and doesn't synthesize the arguments. -->
