---
id: "CO-LEN-7-2026-W17-vicios-linguisticos-001-MASTERY-bundle"
country: "colombia"
grado: 7
asignatura: "lengua"
...
# CO-LEN-7-2026-W17-vicios-linguisticos-001-MASTERY

## Question 1 [D3-D4]

**ID:** CO-LEN-7-2026-W17-vicios-linguisticos-001-MASTERY-bundle-v1
**Bloom:** Remember
**ICFES:** Competencia Lectora (Literal)
**Contexto:** Los vicios del lenguaje son usos o formas incorrectas de hablar o escribir que pueden dificultar la comprensión.
**Expected_Success:** 0.85

### Enunciado
¿A qué vicio del lenguaje nos referimos cuando usamos palabras innecesarias que ya están implícitas en el significado de otras, como "subir arriba"?
...
**ID:** CO-LEN-7-2026-W17-vicios-linguisticos-001-MASTERY-bundle-v2
**Bloom:** Remember
**ICFES:** Competencia Lectora (Literal)
**Contexto:** El uso excesivo o inadecuado de ciertas palabras puede empobrecer el discurso.
...
**ID:** CO-LEN-7-2026-W17-vicios-linguisticos-001-MASTERY-bundle-v3
**Bloom:** Apply
**ICFES:** Competencia Lectora (Inferencial)
**Contexto:** En Colombia, es común escuchar expresiones que contienen errores de concordancia o de estructura.
**Expected_Success:** 0.75

### Enunciado
¿Cuál de las siguientes frases presenta un **solecismo** de concordancia?
...
### Explicacion Pedagogica
El solecismo ocurre cuando se violan las normas de la sintaxis o la concordancia. El uso de "hubieron" en lugar de "hubo" para expresar existencia es uno de los solecismos más comunes en el habla hispana.

## Question 4 [D5-D6]

**ID:** CO-LEN-7-2026-W17-vicios-linguisticos-001-MASTERY-bundle-v4
**Bloom:** Apply
**ICFES:** Competencia Lectora (Inferencial)
**Contexto:** El barbarismo incluye tanto errores ortográficos como el uso innecesario de términos extranjeros.
...
### Explicacion Pedagogica
Los barbarismos ortográficos o fonéticos ocurren cuando se deforman las palabras. "Haiga" es un ejemplo clásico de vulgarismo que se clasifica como barbarismo.

## Question 5 [D5-D6]

**ID:** CO-LEN-7-2026-W17-vicios-linguisticos-001-MASTERY-bundle-v5
**Bloom:** Understand
**ICFES:** Competencia Lectora (Literal)
**Contexto:** La anfibología genera confusión en el receptor porque el mensaje tiene más de una interpretación.
**Expected_Success:** 0.65

### Enunciado
¿Cuál es la interpretación ambigua de la frase: "Vimos a Juan paseando con su perro"?
...
**ID:** CO-LEN-7-2026-W17-vicios-linguisticos-001-MASTERY-bundle-v6
**Bloom:** Analyze
**ICFES:** Competencia Lectora (Inferencial)
**Contexto:** La cacofonía es el encuentro o repetición de sonidos iguales o semejantes que resultan desagradables al oído.
...
### Explicacion Pedagogica
La cacofonía se evita buscando sinónimos o cambiando el orden de las palabras. En el ejemplo B, se podría decir: "Bebe el té y mejorarás pronto".

## Question 7 [D7-D8]

**ID:** CO-LEN-7-2026-W17-vicios-linguisticos-001-MASTERY-bundle-v7
**Bloom:** Analyze
**ICFES:** Competencia Lectora (Crítica)
**Contexto:** El uso innecesario de anglicismos es un tipo de barbarismo muy común en la era digital.
**Expected_Success:** 0.55

### Enunciado
¿Cuál de estas frases contiene un barbarismo por uso innecesario de un anglicismo, teniendo un término equivalente en español?

### Opciones
- [ ] A) Debemos actualizar el software del computador del colegio. <!-- feedback: Incorrecto. "Software" es un término técnico aceptado ante la falta de una traducción exacta y breve. -->
- [ ] B) El partido de fútbol fue transmitido en alta definición. <!-- feedback: Incorrecto. Todos los términos son propios del español. -->
- [x] C) Por favor, envíame un **feedback** sobre mi exposición de sociales. <!-- feedback: ¡Correcto! "Feedback" puede sustituirse perfectamente por "comentarios", "retroalimentación" o "opinión". -->
- [ ] D) La red inalámbrica de la biblioteca no está funcionando. <!-- feedback: Incorrecto. Utiliza terminología correcta en español. -->

### Explicacion Pedagogica
Los anglicismos son vicios cuando desplazan a palabras en español que expresan exactamente lo mismo, empobreciendo el idioma y dificultando la comunicación para quienes no conocen el inglés.

## Question 8 [D7-D8]

**ID:** CO-LEN-7-2026-W17-vicios-linguisticos-001-MASTERY-bundle-v8
**Bloom:** Analyze
**ICFES:** Competencia Lectora (Inferencial)
**Contexto:** El queísmo y el dequeísmo son vicios relacionados con el uso incorrecto de la preposición "de" ante la conjunción "que".
**Expected_Success:** 0.50

### Enunciado
Identifica la oración que presenta un caso de **dequeísmo**:
...
### Explicacion Pedagogica
Para saber si se debe usar "de que", se puede sustituir la frase subordinada por "esto". Si al preguntar "¿Qué dijo?" la respuesta es "esto", no lleva "de". Si la pregunta es "¿De qué está seguro?", la respuesta es "de esto", por lo que sí lleva "de".

## Question 9 [D9-D10]

**ID:** CO-LEN-7-2026-W17-vicios-linguisticos-001-MASTERY-bundle-v9
**Bloom:** Evaluate
**ICFES:** Competencia Lectora (Crítica)
**Contexto:** Evitar los vicios del lenguaje mejora la calidad de los textos argumentativos y académicos.
**Expected_Success:** 0.45

### Enunciado
Lee el siguiente fragmento de una noticia escolar: "Ayer hubieron muchos inscritos para el club de robótica, por lo que el profesor decidió de que el cupo se ampliaría para todos los que subieran arriba al segundo piso".

¿Cuáles vicios del lenguaje aparecen en este orden?
...
**ID:** CO-LEN-7-2026-W17-vicios-linguisticos-001-MASTERY-bundle-v10
**Bloom:** Analyze
**ICFES:** Competencia Lectora (Inferencial)
**Contexto:** Los arcaísmos y neologismos pueden considerarse vicios si se usan de forma inadecuada para el contexto.
**Expected_Success:** 0.40

### Enunciado
En una conversación sobre tecnología moderna, un abuelo le dice a su nieto: "Hijo, antes de que **vos** te vayas, déjame **mesmo** el aparato ese que me **asimpla** la cabeza".
...
### Explicacion Pedagogica
Los arcaísmos son palabras del pasado que sobreviven en ciertas comunidades. Usarlos en contextos formales actuales puede considerarse un vicio o una falta de adecuación al registro.
