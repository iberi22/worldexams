---
id: "CO-LEN-7-2026-W21-tipos-de-argumentos-001-MASTERY-bundle"
country: "colombia"
grado: 7
asignatura: "lengua"
...
# CO-LEN-7-2026-W21-tipos-de-argumentos-001-MASTERY

## Question 1 [D3-D4]

**ID:** CO-LEN-7-2026-W21-tipos-de-argumentos-001-MASTERY-bundle-v1
**Bloom:** Remember
**ICFES:** Competencia Lectora (Literal)
**Contexto:** Existen diversas formas de apoyar una tesis según el tipo de información que se utilice.
**Expected_Success:** 0.85

### Enunciado
¿Cómo se llama el tipo de argumento que utiliza números, porcentajes o datos comprobables para sustentar una idea?
...
Los datos y estadísticas son muy valorados en la argumentación científica y periodística porque son difíciles de refutar si provienen de fuentes confiables.

## Question 2 [D3-D4]

**ID:** CO-LEN-7-2026-W21-tipos-de-argumentos-001-MASTERY-bundle-v2
**Bloom:** Understand
**ICFES:** Competencia Lectora (Literal)
**Contexto:** Los argumentos por analogía establecen una comparación entre dos situaciones similares para extraer una conclusión.
**Expected_Success:** 0.80

### Enunciado
¿Cuál de las siguientes frases es un ejemplo de **analogía**?
...
### Explicacion Pedagogica
La analogía ayuda a comprender conceptos abstractos o complejos comparándolos con situaciones más cotidianas y fáciles de visualizar.

## Question 3 [D5-D6]

**ID:** CO-LEN-7-2026-W21-tipos-de-argumentos-001-MASTERY-bundle-v3
**Bloom:** Apply
**ICFES:** Competencia Lectora (Inferencial)
**Contexto:** El argumento de causa-efecto establece una conexión lógica donde un hecho es consecuencia directa de otro.
**Expected_Success:** 0.75

### Enunciado
¿Qué tipo de argumento se utiliza en la siguiente frase?
"Si no protegemos los nacederos de agua, en el futuro sufriremos graves sequías que afectarán la agricultura nacional".
...
### Explicacion Pedagogica
Este tipo de argumento es muy común para realizar advertencias o proponer soluciones a problemas ambientales y sociales.

## Question 4 [D5-D6]

**ID:** CO-LEN-7-2026-W21-tipos-de-argumentos-001-MASTERY-bundle-v4
**Bloom:** Understand
**ICFES:** Competencia Lectora (Literal)
**Contexto:** Los argumentos afectivos o emotivos buscan conmover al receptor para que acepte una idea por empatía.
**Expected_Success:** 0.70

### Enunciado
¿En qué situación es más probable encontrar un predominio de **argumentos afectivos**?
...
### Explicacion Pedagogica
Aunque son menos rigurosos que los lógicos, los argumentos afectivos son muy poderosos para movilizar a las personas hacia causas sociales o solidarias.

## Question 5 [D5-D6]

**ID:** CO-LEN-7-2026-W21-tipos-de-argumentos-001-MASTERY-bundle-v5
**Bloom:** Apply
**ICFES:** Competencia Lectora (Inferencial)
**Contexto:** Los argumentos de conocimiento general se basan en verdades aceptadas por la mayoría de la sociedad.
...
### Explicacion Pedagogica
El sentido común ayuda a generar acuerdos rápidos con el lector, ya que apela a experiencias compartidas y sabiduría popular.

## Question 6 [D7-D8]

**ID:** CO-LEN-7-2026-W21-tipos-de-argumentos-001-MASTERY-bundle-v6
**Bloom:** Analyze
**ICFES:** Competencia Lectora (Inferencial)
**Contexto:** Un argumento por generalización observa varios casos similares y extrae una regla general de ellos.
**Expected_Success:** 0.60

### Enunciado
Analiza la siguiente frase: "Todos los municipios que han invertido en turismo sostenible en Boyacá han mejorado su economía; por lo tanto, el turismo es la clave del desarrollo regional". ¿Qué tipo de argumento se aplica?

### Opciones
- [ ] A) Argumento de autoridad. <!-- feedback: Incorrecto. No cita a ninguna entidad experta en economía. -->
- [ ] B) Argumento por analogía. <!-- feedback: Incorrecto. No compara el turismo con otra cosa diferente. -->
- [x] C) Argumento por generalización. <!-- feedback: ¡Correcto! Observa los casos de varios municipios y crea una conclusión general a partir de ellos. -->
- [ ] D) Argumento afectivo. <!-- feedback: Incorrecto. No apela a las emociones, sino a la observación de hechos. -->

### Explicacion Pedagogica
La generalización debe hacerse con cuidado; si se basa en muy pocos casos, puede caer en una falacia (error lógico). En este caso, se basa en la observación de una región.

## Question 7 [D7-D8]

**ID:** CO-LEN-7-2026-W21-tipos-de-argumentos-001-MASTERY-bundle-v7
**Bloom:** Analyze
**ICFES:** Competencia Lectora (Crítica)
**Contexto:** Los argumentos de autoridad pueden perder validez si la persona citada no es experta en el tema que se discute.
...
### Explicacion Pedagogica
Para que un argumento de autoridad sea sólido, debe existir una relación directa entre el conocimiento de la persona y el tema tratado.

## Question 8 [D7-D8]

**ID:** CO-LEN-7-2026-W21-tipos-de-argumentos-001-MASTERY-bundle-v8
**Bloom:** Analyze
**ICFES:** Competencia Lectora (Inferencial)
**Contexto:** Los argumentos de experiencia personal se basan en lo vivido por el propio autor del texto.
**Expected_Success:** 0.50

### Enunciado
En un foro sobre transporte público, un ciudadano dice: "Yo uso el Transmilenio todos los días desde hace diez años y puedo asegurar que el servicio ha empeorado en puntualidad". ¿Qué valor tiene este argumento?
...
**ID:** CO-LEN-7-2026-W21-tipos-de-argumentos-001-MASTERY-bundle-v9
**Bloom:** Evaluate
**ICFES:** Competencia Lectora (Crítica)
**Contexto:** Identificar el tipo de argumento dominante ayuda a entender la intención del autor y la calidad del texto.
**Expected_Success:** 0.45

### Enunciado
Lee el siguiente fragmento: "El 80% de los jóvenes prefiere las redes sociales para informarse. Como dice el experto en medios Manuel Castells, vivimos en una sociedad de red. Por eso, si las escuelas no integran la tecnología, se quedarán aisladas del mundo real, tal como ocurrió con las bibliotecas que no se digitalizaron".

¿En qué orden aparecen los argumentos en este texto?
...
**ID:** CO-LEN-7-2026-W21-tipos-de-argumentos-001-MASTERY-bundle-v10
**Bloom:** Evaluate
**ICFES:** Competencia Lectora (Crítica)
**Contexto:** Las falacias son argumentos que parecen válidos pero tienen un error lógico en su construcción.
**Expected_Success:** 0.40

### Enunciado
Analiza el siguiente argumento: "Debes comprar esta marca de celular porque es la que más se vende en toda Colombia; si todos lo compran, es porque es el mejor". ¿A qué tipo de razonamiento (posiblemente falaz) corresponde?
...
### Explicacion Pedagogica
El pensamiento crítico permite identificar cuando un autor intenta convencernos usando la presión social ("todos lo hacen") en lugar de darnos razones de calidad sobre el producto o la idea.
