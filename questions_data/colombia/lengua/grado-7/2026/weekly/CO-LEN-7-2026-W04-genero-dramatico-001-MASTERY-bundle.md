---
id: "CO-LEN-7-2026-W04-genero-dramatico-001-MASTERY-bundle"
country: "colombia"
grado: 7
asignatura: "lengua"
...
# CO-LEN-7-2026-W04-genero-dramatico-001-MASTERY

## Question 1 [D3-D4]
**ID:** CO-LEN-7-2026-W04-genero-dramatico-001-MASTERY-bundle-v1
**Bloom:** Remember
**ICFES:** Competencia Lectora (Literal)
**Contexto:** Un grupo de estudiantes de Bogotá asiste a una función en el Teatro Colón. Al leer el libreto, notan que la historia se cuenta de forma directa.
**Expected_Success:** 0.85

### Enunciado
¿Cuál es la característica principal que define al género dramático frente al narrativo o al lírico?
...
El género dramático (o teatro) se distingue porque la acción no es contada, sino representada. Los personajes "viven" la historia frente al espectador. Su estructura se basa en el diálogo y las acotaciones.

---

## Question 2 [D3-D4]
**ID:** CO-LEN-7-2026-W04-genero-dramatico-001-MASTERY-bundle-v2
**Bloom:** Understand
**ICFES:** Competencia Lectora (Literal)
**Contexto:** Valentina lee una obra de teatro y encuentra textos escritos en cursiva y entre paréntesis como *(Sale lentamente por la izquierda)*.
**Expected_Success:** 0.80

### Enunciado
¿Cómo se denominan las indicaciones que el autor da sobre el vestuario, los movimientos o la escenografía en una obra dramática?
...
### Explicacion Pedagogica
Las acotaciones son fundamentales para el director y los actores. No se dicen durante la función, pero sirven para construir el ambiente y la acción que el autor imaginó.

---

## Question 3 [D5-D6]
**ID:** CO-LEN-7-2026-W04-genero-dramatico-001-MASTERY-bundle-v3
**Bloom:** Apply
**ICFES:** Competencia Lectora (Inferencial)
**Contexto:** En una obra, un personaje se queda solo en el escenario y expresa sus pensamientos en voz alta para que el público sepa lo que siente.
...
### Explicacion Pedagogica
El monólogo permite profundizar en la psicología del personaje sin necesidad de un narrador. Es muy común en las tragedias para mostrar dilemas morales o sufrimientos profundos.

---

## Question 4 [D5-D6]
**ID:** CO-LEN-7-2026-W04-genero-dramatico-001-MASTERY-bundle-v4
**Bloom:** Understand
**ICFES:** Competencia Lectora (Literal)
**Contexto:** Las obras dramáticas suelen dividirse en grandes unidades que se marcan con la caída del telón o el apagado de luces.
**Expected_Success:** 0.78

### Enunciado
¿Cómo se llaman las partes principales en las que se divide una obra de teatro, que suelen ser tres (inicio, nudo y desenlace)?

### Opciones
- [ ] A) Escenas <!-- feedback: Incorrecto. Las escenas son divisiones menores marcadas por la entrada o salida de personajes. -->
- [x] B) Actos <!-- feedback: ¡Correcto! Los actos son las divisiones mayores de la obra dramática. -->
- [ ] C) Cuadros <!-- feedback: Incorrecto. El cuadro es una división basada en el cambio de escenografía. -->
- [ ] D) Capítulos <!-- feedback: Incorrecto. Los capítulos son divisiones propias de la narrativa (novela). -->

### Explicacion Pedagogica
Tradicionalmente, una obra tiene tres actos. Entre actos suele haber un intermedio. Dentro de cada acto hay escenas, que cambian cada vez que un personaje entra o sale del escenario.

---

## Question 5 [D5-D6]
**ID:** CO-LEN-7-2026-W04-genero-dramatico-001-MASTERY-bundle-v5
**Bloom:** Apply
**ICFES:** Competencia Lectora (Inferencial)
**Contexto:** Santiago estudia los subgéneros dramáticos. Aprende que uno de ellos busca provocar la risa y suele tener un final feliz.
**Expected_Success:** 0.72

### Enunciado
¿Qué subgénero dramático se caracteriza por presentar conflictos de la vida cotidiana de manera humorística y con personajes comunes?
...
## Question 6 [D7-D8]
**ID:** CO-LEN-7-2026-W04-genero-dramatico-001-MASTERY-bundle-v6
**Bloom:** Analyze
**ICFES:** Competencia Lectora (Crítica)
**Contexto:** En el teatro clásico, la "tragedia" presentaba a héroes luchando contra un destino inevitable y terminaba siempre de forma funesta.
**Expected_Success:** 0.65

### Enunciado
¿Cuál es la finalidad principal (la "catarsis") que buscaba la tragedia griega en los espectadores?
...
## Question 7 [D7-D8]
**ID:** CO-LEN-7-2026-W04-genero-dramatico-001-MASTERY-bundle-v7
**Bloom:** Analyze
**ICFES:** Competencia Lectora (Inferencial)
**Contexto:** Camila analiza una escena donde dos personajes hablan, pero de repente uno mira al público y dice algo que el otro personaje "no escucha".
...
### Explicacion Pedagogica
El aparte es una convención: el público acepta que el otro personaje en escena no escucha lo que se dice, permitiendo que la trama avance mediante secretos o ironías compartidas con el espectador.

---

## Question 8 [D7-D8]
**ID:** CO-LEN-7-2026-W04-genero-dramatico-001-MASTERY-bundle-v8
**Bloom:** Evaluate
**ICFES:** Competencia Lectora (Crítica)
**Contexto:** Durante el siglo XX en Colombia, el teatro se convirtió en una herramienta de denuncia social muy importante, alejándose de los temas clásicos.
...
### Explicacion Pedagogica
El teatro colombiano ha sido fundamental para entender nuestra realidad. La creación colectiva permitió que las historias del pueblo llegaran a las tablas, convirtiendo el escenario en un espacio de debate sobre la paz, la justicia y la identidad nacional.

---

## Question 9 [D9-D10]
**ID:** CO-LEN-7-2026-W04-genero-dramatico-001-MASTERY-bundle-v9
**Bloom:** Evaluate
**ICFES:** Competencia Lectora (Crítica)
**Contexto:** Algunos teóricos dicen que "el texto dramático es solo la mitad de la obra".
**Expected_Success:** 0.55

### Enunciado
¿Por qué se afirma que la obra dramática solo se completa en la representación?
...
### Explicacion Pedagogica
El texto dramático es una partitura o un mapa. La verdadera "obra de teatro" nace cuando los actores encarnan las palabras y las luces y sonidos crean la atmósfera, produciendo una experiencia única en cada función.

---

## Question 10 [D9-D10]
**ID:** CO-LEN-7-2026-W04-genero-dramatico-001-MASTERY-bundle-v10
**Bloom:** Analyze
**ICFES:** Competencia Lectora (Inferencial)
**Contexto:** En una obra moderna, los personajes no hablan entre sí, sino que realizan acciones repetitivas mientras se oye un ruido extraño de fondo.
**Expected_Success:** 0.50

### Enunciado
¿Qué elemento del género dramático se está resaltando en este tipo de teatro contemporáneo (Teatro del Absurdo o experimental)?
