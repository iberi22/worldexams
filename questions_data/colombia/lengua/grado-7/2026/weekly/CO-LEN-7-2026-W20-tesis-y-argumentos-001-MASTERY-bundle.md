---
id: "CO-LEN-7-2026-W20-tesis-y-argumentos-001-MASTERY-bundle"
country: "colombia"
grado: 7
asignatura: "lengua"
...
# CO-LEN-7-2026-W20-tesis-y-argumentos-001-MASTERY

## Question 1 [D3-D4]

**ID:** CO-LEN-7-2026-W20-tesis-y-argumentos-001-MASTERY-bundle-v1
**Bloom:** Remember
**ICFES:** Competencia Lectora (Literal)
**Contexto:** Un texto argumentativo tiene como objetivo principal convencer o persuadir al lector sobre un punto de vista determinado.
**Expected_Success:** 0.85

### Enunciado
¿Cuál de las siguientes definiciones describe mejor qué es la **tesis** en un texto argumentativo?

### Opciones
- [ ] A) Es el resumen de todos los párrafos del texto. <!-- feedback: Incorrecto. El resumen condensa la información, pero no necesariamente plantea una postura a defender. -->
- [x] B) Es la idea u opinión central que el autor defiende y sobre la cual intenta convencer al lector. <!-- feedback: ¡Correcto! La tesis es el eje del texto argumentativo, la afirmación principal que se sostiene con pruebas. -->
- [ ] C) Es una pregunta abierta que se hace al inicio para generar curiosidad. <!-- feedback: Incorrecto. Aunque se puede empezar con una pregunta, la tesis debe ser una afirmación o negación clara, no una duda. -->
- [ ] D) Es la lista de ejemplos que se utilizan para ilustrar un tema. <!-- feedback: Incorrecto. Los ejemplos son parte de los argumentos, no la tesis misma. -->

### Explicacion Pedagogica
La tesis es la columna vertebral de la argumentación. Sin una tesis clara, el texto se convierte en una simple exposición de información sin un propósito persuasivo definido.

## Question 2 [D3-D4]

**ID:** CO-LEN-7-2026-W20-tesis-y-argumentos-001-MASTERY-bundle-v2
**Bloom:** Understand
**ICFES:** Competencia Lectora (Literal)
**Contexto:** Los argumentos son las razones, datos o pruebas que se utilizan para sustentar la tesis.
...
### Explicacion Pedagogica
Un argumento eficaz debe estar directamente conectado con la tesis. Se basa en la lógica, la evidencia científica, la experiencia o la autoridad de expertos.

## Question 3 [D5-D6]

**ID:** CO-LEN-7-2026-W20-tesis-y-argumentos-001-MASTERY-bundle-v3
**Bloom:** Apply
**ICFES:** Competencia Lectora (Inferencial)
**Contexto:** Identificar la tesis en un texto breve es una habilidad clave para la comprensión crítica.
**Expected_Success:** 0.75

### Enunciado
Lee el siguiente fragmento: "El uso excesivo de plásticos está destruyendo nuestros océanos y afectando a miles de especies marinas. Es urgente que el gobierno colombiano implemente leyes más estrictas para prohibir los plásticos de un solo uso".
...
### Explicacion Pedagogica
La tesis suele presentarse como una propuesta de cambio, una valoración o una afirmación que requiere ser demostrada. En este caso, la propuesta es la creación de leyes.

## Question 4 [D5-D6]

**ID:** CO-LEN-7-2026-W20-tesis-y-argumentos-001-MASTERY-bundle-v4
**Bloom:** Apply
**ICFES:** Competencia Lectora (Inferencial)
**Contexto:** Un argumento de autoridad se basa en el prestigio de una persona o institución experta en el tema.
...
### Explicacion Pedagogica
El argumento de autoridad refuerza la tesis al demostrar que personas que saben mucho sobre el tema coinciden con la postura del autor.

## Question 5 [D5-D6]

**ID:** CO-LEN-7-2026-W20-tesis-y-argumentos-001-MASTERY-bundle-v5
**Bloom:** Understand
**ICFES:** Competencia Lectora (Literal)
**Contexto:** Los textos argumentativos suelen tener una estructura clara: introducción, desarrollo y conclusión.
...
### Explicacion Pedagogica
Presentar la tesis en la introducción permite que el lector sepa desde el principio qué es lo que el autor intenta demostrar, facilitando el seguimiento de los argumentos.

## Question 6 [D7-D8]

**ID:** CO-LEN-7-2026-W20-tesis-y-argumentos-001-MASTERY-bundle-v6
**Bloom:** Analyze
**ICFES:** Competencia Lectora (Inferencial)
**Contexto:** Diferenciar entre un hecho (objetivo) y una opinión (subjetiva) es vital para analizar argumentos.
**Expected_Success:** 0.60

### Enunciado
¿Cuál de las siguientes afirmaciones es una **opinión** que podría funcionar como base para una tesis?
...
### Explicacion Pedagogica
Las tesis se construyen sobre opiniones fundamentadas. Los hechos sirven como evidencia para apoyar esas opiniones, pero no son tesis en sí mismos porque no admiten discusión.

## Question 7 [D7-D8]

**ID:** CO-LEN-7-2026-W20-tesis-y-argumentos-001-MASTERY-bundle-v7
**Bloom:** Analyze
**ICFES:** Competencia Lectora (Crítica)
**Contexto:** Los argumentos de ejemplificación utilizan casos concretos para ilustrar y validar una idea general.
...
### Explicacion Pedagogica
El ejemplo debe ser pertinente y representativo. Mencionar nombres propios de éxito global valida directamente la afirmación sobre el reconocimiento internacional.

## Question 8 [D7-D8]

**ID:** CO-LEN-7-2026-W20-tesis-y-argumentos-001-MASTERY-bundle-v8
**Bloom:** Analyze
**ICFES:** Competencia Lectora (Inferencial)
**Contexto:** La relación entre tesis y argumentos debe ser lógica y coherente.
**Expected_Success:** 0.50

### Enunciado
Identifica la falla lógica en este razonamiento:
Tesis: "Debemos comer más frutas".
Argumento: "Porque las frutas son de colores muy bonitos y alegran la decoración de la mesa".

¿Por qué este argumento es débil para defender la tesis?
...
### Explicacion Pedagogica
La relevancia es un criterio de calidad argumentativa. El argumento debe dar una razón de peso que justifique lógicamente la aceptación de la tesis.

## Question 9 [D9-D10]

**ID:** CO-LEN-7-2026-W20-tesis-y-argumentos-001-MASTERY-bundle-v9
**Bloom:** Evaluate
**ICFES:** Competencia Lectora (Crítica)
**Contexto:** Los contraargumentos son ideas que se oponen a la tesis y que el autor debe mencionar para luego refutarlas.
**Expected_Success:** 0.45

### Enunciado
En un debate sobre el uniforme escolar, un estudiante dice: "Sé que muchos piensan que el uniforme limita la libertad de expresión (punto de vista contrario), pero en realidad ayuda a reducir las diferencias económicas entre compañeros".
...
### Explicacion Pedagogica
La capacidad de anticipar las críticas y responder a ellas de manera lógica fortalece enormemente cualquier texto o discurso argumentativo.

## Question 10 [D9-D10]

**ID:** CO-LEN-7-2026-W20-tesis-y-argumentos-001-MASTERY-bundle-v10
**Bloom:** Evaluate
**ICFES:** Competencia Lectora (Crítica)
**Contexto:** Evaluar la solidez de una tesis implica considerar si es debatible, clara y sustentable.
**Expected_Success:** 0.40

### Enunciado
¿Cuál de las siguientes tesis es la mejor formulada para un ensayo académico de nivel secundaria?
...
### Explicacion Pedagogica
Una buena tesis académica debe ser una afirmación compleja que invite a la reflexión y que requiera un esfuerzo intelectual para ser demostrada mediante pruebas y razonamientos.
