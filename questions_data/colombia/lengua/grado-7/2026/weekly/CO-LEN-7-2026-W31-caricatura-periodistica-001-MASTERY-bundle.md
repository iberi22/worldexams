---
id: "CO-LEN-7-2026-W31-caricatura-periodistica-001-MASTERY-bundle"
country: "colombia"
grado: 7
asignatura: "lengua"
tema: "caricatura-periodistica"
periodo: "weekly"
week: "W31"
year: 2026
bundle_type: "weekly"
...
## Question 1 [D3-D4]
**ID:** CO-LEN-7-2026-W31-caricatura-periodistica-001-MASTERY-v1
**Bloom:** Remember
**ICFES:** Competencia Lectora (Literal)
**Expected_Success:** 0.85
**Contexto:** En la sección de opinión de un diario colombiano, los estudiantes observan una caricatura de Matador. En ella aparece un personaje político con las orejas exageradamente grandes y una nariz muy larga.

### Enunciado
¿Cuál es el recurso gráfico fundamental de la caricatura que consiste en deformar o resaltar los rasgos físicos de una persona para hacerla reconocible o burlarse de ella?
...
## Question 2 [D3-D4]
**ID:** CO-LEN-7-2026-W31-caricatura-periodistica-001-MASTERY-v2
**Bloom:** Remember
**ICFES:** Competencia Lectora (Literal)
**Expected_Success:** 0.80
**Contexto:** Un caricaturista dibuja a un funcionario público sentado sobre un cerro de monedas de oro mientras a su lado hay un niño con un plato vacío. No hay diálogos en la imagen.

### Enunciado
¿A qué género periodístico pertenece principalmente la caricatura que busca expresar una postura crítica sobre un hecho de actualidad?
...
## Question 3 [D5-D6]
**ID:** CO-LEN-7-2026-W31-caricatura-periodistica-001-MASTERY-v3
**Bloom:** Understand
**ICFES:** Competencia Lectora (Inferencial)
**Expected_Success:** 0.75
**Contexto:** En una caricatura sobre la justicia en Colombia, se dibuja a la "Dama de la Justicia" con la venda en los ojos, pero en lugar de una balanza, sostiene un fajo de billetes.

### Enunciado
¿Qué figura retórica visual se está empleando al sustituir la balanza por billetes en este contexto?
...
### Explicacion Pedagogica
La metáfora visual permite comunicar conceptos abstractos complejos (como la corrupción) mediante la sustitución de elementos icónicos tradicionales por otros que cargan un nuevo significado crítico.

## Question 4 [D5-D6]
**ID:** CO-LEN-7-2026-W31-caricatura-periodistica-001-MASTERY-v4
**Bloom:** Understand
**ICFES:** Competencia Lectora (Inferencial)
**Expected_Success:** 0.70
**Contexto:** Una caricatura muestra a un ciudadano colombiano tratando de subir una montaña muy alta etiquetada como "Costo de vida", mientras lleva una maleta pequeña llamada "Salario mínimo".

### Enunciado
¿Cuál es el mensaje implícito que el autor quiere transmitir con esta imagen?
...
## Question 5 [D5-D6]
**ID:** CO-LEN-7-2026-W31-caricatura-periodistica-001-MASTERY-v5
**Bloom:** Apply
**ICFES:** Competencia Lectora (Inferencial)
**Expected_Success:** 0.70
**Contexto:** Imagina que debes crear una caricatura para criticar la contaminación del río Bogotá. Tienes dos ideas:
1. Dibujar el río tal como se ve en una foto.
2. Dibujar al río como un paciente en una camilla, con tapabocas y conectado a un suero de agua limpia.

### Enunciado
¿Cuál de las dos opciones cumple mejor con la función de una caricatura periodística y por qué?
...
## Question 6 [D7-D8]
**ID:** CO-LEN-7-2026-W31-caricatura-periodistica-001-MASTERY-v6
**Bloom:** Apply
**ICFES:** Competencia Lectora (Inferencial)
**Expected_Success:** 0.65
**Contexto:** Analiza una caricatura donde aparece un político prometiendo "puentes" en un pueblo donde no hay río. Un campesino le pregunta: "¿Y el río?", y el político responde: "¡También se los construyo!".

### Enunciado
¿Qué recurso del humor se está utilizando principalmente en este diálogo para criticar la demagogia política?
...
## Question 7 [D7-D8]
**ID:** CO-LEN-7-2026-W31-caricatura-periodistica-001-MASTERY-v7
**Bloom:** Analyze
**ICFES:** Competencia Lectora (Crítica)
**Expected_Success:** 0.65
**Contexto:** Observa una caricatura sobre la educación virtual. Se ve a un niño frente a una pantalla con los ojos rojos y cansados, y de la pantalla salen manos que le roban sus juguetes y su tiempo de juego.
...
### Explicacion Pedagogica
En la caricatura, los elementos fantásticos o imposibles (como manos saliendo de una pantalla) actúan como símbolos que refuerzan la tesis del autor sobre un problema social o psicológico.

## Question 8 [D7-D8]
**ID:** CO-LEN-7-2026-W31-caricatura-periodistica-001-MASTERY-v8
**Bloom:** Analyze
**ICFES:** Competencia Lectora (Crítica)
**Expected_Success:** 0.60
**Contexto:** Un periódico de una tendencia política dibuja al líder de la oposición como un lobo feroz, mientras que el periódico de la otra tendencia lo dibuja como un salvador con aureola.

### Enunciado
¿Qué conclusión se puede extraer sobre la objetividad en la caricatura periodística a partir de este ejemplo?
...
### Explicacion Pedagogica
La caricatura no busca la verdad objetiva, sino la "verdad" desde un punto de vista. El análisis crítico permite identificar cómo los símbolos visuales se usan para construir héroes o villanos según la ideología.

## Question 9 [D9-D10]
**ID:** CO-LEN-7-2026-W31-caricatura-periodistica-001-MASTERY-v9
**Bloom:** Analyze
**ICFES:** Competencia Lectora (Crítica)
**Expected_Success:** 0.55
**Contexto:** En Colombia, el uso del humor negro en la caricatura para tratar temas de violencia ha generado debates sobre la ética y la libertad de expresión.

### Enunciado
¿Cuál es el argumento principal que justifica el uso de la sátira y la caricatura incluso en temas dolorosos de la realidad nacional?
...
### Explicacion Pedagogica
La caricatura periodística cumple una función catártica y crítica. Su valor reside en su capacidad para cuestionar el poder y visibilizar problemas sociales mediante un lenguaje que combina el ingenio, el arte y la opinión.

## Question 10 [D9-D10]
**ID:** CO-LEN-7-2026-W31-caricatura-periodistica-001-MASTERY-v10
**Bloom:** Evaluate
**ICFES:** Competencia Lectora (Crítica)
**Expected_Success:** 0.50
**Contexto:** Evalúa el impacto de la siguiente caricatura: Un grupo de personas está mirando sus teléfonos mientras una inundación real les llega a las rodillas. Uno dice: "¡Mira la foto que subieron de la inundación, tiene mil likes!".
...
### Explicacion Pedagogica
La evaluación final de una caricatura implica conectar los elementos visuales y textuales con un fenómeno sociológico o cultural profundo, juzgando la efectividad del autor para señalar una contradicción humana.

[//]: # (QUALITY_REVIEW)
| Criterio | Puntuación | Notas |
| :--- | :---: | :--- |
| Técnico | 30/30 | Estructura v5.2 impecable. |
| Curricular | 40/40 | Análisis completo de la caricatura periodística para grado 7. |
| Contexto | 20/20 | Referencias a autores locales (Matador), temas nacionales (río Bogotá, salario mínimo) y sociales. |
| Redacción | 10/10 | Lenguaje adaptado y explicaciones pedagógicas que refuerzan el aprendizaje. |
| **Total** | **100/100** | |
