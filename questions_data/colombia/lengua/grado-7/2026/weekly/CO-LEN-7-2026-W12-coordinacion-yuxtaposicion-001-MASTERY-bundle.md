---
id: "CO-LEN-7-2026-W12-coordinacion-yuxtaposicion-001-MASTERY-bundle"
country: "colombia"
grado: 7
asignatura: "lengua"
tema: "coordinacion-yuxtaposicion"
periodo: "weekly"
week: "W12"
year: 2026
bundle_type: "weekly"
...
# CO-LEN-7-2026-W12-coordinacion-yuxtaposicion-001-MASTERY

## Question 1 [D3-D4]
**ID:** CO-LEN-7-2026-W12-coordinacion-yuxtaposicion-001-MASTERY-bundle-v1
**Bloom:** Remember
**ICFES:** Competencia Lectora (Literal)
**Contexto:** En la clase de Lengua en un colegio de Manizales, los estudiantes estudian cómo las oraciones pueden tener independencia o dependencia entre sí.
**Expected_Success:** 0.85

### Enunciado
¿Qué característica comparten la coordinación y la yuxtaposición en la formación de oraciones compuestas?
...
## Question 2 [D3-D4]
**ID:** CO-LEN-7-2026-W12-coordinacion-yuxtaposicion-001-MASTERY-bundle-v2
**Bloom:** Understand
**ICFES:** Competencia Lectora (Literal)
**Contexto:** Valentina escribe en su diario: "Fui al centro de Medellín, compré unas flores, regresé temprano".
**Expected_Success:** 0.82

### Enunciado
¿Qué tipo de oración compuesta ha escrito Valentina y cuál es el signo de puntuación que permite identificarlo?
...
## Question 3 [D5-D6]
**ID:** CO-LEN-7-2026-W12-coordinacion-yuxtaposicion-001-MASTERY-bundle-v3
**Bloom:** Apply
**ICFES:** Competencia Lectora (Inferencial)
**Contexto:** Los nexos coordinantes copulativos sirven para sumar ideas o acciones.
**Expected_Success:** 0.75

### Enunciado
Identifica cuál de las siguientes es una oración COORDINADA COPULATIVA.
...
### Explicacion Pedagogica
La coordinación copulativa usa nexos como "y", "e", "ni". Su función es simple: acumular información. Es la forma más básica de construcción de oraciones compuestas.

---

## Question 4 [D5-D6]
**ID:** CO-LEN-7-2026-W12-coordinacion-yuxtaposicion-001-MASTERY-bundle-v4
**Bloom:** Understand
**ICFES:** Competencia Lectora (Literal)
**Contexto:** En la coordinación adversativa, una proposición corrige o limita el significado de la otra.
**Expected_Success:** 0.78

### Enunciado
"Quería comprar el libro de Rafael Pombo, **pero la librería estaba cerrada**". ¿Qué tipo de relación establece el nexo en negrilla?
...
## Question 5 [D5-D6]
**ID:** CO-LEN-7-2026-W12-coordinacion-yuxtaposicion-001-MASTERY-bundle-v5
**Bloom:** Apply
**ICFES:** Competencia Lectora (Inferencial)
**Contexto:** Santiago nota que en los textos de historia a veces se usan dos puntos (:) para explicar algo sin usar palabras como "porque" o "entonces".
...
### Explicacion Pedagogica
Los dos puntos en la yuxtaposición tienen un valor explicativo. Equivalen a nexos como "ya que" o "debido a que", pero con una estructura más directa y sintética, propia de un lenguaje más maduro.

---

## Question 6 [D7-D8]
**ID:** CO-LEN-7-2026-W12-coordinacion-yuxtaposicion-001-MASTERY-bundle-v6
**Bloom:** Analyze
**ICFES:** Competencia Lectora (Crítica)
**Contexto:** Al escribir, es importante evitar la repetición excesiva de nexos ("y", "y", "y"), lo que se conoce como polisíndeton innecesario.
**Expected_Success:** 0.65

### Enunciado
¿Cómo se puede transformar la oración: "Juan estudia y Pedro trabaja y María descansa" en una oración YUXTAPUESTA para que sea más fluida?
...
### Explicacion Pedagogica
La yuxtaposición (en este caso llamada asíndeton cuando se eliminan conjunciones) aporta rapidez y agilidad al texto. Es un recurso estilístico que evita la monotonía y permite que el lector conecte las ideas de forma más dinámica.

---

## Question 7 [D7-D8]
**ID:** CO-LEN-7-2026-W12-coordinacion-yuxtaposicion-001-MASTERY-bundle-v7
**Bloom:** Analyze
**ICFES:** Competencia Lectora (Inferencial)
**Contexto:** Camila analiza las oraciones coordinadas distributivas, que presentan acciones que se alternan.
**Expected_Success:** 0.68

### Enunciado
"**Ya** sale el sol por los cerros, **ya** se oculta tras las nubes". ¿Qué tipo de coordinación se utiliza aquí?
...
## Question 8 [D7-D8]
**ID:** CO-LEN-7-2026-W12-coordinacion-yuxtaposicion-001-MASTERY-bundle-v8
**Bloom:** Evaluate
**ICFES:** Competencia Lectora (Crítica)
**Contexto:** En un texto argumentativo, la elección entre usar un nexo coordinante o un signo de puntuación (yuxtaposición) cambia el ritmo de la lectura.
**Expected_Success:** 0.60

### Enunciado
¿En qué situación es preferible usar la YUXTAPOSICIÓN con punto y coma en lugar de la COORDINACIÓN con "y"?
...
## Question 9 [D9-D10]
**ID:** CO-LEN-7-2026-W12-coordinacion-yuxtaposicion-001-MASTERY-bundle-v9
**Bloom:** Evaluate
**ICFES:** Competencia Lectora (Crítica)
**Contexto:** Un texto dice: "El río Magdalena es la arteria de Colombia; su historia es la nuestra".
...
### Explicacion Pedagogica
La yuxtaposición exige un lector activo. Al no haber un nexo que nos diga exactamente cuál es la relación (causa, efecto, suma), el lector debe interpretarla basándose en su conocimiento del mundo. En este caso, une la geografía con la historia y la identidad de forma magistral.

---

## Question 10 [D9-D10]
**ID:** CO-LEN-7-2026-W12-coordinacion-yuxtaposicion-001-MASTERY-bundle-v10
**Bloom:** Analyze
**ICFES:** Competencia Lectora (Inferencial)
**Contexto:** El uso correcto de la conjunción "ni" requiere que la oración tenga un sentido negativo previo o que se repita el nexo.
...
### Explicacion Pedagogica
La conjunción "ni" es la versión negativa de "y". Su uso correcto es fundamental para expresar carencias o rechazos dobles de forma clara. Recordar que "ni" ya incluye la negación, por lo que no se debe decir "y no ni".
