---
id: "CO-LEN-7-2026-W24-propaganda-publicidad-001-MASTERY-bundle"
country: "colombia"
grado: 7
asignatura: "lengua"
...
# CO-LEN-7-2026-W24-propaganda-publicidad-001-MASTERY

## Question 1 [D3-D4]

**ID:** CO-LEN-7-2026-W24-propaganda-publicidad-001-MASTERY-bundle-v1
**Bloom:** Remember
**ICFES:** Competencia Lectora (Literal)
**Contexto:** Aunque a menudo se usan como sinónimos, la publicidad y la propaganda tienen objetivos diferentes.
**Expected_Success:** 0.85

### Enunciado
¿Cuál es la principal diferencia entre la **publicidad** y la **propaganda**?
...
**ID:** CO-LEN-7-2026-W24-propaganda-publicidad-001-MASTERY-bundle-v2
**Bloom:** Remember
**ICFES:** Competencia Lectora (Literal)
**Contexto:** El eslogan es una frase corta y memorable que identifica a una marca o campaña.
**Expected_Success:** 0.80

### Enunciado
¿Cuál es la característica principal de un buen **eslogan**?

### Opciones
- [ ] A) Debe ser muy largo para explicar todas las ventajas del producto. <!-- feedback: Incorrecto. La longitud dificulta que la gente lo recuerde. -->
- [ ] B) Debe usar un lenguaje científico muy complejo para dar confianza. <!-- feedback: Incorrecto. El eslogan debe ser sencillo y directo para el gran público. -->
- [x] C) Debe ser breve, fácil de recordar y capaz de impactar emocionalmente al consumidor. <!-- feedback: ¡Correcto! La brevedad y el ritmo facilitan que el eslogan se quede en la memoria de las personas. -->
- [ ] D) No debe tener relación con la marca para generar misterio. <!-- feedback: Incorrecto. El eslogan debe reforzar la identidad de la marca o campaña. -->

### Explicacion Pedagogica
Ejemplos como "Just do it" o "Colombia, el riesgo es que te quieras quedar" demuestran cómo pocas palabras pueden transmitir la esencia de una marca o un país.

## Question 3 [D5-D6]

**ID:** CO-LEN-7-2026-W24-propaganda-publicidad-001-MASTERY-bundle-v3
**Bloom:** Apply
**ICFES:** Competencia Lectora (Inferencial)
**Contexto:** La publicidad utiliza diversos recursos persuasivos, entre ellos la apelación a las emociones.
**Expected_Success:** 0.75

### Enunciado
Un comercial de una bebida achocolatada muestra a un niño colombiano que, después de tomar el producto, se convierte en un gran deportista y abraza a su mamá. ¿Qué recurso persuasivo está usando?
...
### Explicacion Pedagogica
La publicidad emocional busca que el consumidor asocie el producto con sensaciones positivas, de modo que lo compre no solo por su función, sino por lo que lo hace sentir.

## Question 4 [D5-D6]

**ID:** CO-LEN-7-2026-W24-propaganda-publicidad-001-MASTERY-bundle-v4
**Bloom:** Apply
**ICFES:** Competencia Lectora (Inferencial)
**Contexto:** La propaganda institucional busca mejorar los comportamientos de la ciudadanía en beneficio de todos.
...
### Explicacion Pedagogica
La propaganda no intenta vender algo físico, sino una actitud o una creencia (en este caso, la valoración del parque y el pago de impuestos).

## Question 5 [D5-D6]

**ID:** CO-LEN-7-2026-W24-propaganda-publicidad-001-MASTERY-bundle-v5
**Bloom:** Understand
**ICFES:** Competencia Lectora (Inferencial)
**Contexto:** El público objetivo o "target" es el grupo específico de personas al que se dirige un mensaje.
**Expected_Success:** 0.65

### Enunciado
Si ves una publicidad llena de colores neón, música urbana de moda y lenguaje juvenil, ¿quién es probablemente el **público objetivo**?
...
### Explicacion Pedagogica
Adecuar el mensaje al público objetivo es clave para que la publicidad o propaganda sea efectiva. Cada grupo humano tiene códigos visuales y lingüísticos propios.

## Question 6 [D7-D8]

**ID:** CO-LEN-7-2026-W24-propaganda-publicidad-001-MASTERY-bundle-v6
**Bloom:** Analyze
**ICFES:** Competencia Lectora (Inferencial)
**Contexto:** Los estereotipos son imágenes simplificadas y generalizadas sobre grupos de personas que la publicidad suele repetir.
**Expected_Success:** 0.60

### Enunciado
Analiza el siguiente anuncio: "Detergente 'Limpiecito': para que mamá descanse mientras la ropa queda blanca". ¿Qué **estereotipo de género** refuerza esta publicidad?
...
**ID:** CO-LEN-7-2026-W24-propaganda-publicidad-001-MASTERY-bundle-v7
**Bloom:** Analyze
**ICFES:** Competencia Lectora (Crítica)
**Contexto:** La publicidad engañosa ocurre cuando se ocultan datos negativos o se exageran las cualidades de un producto de forma falsa.
**Expected_Success:** 0.55

### Enunciado
¿Cuál de las siguientes situaciones representa un caso de **publicidad engañosa**?
...
**ID:** CO-LEN-7-2026-W24-propaganda-publicidad-001-MASTERY-bundle-v8
**Bloom:** Analyze
**ICFES:** Competencia Lectora (Inferencial)
**Contexto:** En la publicidad y propaganda, la imagen suele ser más importante que el texto. Esto se llama lenguaje visual.
**Expected_Success:** 0.50

### Enunciado
En una propaganda de salud pública, aparece la imagen de un pulmón gris y marchito junto al eslogan: "El tabaco te consume". ¿Cómo interactúan la imagen y el texto aquí?
...
**ID:** CO-LEN-7-2026-W24-propaganda-publicidad-001-MASTERY-bundle-v9
**Bloom:** Evaluate
**ICFES:** Competencia Lectora (Crítica)
**Contexto:** El uso de celebridades en la publicidad busca transferir el prestigio de la persona al producto.
**Expected_Success:** 0.45

### Enunciado
Un famoso futbolista colombiano aparece en un comercial recomendando un banco nacional. Desde un punto de vista crítico, ¿qué relación real existe entre el futbolista y el banco?
...
### Explicacion Pedagogica
Identificar estas asociaciones nos permite ser consumidores más críticos, entendiendo que el éxito de una persona en un campo no garantiza la calidad de lo que promociona en otro.

## Question 10 [D9-D10]

**ID:** CO-LEN-7-2026-W24-propaganda-publicidad-001-MASTERY-bundle-v10
**Bloom:** Evaluate
**ICFES:** Competencia Lectora (Crítica)
**Contexto:** El análisis crítico de la propaganda política es fundamental para una democracia saludable.
**Expected_Success:** 0.40

### Enunciado
Un afiche de propaganda muestra a un candidato sonriendo con niños de diferentes razas y el texto: "La unión que necesitamos". ¿Qué recurso de manipulación emocional podría estar presente aquí?
...
### Explicacion Pedagogica
La propaganda a menudo utiliza imágenes "incuestionables" (como niños o la bandera) para blindar al candidato contra las críticas, asociándolo con la pureza y el patriotismo de forma automática.
