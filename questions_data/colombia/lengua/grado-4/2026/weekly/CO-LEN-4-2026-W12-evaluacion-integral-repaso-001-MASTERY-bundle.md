...
tema: "evaluacion-integral-repaso"
periodo: 4
bundle_index: 1
week: 12
year: 2026
...
**Grado:** 4° | **Periodo:** 4 | **Semana:** 12 | **Año:** 2026
...
- [ ] D) **Hola** se usa solo para hablar y **Ola** solo para escribir. <!-- feedback: Incorrecto. Ambas se usan en el lenguaje oral y escrito. -->

### Explicación Pedagógica
Diferenciar homófonos comunes mediante el contexto asegura que el estudiante no cometa errores ortográficos que cambien el sentido de sus mensajes.
...
- [ ] D) Que los turistas ya no quieren ir. <!-- feedback: Incorrecto. La gráfica mide nieve, no turistas (a menos que se especifique lo contrario). -->

### Explicación Pedagógica
La interpretación de tendencias en gráficas (subidas y bajadas) es una habilidad de análisis de textos discontinuos fundamental para las ciencias y el lenguaje.
...
- [ ] D) Como un error de repetición. <!-- feedback: Incorrecto. Es un uso válido para mostrar la polisemia. -->

### Explicación Pedagógica
La polisemia permite entender la flexibilidad del lenguaje. Reconocer estos usos evita confusiones en las instrucciones escolares.
...
- [ ] D) Listar los materiales que se usaron para el trabajo. <!-- feedback: Incorrecto. Eso sería una lista de materiales, no argumentos. -->

### Explicación Pedagógica
Entender la función de la argumentación diferencia al ensayo de otros tipos de texto como la narración o la descripción pura.
...
- [ ] D) A quien le interese esto. <!-- feedback: Incorrecto. Es una forma descortés y poco profesional de dirigirse a alguien. -->

### Explicación Pedagógica
El registro formal es una competencia social. El estudiante debe saber elegir las palabras que demuestren respeto por la jerarquía y la institución.
...
- [ ] D) No debe ir, porque el vapor no se ve. <!-- feedback: Incorrecto. Aunque sea invisible, es un concepto clave del proceso científico. -->

### Explicación Pedagógica
La estructura jerárquica y lógica del mapa conceptual ayuda a organizar el conocimiento científico de forma visual.
...
- [ ] D) Subrayar todo el libro con el mismo color. <!-- feedback: Incorrecto. El subrayado total no permite distinguir lo importante. -->

### Explicación Pedagógica
La metacognición (saber cómo estudiar mejor) es el nivel más alto de las técnicas de estudio. El estudiante debe elegir herramientas según la tarea (datos vs. conceptos).
...
- [ ] D) Que no se puede subir a esa montaña. <!-- feedback: Incorrecto. El texto no menciona que sea inaccesible. -->

### Explicación Pedagógica
La inferencia lógica a partir de textos académicos es una habilidad de comprensión lectora crítica. El estudiante debe ir más allá de lo literal y entender las implicaciones de las palabras (como "aislado").
...
| Curricular | 40/40 | Repaso final de competencias de grado 4°. |
| Contexto | 20/20 | Referencias a Amazonas, El Cocuy, Cali, Sierra Nevada de Santa Marta y Ministerios. |
| Redacción | 10/10 | Alta calidad en distractores y explicaciones. |
| **TOTAL** | **100/100** | |
