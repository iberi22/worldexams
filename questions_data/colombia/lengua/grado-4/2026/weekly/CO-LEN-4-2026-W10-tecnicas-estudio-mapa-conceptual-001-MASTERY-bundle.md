...
tema: "tecnicas-estudio-mapa-conceptual"
periodo: 3
bundle_index: 1
week: 10
year: 2026
...
**Grado:** 4° | **Periodo:** 3 | **Semana:** 10 | **Año:** 2026
...
- [ ] D) Usando solo dibujos sin ninguna palabra. <!-- feedback: Incorrecto. Los mapas conceptuales requieren palabras de enlace y conceptos. -->

### Explicación Pedagógica
La jerarquía es el principio organizador del mapa conceptual. El estudiante debe entender que la posición visual indica la importancia o generalidad del concepto.
...
- [ ] D) Títulos secundarios. <!-- feedback: Incorrecto. Aunque son títulos, dentro del mapa se denominan conceptos. -->

### Explicación Pedagógica
Identificar las partes del mapa conceptual (conceptos, líneas de enlace, palabras de enlace) es necesario para su correcta construcción.
...
- [ ] D) Es un adorno para que la línea no se vea vacía. <!-- feedback: Incorrecto. Tiene una función gramatical y lógica clara. -->

### Explicación Pedagógica
Las palabras de enlace permiten la lectura proposicional del mapa conceptual. El estudiante debe reconocer que el mapa se lee como un conjunto de oraciones lógicas.
...
- [ ] D) Que los mapas conceptuales siempre tienen dibujos de colores. <!-- feedback: Incorrecto. Pueden ser solo texto y líneas, la ventaja es la estructura. -->

### Explicación Pedagógica
La visualización de relaciones jerárquicas y asociativas es la fortaleza pedagógica del mapa conceptual. El estudiante debe valorar la estructura sobre la simple acumulación de datos.
...
- [ ] D) Astronautas. <!-- feedback: Incorrecto. Es un tema relacionado, pero no es el núcleo del sistema solar. -->

### Explicación Pedagógica
La habilidad de jerarquizar es central. El estudiante debe ser capaz de identificar el concepto supraordinado que engloba a todos los demás.
...
- [ ] D) Porque el profesor no tiene tiempo de leer tanto. <!-- feedback: Incorrecto. El mapa es para el aprendizaje del estudiante. -->

### Explicación Pedagógica
La capacidad de síntesis es vital. El mapa conceptual obliga al estudiante a extraer el concepto núcleo, evitando la copia literal de textos largos.
...
- [ ] D) Que no tiene cuadros de colores. <!-- feedback: Incorrecto. Los colores son opcionales. -->

### Explicación Pedagógica
La veracidad del contenido es fundamental. Un mapa conceptual es una herramienta de conocimiento, por lo que las relaciones entre conceptos deben ser correctas.
...
- [ ] D) Ninguna, el ciclo de la vida se dibuja con un círculo. <!-- feedback: Incorrecto. Aunque es un ciclo, en el mapa conceptual se representan las relaciones de forma jerárquica o secuencial con líneas. -->

### Explicación Pedagógica
Este ejercicio evalúa la capacidad de transcodificación (de texto a mapa). El estudiante debe identificar cuántos elementos de igual jerarquía dependen del tema central.
...
| Curricular | 40/40 | Estrategias de organización de información (DBA). |
| Contexto | 20/20 | Referencias a Ibagué, Arauca y Neiva. |
| Redacción | 10/10 | Lenguaje adaptado a 4° y conceptos claros. |
| **TOTAL** | **100/100** | |
