---
id: "CO-LEN-6-2026-W01-comunicacion-intencion-comunicativa-001-MASTERY-bundle"
country: "colombia"
grado: 6
asignatura: "lengua"
tema: "comunicacion-intencion-comunicativa"
periodo: "weekly"
week: "W01"
year: 2026
bundle_type: "weekly"
...
# Bundle Mastery: Comunicación e Intención Comunicativa - Grado 6
## Semana W01

## Question 1 [D3-D4]
**ID:** CO-LEN-6-2026-W01-comunicacion-intencion-comunicativa-001-MASTERY-bundle-v1
**Bloom:** Remember
**ICFES:** Identificación de contenidos locales
**Contexto:** En la Institución Educativa Distrital de Barranquilla, el profesor Manuel explica que todo acto comunicativo tiene un propósito específico.
...
La intención comunicativa es el propósito, meta u objetivo que todo emisor tiene al emitir un mensaje. Dependiendo de lo que queramos lograr (informar, convencer, pedir, etc.), estructuramos nuestro mensaje de una manera específica.

---

## Question 2 [D3-D4]
**ID:** CO-LEN-6-2026-W01-comunicacion-intencion-comunicativa-001-MASTERY-bundle-v2
**Bloom:** Understand
**ICFES:** Comprensión de textos
**Contexto:** Mariana lee un cartel en el parque Simón Bolívar de Bogotá que dice: "Por favor, deposite la basura en los recipientes indicados para mantener nuestro parque limpio".
**Expected_Success:** 0.82

### Enunciado
¿Cuál es la intención comunicativa principal del cartel que leyó Mariana?
...
### Explicacion Pedagogica
Cuando un mensaje busca que el receptor realice una acción o cambie una conducta, la intención es apelativa o persuasiva. En este caso, el cartel da una instrucción clara para mantener el orden y la limpieza.

---

## Question 3 [D5-D6]
**ID:** CO-LEN-6-2026-W01-comunicacion-intencion-comunicativa-001-MASTERY-bundle-v3
**Bloom:** Understand
**ICFES:** Identificación de contenidos locales
**Contexto:** Durante el noticiero del mediodía en un canal regional de Medellín, el presentador informa sobre el estado del clima para la tarde de hoy.
...
### Explicacion Pedagogica
La intención informativa (o función referencial) se utiliza cuando el objetivo principal es transmitir datos, hechos o conocimientos de manera objetiva sobre el mundo que nos rodea, como ocurre en las noticias o reportes meteorológicos.

---

## Question 4 [D5-D6]
**ID:** CO-LEN-6-2026-W01-comunicacion-intencion-comunicativa-001-MASTERY-bundle-v4
**Bloom:** Apply
**ICFES:** Uso comprensivo del conocimiento
**Contexto:** En una plaza de mercado de Cali, un vendedor grita: "¡Lleve la mandarina dulce, barata y fresquita, la mejor de la galería!".
**Expected_Success:** 0.75

### Enunciado
En esta situación, ¿cuál es la intención comunicativa del vendedor y qué función predomina?
...
## Question 5 [D5-D6]
**ID:** CO-LEN-6-2026-W01-comunicacion-intencion-comunicativa-001-MASTERY-bundle-v5
**Bloom:** Analyze
**ICFES:** Comprensión de textos
**Contexto:** Sofía le escribe un mensaje por WhatsApp a su mamá que dice: "¡Te quiero mucho, mami! Gracias por apoyarme siempre".
**Expected_Success:** 0.72

### Enunciado
¿Qué intención comunicativa se evidencia primordialmente en el mensaje de Sofía?

### Opciones
- [ ] A) Informativa, porque le cuenta a su mamá algo que ella no sabía. <!-- feedback: Incorrecto. El foco no es un dato externo, sino un sentimiento. -->
- [x] B) Expresiva o emotiva, ya que manifiesta sus sentimientos y afectos personales. <!-- feedback: Correcto. La función expresiva se centra en el emisor y su mundo interior (emociones, sentimientos, opiniones). -->
- [ ] C) Apelativa, porque le ordena a su mamá que la quiera también. <!-- feedback: Incorrecto. El mensaje no es una orden ni una petición de acción. -->
- [ ] D) Fática, porque solo quiere verificar si el celular de su mamá funciona. <!-- feedback: Incorrecto. El contenido del mensaje es profundo y afectivo, no es solo un saludo de prueba. -->

### Explicacion Pedagogica
La intención expresiva o emotiva ocurre cuando el emisor exterioriza lo que siente o piensa. Se reconoce comúnmente por el uso de exclamaciones, términos afectuosos y la primera persona gramatical.

---

## Question 6 [D7-D8]
**ID:** CO-LEN-6-2026-W01-comunicacion-intencion-comunicativa-001-MASTERY-bundle-v6
**Bloom:** Analyze
**ICFES:** Estrategias de lectura
**Contexto:** En la biblioteca de un colegio en Pasto, los estudiantes analizan la siguiente frase de un poema: "Tus ojos son dos luceros que iluminan mi caminar".
**Expected_Success:** 0.68

### Enunciado
¿Cuál es la intención comunicativa del autor al usar este lenguaje figurado?
...
## Question 7 [D7-D8]
**ID:** CO-LEN-6-2026-W01-comunicacion-intencion-comunicativa-001-MASTERY-bundle-v7
**Bloom:** Understand
**ICFES:** Identificación de contenidos locales
**Contexto:** En una videollamada, Juan dice: "¿Aló? ¿Me escuchan bien? ¿Están ahí?".
**Expected_Success:** 0.70

### Enunciado
¿Qué intención comunicativa tiene Juan al pronunciar esas frases durante la llamada?
...
### Explicacion Pedagogica
La función fática se centra en el canal de comunicación. Su propósito no es transmitir un mensaje complejo, sino asegurarse de que la comunicación es posible (como decir "bueno", "¿sí?", "¿me oyes?").

---

## Question 8 [D7-D8]
**ID:** CO-LEN-6-2026-W01-comunicacion-intencion-comunicativa-001-MASTERY-bundle-v8
**Bloom:** Apply
**ICFES:** Uso comprensivo del conocimiento
**Contexto:** Un diccionario escolar define la palabra "comunicación" como: "Acción de comunicar o comunicarse. Trato, correspondencia entre dos o más personas".
...
### Explicacion Pedagogica
La función metalingüística se activa cuando el mensaje tiene como objeto de estudio el propio lenguaje. Es típica de diccionarios, gramáticas y clases de lengua donde se aclaran significados o normas.

---

## Question 9 [D9-D10]
**ID:** CO-LEN-6-2026-W01-comunicacion-intencion-comunicativa-001-MASTERY-bundle-v9
**Bloom:** Analyze
**ICFES:** Explicación de fenómenos
**Contexto:** Durante una campaña electoral estudiantil en una escuela de Neiva, un candidato dice: "Voten por mí si quieren un colegio con mejores canchas y más arte".
**Expected_Success:** 0.60

### Enunciado
En este contexto, ¿por qué la intención comunicativa es compleja y mezcla diferentes propósitos?
...
## Question 10 [D9-D10]
**ID:** CO-LEN-6-2026-W01-comunicacion-intencion-comunicativa-001-MASTERY-bundle-v10
**Bloom:** Evaluate
**ICFES:** Estrategias de lectura
**Contexto:** Analiza la siguiente situación: Un guía turístico en el Parque Arqueológico de San Agustín (Huila) explica la historia de las estatuas, mientras pide a los turistas que no las toquen para evitar el deterioro.
**Expected_Success:** 0.55

### Enunciado
¿Cómo se distribuyen las intenciones comunicativas en el discurso del guía?
...
### Explicacion Pedagogica
En situaciones reales, las intenciones se solapan. Un buen comunicador sabe informar (función referencial) para dar contexto y luego dar una instrucción clara (función apelativa) basada en esa información.
