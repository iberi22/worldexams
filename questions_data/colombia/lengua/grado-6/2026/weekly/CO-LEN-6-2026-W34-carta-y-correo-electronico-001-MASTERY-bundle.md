---
id: "CO-LEN-6-2026-W34-carta-y-correo-electronico-001-MASTERY-bundle"
country: "colombia"
grado: 6
asignatura: "lengua"
tema: "carta-y-correo-electronico"
periodo: "weekly"
week: "W34"
year: 2026
bundle_type: "weekly"
...
# Weekly Pack W34 — La Carta y el Correo Electrónico
...
**Contexto:** En la Institución Educativa Sagrado Corazón de Jesús de Cúcuta, los estudiantes aprenden sobre los medios de comunicación interpersonal.
...
El encabezado de una carta (ciudad y fecha) es fundamental para la organización administrativa y personal de la correspondencia, permitiendo llevar un registro temporal de la comunicación.
...
**Contexto:** Un estudiante de 6° grado en Medellín está redactando un correo electrónico para su profesora y debe elegir el asunto adecuado.

### Enunciado
¿Cuál es la función del campo **Asunto** en un correo electrónico?
...
**Contexto:** Un grupo de estudiantes en Cali debe escribir una carta de solicitud al rector para pedir permiso para un evento deportivo.

### Enunciado
¿Cuál de los siguientes **saludos** es el más apropiado para una carta formal dirigida a una autoridad escolar?
...
**Contexto:** En un taller sobre ciudadanía digital en Barranquilla, se explica la parte final de un correo electrónico formal.
...
### Explicacion Pedagogica
La firma en un correo electrónico profesional o académico suele incluir datos de contacto adicionales, asegurando que el receptor sepa exactamente con quién se está comunicando.
...
**Contexto:** Un estudiante de Bucaramanga quiere enviar una foto de su tarea por correo electrónico.

### Enunciado
¿Cómo se denomina la función técnica que permite enviar documentos, imágenes o videos junto con un mensaje de correo electrónico?
...
### Explicacion Pedagogica
La capacidad de adjuntar archivos es una de las mayores ventajas del correo electrónico sobre la carta tradicional, permitiendo el intercambio instantáneo de información multimedia.
...
**Contexto:** Un grupo de alumnos en Cartagena analiza las diferencias de lenguaje entre una carta a un amigo y una carta a una empresa.

### Enunciado
¿Qué tipo de lenguaje predomina en una **carta informal** (dirigida a un familiar o amigo)?
...
### Explicacion Pedagogica
El registro lingüístico se adapta al destinatario. En las cartas informales, el objetivo es mantener el vínculo afectivo, por lo que el lenguaje es más libre y espontáneo.
...
**Contexto:** En una clase en Pereira, se estudia la estructura de los correos electrónicos y la función de los campos de destinatario.

### Enunciado
¿Para qué sirve el campo **CC** (Copia de Carbón) en un correo electrónico?
...
**Contexto:** Un docente de Popayán explica la importancia de la ortografía en los correos electrónicos académicos.
...
### Explicacion Pedagogica
La "netiqueta" (etiqueta en la red) incluye el respeto por las normas gramaticales, lo cual facilita la comprensión y demuestra respeto hacia el tiempo del lector.
...
**Contexto:** En un ejercicio de análisis en Villavicencio, se compara la velocidad y costo de una carta física frente a un correo electrónico.

### Enunciado
¿Cuál es la principal ventaja de la carta física (en papel) en la era de los correos electrónicos?
...
**Contexto:** Un estudiante de 6° grado en Pasto recibe un correo sospechoso que le pide datos personales.

### Enunciado
¿Cuál es la medida de seguridad más importante al usar el correo electrónico?
...
|-----------|-------|-------|
| Técnico | 30/30 | Cumple con el protocolo v5.2. |
| Curricular | 40/40 | Alineado con DBA sobre producción de textos (carta/email). |
| Contexto | 20/20 | Contextos colombianos variados y realistas. |
| Redacción | 10/10 | Preguntas pedagógicas y claras. |
| **TOTAL** | **100/100** | |
