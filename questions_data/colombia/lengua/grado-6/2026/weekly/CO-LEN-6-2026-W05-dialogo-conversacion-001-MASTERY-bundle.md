---
id: "CO-LEN-6-2026-W05-dialogo-conversacion-001-MASTERY-bundle"
country: "colombia"
grado: 6
asignatura: "lengua"
tema: "dialogo-conversacion"
periodo: "weekly"
week: "W05"
year: 2026
bundle_type: "weekly"
...
# Bundle Mastery: Diálogo y Conversación - Grado 6
## Semana W05

## Question 1 [D3-D4]
**ID:** CO-LEN-6-2026-W05-dialogo-conversacion-001-MASTERY-bundle-v1
**Bloom:** Remember
**ICFES:** Identificación de contenidos locales
**Contexto:** En la biblioteca de un colegio en Ibagué, dos amigos conversan sobre los libros que han leído este mes.
...
El diálogo se define por la reciprocidad. A diferencia del monólogo, en el diálogo los participantes alternan sus turnos de habla, permitiendo que la información fluya en ambas direcciones.

---

## Question 2 [D3-D4]
**ID:** CO-LEN-6-2026-W05-dialogo-conversacion-001-MASTERY-bundle-v2
**Bloom:** Understand
**ICFES:** Comprensión de textos
**Contexto:** Lee el siguiente fragmento:
—¿A qué hora empieza la clase de Educación Física, Andrés?
—A las diez de la mañana en las canchas múltiples.
—Gracias, allá nos vemos.
**Expected_Success:** 0.85

### Enunciado
¿Qué tipo de diálogo es este según su nivel de preparación?
...
## Question 3 [D5-D6]
**ID:** CO-LEN-6-2026-W05-dialogo-conversacion-001-MASTERY-bundle-v3
**Bloom:** Understand
**ICFES:** Identificación de contenidos locales
**Contexto:** Un grupo de estudiantes en Sincelejo está realizando un diálogo dirigido para decidir el tema de su proyecto de grado.
**Expected_Success:** 0.78

### Enunciado
¿Cuál es la función principal de un moderador en un diálogo dirigido o formal?
...
## Question 4 [D5-D6]
**ID:** CO-LEN-6-2026-W05-dialogo-conversacion-001-MASTERY-bundle-v4
**Bloom:** Apply
**ICFES:** Uso comprensivo del conocimiento
**Contexto:** En un chat familiar de Barranquilla, varias personas escriben al mismo tiempo sobre temas diferentes: el partido de fútbol, la receta de la abuela y el clima.
**Expected_Success:** 0.75

### Enunciado
¿Qué regla de la conversación se está rompiendo en esta situación digital?
...
## Question 5 [D5-D6]
**ID:** CO-LEN-6-2026-W05-dialogo-conversacion-001-MASTERY-bundle-v5
**Bloom:** Analyze
**ICFES:** Comprensión de textos
**Contexto:** Analiza este breve diálogo en un mercado de Medellín:
Vendedor: —¡A la orden, patrón! ¿Qué buscaba?
Cliente: —Buenas tardes. ¿A cómo tiene el kilo de mora?
Vendedor: —A seis mil pesitos, bien madura y dulce.
**Expected_Success:** 0.72

### Enunciado
¿Cuál es la estructura que sigue este diálogo?
...
### Explicacion Pedagogica
Todo diálogo tiene una estructura: 1) Apertura (saludos), 2) Orientación (introducción del tema), 3) Desarrollo o Cuerpo (intercambio de ideas) y 4) Cierre (despedida). Reconocer estas partes ayuda a mejorar nuestra competencia comunicativa.

---

## Question 6 [D7-D8]
**ID:** CO-LEN-6-2026-W05-dialogo-conversacion-001-MASTERY-bundle-v6
**Bloom:** Analyze
**ICFES:** Estrategias de lectura
**Contexto:** En una obra de teatro escolar en Popayán, un personaje dice: "—¡Oh, qué bella tarde! —exclamó Juan mientras miraba el horizonte".
**Expected_Success:** 0.70

### Enunciado
En los textos escritos, ¿cuál es el signo de puntuación que se utiliza para indicar que un personaje empieza a hablar en un diálogo?
...
### Explicacion Pedagogica
En la escritura de narraciones, el uso de la raya (—) permite al lector identificar rápidamente cuándo cambia el turno de palabra entre los personajes, sin necesidad de repetir constantemente "dijo él" o "respondió ella".

---

## Question 7 [D7-D8]
**ID:** CO-LEN-6-2026-W05-dialogo-conversacion-001-MASTERY-bundle-v7
**Bloom:** Understand
**ICFES:** Identificación de contenidos locales
**Contexto:** Dos personas discuten en una fila de un banco en Bogotá. Una de ellas no para de hablar y no deja que la otra explique por qué se coló.
**Expected_Success:** 0.68

### Enunciado
¿Cuál es la falla ética y comunicativa que impide que esta discusión sea un verdadero diálogo?
...
## Question 8 [D7-D8]
**ID:** CO-LEN-6-2026-W05-dialogo-conversacion-001-MASTERY-bundle-v8
**Bloom:** Apply
**ICFES:** Uso comprensivo del conocimiento
**Contexto:** Un periodista de una revista en Colombia prepara una entrevista con un deportista famoso. El periodista lleva una lista de preguntas listas.
**Expected_Success:** 0.65

### Enunciado
¿Qué tipo de diálogo es la entrevista y por qué se diferencia de una charla de amigos?
...
### Explicacion Pedagogica
La entrevista es un diálogo formal y planificado. A diferencia de la conversación cotidiana, hay una clara distinción de roles: uno pregunta (entrevistador) y otro responde (entrevistado), siguiendo un guion o temática establecida.

---

## Question 9 [D9-D10]
**ID:** CO-LEN-6-2026-W05-dialogo-conversacion-001-MASTERY-bundle-v9
**Bloom:** Analyze
**ICFES:** Explicación de fenómenos
**Contexto:** En la literatura, los autores usan el diálogo para mostrar la personalidad de los personajes sin tener que describirlos físicamente.
**Expected_Success:** 0.60

### Enunciado
Lee:
—Oye, pelado, pásame esa vaina rápido que tenemos que irnos pal río antes de que llueva.
¿Qué información nos da este diálogo sobre el personaje que habla?
...
## Question 10 [D9-D10]
**ID:** CO-LEN-6-2026-W05-dialogo-conversacion-001-MASTERY-bundle-v10
**Bloom:** Evaluate
**ICFES:** Estrategias de lectura
**Contexto:** Analiza la situación: Un padre y un hijo están "dialogando" sobre las notas del colegio. El padre habla durante 20 minutos seguidos sobre la importancia del estudio, y el hijo solo dice "sí, señor" al final.
**Expected_Success:** 0.50

### Enunciado
¿Por qué esta situación, aunque parece un diálogo, en realidad no cumple con la esencia de una conversación efectiva?
