---
id: "CO-LEN-8-2026-W08-conceptismo-001-MASTERY-bundle"
country: "colombia"
grado: 8
asignatura: "lengua"
tema: "conceptismo"
...
# Bundle Mastery: Conceptismo — Grado 8
## Semana W08

## Question 1 [D3-D4]
**ID:** CO-LEN-8-2026-W08-conceptismo-001-MASTERY-bundle-v1
**Bloom:** Remember
**ICFES:** Competencia Lectora (Literal)
**Contexto:** El Conceptismo es una de las dos grandes corrientes de la lírica barroca española del siglo XVII, centrada en la agudeza del pensamiento.
**Expected_Success:** 0.88

### Enunciado
¿Cuál es el autor más representativo y brillante de la corriente conceptista en España?
...
## Question 2 [D3-D4]
**ID:** CO-LEN-8-2026-W08-conceptismo-001-MASTERY-bundle-v2
**Bloom:** Understand
**ICFES:** Competencia Lectora (Literal)
**Contexto:** Baltasar Gracián definió el "concepto" como un acto del entendimiento que expresa la correspondencia que se halla entre los objetos.
...
### Explicacion Pedagogica
El Conceptismo valora la inteligencia y el ingenio del lector, desafiándolo a encontrar relaciones inesperadas entre palabras y conceptos.

---

## Question 3 [D3-D4]
**ID:** CO-LEN-8-2026-W08-conceptismo-001-MASTERY-bundle-v3
**Bloom:** Remember
**ICFES:** Competencia Lectora (Literal)
**Contexto:** Los escritores conceptistas utilizaban juegos de palabras basados en el significado para sorprender al lector.
**Expected_Success:** 0.82

### Enunciado
¿Cómo se denomina el recurso literario que consiste en usar palabras que suenan igual o parecido pero tienen significados distintos, muy común en Quevedo?

### Opciones
- [ ] A) Hipérbaton <!-- feedback: Es la alteración del orden de la frase, más común en Góngora. -->
- [ ] B) Metáfora <!-- feedback: Es una comparación implícita basada en la analogía. -->
- [x] C) Calambur o equívoco <!-- feedback: El juego con el doble sentido de las palabras es una herramienta esencial del ingenio conceptista. -->
- [ ] D) Epíteto <!-- feedback: Es un adjetivo calificativo que resalta una cualidad inherente. -->

### Explicacion Pedagogica
El juego de palabras permite al autor conceptista crear múltiples capas de significado en un mismo verso, demostrando su agudeza verbal.

---

## Question 4 [D5-D6]
**ID:** CO-LEN-8-2026-W08-conceptismo-001-MASTERY-bundle-v4
**Bloom:** Understand
**ICFES:** Competencia Lectora (Inferencial)
**Contexto:** El Conceptismo se asocia a menudo con la brevedad y la concisión. Se dice que "lo bueno, si breve, dos veces bueno".
...
### Explicacion Pedagogica
La economía de lenguaje en el Conceptismo obliga al lector a participar activamente, "desempaquetando" los múltiples sentidos de cada frase.

---

## Question 5 [D5-D6]
**ID:** CO-LEN-8-2026-W08-conceptismo-001-MASTERY-bundle-v5
**Bloom:** Apply
**ICFES:** Competencia Lectora (Inferencial)
**Contexto:** La dilogía es un recurso que consiste en usar una palabra con dos significados distintos al mismo tiempo.
**Expected_Success:** 0.70

### Enunciado
Si Quevedo dice de un hombre muy pobre que "no tiene ni cama ni cara", jugando con que "cara" significa rostro y también alto precio, ¿qué está logrando con este recurso?
...
## Question 6 [D5-D6]
**ID:** CO-LEN-8-2026-W08-conceptismo-001-MASTERY-bundle-v6
**Bloom:** Analyze
**ICFES:** Competencia Lectora (Inferencial)
**Contexto:** Quevedo escribió tanto poesía metafísica profunda como sátiras burlonas muy crueles.
**Expected_Success:** 0.65

### Enunciado
¿Qué elemento común une la poesía donde Quevedo reflexiona sobre la muerte y sus poemas donde se burla de un enemigo?
...
## Question 7 [D7-D8]
**ID:** CO-LEN-8-2026-W08-conceptismo-001-MASTERY-bundle-v7
**Bloom:** Analyze
**ICFES:** Competencia Lectora (Crítica)
**Contexto:** En el conceptismo se utiliza mucho la antítesis y la paradoja para mostrar los conflictos internos del alma.
**Expected_Success:** 0.60

### Enunciado
En el famoso verso "Ayer se fue; mañana no ha llegado; hoy se está yendo sin parar un punto", ¿qué concepto filosófico está expresando Quevedo?
...
### Explicacion Pedagogica
La reflexión sobre el tiempo es uno de los temas cumbres del conceptismo, expresando la conciencia barroca de la muerte como algo que ocurre en cada instante de la vida.

---

## Question 8 [D7-D8]
**ID:** CO-LEN-8-2026-W08-conceptismo-001-MASTERY-bundle-v8
**Bloom:** Analyze
**ICFES:** Competencia Lectora (Crítica)
**Contexto:** Los conceptistas criticaban a los culteranos por su "oscuridad", mientras que los culteranos criticaban a los conceptistas por su lenguaje "seco".
**Expected_Success:** 0.58

### Enunciado
¿Cuál es la diferencia fundamental entre la "oscuridad" de Góngora y la "oscuridad" de Quevedo?
...
## Question 9 [D7-D8]
**ID:** CO-LEN-8-2026-W08-conceptismo-001-MASTERY-bundle-v9
**Bloom:** Analyze
**ICFES:** Competencia Lectora (Inferencial)
**Contexto:** Baltasar Gracián llevó el conceptismo a la prosa en obras como "El Criticón" y "El Oráculo Manual".
**Expected_Success:** 0.52

### Enunciado
¿Qué objetivo perseguía Gracián al escribir sus tratados de prudencia y sabiduría de forma tan densa y llena de aforismos?
...
## Question 10 [D9-D10]
**ID:** CO-LEN-8-2026-W08-conceptismo-001-MASTERY-bundle-v10
**Bloom:** Evaluate
**ICFES:** Competencia Lectora (Crítica)
**Contexto:** Quevedo utiliza a menudo la cosificación de las personas en sus sátiras (convertir a personas en objetos).
...
### Explicacion Pedagogica
La técnica de la cosificación o animalización en la sátira conceptista sirve para subrayar el desengaño barroco ante la fealdad y el paso del tiempo.

---

## Question 11 [D9-D10]
**ID:** CO-LEN-8-2026-W08-conceptismo-001-MASTERY-bundle-v11
**Bloom:** Evaluate
**ICFES:** Competencia Lectora (Crítica)
**Contexto:** El soneto "Cerrar podrá mis ojos la postrera..." es considerado uno de los mejores poemas de amor de la lengua española.
...
### Explicacion Pedagogica
Este poema representa la síntesis conceptista entre la crudeza de la muerte y la altura del sentimiento humano, logrando una imagen de gran poder emocional.

---

## Question 12 [D9-D10]
**ID:** CO-LEN-8-2026-W08-conceptismo-001-MASTERY-bundle-v12
**Bloom:** Analyze
**ICFES:** Competencia Lectora (Crítica)
**Contexto:** El Conceptismo es fundamental para entender el origen de la modernidad literaria en España por su uso irónico y autorreferencial del lenguaje.
**Expected_Success:** 0.38

### Enunciado
¿Por qué se considera que el Conceptismo de Quevedo es un precursor del humor negro y de la ironía moderna?
...
Este bundle sobre el Conceptismo profundiza en la estética de Francisco de Quevedo y Baltasar Gracián. Se analizan recursos como la dilogía, la hipérbole y la paradoja, destacando la densidad del pensamiento y la visión desengañada de la realidad propia del Barroco español.
