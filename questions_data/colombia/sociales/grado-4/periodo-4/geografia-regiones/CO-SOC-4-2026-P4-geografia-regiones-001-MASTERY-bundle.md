...
- [ ] D) Océano Antártico y Océano Pacífico <!-- feedback: Incorrect. El Antártico rodea el Polo Sur; Colombia no tiene costa en aguas tan frías del sur. -->

### Explicación Pedagógica
Se evalúa la ubicación astronómica y geográfica de Colombia. La respuesta correcta identifica la característica de país biocéanico. Los errores comunes provienen de desconocer la ubicación de los grandes océanos del mundo en relación con el continente americano.
...
- [ ] D) Región Insular <!-- feedback: Incorrect. La región insular corresponde a las islas como San Andrés y Gorgona, fuera del territorio continental. -->

### Explicación Pedagógica
Se evalúa el conocimiento sobre la división regional del territorio colombiano. La respuesta correcta identifica la Región Andina por sus rasgos físicos. Un error frecuente es confundir la ubicación de las regiones en el mapa nacional.
...
- [ ] D) El efecto invernadero <!-- feedback: Incorrect. Este es un fenómeno global de calentamiento, no el sistema local de clasificación de climas por altitud. -->

### Explicación Pedagógica
Se evalúa la comprensión de los factores climáticos del país. La respuesta correcta identifica el concepto de pisos térmicos. El error típico es creer que tenemos estaciones climáticas como en otros países alejados de la línea del ecuador.
...
- [ ] D) La minería de esmeraldas. <!-- feedback: Incorrect. Las esmeraldas se encuentran principalmente en las montañas de Boyacá y Cundinamarca, en la región Andina. -->

### Explicación Pedagógica
Se evalúa la asociación entre las características físicas de una región y sus actividades productivas. La respuesta correcta destaca la ganadería llanera. Los errores comunes provienen de confundir productos típicos de diferentes regiones.
...
- [ ] D) No construyen casas, viven dentro de las ballenas. <!-- feedback: Incorrect. Es una idea de fantasía; las personas construyen viviendas adaptadas a su entorno selvático y húmedo. -->

### Explicación Pedagógica
Se evalúa la comprensión de la adaptación humana al medio ambiente regional. La respuesta correcta identifica el uso de palafitos. Los errores reflejan una falta de conocimiento sobre la arquitectura tradicional de las comunidades afrocolombianas.
...
- [ ] D) El río Bogotá <!-- feedback: Incorrect. Es un río importante para la capital, pero es pequeño en comparación con el Magdalena y no atraviesa todo el país. -->

### Explicación Pedagógica
Se evalúa el conocimiento de los principales rasgos hidrográficos nacionales. La respuesta correcta identifica al río Magdalena. Los estudiantes suelen confundir los ríos locales de sus ciudades con los grandes ríos nacionales.
...
- [ ] D) El cerro de Monserrate <!-- feedback: Incorrect. Es un cerro famoso de Bogotá, ubicado a más de 2.600 metros de altura pero muy lejos del mar Caribe. -->

### Explicación Pedagógica
Se evalúa la identificación de accidentes geográficos excepcionales. La respuesta correcta reconoce la Sierra Nevada de Santa Marta. Los errores provienen de confundir los diferentes picos nevados y montañas famosas de Colombia.
...
- [ ] D) Las Islas Canarias <!-- feedback: Incorrect. Estas islas se encuentran en el Océano Atlántico frente a África y pertenecen a España. -->

### Explicación Pedagógica
Se evalúa el conocimiento sobre la soberanía y geografía insular. La respuesta correcta identifica el archipiélago de San Andrés. Los errores reflejan confusión entre islas famosas del mundo y las que pertenecen al territorio colombiano.
...
- [ ] D) El turismo responsable y ecológico. <!-- feedback: Incorrect. El turismo bien manejado puede ayudar a conservar la selva al dar recursos a las comunidades para protegerla. -->

### Explicación Pedagógica
Se evalúa la identificación de problemáticas ambientales contemporáneas de gran escala. La respuesta correcta identifica la deforestación. Los errores reflejan una falta de conciencia sobre las amenazas reales a la biodiversidad nacional.
...
- [ ] D) Porque en las otras regiones no hay oxígeno para respirar. <!-- feedback: Incorrect. En todas las regiones de Colombia hay aire y oxígeno suficiente; los humanos viven en todas ellas. -->

### Explicación Pedagógica
Se evalúa la capacidad de analizar la relación entre geografía física y asentamientos humanos. La respuesta correcta destaca las ventajas climáticas y agrícolas de los Andes. Los errores suelen basarse en explicaciones sin fundamento biológico o técnico.

### Explicación Pedagógica Final
Este bundle de Ciencias Sociales para el cuarto periodo de cuarto grado se centra en la geografía física y humana de Colombia. Los temas evaluados incluyen la posición biocéanica del país, las características de las 6 regiones naturales (Andina, Caribe, Pacífica, Orinoquía, Amazonía e Insular), el sistema de pisos térmicos, la importancia de los grandes ríos y las problemáticas ambientales actuales. El objetivo es que el estudiante reconozca la inmensa diversidad de paisajes y culturas de Colombia, comprendiendo cómo el medio físico influye en la vida, las costumbres y la economía de las personas en cada rincón del territorio nacional.
