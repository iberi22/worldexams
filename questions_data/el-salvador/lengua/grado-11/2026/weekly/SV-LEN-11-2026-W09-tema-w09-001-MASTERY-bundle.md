---
id: "SV-LEN-11-2026-W09-tema-w09-001-MASTERY-bundle"
country: "el-salvador"
grado: 11
asignatura: "lengua"
tema: "tema-w09"
...
# MASTERY Bundle — Lengua: Gramática del español: la oración simple y sus constituyentes (W09)
...
Este concepto gramatical define de manera precisa y rigurosa el funcionamiento de Sujeto gramatical dentro de la oración simple.
...
### Enunciado
Se propone el análisis del siguiente elemento gramatical: el sintagma verbal que detalla la acción, el proceso o el estado que se le atribuye al sujeto de la oración. ¿Qué función o estructura sintáctica específica se está definiendo?

### Opciones
- [x] A) La definición de Predicado oracional.
  <!-- feedback: ¡Correcto! Corresponde a Predicado oracional de la gramática oracional castellana. -->
- [ ] B) La métrica del romance tradicional castellano.
  <!-- feedback: Incorrecto. Se analiza gramática del español actual, no métrica de poemas del romance medieval. -->
- [ ] C) La manipulación masiva de propaganda digital.
  <!-- feedback: Incorrecto. No se analiza la comunicación de masas, sino los sintagmas de la oración. -->
...
### Explicación Pedagógica
Este concepto gramatical define de manera precisa y rigurosa el funcionamiento de Predicado oracional dentro de la oración simple.
...
### Explicación Pedagógica
Este concepto gramatical define de manera precisa y rigurosa el funcionamiento de Modificador directo e indirecto dentro de la oración simple.
...
### Explicación Pedagógica
Este concepto gramatical define de manera precisa y rigurosa el funcionamiento de Complemento Directo (CD) dentro de la oración simple.
...
### Enunciado
Se propone el análisis del siguiente elemento gramatical: el beneficiario o perjudicado por la acción verbal, sustituible por los pronombres personales átonos le o les. ¿Qué función o estructura sintáctica específica se está definiendo?

### Opciones
- [x] A) La definición de Complemento Indirecto (CI).
  <!-- feedback: ¡Correcto! Corresponde a Complemento Indirecto (CI) de la gramática oracional castellana. -->
- [ ] B) La métrica del romance tradicional castellano.
  <!-- feedback: Incorrecto. Se analiza gramática del español actual, no métrica de poemas del romance medieval. -->
- [ ] C) La manipulación masiva de propaganda digital.
  <!-- feedback: Incorrecto. No se analiza la comunicación de masas, sino los sintagmas de la oración. -->
...
### Explicación Pedagógica
Este concepto gramatical define de manera precisa y rigurosa el funcionamiento de Complemento Indirecto (CI) dentro de la oración simple.
...
### Enunciado
Se propone el análisis del siguiente elemento gramatical: el modificador del verbo que sitúa temporalmente la acción respondiendo de forma exacta a la pregunta ¿cuándo? ¿Qué función o estructura sintáctica específica se está definiendo?

### Opciones
- [x] A) La definición de Complemento Circunstancial de tiempo.
  <!-- feedback: ¡Correcto! Corresponde a Complemento Circunstancial de tiempo de la gramática oracional castellana. -->
- [ ] B) La métrica del romance tradicional castellano.
  <!-- feedback: Incorrecto. Se analiza gramática del español actual, no métrica de poemas del romance medieval. -->
- [ ] C) La manipulación masiva de propaganda digital.
  <!-- feedback: Incorrecto. No se analiza la comunicación de masas, sino los sintagmas de la oración. -->
...
### Explicación Pedagógica
Este concepto gramatical define de manera precisa y rigurosa el funcionamiento de Complemento Circunstancial de tiempo dentro de la oración simple.
...
### Explicación Pedagógica
Este concepto gramatical define de manera precisa y rigurosa el funcionamiento de Complemento Circunstancial de lugar dentro de la oración simple.
...
### Explicación Pedagógica
Este concepto gramatical define de manera precisa y rigurosa el funcionamiento de Predicado nominal copulativo dentro de la oración simple.
...
### Explicación Pedagógica
Este concepto gramatical define de manera precisa y rigurosa el funcionamiento de Atributo nominal dentro de la oración simple.
...
### Explicación Pedagógica
Este concepto gramatical define de manera precisa y rigurosa el funcionamiento de Oraciones impersonales con haber dentro de la oración simple.
...
### Explicación Pedagógica
Este concepto gramatical define de manera precisa y rigurosa el funcionamiento de Oraciones meteorológicas dentro de la oración simple.
...
### Explicación Pedagógica
Este concepto gramatical define de manera precisa y rigurosa el funcionamiento de Complemento Agente en voz pasiva dentro de la oración simple.
...
### Explicación Pedagógica
Este concepto gramatical define de manera precisa y rigurosa el funcionamiento de Sujeto omitido o tácito dentro de la oración simple.
...
### Explicación Pedagógica
Este concepto gramatical define de manera precisa y rigurosa el funcionamiento de Pronombre 'se' de pasiva refleja dentro de la oración simple.
...
### Explicación Pedagógica
Este concepto gramatical define de manera precisa y rigurosa el funcionamiento de Regla de concordancia sintáctica dentro de la oración simple.
...
### Explicación Pedagógica
Este concepto gramatical define de manera precisa y rigurosa el funcionamiento de Complemento de Régimen Verbal dentro de la oración simple.
...
### Explicación Pedagógica
Este concepto gramatical define de manera precisa y rigurosa el funcionamiento de Complemento Predicativo del sujeto dentro de la oración simple.
...
### Explicación Pedagógica
Este concepto gramatical define de manera precisa y rigurosa el funcionamiento de Sintagma preposicional y nominal dentro de la oración simple.
...
### Explicación Pedagógica
Este concepto gramatical define de manera precisa y rigurosa el funcionamiento de Aposiciones en el sujeto dentro de la oración simple.
...
### Explicación Pedagógica
Este concepto gramatical define de manera precisa y rigurosa el funcionamiento de Concordancia con sujeto colectivo dentro de la oración simple.
