---
id: "SV-LEN-11-2026-W04-tema-w04-001-MASTERY-bundle"
country: "el-salvador"
grado: 11
asignatura: "lengua"
tema: "tema-w04"
...
# MASTERY Bundle — Lengua: Tipologías textuales: textos expositivos y argumentativos (W04)
...
La estructura, el propósito y los recursos lógicos del fragmento se corresponden de forma exacta con tesis argumentativa.
...
### Explicación Pedagógica
La estructura, el propósito y los recursos lógicos del fragmento se corresponden de forma exacta con exposición divulgativa.
...
### Explicación Pedagógica
La estructura, el propósito y los recursos lógicos del fragmento se corresponden de forma exacta con estructura argumentativa tripartita.
...
### Explicación Pedagógica
La estructura, el propósito y los recursos lógicos del fragmento se corresponden de forma exacta con argumento de autoridad.
...
### Explicación Pedagógica
La estructura, el propósito y los recursos lógicos del fragmento se corresponden de forma exacta con argumento por analogía.
...
### Enunciado
Examina el siguiente fragmento: Durante el debate escolar en Cojutepeque, un estudiante ataca la vestimenta y la edad de su oponente en lugar de rebatir sus ideas sobre el tráfico. ¿Qué recurso o elemento discursivo formal se está aplicando?

### Opciones
- [x] A) El uso de falacia ad hominem.
  <!-- feedback: ¡Correcto! Aplica falacia ad hominem porque se centra en descalificar personalmente al oponente con insultos o burlas en lugar de refutar lógicamente sus argumentos. -->
- [ ] B) Una descripción prosopográfica de un personaje ficticio.
  <!-- feedback: Incorrecto. No se describen rasgos físicos, se analiza la estructura de un texto. -->
- [ ] C) La función fática de apertura del canal de voz.
  <!-- feedback: Incorrecto. No se trata de un canal acústico, sino del análisis de un argumento. -->
...
### Explicación Pedagógica
La estructura, el propósito y los recursos lógicos del fragmento se corresponden de forma exacta con falacia ad hominem.
...
### Explicación Pedagógica
La estructura, el propósito y los recursos lógicos del fragmento se corresponden de forma exacta con falacia de generalización apresurada.
...
### Explicación Pedagógica
La estructura, el propósito y los recursos lógicos del fragmento se corresponden de forma exacta con estructura expositiva inductiva.
...
### Enunciado
Examina el siguiente fragmento: Un texto escolar define primero las leyes físicas de la gravedad y luego detalla tres ejemplos de caída de objetos observados en el aula. ¿Qué recurso o elemento discursivo formal se está aplicando?

### Opciones
- [x] A) El uso de estructura expositiva deductiva.
  <!-- feedback: ¡Correcto! Aplica estructura expositiva deductiva porque se centra en partir de una ley general para explicar casos particulares específicos en el desarrollo. -->
- [ ] B) Una descripción prosopográfica de un personaje ficticio.
  <!-- feedback: Incorrecto. No se describen rasgos físicos, se analiza la estructura de un texto. -->
- [ ] C) La función fática de apertura del canal de voz.
  <!-- feedback: Incorrecto. No se trata de un canal acústico, sino del análisis de un argumento. -->
...
### Explicación Pedagógica
La estructura, el propósito y los recursos lógicos del fragmento se corresponden de forma exacta con estructura expositiva deductiva.
...
### Explicación Pedagógica
La estructura, el propósito y los recursos lógicos del fragmento se corresponden de forma exacta con contraargumentación.
...
### Enunciado
Examina el siguiente fragmento: Un manual de geología del Ministerio de Medio Ambiente detalla con complejos tecnicismos químicos la composición de los suelos volcánicos. ¿Qué recurso o elemento discursivo formal se está aplicando?

### Opciones
- [x] A) El uso de exposición especializada.
  <!-- feedback: ¡Correcto! Aplica exposición especializada porque se centra en explicar conceptos de alta complejidad científica dirigidos exclusivamente a un público experto en la materia. -->
- [ ] B) Una descripción prosopográfica de un personaje ficticio.
  <!-- feedback: Incorrecto. No se describen rasgos físicos, se analiza la estructura de un texto. -->
- [ ] C) La función fática de apertura del canal de voz.
  <!-- feedback: Incorrecto. No se trata de un canal acústico, sino del análisis de un argumento. -->
...
### Explicación Pedagógica
La estructura, el propósito y los recursos lógicos del fragmento se corresponden de forma exacta con exposición especializada.
...
### Explicación Pedagógica
La estructura, el propósito y los recursos lógicos del fragmento se corresponden de forma exacta con ensayo de opinión.
...
### Explicación Pedagógica
La estructura, el propósito y los recursos lógicos del fragmento se corresponden de forma exacta con argumento basado en hechos.
...
### Explicación Pedagógica
La estructura, el propósito y los recursos lógicos del fragmento se corresponden de forma exacta con argumento de causa-efecto.
...
### Explicación Pedagógica
La estructura, el propósito y los recursos lógicos del fragmento se corresponden de forma exacta con falacia ad populum.
...
### Explicación Pedagógica
La estructura, el propósito y los recursos lógicos del fragmento se corresponden de forma exacta con uso de la tercera persona.
...
### Enunciado
Examina el siguiente fragmento: El primer párrafo de una monografía escolar presenta el tema de los movimientos tectónicos y justifica su importancia de estudio social. ¿Qué recurso o elemento discursivo formal se está aplicando?

### Opciones
- [x] A) El uso de introducción expositiva.
  <!-- feedback: ¡Correcto! Aplica introducción expositiva porque se centra en presentar de forma atractiva el tema, los objetivos generales y la importancia del escrito expositivo. -->
- [ ] B) Una descripción prosopográfica de un personaje ficticio.
  <!-- feedback: Incorrecto. No se describen rasgos físicos, se analiza la estructura de un texto. -->
- [ ] C) La función fática de apertura del canal de voz.
  <!-- feedback: Incorrecto. No se trata de un canal acústico, sino del análisis de un argumento. -->
...
### Explicación Pedagógica
La estructura, el propósito y los recursos lógicos del fragmento se corresponden de forma exacta con introducción expositiva.
...
### Explicación Pedagógica
La estructura, el propósito y los recursos lógicos del fragmento se corresponden de forma exacta con réplica en foro oral.
...
### Explicación Pedagógica
La estructura, el propósito y los recursos lógicos del fragmento se corresponden de forma exacta con uso de tecnicismos científicos.
...
### Explicación Pedagógica
La estructura, el propósito y los recursos lógicos del fragmento se corresponden de forma exacta con conclusión argumentativa.
