---
id: "UY-MAT-11-2026-W08-tema-w08-001-MASTERY-bundle"
country: "uruguay"
grado: 11
...
**Contexto:** Una docente de Montevideo repasa el plano cartesiano con sexto año.
...
**Contexto:** En un liceo de Salto se memoriza la fórmula de distancia entre puntos.
...
**Contexto:** Un estudiante de Colonia ubica puntos en los cuadrantes.
...
**Contexto:** Una estudiante de Maldonado calcula el punto medio de un segmento.

### Enunciado
¿Cuál es el punto medio del segmento con extremos $A(2, 4)$ y $B(6, 10)$?
...
**Contexto:** Un técnico de Canelones calcula la distancia entre dos localidades en un mapa cuadriculado.
...
**Contexto:** Un docente de Tacuarembó analiza la pendiente de una recta entre dos puntos.

### Enunciado
¿Cuál es la pendiente de la recta que pasa por $(0, -1)$ y $(3, 5)$?
...
**Contexto:** Una estudiante de Rivera identifica la ecuación de una recta horizontal.

### Enunciado
¿Cuál es la ecuación de la recta horizontal que pasa por el punto $(5, -3)$?

### Opciones
- [ ] A) $x = 5$ <!-- feedback: Incorrecto. Esa es la recta vertical que pasa por el punto. -->
- [x] B) $y = -3$ <!-- feedback: ¡Correcto! Toda recta horizontal tiene ordenada constante. -->
- [ ] C) $y = 5x - 3$ <!-- feedback: Incorrecto. Esa recta tiene pendiente 5, no es horizontal. -->
- [ ] D) $x + y = 2$ <!-- feedback: Incorrecto. Es una recta oblicua, aunque el punto la verifique. -->
...
**Contexto:** Un arquitecto de Paysandú verifica si dos paredes son perpendiculares.
...
**Contexto:** Un ingeniero de Durazno halla la ecuación de una circunferencia centrada en el origen.

### Enunciado
¿Cuál es la ecuación de la circunferencia con centro en el origen y radio $4$?

### Opciones
- [ ] A) $x^2 + y^2 = 4$ <!-- feedback: Incorrecto. El lado derecho es el radio al cuadrado: 16. -->
- [x] B) $x^2 + y^2 = 16$ <!-- feedback: ¡Correcto! Con centro $(0,0)$, la ecuación es $x^2 + y^2 = r^2 = 16$. -->
- [ ] C) $(x - 4)^2 + (y - 4)^2 = 16$ <!-- feedback: Incorrecto. Esa circunferencia tiene centro $(4, 4)$. -->
- [ ] D) $x + y = 4$ <!-- feedback: Incorrecto. Esa es una recta, no una circunferencia. -->
...
**Contexto:** Una docente de Florida plantea hallar dónde una recta corta al eje $x$.

### Enunciado
¿En qué punto la recta $y = 2x - 6$ corta al eje de abscisas?
...
**Contexto:** Un estudiante de Rocha clasifica un triángulo por las longitudes de sus lados.
...
**Contexto:** Una docente de Melo pregunta por la condición de paralelismo.
...
**Contexto:** Un estudiante de Minas analiza la posición de un punto respecto a una circunferencia.

### Enunciado
Respecto de la circunferencia $x^2 + y^2 = 25$, el punto $(3, 5)$ se encuentra:
...
**Contexto:** Un urbanista de San José diseña una rotonda con centro desplazado del origen.

### Enunciado
¿Cuál es el centro y el radio de la circunferencia $(x - 2)^2 + (y + 1)^2 = 9$?
...
**Contexto:** Una estudiante de Treinta y Tres halla la recta paralela a otra por un punto dado.

### Enunciado
¿Cuál es la ecuación de la recta paralela a $y = 3x + 1$ que pasa por $(2, 4)$?

### Opciones
- [ ] A) $y = 3x + 4$ <!-- feedback: Incorrecto. Usaste la ordenada del punto como término independiente sin ajustar. -->
- [x] B) $y = 3x - 2$ <!-- feedback: ¡Correcto! Misma pendiente 3; $4 = 3(2) + b$ da $b = -2$. -->
- [ ] C) $y = -\frac{1}{3}x + 4$ <!-- feedback: Incorrecto. Esa pendiente corresponde a la perpendicular, no a la paralela. -->
- [ ] D) $y = 3x + 1$ <!-- feedback: Incorrecto. Es la recta original; el punto $(2,4)$ no la verifica: $3(2)+1 = 7$. -->
...
**Contexto:** Un docente de Maldonado plantea verificar si tres puntos están alineados.
...
**Contexto:** En un examen en Paysandú se evalúa la distancia de un punto a una recta vertical.

### Enunciado
¿Cuál es la distancia del punto $(7, 2)$ a la recta $x = 3$?
...
**Contexto:** Una examinadora de Durazno presenta un cuadrilátero con vértices $A(0,0)$, $B(6,0)$, $C(6,4)$ y $D(0,4)$.

### Enunciado
¿Qué figura es el cuadrilátero $ABCD$ y cuál es su área?
...
**Contexto:** Un diseñador de Montevideo necesita el área del triángulo con vértices $A(0,0)$, $B(6,0)$ y $C(2,4)$.
...
**Contexto:** Un urbanista de Colonia estudia si una calle recta toca una plaza circular: la plaza es $x^2 + y^2 = 16$ y la calle es $y = x + 6$.
