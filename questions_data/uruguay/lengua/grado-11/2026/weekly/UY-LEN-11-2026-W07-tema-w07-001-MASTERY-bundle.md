---
id: "UY-LEN-11-2026-W07-tema-w07-001-MASTERY-bundle"
country: "uruguay"
grado: 11
asignatura: "lengua"
tema: "tema-w07"
...
### Enunciado
¿Qué elemento de la estructura del texto argumentativo representa la frase anterior?
...
### Enunciado
¿Qué tipo específico de argumento se está desplegando en la intervención anterior?

### Opciones
- [ ] A) Argumento de analogía biológica.
  <!-- feedback: Incorrecto. No se hace una comparación entre dos realidades distintas (como el aula y una esponja biológica). -->
- [x] B) Argumento de autoridad.
  <!-- feedback: ¡Correcto! El argumento de autoridad se fundamenta en citar, referenciar o ampararse en el prestigio, estudios o investigaciones de una institución u organismo reconocido (en este caso, Unicef) para validar la tesis propia. -->
- [ ] C) Argumento de causa-efecto climatológico de Salto.
  <!-- feedback: Incorrecto. No se vincula el clima geográfico con la conducta de los estudiantes de Salto. -->
- [ ] D) Una caricatura deformante de los docentes del liceo.
  <!-- feedback: Incorrecto. Se expone un argumento serio institucional formal, exento de sátiras humorísticas. -->
...
- [ ] D) Una elipsis de datos que rompe la coherencia sintáctica de la editorial.
  <!-- feedback: Incorrecto. Es un conector de alta cohesión sintáctica y lógica que amarra con rigor el sentido de la editorial periodística. -->
...
### Enunciado
¿Qué tipo de razonamiento argumentativo se ha empleado en este pasaje?
...
### Enunciado
Identificá qué recurso argumentativo complejo destaca en el pasaje anterior para refutar la postura contraria.

### Opciones
- [ ] A) El uso de la primera persona del singular para plasmar las dudas del columnista montevideano.
...
- [ ] D) Una caricatura satírica de los vecinos ganaderos de la frontera.
  <!-- feedback: Incorrecto. Es una intervención seria, alarmante y ecologista de salud, exenta de sátiras humorísticas de vecinos. -->
...
### Enunciado
¿Qué recursos lingüísticos y qué tipos de argumentos resultan más adecuados para lograr este objetivo pragmático persuasivo?

### Opciones
- [ ] A) Uso de un vocabulario de misterio, metáforas sobre cementerios abandonados de Paysandú, y poemas líricos de invierno.
  <!-- feedback: Incorrecto. Estos recursos góticos literarios son ajenos a la persuasión vecinal ecológica civil; ahuyentarían al lector sin motivar el compostaje municipal. -->
- [x] B) Uso de un registro formal pero cercano (voseo respetuoso en apelaciones controladas), argumentos de causa-efecto (reducir la basura del vertedero e incrementar la fertilidad del suelo local) y argumentos de autoridad citando directivas de salud ambiental de Paysandú.
  <!-- feedback: ¡Correcto! La carta exige claridad y persuasión (diafasia formal-cercana de opinión). Vincular la acción (separar basura) con beneficios ambientales constatables locales (causa-efecto) y ampararse en el aval técnico de salud (autoridad) optimiza de manera drástica el impacto persuasivo sobre los vecinos. -->
- [ ] C) Un memorándum puramente técnico que obligue al pago de multas impositivas de forma administrativa y judicial.
  <!-- feedback: Incorrecto. Las multas administrativas no forman parte de una carta de opinión ciudadana de persuasión voluntaria ecológica. -->
- [ ] D) La descripción científica de la estructura mineral del fósforo con nombres taxonómicos en latín.
  <!-- feedback: Incorrecto. El exceso de tecnicismos estériles aburriría al vecino común de Paysandú; se requiere un lenguaje claro, persuasivo y de beneficio directo municipal. -->
...
### Enunciado
¿Qué error o falacia de razonamiento argumentativo se comete de forma flagrante en la intervención anterior?

### Opciones
- [ ] A) Un argumento de analogía con las dunas de Cabo Polonio.
  <!-- feedback: Incorrecto. No se hace una comparación entre los gurises y las dunas costeras de Cabo Polonio. -->
- [x] B) Una falacia de generalización apresurada (o muestra insuficiente), al extraer una ley general para todos los gurises uruguayos a partir de solo tres casos aislados anecdóticos en una parada de ómnibus.
  <!-- feedback: ¡Correcto! La generalización apresurada es una falacia argumentativa común. Consiste en formular una regla o conclusión general a partir de una muestra ínfima o anecdótica de casos que no representa de forma estadística a la población de estudio. -->
- [ ] C) Un argumento de causa-efecto climatológico que explica la apatía juvenil por el calor del verano montevideano.
  <!-- feedback: Incorrecto. El orador no vincula la climatología con la apatía; asienta su regla en las declaraciones de la parada de ómnibus. -->
- [ ] D) Una definición taxonómica científica de la palabra 'videojuego'.
  <!-- feedback: Incorrecto. No se explica el origen etimológico del término; se razona de forma falaz sobre la conducta de la juventud. -->
...
- [ ] D) Una elipsis de verbos de acción que destruye la coherencia de la estación ferroviaria.
  <!-- feedback: Incorrecto. El conector amarra e hila con gran precisión y finura sintáctica las dos ideas contrastantes de la editorial de prensa. -->
...
### Enunciado
¿Qué tipo de trampa argumentativa o falacia informal se comete de forma flagrante en la afirmación del participante?

### Opciones
- [ ] A) Un argumento de causa-efecto basado en datos químicos de la atmósfera de Tala.
  <!-- feedback: Incorrecto. No se citan datos químicos o atmosféricos; se apela a la opinión general de forma falaz. -->
- [x] B) Una falacia ad populum (apelación a la opinión común o al 'todo el mundo sabe'), al dar por sentada la verdad de una afirmación polémica sin aportar pruebas científicas, asomándose al prejuicio masivo de la sociedad.
  <!-- feedback: ¡Correcto! La falacia ad populum sostiene la verdad de una premisa escudándose únicamente en que es compartida por la mayoría o el sentido común masivo ('todo el mundo sabe'), esquivando la necesidad de argumentar con datos o lógica real contrastable. -->
- [ ] C) Un argumento de analogía con las dunas costeras del Cabo Polonio.
  <!-- feedback: Incorrecto. No se hace una analogía con Cabo Polonio; se debate sobre las ciclovías y bicicletas urbanas de la rambla. -->
- [ ] D) Una definición etimológica de origen latín de la palabra 'bicicleta'.
  <!-- feedback: Incorrecto. No se analiza el origen filológico del vocablo; se formula una acusación falaz contra las bicicletas. -->
...
- [ ] D) La intervención es un mandato apelativo conativo que prohíbe el consumo de carne en todo el territorio nacional.
  <!-- feedback: Incorrecto. No hay prohibiciones impositivas o mandatos imperativos de conducta dietaria; se expone una técnica ganadera sostenible verídica. -->
...
- [ ] D) Argumento de analogía con los comedores escolares de Europa.
  <!-- feedback: Incorrecto. No se hace una comparación entre continentes o comedores extranjeros; se descalifica al militante de forma directa. -->
...
### Enunciado
Analizá la estructura argumentativa de la pieza. ¿Qué concesión e irrupción jerárquica de valores se produce en el discurso?
...
- [ ] D) La diferencia radica en que los contraejemplos solo se pueden formular empleando el voseo de Salto.
  <!-- feedback: Incorrecto. Ambos métodos se formulan respetando con rigor la norma culta formal escrita estándar de la asignatura Lengua de Secundaria. -->
...
### Enunciado
Analizá críticamente el razonamiento anterior. ¿Qué trampa lógica o falacia de encadenamiento causal se está cometiendo de manera flagrante?
...
### Enunciado
¿Qué estructura lógica explicativa y argumentativa organiza la refutación del columnista de Paysandú?
...
### Enunciado
Evaluá críticamente la estructura argumentativa, la escala de valores y la fuerza persuasiva de la editorial de prensa seria sobre la matriz de energía eólica del país.

### Opciones
- [ ] A) La editorial fracasa al defender la matriz de energía eólica debido a que utiliza términos científicos que lesionan de forma biológica la comprensión de Secundaria.
  <!-- feedback: Incorrecto. Se comprende con gran fluidez; la editorial asocia economía, soberanía energética nacional y política exterior de forma impecable de Secundaria. -->
- [x] B) La editorial realiza una refutación brillante al confrontar una escala de valores de corto plazo (el balance fiscal mensual de la matriz de energía eólica) frente a una escala de valores de largo plazo de soberanía nacional (blindaje industrial e independencia geopolítica energética), respaldando su tesis con el hecho contrastable de la exportación al Mercosur y logrando gran fuerza persuasiva racional de Secundaria.
  <!-- feedback: ¡Correcto! El editorial periodístico se estructura sobre la confrontación de dos lógicas: la financiera cortoplacista (criticada como 'ceguera histórica') y la de soberanía nacional de largo plazo (defendida como acierto histórico). Sostiene su postura evidenciando el éxito real contemporáneo de la exportación de energía eólica limpia al Mercosur, neutralizando las quejas iniciales con datos objetivos de Secundaria. -->
- [ ] C) La pieza es en verdad un poema lírico que canta con nostalgia la belleza de los parques eólicos de Tacuarembó de forma lírica.
  <!-- feedback: Incorrecto. Es un texto de prensa de opinión de gran formalidad argumentativa de ciencias sociales; no posee intencionalidades líricas de adorno literario. -->
- [ ] D) La editorial exige el pago de multas de tránsito de cometas de forma administrativa y judicial.
  <!-- feedback: Incorrecto. Las multas viales son ajenas al debate de soberanía energética industrial y política exterior del país. -->
...
### Enunciado
Evaluá críticamente el uso de los recursos lingüísticos y de persuasión en esta declaración estudiantil. ¿Qué trasgresiones lógicas o falacias de desmesura emotiva se cometen para alarmar al receptor?
...
### Enunciado
¿Qué objeción teórica fundamental de la retórica y del análisis de la tipología textual argumentativa se le puede oponer de forma científica a esta directiva de redacción?
...
### Enunciado
Evaluá críticamente el razonamiento del estudiante de Bachillerato. ¿Qué debilidades o falacias de analogía transcultural e insolvencia causal desarticulan la validez de su tesis sobre los exámenes de Secundaria?
...
### Explicacion Pedagogica
La argumentación sólida de Secundaria veta el traslado mecánico de soluciones de un país a otro de forma descontextualizada. El análisis de políticas públicas de Secundaria exige ponderar la viabilidad local de las propuestas de Secundaria con datos socioculturales locales del país de forma lógica y verosímil, desarmando el voluntarismo mágico de Secundaria con rigor fáctico de Secundaria.
