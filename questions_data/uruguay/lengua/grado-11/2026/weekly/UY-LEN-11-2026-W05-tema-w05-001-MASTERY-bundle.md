---
id: "UY-LEN-11-2026-W05-tema-w05-001-MASTERY-bundle"
country: "uruguay"
grado: 11
asignatura: "lengua"
tema: "tema-w05"
...
### Enunciado
¿Qué tipo específico de descripción de personas se está ejecutando en el fragmento anterior?

### Opciones
- [ ] A) Etopeya.
  <!-- feedback: Incorrecto. La etopeya describe los rasgos psicológicos, morales o de personalidad de un personaje, no su fisonomía exterior física. -->
- [x] B) Prosopografía.
  <!-- feedback: ¡Correcto! La prosopografía es la descripción centrada exclusivamente en los rasgos físicos externos, fisonomía, vestimenta y aspecto corporal de un personaje. -->
- [ ] C) Topografía.
  <!-- feedback: Incorrecto. La topografía es la descripción de paisajes, lugares o terrenos geográficos, no de personas. -->
- [ ] D) Retrato laudatorio divino.
  <!-- feedback: Incorrecto. Un retrato laudatorio idealiza de forma solemne; aquí se describen rasgos realistas crudos de fisonomía común. -->
...
### Enunciado
¿Cómo se clasifica técnicamente esta descripción centrada en las virtudes morales e intelectuales del personaje?
...
### Enunciado
¿Qué tipo de descripción se realiza en este fragmento y qué sentido sensorial predomina?

### Opciones
- [ ] A) Etopeya psicológica, con predominio del sentido del gusto.
  <!-- feedback: Incorrecto. No se describen sentimientos morales de personas ni sabores gastronómicos. -->
- [x] B) Topografía, con predominio del canal auditivo y visual.
  <!-- feedback: ¡Correcto! Es una topografía porque describe minuciosamente un espacio geográfico y paisaje real (Cabo Polonio). Predominan las sensaciones visuales ('dunas', 'casitas de colores', 'roca') y auditivas ('viento soplaba', 'océano embravecido que rugía'). -->
- [ ] C) Prosopografía costera, centrada en el tacto gélido.
  <!-- feedback: Incorrecto. La prosopografía es de personas; el texto pinta un relieve de naturaleza geográfica. -->
- [ ] D) Retrato de un marinero náufrago de Rocha.
  <!-- feedback: Incorrecto. No hay personajes humanos descritos en este pasaje; el protagonista es el relieve costero de Cabo Polonio. -->
...
### Enunciado
¿Cuáles son los recursos lingüísticos y morfosintácticos predominantes que tipifican este fragmento como descriptivo?

### Opciones
- [ ] A) El uso exclusivo de verbos en pretérito perfecto simple de acción rápida.
  <!-- feedback: Incorrecto. El pretérito perfecto simple dinamiza la acción en el texto narrativo, mientras que la descripción se apoya en estados y cualidades. -->
- [x] B) La acumulación de adjetivos calificativos ('empedrada', 'estrecha', 'húmuda', 'silenciosa', 'colonial'), el verbo copulativo en pretérito imperfecto ('era') y una comparación estilística ('como un pasadizo...').
  <!-- feedback: ¡Correcto! El texto descriptivo descansa en la adjetivación para atribuir cualidades al sustantivo, utiliza verbos de estado o proceso en pretérito imperfecto que suspenden el paso del tiempo narrativo, y recurre a símiles o comparaciones para aproximar la imagen al receptor. -->
- [ ] C) El predominio del diálogo directo mediante rayas de diálogo teatral.
  <!-- feedback: Incorrecto. Es un pasaje puramente descriptivo de paisaje; no hay personajes dialogando entre sí en la calle empedrada. -->
- [ ] D) La presencia de tecnicismos informáticos y matemáticos del Mercosur.
  <!-- feedback: Incorrecto. El vocabulario es literario, evocador, histórico e identitario de Colonia. -->
...
### Enunciado
¿Qué técnica descriptiva compleja se ha empleado en este retrato histórico?
...
### Enunciado
¿Por qué se sostiene que el pretérito imperfecto es el tiempo descriptivo por excelencia en los relatos?
...
### Enunciado
¿Qué selección de adjetivos, sustantivos y recursos estilísticos resulta más adecuada para lograr ese fin pragmático estético?
...
### Enunciado
¿Qué tipo específico de descripción deformante se está ejecutando en este fragmento literario?
...
- [ ] D) A la descripción de los órganos digestivos de las vacas de los campos norteños.
  <!-- feedback: Incorrecto. Eso es una descripción anatómica biológica médica interna de fauna ganadera. -->
...
- [ ] D) Una metáfora científica sobre la metalurgia del hierro oxidado.
  <!-- feedback: Incorrecto. Es un recurso poético literario de ambientación nostálgica, no una lección académica de química de metales. -->
...
### Enunciado
¿Cómo operan los adjetivos cromáticos y las asociaciones semánticas en este fragmento de descripción clínica y trágica?

### Opciones
- [x] A) Los adjetivos 'denso', 'palidez de cera', 'violáceas' e 'hundidos' construyen una isotopía semántica de enfermedad, muerte y descomposición corporal, reforzando de manera sensorial la inminencia del trágico desenlace gótico.
  <!-- feedback: ¡Correcto! La selección de los adjetivos cromáticos ('violáceas', 'cera', 'apagados') y de cualidad ('denso', 'hundidos') responde a un plan de ambientación tétrica. Asocian el cuerpo joven de Alicia con un cadáver ('palidez de cera'), anticipando sensorialmente su deceso. -->
- [ ] B) La adjetivación sugiere que la protagonista se está recuperando de manera enérgica y alegre de la desnutrición clínica.
  <!-- feedback: Incorrecto. Al contrario: la palidez de cera y las ojeras violáceas marcan el camino irreversible del desgaste físico biológico de Alicia. -->
- [ ] C) Los adjetivos son puramente humorísticos y parodian los manuales escolares de medicina general uruguayos.
  <!-- feedback: Incorrecto. El cuento es trágico, ominoso y serio; el tono quiroguiano de horror veta burlas infantiles o parodias médicas de folletín. -->
- [ ] D) Se utiliza una descripción exclusivamente etopeyica centrada en la maldad espiritual de la protagonista de la casa.
  <!-- feedback: Incorrecto. El texto detalla los estragos de la toxina en el aspecto físico visible de Alicia, representando un retrato patológico de prosopografía dolorosa. -->
...
### Enunciado
¿Qué recursos estilísticos y de concordancia gramatical caracterizan la atmósfera de este cuadro descriptivo local?

### Opciones
- [x] A) La metáfora del campo como un 'oleaje eterno de cuchillas' y la personificación de las siluetas de los coronillas ('quebraban la monotonía', 'estirando sus ramas'), sostenidos por una adjetivación de matiz rural y geográfico uruguayo.
  <!-- feedback: ¡Correcto! La metáfora asocia el relieve de cuchillas con un mar de tierra ('oleaje eterno'). Se personifica a los árboles ('coronillas solitarios' que 'quebran' y 'estiran' de forma humana). El vocabulario es genuinamente local ('cuchillas', 'penillanura', 'coronillas'). -->
- [ ] B) La ausencia de adjetivos calificativos para lograr un informe mineralógico árido neutro de Tacuarembó.
  <!-- feedback: Incorrecto. Hay abundantes adjetivos calificativos ('ondulado', 'eterno', 'solitarios', 'nudosas', 'plomizo', 'inminente') indispensables para la topografía lírica. -->
- [ ] C) La irrupción del diálogo dramático en portuñol entre los paisanos de la estancia de Tacuarembó.
  <!-- feedback: Incorrecto. El pasaje es un cuadro descriptivo estático de relieve e intemperie; no aloja diálogos directos de personajes en escena. -->
- [ ] D) Un desvío sintáctico vulgar que altera la concordancia entre los árboles y el cielo de forma caprichosa.
  <!-- feedback: Incorrecto. La concordancia sintáctica de género y número es impecable y respeta de forma estricta las normas de la lengua escrita. -->
...
### Enunciado
¿Cómo condiciona la intencionalidad comunicativa y el contexto pragmático los recursos del texto descriptivo en ambos casos?
...
### Enunciado
Analizá la función del espacio descriptivo en la reconstrucción de la memoria o la nostalgia en este pasaje literario.
...
### Enunciado
¿Qué papel cumple el principio de 'selección de detalles' o 'relevancia descriptiva' al redactar un retrato o una topografía en una obra narrativa literaria verosímil?
...
### Enunciado
Analizá críticamente este fragmento. ¿Qué marcas lingüísticas determinan de manera indudable que estamos ante una descripción de carácter técnico-expositivo en lugar de una descripción literaria de ceibos?

### Opciones
- [x] A) La presencia del nombre científico en latín entre paréntesis, la adjetivación denotativa, precisa y descriptiva física de la morfología del árbol ('tronco tortuoso', 'corteza suberosa', 'inflorescencia en racimos') y la neutralidad afectiva del emisor.
  <!-- feedback: ¡Correcto! Las marcas indudables de la descripción técnica son la nomenclatura taxonómica científica formal de prestigio, la precisión objetiva de los adjetivos denotativos anatómicos del ceibo y la completa ausencia de figuras retóricas connotativas o afectivas subjetivas de ceibos. -->
- [ ] B) El uso del voseo coloquial informal rioplatense para apelar de forma afectiva a la sensibilidad de los gurises del norte.
  <!-- feedback: Incorrecto. Un texto de botánica de ceibos veta los coloquialismos de voseo y apelativos para preservar la objetividad impersonal de la ciencia. -->
- [ ] C) La personificación lírica de las flores rojas que cantan bajo la lluvia de primavera de Uruguay.
  <!-- feedback: Incorrecto. El texto es de botánica denotativa; no atribuye conductas humanas líricas o musicales a los racimos de flores. -->
- [ ] D) El desorden gramatical de la sintaxis que impide asimilar las partes anatómicas de la planta.
  <!-- feedback: Incorrecto. La sintaxis del texto expositivo-botánico de ceibos es de un rigor estructural y claridad expositiva modélica. -->
...
### Enunciado
Evaluá críticamente la integración de la topografía del hogar con el retrato psicológico y físico de la protagonista Alicia. ¿Qué relación semiótica se establece entre el espacio de la casa y el personaje femenino?
...
- [ ] D) El texto es un instructivo de ingeniería civil militar que enseña a demoler las murallas históricas con dinamita.
  <!-- feedback: Incorrecto. Es un texto ensayístico descriptivo literario que busca capturar estéticamente el espíritu y la atmósfera de una época colonial montevideana pasada, sin fines de demolición de monumentos. -->
...
- [ ] D) Que la descripción solo se debe realizar empleando el voseo coloquial fronterizo de Rivera para evitar la ortografía formal estándar.
  <!-- feedback: Incorrecto. La descripción literaria de prestigio se escribe mayormente en la norma culta formal escrita estándar rioplatense o internacional. -->
...
### Enunciado
Desde el punto de vista del análisis de la tipología textual, ¿cuál es la importancia de la descripción ( prosopografía y etopeya) en la verosimilitud e impacto cognitivo de los textos de historia o de narrativa?

### Opciones
- [ ] A) Ninguna, la descripción física es un desperdicio de palabras que debe ser suprimido de todas las novelas e informes históricos de Uruguay.
  <!-- feedback: Incorrecto. Omitir la descripción física y moral despojaría a los textos de su capacidad de crear mundos posibles verosímiles, reduciendo el impacto cognitivo de asimilación. -->
- [x] B) La descripción encarna y humaniza los conceptos abstractos: el retrato físico (prosopografía) y moral (etopeya) del caudillo le otorga densidad humana y psicológica, permitiendo que el lector construya una representación mental vívida e identifique las motivaciones y tensiones existenciales del protagonista de la historia, optimizando de manera drástica la comprensión y la memoria a largo plazo.
  <!-- feedback: ¡Correcto! El ser humano procesa e interioriza mejor la información cuando está vinculada a imágenes sensoriales, rostros, gestos y temperamentos humanos concretos. La descripción es el recurso que encarna las ideas abstractas del texto, dotando de espesor vital, verosimilitud y empatía a la reconstrucción histórica o literaria de la diégesis. -->
- [ ] C) La descripción física solo sirve para saber si el caudillo usaba botas de cuero curtido importadas de Europa.
  <!-- feedback: Incorrecto. Las prendas y el aspecto físico van más allá de una marca de calzado: connotan modos de vida, dureza de campaña, extracción social e identidad de época. -->
- [ ] D) La descripción tiene un rol exclusivamente fático destinado a probar si el lápiz de grafito escolar pinta de color rojo o azul.
  <!-- feedback: Incorrecto. La descripción es un componente tipológico estructural central de la competencia comunicativa escrita universal. -->

### Explicacion Pedagogica
La tipología textual descriptiva dota de verosimilitud, plasticidad e imágenes visuales a los relatos históricos o literarios. El retrato de época de los caudillos de la Banda Oriental permite que el lector asimile e interiorice la realidad del relato con mayor fuerza afectiva y cognitiva.
