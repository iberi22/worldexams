---
id: "UY-LEN-11-2026-W06-tema-w06-001-MASTERY-bundle"
country: "uruguay"
grado: 11
asignatura: "lengua"
tema: "tema-w06"
...
- [ ] D) Ejemplificación de cuencas.
  <!-- feedback: Incorrecto. No se están listando casos concretos o ejemplos de penillanuras departamentales uruguayas. -->
...
### Enunciado
¿Cuál es el propósito comunicativo predominante de este fragmento de biodiversidad uruguaya?
...
- [ ] D) Una definición etimológica de origen latino medieval sobre la palabra 'esponja'.
  <!-- feedback: Incorrecto. No se hace mención de la filología de las palabras; se explica la dinámica ecológica del agua. -->
...
- [ ] D) Metáfora barroca sobre el río Uruguay.
  <!-- feedback: Incorrecto. El lenguaje es denotativo, histórico e ilustrativo; no persigue fines ornamentales barrocos líricos. -->
...
### Enunciado
¿Qué rasgos morfosintácticos y estilísticos propios de la objetividad de la tipología expositiva se observan de manera evidente en el fragmento anterior?
...
Texto 2: 'Me partió el alma ver las fotos del venado de campo. Pobrecito animal, tenemos que hacer algo urgente contra esos cazadores malos de Rocha'.

### Enunciado
¿Cómo clasifica la teoría de las tipologías textuales a ambos fragmentos de biodiversidad?
...
- [ ] D) Escribir un ensayo exclusivamente etopeyico sobre la bondad de los ingenieros de Tacuarembó.
  <!-- feedback: Incorrecto. El informe debe centrarse en los procesos físicos y de ingeniería eólica objetiva, no en los rasgos de personalidad moral íntima de los ingenieros. -->
...
### Enunciado
Analizá la terminología y estructura del texto. ¿Qué tipo de léxico predomina y qué función cumple en la tipología expositiva explicativa?
...
### Enunciado
¿Qué recurso explicativo de mediación pedagógica se está empleando de forma prioritaria en la segunda mitad de la oración anterior?
...
### Enunciado
¿Qué conector o marcador textual y qué recurso lógico se despliegan en la estructura de la oración para clasificar los componentes del suelo agrícola?
...
### Enunciado
¿Qué propiedad o criterio epistemológico define y sustenta la validez de un texto expositivo-explicativo académico?

### Opciones
- [ ] A) La capacidad del texto de emocionar estéticamente al lector mediante la invención de batallas fantásticas y diálogos líricos imaginados.
  <!-- feedback: Incorrecto. Eso corresponde a la verosimilitud de la novela histórica ficcional de entretenimiento estético, no a la validez de la ciencia histórica formal. -->
- [x] B) El rigor de la verdad fáctica histórica y la objetividad científica, sustentada en la contrastabilidad de las fuentes documentales oficiales, la precisión del léxico técnico y la coherencia lógica de las explicaciones causales expuestas.
  <!-- feedback: ¡Correcto! La validez del discurso expositivo-explicativo académico reposa en la objetividad y veracidad fáctica de la información representada. Exige contrastar datos, consultar fuentes documentales fidedignas y argumentar de forma lógica-causal neutral. -->
- [ ] C) La prohibición absoluta de utilizar verbos en tiempo pasado de la gramática española.
  <!-- feedback: Incorrecto. La historia recurre constantemente al pretérito perfecto simple, imperfecto y pluscuamperfecto para articular explicaciones temporales de sucesos pasados. -->
- [ ] D) El uso obligatorio del portugués fronterizo de Rivera en todos los informes geográficos ministeriales del país.
  <!-- feedback: Incorrecto. Los informes académicos de Secundaria de historia nacional se redactan en el español formal culto estándar del país. -->
...
### Enunciado
Analizá la estructura del texto. ¿Qué tipo de secuencia discursiva secundaria se introduce a partir del conector 'Sin embargo' y cómo incide en el carácter expositivo explicativo?
...
### Enunciado
¿Cómo operan los marcadores textuales de reformulación explicativa (tales como 'en otras palabras', 'dicho de otro modo', 'esto es') en la arquitectura cognitiva de un texto didáctico de ciencias naturales de Secundaria?
...
### Enunciado
Analizá la progresión temática del fragmento anterior. ¿Cómo fluye la información de una oración a otra para articular la explicación geológica?

### Opciones
- [ ] A) Hay una progresión temática rota que introduce de golpe leyendas fantásticas de minería sin nexo lógico o semántico.
  <!-- feedback: Incorrecto. La secuencia explicativa es perfectamente lógica, fluida, hilvanada y con alta coherencia textual geológica. -->
- [x] B) Presenta una progresión temática de tema constante (o hipertema): la primera oración define e identifica al Acuífero; la segunda especifica su composición material geológica; la tercera explica de manera causal su dinámica hídrica de recarga por infiltración pluvial, guiando al lector del plano general al proceso físico específico.
  <!-- feedback: ¡Correcto! El texto geológico avanza de forma lógica mediante una progresión hilvanada de tema constante (el Acuífero Guaraní). Cada enunciado añade información relevante (definición general -> estructura pétrea -> dinámica de infiltración física real), construyendo un mapa mental claro y estructurado del referente. -->
- [ ] C) El texto carece de cohesión y progresión dado que se escribe omitiendo todos los sustantivos y adjetivos geológicos.
  <!-- feedback: Incorrecto. Al contrario: el fragmento es modélico en su cohesión léxica, recurriendo a elipsis pronominales ('consiste', 'su recarga') que mantienen al Acuífero como núcleo de la progresión. -->
- [ ] D) La progresión temática es exclusivamente de tipo poético lírico líneal con rima asonante del Río de la Plata.
  <!-- feedback: Incorrecto. Es prosa científica geológica descriptiva denotativa pura de ciencias naturales; no hay métrica o rima poética lírica. -->
...
### Enunciado
¿Qué estructura lógica explicativa organiza de manera prioritaria la información en este pasaje científico de ciencias naturales?
...
### Enunciado
Evaluá críticamente el diseño argumentativo y explicativo de este afiche de salud pública. ¿De qué manera la estructura expositiva explicativa apoya el fin persuasivo de la campaña institucional?

### Opciones
- [ ] A) El afiche fracasa al divulgar el dengue debido a que utiliza términos del portugués de frontera de Rivera que confunden al receptor de Montevideo.
  <!-- feedback: Incorrecto. El texto está en un español formal estándar uruguayo claro y preciso, libre de préstamos o hibridaciones de frontera luso-uruguaya. -->
- [x] B) La explicación causal científica (cómo y dónde se reproduce el insecto vector de salud) actúa como la premisa lógica indiscutible que justifica e impulsa la acción del ciudadano (eliminar criaderos domésticos específicos listados como ejemplos), demostrando que la tipología expositiva-explicativa sirve de base racional para la argumentación de prevención en salud pública.
  <!-- feedback: ¡Correcto! Los folletos preventivos de salud combinan la explicación científica (cómo opera biológicamente la cría del insecto vector de salud) con el mandato persuasivo cívico (eliminar tarros). El rigor de la explicación científica dota de racionalidad y veracidad al mandato preventivo, optimizando la persuasión ciudadana de salud pública. -->
- [ ] C) El afiche es en verdad un poema descriptivo de flores de cementerio que utiliza la función lírica poética poética.
  <!-- feedback: Incorrecto. Se explican dinámicas entomológicas de reproducción y de profilaxis de salud pública; no hay intenciones ornamentales de lirismo poético lírico de cementerio. -->
- [ ] D) Se utiliza una descripción etopeyica de la crueldad psicológica e íntima del mosquito Aedes aegypti.
  <!-- feedback: Incorrecto. El mosquito es un organismo vivo que actúa por instintos de especie biológica; no posee moral, maldad íntima o psicología etopeyica. -->
...
- [ ] D) La descripción científica astronómica de los tránsitos lunares del año 1830 en Montevideo.
  <!-- feedback: Incorrecto. No hay menciones de física de astros, planetas, sol o climatología de 1830 en Montevideo. -->
...
### Enunciado
¿Qué valoración crítica y epistemológica merece este postulado didáctico tan restrictivo?
...
### Enunciado
Desde el punto de vista del análisis de la tipología textual expositiva explicativa escolar, ¿cómo deben reformular los estudiantes su conclusión para adecuarla a la monografía científica?
...
### Explicacion Pedagogica
La adecuación al registro monográfico científico formal de Secundaria exige el rigor de la despersonalización del discurso (pasivas reflejas, tercera persona, léxico denotativo químico). Traducir los juicios de valor afectivos de Secundaria en argumentos técnicos basados en datos objetivos reales es un hito de la competencia comunicativa escrita formal.
