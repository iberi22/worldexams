...
Generates Grade 11 weekly packs (W01-W40) for Uruguay (UY), Paraguay (PY), Bolivia (BO).

Usage:
    python scripts/gen_uy_py_bo_weekly.py [--country uy|py|bo|all]
...
COUNTRY_NAME = {"uy": "uy", "py": "py", "bo": "bo"}
EXAMS = {
    "uy": "ANEP / Ubicacion - Direccion General de Educacion Secundaria",
    "py": "MEC / SNEPE - Ministerio de Educacion y Ciencias",
    "bo": "MINEDU - Ministerio de Educacion del Estado Plurinacional",
}
ALIGNMENT = {
    "uy": "ANEP - Plan 2006 Riformulacion / Programa Ubicacion",
    "py": "MEC - Curriculo Nacional Base / SNEPE",
    "bo": "MINEDU - Ley Educativa Avelino Sinani - Elizardo Perez",
}
SUBJ_NAMES = {
...
CITIES = {
    "uy": [
        ("Montevideo", "Liceo No. 1 Dr. Joaquin Suarez"),
        ("Salto", "Liceo No. 1 Dr. Bernando Etchepare"),
        ("Paysandu", "Liceo No. 1 Dr. Pedro J. Varela"),
        ("Maldonado", "Liceo No. 1 Prof. Milton Schinca"),
        ("Rivera", "Liceo No. 1 Dra. Celia O. de Rubio"),
        ("Tacuarembo", "Liceo No. 1 Juan Zorrilla de San Martin"),
        ("Colonia", "Liceo No. 1 Prof. Juan L. Perrou"),
        ("Mercedes", "Liceo No. 1 Prof. Victorino Silva"),
        ("Minas", "Instituto de Ensenanza Secundaria de Minas"),
        ("Rocha", "Liceo No. 1 Dra. Celia O. de Rubio"),
        ("Florida", "Liceo No. 1 Prof. Carmen Collares"),
        ("Durazno", "Liceo No. 1 Pedro Antonio Queirolo"),
        ("Treinta y Tres", "Liceo No. 1 Dr. Adelaida G. de Gutierrez"),
        ("San Jose", "Liceo No. 1 Dr. Maria Elena Castro"),
        ("Lavalleja", "Liceo No. 1 Dr. Juan F. Larratea"),
        ("Canelones", "Liceo No. 1 Prof. Maria Armand Ugon"),
        ("Artigas", "Liceo No. 1 Dr. Carlos A. Delgado"),
        ("Rio Branco", "Liceo de Rio Branco"),
        ("Trinidad", "Liceo No. 1 Prof. Maria A. R. de Pereira"),
        ("Fray Bentos", "Liceo No. 1 Ing. Elbio Z. Laviña"),
    ],
    "py": [
        ("Asuncion", "Colegio Nacional de la Capital"),
        ("Encarnacion", "Colegio Nacional Encaracion"),
        ("Ciudad del Este", "Colegio Nacional del Alto Parana"),
        ("San Lorenzo", "Colegio Nacional San Lorenzo"),
        ("Luque", "Colegio Nacional Luque"),
        ("Capata", "Colegio Nacional Capata"),
        ("Fernando de la Mora", "Colegio Nacional Fernando de la Mora"),
        ("Lambare", "Colegio Nacional Lambare"),
        ("Caaguazu", "Colegio Nacional Caaguazu"),
        ("Itaugua", "Colegio Nacional Itaugua"),
        ("Coronel Oviedo", "Colegio Nacional Coronel Oviedo"),
        ("Concepcion", "Colegio Nacional Concepcion"),
        ("Villarrica", "Colegio Nacional Villarrica"),
        ("San Ignacio", "Colegio Nacional San Ignacio Guazu"),
        ("Pilar", "Colegio Nacional Pilar"),
        ("Mariscal Estigarribia", "Colegio Nacional Mariscal Estigarribia"),
        ("Pedro Juan Caballero", "Colegio Nacional Pedro Juan Caballero"),
        ("Salto del Guaira", "Colegio Nacional Salto del Guaira"),
        ("Hernandarias", "Colegio Nacional Hernandarias"),
        ("Aregua", "Colegio Nacional Aregua"),
    ],
    "bo": [
        ("La Paz", "Colegio Nacional Ayacucho"),
        ("Santa Cruz", "Colegio Nacional Santa Cruz"),
        ("Cochabamba", "Colegio Nacional Sucre"),
        ("El Alto", "Colegio Nacional El Alto"),
        ("Sucre", "Colegio Nacional Junin"),
        ("Oruro", "Colegio Nacional Bolivar"),
        ("Potos", "Colegio Nacional Potos"),
        ("Tarija", "Colegio Nacional San Luis"),
        ("Trinidad", "Colegio Nacional Trinidad"),
        ("Cobija", "Colegio Nacional Cobija"),
        ("Riberalta", "Colegio Nacional Riberalta"),
        ("Camiri", "Colegio Nacional Camiri"),
        ("Villazon", "Colegio Nacional Villazon"),
        ("Yacuiba", "Colegio Nacional Yacuiba"),
        ("Montero", "Colegio Nacional Montero"),
        ("Viacha", "Colegio Nacional Viacha"),
        ("Warnes", "Colegio Nacional Warnes"),
        ("Llallagua", "Colegio Nacional Llallagua"),
        ("Huanuni", "Colegio Nacional Huanuni"),
        ("Patacamaya", "Colegio Nacional Patacamaya"),
    ],
}
...
def gen_math(qnum, topic, cc, cities):
    ...
    templates = [
        ...
        {"diff": "D5", "bloom": "Analyze",
         "stem": f"En un examen ANEP/MEC en {city}, se pide: si f(x) = {a}x^2 + {b}x + {c%10}. &iquest;Cual es f(2)?",
         "opts": [("A", str(4*a+2*b+c%10), True), ("B", str(2*a+b), False), ("C", str(c%10), False), ("D", str(a+b), False)],
         "exp": f"Sustituyo x=2: f(2) = {a}(4) + {b}(2) + {c%10} = {4*a+2*b+c%10}."},
        {"diff": "D6", "bloom": "Apply",
        ...
        {"diff": "D6", "bloom": "Evaluate",
         "stem": f"Un estudiante de {city} obtuvo notas: {a*2}, {b*3}, {a+b+5}. &iquest;Cual es la media?",
         "opts": [("A", str(round((a*2+b*3+a+b+5)/3,1)), True), ("B", str(rng.randint(3,8)), False), ("C", str(a*b), False), ("D", str(a+b), False)],
         "exp": "La media aritmetica se calcula sumando todos los valores y dividiendo por el numero total."},
        {"diff": "D7", "bloom": "Apply",
         "stem": f"Calcule la derivada de f(x) = {a}x^3 + {b}x^2 + {c%10}x",
         "opts": [("A", f"f'(x) = {3*a}x^2 + {2*b}x + {c%10}", True), ("B", f"f'(x) = {a}x^2 + {b}x", False), ("C", f"f'(x) = {3*a}x^2 + {b}x", False), ("D", f"f'(x) = {3*a}x^3 + {2*b}x^2", False)],
         "exp": f"Derivada termino a termino: d/dx({a}x^3) = {3*a}x^2, d/dx({b}x^2) = {2*b}x, d/dx({c%10}x) = {c%10}."},
        {"diff": "D7", "bloom": "Evaluate",
         "stem": "&iquest;Es correcta la siguiente afirmacion? La funcion f(x) = x^2 tiene un minimo en x = 0",
...
def gen_lang(qnum, topic, cc, cities):
    ...
    templates = [
        ...
        {"diff": "D6", "bloom": "Analyze",
         ...
         "exp": "La metafora identifica un termino real con uno imaginario por su semejanza."},
        {"diff": "D6", "bloom": "Apply",
...
def main():
    ...
    parser.add_argument("--country", choices=["uy", "py", "bo", "all"], default="all")
    parser.add_argument("--force", action="store_true")
    args = parser.parse_args()
    
    topics_path = os.path.join(BASE_DIR, "scripts", "uy_py_bo_topics.json")
    ...
    countries = ["uy", "py", "bo"] if args.country == "all" else [args.country]
    total_created = 0
    total_existing = 0
        ...
        for subj_key in cfg:
            ...
            for w, topic in enumerate(topics_list, 1):
                ...
                if total_created % 10 == 0:
                    print(f"    Progress: {total_created} created so far...")
