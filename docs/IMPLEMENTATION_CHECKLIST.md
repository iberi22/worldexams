...
- [ ] **Compilation**
  ...
  - [ ] Test build on Linux (GitHub Actions)
...
## ⚙️ Phase 6: GitHub Workflows

### Workflows Created

| Workflow | Schedule | Status |
|----------|----------|--------|
| `social-content.yml` | Every 3 hours | ✅ Created |
| `issue-triage.yml` | Every hour | ✅ Created |
| `weekly-report.yml` | Monday 9 AM | ✅ Created |

### To Do
- [ ] **Testing**
  - [ ] Trigger workflows manually
  - [ ] Verify secret access
  - [ ] Check Rust compilation in Actions
...
- [ ] **Repository Setup**
  - [ ] Push code to `world-exams/world-exams`
...
3. **Rust:** Test compilation in GitHub Actions first
