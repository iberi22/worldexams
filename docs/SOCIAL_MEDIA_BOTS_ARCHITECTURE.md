...
> Diseño híbrido para administrar Telegram, Discord, X.com desde Edge Functions y GitHub Workflows
...
2. **GitHub Workflows (Rust)** → Tareas programadas y triage automatizado
...
| **GitHub Workflows** | Tareas programadas | • Totalmente gratis<br>• Binario Rust eficiente<br>• 6+ horas/día disponibles | • No es tiempo real<br>• Max 6 horas por job |
...
- ✅ Leer issues del repo `world-exams/world-exams`
...
```bash
# Telegram
TELEGRAM_BOT_TOKEN=8116938644:AAEPc7fpKCb-XKbqv0rVGgAOPO42fO_ZTu8
TELEGRAM_CHAT_ID=2076598024
