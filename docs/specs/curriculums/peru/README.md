# Curriculum map — peru (PE)

Source of truth for Jules issue tables (W01–W40 × grade × subject).

## How to use
1. Pick grade + subject from `skills/bundle-creator/rules/PE.md`
2. Fill topic per week below (or extend this file)
3. Generate issues: `node scripts/generate-jules-issue-matrix.mjs --country PE --grade 11 --subject matematicas --from 1 --to 10`
