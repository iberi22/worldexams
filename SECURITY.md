# Política de Seguridad de WorldExamns

> WorldExamns / SaberParaTodos se compromete a mantener seguros los datos de usuarios, contribuyentes y la plataforma.
> Este documento describe cómo reportar vulnerabilidades y nuestras prácticas de seguridad.
...
3. **Auditoría de git history:**
   ...
   - Usa `git-filter-repo` para limpiar history si es necesario
   - Issue #221 trackea la limpieza de secrets expuestos
